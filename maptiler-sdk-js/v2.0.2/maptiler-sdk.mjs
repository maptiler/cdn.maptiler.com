...
class Map extends maplibregl.Map {
  constructor(options) {
    ...
    super(__spreadValues$2(__spreadProps$1(__spreadValues$2({}, options), {
      style,
      maplibreLogo: false,
      transformRequest: combineTransformRequest(options.transformRequest)
    }), (_a = options.attributionControl) != null ? _a : { attributionControl: false }));
    ...
    this.primaryLanguage = (_b = options.language) != null ? _b : config$1.primaryLanguage;
    ...
    this.terrainExaggeration = (_c = options.terrainExaggeration) != null ? _c : this.terrainExaggeration;
    ...
    if (options.terrain) {
      this.enableTerrain(
        (_d = options.terrainExaggeration) != null ? _d : this.terrainExaggeration
      );
    }
  }
  /**
