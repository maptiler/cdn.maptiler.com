import{getIntersection as Ae,scaleFromCenter as Me,getArea as Q,getIntersectionArea as De}from"ol/extent.js";import{createXYZ as Ie}from"ol/tilegrid.js";import*as h from"three";import{OrthographicCamera as ze,Scene as Fe,RawShaderMaterial as Oe,GLSL3 as Ne,Vector2 as Ue,WebGLRenderTarget as ue,LinearFilter as q,RGBAFormat as ee,Mesh as Le,PlaneGeometry as $e,DataTexture as Ve,WebGLRenderer as Be}from"three";import We from"ol/structs/LRUCache.js";import{EventEmitter as Ge}from"events";var he=(r=>(r[r.r=0]="r",r[r.g=1]="g",r[r.b=2]="b",r[r.a=3]="a",r))(he||{});let te=null,oe=null;function ke(){return(!te||!oe)&&(te=document.createElement("canvas"),oe=te.getContext("webgl2")),oe}function L(r){var e;return`vec4(${(r[0]/255).toFixed(3)},${(r[1]/255).toFixed(3)},${(r[2]/255).toFixed(3)},${(((e=r[3])!=null?e:255)/255).toFixed(3)})`}function je(r){var e;return[r[0]/255,r[1]/255,r[2]/255,((e=r[3])!=null?e:255)/255]}function ve(r){return 180/Math.PI*Math.log(Math.tan(Math.PI/4+r*Math.PI/360))/360}function re(r,e){return[r/360,ve(e)]}function me(r){const e=Math.PI,t=Math.atan,o=Math.exp,i=o(r*2*e);return(t(i)-e/4)*360/e}function Ze(r,e){const t=-.5*(r/e*2-1);return me(t)}const de=6378137,j=2*Math.PI*de;function V(r,e){return re(r,e).map(t=>t*j)}function pe(r,e,t){const o=Math.floor(e*r.width),i=Math.floor(t*r.height),n=ke();if(n==null)throw new Error("Failed to obtain WebGL2 context");n.activeTexture(n.TEXTURE0);const a=n.createTexture();n.bindTexture(n.TEXTURE_2D,a);const s=n.createFramebuffer();n.bindFramebuffer(n.FRAMEBUFFER,s),n.framebufferTexture2D(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,a,0),n.texImage2D(n.TEXTURE_2D,0,n.RGBA,n.RGBA,n.UNSIGNED_BYTE,r),n.drawBuffers([n.COLOR_ATTACHMENT0]);const l=new Uint8Array(4);return n.readPixels(o,i,1,1,n.RGBA,n.UNSIGNED_BYTE,l),n.deleteTexture(a),n.deleteFramebuffer(s),{r:l[0]/255,g:l[1]/255,b:l[2]/255,a:l[3]/255}}function Ye(r,e,t=""){r.isStyleLoaded()?r.addLayer(e,t):r.once("load",()=>{r.addLayer(e,t)})}function xe(r){const e=["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"],t=Math.round((r+360)%360/22.5)%16;return e[t]}var He=`
...
void main() {
  ...
  color.a *= opacity;
  fragColor = color;
}`,qe=Object.defineProperty,Xe=(r,e,t)=>e in r?qe(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,Z=(r,e,t)=>(Xe(r,typeof e!="symbol"?e+"":e,t),t);const N=7;function Ke(r){return r.filter((e,t)=>t===0||t%2||t===r.length-1)}function fe(r,e=50){if(r.length<=e)return r;const t=Ke(r);return fe(t,e)}function ge(r,e,t={inputName:"v",outputName:"c"}){const o=fe(r);let i="";for(let n=0;n<o.length;n++){const a=o[n];n===0&&(i+=`vec4 ${t.outputName}=${L(a.color)};
`);const s=a.value,l=L(a.color);if(e&&n+1<o.length){const c=o[n+1].value,v=L(o[n+1].color),p=parseFloat((s-c).toFixed(N))===0?"0.":`(${t.inputName} - ${s.toFixed(N)}) / (${(c-s).toFixed(N)})`;i+=`${n>0?" else ":""} if(${t.inputName}>=${s.toFixed(N)}&&${t.inputName}<${c.toFixed(N)}) { ${t.outputName}=mix(${l},${v}, ${p} ); }
`}else i+=`if(${t.inputName}>=${s.toFixed(N)})${t.outputName}=${l};
`}return i}class ie{constructor(e,t){this.code=e,this.decode=t;var o,i;this.decode.min=(o=this.decode.min)!=null?o:0,this.decode.max=(i=this.decode.max)!=null?i:1}codeValue(e){return(e-this.decode.min)/(this.decode.max-this.decode.min)}decodeValue(e){return this.decode.min+e*(this.decode.max-this.decode.min)}decodeChannel(e){if(this.decode.channel.length>1){const t=this.decodeValue(e[this.decode.channel[0]]),o=this.decodeValue(e[this.decode.channel[1]]);return[t,o,Math.sqrt(t*t+o*o)]}return this.decodeValue(e[this.decode.channel])}getBlendCode(e){const t=this.code+"d.rgb=(d.rgb*d.a*(1.-c.a)+c.rgb*c.a)/(d.a*(1.-c.a)+c.a);d.a=d.a+c.a*(1.-d.a);";return`vec4 ${e}(vec4 d,vec4 data){${t}return d;}`}getCode(e){return`vec4 ${e}(vec4 data){${this.code}return c;}`}}function ye({channel:r="r",min:e=0,max:t=1}){let o=`${e.toFixed(N)}+data.${r}*${(t-e).toFixed(N)}`;return r.length>1&&(o=`length(${o})`),`float v=${o};`}class B extends ie{constructor(e){var t,o;const i=e.decode,n=e.stops||[{value:i.min,color:[0,0,0,0]},{value:i.max,color:[255,255,255,255]}],a=(t=e.smooth)!=null?t:!0,s=(o=e.opacity)!=null?o:1;let l=ye(i);l+=ge(n,a),l+=`c.a*=${s.toFixed(3)};`,super(l,i)}}class Je extends ie{constructor(e){var t;const o=e.decode,i=e.color||[255,255,255],n=(t=e.opacity)!=null?t:1,a=ye(o)+`vec4 c=${L(i)};c.a*=v*${n.toFixed(3)};`;super(a,o)}}class Qe{constructor(e){Z(this,"decode",{polynomialCoefDegree2:0,polynomialCoefDegree1:1,polynomialConstant:0}),Z(this,"stopsPerCategory",[{category:"all",stops:[{value:0,color:[0,0,0]},{value:255,color:[255,255,255]}]}]),Z(this,"smooth"),Z(this,"opacity"),Z(this,"code");var t,o;this.decode=e.decode,this.stopsPerCategory=e.stopsPerCategory,this.smooth=(t=e.smooth)!=null?t:!0,this.opacity=(o=e.opacity)!=null?o:1;const i=this.stopsPerCategory.filter(l=>l.category==="all");let n=this.stopsPerCategory;i.length&&(n=i);const a=n.map(l=>{let c=`vec4 _mccf_${l.category}(float v) {
`;return c+=`${ge(l.stops,this.smooth)}`,c+=`return c;}
`,c}).join(`
`);let s=`vec4 getColor(int category, float v) {
`;s+=`vec4 outputColor;
`,i.length?s+="outputColor  = _mccf_all(v);":(s+=this.stopsPerCategory.map((l,c)=>`${c===0?"":"else "}if (category == ${l.category}) outputColor  = _mccf_${l.category}(v);`).join(`
`),s+=`
 else outputColor = vec4(0., 0., 0., 0.);
`),s+=`outputColor.a *= ${this.opacity.toFixed(3)};
`,s+=`return outputColor;}
`,this.code=He.replace("<gradient_function_definitions>",a).replace("<getColor_code>",s).replace("<polynomialCoefDegree2>",this.decode.polynomialCoefDegree2.toFixed(N)).replace("<polynomialCoefDegree1>",this.decode.polynomialCoefDegree1.toFixed(N)).replace("<polynomialConstant>",this.decode.polynomialConstant.toFixed(N))}getCode(){return this.code}decodeChannel(e){const t={r:e.r*255,g:e.g*255,b:e.b*255,a:e.a*255},o=t.r*256*256+t.g*256+t.b;return[this.decode.polynomialCoefDegree2*o*o+this.decode.polynomialCoefDegree1*o+this.decode.polynomialConstant,t.a]}}var et=Object.defineProperty,tt=(r,e,t)=>e in r?et(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,Se=(r,e,t)=>(tt(r,typeof e!="symbol"?e+"":e,t),t);class ot{constructor(){Se(this,"allInstances",[]),Se(this,"availableInstances",[])}add(e,t=!1){return this.allInstances.push(e),t&&this.availableInstances.push(e),e}isEmpty(){return this.availableInstances.length===0}pop(){if(this.isEmpty())throw new Error("No more instances available ini the pool.");return this.availableInstances.pop()}init(){this.availableInstances=this.allInstances.slice()}reset(){this.availableInstances=[],this.allInstances=[]}}var rt=`
precision highp float;
precision highp sampler2D;
...
void main() {
  fragColor = vec4(1., 0., 0., 1.);
}`,st=Object.defineProperty,ct=(r,e,t)=>e in r?st(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,W=(r,e,t)=>(ct(r,typeof e!="symbol"?e+"":e,t),t);let ne=null;function ut(){return ne||(ne=new Be({alpha:!0,premultipliedAlpha:!1})),ne}class ae{constructor(e,t,o=ut()){W(this,"renderer"),W(this,"camera",new ze(-1,1,1,-1,0,1)),W(this,"scene",new Fe),W(this,"renderTarget"),W(this,"material",new Oe({glslVersion:Ne,vertexShader:at,fragmentShader:lt,depthWrite:!1,transparent:!0})),W(this,"size"),this.size=new Ue(e,t),this.renderTarget=new ue(e,t,{minFilter:q,magFilter:q,format:ee}),this.camera.matrixAutoUpdate=!1,this.renderer=o,this.renderer.setPixelRatio(1),this.renderer.autoClear=!1;const i=new Le(new $e(2,2),this.material);this.scene.add(i)}getOutputTexture(e=!1){return e?new Ve(this.getPixelData(),this.size.x,this.size.y,ee):this.renderTarget.texture}setSize(e,t){e===this.size.x&&t===this.size.y||(this.size.x=e,this.size.y=t,this.renderTarget=new ue(e,t,{minFilter:q,magFilter:q,format:ee}),this.renderer.setRenderTarget(this.renderTarget))}setVertexShader(e){this.material.vertexShader=e.trim(),this.material.needsUpdate=!0}setFragmentShader(e){this.material.fragmentShader=e.trim(),this.material.needsUpdate=!0}setUniform(e,t){this.material.uniforms[e]={value:t}}setDefine(e,t){this.material.fragmentShader=this.material.fragmentShader.replace(new RegExp(e,"g"),t.toString()),this.material.vertexShader=this.material.vertexShader.replace(new RegExp(e,"g"),t.toString()),this.material.needsUpdate=!0}getPixelData(){const e=this.size,t=new Uint8Array(e.x*e.y*4);return this.renderer.readRenderTargetPixels(this.renderTarget,0,0,e.x,e.y,t),t}getSize(){return this.size.clone()}process(){return this.material.needsUpdate=!0,this.renderer.setRenderTarget(this.renderTarget),this.renderer.clear(),this.renderer.render(this.scene,this.camera),this.renderTarget.texture}debugAsPNG(){const e=this.getSize(),t=this.getPixelData(),o=document.createElement("canvas");o.width=e.x,o.height=e.y;const i=o.getContext("2d");if(!i)return;const n=i.getImageData(0,0,o.width,o.height);n.data.set(t),i.putImageData(n,0,0);const a=window.open();a&&a.document.write(`<iframe src="${o.toDataURL("image/png")}" frameborder="0" style="border:0; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%;" allowfullscreen></iframe>`)}dispose(){this.renderTarget.texture.dispose(),this.renderTarget.dispose()}}var ht=Object.defineProperty,vt=(r,e,t)=>e in r?ht(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,we=(r,e,t)=>(vt(r,typeof e!="symbol"?e+"":e,t),t);class mt{constructor(e,t){this.url=e,this.onTileLoad=t,we(this,"loader",new h.TextureLoader),we(this,"lru",new We(32))}getTile(e,t){if(this.lru.containsKey(e))return this.lru.get(e);if(t){const o=this.createTile(e);return this.lru.set(e,o),o}return null}createTile(e){const t=this.url.replace("{zxy}",e),o={ready:!1,texture:null,zxy:e};return o.texture=this.loader.load(t,i=>{o.ready=!0,this.onTileLoad!=null&&this.onTileLoad(o,t,null)},void 0,i=>{this.onTileLoad!=null&&this.onTileLoad(o,t,i)}),o.texture.minFilter=h.LinearFilter,o.texture.needsUpdate=!0,o}disposeTile(e){e.texture&&e.texture.dispose()}expireCache(e){for(;this.lru.canExpireCache()&&!(this.lru.peekLast().zxy in e);)this.disposeTile(this.lru.pop())}dispose(){this.lru.forEach(e=>{this.disposeTile(e)}),this.lru.clear()}}var dt=Object.defineProperty,pt=(r,e,t)=>e in r?dt(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,X=(r,e,t)=>(pt(r,typeof e!="symbol"?e+"":e,t),t);class xt extends Ge{constructor(){super(),X(this,"frames",[]),X(this,"time",0),X(this,"animationSpeed",0),X(this,"lastTickTime",0)}addFrame(e,t){const o=this.findSmallerFrameIndex(e);if(o<0)this.frames.unshift({time:e,data:t});else{if(this.frames[o].time==e)throw new Error("Frame with this time already exists");this.frames.splice(o+1,0,{time:e,data:t})}this.clampAnimation()}removeFrame(e){const t=this.frames.filter(o=>o.time==e);return this.frames=this.frames.filter(o=>o.time!=e),this.clampAnimation(),t}forEachFrame(e){this.frames.forEach(t=>e(t))}getAnimationStart(){return this.frames.length?this.frames[0].time:1/0}getAnimationStartDate(){return new Date(this.getAnimationStart()*1e3)}getAnimationEnd(){return this.frames.length?this.frames[this.frames.length-1].time:-1/0}getAnimationEndDate(){return new Date(this.getAnimationEnd()*1e3)}getAnimationTime(){return this.time}getAnimationTimeDate(){return new Date(this.getAnimationTime()*1e3)}setAnimationTime(e){this.time=e,this.clampAnimation(),this.emit("animationTimeSet",{time:this.time})}clampAnimation(){this.time=Math.max(this.getAnimationStart(),Math.min(this.getAnimationEnd(),this.time))}animateByFactor(e){this.animate(e)}animate(e){e>0&&this.animationSpeed===0?this.emit("playAnimation",{time:this.time}):e===0&&this.animationSpeed>0&&this.emit("pauseAnimation",{time:this.time}),this.animationSpeed=e,this.animationSpeed!=0&&(this.lastTickTime=performance.now())}getAnimationSpeed(){return this.animationSpeed}isPlaying(){return this.animationSpeed>0}animationTick(){const e=performance.now();if(this.animationSpeed>0&&this.lastTickTime){const t=e-this.lastTickTime;this.time+=this.animationSpeed*(t/1e3);const o=this.getAnimationStart(),i=this.getAnimationEnd();this.time=o+(this.time-o)%(i-o),isNaN(this.time)&&(this.time=o),this.emit("tick",{time:this.time})}this.lastTickTime=e}findSmallerFrameIndex(e){for(let t=this.frames.length-1;t>=0;--t)if(this.frames[t].time<=e)return t;return-1}getCurrentFrames(){if(this.frames.length==0)return{frameA:null,frameB:null,mix:0};let e=this.findSmallerFrameIndex(this.time);e<0&&(e=0);const t=this.frames[e],o=this.frames[Math.min(this.frames.length-1,e+1)],i=o.time-t.time,n=i==0?0:(this.time-t.time)/i;return{frameA:t,frameB:o,mix:n}}getNextFrame(e,t){const o=this.frames.findIndex(i=>i===e);return o<0?null:t<0?o>0?this.frames[o-1]:null:o<this.frames.length-1?this.frames[o+1]:null}}var ft=Object.defineProperty,gt=(r,e,t)=>e in r?ft(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,f=(r,e,t)=>(gt(r,typeof e!="symbol"?e+"":e,t),t);class G extends xt{constructor(e,t,o=null,i=null){super(),f(this,"id"),f(this,"type","custom"),f(this,"renderingMode","3d"),f(this,"camera",new h.Camera),f(this,"scene",new h.Scene),f(this,"slippyTiles",[]),f(this,"map",null),f(this,"renderer",null),f(this,"material"),f(this,"geometry",new h.PlaneBufferGeometry(1,1)),f(this,"flusher"),f(this,"tilegrid"),f(this,"extent",null),f(this,"repaintOnPausedAnimation",!0),f(this,"materialPool",new ot),f(this,"bluringNodePasses",[]),f(this,"tileThreeContainer",new h.Object3D),f(this,"extentScale",1),f(this,"extentChangedThreshold",.75),f(this,"lastExtent",[0,0,0,0]),f(this,"lastExtentArea",0),f(this,"timeInterpolation",!0),f(this,"isReady",!1),f(this,"defaultTexture",new h.DataTexture(new Uint8Array([128,128,128,255]),1,1,h.RGBAFormat)),f(this,"onMoveEndListener"),f(this,"onResizeListener"),f(this,"onMoveListener"),f(this,"coloringFragments",null),f(this,"multiChannelColoringFragment"),f(this,"getMapOrThrow",()=>{if(this.map==null)throw new Error("Accessing map on detached layer");return this.map}),f(this,"getRendererOrThrow",()=>{if(this.renderer==null)throw new Error("Accessing renderer on detached layer");return this.renderer}),this.defaultTexture.needsUpdate=!0,this.id=e,t&&this.init(t,o,i)}init(e,t=null,o=null){var i,n,a,s,l,c,v,p,m;this.coloringFragments=t,this.multiChannelColoringFragment=o,this.repaintOnPausedAnimation=(i=e.repaintOnPausedAnimation)!=null?i:!0,this.onMoveEndListener=this.onMoveEnd.bind(this),this.onResizeListener=this.onResize.bind(this),this.onMoveListener=this.onMove.bind(this),this.tilegrid=Ie({minZoom:(n=e.minZoom)!=null?n:0,maxZoom:(a=e.maxZoom)!=null?a:4}),e.bounds&&(this.extent=V(e.bounds[0],e.bounds[1]).concat(V(e.bounds[2],e.bounds[3])));let d="";if(this.coloringFragments){const C=this.coloringFragments.map((x,A)=>x.getBlendCode(`_cf_${A}`));let P="fragColor";for(let x=0;x<this.coloringFragments.length;x++)P=`_cf_${x}(${P},inter)`;P=`fragColor=${P};`,d=rt.replace("COLORING_FRAGMENT_DEFS",C.join(`
`)).replace("COLORING_FRAGMENT_CALLS",P)}else o&&(d=o.getCode());const w=((s=e.nbSmoothingBins)!=null?s:16).toFixed(0);this.timeInterpolation=(l=e.timeInterpolation)!=null?l:!0,this.material=new h.RawShaderMaterial({glslVersion:h.GLSL3,uniforms:{opacity:{value:1},time:{value:0},zoom:{value:0},tex0xy:{value:[0,0]},tex1xy:{value:[0,0]},tex0size:{value:1},tex1size:{value:1},tilePixelSize:{value:1},categorySmoothTransition:{value:(c=e.categorySmoothTransition)!=null?c:!1},timeInterpolation:{value:this.timeInterpolation},tex0:{value:null},tex1:{value:null},zoomDelta:{value:0},localSmoothing:{value:(v=e.localSmoothing)!=null?v:!1},maxSmoothingDistance:{value:(p=e.maxSmoothingDistance)!=null?p:12},smoothingDistanceDecayFactor:{value:(m=e.smoothingDistanceDecayFactor)!=null?m:10},texN0:{value:this.defaultTexture},texN1:{value:this.defaultTexture},availableN:{value:!1},texE0:{value:this.defaultTexture},texE1:{value:this.defaultTexture},availableE:{value:!1},texS0:{value:this.defaultTexture},texS1:{value:this.defaultTexture},availableS:{value:!1},texW0:{value:this.defaultTexture},texW1:{value:this.defaultTexture},availableW:{value:!1}},vertexShader:it,fragmentShader:d,depthTest:!1,depthWrite:!1,transparent:!0,defines:{RENDER_TRANSPARENT:e.renderTransparentArea?"true":"false",NB_SMOOTHING_BINS:w}}),this.flusher=new h.Mesh(new h.PlaneBufferGeometry(1,1),new h.MeshBasicMaterial({colorWrite:!1,depthWrite:!1})),this.flusher.frustumCulled=!1,this.scene.add(this.flusher),this.scene.add(this.tileThreeContainer),this.updateSlippyTileGrid(8,8),this.on("playAnimation",()=>{this.forceRepaint()}),this.on("animationTimeSet",()=>{this.forceRepaint()}),this.isReady=!0}updateSlippyTileGrid(e,t){this.tileThreeContainer.clear(),this.slippyTiles.length=0;for(let o=0;o<e;o++){this.slippyTiles[o]=[];for(let i=0;i<t;i++){const n=new h.Mesh(this.geometry);n.frustumCulled=!1,this.slippyTiles[o][i]=n,this.tileThreeContainer.add(n)}}}addSource(e,t,o=null){super.addFrame(e,new mt(t,(i,n,a)=>{o&&o(i,n,a),this.forceRepaint()}))}removeSource(e){super.removeFrame(e).forEach(t=>{t.data.dispose()}),this.forceRepaint()}getVisibleExtent(e){if(!this.isReady)return;const t=this.getMapOrThrow().getBounds();let o=V(t.getWest(),t.getSouth()).concat(V(t.getEast(),t.getNorth()));return this.extent&&(o=Ae(this.extent,o)),e&&Me(o,e),o}getWantedTiles(e){if(!this.isReady)return;e=Math.ceil(e);const t={},o=this.getVisibleExtent(),i=this.tilegrid.getMinZoom(),n=this.tilegrid.getMaxZoom(),a=Math.min(n,Math.max(i,e-1)),s=Math.min(n,Math.max(i,e));for(let l=a;l<=s;++l){const c=Math.pow(2,l),v=this.tilegrid.getTileRangeForExtentAndZ(o,l);for(let p=v.minX;p<=v.maxX;++p)for(let m=v.minY;m<=v.maxY;++m)m<0||m>=c||(t[`${l}/${p}/${m}`]=!0)}return t}setOpacity(e){this.isReady&&(this.material.uniforms.opacity.value=e,this.forceRepaint())}onAdd(e,t){this.map=e,this.map.on("moveend",this.onMoveEndListener),this.map.on("resize",this.onResizeListener),this.map.on("move",this.onMoveListener),this.renderer=new h.WebGLRenderer({canvas:e.getCanvas(),context:t,depth:!1,stencil:!1,antialias:!0}),this.renderer.autoClear=!1,this.renderer.sortObjects=!1,this.renderer.debug.checkShaderErrors=!0,this.renderer.compile(this.scene,this.camera),this.onResize(),this.refresh(),this.lastExtent=this.getVisibleExtent(this.extentScale),this.lastExtentArea=Q(this.lastExtent),this.forceRepaint()}onMove(){if(!this.isReady)return;const e=this.getVisibleExtent(this.extentScale),t=Q(e),o=[Math.min(e[0],this.lastExtent[0]),Math.min(e[1],this.lastExtent[1]),Math.max(e[2],this.lastExtent[2]),Math.max(e[3],this.lastExtent[3])],i=Q(o);De(this.lastExtent,e)/i<=this.extentChangedThreshold&&(this.lastExtent=e,this.lastExtentArea=t,this.emit("extentChanged"))}refresh(){}onRemove(e,t){this.isReady&&(this.map!=null&&(this.map.off("moveend",this.onMoveEndListener),this.map.off("resize",this.onResizeListener),this.map.off("move",this.onMoveListener),this.map=null),this.renderer!=null&&(this.renderer.dispose(),this.renderer=null),this.forEachFrame(o=>{o.data.dispose()}),this.disposeObjects())}disposeObjects(){this.isReady&&(this.geometry.dispose(),this.material.dispose(),this.flusher.geometry.dispose(),this.flusher.material.dispose(),this.bluringNodePasses.forEach(e=>e.dispose()))}onResize(){if(!this.isReady)return;const e=this.getMapOrThrow().getCanvas(),t=e.width,o=e.height;this.getRendererOrThrow().setViewport(0,0,t,o),this.updateSlippyTileGrid(Math.ceil(t/512)+2,Math.ceil(o/512)+2)}onMoveEnd(){}getTilePlacement(e,t,o,i,n,a){if(!this.isReady)return;const s=`${o}/${i}/${n}`,l=e.getTile(s,t);if(!l||!l.ready)return o>this.tilegrid.getMinZoom()?this.getTilePlacement(e,t,o-1,Math.floor(i/2),Math.floor(n/2),a||{z:o,x:i,y:n}):null;const c={tile:l,xy:[0,0],size:1};if(a!==void 0){const v=Math.pow(2,a.z-o);c.size/=v,c.xy[0]=a.x%v/v,c.xy[1]=(Math.pow(2,a.z)-a.y-1)%v/v}return c}updateSlippyTiles(){var e;if(!this.isReady)return;const{frameA:t,frameB:o,mix:i}=this.getCurrentFrames();if(!t||!o){this.scene.visible=!1;return}this.scene.visible=!0;const n=t.data,a=o.data,s=this.getMapOrThrow().getZoom(),l=this.getWantedTiles(s),c={},v=this.tilegrid.getMinZoom(),p=this.tilegrid.getMaxZoom(),m=Math.min(p,Math.max(v,Math.floor(s))),d=Math.pow(2,m),w=1/d,C=this.getMapOrThrow().getCenter(),P=this.tilegrid.getTileCoordForCoordAndZ(V(C.lng,C.lat),m),x=s-m,A=this.slippyTiles.length;this.materialPool.init();const _=new globalThis.Map;for(let E=0;E<A;E++){const z=this.slippyTiles[0].length;for(let F=0;F<z;F++){const M=this.slippyTiles[E][F],g=P[1]+E-Math.floor(A/2),O=P[2]+F-Math.floor(z/2),Y=`${m}/${g}/${O}`;if(O<0||O>=d||!l[Y]){M.visible=!1;continue}M.visible=!0;const U=(g%d+d)%d,H=`${m}/${U}/${O}`;c[H]=!0;const J=d-O-1;M.scale.x=w,M.scale.y=w,M.position.x=w*(g+.5),M.position.y=w*(J+.5)-1;let b=this.getTilePlacement(n,!0,m,U,O),D=this.getTilePlacement(a,!0,m,U,O);if(b&&!D&&(D=b),!b&&D&&(b=D),!b||!D){let y=t;for(;!b&&(y=this.getNextFrame(y,-1),!!y);)b=D=this.getTilePlacement(y.data,!1,m,U,O);if(!b||!D){M.visible=!1;continue}}const R=this.materialPool.isEmpty()?this.materialPool.add(this.material.clone()):this.materialPool.pop();R.uniforms.localSmoothing.value=this.material.uniforms.localSmoothing.value,R.uniforms.maxSmoothingDistance.value=this.material.uniforms.maxSmoothingDistance.value,R.uniforms.smoothingDistanceDecayFactor.value=this.material.uniforms.smoothingDistanceDecayFactor.value,R.uniforms.timeInterpolation.value=this.material.uniforms.timeInterpolation.value,R.uniforms.categorySmoothTransition.value=this.material.uniforms.categorySmoothTransition.value,R.uniforms.opacity.value=this.material.uniforms.opacity.value,R.uniforms.tex0.value=b.tile.texture,R.uniforms.tex0xy.value=b.xy,R.uniforms.tex0size.value=b.size,R.uniforms.tex1.value=D.tile.texture,R.uniforms.tex1xy.value=D.xy,R.uniforms.tex1size.value=D.size,R.uniforms.tilePixelSize.value=(e=b.tile.texture)==null?void 0:e.image.width,R.uniforms.time.value=i,R.uniforms.zoomDelta.value=x,M.material=R,R.uniforms.zoom.value=s,_.set(`${E} ${F}`,{material:R,tileA:b,tileB:D,x:E,y:F,z:m})}}this.material.uniforms.localSmoothing.value&&_.forEach((E,z)=>{const F=E.x,M=E.y,g=E.material,O={x:F,y:M-1},Y={x:F+1,y:M},U={x:F,y:M+1},H={x:F-1,y:M},J=`${O.x} ${O.y}`,b=`${Y.x} ${Y.y}`,D=`${U.x} ${U.y}`,R=`${H.x} ${H.y}`;let y=_.get(J);y&&y.tileA.tile.ready&&y.tileB.tile.ready?(g.uniforms.texN0.value=y.tileA.tile.texture,g.uniforms.texN1.value=y.tileB.tile.texture,g.uniforms.availableN.value=!0):(g.uniforms.texN0.value=null,g.uniforms.texN1.value=null,g.uniforms.availableN.value=!1),y=_.get(b),y&&y.tileA.tile.ready&&y.tileB.tile.ready?(g.uniforms.texE0.value=y.tileA.tile.texture,g.uniforms.texE1.value=y.tileB.tile.texture,g.uniforms.availableE.value=!0):(g.uniforms.texE0.value=null,g.uniforms.texE1.value=null,g.uniforms.availableE.value=!1),y=_.get(D),y&&y.tileA.tile.ready&&y.tileB.tile.ready?(g.uniforms.texS0.value=y.tileA.tile.texture,g.uniforms.texS1.value=y.tileB.tile.texture,g.uniforms.availableS.value=!0):(g.uniforms.texS0.value=null,g.uniforms.texS1.value=null,g.uniforms.availableS.value=!1),y=_.get(R),y&&y.tileA.tile.ready&&y.tileB.tile.ready?(g.uniforms.texW0.value=y.tileA.tile.texture,g.uniforms.texW1.value=y.tileB.tile.texture,g.uniforms.availableW.value=!0):(g.uniforms.texW0.value=null,g.uniforms.texW1.value=null,g.uniforms.availableW.value=!1)}),setTimeout(()=>{n.expireCache(c),a.expireCache(c);const E=this.getNextFrame(o,1);E&&E.data&&Object.keys(c).forEach(z=>{E.data.getTile(z,!0)})},0)}prerender(e,t){if(!this.isReady)return;this.animationTick();const o=new h.Matrix4().fromArray(t),i=new h.Matrix4().makeTranslation(0,0,0).scale(new h.Vector3(1,-1,1));this.camera.projectionMatrix=o.multiply(i),this.updateSlippyTiles(),this.prerenderInternal()}prerenderInternal(){}render(e,t){if(!this.isReady)return;const o=this.getRendererOrThrow();o.state.reset(),this.renderInternal(),o.render(this.scene,this.camera),(this.getAnimationSpeed()>0||this.repaintOnPausedAnimation)&&this.forceRepaint()}renderInternal(){}pickFrame(e,t,o){if(!this.isReady)return null;const i=re(e,t),n=this.tilegrid.getMaxZoom(),a=Math.pow(2,n),s=(.5+i[0])%1*a,l=(1-(i[1]+.5))*a,c=this.getTilePlacement(o,!1,n,Math.floor(s),Math.floor(l));if(c==null||c.tile.texture==null)return null;const v=pe(c.tile.texture.image,c.xy[0]+c.size*(s%1),1-c.xy[1]-c.size+c.size*(l%1));return this.coloringFragments?this.coloringFragments.map(p=>p.decodeChannel(v)).flat():this.multiChannelColoringFragment?this.multiChannelColoringFragment.decodeChannel(v):null}pick(e,t){if(!this.isReady)return;const{frameA:o,frameB:i,mix:n}=this.getCurrentFrames();if(!o||!i)return null;const a=this.pickFrame(e,t,o.data),s=this.pickFrame(e,t,i.data);return a?s?this.coloringFragments?a.map((l,c)=>{const v=s[c];return Array.isArray(l)&&Array.isArray(v)?l.map((p,m)=>{const d=v[m];return p*(1-n)+d*n}):l*(1-n)+v*n}).flat():this.multiChannelColoringFragment?this.timeInterpolation?[a[0]*(1-n)+s[0]*n,n<.5?a[1]:s[1]]:[n<.5?a[0]:s[0],n<.5?a[1]:s[1]]:null:a:s}forceRepaint(){try{this.getMapOrThrow().triggerRepaint()}catch{}}computeCurrentMixedImage({zxy:e="0/0/0",blurKernel:t=0,outputSize:o=-1,channel:i="r"}){var n,a,s,l;if(!this.isReady)return;const c=this.getCurrentFrames(),v=c.mix,p=(a=(n=c.frameA)==null?void 0:n.data.getTile(e,!1))==null?void 0:a.texture,m=(l=(s=c.frameB)==null?void 0:s.data.getTile(e,!1))==null?void 0:l.texture,d=o<0?parseInt(p?.image.width):o,w=o<0?parseInt(p?.image.height):o;this.bluringNodePasses.length||this.bluringNodePasses.push(new ae(d,w),new ae(d,w),new ae(d,w));const C=this.bluringNodePasses[0],P=this.bluringNodePasses[1],x=this.bluringNodePasses[2];if(C.setSize(d,w),P.setSize(d,w),P.setSize(d,w),C.setFragmentShader(nt),C.setDefine("CHANNEL",i),C.setUniform("imageA",p),C.setUniform("imageB",m),C.setUniform("mixValue",v),C.process(),t===0){const _=C.getPixelData();return{data:_,channels:_.length/(d*w),width:d,height:w}}if(![5,9,13,19].includes(t))throw new Error(`The kernel bluring kernel size ${t} is not available.`);P.setUniform("direction",new h.Vector2(1,0)),P.setUniform("kernelSize",t),P.setUniform("imgToBlur",C.getOutputTexture()),P.setFragmentShader(Te),P.process(),x.setUniform("direction",new h.Vector2(0,1)),x.setUniform("kernelSize",t),x.setUniform("imgToBlur",P.getOutputTexture()),x.setFragmentShader(Te),x.process();const A=x.getPixelData();return{data:A,channels:A.length/(d*w),width:d,height:w}}setTimeInterpolation(e){this.isReady&&(this.material.uniforms.timeInterpolation.value=e)}setCategorySmoothTransition(e){this.isReady&&(this.material.uniforms.categorySmoothTransition.value=e,this.forceRepaint())}setLocalSmoothing(e){this.material.uniforms.localSmoothing.value=e,this.forceRepaint()}setMaxSmoothingDistance(e){this.material.uniforms.maxSmoothingDistance.value=e,this.forceRepaint()}setSmoothingDistanceDecayFactor(e){this.material.uniforms.smoothingDistanceDecayFactor.value=e,this.forceRepaint()}getRepaintOnPausedAnimation(){return this.repaintOnPausedAnimation}setRepaintOnPausedAnimation(e){this.repaintOnPausedAnimation=e,this.forceRepaint()}}var yt=`
