...
(function() {
  ...
  const mapEngine = mapboxgl || maplibregl;
  var langaugeEnabled = true;

  var setStyleMutex = false;
  var origSetStyle = mapEngine.Map.prototype.setStyle;
  mapEngine.Map.prototype.setStyle = function() {
  ...
  mapEngine.Map.prototype.setLanguageEnabled = function(enable) {
    langaugeEnabled = enable;
  };

  mapEngine.Map.prototype.setLanguage = function(language, noAlt) {
  ...
  mapEngine.Map.prototype.autodetectLanguage = function(opt_fallback) {
