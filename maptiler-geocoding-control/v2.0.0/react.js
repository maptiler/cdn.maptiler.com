...
function gn(i, e, t) {
  ...
  let { class: f = void 0 } = e, { apiKey: c } = e, { bbox: m = void 0 } = e, { clearButtonTitle: v = "clear" } = e, { clearOnBlur: h = !1 } = e, { collapsed: y = !1 } = e, { country: _ = void 0 } = e, { debounceSearch: R = 200 } = e, { enableReverse: L = "never" } = e, { errorMessage: E = "Something went wrong…" } = e, { filter: C = () => !0 } = e, { flyTo: k = !0 } = e, { fuzzyMatch: p = !0 } = e, { language: H = void 0 } = e, { limit: z = void 0 } = e, { mapController: d = void 0 } = e, { minLength: g = 2 } = e, { noResultsMessage: T = "Oops! Looks like you're trying to predict something that's not quite right. We can't seem to find what you're looking for. Maybe try double-checking your spelling or try a different search term. Keep on typing - we'll do our best to get you where you need to go!" } = e, { placeholder: Z = "Search" } = e, { proximity: he = [{ type: "server-geolocation" }] } = e, { reverseActive: q = L === "always" } = e, { reverseButtonTitle: Se = "toggle reverse geocoding" } = e, { searchValue: b = "" } = e, { pickedResultStyle: U = "full-geometry" } = e, { showPlaceType: ee = "if-needed" } = e, { showResultsWhileTyping: ue = !0 } = e, { selectFirst: ve = !0 } = e, { flyToSelected: He = !1 } = e, { markerOnSelected: We = !0 } = e, { types: ce = void 0 } = e, { exhaustiveReverseGeocoding: Pe = !1 } = e, { excludeTypes: Re = !1 } = e, { zoom: ze = r } = e, { apiUrl: je = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: Ze = {} } = e, { iconsBaseUrl: ot = "https://cdn.maptiler.com/maptiler-geocoding-control/v2.0.0/icons/" } = e, { adjustUrlQuery: Ge = () => {
  } } = e;
  function Bt() {
    X.focus();
  }
