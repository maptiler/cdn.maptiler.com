...
var Sn = (r, t, e) => (ad(r, typeof t != "symbol" ? t + "" : t, e), e), Sc = (r, t, e) => {
  if (!t.has(r))
...
function Zd(r, t, e) {
  ...
  if (i === fe.INTERSECTING || s === fe.INTERSECTING)
    ...
    let _, p;
    s & fe.ABOVE && !(i & fe.ABOVE) && (_ = f - (g - l) / d, n = _ >= o && _ <= u), !n && s & fe.RIGHT && !(i & fe.RIGHT) && (p = g - (f - u) * d, n = p >= a && p <= l), !n && s & fe.BELOW && !(i & fe.BELOW) && (_ = f - (g - a) / d, n = _ >= o && _ <= u), !n && s & fe.LEFT && !(i & fe.LEFT) && (p = g - (f - o) * d, n = p >= a && p <= l);
  }
  return n;
}
function Kd(r, t, e, n) {
...
function Bc(r, t, e) {
  return (
    ...
    function(n, i, s, o, a) {
      ...
      let f = r[0] + u / 2 + c, g = r[2] - u / 2 + c, d = r[1] + l / 2 + h, _ = r[3] - l / 2 + h;
      f > g && (f = (g + f) / 2, g = f), d > _ && (d = (_ + d) / 2, _ = d);
      let p = Oe(n[0], f, g), m = Oe(n[1], d, _);
      if (o && e && i) {
        const y = 30 * i;
...
function Op(r, t, e, n, i, s) {
  ...
  function(o, a, u, l) {
    if (o !== void 0) {
      ...
      ), p = Math.max(f, _), m = t / Math.pow(r, p);
      return Oe(m, e, c);
    }
  };
}
...
function Kl(r, t, e, n, i, s, o) {
  ...
  for (; l.length > 0; ) {
    ...
    let g = 0;
    const d = r[f], _ = r[f + 1], p = r[h], m = r[h + 1];
    for (let y = f + n; y < h; y += n) {
      const v = r[y], I = r[y + 1], C = Qd(v, I, d, _, p, m);
      C > g && (c = y, g = C);
    }
...
function zf(r, t, e, n, i, s, o) {
  ...
  for (let y = 0, v = e.length; y < v; ++y) {
    ...
    for (c = r[I - n], f = r[I - n + 1], a = t; a < I; a += n)
      h = r[a], g = r[a + 1], (d <= f && g <= d || f <= d && d <= g) && (l = (d - f) / (g - f) * (h - c) + c, _.push(l)), c = h, f = g;
  }
  let p = NaN, m = -1 / 0;
  for (_.sort(Bo), c = _[0], a = 1, u = _.length; a < u; ++a) {
    h = _[a];
    const y = Math.abs(h - c);
    y > m && (l = (c + h) / 2, Jl(r, t, e, n, l, d) && (p = l, m = y)), c = h;
  }
  return isNaN(p) && (p = i[s]), o ? (o.push(p, d, m), o) : [p, d, m];
}
...
class c_ extends Oi {
  ...
  animateInternal(t) {
    ...
    this.animations_.push(l), this.setHint(Ln.ANIMATING, 1), this.updateAnimations_();
  }
  /**
   ...
   */
  getAnimating() {
    return this.hints_[Ln.ANIMATING] > 0;
  }
  /**
   ...
   */
  getInteracting() {
    return this.hints_[Ln.INTERACTING] > 0;
  }
  /**
   ...
   */
  cancelAnimations() {
    this.setHint(Ln.ANIMATING, -this.hints_[Ln.ANIMATING]);
    let t;
  ...
  updateAnimations_() {
    ...
    for (let n = this.animations_.length - 1; n >= 0; --n) {
      ...
      if (s) {
        this.animations_[n] = null, this.setHint(Ln.ANIMATING, -1), this.nextCenter_ = null, this.nextResolution_ = NaN, this.nextRotation_ = NaN;
  ...
  fitInternal(t, e) {
    ...
    e.duration !== void 0 ? this.animateInternal(
      ...
      p
    ) : (this.targetResolution_ = u, this.targetCenter_ = _, this.applyTargetState_(!1, !0), Fa(p, !0));
  }
  /**
   ...
   */
  beginInteraction() {
    this.resolveConstraints(0), this.setHint(Ln.INTERACTING, 1);
  }
  /**
  ...
  endInteractionInternal(t, e, n) {
    this.getInteracting() && (this.setHint(Ln.INTERACTING, -1), this.resolveConstraints(t, e, n));
  }
  /**
...
function f_(r) {
  ...
  let d = r.constrainOnlyCenter, _ = r.extent;
  if (!l && !_ && f.isGlobal() && (d = !1, _ = g), r.resolutions !== void 0) {
    const p = r.resolutions;
    e = p[o], n = p[a] !== void 0 ? p[a] : p[p.length - 1], r.constrainResolution ? t = Mp(
      p,
      c,
      !d && _,
      h
...
` + c.weight + `
` + d;
      si.get(_) === void 0 && (si.set(_, 100, !0), a(c.style, c.weight, d) || (si.set(_, 0, !0), s === void 0 && (s = setInterval(u, 32))));
    }
  };
...
function X_(r, t, e, n, i, s, o, a, u, l, c, h) {
  ...
  for (d = g; d--; ) {
    const L = h(i, s, d), b = e(L);
    let w = o.get(b);
    w ? n && v.push(() => w.p(L, t)) : (w = l(b, L), w.c()), m.set(b, p[d] = w), b in _ && y.set(b, Math.abs(d - _[b]));
  }
  const I = /* @__PURE__ */ new Set(), C = /* @__PURE__ */ new Set();
  function N(L) {
    Ht(L, 1), L.m(a, c), o.set(L.key, L), c = L.first, g--;
  }
  for (; f && g; ) {
    const L = p[g - 1], b = r[f - 1], w = L.key, M = b.key;
    L === b ? (c = L.first, f--, g--) : m.has(M) ? !o.has(w) || I.has(w) ? N(L) : C.has(M) ? f-- : y.get(w) > y.get(M) ? (C.add(w), N(L)) : (I.add(M), f--) : (u(b, o), f--);
  }
  for (; f--; ) {
    const L = r[f];
    m.has(L.key) || u(L, o);
...
function _s(r, t, e, n, i, s, o = null, a = [-1]) {
  ...
  if (l.ctx = e ? e(r, t.props || {}, (h, f, ...g) => {
    ...
    if (t.hydrate) {
      const h = O_(t.target);
      l.fragment && l.fragment.l(h), h.forEach(Ut);
    } else
      l.fragment && l.fragment.c();
    t.intro && Ht(r.$$.fragment), Ur(r, t.target, t.anchor), Qf();
  }
  Fo(u);
}
class ms {
...
function tm(r) {
  ...
  let t, e, n, i, s, o, a, u, l = (
    ...
    r[2] && !/*feature*/
    r[0].address && /*feature*/
    ((L = r[0].properties) == null ? void 0 : L.kind) !== "road" && /*feature*/
    ((b = r[0].properties) == null ? void 0 : b.kind) !== "road_relation" && !/*feature*/
  ...
  function v(w, M) {
    ...
    w[5] ? $_ : (
      ...
      w[0].address ? Q_ : (
        ...
        ((F = w[0].properties) == null ? void 0 : F.kind) === "road_relation" ? J_ : (e == null && (e = !!/*feature*/
        w[0].id.startsWith("address.")), e ? K_ : (n == null && (n = !!/*feature*/
        w[0].id.startsWith("postal_code.")), n ? Z_ : (i == null && (i = !!/*feature*/
        w[0].id.startsWith("poi.")), i ? j_ : H_)))
      )
    );
  }
  let I = v(r, -1), C = I(r), N = f && nh(r);
  return {
    c() {
      t = Ct("li"), C.c(), s = cn(), o = Ct("span"), a = Ct("span"), u = Ct("span"), c = xi(l), h = cn(), N && N.c(), g = cn(), d = Ct("span"), p = xi(_), D(u, "class", "primary svelte-ltkwvy"), D(a, "class", "svelte-ltkwvy"), D(d, "class", "line2 svelte-ltkwvy"), D(o, "class", "texts svelte-ltkwvy"), D(t, "tabindex", "0"), D(
        t,
        "data-selected",
        /*selected*/
        r[1]
      ), D(t, "class", "svelte-ltkwvy"), gi(
        t,
        "selected",
        /*selected*/
        r[1]
    ...
    m(w, M) {
      qt(w, t, M), C.m(t, null), ct(t, s), ct(t, o), ct(o, a), ct(a, u), ct(u, c), ct(a, h), N && N.m(a, null), ct(o, g), ct(o, d), ct(d, p), m || (y = [
        ze(
          t,
          "mouseenter",
          /*mouseenter_handler*/
    ...
    p(w, [M]) {
      var z, F;
      I === (I = v(w, M)) && C ? C.p(w, M) : (C.d(1), C = I(w), C && (C.c(), C.m(t, s))), M & /*feature*/
      1 && l !== (l = /*feature*/
      ...
      w[5])), f ? N ? N.p(w, M) : (N = nh(w), N.c(), N.m(a, null)) : N && (N.d(1), N = null), M & /*feature*/
      1 && _ !== (_ = /*feature*/
      w[0].place_name.replace(/[^,]*,?\s*/, "") + "") && Zo(p, _), M & /*selected*/
      2 && D(
        t,
        "data-selected",
        /*selected*/
...
function em(r, t, e) {
  ...
  return r.$$set = (v) => {
    ...
    1848)
      ...
      while (n > -1 && (!f || u.has(f)));
    r.$$.dirty & /*feature*/
    1 && e(6, i = s.id.startsWith("poi.") ? (I = (v = s.properties) == null ? void 0 : v.categories) == null ? void 0 : I.join(", ") : ((N = (C = s.properties) == null ? void 0 : C.place_type_name) == null ? void 0 : N[0]) ?? s.place_type[0]);
...
function oh(r) {
  ...
  return e = new om({}), {
    c() {
      t = Ct("button"), Ci(e.$$.fragment), D(t, "type", "button"), D(
        t,
        "title",
        /*reverseButtonTitle*/
        r[9]
      ), D(t, "class", "svelte-1r7dvt7"), gi(
        t,
        "active",
        /*reverseActive*/
        r[0]
    ...
    m(o, a) {
      qt(o, t, a), Ur(e, t, null), n = !0, i || (s = ze(
        t,
        "click",
        /*click_handler_2*/
        r[63]
...
function fm(r) {
  ...
  return e = new tg({}), {
    c() {
      t = Ct("div"), Ci(e.$$.fragment), n = cn(), i = Ct("div"), s = xi(
        /*noResultsMessage*/
        r[7]
      ), D(i, "class", "svelte-1r7dvt7"), D(t, "class", "no-results svelte-1r7dvt7");
    },
    m(a, u) {
      qt(a, t, u), Ur(e, t, null), ct(t, n), ct(t, i), ct(i, s), o = !0;
    },
    p(a, u) {
  ...
  return e = new tg({}), u = new $f({}), {
    c() {
      t = Ct("div"), Ci(e.$$.fragment), n = cn(), i = Ct("div"), s = xi(
        /*errorMessage*/
        r[6]
      ), o = cn(), a = Ct("button"), Ci(u.$$.fragment), D(i, "class", "svelte-1r7dvt7"), D(a, "class", "svelte-1r7dvt7"), D(t, "class", "error svelte-1r7dvt7");
    },
    m(f, g) {
      qt(f, t, g), Ur(e, t, null), ct(t, n), ct(t, i), ct(i, s), ct(t, o), ct(t, a), Ur(u, a, null), l = !0, c || (h = ze(
        a,
        "click",
        /*click_handler_3*/
        r[64]
    ...
    o(f) {
      ge(e.$$.fragment, f), ge(u.$$.fragment, f), l = !1;
    },
    d(f) {
      f && Ut(t), Wr(e), Wr(u), c = !1, h();
    }
  };
}
function ah(r, t) {
...
function pm(r) {
  let t, e, n, i, s, o, a, u, l, c, h, f, g, d, _, p, m, y, v, I, C, N = !1;
  s = new um({}), h = new $f({});
  let L = (
    /*abortController*/
    r[18] && sh()
  ...
  return ~(p = U(r)) && (m = F[p] = z[p](r)), {
    c() {
      t = cn(), e = Ct("form"), n = Ct("div"), i = Ct("button"), Ci(s.$$.fragment), o = cn(), a = Ct("input"), u = cn(), l = Ct("div"), c = Ct("button"), Ci(h.$$.fragment), f = cn(), L && L.c(), g = cn(), b && b.c(), d = cn(), M && M.c(), _ = cn(), m && m.c(), D(i, "class", "search-button svelte-1r7dvt7"), D(i, "type", "button"), D(
        a,
        "placeholder",
        /*placeholder*/
        r[8]
        ...
        /*clearButtonTitle*/
        r[3]
      ), D(c, "class", "svelte-1r7dvt7"), D(l, "class", "clear-button-container svelte-1r7dvt7"), gi(
        l,
        "displayable",
        /*searchValue*/
        r[1] !== ""
      ), D(n, "class", "input-group svelte-1r7dvt7"), D(e, "tabindex", "0"), D(e, "class", y = Jc(
        /*className*/
        r[2]
      ) + " svelte-1r7dvt7"), gi(
        e,
    ...
    m(R, T) {
      qt(R, t, T), qt(R, e, T), ct(e, n), ct(n, i), Ur(s, i, null), ct(n, o), ct(n, a), r[57](a), Qc(
        a,
        /*searchValue*/
        r[1]
      ), ct(n, u), ct(n, l), ct(l, c), Ur(h, c, null), ct(l, f), L && L.m(l, null), ct(n, g), b && b.m(n, null), ct(n, d), M && M.m(n, null), ct(e, _), ~p && F[p].m(e, null), v = !0, I || (C = [
        ze(
          i,
          "click",
          /*click_handler*/
    ...
    p(R, T) {
      ...
      R[18] ? L ? T[0] & /*abortController*/
      262144 && Ht(L, 1) : (L = sh(), L.c(), Ht(L, 1), L.m(l, null)) : L && (Ha(), ge(L, 1, 1, () => {
        L = null;
      }), ja()), (!v || T[0] & /*searchValue*/
      2) && gi(
        l,
        "displayable",
        /*searchValue*/
      ...
      R[5] === !0 ? b ? (b.p(R, T), T[0] & /*enableReverse*/
      32 && Ht(b, 1)) : (b = oh(R), b.c(), Ht(b, 1), b.m(n, d)) : b && (Ha(), ge(b, 1, 1, () => {
        b = null;
      }), ja()), M && M.p && (!v || T[1] & /*$$scope*/
      8388608) && b_(
        M,
        w,
        R,
      ...
      let B = p;
      p = U(R), p === B ? ~p && F[p].p(R, T) : (m && (Ha(), ge(F[B], 1, 1, () => {
        F[B] = null;
      }), ja()), ~p ? (m = F[p], m ? m.p(R, T) : (m = F[p] = z[p](R), m.c()), Ht(m, 1), m.m(e, null)) : m = null), (!v || T[0] & /*className*/
      4 && y !== (y = Jc(
        /*className*/
        R[2]
      ) + " svelte-1r7dvt7")) && D(e, "class", y), (!v || T[0] & /*className, collapsed, searchValue*/
      22) && gi(
        e,
        "can-collapse",
        /*collapsed*/
    ...
    i(R) {
      v || (Ht(N), Ht(s.$$.fragment, R), Ht(h.$$.fragment, R), Ht(L), Ht(b), Ht(M, R), Ht(m), v = !0);
    },
    o(R) {
      ge(N), ge(s.$$.fragment, R), ge(h.$$.fragment, R), ge(L), ge(b), ge(M, R), ge(m), v = !1;
    },
    d(R) {
      R && (Ut(t), Ut(e)), Wr(s), r[57](null), Wr(h), L && L.d(), b && b.d(), M && M.d(R), ~p && F[p].d(), I = !1, ei(C);
    }
  };
}
function _m(r, t, e) {
  ...
  function Me(P, lt = !0) {
    e(1, F = P), lt ? (e(14, xt = -1), Eo()) : (Co(), setTimeout(() => {
      un.focus(), un.select();
    }));
  }
  function zu() {
  ...
  function Eo(P) {
    if (ni && (clearTimeout(ni), ni = void 0), xt > -1 && ft)
      e(51, at = ft[xt]), e(1, F = at.place_name.replace(/,.*/, "")), e(17, Ke = void 0), e(50, se = void 0), e(14, xt = -1);
    else if (F) {
      const lt = P || !ri();
      Gi(F, { exact: !0 }).then(() => {
  ...
  async function Gi(P, { byId: lt = !1, exact: we = !1 } = {}) {
    e(17, Ke = void 0), Or == null || Or.abort();
    const Gt = new AbortController();
    e(18, Or = Gt);
    try {
      const Lt = ri(), bt = new URLSearchParams();
      if (v !== void 0 && bt.set("language", Array.isArray(v) ? v.join(",") : v ?? ""), B && bt.set("types", B.join(",")), u && bt.set("bbox", u.map((Re) => Re.toFixed(6)).join(",")), f && bt.set("country", Array.isArray(f) ? f.join(",") : f), !lt && !Lt) {
        const Re = await cm(C, w, Gt);
        Re && bt.set("proximity", Re), (we || !T) && bt.set("autocomplete", "false"), bt.set("fuzzyMatch", String(y));
      }
      I !== void 0 && (!Lt || (B == null ? void 0 : B.length) === 1) && bt.set("limit", String(I)), bt.set("key", a), k(bt);
      const Ar = ot + "/" + encodeURIComponent(P) + ".json?" + bt.toString();
      if (Ar === Ra) {
      ...
      ln("response", { url: Ar, featureCollection: he }), lt ? (e(13, ft = void 0), e(51, at = he.features[0]), Is = [at]) : (e(13, ft = he.features.filter(p)), Is = ft, Lt && un.focus());
    } catch (Lt) {
  ...
  function xo() {
    ...
    if (!(se != null && se.length) || !m)
      return;
    const P = [180, 90, -180, -90], lt = !se.some((Gt) => !Gt.matching_text);
    for (const Gt of se)
      if (lt || !Gt.matching_text)
        for (const Lt of [0, 1, 2, 3])
          P[Lt] = Math[Lt < 2 ? "min" : "max"](P[Lt], ((we = Gt.bbox) == null ? void 0 : we[Lt]) ?? Gt.center[Lt % 2]);
    C && se.length > 0 && (at && P[0] === P[2] && P[1] === P[3] ? C.flyTo(at.center, V) : C.fitBounds(rh(P), 50, j));
  }
  function Ss(P) {
    e(0, M = d === "always"), Me(lm(P[0], [-180, 180], !0).toFixed(6) + "," + P[1].toFixed(6));
  }
  function ws(P) {
    if (!ft)
      return;
    let lt = P.key === "ArrowDown" ? 1 : P.key === "ArrowUp" ? -1 : 0;
    lt ? (xt === -1 && lt === -1 && e(14, xt = ft.length), e(14, xt += lt), xt >= ft.length && e(14, xt = -1), P.preventDefault()) : ["ArrowLeft", "ArrowRight", "Home", "End"].includes(P.key) && e(14, xt = -1);
  }
  function Co(P = !0) {
    if (e(17, Ke = void 0), T) {
      if (ni && clearTimeout(ni), F.length < N)
        return;
      const lt = F;
      ni = window.setTimeout(
        () => {
          Gi(lt).catch((we) => e(17, Ke = we));
        },
        P ? g : 0
      );
    } else
  ...
  function Rs(P) {
    e(51, at = P), e(1, F = P.place_name), e(14, xt = -1);
  }
  const Na = () => un.focus();
  function Io(P) {
    pl[P ? "unshift" : "push"](() => {
  ...
  function Yu() {
    F = this.value, e(1, F), e(12, Mr), e(26, c);
  }
  const Uu = () => e(12, Mr = !0), La = () => e(12, Mr = !1), ba = () => Co(), So = () => {
    e(1, F = ""), un.focus();
  }, Pa = () => e(0, M = !M), wo = () => e(17, Ke = void 0), Bi = (P) => e(14, xt = P), zi = (P) => Rs(P), Vi = () => e(14, xt = -1), Ta = () => {
  };
  return r.$$set = (P) => {
    "class" in P && e(2, o = P.class), "apiKey" in P && e(24, a = P.apiKey), "bbox" in P && e(25, u = P.bbox), "clearButtonTitle" in P && e(3, l = P.clearButtonTitle), "clearOnBlur" in P && e(26, c = P.clearOnBlur), "collapsed" in P && e(4, h = P.collapsed), "country" in P && e(27, f = P.country), "debounceSearch" in P && e(28, g = P.debounceSearch), "enableReverse" in P && e(5, d = P.enableReverse), "errorMessage" in P && e(6, _ = P.errorMessage), "filter" in P && e(29, p = P.filter), "flyTo" in P && e(30, m = P.flyTo), "fuzzyMatch" in P && e(31, y = P.fuzzyMatch), "language" in P && e(32, v = P.language), "limit" in P && e(33, I = P.limit), "mapController" in P && e(34, C = P.mapController), "minLength" in P && e(35, N = P.minLength), "noResultsMessage" in P && e(7, L = P.noResultsMessage), "placeholder" in P && e(8, b = P.placeholder), "proximity" in P && e(36, w = P.proximity), "reverseActive" in P && e(0, M = P.reverseActive), "reverseButtonTitle" in P && e(9, z = P.reverseButtonTitle), "searchValue" in P && e(1, F = P.searchValue), "showFullGeometry" in P && e(37, U = P.showFullGeometry), "showPlaceType" in P && e(10, R = P.showPlaceType), "showResultsWhileTyping" in P && e(38, T = P.showResultsWhileTyping), "types" in P && e(39, B = P.types), "zoom" in P && e(40, V = P.zoom), "maxZoom" in P && e(41, j = P.maxZoom), "apiUrl" in P && e(42, ot = P.apiUrl), "fetchParameters" in P && e(43, yt = P.fetchParameters), "iconsBaseUrl" in P && e(11, kt = P.iconsBaseUrl), "adjustUrlQuery" in P && e(44, k = P.adjustUrlQuery), "$$scope" in P && e(54, s = P.$$scope);
  }, r.$$.update = () => {
    if (r.$$.dirty[0] & /*focused, clearOnBlur*/
    67112960 && setTimeout(() => {
      e(15, Fi = Mr), c && !Mr && e(1, F = "");
    }), r.$$.dirty[0] & /*searchValue, listFeatures*/
    8194 | r.$$.dirty[1] & /*minLength*/
    16 && F.length < N && (e(51, at = void 0), e(13, ft = void 0), e(17, Ke = void 0), e(50, se = ft)), r.$$.dirty[1] & /*showFullGeometry, picked*/
    1048640 && U && at && !at.address && at.geometry.type === "Point" && Gi(at.id, { byId: !0 }).catch((P) => e(17, Ke = P)), r.$$.dirty[0] & /*flyTo*/
    1073741824 | r.$$.dirty[1] & /*mapController, picked, prevIdToFly, maxZoom, zoom*/
    3147272 && (C && at && at.id !== ki && m && (!at.bbox || at.bbox[0] === at.bbox[2] && at.bbox[1] === at.bbox[3] ? C.flyTo(at.center, at.id.startsWith("poi.") || at.id.startsWith("address.") ? j : V) : C.fitBounds(rh(at.bbox), 50, j), e(13, ft = void 0), e(50, se = void 0), e(14, xt = -1)), e(52, ki = at == null ? void 0 : at.id)), r.$$.dirty[0] & /*listFeatures*/
    8192 | r.$$.dirty[1] & /*markedFeatures*/
    524288 && se !== ft && e(50, se = void 0), r.$$.dirty[1] & /*mapController, markedFeatures, picked*/
    1572872 && C && C.setMarkers(se, at), r.$$.dirty[0] & /*searchValue*/
    2 && e(14, xt = -1), r.$$.dirty[0] & /*reverseActive, listFeatures, focusedDelayed*/
    40961 | r.$$.dirty[1] & /*mapController*/
    8 && C && C.setEventHandler((P) => {
      switch (P.type) {
        case "mapClick":
          M && Ss(P.coordinates);
          break;
        case "markerClick":
          {
            const lt = ft == null ? void 0 : ft.find((we) => we.id === P.id);
            lt && Rs(lt);
          }
          break;
        case "markerMouseEnter":
          e(14, xt = Fi ? (ft == null ? void 0 : ft.findIndex((lt) => lt.id === P.id)) ?? -1 : -1);
          break;
    ...
    8 && (C == null || C.setSelectedMarker(xt)), r.$$.dirty[0] & /*listFeatures, selectedItemIndex*/
    24576 && e(53, n = ft == null ? void 0 : ft[xt]), r.$$.dirty[0] & /*searchValue*/
    2 | r.$$.dirty[1] & /*mapController*/
    8) {
      const P = /^(-?\d+(?:\.\d*)?),(-?\d+(?:\.\d*)?)$/.exec(F);
      C == null || C.setReverseMarker(P ? [Number(P[1]), Number(P[2])] : void 0);
    }
    r.$$.dirty[1] & /*selected*/
    ...
    1 && ln("reverseToggle", M), r.$$.dirty[0] & /*searchValue*/
    2 && ln("queryChange", F), r.$$.dirty[0] & /*reverseActive*/
    1 | r.$$.dirty[1] & /*mapController*/
    8 && C && C.indicateReverse(M);
  }, [
    M,
    F,
    o,
...
class nc extends rg {
  ...
  calculateLineJoinSize_(t, e, n) {
    ...
    if (t === "miter" && f <= n)
      return f * e;
    const g = e / 2 / f, d = e / 2 * (c / h), p = Math.sqrt((i + g) * (i + g) + d * d) - i;
    if (this.radius2_ === void 0 || t === "bevel")
      return p * 2;
    const m = i * Math.sin(a), y = Math.sqrt(i * i - m * m), v = s - y, C = Math.sqrt(m * m + v * v) / m;
    if (C <= n) {
      const N = C * e / 2 - s - i;
      return 2 * Math.max(p, N);
    }
    return p * 2;
  }
  /**
...
class Mm extends ff {
   ...
   */
  isTainted_() {
    if (this.tainted_ === void 0 && this.imageState_ === jt.LOADED) {
      Lo || (Lo = ir(1, 1, void 0, {
   ...
   */
  handleImageError_() {
    this.imageState_ = jt.ERROR, this.unlistenImage_(), this.dispatchChangeEvent_();
  }
  /**
   * @private
   */
  handleImageLoad_() {
    this.imageState_ = jt.LOADED, this.size_ ? (this.image_.width = this.size_[0], this.image_.height = this.size_[1]) : this.size_ = [this.image_.width, this.image_.height], this.unlistenImage_(), this.dispatchChangeEvent_();
  }
  /**
   * @param {number} pixelRatio Pixel ratio.
   ...
   */
  load() {
    if (this.imageState_ === jt.IDLE) {
      this.image_ || this.initializeImage_(), this.imageState_ = jt.LOADING;
      try {
   ...
   */
  replaceColor_(t) {
    if (!this.color_ || this.canvas_[t] || this.imageState_ !== jt.LOADED)
      return;
...
class sc extends rg {
  ...
  constructor(t) {
    ...
    o.src || de(o)), oe(a !== void 0 && a.length > 0, 6), oe(
      !((t.width !== void 0 || t.height !== void 0) && t.scale !== void 0),
      69
    );
    const u = t.src !== void 0 ? jt.IDLE : jt.LOADED;
  ...
  getWidth() {
    ...
    if (this.iconImage_.getImageState() == jt.LOADED)
...
class Bm extends lg {
  ...
  appendFlatLineCoordinates(t, e, n, i, s, o) {
    ...
    let g = !0, d, _, p;
    for (d = e + i; d < n; d += i)
      f[0] = t[d], f[1] = t[d + 1], p = sl(l, f), p !== _ ? (g && (a[u++] = c, a[u++] = h, g = !1), a[u++] = f[0], a[u++] = f[1]) : p === fe.INTERSECTING ? (a[u++] = f[0], a[u++] = f[1], g = !1) : g = !0, c = f[0], h = f[1], _ = p;
...
function Wm(r, t, e, n, i) {
  ...
  for (; a < r && o + i < n; ) {
    ...
    if (a += g, a >= r) {
      const d = (r - a + g) / g, _ = hn(l, h, d), p = hn(c, f, d);
      u.push(_, p), s.push(u), u = [_, p], a == r && (o += i), a = 0;
    } else if (a < r)
      u.push(
        t[o + i],
        t[o + i + 1]
      ...
      const d = g - a, _ = hn(l, h, d / g), p = hn(c, f, d / g);
      u.push(_, p), s.push(u), u = [_, p], a = 0, o += i;
    }
  }
...
function qm(r, t, e, n, i) {
  ...
  for (h = e; h < n; h += i) {
    const I = t[h], C = t[h + 1];
    d !== void 0 && (y = I - d, v = C - _, g = Math.sqrt(y * y + v * v), p !== void 0 && (u += f, c = Math.acos((p * y + m * v) / (f * g)), c > r && (u > a && (a = u, s = l, o = h), u = 0, l = h - i)), f = g, p = y, m = v), d = I, _ = C;
  }
  ...
  setTextStyle(t, e) {
    ...
    if (!t)
      ...
      if (!a)
        ...
        s.lineCap = a.getLineCap() || ru, s.lineDash = d ? d.slice() : Yo, s.lineDashOffset = _ === void 0 ? Uo : _, s.lineJoin = a.getLineJoin() || Ws, s.lineWidth = p === void 0 ? jo : p, s.miterLimit = m === void 0 ? Wo : m, s.strokeStyle = xr(
          a.getColor() || qo
        );
      }
      n = this.textState_;
...
class Km extends gf {
  ...
  handleImageChange_(t) {
    ...
    t.target.getState() === jt.LOADED && this.renderIfReadyAndVisible();
  }
  /**
  ...
  loadImage(t) {
    let e = t.getState();
    return e != jt.LOADED && e != jt.ERROR && t.addEventListener(An.CHANGE, this.boundHandleImageChange_), e == jt.IDLE && (t.load(), e = t.getState()), e == jt.LOADED;
  }
  /**
   * @protected
   */
...
function ey(r, t, e, n, i, s, o, a, u, l, c, h) {
  let f = r[t], g = r[t + 1], d = 0, _ = 0, p = 0, m = 0;
  function y() {
    d = f, _ = g, t += n, f = r[t], g = r[t + 1], m += p, p = Math.sqrt((f - d) * (f - d) + (g - _) * (g - _));
  }
  do
    y();
  while (t < e - n && m + p < s);
  let v = p === 0 ? 0 : (s - m) / p;
  const I = hn(d, f, v), C = hn(_, g, v), N = t - n, L = m, b = s + a * u(l, i, c);
  for (; t < e - n && m + p < b; )
    y();
  v = p === 0 ? 0 : (b - m) / p;
  const w = hn(d, f, v), M = hn(_, g, v);
  let z;
  if (h) {
    const B = [I, C, w, M];
    Af(B, 0, 4, 2, h, B, B), z = B[0] > B[2];
  } else
    z = I > w;
  const F = Math.PI, U = [], R = N + n === t;
  t = N, p = 0, m = L, f = r[t], g = r[t + 1];
  let T;
  if (R) {
    y(), T = Math.atan2(g - _, f - d), z && (T += T > 0 ? -F : F);
    const B = (w + I) / 2, V = (M + C) / 2;
    return U[0] = [B, V, (b - s) / 2, T, i], U;
  }
  i = i.replace(/\n/g, " ");
  for (let B = 0, V = i.length; B < V; ) {
    y();
    let j = Math.atan2(g - _, f - d);
    if (z && (j += j > 0 ? -F : F), T !== void 0) {
      let Se = j - T;
      if (Se += Se > F ? -2 * F : Se < -F ? 2 * F : 0, Math.abs(Se) > o)
        return null;
    }
    T = j;
    const ot = B;
    let yt = 0;
    for (; B < V; ++B) {
      const Se = z ? V - B - 1 : B, Me = a * u(l, i[Se], c);
      if (t + n < e && m + p < s + yt + Me / 2)
        break;
      yt += Me;
    }
    if (B === ot)
      continue;
    const kt = z ? i.substring(V - ot, V - B) : i.substring(ot, B);
    v = p === 0 ? 0 : (s + yt / 2 - m) / p;
    const k = hn(d, f, v), Ze = hn(_, g, v);
    U.push([k, Ze, yt / 2, j, kt]), s += yt;
  }
  return U;
}
...
`).reduce(ry, []), { width: _, height: p, widths: m, heights: y, lineWidths: v } = C_(
      u,
      d
    ), I = _ + g, C = [], N = (I + 2) * c[0], L = (p + g) * c[1], b = {
      width: N < 0 ? Math.floor(N) : Math.ceil(N),
      height: L < 0 ? Math.floor(L) : Math.ceil(L),
      contextInstructions: C
    };
    (c[0] != 1 || c[1] != 1) && C.push("scale", c), i && (C.push("strokeStyle", o.strokeStyle), C.push("lineWidth", g), C.push("lineCap", o.lineCap), C.push("lineJoin", o.lineJoin), C.push("miterLimit", o.miterLimit), C.push("setLineDash", [o.lineDash]), C.push("lineDashOffset", o.lineDashOffset)), n && C.push("fillStyle", a.fillStyle), C.push("textBaseline", "middle"), C.push("textAlign", "center");
    const w = 0.5 - f;
    let M = f * I + w * g;
    const z = [], F = [];
    let U = 0, R = 0, T = 0, B = 0, V;
...
`) {
      ...
      kt !== V && (i && z.push("font", kt), n && F.push("font", kt), V = kt), U = Math.max(U, y[T]);
      const k = [
        yt,
        M + w * m[T] + f * (m[T] - v[B]),
        0.5 * (g + U) + R
      ];
      M += m[T], i && z.push("strokeText", k), n && F.push("fillText", k), ++T;
    }
    return Array.prototype.push.apply(C, z), Array.prototype.push.apply(C, F), this.labels_[s] = b, b;
  }
  /**
   * @param {CanvasRenderingContext2D} context Context.
   ...
   */
  calculateImageOrLabelDimensions_(t, e, n, i, s, o, a, u, l, c, h, f, g, d, _, p) {
    a *= f[0], u *= f[1];
    let m = n - a, y = i - u;
    const v = s + l > t ? t - l : s, I = o + c > e ? e - c : o, C = d[3] + v * f[0] + d[1], N = d[0] + I * f[1] + d[2], L = m - d[3], b = y - d[0];
    (_ || h !== 0) && (oi[0] = L, ai[0] = L, oi[1] = b, kr[1] = b, kr[0] = L + C, Gr[0] = kr[0], Gr[1] = b + N, ai[1] = Gr[1]);
    let w;
    return h !== 0 ? (w = _a(
      _i(),
      n,
      ...
      -n,
      -i
    ), Je(w, oi), Je(w, kr), Je(w, Gr), Je(w, ai), $i(
  ...
  execute_(t, e, n, i, s, o, a, u) {
    ...
    let c = 0;
    const h = i.length;
    let f = 0, g, d, _, p, m, y, v, I, C, N, L, b, w = 0, M = 0, z = null, F = null;
    const U = this.coordinateCache_, R = this.viewRotation_, T = Math.round(Math.atan2(-n[1], n[0]) * 1e12) / 1e12, B = (
    ...
    for (; c < h; ) {
      ...
      switch (
        ...
        case K.BEGIN_GEOMETRY:
          ...
          break;
        case K.BEGIN_PATH:
          w > V && (this.fill_(t), w = 0), M > V && (t.stroke(), M = 0), !w && !M && (t.beginPath(), p = NaN, m = NaN), ++c;
          break;
        case K.CIRCLE:
          f = /** @type {number} */
          k[1];
          const Se = l[f], Me = l[f + 1], zu = l[f + 2], Vu = l[f + 3], Mr = zu - Se, ft = Vu - Me, se = Math.sqrt(Mr * Mr + ft * ft);
          t.moveTo(Se + se, Me), t.arc(Se, Me, se, 0, 2 * Math.PI, !0), ++c;
          break;
        case K.CLOSE_PATH:
          t.closePath(), ++c;
          break;
        case K.CUSTOM:
          ...
          B.geometry = at, B.feature = j, c in U || (U[c] = []);
          const xt = U[c];
          un ? un(l, f, g, 2, xt) : (xt[0] = l[f], xt[1] = l[f + 1], xt.length = 2), Ra(xt, B), ++c;
          break;
        case K.DRAW_IMAGE:
          f = /** @type {number} */
          k[1], g = /** @type {number} */
          ...
          if (!I && k.length >= 20) {
            ...
            d = (lt.anchorX - we) * this.pixelRatio, k[4] = d;
            const Gt = (
              /** @type {number} */
              k[24]
            );
            _ = (lt.anchorY - Gt) * this.pixelRatio, k[5] = _, Ke = I.height, k[6] = Ke, ln = I.width, k[13] = ln;
          }
          let Gi;
          ...
          k[18]) : (xo = qi, Ss = !1, ws = !1), Fi && T ? ki += R : !Fi && !T && (ki -= R);
          let Co = 0;
          for (; f < g; f += 2) {
            ...
            this.replayImageOrLabel_.apply(this, we);
          }
          ++c;
          break;
        case K.DRAW_CHARS:
          ...
          const Pa = [
            ...
            /** @type {number} */
            k[13]
          ], wo = this.textStates[N], Bi = wo.font, zi = [
            wo.scale[0] * La,
            wo.scale[1] * La
          ];
          let Vi;
          Bi in this.widths_ ? Vi = this.widths_[Bi] : (Vi = {}, this.widths_[Bi] = Vi);
          const Ta = ng(l, Rs, Na, 2), P = Math.abs(zi[0]) * Zc(Bi, C, Vi);
          if (Yu || P <= Ta) {
            const lt = this.textStates[N].textAlign, we = (Ta - P) * ko[lt], Gt = ey(
              l,
              Rs,
              Na,
              2,
              ...
              if (Gt) {
                ...
                if (L)
                  for (bt = 0, Ar = Gt.length; bt < Ar; ++bt) {
                    Re = Gt[bt], Xi = /** @type {string} */
                    Re[4], he = this.createLabel(Xi, N, "", L), d = /** @type {number} */
                    Re[2] + (zi[0] < 0 ? -So : So), _ = Io * he.height + (0.5 - Io) * 2 * So * zi[1] / zi[0] - ba;
                ...
                if (b)
                  for (bt = 0, Ar = Gt.length; bt < Ar; ++bt) {
                    Re = Gt[bt], Xi = /** @type {string} */
                    Re[4], he = this.createLabel(Xi, N, b, ""), d = /** @type {number} */
                    Re[2], _ = Io * he.height - ba;
                    const Dr = this.calculateImageOrLabelDimensions_(
                      he.width,
                      he.height,
                      Re[0],
        ...
        case K.MOVE_TO_LINE_TO:
          for (f = /** @type {number} */
          k[1], g = /** @type {number} */
          k[2], ot = l[f], yt = l[f + 1], y = ot + 0.5 | 0, v = yt + 0.5 | 0, (y !== p || v !== m) && (t.moveTo(ot, yt), p = y, m = v), f += 2; f < g; f += 2)
            ot = l[f], yt = l[f + 1], y = ot + 0.5 | 0, v = yt + 0.5 | 0, (f == g - 2 || y !== p || v !== m) && (t.lineTo(ot, yt), p = y, m = v);
          ++c;
          break;
        case K.SET_FILL_STYLE:
          z = k, this.alignFill_ = k[2], w && (this.fill_(t), w = 0, M && (t.stroke(), M = 0)), t.fillStyle = /** @type {import("../../colorlike.js").ColorLike} */
          k[1], ++c;
          break;
        case K.SET_STROKE_STYLE:
          F = k, M && (t.stroke(), M = 0), this.setStrokeStyle_(
            t,
            /** @type {Array<*>} */
            k
          ), ++c;
  ...
  forEachFeatureAtCoordinate(t, e, n, i, s, o) {
    ...
    function d(C, N) {
      ...
      for (let b = 0, w = f.length; b < w; b++)
        if (L[f[b]] > 0) {
          if (!o || g !== "Image" && g !== "Text" || o.includes(C)) {
            const M = (f[b] - 3) / 4, z = i - M % a, F = i - (M / a | 0), U = s(C, N, z * z + F * F);
            if (U)
              return U;
          }
          c.clearRect(0, 0, a, a);
    ...
    for (p = _.length - 1; p >= 0; --p) {
      const C = _[p].toString();
      for (y = this.executorsByZIndex_[C], m = Qu.length - 1; m >= 0; --m)
...
function cy(r, t, e, n, i, s, o) {
  ...
  for (let p = 1; p <= f; ++p) {
    ...
    if (!v)
      continue;
    Array.isArray(v) || (v = [v]);
    const C = (p * g).toString(16).padStart(7, "#00000");
    for (let N = 0, L = v.length; N < L; ++N) {
      const b = v[N], w = b.getGeometryFunction()(m);
      if (!w || !Qn(i, w.getExtent()))
        continue;
      const M = b.clone(), z = M.getFill();
      z && z.setColor(C);
      const F = M.getStroke();
      F && (F.setColor(C), F.setLineDash(null)), M.setText(void 0);
      const U = b.getImage();
      if (U && U.getOpacity() !== 0) {
        ...
        j.fillStyle = C, j.fillRect(0, 0, ot.width, ot.height), M.setImage(
          new oc({
            img: ot,
            imgSize: V,
            anchor: U.getAnchor(),
      ...
      let T = d[R];
      T || (T = {}, d[R] = T, T.Polygon = [], T.Circle = [], T.LineString = [], T.Point = []);
      const B = w.getType();
      if (B === "GeometryCollection") {
        ...
        for (let j = 0, ot = V.length; j < ot; ++j) {
          const yt = V[j];
          T[yt.getType().replace("Multi", "")].push(
            yt,
            M
          );
        }
      } else
        T[B.replace("Multi", "")].push(w, M);
    }
  }
  ...
  for (let p = 0, m = _.length; p < m; ++p) {
    ...
    for (const v in y) {
      const I = y[v];
      for (let C = 0, N = I.length; C < N; C += 2) {
        h.setStyle(I[C + 1]);
        for (let L = 0, b = t.length; L < b; ++L)
          h.setTransform(t[L]), h.drawGeometry(I[C]);
      }
    }
  }
...
function gy(r, t) {
  return parseInt(de(r), 10) - parseInt(de(t), 10);
}
function dy(r, t) {
  const e = El(r, t);
  return e * e;
...
function Eh(r, t, e, n, i, s, o) {
  ...
  if (u) {
    ...
    l == jt.LOADED || l == jt.ERROR ? u.unlistenImageChange(i) : (l == jt.IDLE && u.load(), u.listenImageChange(i), a = !0);
  }
  return _y(
    r,
    t,
...
class Sy extends ty {
   ...
   */
  renderWorlds(t, e, n) {
    const i = e.extent, s = e.viewState, o = s.center, a = s.resolution, u = s.projection, l = s.rotation, c = u.getExtent(), h = this.getLayer().getSource(), f = e.pixelRatio, g = e.viewHints, d = !(g[Ln.ANIMATING] || g[Ln.INTERACTING]), _ = this.compositionContext_, p = Math.round(e.size[0] * f), m = Math.round(e.size[1] * f), y = h.getWrapX() && u.canWrapX(), v = y ? Tn(c) : null, I = y ? Math.ceil((i[2] - c[2]) / v) + 1 : 1;
    let C = y ? Math.floor((i[0] - c[0]) / v) : 0;
    do {
      const N = this.getRenderTransform(
        o,
        a,
        l,
        f,
  ...
  renderFrame(t, e) {
    ...
    if (i.extent && this.clipping) {
      const _ = To(i.extent);
      d = Qn(_, t.extent), g = d && !Fs(_, t.extent), g && this.clipUnrotated(this.compositionContext_, t, _);
    }
    ...
    const o = e.viewState.resolution, a = e.viewState.rotation, u = this.getLayer(), l = {}, c = function(g, d, _) {
      ...
      if (m) {
        if (m !== !0 && _ < m.distanceSq) {
          if (_ === 0)
            return l[p] = !0, s.splice(s.lastIndexOf(m), 1), i(g, u, d);
          m.geometry = d, m.distanceSq = _;
        }
      } else {
        if (_ === 0)
          return l[p] = !0, i(g, u, d);
        s.push(
          l[p] = {
            feature: g,
            layer: u,
  ...
  prepareFrame(t) {
    ...
    if (!n)
      return !1;
    const i = t.viewHints[Ln.ANIMATING], s = t.viewHints[Ln.INTERACTING], o = e.getUpdateWhileAnimating(), a = e.getUpdateWhileInteracting();
    ...
    _ === void 0 && (_ = gy);
    const p = l.center.slice(), m = zl(
      u,
      d * h
    ), y = m.slice(), v = [m.slice()], I = c.getExtent();
    if (n.getWrapX() && c.canWrapX() && !Fs(I, t.extent)) {
      const T = Tn(I), B = Math.max(Tn(m) / 2, T);
      m[0] = I[0] - B, m[2] = I[2] + B, rp(p, c);
      const V = Rf(v[0], c);
    ...
    let N;
    this.getLayer().getDeclutter() && (N = new ph(
      El(h, f),
      m,
      h,
      f
    ...
    const M = (
      ...
      (T) => {
        let B;
        const V = T.getStyleFunction() || e.getStyleFunction();
        if (V && (B = V(T, h)), B) {
    ...
    return N && (this.declutterExecutorGroup = new vh(
      m,
      h,
      f,
      n.getOverlaps(),
      N.finish(),
      e.getRenderBuffer()
    )), this.renderedResolution_ = h, this.renderedRevision_ = g, this.renderedRenderOrder_ = _, this.renderedExtent_ = y, this.wrappedRenderedExtent_ = m, this.renderedCenter_ = p, this.renderedProjection_ = c, this.replayGroup_ = R, this.hitDetectionImageData_ = null, this.replayGroupChanged = !0, !0;
  }
  /**
   * @param {import("../../Feature.js").default} feature Feature.
...
class Ly {
  ...
  insert(t, e) {
    ...
    this.rbush_.insert(n), this.items_[de(e)] = n;
  }
  /**
   ...
   */
  update(t, e) {
    const n = this.items_[de(e)], i = [n.minX, n.minY, n.maxX, n.maxY];
...
class Ay extends Py {
  ...
  removeFeatureInternal(t) {
    const e = de(t), n = this.featureChangeKeys_[e];
    if (!n)
      return;
...
function dg(r, t, e) {
  if (r !== null)
    for (var n, i, s, o, a, u, l, c = 0, h = 0, f, g = r.type, d = g === "FeatureCollection", _ = g === "Feature", p = d ? r.features.length : 1, m = 0; m < p; m++) {
      l = d ? r.features[m].geometry : _ ? r.geometry : r, f = l ? l.type === "GeometryCollection" : !1, a = f ? l.geometries.length : 1;
      for (var y = 0; y < a; y++) {
        var v = 0, I = 0;
          ...
          switch (c = e && (C === "Polygon" || C === "MultiPolygon") ? 1 : 0, C) {
            ...
            case "MultiLineString":
              for (n = 0; n < u.length; n++) {
                ...
                C === "MultiLineString" && v++, C === "Polygon" && I++;
              }
              C === "Polygon" && v++;
              break;
            case "MultiPolygon":
...
function pg(r, t) {
  var e, n, i, s, o, a, u, l, c, h, f = 0, g = r.type === "FeatureCollection", d = r.type === "Feature", _ = g ? r.features.length : 1;
  for (e = 0; e < _; e++) {
...
var fn = function r() {
  if (this.x = null, this.y = null, this.w = null, arguments.length === 0)
    ...
    var h = arguments[0], f = arguments[1], g = arguments[2], d = arguments[3], _ = h.y - f.y, p = f.x - h.x, m = h.x * f.y - f.x * h.y, y = g.y - d.y, v = d.x - g.x, I = g.x * d.y - d.x * g.y;
    this.x = p * I - v * m, this.y = y * m - _ * I, this.w = _ * v - y * p;
  }
};
...
fn.intersection = function(t, e, n, i) {
  var s = t.y - e.y, o = e.x - t.x, a = t.x * e.y - e.x * t.y, u = n.y - i.y, l = i.x - n.x, c = n.x * i.y - i.x * n.y, h = o * c - l * a, f = u * a - s * c, g = s * l - u * o, d = h / g, _ = f / g;
...
bu.prototype.read = function(t) {
  var e, n, i;
  t = t.replace(/[\n\r]/g, " ");
  var s = wn.typeStr.exec(t);
  if (t.search("EMPTY") !== -1 && (s = wn.emptyTypeStr.exec(t), s[2] = void 0), s && (n = s[1].toLowerCase(), i = s[2], Gs[n] && (e = Gs[n].apply(this, [i]))), e === void 0)
...
var _r = {
  ...
  multipoint: function(t) {
    ...
    for (var n, i = t.trim().split(","), s = [], o = 0, a = i.length; o < a; ++o)
      n = i[o].replace(wn.trimParens, "$1"), s.push(Gs.point.apply(e, [n]));
  ...
  linestring: function(t) {
    ...
    for (var e = t.trim().split(","), n = [], i, s = 0, o = e.length; s < o; ++s)
      i = e[s].trim().split(wn.spaces), n.push(new E(Number.parseFloat(i[0]), Number.parseFloat(i[1])));
  ...
  multilinestring: function(t) {
    ...
    for (var n, i = t.trim().split(wn.parenComma), s = [], o = 0, a = i.length; o < a; ++o)
      n = i[o].replace(wn.trimParens, "$1"), s.push(Gs.linestring.apply(e, [n]));
  ...
  polygon: function(t) {
    ...
    for (var n, i, s, o = t.trim().split(wn.parenComma), a, u = [], l = 0, c = o.length; l < c; ++l)
      n = o[l].replace(wn.trimParens, "$1"), i = Gs.linestring.apply(e, [n]), s = e.geometryFactory.createLinearRing(i._points), l === 0 ? a = s : u.push(s);
  ...
  multipolygon: function(t) {
    ...
    for (var n, i = t.trim().split(wn.doubleParenComma), s = [], o = 0, a = i.length; o < a; ++o)
      n = i[o].replace(wn.trimParens, "$1"), s.push(Gs.polygon.apply(e, [n]));
...
var Ai = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.isInSegmentEnvelopes = function(n) {
    ...
    var u = n.x < i.x ? n.x : i.x, l = n.y < i.y ? n.y : i.y, c = n.x > i.x ? n.x : i.x, h = n.y > i.y ? n.y : i.y, f = s.x < o.x ? s.x : o.x, g = s.y < o.y ? s.y : o.y, d = s.x > o.x ? s.x : o.x, _ = s.y > o.y ? s.y : o.y, p = u > f ? u : f, m = c < d ? c : d, y = l > g ? l : g, v = h < _ ? h : _, I = (p + m) / 2, C = (y + v) / 2;
    a.x = I, a.y = C, n.x -= a.x, n.y -= a.y, i.x -= a.x, i.y -= a.y, s.x -= a.x, s.y -= a.y, o.x -= a.x, o.y -= a.y;
...
G.isPointInRing = function(t, e) {
  return G.locatePointInRing(t, e) !== x.EXTERIOR;
};
...
var A = function(r) {
  ...
  return e.coordArrayType.get = function() {
    ...
    if (arguments.length === 1) {
      ...
      var b = arguments[0], w = arguments[1], M = arguments[2], z = arguments[3], F = 1;
      M > z && (F = -1);
      for (var U = M; U !== z; U += F)
        i.add(b[U], w);
      return !0;
  ...
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    if (arguments.length === 1) {
      ...
      for (var u = arguments[0], l = arguments[1], c = u, h = this.getNumGeometries(), f = c.getNumGeometries(), g = 0; g < h && g < f; ) {
        var d = i.getGeometryN(g), _ = c.getGeometryN(g), p = d.compareToSameClass(_, l);
        if (p !== 0)
          return p;
        g++;
      }
...
var Wt = function(r) {
  ...
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    for (var l = i.getX(0), c = i.getY(0), h = 1; h <= 4; h++) {
      var f = i.getX(h), g = i.getY(h), d = f !== l, _ = g !== c;
      if (d === _)
        return !1;
      l = f, c = g;
    }
    ...
    if (arguments.length === 1) {
      ...
      for (var d = this.getNumInteriorRing(), _ = c.getNumInteriorRing(), p = 0; p < d && p < _; ) {
        var m = i.getInteriorRingN(p), y = c.getInteriorRingN(p), v = m.compareToSameClass(y, l);
        if (v !== 0)
          return v;
        p++;
      }
...
rn.prototype.editInternal = function(t, e) {
  return this._factory === null && (this._factory = t.getFactory()), t instanceof Ee ? this.editGeometryCollection(t, e) : t instanceof Wt ? this.editPolygon(t, e) : t instanceof De ? e.edit(t, this._factory) : t instanceof Rt ? e.edit(t, this._factory) : (J.shouldNeverReachHere("Unsupported Geometry class: " + t.getClass().getName()), null);
};
...
Au.prototype.read = function(t) {
  ...
  return iv.indexOf(n) !== -1 ? bn[n].apply(this, [e.coordinates]) : n === "GeometryCollection" ? bn[n].apply(this, [e.geometries]) : bn[n].apply(this, [e]);
};
...
var bn = {
  ...
  Feature: function(r) {
    ...
    return r.bbox && (t.bbox = bn.bbox.apply(this, [r.bbox])), t;
  },
  /**
  ...
  LineString: function(r) {
    var t = bn.coordinates.apply(this, [r]);
  ...
  MultiLineString: function(r) {
    for (var t = this, e = [], n = 0; n < r.length; ++n)
      e.push(bn.LineString.apply(t, [r[n]]));
   ...
   */
  Polygon: function(r) {
    for (var t = this, e = bn.coordinates.apply(this, [r[0]]), n = this.geometryFactory.createLinearRing(e), i = [], s = 1; s < r.length; ++s) {
      var o = r[s], a = bn.coordinates.apply(t, [o]), u = t.geometryFactory.createLinearRing(a);
      i.push(u);
    }
...
var xe = function() {
  this._finder = null, this._dirEdgeList = new A(), this._nodes = new A(), this._rightMostCoord = null, this._env = null, this._finder = new Bn();
};
xe.prototype.clearVisitedEdges = function() {
  for (var t = this._dirEdgeList.iterator(); t.hasNext(); ) {
    var e = t.next();
    e.setVisited(!1);
  }
};
xe.prototype.getRightmostCoordinate = function() {
  return this._rightMostCoord;
};
xe.prototype.computeNodeDepth = function(t) {
...
xe.prototype.getEnvelope = function() {
  if (this._env === null) {
...
xe.prototype.addReachable = function(t) {
  var e = this, n = new qn();
  for (n.add(t); !n.empty(); ) {
    var i = n.pop();
    e.add(i, n);
...
xe.prototype.copySymDepths = function(t) {
  var e = t.getSym();
...
xe.prototype.getNodes = function() {
  return this._nodes;
};
xe.prototype.getDirectedEdges = function() {
...
pt.prototype.merge = function(t) {
  ...
  if (t.location.length > this.location.length) {
    ...
    n[O.ON] = this.location[O.ON], n[O.LEFT] = x.NONE, n[O.RIGHT] = x.NONE, this.location = n;
  }
  for (var i = 0; i < this.location.length; i++)
    e.location[i] === x.NONE && i < t.location.length && (e.location[i] = t.location[i]);
};
...
pt.prototype.toString = function() {
  var t = new Wn();
  return this.location.length > 1 && t.append(x.toLocationSymbol(this.location[O.LEFT])), t.append(x.toLocationSymbol(this.location[O.ON])), this.location.length > 1 && t.append(x.toLocationSymbol(this.location[O.RIGHT])), t.toString();
};
...
var ut = function r() {
  if (this.elt = new Array(2).fill(null), arguments.length === 1) {
    ...
    var n = arguments[0], i = arguments[1];
    this.elt[0] = new pt(x.NONE), this.elt[1] = new pt(x.NONE), this.elt[n].setLocation(i);
  } else if (arguments.length === 3) {
    ...
    this.elt[0] = new pt(x.NONE, x.NONE, x.NONE), this.elt[1] = new pt(x.NONE, x.NONE, x.NONE), this.elt[u].setLocations(l, c, h);
  }
};
...
ut.toLineLabel = function(t) {
  for (var e = new ut(x.NONE), n = 0; n < 2; n++)
    e.setLocation(n, t.getLocation(n));
  return e;
};
var Ft = function() {
  this._startDe = null, this._maxNodeDegree = -1, this._edges = new A(), this._pts = new A(), this._label = new ut(x.NONE), this._ring = null, this._isHole = null, this._shell = null, this._holes = new A(), this._geometryFactory = null;
  var t = arguments[0], e = arguments[1];
...
var Gu = function(r) {
  function t() {
    ...
    var e = arguments[0], n = arguments[1];
    this._coord = e, this._edges = n, this._label = new ut(0, x.NONE);
  }
...
var Rl = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.getNextMin = function() {
    ...
    for (var n = this, i = !0, s = 0; s < 2; s++)
      n._label.isArea(s) && n._label.getLocation(s, O.LEFT) === x.INTERIOR && n._label.getLocation(s, O.RIGHT) === x.INTERIOR || (i = !1);
    return i;
...
Zt.prototype.getNodeCapacity = function() {
  return this._nodeCapacity;
};
Zt.prototype.lastNode = function(t) {
...
Zt.prototype.size = function() {
  ...
  if (arguments.length === 1) {
    for (var e = arguments[0], n = 0, i = e.getChildBoundables().iterator(); i.hasNext(); ) {
      var s = i.next();
      s instanceof Xt ? n += t.size(s) : s instanceof _n && (n += 1);
    }
    return n;
  }
};
Zt.prototype.removeItem = function(t, e) {
...
Zt.prototype.itemsTree = function() {
  var t = this;
  if (arguments.length === 0) {
    this.build();
...
Zt.prototype.boundablesAtLevel = function() {
  var t = this;
  if (arguments.length === 1) {
    ...
    for (var a = s.getChildBoundables().iterator(); a.hasNext(); ) {
      var u = a.next();
      u instanceof Xt ? t.boundablesAtLevel(i, u, o) : (J.isTrue(u instanceof _n), i === -1 && o.add(u));
    }
    return null;
  }
};
Zt.prototype.query = function() {
  var t = this;
  if (arguments.length === 1) {
    var e = arguments[0];
    this.build();
    ...
    if (q(arguments[2], Hr) && arguments[0] instanceof Object && arguments[1] instanceof Xt)
      for (var o = arguments[0], a = arguments[1], u = arguments[2], l = a.getChildBoundables(), c = 0; c < l.size(); c++) {
        var h = l.get(c);
        t.getIntersectsOp().intersects(h.getBounds(), o) && (h instanceof Xt ? t.query(o, h, u) : h instanceof _n ? u.visitItem(h.getItem()) : J.shouldNeverReachHere());
      }
    else if (q(arguments[2], gn) && arguments[0] instanceof Object && arguments[1] instanceof Xt)
      for (var f = arguments[0], g = arguments[1], d = arguments[2], _ = g.getChildBoundables(), p = 0; p < _.size(); p++) {
        var m = _.get(p);
        t.getIntersectsOp().intersects(m.getBounds(), f) && (m instanceof Xt ? t.query(f, m, d) : m instanceof _n ? d.add(m.getItem()) : J.shouldNeverReachHere());
      }
  }
};
Zt.prototype.build = function() {
  if (this._built)
    return null;
  this._root = this._itemBoundables.isEmpty() ? this.createNode(0) : this.createHigherLevels(this._itemBoundables, -1), this._itemBoundables = null, this._built = !0;
};
Zt.prototype.getRoot = function() {
...
Zt.prototype.createHigherLevels = function(t, e) {
  J.isTrue(!t.isEmpty());
  var n = this.createParentBoundables(t, e + 1);
  return n.size() === 1 ? n.get(0) : this.createHigherLevels(n, e + 1);
};
Zt.prototype.depth = function() {
  var t = this;
  if (arguments.length === 0)
...
Zt.prototype.createParentBoundables = function(t, e) {
  var n = this;
  J.isTrue(!t.isEmpty());
  var i = new A();
...
Zt.compareDoubles = function(t, e) {
...
var Ng = function(r) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, s) {
    ...
    if (arguments.length === 1) {
      ...
      var m = arguments[0], y = arguments[1], v = arguments[2], I = new _n(m, y), C = new At(this.getRoot(), I, v);
...
Ne.relativeSign = function(t, e) {
  return t < e ? -1 : t > e ? 1 : 0;
};
Ne.compare = function(t, e, n) {
  if (e.equals2D(n))
    return 0;
  var i = Ne.relativeSign(e.x, n.x), s = Ne.relativeSign(e.y, n.y);
  switch (t) {
    case 0:
      return Ne.compareValue(i, s);
    case 1:
      return Ne.compareValue(s, i);
    case 2:
      return Ne.compareValue(s, -i);
    case 3:
      return Ne.compareValue(-i, s);
...
jr.prototype.compareTo = function(t) {
  var e = t;
  return this.segmentIndex < e.segmentIndex ? -1 : this.segmentIndex > e.segmentIndex ? 1 : this.coord.equals2D(e.coord) ? 0 : Ne.compare(this._segmentOctant, this.coord, e.coord);
};
...
Ce.prototype.getSplitCoordinates = function() {
  var t = this, e = new xa();
  this.addEndpoints();
...
Ce.prototype.addCollapsedNodes = function() {
  var t = this, e = new A();
...
Ce.prototype.findCollapsesFromExistingVertices = function(t) {
...
Ce.prototype.addEdgeCoordinates = function(t, e, n) {
...
Ce.prototype.addSplitEdges = function(t) {
  var e = this;
...
Ce.prototype.addEndpoints = function() {
  var t = this._edge.size() - 1;
  this.add(this._edge.getCoordinate(0), 0), this.add(this._edge.getCoordinate(t), t);
};
Ce.prototype.createSplitEdge = function(t, e) {
...
Ce.prototype.checkSplitEdgesCorrectness = function(t) {
...
var Ot = function() {
  this._nodeList = new Ce(this), this._pts = null, this._data = null;
  var t = arguments[0], e = arguments[1];
...
Ot.prototype.toString = function() {
  return dn.toLineString(new Pt(this._pts));
};
...
On.getChains = function() {
  if (arguments.length === 1) {
    ...
    for (var e = arguments[0], n = arguments[1], i = new A(), s = On.getChainStartIndices(e), o = 0; o < s.length - 1; o++) {
...
var pc = function(r) {
  function t(n) {
    n ? r.call(this, n) : r.call(this), this._monoChains = new A(), this._index = new Ng(), this._idCounter = 0, this._nodedSegStrings = null, this._nOverlaps = 0;
  }
  r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t;
...
mt.prototype.addNextSegment = function(t, e) {
  if (this._s0 = this._s1, this._s1 = this._s2, this._s2 = t, this._seg0.setCoordinates(this._s0, this._s1), this.computeOffsetSegment(this._seg0, this._side, this._distance, this._offset0), this._seg1.setCoordinates(this._s1, this._s2), this.computeOffsetSegment(this._seg1, this._side, this._distance, this._offset1), this._s1.equals(this._s2))
    return null;
  var n = G.computeOrientation(this._s0, this._s1, this._s2), i = n === G.CLOCKWISE && this._side === O.LEFT || n === G.COUNTERCLOCKWISE && this._side === O.RIGHT;
...
mt.prototype.addLimitedMitreJoin = function(t, e, n, i) {
  var s = this._seg0.p1, o = tt.angle(s, this._seg0.p0), a = tt.angleBetweenOriented(this._seg0.p0, s, this._seg1.p1), u = a / 2, l = tt.normalize(o + u), c = tt.normalize(l + Math.PI), h = i * n, f = h * Math.abs(Math.sin(u)), g = n - f, d = s.x + h * Math.cos(c), _ = s.y + h * Math.sin(c), p = new E(d, _), m = new Y(s, p), y = m.pointAlongOffset(1, g), v = m.pointAlongOffset(1, -g);
...
is.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (q(arguments[2], gn) && arguments[0] instanceof E && arguments[1] instanceof Rl)
...
st.interpolateZ = function(t, e, n, i) {
  var s = e.x, o = e.y, a = n.x - s, u = i.x - s, l = n.y - o, c = i.y - o, h = a * c - u * l, f = t.x - s, g = t.y - o, d = (c * f - u * g) / h, _ = (-l * f + a * g) / h, p = e.z + d * (n.z - e.z) + _ * (i.z - e.z);
  return p;
};
...
sn.prototype.addPolygon = function(t) {
  ...
  if (this._distance < 0 && this.isErodedCompletely(s, this._distance) || this._distance <= 0 && o.length < 3)
    return null;
  this.addPolygonRing(o, n, i, x.EXTERIOR, x.INTERIOR);
  for (var a = 0; a < t.getNumInteriorRing(); a++) {
    var u = t.getInteriorRingN(a), l = $.removeRepeatedPoints(u.getCoordinates());
    e._distance > 0 && e.isErodedCompletely(u, -e._distance) || e.addPolygonRing(l, n, O.opposite(i), x.INTERIOR, x.EXTERIOR);
  }
};
...
sn.prototype.addCurve = function(t, e, n) {
  if (t === null || t.length < 2)
    return null;
  var i = new Ot(t, new ut(0, x.BOUNDARY, e, n));
...
sn.prototype.addPolygonRing = function(t, e, n, i, s) {
  if (e === 0 && t.length < or.MINIMUM_VALID_SIZE)
    return null;
  var o = i, a = s;
  t.length >= or.MINIMUM_VALID_SIZE && G.isCCW(t) && (o = s, a = i, n = O.opposite(n));
...
sn.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof Wt ? this.addPolygon(t) : t instanceof Rt ? this.addLineString(t) : t instanceof De ? this.addPoint(t) : t instanceof $s ? this.addCollection(t) : t instanceof Ii ? this.addCollection(t) : t instanceof nr ? this.addCollection(t) : t instanceof Ee && this.addCollection(t);
};
...
rr.prototype.next = function() {
  ...
  return t instanceof Ee ? (this._subcollectionIterator = new rr(t), this._subcollectionIterator.next()) : t;
};
...
Xe.locate = function(t, e) {
  return e.isEmpty() ? x.EXTERIOR : Xe.containsPoint(t, e) ? x.INTERIOR : x.EXTERIOR;
};
var ce = function() {
  this._edgeMap = new ue(), this._edgeList = null, this._ptInAreaLocation = [x.NONE, x.NONE];
};
...
ce.prototype.propagateSideLabels = function(t) {
  for (var e = x.NONE, n = this.iterator(); n.hasNext(); ) {
    ...
    s.isArea(t) && s.getLocation(t, O.LEFT) !== x.NONE && (e = s.getLocation(t, O.LEFT));
  }
  if (e === x.NONE)
    return null;
  for (var o = e, a = this.iterator(); a.hasNext(); ) {
    var u = a.next(), l = u.getLabel();
    if (l.getLocation(t, O.ON) === x.NONE && l.setLocation(t, O.ON, o), l.isArea(t)) {
      ...
      if (h !== x.NONE) {
        ...
        J.isTrue(l.getLocation(t, O.LEFT) === x.NONE, "found single null side"), l.setLocation(t, O.RIGHT, o), l.setLocation(t, O.LEFT, o);
    }
  }
};
...
ce.prototype.getLocation = function(t, e, n) {
  return this._ptInAreaLocation[t] === x.NONE && (this._ptInAreaLocation[t] = Xe.locate(e, n[t].getGeometry())), this._ptInAreaLocation[t];
};
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.linkResultDirectedEdges = function() {
    ...
    if (arguments.length === 1) {
      ...
      for (var c = arguments[0], h = arguments[1], f = arguments[2], g = f, d = c; d < h; d++) {
        ...
        _.setEdgeDepths(O.RIGHT, g), g = _.getDepth(O.LEFT);
      }
      return g;
    }
    ...
    var i = this;
    r.prototype.computeLabelling.call(this, n), this._label = new ut(x.NONE);
    for (var s = this.iterator(); s.hasNext(); )
      for (var o = s.next(), a = o.getEdge(), u = a.getLabel(), l = 0; l < 2; l++) {
        var c = u.getLocation(l);
        (c === x.INTERIOR || c === x.BOUNDARY) && i._label.setLocation(l, x.INTERIOR);
      }
  }, t.prototype.interfaces_ = function() {
    return [];
  }, t.prototype.getClass = function() {
...
var yn = function() {
  this._edges = new A(), this._ocaMap = new ue();
};
  ...
  if (arguments.length === 1)
    for (var e = arguments[0], n = 0; n < 2; n++)
      for (var i = 1; i < 3; i++) {
        ...
        (s === x.EXTERIOR || s === x.INTERIOR) && (t.isNull(n, i) ? t._depth[n][i] = te.depthAtLocation(s) : t._depth[n][i] += te.depthAtLocation(s));
      }
  else if (arguments.length === 3) {
    var o = arguments[0], a = arguments[1], u = arguments[2];
...
te.depthAtLocation = function(t) {
  return t === x.EXTERIOR ? 0 : t === x.INTERIOR ? 1 : te.NULL_VALUE;
};
...
ve.prototype.setWorkingPrecisionModel = function(t) {
  this._workingPrecisionModel = t;
};
ve.prototype.insertUniqueEdge = function(t) {
  var e = this._edgeList.findEqualEdge(t);
  if (e !== null) {
    var n = e.getLabel(), i = t.getLabel();
    e.isPointwiseEqual(t) || (i = new ut(t.getLabel()), i.flip()), n.merge(i);
    var s = ve.depthDelta(i), o = e.getDepthDelta(), a = o + s;
    e.setDepthDelta(a);
  } else
    this._edgeList.add(t), t.setDepthDelta(ve.depthDelta(t.getLabel()));
};
ve.prototype.buildSubgraphs = function(t, e) {
...
ve.prototype.createSubgraphs = function(t) {
...
ve.prototype.computeNodedEdges = function(t, e) {
...
ve.prototype.setNoder = function(t) {
...
Xn.prototype.checkInteriorIntersections = function() {
  ...
  if (arguments.length === 0)
    ...
    if (this._li.computeIntersection(p, m, y, v), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, p, m) || this.hasInteriorIntersection(this._li, y, v)))
      throw new Sr("found non-noded intersection at " + p + "-" + m + " and " + y + "-" + v);
  }
};
...
$t.prototype.bufferFixedPrecision = function(t) {
  var e = new Kr(new cr(new it(1)), t.getScale()), n = new ve(this._bufParams);
...
$t.bufferOp = function() {
  if (arguments.length === 2) {
    ...
    var _ = arguments[0], p = arguments[1], m = arguments[2], y = arguments[3], v = new $t(_);
    v.setQuadrantSegments(m), v.setEndCapStyle(y);
    var I = v.getResultGeometry(p);
    return I;
  }
};
...
_e.prototype.getCoordinates = function() {
  return this._pt;
};
_e.prototype.getCoordinate = function(t) {
  return this._pt[t];
};
_e.prototype.setMinimum = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
...
_e.prototype.initialize = function() {
  if (arguments.length === 0)
    this._isNull = !0;
  else if (arguments.length === 2) {
    var t = arguments[0], e = arguments[1];
...
_e.prototype.getDistance = function() {
  return this._distance;
};
_e.prototype.setMaximum = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
...
Jn.computeDistance = function() {
  if (arguments[2] instanceof _e && arguments[0] instanceof Rt && arguments[1] instanceof E)
  ...
  else if (arguments[2] instanceof _e && arguments[0] instanceof Wt && arguments[1] instanceof E) {
    var u = arguments[0], l = arguments[1], c = arguments[2];
    Jn.computeDistance(u.getExteriorRing(), l, c);
    for (var h = 0; h < u.getNumInteriorRing(); h++)
      Jn.computeDistance(u.getInteriorRingN(h), l, c);
  } else if (arguments[2] instanceof _e && arguments[0] instanceof W && arguments[1] instanceof E) {
  ...
  } else if (arguments[2] instanceof _e && arguments[0] instanceof Y && arguments[1] instanceof E) {
    var y = arguments[0], v = arguments[1], I = arguments[2], C = y.closestPoint(v);
    I.setMinimum(C, v);
  }
};
var Li = function(t) {
  this._maxPtDist = new _e(), this._inputGeom = t || null;
...
var os = function(t) {
  this._maxPtDist = new _e(), this._minPtDist = new _e(), this._geom = t || null;
};
...
Ir.prototype.filter = function(t) {
  t instanceof Wt && this._comps.add(t);
};
...
Ir.getPolygons = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return Ir.getPolygons(t, new A());
  } else if (arguments.length === 2) {
    var e = arguments[0], n = arguments[1];
    return e instanceof Wt ? n.add(e) : e instanceof Ee && e.apply(new Ir(n)), n;
  }
};
var Qt = function() {
...
vn.prototype.locateInternal = function() {
  var t = this;
  if (arguments[0] instanceof E && arguments[1] instanceof Wt) {
    var e = arguments[0], n = arguments[1];
    if (n.isEmpty())
      return x.EXTERIOR;
    ...
    return !c.isClosed() && (l.equals(h[0]) || l.equals(h[h.length - 1])) ? x.BOUNDARY : G.isOnLine(l, h) ? x.INTERIOR : x.EXTERIOR;
  } else if (arguments[0] instanceof E && arguments[1] instanceof De) {
    var f = arguments[0], g = arguments[1], d = g.getCoordinate();
    return d.equals2D(f) ? x.INTERIOR : x.EXTERIOR;
  }
};
vn.prototype.locateInPolygonRing = function(t, e) {
  return e.getEnvelopeInternal().intersects(t) ? G.locatePointInRing(t, e.getCoordinates()) : x.EXTERIOR;
};
...
vn.prototype.locate = function(t, e) {
  return e.isEmpty() ? x.EXTERIOR : e instanceof Rt ? this.locateInternal(t, e) : e instanceof Wt ? this.locateInternal(t, e) : (this._isIn = !1, this._numBoundaries = 0, this.computeLocation(t, e), this._boundaryRule.isInBoundary(this._numBoundaries) ? x.BOUNDARY : this._numBoundaries > 0 || this._isIn ? x.INTERIOR : x.EXTERIOR);
};
vn.prototype.interfaces_ = function() {
  return [];
};
...
Xr.getPoints = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return t instanceof De ? mn.singletonList(t) : Xr.getPoints(t, new A());
  } else if (arguments.length === 2) {
    var e = arguments[0], n = arguments[1];
    return e instanceof De ? n.add(e) : e instanceof Ee && e.apply(new Xr(n)), n;
  }
};
var as = function() {
...
as.prototype.filter = function(t) {
  (t instanceof De || t instanceof Rt || t instanceof Wt) && this._locations.add(new me(t, 0, t.getCoordinate()));
};
      ...
      for (var u = arguments[0], l = arguments[1], c = arguments[2], h = 0; h < u.size(); h++)
        for (var f = u.get(h), g = 0; g < l.size(); g++)
          if (t.computeContainmentDistance(f, l.get(g), c), t._minDistance <= t._terminateDistance)
            return null;
    } else if (arguments[2] instanceof Array && arguments[0] instanceof me && arguments[1] instanceof Wt) {
      var d = arguments[0], _ = arguments[1], p = arguments[2], m = d.getCoordinate();
      if (x.EXTERIOR !== this._ptLocator.locate(m, _))
        return this._minDistance = 0, p[0] = d, p[1] = new me(_, m), null;
    }
  }
};
    ...
    if (arguments[2] instanceof Array && arguments[0] instanceof Rt && arguments[1] instanceof De) {
      ...
      for (var s = e.getCoordinates(), o = n.getCoordinate(), a = 0; a < s.length - 1; a++) {
        ...
        if (u < t._minDistance) {
          ...
          i[0] = new me(e, a, c), i[1] = new me(n, 0, o);
        }
      ...
      for (var d = h.getCoordinates(), _ = f.getCoordinates(), p = 0; p < d.length - 1; p++)
        for (var m = 0; m < _.length - 1; m++) {
          var y = G.distanceLineLine(d[p], d[p + 1], _[m], _[m + 1]);
          if (y < t._minDistance) {
            t._minDistance = y;
            var v = new Y(d[p], d[p + 1]), I = new Y(_[m], _[m + 1]), C = v.closestPoints(I);
            g[0] = new me(h, p, C[0]), g[1] = new me(f, m, C[1]);
          }
          if (t._minDistance <= t._terminateDistance)
            return null;
        }
...
ne.prototype.computeMinDistancePoints = function(t, e, n) {
  for (var i = this, s = 0; s < t.size(); s++)
    for (var o = t.get(s), a = 0; a < e.size(); a++) {
      ...
      if (l < i._minDistance && (i._minDistance = l, n[0] = new me(o, 0, o.getCoordinate()), n[1] = new me(u, 0, u.getCoordinate())), i._minDistance <= i._terminateDistance)
        return null;
    }
};
...
Pn.computeDistance = function() {
  ...
  else if (arguments[2] instanceof ae && arguments[0] instanceof Wt && arguments[1] instanceof E) {
    var u = arguments[0], l = arguments[1], c = arguments[2];
...
Ae.prototype.checkNegativeValid = function() {
  if (!(this._input instanceof Wt || this._input instanceof nr || this._input instanceof Ee))
    return null;
...
Ae.prototype.getPolygonLines = function(t) {
  for (var e = new A(), n = new Qt(e), i = Ir.getPolygons(t), s = i.iterator(); s.hasNext(); ) {
    var o = s.next();
    o.apply(n);
  }
...
re.prototype.checkPolygonal = function() {
  this._result instanceof Wt || this._result instanceof nr || (this._isValid = !1), this._errorMsg = "Result is not polygonal", this._errorIndicator = this._result, this.report("Polygonal");
};
...
Kt.prototype.processIntersections = function(t, e, n, i) {
...
En.prototype.checkInteriorIntersections = function() {
  this._isValid = !0, this._segInt = new Kt(this._li), this._segInt.setFindAllIntersections(this._findAllIntersections);
  var t = new pc();
...
pe.prototype.getCommon = function() {
  return H.longBitsToDouble(this._commonBits);
};
pe.prototype.add = function(t) {
  var e = H.doubleToLongBits(t);
  if (this._isFirst)
    return this._commonBits = e, this._commonSignExp = pe.signExpBits(this._commonBits), this._isFirst = !1, null;
  var n = pe.signExpBits(e);
  if (n !== this._commonSignExp)
    return this._commonBits = 0, null;
  this._commonMantissaBitsCount = pe.numCommonMostSigMantissaBits(this._commonBits, e), this._commonBits = pe.zeroLowerBits(this._commonBits, 64 - (12 + this._commonMantissaBitsCount));
};
...
pe.getBit = function(t, e) {
  var n = 1 << e;
  return t & n ? 1 : 0;
};
pe.signExpBits = function(t) {
  return t >> 52;
};
pe.zeroLowerBits = function(t, e) {
  var n = (1 << e) - 1, i = ~n, s = t & i;
  return s;
};
pe.numCommonMostSigMantissaBits = function(t, e) {
  for (var n = 0, i = 52; i >= 0; i--) {
    if (pe.getBit(t, i) !== pe.getBit(e, i))
      return n;
    n++;
  }
  return 52;
...
var hs = function() {
  this._commonBitsX = new pe(), this._commonBitsY = new pe();
};
...
Jt.prototype.selfSnap = function(t) {
  var e = new Tt(t), n = e.snapTo(t, this._snapTolerance);
  return n;
};
Jt.prototype.removeCommonBits = function(t) {
...
Jt.overlayOp = function(t, e, n) {
  var i = new Jt(t, e);
  return i.getResultGeometry(n);
};
Jt.union = function(t, e) {
  return Jt.overlayOp(t, e, Z.UNION);
};
Jt.intersection = function(t, e) {
  return Jt.overlayOp(t, e, Z.INTERSECTION);
};
Jt.symDifference = function(t, e) {
  return Jt.overlayOp(t, e, Z.SYMDIFFERENCE);
};
Jt.difference = function(t, e) {
  return Jt.overlayOp(t, e, Z.DIFFERENCE);
};
var Ie = function(t, e) {
  this._geom = new Array(2).fill(null), this._geom[0] = t, this._geom[1] = e;
};
Ie.prototype.getResultGeometry = function(t) {
  ...
  if (!n)
    try {
      e = Jt.overlayOp(this._geom[0], this._geom[1], t);
    } catch (o) {
...
Ie.overlayOp = function(t, e, n) {
  var i = new Ie(t, e);
  return i.getResultGeometry(n);
};
Ie.union = function(t, e) {
  return Ie.overlayOp(t, e, Z.UNION);
};
Ie.intersection = function(t, e) {
  return Ie.overlayOp(t, e, Z.INTERSECTION);
};
Ie.symDifference = function(t, e) {
  return Ie.overlayOp(t, e, Z.SYMDIFFERENCE);
};
Ie.difference = function(t, e) {
  return Ie.overlayOp(t, e, Z.DIFFERENCE);
};
var ha = function() {
...
gr.prototype.buildTree = function() {
  var t = this;
  mn.sort(this._leaves, new fr.NodeComparator());
...
var bo = function(r) {
  function t() {
    if (r.call(this), this._parentGeom = null, this._lineEdgeMap = new Ig(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new vn(), arguments.length === 2) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(n, i) {
    var s = this._nodes.addNode(i), o = s.getLabel(), a = 1, u = x.NONE;
    u = o.getLocation(n, O.ON), u === x.BOUNDARY && a++;
    ...
    if (arguments.length === 2) {
      ...
      var l = this.createEdgeSetIntersector(), c = this._parentGeom instanceof or || this._parentGeom instanceof Wt || this._parentGeom instanceof nr, h = o || !c;
    ...
    if (arguments[0] instanceof De) {
      ...
      this.insertPoint(this._argIndex, i, x.INTERIOR);
    } else if (arguments[0] instanceof E) {
      var s = arguments[0];
    ...
    for (var s = 0; s < n.getNumInteriorRing(); s++) {
      ...
      i.addPolygonRing(o, x.INTERIOR, x.EXTERIOR);
    }
  }, t.prototype.addEdge = function(n) {
    this.insertEdge(n);
    var i = n.getCoordinates();
    this.insertPoint(this._argIndex, i[0], x.BOUNDARY), this.insertPoint(this._argIndex, i[i.length - 1], x.BOUNDARY);
    ...
    var s = new fu(i, new ut(this._argIndex, x.INTERIOR));
    ...
    if (this.isBoundaryNode(n, i))
      return null;
    s === x.BOUNDARY && this._useBoundaryDeterminationRule ? this.insertBoundaryPoint(n, i) : this.insertPoint(n, i, s);
    ...
    var a = i, u = s;
    G.isCCW(o) && (a = s, u = i);
    var l = new fu(o, new ut(this._argIndex, x.BOUNDARY, a, u));
    ...
    if (arguments.length === 1) {
      ...
      if (n.isEmpty())
        return null;
      if (n instanceof nr && (this._useBoundaryDeterminationRule = !1), n instanceof Wt)
        this.addPolygon(n);
    ...
    return n.isInBoundary(i) ? x.BOUNDARY : x.INTERIOR;
  }, t;
}(St), uo = function() {
...
var Z = function(r) {
  function t() {
    var e = arguments[0], n = arguments[1];
    r.call(this, e, n), this._ptLocator = new vn(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new yn(), this._resultPolyList = new A(), this._resultLineList = new A(), this._resultPointList = new A(), this._graph = new St(new Tg()), this._geomFact = e.getFactory();
  }
...
Z.intersection = function(r, t) {
  ...
  return r.checkNotGeometryCollection(r), r.checkNotGeometryCollection(t), Ie.overlayOp(r, t, Z.INTERSECTION);
};
Z.symDifference = function(r, t) {
  ...
  return r.checkNotGeometryCollection(r), r.checkNotGeometryCollection(t), Ie.overlayOp(r, t, Z.SYMDIFFERENCE);
};
...
Z.difference = function(r, t) {
  return r.isEmpty() ? Z.createEmptyResult(Z.DIFFERENCE, r, t, r.getFactory()) : t.isEmpty() ? r.copy() : (r.checkNotGeometryCollection(r), r.checkNotGeometryCollection(t), Ie.overlayOp(r, t, Z.DIFFERENCE));
};
Z.isResultOfOp = function() {
  if (arguments.length === 2) {
    ...
    var i = arguments[0], s = arguments[1], o = arguments[2];
    switch (i === x.BOUNDARY && (i = x.INTERIOR), s === x.BOUNDARY && (s = x.INTERIOR), o) {
      case Z.INTERSECTION:
        return i === x.INTERIOR && s === x.INTERIOR;
      case Z.UNION:
        return i === x.INTERIOR || s === x.INTERIOR;
      case Z.DIFFERENCE:
        return i === x.INTERIOR && s !== x.INTERIOR;
      case Z.SYMDIFFERENCE:
        return i === x.INTERIOR && s !== x.INTERIOR || i !== x.INTERIOR && s === x.INTERIOR;
    }
    return !1;
  }
};
...
He.prototype.reportResult = function(t, e, n) {
  ee.out.println("Overlay result invalid - A:" + x.toLocationSymbol(e[0]) + " B:" + x.toLocationSymbol(e[1]) + " expected:" + (n ? "i" : "e") + " actual:" + x.toLocationSymbol(e[2]));
};
...
He.prototype.checkValid = function() {
  ...
  if (arguments.length === 1) {
    ...
    var s = arguments[0], o = arguments[1];
    return this._location[0] = this._locFinder[0].getLocation(o), this._location[1] = this._locFinder[1].getLocation(o), this._location[2] = this._locFinder[2].getLocation(o), He.hasLocation(this._location, x.BOUNDARY) ? !0 : this.isValidResult(s, this._location);
  }
};
...
He.prototype.isValidResult = function(t, e) {
  var n = Z.isResultOfOp(e[0], e[1], t), i = e[2] === x.INTERIOR, s = !(n ^ i);
...
du.union = function(t, e) {
  ...
  return t.checkNotGeometryCollection(t), t.checkNotGeometryCollection(e), Ie.overlayOp(t, e, Z.UNION);
};
function Di() {
  return new pu();
}
...
var wt = 1e-6, gt = Math.PI, Cr = gt / 2, Ah = gt / 4, br = gt * 2, ci = 180 / gt, Rn = gt / 180, ye = Math.abs, fv = Math.atan, co = Math.atan2, zt = Math.cos, Vt = Math.sin, vo = Math.sqrt;
function Yg(r) {
...
function Za(r, t) {
  return ye(r[0] - t[0]) < wt && ye(r[1] - t[1]) < wt;
}
function Ua(r, t, e, n) {
...
function qg(r, t, e, n, i) {
  ...
  if (r.forEach(function(d) {
    if (!((_ = d.length - 1) <= 0)) {
      var _, p = d[0], m = d[_], y;
      if (Za(p, m)) {
        for (i.lineStart(), a = 0; a < _; ++a)
          i.point((p = d[a])[0], p[1]);
        i.lineEnd();
        return;
      }
      s.push(y = new Ua(p, d, null, !0)), o.push(y.o = new Ua(p, null, y, !1)), s.push(y = new Ua(m, d, null, !1)), o.push(y.o = new Ua(m, null, y, !0));
    }
  }), !!s.length) {
...
function vv(r, t, e, n) {
  ...
  function o(l, c) {
    return ye(l[0] - r) < wt ? c > 0 ? 0 : 3 : ye(l[0] - e) < wt ? c > 0 ? 2 : 1 : ye(l[1] - t) < wt ? c > 0 ? 1 : 0 : c > 0 ? 3 : 2;
  }
  function a(l, c) {
    return u(l.x, c.x);
  }
  ...
  return function(l) {
    var c = l, h = Wg(), f, g, d, _, p, m, y, v, I, C, N, L = {
      point: b,
      lineStart: F,
      lineEnd: U,
      polygonStart: M,
    ...
    function w() {
      for (var T = 0, B = 0, V = g.length; B < V; ++B)
        for (var j = g[B], ot = 1, yt = j.length, kt = j[0], k, Ze, Se = kt[0], Me = kt[1]; ot < yt; ++ot)
          k = Se, Ze = Me, kt = j[ot], Se = kt[0], Me = kt[1], Ze <= n ? Me > n && (Se - k) * (n - Ze) > (Me - Ze) * (r - k) && ++T : Me <= n && (Se - k) * (n - Ze) < (Me - Ze) * (r - k) && --T;
      return T;
    }
    function M() {
      c = h, f = [], g = [], N = !0;
    ...
    function z() {
      var T = w(), B = N && T, V = (f = jg(f)).length;
      (B || V) && (l.polygonStart(), B && (l.lineStart(), s(null, null, 1, l), l.lineEnd()), V && qg(f, a, T, s, l), l.polygonEnd()), c = l, f = g = d = null;
    }
    function F() {
      L.point = R, g && g.push(d = []), C = !0, I = !1, y = v = NaN;
    }
    function U() {
      f && (R(_, p), m && I && h.rejoin(), f.push(h.result())), L.point = b, I && c.lineEnd();
    }
    function R(T, B) {
      var V = i(T, B);
      if (g && d.push([T, B]), C)
        _ = T, p = B, m = V, C = !1, V && (c.lineStart(), c.point(T, B));
      else if (V && I)
        c.point(T, B);
      else {
        var j = [y = Math.max(Wa, Math.min(Do, y)), v = Math.max(Wa, Math.min(Do, v))], ot = [T = Math.max(Wa, Math.min(Do, T)), B = Math.max(Wa, Math.min(Do, B))];
        _v(j, ot, r, t, e, n) ? (I || (c.lineStart(), c.point(j[0], j[1])), c.point(ot[0], ot[1]), V || c.lineEnd(), N = !1) : V && (c.lineStart(), c.point(T, B), N = !1);
      }
      y = T, v = B, I = V;
    }
    return L;
...
function Ev(r, t) {
  ...
  for (var a = 0, u = r.length; a < u; ++a)
    if (c = (l = r[a]).length)
      for (var l, c, h = l[c - 1], f = h[0], g = h[1] / 2 + Ah, d = Vt(g), _ = zt(g), p = 0; p < c; ++p, f = y, d = I, _ = C, h = m) {
        var m = l[p], y = m[0], v = m[1] / 2 + Ah, I = Vt(v), C = zt(v), N = y - f, L = N >= 0 ? 1 : -1, b = L * N, w = b > gt, M = d * I;
        if (nl.add(co(M * L * Vt(b), _ * C + M * zt(b))), s += w ? N + L * br : N, w ^ f >= e ^ y >= e) {
          var z = mu(ho(h), ho(m));
          bl(z);
          var F = mu(i, z);
          bl(F);
          var U = (w ^ N >= 0 ? -1 : 1) * fs(F[2]);
          (n > U || n === U && (z[0] || z[1])) && (o += w ^ N >= 0 ? 1 : -1);
        }
      }
  ...
  return function(i, s) {
    var o = t(s), a = i.invert(n[0], n[1]), u = Wg(), l = t(u), c = !1, h, f, g, d = {
      ...
      polygonStart: function() {
        d.point = v, d.lineStart = I, d.lineEnd = C, f = [], h = [];
      },
      polygonEnd: function() {
        d.point = _, d.lineStart = m, d.lineEnd = y, f = jg(f);
        var N = Ev(h, a);
        f.length ? (c || (s.polygonStart(), c = !0), qg(f, Iv, N, e, s)) : N && (c || (s.polygonStart(), c = !0), s.lineStart(), e(null, null, 1, s), s.lineEnd()), c && (s.polygonEnd(), c = !1), f = h = null;
      },
      sphere: function() {
    ...
    function C() {
      ...
      var N = l.clean(), L = u.result(), b, w = L.length, M, z, F;
      if (g.pop(), h.push(g), g = null, !!w) {
        if (N & 1) {
          if (z = L[0], (M = z.length - 1) > 0) {
            for (c || (s.polygonStart(), c = !0), s.lineStart(), b = 0; b < M; ++b)
              s.point((F = z[b])[0], F[1]);
            s.lineEnd();
          }
          return;
        }
        w > 1 && N & 2 && L.push(L.pop().concat(L.shift())), f.push(L.filter(Cv));
      }
    }
    return d;
  };
...
function Sv(r) {
  ...
  return {
    ...
    point: function(s, o) {
      var a = s > 0 ? gt : -gt, u = ye(s - t);
      ye(u - gt) < wt ? (r.point(t, e = (e + o) / 2 > 0 ? Cr : -Cr), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), r.point(s, e), i = 0) : n !== a && u >= gt && (ye(t - n) < wt && (t -= n * wt), ye(s - a) < wt && (s -= a * wt), e = wv(t, e, s, o), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), i = 0), r.point(t = s, e = o), n = a;
    },
    lineEnd: function() {
      r.lineEnd(), t = e = NaN;
    },
...
function wv(r, t, e, n) {
  var i, s, o = Vt(r - e);
  return ye(o) > wt ? fv((Vt(t) * (s = zt(n)) * Vt(e) - Vt(n) * (i = zt(t)) * Vt(r)) / (i * s * o)) : (t + n) / 2;
}
function Rv(r, t, e, n) {
  var i;
  if (r == null)
...
function Nv(r, t) {
  ...
  function a(c) {
    ...
    return {
      ...
      point: function(p, m) {
        var y = [p, m], v, I = o(p, m), C = n ? I ? 0 : l(p, m) : I ? l(p + (p < 0 ? gt : -gt), m) : 0;
        if (!h && (d = g = I) && c.lineStart(), I !== g && (v = u(h, y), (!v || Za(h, v) || Za(y, v)) && (y[0] += wt, y[1] += wt, I = o(y[0], y[1]))), I !== g)
          _ = 0, I ? (c.lineStart(), v = u(y, h), c.point(v[0], v[1])) : (v = u(h, y), c.point(v[0], v[1]), c.lineEnd()), h = v;
        else if (i && h && n ^ I) {
          var N;
          !(C & f) && (N = u(y, h, !0)) && (_ = 0, n ? (c.lineStart(), c.point(N[0][0], N[0][1]), c.point(N[1][0], N[1][1]), c.lineEnd()) : (c.point(N[1][0], N[1][1]), c.lineEnd(), c.lineStart(), c.point(N[0][0], N[0][1])));
        }
        I && (!h || !Za(h, y)) && c.point(y[0], y[1]), h = y, g = I, f = C;
      },
      lineEnd: function() {
        g && c.lineEnd(), h = null;
      },
  ...
  function u(c, h, f) {
    var g = ho(c), d = ho(h), _ = [1, 0, 0], p = mu(g, d), m = Xa(p, p), y = p[0], v = m - y * y;
    if (!v)
      return !f && c;
    var I = e * m / v, C = -e * y / v, N = mu(_, p), L = Ya(_, I), b = Ya(p, C);
    el(L, b);
    var w = N, M = Xa(L, w), z = Xa(w, w), F = M * M - z * (Xa(L, L) - 1);
    if (!(F < 0)) {
      var U = vo(F), R = Ya(w, (-M - U) / z);
      if (el(R, L), R = Ll(R), !f)
        return R;
      var T = c[0], B = h[0], V = c[1], j = h[1], ot;
      B < T && (ot = T, T = B, B = ot);
      var yt = B - T, kt = ye(yt - gt) < wt, k = kt || yt < wt;
      if (!kt && j < V && (ot = V, V = j, j = ot), k ? kt ? V + j > 0 ^ R[1] < (ye(R[0] - T) < wt ? V : j) : V <= R[1] && R[1] <= j : yt > gt ^ (T <= R[0] && R[0] <= B)) {
        var Ze = Ya(w, (-M + U) / z);
        return el(Ze, L), [R, Ll(Ze)];
      }
    }
  }
  function l(c, h) {
...
function Tv(r, t) {
  function e(n, i, s, o, a, u, l, c, h, f, g, d, _, p) {
    var m = l - n, y = c - i, v = m * m + y * y;
    if (v > 4 * t && _--) {
      var I = o + f, C = a + g, N = u + d, L = vo(I * I + C * C + N * N), b = fs(N /= L), w = ye(ye(N) - 1) < wt || ye(s - h) < wt ? (s + h) / 2 : co(C, I), M = r(w, b), z = M[0], F = M[1], U = z - n, R = F - i, T = y * U - m * R;
      (T * T / v > t || ye((m * U + y * R) / v - 0.5) > 0.3 || o * f + a * g + u * d < bv) && (e(n, i, s, o, a, u, z, F, w, I /= L, C /= L, N, _, p), p.point(z, F), e(z, F, w, I, C, N, l, c, h, f, g, d, _, p));
    }
  }
  return function(n) {
    var i, s, o, a, u, l, c, h, f, g, d, _, p = {
      point: m,
      lineStart: y,
      lineEnd: I,
      polygonStart: function() {
    ...
    function m(b, w) {
      b = r(b, w), n.point(b[0], b[1]);
    }
    function y() {
      h = NaN, p.point = v, n.lineStart();
    }
    function v(b, w) {
      var M = ho([b, w]), z = r(b, w);
      e(h, f, c, g, d, _, h = z[0], f = z[1], c = b, g = M[0], d = M[1], _ = M[2], qh, n), n.point(h, f);
    }
    function I() {
      p.point = m, n.lineEnd();
    }
    function C() {
      y(), p.point = N, p.lineEnd = L;
    }
    function N(b, w) {
      v(i = b, w), s = h, o = f, a = g, u = d, l = _, p.point = v;
    }
    function L() {
      e(h, f, c, g, d, _, s, o, i, a, u, l, qh, n), p.lineEnd = I, I();
    }
    return p;
  };
}
...
function Av(r) {
  var t, e = 150, n = 480, i = 250, s, o, a = 0, u = 0, l = 0, c = 0, h = 0, f, g, d = null, _ = Wh, p = null, m, y, v, I = Yh, C = 0.5, N = Hh(z, C), L, b;
  function w(R) {
    return R = g(R[0] * Rn, R[1] * Rn), [R[0] * e + s, o - R[1] * e];
  }
  function M(R) {
    return R = g.invert((R[0] - s) / e, (o - R[1]) / e), R && [R[0] * ci, R[1] * ci];
  }
  function z(R, T) {
    return R = t(R, T), [R[0] * e + s, o - R[1] * e];
  }
  w.stream = function(R) {
    return L && b === R ? L : L = Mv(_(f, N(I(b = R))));
  }, w.clipAngle = function(R) {
    return arguments.length ? (_ = +R ? Nv(d = R * Rn, 6 * Rn) : (d = null, Wh), U()) : d * ci;
  }, w.clipExtent = function(R) {
    return arguments.length ? (I = R == null ? (p = m = y = v = null, Yh) : vv(p = +R[0][0], m = +R[0][1], y = +R[1][0], v = +R[1][1]), U()) : p == null ? null : [[p, m], [y, v]];
  }, w.scale = function(R) {
    return arguments.length ? (e = +R, F()) : e;
  }, w.translate = function(R) {
    return arguments.length ? (n = +R[0], i = +R[1], F()) : [n, i];
  }, w.center = function(R) {
    return arguments.length ? (a = R[0] % 360 * Rn, u = R[1] % 360 * Rn, F()) : [a * ci, u * ci];
  }, w.rotate = function(R) {
    return arguments.length ? (l = R[0] % 360 * Rn, c = R[1] % 360 * Rn, h = R.length > 2 ? R[2] % 360 * Rn : 0, F()) : [l * ci, c * ci, h * ci];
  }, w.precision = function(R) {
    return arguments.length ? (N = Hh(z, C = R * R), U()) : vo(C);
  }, w.fitExtent = function(R, T) {
    return Jg(w, R, T);
  }, w.fitSize = function(R, T) {
    return Lv(w, R, T);
  };
  function F() {
    g = Ug(f = dv(l, c, h), t);
...
var Wv = pi * pi, kl = function(t, e) {
        ...
        if (!(!o.isInResult() || o.ringOut)) {
          for (var a = null, u = o.leftSE, l = o.rightSE, c = [u], h = u.point, f = []; a = u, u = l, c.push(u), u.point !== h; )
            for (; ; ) {
              ...
              if (p !== null) {
                var v = f.splice(p)[0], I = c.splice(v.index);
      ...
      if (e.isLeft) {
        ...
        if (c !== null || _ !== null) {
          ...
          if (c === null)
            ...
            var C = vr.comparePoints(c, _);
            I = C <= 0 ? c : _;
          }
          this.queue.remove(n.rightSE), i.push(n.rightSE);
          for (var N = n.split(I), L = 0, b = N.length; L < b; L++)
            i.push(N[L]);
        }
          ...
          if (w !== null) {
            if (!u.isAnEndpoint(w))
              for (var M = this._splitSafely(u, w), z = 0, F = M.length; z < F; z++)
                i.push(M[z]);
            if (!l.isAnEndpoint(w))
              for (var U = this._splitSafely(l, w), R = 0, T = U.length; R < T; R++)
                i.push(U[R]);
          }
        }
        this.tree.remove(n);
  ...
  return je(r, [{
    ...
    value: function(e, n, i) {
      ...
      for (var _ = new Ic(vr.compare), p = 0, m = s.length; p < m; p++)
        for (var y = s[p].getSweepEvents(), v = 0, I = y.length; v < I; v++)
          if (_.insert(y[v]), _.size > sf)
            throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");
      for (var C = new t0(_), N = _.size, L = _.pop(); L; ) {
        var b = L.key;
        if (_.size === N) {
          var w = b.segment;
        ...
        if (C.segments.length > e0)
          throw new Error("Infinite loop when passing sweep line over endpoints (too many sweep line segments). Please file a bug report.");
        for (var M = C.process(b), z = 0, F = M.length; z < F; z++) {
          var U = M[z];
          U.consumedBy === void 0 && _.insert(U);
        }
        N = _.size, L = _.pop();
      }
      da.reset();
      var R = Qv.factory(C.segments), T = new $v(R);
      return T.getGeom();
    }
  }]), r;
...
function c0(r, t = {}, e = {}, n = l0) {
  ...
  l.setSource(c), l.setStyle(n), r.on("click", (g) => {
    r.forEachFeatureAtPixel(g.pixel, (d) => {
      const _ = d.getId();
      if (_)
        return g.stopPropagation(), o == null || o({ type: "markerClick", id: _ }), d;
    });
  }), r.on("pointermove", (g) => {
    const d = r.forEachFeatureAtPixel(g.pixel, (_) => _.getId());
    s !== d && (s && (o == null || o({
  ...
  return {
    ...
    setMarkers(g, d) {
      ...
      if (c.clear(), a && c.addFeature(a), _(), d) {
        let p = !1;
        if (d.geometry.type === "GeometryCollection") {
          ...
          if (m.length > 0)
            ...
            for (const y of d.geometry.geometries)
              ...
              ), p = !0) : y.type === "MultiLineString" && c.addFeature(
                new Fr(
      ...
      for (const p of g ?? []) {
        if (p === d)
          continue;
        const m = new Fr(
          new zs(Aa(p.center, r.getView().getProjection()))
        );
        m.setId(p.id), m.setProperties({
          fuzzy: !!p.matching_text,
          tooltip: p.place_name.replace(/,.*/, "")
        }), c.addFeature(m);
      }
    },
    setSelectedMarker(g) {
      var p, m, y;
      const d = c.getFeatures(), _ = (p = d[0]) != null && p.getProperties().isReverse ? 1 : 0;
      i > -1 && ((m = d[i + _]) == null || m.setProperties({
        isSelected: !1
      })), g > -1 && ((y = d[g + _]) == null || y.setProperties({
        isSelected: !0
      })), i = g;
    },
    getCenterAndZoom() {
      const g = r.getView(), d = g.getCenter(), _ = g.getZoom();
      if (!(!d || _ === void 0))
        return [_, ...Mc(d, g.getProjection())];
    }
  };
}
var Nn, Zi;
class S0 extends Sd {
  ...
  setMap(e) {
    ...
    if (super.setMap(e), e) {
      ...
      (n = jn(this, Nn)) == null || n.$set({ mapController: o });
    }
  }
  setOptions(e) {
    var o;
  ...
  setQuery(e, n = !0) {
    var i;
    (i = jn(this, Nn)) == null || i.setQuery(e, n);
  }
  clearMap() {
    var e;
    (e = jn(this, Nn)) == null || e.clearMap();
  }
  clearList() {
    var e;
    (e = jn(this, Nn)) == null || e.clearList();
  }
  focus() {
    var e;
    (e = jn(this, Nn)) == null || e.focus();
  }
  blur() {
    var e;
    (e = jn(this, Nn)) == null || e.blur();
  }
  // onRemove() {
  //   this.#gc?.$destroy();
  // }
}
Nn = new WeakMap(), Zi = new WeakMap();
class h0 extends xn {
  constructor(e) {
    super("select");
    Sn(this, "feature");
