...
var tn = (r, t, e) => (ua(r, t, "read from private field"), e ? e.call(r) : t.get(r)), ms = (r, t, e) => {
  if (t.has(r))
...
function ql(r, t, e, n, i, o, s, a, u, l, c, f) {
  ...
  for (g = p; g--; ) {
    ...
    let L = s.get(T);
    L ? n && E.push(() => L.p(R, t)) : (L = l(T, R), L.c()), _.set(T, d[g] = L), T in v && C.set(T, Math.abs(g - v[T]));
  }
  ...
  for (; h && p; ) {
    const R = d[p - 1], T = r[h - 1], L = R.key, A = T.key;
...
function Ur(r, t, e, n, i, o, s = null, a = [-1]) {
  ...
  s && s(l.root);
  let c = !1;
  if (l.ctx = e ? e(r, t.props || {}, (f, h, ...p) => {
    const g = p.length ? p[0] : h;
    return l.ctx && i(l.ctx[f], l.ctx[f] = g) && (!l.skip_bound && l.bound[f] && l.bound[f](g), c && Xl(r, f)), h;
    ...
    t.intro && At(r.$$.fragment), cr(r, t.target, t.anchor), su();
  }
  Zi(u);
}
class qr {
...
function ec(r) {
  ...
  let S = E(r, -1), w = S(r), D = h && da(r);
  return {
    c() {
      t = ht("li"), w.c(), o = ze(), s = ht("span"), a = ht("span"), u = ht("span"), c = Pr(l), f = ze(), D && D.c(), p = ze(), g = ht("span"), d = Pr(v), P(u, "class", "primary svelte-ltkwvy"), P(a, "class", "svelte-ltkwvy"), P(g, "class", "line2 svelte-ltkwvy"), P(s, "class", "texts svelte-ltkwvy"), P(t, "tabindex", "0"), P(
        t,
        "data-selected",
        /*selected*/
        r[1]
    ...
    m(L, A) {
      Dt(L, t, A), w.m(t, null), nt(t, o), nt(t, s), nt(s, a), nt(a, u), nt(u, c), nt(a, f), D && D.m(a, null), nt(s, p), nt(s, g), nt(g, d), _ || (C = [
        Ce(
          t,
          "mouseenter",
          /*mouseenter_handler*/
...
class uc extends qr {
  constructor(t) {
    super(), Ur(this, t, ac, sc, zr, { displayIn: 0 });
  }
}
function lc(r) {
  let t, e;
...
function _a(r) {
  ...
  return e = new cc({}), {
    ...
    m(s, a) {
      Dt(s, t, a), cr(e, t, null), n = !0, i || (o = Ce(
        t,
        "click",
        /*click_handler_2*/
        r[63]
...
function vc(r) {
  ...
  return e = new uu({}), {
    c() {
      t = ht("div"), Rr(e.$$.fragment), n = ze(), i = ht("div"), o = Pr(
        /*noResultsMessage*/
        r[7]
      ), P(i, "class", "svelte-1r7dvt7"), P(t, "class", "no-results svelte-1r7dvt7");
    },
    m(a, u) {
      Dt(a, t, u), cr(e, t, null), nt(t, n), nt(t, i), nt(i, o), s = !0;
    },
    p(a, u) {
  ...
  return e = new uu({}), u = new au({}), {
    c() {
      t = ht("div"), Rr(e.$$.fragment), n = ze(), i = ht("div"), o = Pr(
        /*errorMessage*/
        r[6]
      ), s = ze(), a = ht("button"), Rr(u.$$.fragment), P(i, "class", "svelte-1r7dvt7"), P(a, "class", "svelte-1r7dvt7"), P(t, "class", "error svelte-1r7dvt7");
    },
    m(h, p) {
      Dt(h, t, p), cr(e, t, null), nt(t, n), nt(t, i), nt(i, o), nt(t, s), nt(t, a), cr(u, a, null), l = !0, c || (f = Ce(
        a,
        "click",
        /*click_handler_3*/
        r[64]
...
function _c(r) {
  let t, e, n, i, o, s, a, u, l, c, f, h, p, g, v, d, _, C, E, S, w, D = !1;
  o = new hc({}), f = new au({});
  let R = (
    /*abortController*/
    r[18] && ma()
  ...
  return ~(d = ot(r)) && (_ = G[d] = Y[d](r)), {
    c() {
      t = ze(), e = ht("form"), n = ht("div"), i = ht("button"), Rr(o.$$.fragment), s = ze(), a = ht("input"), u = ze(), l = ht("div"), c = ht("button"), Rr(f.$$.fragment), h = ze(), R && R.c(), p = ze(), T && T.c(), g = ze(), A && A.c(), v = ze(), _ && _.c(), P(i, "class", "search-button svelte-1r7dvt7"), P(i, "type", "button"), P(
        a,
        "placeholder",
        /*placeholder*/
        r[8]
        ...
        /*clearButtonTitle*/
        r[3]
      ), P(c, "class", "svelte-1r7dvt7"), P(l, "class", "clear-button-container svelte-1r7dvt7"), sn(
        l,
        "displayable",
        /*searchValue*/
        r[1] !== ""
      ), P(n, "class", "input-group svelte-1r7dvt7"), P(e, "tabindex", "0"), P(e, "class", C = ca(
        /*className*/
        r[2]
      ) + " svelte-1r7dvt7"), sn(
        e,
    ...
    m(N, k) {
      Dt(N, t, k), Dt(N, e, k), nt(e, n), nt(n, i), cr(o, i, null), nt(n, s), nt(n, a), r[57](a), fa(
        a,
        /*searchValue*/
        r[1]
      ), nt(n, u), nt(n, l), nt(l, c), cr(f, c, null), nt(l, h), R && R.m(l, null), nt(n, p), T && T.m(n, null), nt(n, g), A && A.m(n, null), nt(e, v), ~d && G[d].m(e, null), E = !0, S || (w = [
        Ce(
          i,
          "click",
          /*click_handler*/
    ...
    p(N, k) {
      ...
      32 && At(T, 1)) : (T = _a(N), T.c(), At(T, 1), T.m(n, g)) : T && (Fo(), Jt(T, 1, 1, () => {
        T = null;
...
function Ec(r, t, e) {
  ...
  let pi = !1, lt, pe, rt, ia = "", Gn, Mt = -1, Vn, xo = [], Hr, di, So, hs;
  ...
  function oa(x) {
    if (di && (clearTimeout(di), di = void 0), Mt > -1 && lt)
      e(51, rt = lt[Mt]), e(1, G = rt.place_name.replace(/,.*/, "")), e(17, Vn = void 0), e(50, pe = void 0), e(14, Mt = -1);
    else if (G) {
      const Vt = x || !sa();
      gs(G, { exact: !0 }).then(() => {
        e(50, pe = lt), e(51, rt = void 0), Vt && al();
      }).catch((zn) => e(17, Vn = zn));
    }
  }
  function sa() {
  ...
  async function gs(x, { byId: Vt = !1, exact: zn = !1 } = {}) {
    e(17, Vn = void 0), Hr == null || Hr.abort();
    const Un = new AbortController();
    e(18, Hr = Un);
    try {
      const Ee = sa(), xn = new URLSearchParams();
      if (E !== void 0 && xn.set("language", Array.isArray(E) ? E.join(",") : E ?? ""), K && xn.set("types", K.join(",")), u && xn.set("bbox", u.map((Lo) => Lo.toFixed(6)).join(",")), h && xn.set("country", Array.isArray(h) ? h.join(",") : h), !Vt && !Ee) {
        const Lo = await pc(w, L, Un);
        Lo && xn.set("proximity", Lo), (zn || !k) && xn.set("autocomplete", "false"), xn.set("fuzzyMatch", String(C));
      }
      S !== void 0 && (!Ee || (K == null ? void 0 : K.length) === 1) && xn.set("limit", String(S)), xn.set("key", a), Cn(xn);
      const wo = ge + "/" + encodeURIComponent(x) + ".json?" + xn.toString();
      if (wo === ia) {
        Vt ? (e(13, lt = void 0), e(51, rt = xo[0])) : e(13, lt = xo);
        return;
      }
      ia = wo;
      ...
      Cr("response", { url: wo, featureCollection: vs }), Vt ? (e(13, lt = void 0), e(51, rt = vs.features[0]), xo = [rt]) : (e(13, lt = vs.features.filter(d)), xo = lt, Ee && Gn.focus());
    } catch (Ee) {
  ...
  function al() {
    ...
    if (!(pe != null && pe.length) || !_)
      return;
    const x = [180, 90, -180, -90], Vt = !pe.some((Un) => !Un.matching_text);
    for (const Un of pe)
      if (Vt || !Un.matching_text)
        for (const Ee of [0, 1, 2, 3])
          x[Ee] = Math[Ee < 2 ? "min" : "max"](x[Ee], ((zn = Un.bbox) == null ? void 0 : zn[Ee]) ?? Un.center[Ee % 2]);
    w && pe.length > 0 && (rt && x[0] === x[2] && x[1] === x[3] ? w.flyTo(rt.center, dt) : w.fitBounds(va(x), 50, Gt));
  }
  function ul(x) {
    e(0, A = g === "always"), sr(gc(x[0], [-180, 180], !0).toFixed(6) + "," + x[1].toFixed(6));
  }
  function ll(x) {
    if (!lt)
      return;
  ...
  function ds(x) {
    e(51, rt = x), e(1, G = x.place_name), e(14, Mt = -1);
  }
  const cl = () => Gn.focus();
  function fl(x) {
    xs[x ? "unshift" : "push"](() => {
  ...
  const gl = () => e(12, pi = !0), pl = () => e(12, pi = !1), dl = () => ps(), vl = () => {
    e(1, G = ""), Gn.focus();
  }, yl = () => e(0, A = !A), ml = () => e(17, Vn = void 0), _l = (x) => e(14, Mt = x), El = (x) => ds(x), Il = () => e(14, Mt = -1), Cl = () => {
  };
  return r.$$set = (x) => {
    "class" in x && e(2, s = x.class), "apiKey" in x && e(24, a = x.apiKey), "bbox" in x && e(25, u = x.bbox), "clearButtonTitle" in x && e(3, l = x.clearButtonTitle), "clearOnBlur" in x && e(26, c = x.clearOnBlur), "collapsed" in x && e(4, f = x.collapsed), "country" in x && e(27, h = x.country), "debounceSearch" in x && e(28, p = x.debounceSearch), "enableReverse" in x && e(5, g = x.enableReverse), "errorMessage" in x && e(6, v = x.errorMessage), "filter" in x && e(29, d = x.filter), "flyTo" in x && e(30, _ = x.flyTo), "fuzzyMatch" in x && e(31, C = x.fuzzyMatch), "language" in x && e(32, E = x.language), "limit" in x && e(33, S = x.limit), "mapController" in x && e(34, w = x.mapController), "minLength" in x && e(35, D = x.minLength), "noResultsMessage" in x && e(7, R = x.noResultsMessage), "placeholder" in x && e(8, T = x.placeholder), "proximity" in x && e(36, L = x.proximity), "reverseActive" in x && e(0, A = x.reverseActive), "reverseButtonTitle" in x && e(9, Y = x.reverseButtonTitle), "searchValue" in x && e(1, G = x.searchValue), "showFullGeometry" in x && e(37, ot = x.showFullGeometry), "showPlaceType" in x && e(10, N = x.showPlaceType), "showResultsWhileTyping" in x && e(38, k = x.showResultsWhileTyping), "types" in x && e(39, K = x.types), "zoom" in x && e(40, dt = x.zoom), "maxZoom" in x && e(41, Gt = x.maxZoom), "apiUrl" in x && e(42, ge = x.apiUrl), "fetchParameters" in x && e(43, or = x.fetchParameters), "iconsBaseUrl" in x && e(11, $e = x.iconsBaseUrl), "adjustUrlQuery" in x && e(44, Cn = x.adjustUrlQuery), "$$scope" in x && e(54, o = x.$$scope);
  }, r.$$.update = () => {
    ...
    16 && G.length < D && (e(51, rt = void 0), e(13, lt = void 0), e(17, Vn = void 0), e(50, pe = lt)), r.$$.dirty[1] & /*showFullGeometry, picked*/
    1048640 && ot && rt && !rt.address && rt.geometry.type === "Point" && gs(rt.id, { byId: !0 }).catch((x) => e(17, Vn = x)), r.$$.dirty[0] & /*flyTo*/
    1073741824 | r.$$.dirty[1] & /*mapController, picked, prevIdToFly, maxZoom, zoom*/
    3147272 && (w && rt && rt.id !== hs && _ && (!rt.bbox || rt.bbox[0] === rt.bbox[2] && rt.bbox[1] === rt.bbox[3] ? w.flyTo(rt.center, rt.id.startsWith("poi.") || rt.id.startsWith("address.") ? Gt : dt) : w.fitBounds(va(rt.bbox), 50, Gt), e(13, lt = void 0), e(50, pe = void 0), e(14, Mt = -1)), e(52, hs = rt == null ? void 0 : rt.id)), r.$$.dirty[0] & /*listFeatures*/
    ...
    8 && w && w.setEventHandler((x) => {
      switch (x.type) {
        ...
        case "markerClick":
          {
            const Vt = lt == null ? void 0 : lt.find((zn) => zn.id === x.id);
            Vt && ds(Vt);
          }
          break;
    ...
    1048576 && Cr("pick", rt), r.$$.dirty[0] & /*focusedDelayed, listFeatures*/
    ...
    1 && Cr("reverseToggle", A), r.$$.dirty[0] & /*searchValue*/
    2 && Cr("queryChange", G), r.$$.dirty[0] & /*reverseActive*/
...
var zs = (
  ...
  function() {
    ...
    return r.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = Es(e, n, a, i) : s = Es(e, n, s, i), this._root = xc(s, a, i);
...
var bc = wr * wr, Ds = function(t, e) {
  if (-wr < t && t < wr && -wr < e && e < wr)
    return 0;
  var n = t - e;
  return n * n < bc * t * e ? 0 : t < e ? -1 : 1;
  ...
  var s = {
    x: n.x - t.x,
    y: n.y - t.y
  }, a = Ji(s, e) / o, u = Ji(s, i) / o, l = t.x + u * e.x, c = n.x + a * i.x, f = t.y + u * e.y, h = n.y + a * i.y, p = (l + c) / 2, g = (f + h) / 2;
  return {
    x: p,
    y: g
  };
  ...
  return Se(r, [{
    ...
    value: function(e) {
      var n = this, i = /* @__PURE__ */ new Map(), o = function(a) {
        var u = a.otherSE;
        i.set(a, {
          sine: Rc(n.point, e.point, u.point),
          cosine: Oc(n.point, e.point, u.point)
        });
      };
      return function(s, a) {
  ...
  Se(r, null, [{
    ...
    value: function(e, n) {
      ...
      if (i > o) {
        ...
        if (u > l && u > f)
          return 1;
        var g = n.comparePoint(e.leftSE.point);
        if (g !== 0)
          return g;
  ...
  function r(t, e, n, i) {
    _n(this, r), this.id = ++Tc, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = n, this.windings = i;
  }
  return Se(r, [{
    key: "replaceRightSE",
    ...
    value: function(e) {
      ...
      if (o === null)
        return null;
      var s = this.leftSE.point, a = this.rightSE.point, u = e.leftSE.point, l = e.rightSE.point, c = Wi(n, u) && this.comparePoint(u) === 0, f = Wi(i, s) && e.comparePoint(s) === 0, h = Wi(n, l) && this.comparePoint(l) === 0, p = Wi(i, a) && e.comparePoint(a) === 0;
      if (f && c)
    ...
    value: function() {
      ...
      for (var f = [], h = [], p = 0, g = n.length; p < g; p++)
        if (i[p] !== 0) {
          var v = n[p], d = v.poly;
          if (h.indexOf(d) === -1)
            if (v.isExterior)
  ...
  return Se(r, [{
    ...
    value: function() {
      ...
      for (var c = this.isExteriorRing() ? 1 : -1, f = this.isExteriorRing() ? 0 : n.length - 1, h = this.isExteriorRing() ? n.length : -1, p = [], g = f; g != h; g += c)
        p.push([n[g].x, n[g].y]);
      return p;
    }
  }, {
      ...
      if (e.isLeft) {
        ...
        if (c !== null || v !== null) {
          ...
          if (c === null)
            ...
            var w = Hn.comparePoints(c, v);
            S = w <= 0 ? c : v;
          }
          this.queue.remove(n.rightSE), i.push(n.rightSE);
          for (var D = n.split(S), R = 0, T = D.length; R < T; R++)
            i.push(D[R]);
        }
  ...
  return Se(r, [{
    ...
    value: function(e, n, i) {
      ...
      for (var v = new zs(Hn.compare), d = 0, _ = o.length; d < _; d++)
...
function pu(r, t, e) {
  if (r !== null)
    for (var n, i, o, s, a, u, l, c = 0, f = 0, h, p = r.type, g = p === "FeatureCollection", v = p === "Feature", d = g ? r.features.length : 1, _ = 0; _ < d; _++) {
      l = g ? r.features[_].geometry : v ? r.geometry : r, h = l ? l.type === "GeometryCollection" : !1, a = h ? l.geometries.length : 1;
      for (var C = 0; C < a; C++) {
        var E = 0, S = 0;
...
function du(r, t) {
  var e, n, i, o, s, a, u, l, c, f, h = 0, p = r.type === "FeatureCollection", g = r.type === "Feature", v = p ? r.features.length : 1;
  for (e = 0; e < v; e++) {
    for (a = p ? r.features[e].geometry : g ? r.geometry : r, l = p ? r.features[e].properties : g ? r.properties : {}, c = p ? r.features[e].bbox : g ? r.bbox : void 0, f = p ? r.features[e].id : g ? r.id : void 0, u = a ? a.type === "GeometryCollection" : !1, s = u ? a.geometries.length : 1, i = 0; i < s; i++) {
...
Ue.intersection = function(t, e, n, i) {
  var o = t.y - e.y, s = e.x - t.x, a = t.x * e.y - e.x * t.y, u = n.y - i.y, l = i.x - n.x, c = n.x * i.y - i.x * n.y, f = s * c - l * a, h = u * a - o * c, p = o * l - u * s, g = f / p, v = h / p;
...
es.prototype.read = function(t) {
  var e, n, i;
  t = t.replace(/[\n\r]/g, " ");
  var o = en.typeStr.exec(t);
  if (t.search("EMPTY") !== -1 && (o = en.emptyTypeStr.exec(t), o[2] = void 0), o && (n = o[1].toLowerCase(), i = o[2], mi[n] && (e = mi[n].apply(this, [i]))), e === void 0)
...
var Xn = {
  ...
  multipoint: function(t) {
    ...
    for (var n, i = t.trim().split(","), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(en.trimParens, "$1"), o.push(mi.point.apply(e, [n]));
  ...
  linestring: function(t) {
    ...
    for (var e = t.trim().split(","), n = [], i, o = 0, s = e.length; o < s; ++o)
      i = e[o].trim().split(en.spaces), n.push(new y(Number.parseFloat(i[0]), Number.parseFloat(i[1])));
  ...
  multilinestring: function(t) {
    ...
    for (var n, i = t.trim().split(en.parenComma), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(en.trimParens, "$1"), o.push(mi.linestring.apply(e, [n]));
  ...
  polygon: function(t) {
    ...
    for (var n, i, o, s = t.trim().split(en.parenComma), a, u = [], l = 0, c = s.length; l < c; ++l)
      n = s[l].replace(en.trimParens, "$1"), i = mi.linestring.apply(e, [n]), o = e.geometryFactory.createLinearRing(i._points), l === 0 ? a = o : u.push(o);
  ...
  multipolygon: function(t) {
    ...
    for (var n, i = t.trim().split(en.doubleParenComma), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(en.trimParens, "$1"), o.push(mi.polygon.apply(e, [n]));
...
var Xr = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.isInSegmentEnvelopes = function(n) {
    ...
    var u = n.x < i.x ? n.x : i.x, l = n.y < i.y ? n.y : i.y, c = n.x > i.x ? n.x : i.x, f = n.y > i.y ? n.y : i.y, h = o.x < s.x ? o.x : s.x, p = o.y < s.y ? o.y : s.y, g = o.x > s.x ? o.x : s.x, v = o.y > s.y ? o.y : s.y, d = u > h ? u : h, _ = c < g ? c : g, C = l > p ? l : p, E = f < v ? f : v, S = (d + _) / 2, w = (C + E) / 2;
    a.x = S, a.y = w, n.x -= a.x, n.y -= a.y, i.x -= a.x, i.y -= a.y, o.x -= a.x, o.y -= a.y, s.x -= a.x, s.y -= a.y;
...
Oe.prototype.getBoundary = function() {
  return this._geom instanceof yt ? this.boundaryLineString(this._geom) : this._geom instanceof Dr ? this.boundaryMultiLineString(this._geom) : this._geom.getBoundary();
};
...
var H = function r() {
  this._precisionModel = new $(), this._SRID = 0, this._coordinateSequenceFactory = r.getDefaultCoordinateSequenceFactory(), arguments.length === 0 || (arguments.length === 1 ? z(arguments[0], Ii) ? this._coordinateSequenceFactory = arguments[0] : arguments[0] instanceof $ && (this._precisionModel = arguments[0]) : arguments.length === 2 ? (this._precisionModel = arguments[0], this._SRID = arguments[1]) : arguments.length === 3 && (this._precisionModel = arguments[0], this._SRID = arguments[1], this._coordinateSequenceFactory = arguments[2]));
...
ss.prototype.read = function(t) {
  ...
  return of.indexOf(n) !== -1 ? rn[n].apply(this, [e.coordinates]) : n === "GeometryCollection" ? rn[n].apply(this, [e.geometries]) : rn[n].apply(this, [e]);
};
...
var rn = {
  ...
  Feature: function(r) {
    ...
    return r.bbox && (t.bbox = rn.bbox.apply(this, [r.bbox])), t;
  },
  /**
  ...
  LineString: function(r) {
    var t = rn.coordinates.apply(this, [r]);
  ...
  MultiLineString: function(r) {
    for (var t = this, e = [], n = 0; n < r.length; ++n)
      e.push(rn.LineString.apply(t, [r[n]]));
   ...
   */
  Polygon: function(r) {
    for (var t = this, e = rn.coordinates.apply(this, [r[0]]), n = this.geometryFactory.createLinearRing(e), i = [], o = 1; o < r.length; ++o) {
      var s = r[o], a = rn.coordinates.apply(t, [s]), u = t.geometryFactory.createLinearRing(a);
      i.push(u);
    }
...
Ft.prototype.size = function() {
  ...
  if (arguments.length === 1) {
    for (var e = arguments[0], n = 0, i = e.getChildBoundables().iterator(); i.hasNext(); ) {
      var o = i.next();
      o instanceof Ot ? n += t.size(o) : o instanceof He && (n += 1);
    }
    return n;
  }
};
Ft.prototype.removeItem = function(t, e) {
  for (var n = null, i = t.getChildBoundables().iterator(); i.hasNext(); ) {
    var o = i.next();
    o instanceof He && o.getItem() === e && (n = o);
  }
...
Ft.prototype.query = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (z(arguments[2], gr) && arguments[0] instanceof Object && arguments[1] instanceof Ot)
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[0] instanceof t && z(arguments[1], Ri)) {
        ...
        var c = arguments[0], f = arguments[1], h = f, p = null, g = new tr();
...
ct.prototype.addLimitedMitreJoin = function(t, e, n, i) {
  var o = this._seg0.p1, s = j.angle(o, this._seg0.p0), a = j.angleBetweenOriented(this._seg0.p0, o, this._seg1.p1), u = a / 2, l = j.normalize(s + u), c = j.normalize(l + Math.PI), f = i * n, h = f * Math.abs(Math.sin(u)), p = n - h, g = o.x + f * Math.cos(c), v = o.y + f * Math.sin(c), d = new y(g, v), _ = new B(o, d), C = _.pointAlongOffset(1, p), E = _.pointAlongOffset(1, -p);
...
tt.interpolateZ = function(t, e, n, i) {
  var o = e.x, s = e.y, a = n.x - o, u = i.x - o, l = n.y - s, c = i.y - s, f = a * c - u * l, h = t.x - o, p = t.y - s, g = (c * h - u * p) / f, v = (-l * h + a * p) / f, d = e.z + g * (n.z - e.z) + v * (i.z - e.z);
  return d;
};
...
tt.circumcentre = function(t, e, n) {
  var i = n.x, o = n.y, s = t.x - i, a = t.y - o, u = e.x - i, l = e.y - o, c = 2 * tt.det(s, a, u, l), f = tt.det(a, s * s + a * a, l, u * u + l * l), h = tt.det(s, s * s + a * a, u, u * u + l * l), p = i - f / c, g = o + h / c;
  return new y(p, g);
};
...
tt.area3D = function(t, e, n) {
  var i = e.x - t.x, o = e.y - t.y, s = e.z - t.z, a = n.x - t.x, u = n.y - t.y, l = n.z - t.z, c = o * l - s * u, f = s * a - i * l, h = i * u - o * a, p = c * c + f * f + h * h, g = Math.sqrt(p) / 2;
  return g;
};
...
Be.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof Tt ? this.addPolygon(t) : t instanceof yt ? this.addLineString(t) : t instanceof ve ? this.addPoint(t) : t instanceof Li ? this.addCollection(t) : t instanceof Dr ? this.addCollection(t) : t instanceof Ln ? this.addCollection(t) : t instanceof ie && this.addCollection(t);
};
...
vn.prototype.checkInteriorIntersections = function() {
  ...
  if (arguments.length === 0)
    ...
    if (this._li.computeIntersection(d, _, C, E), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, d, _) || this.hasInteriorIntersection(this._li, C, E)))
      throw new Zn("found non-noded intersection at " + d + "-" + _ + " and " + C + "-" + E);
  }
};
...
Mn.prototype.checkCorrectness = function(t) {
  var e = Nt.getNodedSubstrings(t), n = new vn(e);
  try {
    n.checkValid();
  } catch (i) {
    if (i instanceof _u)
...
Ut.prototype.bufferFixedPrecision = function(t) {
  var e = new vr(new Mn(new $(1)), t.getScale()), n = new re(this._bufParams);
...
Kn.getPolygons = function() {
  if (arguments.length === 1) {
    ...
    var e = arguments[0], n = arguments[1];
    return e instanceof Tt ? n.add(e) : e instanceof ie && e.apply(new Kn(n)), n;
  }
};
var zt = function() {
...
ur.getPoints = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return t instanceof ve ? We.singletonList(t) : ur.getPoints(t, new O());
  } else if (arguments.length === 2) {
    var e = arguments[0], n = arguments[1];
    return e instanceof ve ? n.add(e) : e instanceof ie && e.apply(new ur(n)), n;
  }
};
var ni = function() {
...
on.computeDistance = function() {
  if (arguments[2] instanceof jt && arguments[0] instanceof yt && arguments[1] instanceof y)
    ...
    var h = arguments[0], p = arguments[1], g = arguments[2];
    if (h instanceof yt)
      on.computeDistance(h, p, g);
    else if (h instanceof Tt)
      on.computeDistance(h, p, g);
    else if (h instanceof ie)
      for (var v = h, d = 0; d < v.getNumGeometries(); d++) {
        var _ = v.getGeometryN(d);
        on.computeDistance(_, p, g);
      }
    else
      g.setMinimum(h.getCoordinate(), p);
...
Bn.prototype.buildTree = function() {
  var t = this;
  We.sort(this._leaves, new Fn.NodeComparator());
...
var ji = function(r) {
  function t() {
    if (r.call(this), this._parentGeom = null, this._lineEdgeMap = new Nu(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new Ke(), arguments.length === 2) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(n, i) {
    ...
    return z(this._parentGeom, hr) && this._parentGeom.getNumGeometries() > 50 ? (this._areaPtLocator === null && (this._areaPtLocator = new Mi(this._parentGeom)), this._areaPtLocator.locate(n)) : this._ptLocator.locate(n, this._parentGeom);
...
br.map = function() {
  if (arguments[0] instanceof V && z(arguments[1], br.MapOp)) {
  ...
  } else if (z(arguments[0], bt) && z(arguments[1], br.MapOp)) {
...
var q = function(r) {
  function t() {
    var e = arguments[0], n = arguments[1];
    r.call(this, e, n), this._ptLocator = new Ke(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new je(), this._resultPolyList = new O(), this._resultLineList = new O(), this._resultPointList = new O(), this._graph = new pt(new Ou()), this._geomFact = e.getFactory();
  }
...
St.prototype.reduceToGeometries = function(t) {
  for (var e = this, n = new O(), i = t.iterator(); i.hasNext(); ) {
    var o = i.next(), s = null;
    z(o, qe) ? s = e.unionTree(o) : o instanceof V && (s = o), n.add(s);
  }
  return n;
};
...
var vt = 1e-6, st = Math.PI, jn = st / 2, ka = st / 4, nr = st * 2, xr = 180 / st, nn = st / 180, ne = Math.abs, gf = Math.atan, ki = Math.atan2, Pt = Math.cos, Rt = Math.sin, Yi = Math.sqrt;
function qu(r) {
...
function Xa(r, t) {
  ...
  function s(a, u) {
    var l = Pt(u), c = Pt(a) * l, f = Rt(a) * l, h = Rt(u), p = h * e + c * n;
    return [
      ki(f * i - p * o, c * e - h * n),
      ai(p * i + f * o)
    ];
...
function vf(r, t, e, n, i, o) {
  if (e) {
    ...
    for (var l, c = i; n > 0 ? c > o : c < o; c -= u)
      l = Bs([s, -a * Pt(c), -a * Rt(c)]), r.point(l[0], l[1]);
  }
}
function Ya(r, t) {
  t = Gi(t), t[0] -= r, ks(t);
...
function yf(r, t, e, n, i, o) {
  var s = r[0], a = r[1], u = t[0], l = t[1], c = 0, f = 1, h = u - s, p = l - a, g;
  if (g = e - s, !(!h && g > 0)) {
    if (g /= h, h < 0) {
      if (g < c)
        return;
    ...
    if (g = i - s, !(!h && g < 0)) {
      ...
      if (g = n - a, !(!p && g > 0)) {
        ...
        if (g = o - a, !(!p && g < 0)) {
          ...
          return c > 0 && (r[0] = s + c * h, r[1] = a + c * p), f < 1 && (t[0] = s + f * h, t[1] = a + f * p), !0;
        }
      }
    }
  }
  ...
  return function(l) {
    ...
    function L() {
      for (var k = 0, K = 0, dt = p.length; K < dt; ++K)
        for (var Gt = p[K], ge = 1, or = Gt.length, $e = Gt[0], Cn, Nn, gi = $e[0], sr = $e[1]; ge < or; ++ge)
          Cn = gi, Nn = sr, $e = Gt[ge], gi = $e[0], sr = $e[1], Nn <= n ? sr > n && (gi - Cn) * (n - Nn) > (sr - Nn) * (r - Cn) && ++k : sr <= n && (gi - Cn) * (n - Nn) < (sr - Nn) * (r - Cn) && --k;
      return k;
    }
    function A() {
      c = f, h = [], p = [], D = !0;
    ...
    function N(k, K) {
      ...
      if (p && g.push([k, K]), w)
        ...
        yf(Gt, ge, r, t, e, n) ? (S || (c.lineStart(), c.point(Gt[0], Gt[1])), c.point(ge[0], ge[1]), dt || c.lineEnd(), D = !1) : dt && (c.lineStart(), c.point(k, K), D = !1);
      }
      C = k, E = K, S = dt;
    }
    return R;
  ...
  for (var a = 0, u = r.length; a < u; ++a)
    if (c = (l = r[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], p = f[1] / 2 + ka, g = Rt(p), v = Pt(p), d = 0; d < c; ++d, h = C, g = S, v = w, f = _) {
        ...
        if (Ns.add(ki(A * R * Rt(T), v * w + A * Pt(T))), o += L ? D + R * nr : D, L ^ h >= e ^ C >= e) {
          var Y = Qo(Gi(f), Gi(_));
          ks(Y);
          var G = Qo(i, Y);
          ks(G);
...
function Ku(r, t, e, n) {
  return function(i, o) {
    var s = t(o), a = i.invert(n[0], n[1]), u = Yu(), l = t(u), c = !1, f, h, p, g = {
      point: v,
      lineStart: _,
      lineEnd: C,
...
function Sf(r) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      ne(u - st) < vt ? (r.point(t, e = (e + s) / 2 > 0 ? jn : -jn), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), r.point(o, e), i = 0) : n !== a && u >= st && (ne(t - n) < vt && (t -= n * vt), ne(o - a) < vt && (o -= a * vt), e = wf(t, e, o, s), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), i = 0), r.point(t = o, e = s), n = a;
    },
    lineEnd: function() {
      r.lineEnd(), t = e = NaN;
    },
...
function wf(r, t, e, n) {
  var i, o, s = Rt(r - e);
  return ne(s) > vt ? gf((Rt(t) * (o = Pt(n)) * Rt(e) - Rt(n) * (i = Pt(t)) * Rt(r)) / (i * o * s)) : (t + n) / 2;
}
function Lf(r, t, e, n) {
  var i;
  if (r == null)
...
function bf(r, t) {
  ...
  function a(c) {
    ...
    return {
      ...
      point: function(d, _) {
        var C = [d, _], E, S = s(d, _), w = n ? S ? 0 : l(d, _) : S ? l(d + (d < 0 ? st : -st), _) : 0;
        if (!f && (g = p = S) && c.lineStart(), S !== p && (E = u(f, C), (!E || ko(f, E) || ko(C, E)) && (C[0] += vt, C[1] += vt, S = s(C[0], C[1]))), S !== p)
          ...
          var D;
          !(w & h) && (D = u(C, f, !0)) && (v = 0, n ? (c.lineStart(), c.point(D[0][0], D[0][1]), c.point(D[1][0], D[1][1]), c.lineEnd()) : (c.point(D[1][0], D[1][1]), c.lineEnd(), c.lineStart(), c.point(D[0][0], D[0][1])));
        }
  ...
  function u(c, f, h) {
    ...
    if (!(G < 0)) {
      ...
      K < k && (ge = k, k = K, K = ge);
      var or = K - k, $e = ne(or - st) < vt, Cn = $e || or < vt;
      if (!$e && Gt < dt && (ge = dt, dt = Gt, Gt = ge), Cn ? $e ? dt + Gt > 0 ^ N[1] < (ne(N[0] - k) < vt ? dt : Gt) : dt <= N[1] && N[1] <= Gt : or > st ^ (k <= N[0] && N[0] <= K)) {
        var Nn = Do(L, (-A + ot) / Y);
        return Cs(Nn, R), [N, Bs(Nn)];
      }
    }
  }
  function l(c, f) {
...
function Df(r, t) {
  function e(n, i, o, s, a, u, l, c, f, h, p, g, v, d) {
    var _ = l - n, C = c - i, E = _ * _ + C * C;
    if (E > 4 * t && v--) {
      var S = s + h, w = a + p, D = u + g, R = Yi(S * S + w * w + D * D), T = ai(D /= R), L = ne(ne(D) - 1) < vt || ne(o - f) < vt ? (o + f) / 2 : ki(w, S), A = r(L, T), Y = A[0], G = A[1], ot = Y - n, N = G - i, k = C * ot - _ * N;
      (k * k / E > t || ne((_ * ot + C * N) / E - 0.5) > 0.3 || s * h + a * p + u * g < Rf) && (e(n, i, o, s, a, u, Y, G, L, S /= R, w /= R, D, v, d), d.point(Y, G), e(Y, G, L, S, w, D, l, c, f, h, p, g, v, d));
    }
  }
  return function(n) {
    ...
    function E(T, L) {
      var A = Gi([T, L]), Y = r(T, L);
      e(f, h, c, p, g, v, f = Y[0], h = Y[1], c = T, p = A[0], g = A[1], v = A[2], Qa, n), n.point(f, h);
    }
    function S() {
      d.point = _, n.lineEnd();
    }
    ...
    function R() {
      e(f, h, c, p, g, v, o, s, i, a, u, l, Qa, n), d.lineEnd = S, S();
    }
    return d;
  };
}
...
function Af(r) {
  var t, e = 150, n = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, p, g = null, v = Ka, d = null, _, C, E, S = Wa, w = 0.5, D = Za(Y, w), R, T;
  function L(N) {
    return N = p(N[0] * nn, N[1] * nn), [N[0] * e + o, s - N[1] * e];
  }
  function A(N) {
    return N = p.invert((N[0] - o) / e, (s - N[1]) / e), N && [N[0] * xr, N[1] * xr];
  }
  function Y(N, k) {
  ...
  L.stream = function(N) {
    ...
    return arguments.length ? (v = +N ? bf(g = N * nn, 6 * nn) : (g = null, Ka), ot()) : g * xr;
    ...
    return arguments.length ? (a = N[0] % 360 * nn, u = N[1] % 360 * nn, G()) : [a * xr, u * xr];
  }, L.rotate = function(N) {
    return arguments.length ? (l = N[0] % 360 * nn, c = N[1] % 360 * nn, f = N.length > 2 ? N[2] % 360 * nn : 0, G()) : [l * xr, c * xr, f * xr];
...
function $u(r) {
  return function(t, e) {
    var n = Yi(t * t + e * e), i = r(n), o = Rt(i), s = Pt(i);
    return [
      ki(t * o, n * s),
      ai(n && e * o / n)
    ];
...
function Go(r, t, e, n) {
  ...
  }, l = new Ks(), c = l.read(u), f = Yc(Hc(t, e), "meters"), h = Ut.bufferOp(c, f, n), p = new Su();
...
function zf(r, t, e = !0, n = !0, i = {}, o = {}, s = {
  ...
  return {
    setEventHandler(g) {
      g ? (a = g, r.on("click", h)) : (a = void 0, r.off("click", h));
    },
    flyTo(g, v) {
      r.flyTo({ center: g, zoom: v, ...i });
    },
    fitBounds(g, v, d) {
      r.fitBounds(
        [
    ...
    indicateReverse(g) {
      r.getCanvasContainer().style.cursor = g ? "crosshair" : "";
    },
    setReverseMarker(g) {
      !t || !e || (c ? g ? c.setLngLat(g) : (c.remove(), c = void 0) : g && (c = (typeof e == "object" ? new t.Marker(e) : p()).setLngLat(g).addTo(r), c.getElement().classList.add("marker-reverse")));
    },
    setMarkers(g, v) {
      if (!e)
        return;
      ...
      if (u.length = 0, d(eu), !!t) {
        if (v) {
          ...
          e && u.push(
            (typeof e == "object" ? new t.Marker(e) : p()).setLngLat(v.center).addTo(r)
          );
        }
        if (n)
          for (const _ of g ?? []) {
            if (_ === v)
              continue;
            const C = (typeof n == "object" ? new t.Marker(n) : p(!0)).setLngLat(_.center).setPopup(
              new t.Popup({
                offset: [1, -27],
                closeButton: !1,
                closeOnMove: !0,
...
class Uf extends EventTarget {
  ...
  onAdd(e) {
    ...
    const {
      ...
      fullGeometryStyle: a,
      ...u
    } = tn(this, jr), l = typeof s == "boolean" ? {} : s, c = this.getExtraProps(e, n), h = {
      mapController: zf(
        e,
        this.getMapLibreGl(),
        i,
    ...
    bo(this, Ve, new Ic({ target: n, props: h }));
    for (const p of [
      "select",
      "pick",
      "featuresListed",
      ...
      tn(this, Ve).$on(p, (g) => this.dispatchEvent(g));
    return n;
  }
  setOptions(e) {
    var u;
    ...
    (u = tn(this, Ve)) == null || u.$set(a);
  }
  setQuery(e, n = !0) {
    var i;
    (i = tn(this, Ve)) == null || i.setQuery(e, n);
  }
  clearMap() {
    var e;
    (e = tn(this, Ve)) == null || e.clearMap();
  }
  clearList() {
    var e;
    (e = tn(this, Ve)) == null || e.clearList();
  }
  setReverseMode(e) {
    var n;
    (n = tn(this, Ve)) == null || n.$set({ reverseActive: e });
  }
  focus() {
    var e;
    (e = tn(this, Ve)) == null || e.focus();
  }
  blur() {
    var e;
    (e = tn(this, Ve)) == null || e.blur();
  }
  onRemove() {
    var e;
    (e = tn(this, Ve)) == null || e.$destroy();
  }
}
