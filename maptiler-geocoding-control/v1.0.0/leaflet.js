...
function Ul(r, t, e, n, i, o, s, a, u, l, c, f) {
  ...
  for (; p--; )
    v[r[p].key] = p;
  const d = [], I = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), _ = [];
  for (p = g; p--; ) {
    const M = f(i, o, p), A = e(M);
    let L = s.get(A);
    L ? n && _.push(() => L.p(M, t)) : (L = l(A, M), L.c()), I.set(A, d[p] = L), A in v && C.set(A, Math.abs(p - v[A]));
  }
  const x = /* @__PURE__ */ new Set(), N = /* @__PURE__ */ new Set();
  function w(M) {
    zt(M, 1), M.m(a, c), s.set(M.key, M), c = M.first, g--;
  }
  for (; h && g; ) {
    const M = d[g - 1], A = r[h - 1], L = M.key, F = A.key;
    M === A ? (c = M.first, h--, g--) : I.has(F) ? !s.has(L) || x.has(L) ? w(M) : N.has(F) ? h-- : C.get(L) > C.get(F) ? (N.add(L), w(M)) : (x.add(F), h--) : (u(A, s), h--);
  }
  for (; h--; ) {
    const M = r[h];
    I.has(M.key) || u(M, s);
...
function qr(r, t, e, n, i, o, s = null, a = [-1]) {
  ...
  if (l.ctx = e ? e(r, t.props || {}, (f, h, ...g) => {
    ...
    t.intro && zt(r.$$.fragment), fr(r, t.target, t.anchor), su();
  }
  Ji(u);
}
class Xr {
...
function tc(r) {
  ...
  let x = _(r, -1), N = x(r), w = h && va(r);
  return {
    c() {
      t = ht("li"), N.c(), o = nn(), s = ht("span"), a = ht("span"), u = ht("span"), c = Rr(l), f = nn(), w && w.c(), g = nn(), p = ht("span"), d = Rr(v), P(u, "class", "primary svelte-ltkwvy"), P(a, "class", "svelte-ltkwvy"), P(p, "class", "line2 svelte-ltkwvy"), P(s, "class", "texts svelte-ltkwvy"), P(t, "tabindex", "0"), P(
        t,
        "data-selected",
        /*selected*/
        r[1]
    ...
    m(L, F) {
      Tt(L, t, F), N.m(t, null), nt(t, o), nt(t, s), nt(s, a), nt(a, u), nt(u, c), nt(a, f), w && w.m(a, null), nt(s, g), nt(s, p), nt(p, d), I || (C = [
        Ce(
          t,
          "mouseenter",
          /*mouseenter_handler*/
    ...
    p(L, [F]) {
      var X, R;
      x === (x = _(L, F)) && N ? N.p(L, F) : (N.d(1), N = x(L), N && (N.c(), N.m(t, o))), F & /*feature*/
      1 && l !== (l = /*feature*/
      ...
      L[5])), h ? w ? w.p(L, F) : (w = va(L), w.c(), w.m(a, null)) : w && (w.d(1), w = null), F & /*feature*/
      1 && v !== (v = /*feature*/
      L[0].place_name.replace(/[^,]*,?\s*/, "") + "") && to(d, v), F & /*selected*/
      2 && P(
        t,
        "data-selected",
        /*selected*/
...
function ec(r, t, e) {
  ...
  return r.$$set = (_) => {
    ...
    1848)
      ...
      while (n > -1 && (!h || u.has(h)));
    r.$$.dirty & /*feature*/
    1 && e(6, i = o.id.startsWith("poi.") ? (x = (_ = o.properties) == null ? void 0 : _.categories) == null ? void 0 : x.join(", ") : ((w = (N = o.properties) == null ? void 0 : N.place_type_name) == null ? void 0 : w[0]) ?? o.place_type[0]);
...
function Ea(r) {
  ...
  return e = new sc({}), {
    ...
    m(s, a) {
      Tt(s, t, a), fr(e, t, null), n = !0, i || (o = Ce(
        t,
        "click",
        /*click_handler_2*/
        r[63]
...
function hc(r) {
  ...
  return e = new uu({}), {
    ...
    m(a, u) {
      Tt(a, t, u), fr(e, t, null), nt(t, n), nt(t, i), nt(i, o), s = !0;
    },
    p(a, u) {
...
function pc(r) {
  ...
  return e = new uu({}), u = new au({}), {
    ...
    m(h, g) {
      Tt(h, t, g), fr(e, t, null), nt(t, n), nt(t, i), nt(i, o), nt(t, s), nt(t, a), fr(u, a, null), l = !0, c || (f = Ce(
        a,
        "click",
        /*click_handler_3*/
        r[64]
    ...
    i(h) {
      l || (zt(e.$$.fragment, h), zt(u.$$.fragment, h), l = !0);
    },
    o(h) {
      ue(e.$$.fragment, h), ue(u.$$.fragment, h), l = !1;
    },
    d(h) {
      h && Dt(t), hr(e), hr(u), c = !1, f();
    }
  };
}
function Ia(r, t) {
...
function dc(r) {
  let t, e, n, i, o, s, a, u, l, c, f, h, g, p, v, d, I, C, _, x;
  i = new uc({}), c = new au({});
  let N = (
    /*abortController*/
    r[18] && _a()
  ...
  return ~(v = X(r)) && (d = F[v] = L[v](r)), {
    c() {
      t = ht("form"), e = ht("div"), n = ht("button"), Or(i.$$.fragment), o = nn(), s = ht("input"), a = nn(), u = ht("div"), l = ht("button"), Or(c.$$.fragment), f = nn(), N && N.c(), h = nn(), w && w.c(), g = nn(), A && A.c(), p = nn(), d && d.c(), P(n, "class", "search-button svelte-1r7dvt7"), P(n, "type", "button"), P(
        s,
        "placeholder",
        /*placeholder*/
        r[8]
        ...
        /*searchValue*/
        r[1] !== ""
      ), P(e, "class", "input-group svelte-1r7dvt7"), P(t, "tabindex", "0"), P(t, "class", I = fa(
        /*className*/
        r[2]
      ) + " svelte-1r7dvt7"), on(
        t,
    ...
    m(R, Y) {
      Tt(R, t, Y), nt(t, e), nt(e, n), fr(i, n, null), nt(e, o), nt(e, s), r[57](s), ha(
        s,
        /*searchValue*/
        r[1]
      ), nt(e, a), nt(e, u), nt(u, l), fr(c, l, null), nt(u, f), N && N.m(u, null), nt(e, h), w && w.m(e, null), nt(e, g), A && A.m(e, null), nt(t, p), ~v && F[v].m(t, null), C = !0, _ || (x = [
        Ce(
          n,
          "click",
          /*click_handler*/
    ...
    p(R, Y) {
      ...
      262144 && zt(N, 1) : (N = _a(), N.c(), zt(N, 1), N.m(u, null)) : N && (Bo(), ue(N, 1, 1, () => {
        N = null;
      }), ko()), (!C || Y[0] & /*searchValue*/
      2) && on(
        u,
        "displayable",
        /*searchValue*/
      ...
      32 && zt(w, 1)) : (w = Ea(R), w.c(), zt(w, 1), w.m(e, g)) : w && (Bo(), ue(w, 1, 1, () => {
        w = null;
      }), ko()), A && A.p && (!C || Y[1] & /*$$scope*/
      8388608) && Pl(
        A,
        M,
        R,
      ...
      let D = v;
      v = X(R), v === D ? ~v && F[v].p(R, Y) : (d && (Bo(), ue(F[D], 1, 1, () => {
        F[D] = null;
      }), ko()), ~v ? (d = F[v], d ? d.p(R, Y) : (d = F[v] = L[v](R), d.c()), zt(d, 1), d.m(t, null)) : d = null), (!C || Y[0] & /*className*/
      4 && I !== (I = fa(
        /*className*/
        R[2]
      ) + " svelte-1r7dvt7")) && P(t, "class", I), (!C || Y[0] & /*className, collapsed, searchValue*/
      22) && on(
        t,
        "can-collapse",
        /*collapsed*/
    ...
    i(R) {
      C || (zt(i.$$.fragment, R), zt(c.$$.fragment, R), zt(N), zt(w), zt(A, R), zt(d), C = !0);
    },
    o(R) {
      ue(i.$$.fragment, R), ue(c.$$.fragment, R), ue(N), ue(w), ue(A, R), ue(d), C = !1;
    },
    d(R) {
      R && Dt(t), hr(i), r[57](null), hr(c), N && N.d(), w && w.d(), A && A.d(R), ~v && F[v].d(), _ = !1, Cr(x);
    }
  };
}
function vc(r, t, e) {
  let n, { $$slots: i = {}, $$scope: o } = t, { class: s = void 0 } = t, { apiKey: a } = t, { bbox: u = void 0 } = t, { clearButtonTitle: l = "clear" } = t, { clearOnBlur: c = !1 } = t, { collapsed: f = !1 } = t, { country: h = void 0 } = t, { debounceSearch: g = 200 } = t, { enableReverse: p = !1 } = t, { errorMessage: v = "Something went wrong…" } = t, { filter: d = () => !0 } = t, { flyTo: I = !0 } = t, { fuzzyMatch: C = !0 } = t, { language: _ = void 0 } = t, { limit: x = void 0 } = t, { mapController: N = void 0 } = t, { minLength: w = 2 } = t, { noResultsMessage: M = "Oops! Looks like you're trying to predict something that's not quite right. We can't seem to find what you're looking for. Maybe try double-checking your spelling or try a different search term. Keep on typing - we'll do our best to get you where you need to go!" } = t, { placeholder: A = "Search" } = t, { proximity: L = [{ type: "server-geolocation" }] } = t, { reverseActive: F = p === "always" } = t, { reverseButtonTitle: X = "toggle reverse geocoding" } = t, { searchValue: R = "" } = t, { showFullGeometry: Y = !0 } = t, { showPlaceType: D = "ifNeeded" } = t, { showResultsWhileTyping: H = !0 } = t, { types: rt = void 0 } = t, { zoom: wt = 16 } = t, { maxZoom: kt = 18 } = t, { apiUrl: ge = "https://api.maptiler.com/geocoding" } = t, { fetchParameters: or = {} } = t, { iconsBaseUrl: Ze = "https://cdn.maptiler.com/maptiler-geocoding-control/v1.0.0/icons/" } = t, { adjustUrlQuery: In = (S) => {
  } } = t;
  function Cn() {
    Gn.focus();
  }
  ...
  function sr(S, Gt = !0) {
    e(1, R = S), Gt ? (e(14, Mt = -1), sa()) : (ds(), setTimeout(() => {
      Gn.focus(), Gn.select();
    }));
  }
  function il() {
  ...
  let di = !1, lt, pe, it, oa = "", Gn, Mt = -1, zn, xo = [], Wr, vi, wo, gs;
  ...
  function sa(S) {
    if (vi && (clearTimeout(vi), vi = void 0), Mt > -1 && lt)
      e(51, it = lt[Mt]), e(1, R = it.place_name.replace(/,.*/, "")), e(17, zn = void 0), e(50, pe = void 0), e(14, Mt = -1);
    else if (R) {
      const Gt = S || !aa();
      ps(R, { exact: !0 }).then(() => {
  ...
  async function ps(S, { byId: Gt = !1, exact: Vn = !1 } = {}) {
    e(17, zn = void 0), Wr == null || Wr.abort();
    const Un = new AbortController();
    e(18, Wr = Un);
    try {
      const Ee = aa(), Nn = new URLSearchParams();
      if (_ !== void 0 && Nn.set("language", Array.isArray(_) ? _.join(",") : _ ?? ""), rt && Nn.set("types", rt.join(",")), u && Nn.set("bbox", u.map((bo) => bo.toFixed(6)).join(",")), h && Nn.set("country", Array.isArray(h) ? h.join(",") : h), !Gt && !Ee) {
        const bo = await cc(N, L, Un);
        bo && Nn.set("proximity", bo), (Vn || !H) && Nn.set("autocomplete", "false"), Nn.set("fuzzyMatch", String(C));
      }
      x !== void 0 && (!Ee || (rt == null ? void 0 : rt.length) === 1) && Nn.set("limit", String(x)), Nn.set("key", a), In(Nn);
      ...
      Nr("response", { url: Lo, featureCollection: ys }), Gt ? (e(13, lt = void 0), e(51, it = ys.features[0]), xo = [it]) : (e(13, lt = ys.features.filter(d)), xo = lt, Ee && Gn.focus());
    } catch (Ee) {
  ...
  function al() {
    var Vn;
    if (!(pe != null && pe.length) || !I)
      return;
    const S = [180, 90, -180, -90], Gt = !pe.some((Un) => !Un.matching_text);
    for (const Un of pe)
      if (Gt || !Un.matching_text)
        for (const Ee of [0, 1, 2, 3])
          S[Ee] = Math[Ee < 2 ? "min" : "max"](S[Ee], ((Vn = Un.bbox) == null ? void 0 : Vn[Ee]) ?? Un.center[Ee % 2]);
    N && pe.length > 0 && (it && S[0] === S[2] && S[1] === S[3] ? N.flyTo(it.center, wt) : N.fitBounds(ya(S), 50, kt));
  }
  function ul(S) {
    e(0, F = p === "always"), sr(lc(S[0], [-180, 180], !0).toFixed(6) + "," + S[1].toFixed(6));
  }
  function ll(S) {
    if (!lt)
      return;
  ...
  function vs(S) {
    e(51, it = S), e(1, R = S.place_name), e(14, Mt = -1);
  }
  const cl = () => Gn.focus();
  function fl(S) {
    xs[S ? "unshift" : "push"](() => {
  ...
  function hl() {
    R = this.value, e(1, R), e(12, di), e(26, c);
  }
  const gl = () => e(12, di = !0), pl = () => e(12, di = !1), dl = () => ds(), vl = () => {
    e(1, R = ""), Gn.focus();
  }, yl = () => e(0, F = !F), ml = () => e(17, zn = void 0), _l = (S) => e(14, Mt = S), El = (S) => vs(S), Il = () => e(14, Mt = -1), Cl = () => {
  };
  return r.$$set = (S) => {
    "class" in S && e(2, s = S.class), "apiKey" in S && e(24, a = S.apiKey), "bbox" in S && e(25, u = S.bbox), "clearButtonTitle" in S && e(3, l = S.clearButtonTitle), "clearOnBlur" in S && e(26, c = S.clearOnBlur), "collapsed" in S && e(4, f = S.collapsed), "country" in S && e(27, h = S.country), "debounceSearch" in S && e(28, g = S.debounceSearch), "enableReverse" in S && e(5, p = S.enableReverse), "errorMessage" in S && e(6, v = S.errorMessage), "filter" in S && e(29, d = S.filter), "flyTo" in S && e(30, I = S.flyTo), "fuzzyMatch" in S && e(31, C = S.fuzzyMatch), "language" in S && e(32, _ = S.language), "limit" in S && e(33, x = S.limit), "mapController" in S && e(34, N = S.mapController), "minLength" in S && e(35, w = S.minLength), "noResultsMessage" in S && e(7, M = S.noResultsMessage), "placeholder" in S && e(8, A = S.placeholder), "proximity" in S && e(36, L = S.proximity), "reverseActive" in S && e(0, F = S.reverseActive), "reverseButtonTitle" in S && e(9, X = S.reverseButtonTitle), "searchValue" in S && e(1, R = S.searchValue), "showFullGeometry" in S && e(37, Y = S.showFullGeometry), "showPlaceType" in S && e(10, D = S.showPlaceType), "showResultsWhileTyping" in S && e(38, H = S.showResultsWhileTyping), "types" in S && e(39, rt = S.types), "zoom" in S && e(40, wt = S.zoom), "maxZoom" in S && e(41, kt = S.maxZoom), "apiUrl" in S && e(42, ge = S.apiUrl), "fetchParameters" in S && e(43, or = S.fetchParameters), "iconsBaseUrl" in S && e(11, Ze = S.iconsBaseUrl), "adjustUrlQuery" in S && e(44, In = S.adjustUrlQuery), "$$scope" in S && e(54, o = S.$$scope);
  }, r.$$.update = () => {
    ...
    16 && R.length < w && (e(51, it = void 0), e(13, lt = void 0), e(17, zn = void 0), e(50, pe = lt)), r.$$.dirty[1] & /*showFullGeometry, picked*/
    1048640 && Y && it && !it.address && it.geometry.type === "Point" && ps(it.id, { byId: !0 }).catch((S) => e(17, zn = S)), r.$$.dirty[0] & /*flyTo*/
    1073741824 | r.$$.dirty[1] & /*mapController, picked, prevIdToFly, maxZoom, zoom*/
    3147272 && (N && it && it.id !== gs && I && (!it.bbox || it.bbox[0] === it.bbox[2] && it.bbox[1] === it.bbox[3] ? N.flyTo(it.center, it.id.startsWith("poi.") || it.id.startsWith("address.") ? kt : wt) : N.fitBounds(ya(it.bbox), 50, kt), e(13, lt = void 0), e(50, pe = void 0), e(14, Mt = -1)), e(52, gs = it == null ? void 0 : it.id)), r.$$.dirty[0] & /*listFeatures*/
    ...
    8 && N && N.setEventHandler((S) => {
      switch (S.type) {
        ...
        case "markerClick":
          {
            const Gt = lt == null ? void 0 : lt.find((Vn) => Vn.id === S.id);
            Gt && vs(Gt);
          }
          break;
    ...
    1048576 && Nr("pick", it), r.$$.dirty[0] & /*focusedDelayed, listFeatures*/
    ...
    1 && Nr("reverseToggle", F), r.$$.dirty[0] & /*searchValue*/
    2 && Nr("queryChange", R), r.$$.dirty[0] & /*reverseActive*/
...
var Us = (
  ...
  function() {
    function r(t) {
      t === void 0 && (t = _c), this._root = null, this._size = 0, this._comparator = t;
    }
    return r.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = Is(e, n, a, i) : s = Is(e, n, s, i), this._root = Ec(s, a, i);
...
var Sc = Lr * Lr, Ts = function(t, e) {
  ...
  return xe(r, [{
    ...
    value: function(e) {
      var n = this, i = /* @__PURE__ */ new Map(), o = function(a) {
        var u = a.otherSE;
        i.set(a, {
          sine: wc(n.point, e.point, u.point),
          cosine: Lc(n.point, e.point, u.point)
        });
      };
      return function(s, a) {
  ...
  xe(r, null, [{
    ...
    value: function(e, n) {
      ...
      if (s > a) {
        var I = e.comparePoint(n.rightSE.point);
        if (I < 0)
          return 1;
        if (I > 0)
          return -1;
  ...
  function r(t, e, n, i) {
    mn(this, r), this.id = ++Pc, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = n, this.windings = i;
  }
  return xe(r, [{
    key: "replaceRightSE",
    ...
    value: function(e) {
      ...
      if (h)
        return l;
      var p = bc(s, this.vector(), u, e.vector());
        ...
        if (!(!s.isInResult() || s.ringOut)) {
          for (var a = null, u = s.leftSE, l = s.rightSE, c = [u], f = u.point, h = []; a = u, u = l, c.push(u), u.point !== f; )
            for (; ; ) {
              ...
              for (var d = null, I = 0, C = h.length; I < C; I++)
                if (h[I].point === u.point) {
                  d = I;
                  break;
                }
              if (d !== null) {
    ...
    value: function(e) {
      ...
      if (e.isLeft) {
        ...
        if (l) {
          ...
          if (d !== null && (n.isAnEndpoint(d) || (v = d), !l.isAnEndpoint(d)))
            for (var I = this._splitSafely(l, d), C = 0, _ = I.length; C < _; C++)
              i.push(I[C]);
        }
        if (c !== null || v !== null) {
          var x = null;
          if (c === null)
            ...
            var N = Hn.comparePoints(c, v);
            x = N <= 0 ? c : v;
          }
          this.queue.remove(n.rightSE), i.push(n.rightSE);
          for (var w = n.split(x), M = 0, A = w.length; M < A; M++)
            i.push(w[M]);
        }
...
}(), Oa = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, Mc = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, Ac = /* @__PURE__ */ function() {
  function r() {
    mn(this, r);
  }
  return xe(r, [{
    ...
    value: function(e, n, i) {
      ...
      for (var v = new Us(Hn.compare), d = 0, I = o.length; d < I; d++)
        for (var C = o[d].getSweepEvents(), _ = 0, x = C.length; _ < x; _++)
          if (v.insert(C[_]), v.size > Oa)
            throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");
      for (var N = new Tc(v), w = v.size, M = v.pop(); M; ) {
        var A = M.key;
        if (v.size === w) {
          var L = A.segment;
      ...
      no.reset();
      var D = Oc.factory(N.segments), H = new Dc(D);
      return H.getGeom();
    }
  }]), r;
}(), wn = new Ac(), Fc = function(t) {
...
class Hc extends Xr {
  constructor(t) {
    super(), qr(this, t, Yc, Xc, Ur, { displayIn: 0 });
  }
}
function pu(r, t, e) {
  if (r !== null)
    for (var n, i, o, s, a, u, l, c = 0, f = 0, h, g = r.type, p = g === "FeatureCollection", v = g === "Feature", d = p ? r.features.length : 1, I = 0; I < d; I++) {
      l = p ? r.features[I].geometry : v ? r.geometry : r, h = l ? l.type === "GeometryCollection" : !1, a = h ? l.geometries.length : 1;
      for (var C = 0; C < a; C++) {
        var _ = 0, x = 0;
          ...
          switch (c = e && (N === "Polygon" || N === "MultiPolygon") ? 1 : 0, N) {
            ...
            case "MultiLineString":
              for (n = 0; n < u.length; n++) {
                ...
                N === "MultiLineString" && _++, N === "Polygon" && x++;
              }
              N === "Polygon" && _++;
              break;
            case "MultiPolygon":
...
E.prototype.extractSignificantDigits = function(t, e) {
  ...
  for (var s = i + 1, a = new _n(), u = E.MAX_PRINT_DIGITS - 1, l = 0; l <= u; l++) {
    t && l === s && a.append(".");
...
E.prototype.selfAdd = function() {
  if (arguments.length === 1) {
    ...
    var l = arguments[0], c = arguments[1], f = null, h = null, g = null, p = null, v = null, d = null, I = null, C = null;
    v = this._hi + l, g = this._lo + c, I = v - this._hi, C = g - this._lo, d = v - I, p = g - C, d = l - I + (this._hi - d), p = c - C + (this._lo - p), I = d + g, f = v + I, h = I + (v - f), I = p + h;
    var _ = f + I, x = I + (f - _);
  ...
  for (var s = new E(), a = 0, u = 0, l = 0; !(e >= n); ) {
    ...
    if (c === "e" || c === "E") {
      ...
      try {
        ...
        throw I instanceof Error ? new Error("Invalid exponent " + h + " in string " + t) : I;
      } finally {
      }
      break;
    }
...
var ze = function r() {
  if (this.x = null, this.y = null, this.w = null, arguments.length === 0)
    ...
    var f = arguments[0], h = arguments[1], g = arguments[2], p = arguments[3], v = f.y - h.y, d = h.x - f.x, I = f.x * h.y - h.x * f.y, C = g.y - p.y, _ = p.x - g.x, x = g.x * p.y - p.x * g.y;
    this.x = d * x - _ * I, this.y = C * I - v * x, this.w = v * _ - C * d;
  }
};
...
ns.prototype.read = function(t) {
  var e, n, i;
  t = t.replace(/[\n\r]/g, " ");
  var o = Je.typeStr.exec(t);
  if (t.search("EMPTY") !== -1 && (o = Je.emptyTypeStr.exec(t), o[2] = void 0), o && (n = o[1].toLowerCase(), i = o[2], _i[n] && (e = _i[n].apply(this, [i]))), e === void 0)
...
var Xn = {
  ...
  multipoint: function(t) {
    ...
    for (var n, i = t.trim().split(","), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Je.trimParens, "$1"), o.push(_i.point.apply(e, [n]));
  ...
  linestring: function(t) {
    ...
    for (var e = t.trim().split(","), n = [], i, o = 0, s = e.length; o < s; ++o)
      i = e[o].trim().split(Je.spaces), n.push(new y(Number.parseFloat(i[0]), Number.parseFloat(i[1])));
  ...
  multilinestring: function(t) {
    ...
    for (var n, i = t.trim().split(Je.parenComma), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Je.trimParens, "$1"), o.push(_i.linestring.apply(e, [n]));
  ...
  polygon: function(t) {
    ...
    for (var n, i, o, s = t.trim().split(Je.parenComma), a, u = [], l = 0, c = s.length; l < c; ++l)
      n = s[l].replace(Je.trimParens, "$1"), i = _i.linestring.apply(e, [n]), o = e.geometryFactory.createLinearRing(i._points), l === 0 ? a = o : u.push(o);
  ...
  multipolygon: function(t) {
    ...
    for (var n, i = t.trim().split(Je.doubleParenComma), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Je.trimParens, "$1"), o.push(_i.polygon.apply(e, [n]));
...
var Yr = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.isInSegmentEnvelopes = function(n) {
    ...
    var u = n.x < i.x ? n.x : i.x, l = n.y < i.y ? n.y : i.y, c = n.x > i.x ? n.x : i.x, f = n.y > i.y ? n.y : i.y, h = o.x < s.x ? o.x : s.x, g = o.y < s.y ? o.y : s.y, p = o.x > s.x ? o.x : s.x, v = o.y > s.y ? o.y : s.y, d = u > h ? u : h, I = c < p ? c : p, C = l > g ? l : g, _ = f < v ? f : v, x = (d + I) / 2, N = (C + _) / 2;
    a.x = x, a.y = N, n.x -= a.x, n.y -= a.y, i.x -= a.x, i.y -= a.y, o.x -= a.x, o.y -= a.y, s.x -= a.x, s.y -= a.y;
...
sn.locatePointInRing = function() {
  if (arguments[0] instanceof y && z(arguments[1], K)) {
...
Oe.prototype.getBoundary = function() {
  return this._geom instanceof vt ? this.boundaryLineString(this._geom) : this._geom instanceof Tr ? this.boundaryMultiLineString(this._geom) : this._geom.getBoundary();
};
  ...
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    if (arguments.length === 1) {
      ...
      for (var p = this.getNumInteriorRing(), v = c.getNumInteriorRing(), d = 0; d < p && d < v; ) {
        var I = i.getInteriorRingN(d), C = c.getInteriorRingN(d), _ = I.compareToSameClass(C, l);
        if (_ !== 0)
          return _;
        d++;
      }
...
var W = function r() {
  this._precisionModel = new $(), this._SRID = 0, this._coordinateSequenceFactory = r.getDefaultCoordinateSequenceFactory(), arguments.length === 0 || (arguments.length === 1 ? z(arguments[0], Ci) ? this._coordinateSequenceFactory = arguments[0] : arguments[0] instanceof $ && (this._precisionModel = arguments[0]) : arguments.length === 2 ? (this._precisionModel = arguments[0], this._SRID = arguments[1]) : arguments.length === 3 && (this._precisionModel = arguments[0], this._SRID = arguments[1], this._coordinateSequenceFactory = arguments[2]));
...
as.prototype.read = function(t) {
  ...
  return rf.indexOf(n) !== -1 ? en[n].apply(this, [e.coordinates]) : n === "GeometryCollection" ? en[n].apply(this, [e.geometries]) : en[n].apply(this, [e]);
};
...
At.prototype.size = function() {
  ...
  if (arguments.length === 1) {
    for (var e = arguments[0], n = 0, i = e.getChildBoundables().iterator(); i.hasNext(); ) {
      var o = i.next();
      o instanceof Rt ? n += t.size(o) : o instanceof Xe && (n += 1);
    }
    return n;
  }
};
  ...
  if (arguments.length === 0) {
    ...
    for (var n = arguments[0], i = new O(), o = n.getChildBoundables().iterator(); o.hasNext(); ) {
      ...
      if (s instanceof Rt) {
        ...
        s instanceof Xe ? i.add(s.getItem()) : q.shouldNeverReachHere();
    }
    return i.size() <= 0 ? null : i;
  }
};
At.prototype.insert = function(t, e) {
  q.isTrue(!this._built, "Cannot insert items into an STR packed R-tree after it has been built."), this._itemBoundables.add(new Xe(t, e));
};
At.prototype.boundablesAtLevel = function() {
  ...
  if (arguments.length === 1) {
    ...
    for (var a = o.getChildBoundables().iterator(); a.hasNext(); ) {
      var u = a.next();
      u instanceof Rt ? t.boundablesAtLevel(i, u, s) : (q.isTrue(u instanceof Xe), i === -1 && s.add(u));
    }
    return null;
  }
};
At.prototype.query = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (z(arguments[2], pr) && arguments[0] instanceof Object && arguments[1] instanceof Rt)
      for (var s = arguments[0], a = arguments[1], u = arguments[2], l = a.getChildBoundables(), c = 0; c < l.size(); c++) {
        var f = l.get(c);
        t.getIntersectsOp().intersects(f.getBounds(), s) && (f instanceof Rt ? t.query(s, f, u) : f instanceof Xe ? u.visitItem(f.getItem()) : q.shouldNeverReachHere());
      }
    else if (z(arguments[2], Ve) && arguments[0] instanceof Object && arguments[1] instanceof Rt)
      for (var h = arguments[0], g = arguments[1], p = arguments[2], v = g.getChildBoundables(), d = 0; d < v.size(); d++) {
        var I = v.get(d);
        t.getIntersectsOp().intersects(I.getBounds(), h) && (I instanceof Rt ? t.query(h, I, p) : I instanceof Xe ? p.add(I.getItem()) : q.shouldNeverReachHere());
      }
  }
};
...
var Lu = function(r) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[0] instanceof t && z(arguments[1], Oi)) {
      ...
      var I = arguments[0], C = arguments[1], _ = arguments[2], x = new Xe(I, C), N = new Nt(this.getRoot(), x, _);
...
Ct.prototype.toString = function() {
  return Ue.toLineString(new mt(this._pts));
};
...
Q.interiorAngle = function(t, e, n) {
  var i = Q.angle(e, t), o = Q.angle(e, n);
  return Math.abs(o - i);
};
...
Q.angleBetweenOriented = function(t, e, n) {
  var i = Q.angle(e, t), o = Q.angle(e, n), s = o - i;
  return s <= -Math.PI ? s + Q.PI_TIMES_2 : s > Math.PI ? s - Q.PI_TIMES_2 : s;
};
...
ct.prototype.addLimitedMitreJoin = function(t, e, n, i) {
  var o = this._seg0.p1, s = Q.angle(o, this._seg0.p0), a = Q.angleBetweenOriented(this._seg0.p0, o, this._seg1.p1), u = a / 2, l = Q.normalize(s + u), c = Q.normalize(l + Math.PI), f = i * n, h = f * Math.abs(Math.sin(u)), g = n - h, p = o.x + f * Math.cos(c), v = o.y + f * Math.sin(c), d = new y(p, v), I = new k(o, d), C = I.pointAlongOffset(1, g), _ = I.pointAlongOffset(1, -g);
...
ti.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (z(arguments[2], Ve) && arguments[0] instanceof y && arguments[1] instanceof Fs)
    ...
    else if (z(arguments[2], Ve) && arguments[0] instanceof y && z(arguments[1], Ve))
      for (var v = arguments[0], d = arguments[1], I = arguments[2], C = d.iterator(); C.hasNext(); ) {
        var _ = C.next();
        _.isForward() && t.findStabbedSegments(v, _, I);
      }
  }
};
...
tt.interpolateZ = function(t, e, n, i) {
  var o = e.x, s = e.y, a = n.x - o, u = i.x - o, l = n.y - s, c = i.y - s, f = a * c - u * l, h = t.x - o, g = t.y - s, p = (c * h - u * g) / f, v = (-l * h + a * g) / f, d = e.z + p * (n.z - e.z) + v * (i.z - e.z);
  return d;
};
...
Be.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof Ot ? this.addPolygon(t) : t instanceof vt ? this.addLineString(t) : t instanceof ve ? this.addPoint(t) : t instanceof bi ? this.addCollection(t) : t instanceof Tr ? this.addCollection(t) : t instanceof Ln ? this.addCollection(t) : t instanceof re && this.addCollection(t);
};
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.linkResultDirectedEdges = function() {
    ...
    if (arguments.length === 1) {
      ...
      for (var c = arguments[0], f = arguments[1], h = arguments[2], g = h, p = c; p < f; p++) {
        ...
        v.setEdgeDepths(b.RIGHT, g), g = v.getDepth(b.LEFT);
      }
      return g;
    }
...
dn.prototype.checkInteriorIntersections = function() {
  ...
  if (arguments.length === 0)
    ...
    if (h === p && g === v)
      return null;
    var d = h.getCoordinates()[g], I = h.getCoordinates()[g + 1], C = p.getCoordinates()[v], _ = p.getCoordinates()[v + 1];
    if (this._li.computeIntersection(d, I, C, _), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, d, I) || this.hasInteriorIntersection(this._li, C, _)))
      throw new Zn("found non-noded intersection at " + d + "-" + I + " and " + C + "-" + _);
  }
};
...
Mn.prototype.checkCorrectness = function(t) {
  var e = Ct.getNodedSubstrings(t), n = new dn(e);
  try {
    n.checkValid();
  } catch (i) {
    if (i instanceof _u)
...
Ut.prototype.bufferFixedPrecision = function(t) {
  var e = new yr(new Mn(new $(1)), t.getScale()), n = new ne(this._bufParams);
...
Ut.bufferOp = function() {
  if (arguments.length === 2) {
    ...
    var v = arguments[0], d = arguments[1], I = arguments[2], C = arguments[3], _ = new Ut(v);
    _.setQuadrantSegments(I), _.setEndCapStyle(C);
...
Qn.getPolygons = function() {
  if (arguments.length === 1) {
    ...
    var e = arguments[0], n = arguments[1];
    return e instanceof Ot ? n.add(e) : e instanceof re && e.apply(new Qn(n)), n;
  }
};
var Vt = function() {
...
Vt.getLines = function() {
  if (arguments.length === 1) {
    ...
    if (z(arguments[0], Lt) && z(arguments[1], Lt)) {
      ...
      return l instanceof vt ? c.add(l) : l.apply(new Vt(c)), c;
    }
  } else if (arguments.length === 3) {
    if (typeof arguments[2] == "boolean" && z(arguments[0], Lt) && z(arguments[1], Lt)) {
      ...
      var d = arguments[0], I = arguments[1], C = arguments[2];
      return d.apply(new Vt(I, C)), I;
    }
  }
};
var We = function() {
...
lr.getPoints = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return t instanceof ve ? Ye.singletonList(t) : lr.getPoints(t, new O());
  } else if (arguments.length === 2) {
    var e = arguments[0], n = arguments[1];
    return e instanceof ve ? n.add(e) : e instanceof re && e.apply(new lr(n)), n;
  }
};
var ri = function() {
...
Yt.prototype.computeContainmentDistance = function() {
  ...
  if (arguments.length === 0) {
    ...
    if (arguments[2] instanceof Array && z(arguments[0], Ve) && z(arguments[1], Ve)) {
      ...
      var p = arguments[0], v = arguments[1], d = arguments[2], I = p.getCoordinate();
      if (m.EXTERIOR !== this._ptLocator.locate(I, v))
        return this._minDistance = 0, d[0] = p, d[1] = new te(v, I), null;
    }
  }
};
    ...
    if (arguments[2] instanceof Array && arguments[0] instanceof vt && arguments[1] instanceof ve) {
      ...
      for (var p = f.getCoordinates(), v = h.getCoordinates(), d = 0; d < p.length - 1; d++)
        for (var I = 0; I < v.length - 1; I++) {
          var C = T.distanceLineLine(p[d], p[d + 1], v[I], v[I + 1]);
          if (C < t._minDistance) {
            t._minDistance = C;
            var _ = new k(p[d], p[d + 1]), x = new k(v[I], v[I + 1]), N = _.closestPoints(x);
            g[0] = new te(f, d, N[0]), g[1] = new te(h, I, N[1]);
          }
          if (t._minDistance <= t._terminateDistance)
            return null;
        }
...
_t.prototype.snapToSelf = function(t, e) {
  ...
  return e && z(s, gr) && (s = o.buffer(0)), s;
};
...
var lf = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.prepareEvents = function() {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[2] instanceof Wt && z(arguments[0], Ve) && z(arguments[1], Ve)) {
        var a = arguments[0], u = arguments[1], l = arguments[2];
        this.addEdges(a, a), this.addEdges(u, u), this.computeIntersections(l);
      } else if (typeof arguments[2] == "boolean" && z(arguments[0], Ve) && arguments[1] instanceof Wt) {
        var c = arguments[0], f = arguments[1], h = arguments[2];
...
Fn.prototype.toString = function() {
  return Ue.toLineString(new y(this._min, 0), new y(this._max, 0));
};
Fn.prototype.interfaces_ = function() {
  return [];
};
...
Bn.prototype.buildTree = function() {
  var t = this;
  Ye.sort(this._leaves, new Fn.NodeComparator());
...
Bn.prototype.printNode = function(t) {
  Xt.out.println(Ue.toLineString(new y(t._min, this._level), new y(t._max, this._level)));
};
...
var Qi = function(r) {
  function t() {
    if (r.call(this), this._parentGeom = null, this._lineEdgeMap = new Nu(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new We(), arguments.length === 2) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(n, i) {
    ...
    return z(this._parentGeom, gr) && this._parentGeom.getNumGeometries() > 50 ? (this._areaPtLocator === null && (this._areaPtLocator = new Ai(this._parentGeom)), this._areaPtLocator.locate(n)) : this._ptLocator.locate(n, this._parentGeom);
...
var U = function(r) {
  function t() {
    var e = arguments[0], n = arguments[1];
    r.call(this, e, n), this._ptLocator = new We(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new He(), this._resultPolyList = new O(), this._resultLineList = new O(), this._resultPointList = new O(), this._graph = new pt(new Ou()), this._geomFact = e.getFactory();
  }
...
U.SYMDIFFERENCE = 4;
var cr = function() {
  this._g = null, this._boundaryDistanceTolerance = null, this._linework = null, this._ptLocator = new We(), this._seg = new k();
  var t = arguments[0], e = arguments[1];
...
St.prototype.reduceToGeometries = function(t) {
  for (var e = this, n = new O(), i = t.iterator(); i.hasNext(); ) {
    var o = i.next(), s = null;
    z(o, Ve) ? s = e.unionTree(o) : o instanceof G && (s = o), n.add(s);
  }
  return n;
};
...
var dt = 1e-6, st = Math.PI, jn = st / 2, Ga = st / 4, nr = st * 2, xr = 180 / st, $e = st / 180, ee = Math.abs, hf = Math.atan, Gi = Math.atan2, bt = Math.cos, Pt = Math.sin, Hi = Math.sqrt;
function qu(r) {
...
function Hu(r, t, e, n, i) {
  ...
  if (r.forEach(function(p) {
    if (!((v = p.length - 1) <= 0)) {
      ...
      o.push(C = new Mo(d, p, null, !0)), s.push(C.o = new Mo(d, null, C, !1)), o.push(C = new Mo(I, p, null, !1)), s.push(C.o = new Mo(I, null, C, !0));
    }
  }), !!o.length) {
...
function _f(r, t, e, n) {
  ...
  return function(l) {
    var c = l, f = Yu(), h, g, p, v, d, I, C, _, x, N, w, M = {
      point: A,
      lineStart: R,
      lineEnd: Y,
      polygonStart: F,
    ...
    function L() {
      for (var H = 0, rt = 0, wt = g.length; rt < wt; ++rt)
        for (var kt = g[rt], ge = 1, or = kt.length, Ze = kt[0], In, Cn, pi = Ze[0], sr = Ze[1]; ge < or; ++ge)
          In = pi, Cn = sr, Ze = kt[ge], pi = Ze[0], sr = Ze[1], Cn <= n ? sr > n && (pi - In) * (n - Cn) > (sr - Cn) * (r - In) && ++H : sr <= n && (pi - In) * (n - Cn) < (sr - Cn) * (r - In) && --H;
      return H;
    }
    function F() {
      c = f, h = [], g = [], w = !0;
    ...
    function R() {
      M.point = D, g && g.push(p = []), N = !0, x = !1, C = _ = NaN;
    }
    function Y() {
      h && (D(v, d), I && x && f.rejoin(), h.push(f.result())), M.point = A, x && c.lineEnd();
    }
    function D(H, rt) {
      var wt = i(H, rt);
      if (g && p.push([H, rt]), N)
        v = H, d = rt, I = wt, N = !1, wt && (c.lineStart(), c.point(H, rt));
      else if (wt && x)
        c.point(H, rt);
      else {
        var kt = [C = Math.max(Ao, Math.min(Zi, C)), _ = Math.max(Ao, Math.min(Zi, _))], ge = [H = Math.max(Ao, Math.min(Zi, H)), rt = Math.max(Ao, Math.min(Zi, rt))];
        vf(kt, ge, r, t, e, n) ? (x || (c.lineStart(), c.point(kt[0], kt[1])), c.point(ge[0], ge[1]), wt || c.lineEnd(), w = !1) : wt && (c.lineStart(), c.point(H, rt), w = !1);
      }
      C = H, _ = rt, x = wt;
    }
    return M;
...
function Ef(r, t) {
  ...
  for (var a = 0, u = r.length; a < u; ++a)
    if (c = (l = r[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + Ga, p = Pt(g), v = bt(g), d = 0; d < c; ++d, h = C, p = x, v = N, f = I) {
        var I = l[d], C = I[0], _ = I[1] / 2 + Ga, x = Pt(_), N = bt(_), w = C - h, M = w >= 0 ? 1 : -1, A = M * w, L = A > st, F = p * x;
        if (Ss.add(Gi(F * M * Pt(A), v * N + F * bt(A))), o += L ? w + M * nr : w, L ^ h >= e ^ C >= e) {
          var X = Zo(zi(f), zi(I));
          Gs(X);
          var R = Zo(i, X);
          Gs(R);
  ...
  return function(i, o) {
    var s = t(o), a = i.invert(n[0], n[1]), u = Yu(), l = t(u), c = !1, f, h, g, p = {
      ...
      polygonStart: function() {
        p.point = _, p.lineStart = x, p.lineEnd = N, h = [], f = [];
      },
      polygonEnd: function() {
        p.point = v, p.lineStart = I, p.lineEnd = C, h = ju(h);
        var w = Ef(f, a);
        h.length ? (c || (o.polygonStart(), c = !0), Hu(h, Nf, w, e, o)) : w && (c || (o.polygonStart(), c = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), h = f = null;
      },
      sphere: function() {
    ...
    function N() {
      ...
      if (g.pop(), f.push(g), g = null, !!L) {
        ...
        L > 1 && w & 2 && M.push(M.pop().concat(M.shift())), h.push(M.filter(Cf));
      }
    }
    return p;
  };
...
function Sf(r) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      ee(u - st) < dt ? (r.point(t, e = (e + s) / 2 > 0 ? jn : -jn), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), r.point(o, e), i = 0) : n !== a && u >= st && (ee(t - n) < dt && (t -= n * dt), ee(o - a) < dt && (o -= a * dt), e = xf(t, e, o, s), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), i = 0), r.point(t = o, e = s), n = a;
    },
    lineEnd: function() {
      r.lineEnd(), t = e = NaN;
    },
...
function xf(r, t, e, n) {
  var i, o, s = Pt(r - e);
  return ee(s) > dt ? hf((Pt(t) * (o = bt(n)) * Pt(e) - Pt(n) * (i = bt(t)) * Pt(r)) / (i * o * s)) : (t + n) / 2;
}
function wf(r, t, e, n) {
  var i;
  if (r == null)
...
function Lf(r, t) {
  ...
  function a(c) {
    ...
    return {
      ...
      point: function(d, I) {
        var C = [d, I], _, x = s(d, I), N = n ? x ? 0 : l(d, I) : x ? l(d + (d < 0 ? st : -st), I) : 0;
        if (!f && (p = g = x) && c.lineStart(), x !== g && (_ = u(f, C), (!_ || Go(f, _) || Go(C, _)) && (C[0] += dt, C[1] += dt, x = s(C[0], C[1]))), x !== g)
          v = 0, x ? (c.lineStart(), _ = u(C, f), c.point(_[0], _[1])) : (_ = u(f, C), c.point(_[0], _[1]), c.lineEnd()), f = _;
        else if (i && f && n ^ x) {
          var w;
          !(N & h) && (w = u(C, f, !0)) && (v = 0, n ? (c.lineStart(), c.point(w[0][0], w[0][1]), c.point(w[1][0], w[1][1]), c.lineEnd()) : (c.point(w[1][0], w[1][1]), c.lineEnd(), c.lineStart(), c.point(w[0][0], w[0][1])));
        }
        x && (!f || !Go(f, C)) && c.point(C[0], C[1]), f = C, g = x, h = N;
      },
      lineEnd: function() {
        g && c.lineEnd(), f = null;
      },
  ...
  function u(c, f, h) {
    var g = zi(c), p = zi(f), v = [1, 0, 0], d = Zo(g, p), I = Do(d, d), C = d[0], _ = I - C * C;
    if (!_)
      return !h && c;
    var x = e * I / _, N = -e * C / _, w = Zo(v, d), M = To(v, x), A = To(d, N);
    Ns(M, A);
    var L = w, F = Do(M, L), X = Do(L, L), R = F * F - X * (Do(M, M) - 1);
    if (!(R < 0)) {
      var Y = Hi(R), D = To(L, (-F - Y) / X);
      if (Ns(D, M), D = ks(D), !h)
        return D;
      var H = c[0], rt = f[0], wt = c[1], kt = f[1], ge;
      rt < H && (ge = H, H = rt, rt = ge);
      var or = rt - H, Ze = ee(or - st) < dt, In = Ze || or < dt;
      if (!Ze && kt < wt && (ge = wt, wt = kt, kt = ge), In ? Ze ? wt + kt > 0 ^ D[1] < (ee(D[0] - H) < dt ? wt : kt) : wt <= D[1] && D[1] <= kt : or > st ^ (H <= D[0] && D[0] <= rt)) {
        var Cn = To(L, (-F + Y) / X);
        return Ns(Cn, M), [D, ks(Cn)];
      }
    }
  }
  function l(c, f) {
...
function Of(r, t) {
  function e(n, i, o, s, a, u, l, c, f, h, g, p, v, d) {
    var I = l - n, C = c - i, _ = I * I + C * C;
    if (_ > 4 * t && v--) {
      var x = s + h, N = a + g, w = u + p, M = Hi(x * x + N * N + w * w), A = ui(w /= M), L = ee(ee(w) - 1) < dt || ee(o - f) < dt ? (o + f) / 2 : Gi(N, x), F = r(L, A), X = F[0], R = F[1], Y = X - n, D = R - i, H = C * Y - I * D;
      (H * H / _ > t || ee((I * Y + C * D) / _ - 0.5) > 0.3 || s * h + a * g + u * p < Pf) && (e(n, i, o, s, a, u, X, R, L, x /= M, N /= M, w, v, d), d.point(X, R), e(X, R, L, x, N, w, l, c, f, h, g, p, v, d));
    }
  }
  return function(n) {
    ...
    function _(A, L) {
      ...
      e(f, h, c, g, p, v, f = X[0], h = X[1], c = A, g = F[0], p = F[1], v = F[2], Za, n), n.point(f, h);
    }
    function x() {
      d.point = I, n.lineEnd();
    }
    function N() {
      C(), d.point = w, d.lineEnd = M;
    }
    function w(A, L) {
      _(i = A, L), o = f, s = h, a = g, u = p, l = v, d.point = _;
    }
    function M() {
      e(f, h, c, g, p, v, o, s, i, a, u, l, Za, n), d.lineEnd = x, x();
    }
    return d;
  };
}
...
function Mf(r) {
  var t, e = 150, n = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, g, p = null, v = Ka, d = null, I, C, _, x = ja, N = 0.5, w = Ja(X, N), M, A;
  function L(D) {
    return D = g(D[0] * $e, D[1] * $e), [D[0] * e + o, s - D[1] * e];
  }
  function F(D) {
  ...
  L.stream = function(D) {
    return M && A === D ? M : M = Df(v(h, w(x(A = D))));
  }, L.clipAngle = function(D) {
    return arguments.length ? (v = +D ? Lf(p = D * $e, 6 * $e) : (p = null, Ka), Y()) : p * xr;
  }, L.clipExtent = function(D) {
    return arguments.length ? (x = D == null ? (d = I = C = _ = null, ja) : _f(d = +D[0][0], I = +D[0][1], C = +D[1][0], _ = +D[1][1]), Y()) : d == null ? null : [[d, I], [C, _]];
  }, L.scale = function(D) {
    return arguments.length ? (e = +D, R()) : e;
  }, L.translate = function(D) {
    return arguments.length ? (n = +D[0], i = +D[1], R()) : [n, i];
  }, L.center = function(D) {
    return arguments.length ? (a = D[0] % 360 * $e, u = D[1] % 360 * $e, R()) : [a * xr, u * xr];
  }, L.rotate = function(D) {
    return arguments.length ? (l = D[0] % 360 * $e, c = D[1] % 360 * $e, f = D.length > 2 ? D[2] % 360 * $e : 0, R()) : [l * xr, c * xr, f * xr];
  }, L.precision = function(D) {
    return arguments.length ? (w = Ja(X, N = D * D), Y()) : Hi(N);
...
function zo(r, t, e, n) {
  ...
  }, l = new Ks(), c = l.read(u), f = Vc(Uc(t, e), "meters"), h = Ut.bufferOp(c, f, n), g = new xu();
...
function zf(r, t = !0, e = !0, n = {}, i = {}, o = (s) => {
  ...
  function h(g, p = !1) {
    ...
    return new Hc({ props: { displayIn: "leaflet" }, target: v }), new ar.Marker(g, {
      interactive: p,
      icon: new ar.DivIcon({
        html: v,
        className: "",
  ...
  return {
    ...
    setReverseMarker(g) {
      ...
      if (!t)
        return;
      const p = g && [g[1], g[0]];
      l ? p ? l.setLatLng(p) : (l.remove(), l = void 0) : p && (l = (typeof t == "object" ? new ar.Marker(p, t) : h(p)).addTo(r), (v = l.getElement()) == null || v.classList.add("marker-reverse"));
    },
    setMarkers(g, p) {
      if (!t)
        return;
      ...
      if (a.length = 0, v(), p) {
        ...
        const I = [p.center[1], p.center[0]];
        a.push(
          (typeof t == "object" ? new ar.Marker(I, t) : h(I)).addTo(r)
        );
      }
      if (e)
        for (const d of g ?? []) {
          ...
          const I = [
            d.center[1],
            d.center[0]
          ], C = typeof e == "object" ? new ar.Marker(I, e) : h(I, !0);
...
class Vf extends ar.Control {
  ...
  setOptions(e) {
    ...
    (u = Sn(this, tn)) == null || u.$set(a);
  }
  setQuery(e, n = !0) {
    var i;
    (i = Sn(this, tn)) == null || i.setQuery(e, n);
  }
  clearMap() {
    var e;
    (e = Sn(this, tn)) == null || e.clearMap();
  }
  clearList() {
    var e;
    (e = Sn(this, tn)) == null || e.clearList();
  }
  focus() {
    var e;
    (e = Sn(this, tn)) == null || e.focus();
  }
  blur() {
    var e;
    (e = Sn(this, tn)) == null || e.blur();
  }
  onRemove() {
    var e;
    (e = Sn(this, tn)) == null || e.$destroy();
  }
}
tn = new WeakMap(), Qr = new WeakMap();
function Uf(...r) {
  return new Vf(...r);
}
