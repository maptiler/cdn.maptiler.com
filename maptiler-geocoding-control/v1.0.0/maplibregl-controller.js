...
var Ka = Hr * Hr, Po = function(t, e) {
  ...
  return ae(n, [{
    ...
    value: function(e, r, i) {
      ...
      for (var R = new iu(v), O = v.size, F = v.pop(); F; ) {
        var G = F.key;
        if (v.size === O) {
          var M = G.segment;
...
var sn = function(n) {
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.isInSegmentEnvelopes = function(r) {
    ...
    var u = r.x < i.x ? r.x : i.x, l = r.y < i.y ? r.y : i.y, c = r.x > i.x ? r.x : i.x, f = r.y > i.y ? r.y : i.y, h = o.x < s.x ? o.x : s.x, g = o.y < s.y ? o.y : s.y, p = o.x > s.x ? o.x : s.x, v = o.y > s.y ? o.y : s.y, m = u > h ? u : h, E = c < p ? c : p, I = l > g ? l : g, C = f < v ? f : v, S = (m + E) / 2, R = (I + C) / 2;
    ...
    if (arguments[2] instanceof Array && arguments[0] instanceof ut && arguments[1] instanceof te) {
      ...
      for (var p = f.getCoordinates(), v = h.getCoordinates(), m = 0; m < p.length - 1; m++)
        for (var E = 0; E < v.length - 1; E++) {
          ...
          if (I < t._minDistance) {
            t._minDistance = I;
            var C = new b(p[m], p[m + 1]), S = new b(v[E], v[E + 1]), R = C.closestPoints(S);
            g[0] = new zt(f, m, R[0]), g[1] = new zt(h, E, R[1]);
          }
          if (t._minDistance <= t._terminateDistance)
            return null;
        }
...
function sl(n, t, e, r) {
  ...
  return function(l) {
    var c = l, f = Pa(), h, g, p, v, m, E, I, C, S, R, O, F = {
      point: G,
      lineStart: nt,
      lineEnd: ct,
      polygonStart: et,
    ...
    function nt() {
      F.point = w, g && g.push(p = []), R = !0, S = !1, I = C = NaN;
    }
    function ct() {
    ...
    function w(X, ft) {
      var Gt = i(X, ft);
      if (g && p.push([X, ft]), R)
        v = X, m = ft, E = Gt, R = !1, Gt && (c.lineStart(), c.point(X, ft));
      else if (Gt && S)
        c.point(X, ft);
      else {
...
function al(n, t) {
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + xs, p = It(g), v = Et(g), m = 0; m < c; ++m, h = I, p = S, v = R, f = E) {
        var E = l[m], I = E[0], C = E[1] / 2 + xs, S = It(C), R = Et(C), O = I - h, F = O >= 0 ? 1 : -1, G = F * O, M = G > Z, et = p * S;
        if (Co.add(Qn(et * F * It(G), v * R + et * Et(G))), o += M ? O + F * Sr : O, M ^ h >= e ^ I >= e) {
          var K = $i(Jn(f), Jn(E));
          Fo(K);
          var nt = $i(i, K);
          Fo(nt);
  ...
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = Pa(), l = t(u), c = !1, f, h, g, p = {
      ...
      polygonStart: function() {
        p.point = C, p.lineStart = S, p.lineEnd = R, h = [], f = [];
      },
      polygonEnd: function() {
...
function gl(n, t) {
  ...
  function a(c) {
    ...
    return {
      ...
      point: function(m, E) {
        var I = [m, E], C, S = s(m, E), R = r ? S ? 0 : l(m, E) : S ? l(m + (m < 0 ? Z : -Z), E) : 0;
        if (!f && (p = g = S) && c.lineStart(), S !== g && (C = u(f, I), (!C || zi(f, C) || zi(I, C)) && (I[0] += at, I[1] += at, S = s(I[0], I[1]))), S !== g)
          ...
          var O;
          !(R & h) && (O = u(I, f, !0)) && (v = 0, r ? (c.lineStart(), c.point(O[0][0], O[0][1]), c.point(O[1][0], O[1][1]), c.lineEnd()) : (c.point(O[1][0], O[1][1]), c.lineEnd(), c.lineStart(), c.point(O[0][0], O[0][1])));
        }
        S && (!f || !zi(f, I)) && c.point(I[0], I[1]), f = I, g = S, h = R;
      },
      lineEnd: function() {
        g && c.lineEnd(), f = null;
      },
  ...
  function u(c, f, h) {
    ...
    if (!C)
      return !h && c;
    var S = e * E / C, R = -e * I / C, O = $i(v, m), F = Gi(v, S), G = Gi(m, R);
    Io(F, G);
...
function ml(n, t) {
  function e(r, i, o, s, a, u, l, c, f, h, g, p, v, m) {
    ...
    if (C > 4 * t && v--) {
      var S = s + h, R = a + g, O = u + p, F = ni(S * S + R * R + O * O), G = In(O /= F), M = Ut(Ut(O) - 1) < at || Ut(o - f) < at ? (o + f) / 2 : Qn(R, S), et = n(M, G), K = et[0], nt = et[1], ct = K - r, w = nt - i, X = I * ct - E * w;
      (X * X / C > t || Ut((E * ct + I * w) / C - 0.5) > 0.3 || s * h + a * g + u * p < vl) && (e(r, i, o, s, a, u, K, nt, M, S /= F, R /= F, O, v, m), m.point(K, nt), e(K, nt, M, S, R, O, l, c, f, h, g, p, v, m));
    }
  }
  return function(r) {
...
function Il(n) {
  var t, e = 150, r = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, g, p = null, v = As, m = null, E, I, C, S = Ts, R = 0.5, O = Bs(K, R), F, G;
  function M(w) {
  ...
  M.stream = function(w) {
    return F && G === w ? F : F = _l(v(h, O(S(G = w))));
