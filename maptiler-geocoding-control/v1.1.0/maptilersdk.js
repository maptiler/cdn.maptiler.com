...
import * as wl from "@maptiler/sdk";
function It() {
}
function Ll(n, t) {
  for (const e in t)
...
function Ec(n) {
  ...
  return ~(d = ot(n)) && (_ = G[d] = Y[d](n)), {
    ...
    p(N, k) {
      ...
      let K = d;
      d = ot(N), d === K ? ~d && G[d].p(N, k) : (_ && (Fo(), $t(G[K], 1, 1, () => {
        G[K] = null;
...
function Ic(n, t, e) {
  ...
  async function gs(x, { byId: Gt = !1, exact: Vr = !1 } = {}) {
    ...
    try {
      ...
      if (E !== void 0 && er.set("language", Array.isArray(E) ? E.join(",") : E ?? ""), K && er.set("types", K.join(",")), dt && er.set("excludeTypes", String(dt)), u && er.set("bbox", u.map((Lo) => Lo.toFixed(6)).join(",")), h && er.set("country", Array.isArray(h) ? h.join(",") : h), !Gt && !Ee) {
        const Lo = await dc(w, L, zr);
        Lo && er.set("proximity", Lo), (Vr || !k) && er.set("autocomplete", "false"), er.set("fuzzyMatch", String(C));
      }
      S !== void 0 && (!Ee || (K == null ? void 0 : K.length) === 1) && er.set("limit", String(S)), er.set("key", a), ze(er);
...
yr.prototype.checkCollapse = function(t, e, r) {
  if (t.equals(r))
    throw new Qr("found non-noded collapse at " + yr.fact.createLineString([t, e, r]));
};
...
Tr.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new Qs(), this._pointSnapper = new Ti(this._noder.getIndex()), this.snapRound(t, this._li);
};
...
an.getPoints = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return t instanceof ve ? Ke.singletonList(t) : an.getPoints(t, new O());
  } else if (arguments.length === 2) {
    var e = arguments[0], r = arguments[1];
...
Ar.prototype.buildTree = function() {
  var t = this;
  Ke.sort(this._leaves, new Mr.NodeComparator());
...
var q = function(n) {
  function t() {
    var e = arguments[0], r = arguments[1];
    n.call(this, e, r), this._ptLocator = new Ze(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new Qe(), this._resultPolyList = new O(), this._resultLineList = new O(), this._resultPointList = new O(), this._graph = new pt(new Tu()), this._geomFact = e.getFactory();
  }
  ...
  return function(l) {
    ...
    function L() {
      for (var k = 0, K = 0, dt = p.length; K < dt; ++K)
        for (var Wt = p[K], Jt = 1, on = Wt.length, Ve = Wt[0], Br, ze, gi = Ve[0], In = Ve[1]; Jt < on; ++Jt)
    ...
    function Y() {
      var k = L(), K = T && k, dt = (h = Ku(h)).length;
      (K || dt) && (l.polygonStart(), K && (l.lineStart(), o(null, null, 1, l), l.lineEnd()), dt && Wu(h, a, k, o, l), l.polygonEnd()), c = l, h = p = g = null;
    }
    function G() {
    ...
    function N(k, K) {
      ...
      if (p && g.push([k, K]), w)
        ...
        var Wt = [C = Math.max(Mo, Math.min(Qi, C)), E = Math.max(Mo, Math.min(Qi, E))], Jt = [k = Math.max(Mo, Math.min(Qi, k)), K = Math.max(Mo, Math.min(Qi, K))];
        mf(Wt, Jt, n, t, e, r) ? (S || (c.lineStart(), c.point(Wt[0], Wt[1])), c.point(Jt[0], Jt[1]), dt || c.lineEnd(), T = !1) : dt && (c.lineStart(), c.point(k, K), T = !1);
      }
      C = k, E = K, S = dt;
    }
    return R;
...
Yn();
Yn();
var Vi = 1 / 0, Zo = Vi, vo = -Vi, Jo = vo, Ka = {
  point: Nf,
  lineStart: Ki,
  lineEnd: Ki,
  polygonStart: Ki,
...
function Qu(n, t, e, r) {
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = Hu(), l = t(u), c = !1, f, h, p, g = {
      ...
      polygonEnd: function() {
        g.point = v, g.lineStart = _, g.lineEnd = C, h = Ku(h);
        var T = Cf(f, a);
...
function Pf(n, t) {
  ...
  function u(c, f, h) {
    ...
    if (!E)
      return !h && c;
    var S = e * _ / E, w = -e * C / E, T = Qo(v, d), R = To(v, S), D = To(d, w);
    Cs(R, D);
    ...
    if (!(G < 0)) {
      ...
      if (Cs(N, R), N = Bs(N), !h)
        return N;
      var k = c[0], K = f[0], dt = c[1], Wt = f[1], Jt;
      K < k && (Jt = k, k = K, K = Jt);
      var on = K - k, Ve = ne(on - st) < vt, Br = Ve || on < vt;
      if (!Ve && Wt < dt && (Jt = dt, dt = Wt, Wt = Jt), Br ? Ve ? dt + Wt > 0 ^ N[1] < (ne(N[0] - k) < vt ? dt : Wt) : dt <= N[1] && N[1] <= Wt : on > st ^ (k <= N[0] && N[0] <= K)) {
        var ze = To(L, (-A + ot) / Y);
...
function Ju(n, t, e) {
  ...
  n.scale(150).translate([0, 0]), o != null && n.clipExtent(null), df(e, n.stream(Ka));
...
function Ff(n) {
  var t, e = 150, r = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, p, g = null, v = Qa, d = null, _, C, E, S = ja, w = 0.5, T = Ja(Y, w), R, D;
  function L(N) {
  ...
  L.stream = function(N) {
    ...
    return arguments.length ? (v = +N ? Pf(g = N * ir, 6 * ir) : (g = null, Qa), ot()) : g * xn;
...
function Go(n, t, e, r) {
  ...
  }, l = new Ks(), c = l.read(u), f = Hc(Wc(t, e), "meters"), h = zt.bufferOp(c, f, r), p = new wu();
...
function Vf(n) {
  var t = Kc(n).geometry.coordinates, e = [-t[0], -t[1]];
