...
function Kn(i, e, { bubbles: t = !1, cancelable: n = !1 } = {}) {
...
const ot = [], $t = [];
let lt = [];
const Ei = [], Xn = /* @__PURE__ */ Promise.resolve();
let ei = !1;
function Jn() {
  ei || (ei = !0, Xn.then(en));
}
...
function ir(i, e, t, n, r, u, h, o, g, c, E, S) {
...
function De(i, e) {
  const t = i.$$;
  t.fragment !== null && (er(t.after_update), qe(t.on_destroy), t.fragment && t.fragment.d(e), t.on_destroy = t.fragment = null, t.ctx = []);
}
function nr(i, e) {
  i.$$.dirty[0] === -1 && (ot.push(i), Jn(), i.$$.dirty.fill(0)), i.$$.dirty[e / 31 | 0] |= 1 << e % 31;
}
function Ye(i, e, t, n, r, u, h = null, o = [-1]) {
  ...
  if (c.ctx = t ? t(i, e.props || {}, (S, C, ...R) => {
    ...
    return c.ctx && r(c.ctx[S], c.ctx[S] = O) && (!c.skip_bound && c.bound[S] && c.bound[S](O), E && nr(i, S)), C;
...
function mr(i) {
  ...
  function A(m, a) {
    ...
    m[5] ? gr : (
      /*feature*/
      m[0].address ? dr : (t == null && (t = !!/*feature*/
      m[0].id.startsWith("road.")), t ? hr : (n == null && (n = !!/*feature*/
      m[0].id.startsWith("address.")), n ? cr : (r == null && (r = !!/*feature*/
      m[0].id.startsWith("postal_code.")), r ? fr : (u == null && (u = !!/*feature*/
      m[0].id.startsWith("poi.")), u ? ar : (
        /*isReverse*/
        m[8] ? ur : lr
      )))))
    );
...
class Lr extends Qe {
  constructor(e) {
    super(), Ye(this, e, Er, wr, Ke, { displayIn: 0 });
  }
}
function _r(i) {
  let e, t;
...
const Nr = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(EAST|WEST|[EW])?$/i, Si = /^([+-]?[0-8]?[0-9])\s+([0-5]?[0-9]\.\d{3,})[\s,]{1,}([+-]?[0-1]?[0-9]?[0-9])\s+([0-5]?[0-9]\.\d{3,})$/, xi = /^(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?$/i, Ti = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?$/i, Mi = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?$/i, Ci = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?$/i;
function kr(i) {
...
const Wr = zr();
oi.formats = Wr.map((i) => i.verbatimCoordinates);
const Gr = oi;
function Oi(i, e, t) {
  const n = i.slice();
  ...
  return {
    ...
    p(c, E) {
      ...
      102823936 && (o = Li(
        /*listFeatures*/
        c[13]
      ), kt(), t = ir(t, E, g, 1, c, o, n, e, tr, Ai, null, Oi), Ot());
    },
    i(c) {
      if (!r) {
...
function Ai(i, e) {
  ...
  return n = new yr({
    ...
    first: null,
    c() {
      t = Zn(), Ve(n.$$.fragment), this.first = t;
    },
    m(g, c) {
...
function Zr(i, e, t) {
  ...
  const ye = void 0;
  let { reverseGeocodingExcludeTypes: Ne = ye } = e, { zoom: de = g } = e, { apiUrl: fe = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: J = {} } = e, { iconsBaseUrl: ai = "https://cdn.maptiler.com/maptiler-geocoding-control/v2.1.1/icons/" } = e, { adjustUrlQuery: Dt = () => {
  } } = e, { adjustUrl: Ut = () => {
  } } = e;
  function hn(_) {
    Te.focus(_);
  ...
  function vn(_) {
    t(0, w = N === "always"), t(13, F = void 0), t(14, G = void 0), t(15, Y = -1), fi(_[1].toFixed(6) + ", " + Mr(_[0], [-180, 180], !0).toFixed(6), !1, !0);
  }
  function bn(_) {
    if (!F)
      return;
...
var Vr = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, Xt = Math.ceil, Se = Math.floor, pe = "[BigNumber Error] ", Ii = pe + "Number primitive has more than 15 significant digits: ", Me = 1e14, q = 14, Bi = 9007199254740991, Jt = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], Ze = 1e7, we = 1e9;
function sn(i) {
  ...
  function v(s, l) {
    ...
    if (l == null) {
      ...
      if ((d = typeof s == "number") && s * 0 == 0) {
        ...
        if (!Vr.test(w = String(s))) return n(L, w, d);
...
var $r = (i) => i, es = (i) => {
...
}, Rt = (i, e) => i.x.times(e.y).minus(i.y.times(e.x)), un = (i, e) => i.x.times(e.x).plus(i.y.times(e.y)), zt = (i) => un(i, i).sqrt(), ts = (i, e, t) => {
...
}, zi = (i, e, t) => e.y.isZero() ? null : { x: i.x.plus(e.x.div(e.y).times(t.minus(i.y))), y: t }, Wi = (i, e, t) => e.x.isZero() ? null : { x: t, y: i.y.plus(e.y.div(e.x).times(t.minus(i.x))) }, ns = (i, e, t, n) => {
  ...
  getLeftmostComparator(e) {
    const t = /* @__PURE__ */ new Map(), n = (r) => {
      const u = r.otherSE;
      t.set(r, {
        sine: ts(this.point, e.point, u.point),
        cosine: is(this.point, e.point, u.point)
      });
    };
    return (r, u) => {
  ...
  run(i, e, t) {
    ...
    Ue.reset();
    const o = rs.factory(u.segments);
    return new ss(o).getGeom();
  }
}, yt = new ls(), Wt = yt, us = 0, Gt = class Pt {
  ...
  constructor(e, t, n, r) {
    ...
    P(this, "_afterState");
    P(this, "_isInResult");
    this.id = ++us, this.leftSE = e, e.segment = this, e.otherSE = t, this.rightSE = t, t.segment = this, t.otherSE = e, this.rings = n, this.windings = r;
  }
  ...
  getIntersection(e) {
    ...
    if (C) return h;
    if (S) return g;
    const R = ns(u, this.vector(), o, e.vector());
...
}, fs = (i, ...e) => Wt.run("union", i, e), cs = (i, ...e) => Wt.run("difference", i, e);
Ue.set;
function fn(i, e, t) {
  if (i !== null)
...
function ms(i) {
  ...
  const t = i.features[0].properties || {}, n = cs(e[0], ...e.slice(1));
...
function Fi(i, e) {
  ...
  const n = It(qi(i)), r = (n[2] - n[0]) / 360 / 1e3, u = n[0] < -180, h = n[2] > 180, o = vs(i);
...
function bs(i, e, t = !0, n = !0, r = {}, u = {}, h = ji) {
  let o;
  const g = [];
  let c, E, S;
  function C() {
  ...
  function z(T = !1) {
    ...
    return T && k.classList.add("marker-interactive"), new Lr({
...
function ws(i, e, t) {
  ...
  class C extends i {
    ...
    onAddInt(v) {
      ...
      return Yt(this, O, new Hr({ target: N, props: m })), ue(this, O).$on("select", (a) => {
...
const { MapLibreBasedGeocodingControl: Es, events: Xe } = ws(
  vi.Evented,
  vi,
  (i, e) => {
    const t = {};
...
class Ss extends Es {
  onAdd(e) {
    var t;
    return (t = e.telemetry) == null || t.registerModule(zn, Wn), super.onAddInt(e);
  }
}
...
export {
  Ts as FeaturesListedEvent,
  Ms as FeaturesMarkedEvent,
  Ss as GeocodingControl,
  Cs as OptionsVisibilityChangeEvent,
  Ns as PickEvent,
  ks as QueryChangeEvent,
  Os as ResponseEvent,
  Rs as ReverseToggleEvent,
  xs as SelectEvent,
  bs as createMapLibreGlMapController
};
