...
function _l(r, t, { bubbles: e = !1, cancelable: n = !1 } = {}) {
...
const gi = [], ys = [];
let di = [];
const oa = [], Cl = /* @__PURE__ */ Promise.resolve();
let ms = !1;
function Nl() {
  ms || (ms = !0, Cl.then(Ja));
}
...
function Ja() {
  ...
  do {
    try {
      ...
      throw gi.length = 0, hi = 0, t;
    }
    for (Wi(null), gi.length = 0, hi = 0; ys.length; )
      ys.pop()();
...
function Sl(r) {
  const t = [], e = [];
  di.forEach((n) => r.indexOf(n) === -1 ? t.push(n) : e.push(n)), e.forEach((n) => n()), di = t;
}
...
function ar(r, t) {
  const e = r.$$;
  e.fragment !== null && (Sl(e.after_update), Fr(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function wl(r, t) {
  r.$$.dirty[0] === -1 && (gi.push(r), Nl(), r.$$.dirty.fill(0)), r.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function kr(r, t, e, n, i, o, s, a = [-1]) {
  ...
  if (l.ctx = e ? e(r, t.props || {}, (f, h, ...g) => {
    ...
    return l.ctx && i(l.ctx[f], l.ctx[f] = p) && (!l.skip_bound && l.bound[f] && l.bound[f](p), c && wl(r, f)), h;
...
class Gr {
  ...
  $set(t) {
    this.$$set && !fl(t) && (this.$$.skip_bound = !0, this.$$set(t), this.$$.skip_bound = !1);
  }
}
function Ll(r) {
  let t, e;
...
function Pl(r) {
  ...
  return {
    ...
    p(d, [y]) {
      y & /*feature*/
      1 && o !== (o = /*feature*/
      d[0].place_name.replace(/,.*/, "") + "") && Ki(s, o), y & /*feature*/
      1 && l !== (l = /*feature*/
      d[0].place_name.replace(/[^,]*,?\s*/, "") + "") && Ki(c, l), /*showPlaceType*/
...
function Xl(r, t, e) {
  ...
  async function ss(x, { byId: Bt = !1, exact: Gn = !1 } = {}) {
    e(16, kn = void 0);
    const Ui = $s(), ze = new URLSearchParams();
    C != null && ze.set("language", Array.isArray(C) ? C.join(",") : C), St && ze.set("types", St.join(",")), Ui || (u && ze.set("bbox", u.map((mr) => mr.toFixed(6)).join(",")), h && ze.set("country", Array.isArray(h) ? h.join(",") : h)), Bt || (A && ze.set("proximity", A.map((mr) => mr.toFixed(6)).join(",")), (Gn || !Y) && ze.set("autocomplete", "false"), ze.set("fuzzyMatch", String(E))), S !== void 0 && ze.set("limit", String(S)), ze.set("key", a);
    ...
    yr("response", { url: Xr, featureCollection: cs }), Bt ? (e(12, nt = void 0), e(45, vt = cs.features[0]), Io = [vt]) : (e(12, nt = cs.features.filter(y)), Io = nt, Ui && Bn.focus());
  }
  function Wu() {
    var Gn, Ui, ze, Xr;
    ...
    for (const _e of Ot)
      (Bt || !_e.matching_text) && (x[0] = Math.min(x[0], ((Gn = _e.bbox) == null ? void 0 : Gn[0]) ?? _e.center[0]), x[1] = Math.min(x[1], ((Ui = _e.bbox) == null ? void 0 : Ui[1]) ?? _e.center[1]), x[2] = Math.max(x[2], ((ze = _e.bbox) == null ? void 0 : ze[2]) ?? _e.center[0]), x[3] = Math.max(x[3], ((Xr = _e.bbox) == null ? void 0 : Xr[3]) ?? _e.center[1]));
    N && Ot.length > 0 && (vt && x[0] === x[2] && x[1] === x[3] ? N.flyTo(vt.center, Ht) : N.fitBounds(fa(x), 50));
  }
  function ju(x) {
    e(0, q = p === "always"), Fn(ql(x[0], [-180, 180], !0).toFixed(6) + "," + x[1].toFixed(6));
  }
  function Ku(x) {
    if (!nt)
      return;
  ...
  function as(x = !0) {
    if (e(16, kn = void 0), Y) {
      if (fi && clearTimeout(fi), P.length <= L)
        return;
      const Bt = P;
  ...
  const $u = () => e(11, ge = !0), tl = () => e(11, ge = !1), el = () => as(), nl = () => {
    e(1, P = ""), Bn.focus();
  }, rl = () => e(0, q = !q), il = () => e(16, kn = void 0), ol = (x) => e(13, Ft = x), sl = (x) => us(x), al = () => e(13, Ft = -1), ul = () => {
  };
  return r.$$set = (x) => {
    ...
    4098 && (P || (e(45, vt = void 0), e(12, nt = void 0), e(16, kn = void 0), e(44, Ot = nt))), r.$$.dirty[1] & /*showFullGeometry, picked*/
...
var Ms = (
  ...
  function() {
    function r(t) {
      t === void 0 && (t = Wl), this._root = null, this._size = 0, this._comparator = t;
    }
    return r.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = gs(e, n, a, i) : s = gs(e, n, s, i), this._root = jl(s, a, i);
...
var Zl = Cr * Cr, Ss = function(t, e) {
  if (-Cr < t && t < Cr && -Cr < e && e < Cr)
    return 0;
  var n = t - e;
  return n * n < Zl * t * e ? 0 : t < e ? -1 : 1;
}, $l = /* @__PURE__ */ function() {
  function r() {
  ...
  return Ne(r, [{
    ...
    value: function(e) {
      var n = this, i = /* @__PURE__ */ new Map(), o = function(a) {
        var u = a.otherSE;
        i.set(a, {
          sine: tc(n.point, e.point, u.point),
          cosine: ec(n.point, e.point, u.point)
        });
      };
      return function(s, a) {
  ...
  function r(t, e, n, i) {
    vn(this, r), this.id = ++rc, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = n, this.windings = i;
  }
  return Ne(r, [{
    key: "replaceRightSE",
    ...
    value: function(e) {
      ...
      if (h)
        return l;
      var p = nc(s, this.vector(), u, e.vector());
      return p === null || !qi(o, p) ? null : Ji.round(p.x, p.y);
    }
    /**
...
}(), Ia = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, uc = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, lc = /* @__PURE__ */ function() {
  function r() {
    vn(this, r);
  }
  return Ne(r, [{
    ...
    value: function(e, n, i) {
      ...
      for (var N = new ac(d), L = d.size, M = d.pop(); M; ) {
        var B = M.key;
        if (d.size === L) {
          var A = B.segment;
      ...
      Ji.reset();
      var R = oc.factory(N.segments), Y = new sc(R);
      return Y.getGeom();
    }
  }]), r;
}(), Nn = new lc(), cc = function(t) {
...
class Ec extends Gr {
  constructor(t) {
    super(), kr(this, t, _c, mc, Br, { displayIn: 0 });
  }
}
function ou(r, t, e) {
  if (r !== null)
...
}, si = { DimensionalComparator: { configurable: !0 }, serialVersionUID: { configurable: !0 }, NULL_ORDINATE: { configurable: !0 }, X: { configurable: !0 }, Y: { configurable: !0 }, Z: { configurable: !0 } };
...
si.DimensionalComparator.get = function() {
  return rr;
};
si.serialVersionUID.get = function() {
  return 6683108902428367e3;
};
si.NULL_ORDINATE.get = function() {
  return z.NaN;
};
si.X.get = function() {
  return 0;
...
Ko.prototype.read = function(t) {
  ...
  if (t.search("EMPTY") !== -1 && (o = Ze.emptyTypeStr.exec(t), o[2] = void 0), o && (n = o[1].toLowerCase(), i = o[2], pi[n] && (e = pi[n].apply(this, [i]))), e === void 0)
...
var Un = {
  ...
  multipoint: function(t) {
    ...
    for (var n, i = t.trim().split(","), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Ze.trimParens, "$1"), o.push(pi.point.apply(e, [n]));
  ...
  multilinestring: function(t) {
    ...
    for (var n, i = t.trim().split(Ze.parenComma), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Ze.trimParens, "$1"), o.push(pi.linestring.apply(e, [n]));
  ...
  polygon: function(t) {
    ...
    for (var n, i, o, s = t.trim().split(Ze.parenComma), a, u = [], l = 0, c = s.length; l < c; ++l)
      n = s[l].replace(Ze.trimParens, "$1"), i = pi.linestring.apply(e, [n]), o = e.geometryFactory.createLinearRing(i._points), l === 0 ? a = o : u.push(o);
  ...
  multipolygon: function(t) {
    ...
    for (var n, i = t.trim().split(Ze.doubleParenComma), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Ze.trimParens, "$1"), o.push(pi.polygon.apply(e, [n]));
...
}, ai = { DONT_INTERSECT: { configurable: !0 }, DO_INTERSECT: { configurable: !0 }, COLLINEAR: { configurable: !0 }, NO_INTERSECTION: { configurable: !0 }, POINT_INTERSECTION: { configurable: !0 }, COLLINEAR_INTERSECTION: { configurable: !0 } };
...
ai.DONT_INTERSECT.get = function() {
  return 0;
};
ai.DO_INTERSECT.get = function() {
  return 1;
};
ai.COLLINEAR.get = function() {
  return 2;
};
ai.NO_INTERSECTION.get = function() {
  return 0;
};
ai.POINT_INTERSECTION.get = function() {
  return 1;
};
ai.COLLINEAR_INTERSECTION.get = function() {
  return 2;
};
Object.defineProperties(ft, ai);
var zr = function(r) {
  function t() {
...
var O = function() {
}, ui = { CLOCKWISE: { configurable: !0 }, RIGHT: { configurable: !0 }, COUNTERCLOCKWISE: { configurable: !0 }, LEFT: { configurable: !0 }, COLLINEAR: { configurable: !0 }, STRAIGHT: { configurable: !0 } };
...
ui.CLOCKWISE.get = function() {
  return -1;
};
ui.RIGHT.get = function() {
  return O.CLOCKWISE;
};
ui.COUNTERCLOCKWISE.get = function() {
  return 1;
};
ui.LEFT.get = function() {
  return O.COUNTERCLOCKWISE;
};
ui.COLLINEAR.get = function() {
  return 0;
};
ui.STRAIGHT.get = function() {
  return O.COLLINEAR;
};
Object.defineProperties(O, ui);
var Qn = function() {
};
...
Ci.prototype.compare = function(t, e) {
  var n = t, i = e;
...
Ci.prototype.OLDcompare = function(t, e) {
  var n = t, i = e;
  if (n.length < i.length)
    return -1;
  if (n.length > i.length)
...
li.prototype.put = function() {
};
li.prototype.size = function() {
};
li.prototype.values = function() {
};
li.prototype.entrySet = function() {
};
var Nc = function(r) {
  function t() {
    r.apply(this, arguments);
...
De.getStackTrace = function() {
  if (arguments.length === 1) {
    var t = arguments[0], e = new bc(), n = new Sc();
    return t.printStackTrace(n), e.toString();
  } else if (arguments.length === 2) {
    var i = arguments[0], o = arguments[1], s = "";
    new wc(De.getStackTrace(i));
    for (var a = new Rc(), u = 0; u < o; u++)
      try {
...
Ae.prototype.editGeometryCollection = function(t, e) {
  ...
  return i.getClass() === Ni ? this._factory.createMultiPoint(o.toArray([])) : i.getClass() === Lr ? this._factory.createMultiLineString(o.toArray([])) : i.getClass() === xn ? this._factory.createMultiPolygon(o.toArray([])) : this._factory.createGeometryCollection(o.toArray([]));
};
...
var H = function r() {
  this._precisionModel = new $(), this._SRID = 0, this._coordinateSequenceFactory = r.getDefaultCoordinateSequenceFactory(), arguments.length === 0 || (arguments.length === 1 ? G(arguments[0], yi) ? this._coordinateSequenceFactory = arguments[0] : arguments[0] instanceof $ && (this._precisionModel = arguments[0]) : arguments.length === 2 ? (this._precisionModel = arguments[0], this._SRID = arguments[1]) : arguments.length === 3 && (this._precisionModel = arguments[0], this._SRID = arguments[1], this._coordinateSequenceFactory = arguments[2]));
...
var Oc = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], ts = function(t) {
  this.geometryFactory = t || new H();
};
ts.prototype.read = function(t) {
  ...
  return Oc.indexOf(n) !== -1 ? tn[n].apply(this, [e.coordinates]) : n === "GeometryCollection" ? tn[n].apply(this, [e.geometries]) : tn[n].apply(this, [e]);
};
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.buildMinimalRings = function() {
    ...
    do {
      if (o.getMinEdgeRing() === null) {
        var s = new Dc(o, n._geometryFactory);
        i.add(s);
      }
      o = o.getNext();
...
xi.prototype.createNode = function(t) {
...
ve.prototype.buildMaximalEdgeRings = function(t) {
  for (var e = this, n = new b(), i = t.iterator(); i.hasNext(); ) {
    ...
    if (o.isInResult() && o.getLabel().isArea() && o.getEdgeRing() === null) {
      var s = new Tc(o, e._geometryFactory);
...
wi.prototype.distance = function(t, e) {
};
...
var mu = function(r) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[0] instanceof t && G(arguments[1], wi)) {
...
var K = function() {
}, ci = { PI_TIMES_2: { configurable: !0 }, PI_OVER_2: { configurable: !0 }, PI_OVER_4: { configurable: !0 }, COUNTERCLOCKWISE: { configurable: !0 }, CLOCKWISE: { configurable: !0 }, NONE: { configurable: !0 } };
K.prototype.interfaces_ = function() {
  return [];
};
K.prototype.getClass = function() {
...
ci.PI_TIMES_2.get = function() {
  return 2 * Math.PI;
};
ci.PI_OVER_2.get = function() {
  return Math.PI / 2;
};
ci.PI_OVER_4.get = function() {
  return Math.PI / 4;
};
...
ci.NONE.get = function() {
  return O.COLLINEAR;
};
Object.defineProperties(K, ci);
var lt = function r() {
...
Fe.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof Rt ? this.addPolygon(t) : t instanceof pt ? this.addLineString(t) : t instanceof de ? this.addPoint(t) : t instanceof Ni ? this.addCollection(t) : t instanceof Lr ? this.addCollection(t) : t instanceof xn ? this.addCollection(t) : t instanceof ne && this.addCollection(t);
};
...
On.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new qs(), this._pointSnapper = new bi(this._noder.getIndex()), this.snapRound(t, this._li);
};
...
var Fc = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.prepareEvents = function() {
    ...
    for (var o = this, s = n.getMonotoneChainEdge(), a = s.getStartIndexes(), u = 0; u < a.length - 1; u++) {
      var l = new lo(s, u), c = new me(i, s.getMinX(u), l);
...
Pi.prototype.visitItem = function(t) {
  this._items.add(t);
};
Pi.prototype.getItems = function() {
  return this._items;
};
...
Ri.prototype.locate = function(t) {
  var e = new rn(t), n = new Oi(e);
...
Mr.prototype.query = function() {
  if (arguments.length === 2) {
    var t = arguments[0], e = arguments[1], n = new Pi();
...
var Xi = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(n, i) {
    ...
    return G(this._parentGeom, ur) && this._parentGeom.getNumGeometries() > 50 ? (this._areaPtLocator === null && (this._areaPtLocator = new Ri(this._parentGeom)), this._areaPtLocator.locate(n)) : this._ptLocator.locate(n, this._parentGeom);
...
Di.prototype.getArgGeometry = function(t) {
  return this._arg[t].getGeometry();
};
Di.prototype.setComputationPrecision = function(t) {
...
Ti.prototype.getLinework = function() {
...
var gt = 1e-6, ot = Math.PI, Hn = ot / 2, Pa = ot / 4, tr = ot * 2, Er = 180 / ot, $e = ot / 180, te = Math.abs, Gc = Math.atan, Mi = Math.atan2, Lt = Math.cos, bt = Math.sin, Eo = Math.sqrt;
function Mu(r) {
  ...
  return function(l) {
    ...
    function R(Y, ut) {
      ...
      if (g && p.push([Y, ut]), N)
        ...
        var Ht = [E = Math.max(bo, Math.min(Hi, E)), C = Math.max(bo, Math.min(Hi, C))], he = [Y = Math.max(bo, Math.min(Hi, Y)), ut = Math.max(bo, Math.min(Hi, ut))];
        qc(Ht, he, r, t, e, n) ? (S || (c.lineStart(), c.point(Ht[0], Ht[1])), c.point(he[0], he[1]), St || c.lineEnd(), L = !1) : St && (c.lineStart(), c.point(Y, ut), L = !1);
      }
      E = Y, C = ut, S = St;
    }
    return M;
  ...
  for (var a = 0, u = r.length; a < u; ++a)
    if (c = (l = r[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + Pa, p = bt(g), d = Lt(g), y = 0; y < c; ++y, h = E, p = S, d = N, f = _) {
        ...
        if (vs.add(Mi(q * M * bt(B), d * N + q * Lt(B))), o += A ? L + M * tr : L, A ^ h >= e ^ E >= e) {
          var j = Xo(Fi(f), Fi(_));
          Os(j);
          var P = Xo(i, j);
          Os(P);
          var X = (A ^ L >= 0 ? -1 : 1) * Ai(P[2]);
...
Vr();
Vr();
var Bi = 1 / 0, Yo = Bi, fo = -Bi, Ho = fo, Ga = {
  point: jc,
  lineStart: Yi,
  lineEnd: Yi,
  polygonStart: Yi,
  ...
  result: function() {
    var r = [[Bi, Yo], [fo, Ho]];
    return fo = Ho = -(Yo = Bi = 1 / 0), r;
  }
};
function jc(r, t) {
  r < Bi && (Bi = r), r > fo && (fo = r), t < Yo && (Yo = t), t > Ho && (Ho = t);
}
Vr();
function zu(r, t, e, n) {
  return function(i, o) {
    var s = t(o), a = i.invert(n[0], n[1]), u = Fu(), l = t(u), c = !1, f, h, g, p = {
      ...
      polygonEnd: function() {
        ...
        var L = Wc(f, a);
        h.length ? (c || (o.polygonStart(), c = !0), Bu(h, Qc, L, e, o)) : L && (c || (o.polygonStart(), c = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), h = f = null;
      },
      sphere: function() {
    ...
    function N() {
      ...
      if (g.pop(), f.push(g), g = null, !!A) {
        ...
        A > 1 && L & 2 && M.push(M.pop().concat(M.shift())), h.push(M.filter(Kc));
      }
    }
    return p;
  };
...
function Jc(r) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      te(u - ot) < gt ? (r.point(t, e = (e + s) / 2 > 0 ? Hn : -Hn), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), r.point(o, e), i = 0) : n !== a && u >= ot && (te(t - n) < gt && (t -= n * gt), te(o - a) < gt && (o -= a * gt), e = Zc(t, e, o, s), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), i = 0), r.point(t = o, e = s), n = a;
    },
    lineEnd: function() {
      r.lineEnd(), t = e = NaN;
    },
...
function Uu(r, t, e) {
  ...
  r.scale(150).translate([0, 0]), o != null && r.clipExtent(null), zc(e, r.stream(Ga));
...
function of(r, t) {
  function e(n, i, o, s, a, u, l, c, f, h, g, p, d, y) {
    ...
    if (C > 4 * t && d--) {
      var S = s + h, N = a + g, L = u + p, M = Eo(S * S + N * N + L * L), B = Ai(L /= M), A = te(te(L) - 1) < gt || te(o - f) < gt ? (o + f) / 2 : Mi(N, S), q = r(A, B), j = q[0], P = q[1], X = j - n, R = P - i, Y = E * X - _ * R;
      (Y * Y / C > t || te((_ * X + E * R) / C - 0.5) > 0.3 || s * h + a * g + u * p < nf) && (e(n, i, o, s, a, u, j, P, A, S /= M, N /= M, L, d, y), y.point(j, P), e(j, P, A, S, N, L, l, c, f, h, g, p, d, y));
    }
  }
  return function(n) {
...
function uf(r) {
  ...
  A.stream = function(R) {
    return M && B === R ? M : M = sf(d(h, L(S(B = R))));
  }, A.clipAngle = function(R) {
    return arguments.length ? (d = +R ? tf(p = R * $e, 6 * $e) : (p = null, za), X()) : p * Er;
  }, A.clipExtent = function(R) {
    return arguments.length ? (S = R == null ? (y = _ = E = C = null, ka) : Hc(y = +R[0][0], _ = +R[0][1], E = +R[1][0], C = +R[1][1]), X()) : y == null ? null : [[y, _], [E, C]];
  }, A.scale = function(R) {
    ...
    return arguments.length ? (L = Ua(j, N = R * R), X()) : Eo(N);
...
var qu = lf(function(r) {
  return (r = Mu(r)) && r / bt(r);
});
qu.invert = cf(function(r) {
  return r;
});
function ff() {
  return af(qu).scale(79.4188).clipAngle(180 - 1e-3);
}
function qa(r, t) {
  return [r, t];
}
...
function To(r, t, e, n) {
  ...
  }, l = new Us(), c = l.read(u), f = dc(vc(t, e), "meters"), h = zt.bufferOp(c, f, n), g = new vu();
...
function gf(r) {
  var t = Ic(r).geometry.coordinates, e = [-t[0], -t[1]];
...
function df(r, t, e = !0, n = !0, i = {}, o = {}, s = {
  ...
  function d(_ = !1) {
    ...
    return _ && E.classList.add("marker-interactive"), new Ec({
...
class vf extends EventTarget {
  ...
  onAdd(e) {
    ...
    No(this, En, new Yl({ target: n, props: h }));
    for (const g of [
      "select",
      "pick",
      "featuresListed",
...
export {
  _f as GeocodingControl,
  df as createMapLibreGlMapController
};
