...
const mi = [], ws = [];
let _i = [];
const ma = [], Kl = /* @__PURE__ */ Promise.resolve();
let Ps = !1;
function Zl() {
  Ps || (Ps = !0, Kl.then(vu));
}
...
function kf(n, t) {
  n && Qa.hasOwnProperty(n.type) ? Qa[n.type](n, t) : Ko(n, t);
}
Wn();
Wn();
function Vs(n) {
...
function Xf(n, t, e, r) {
  ...
  return function(l) {
    ...
    function b() {
      for (var k = 0, Q = 0, _t = g.length; Q < _t; ++Q)
        for (var Kt = g[Q], zt = 1, kr = Kt.length, Ie = Kt[0], De, Ue, In = Ie[0], sn = Ie[1]; zt < kr; ++zt)
          De = In, Ue = sn, Ie = Kt[zt], In = Ie[0], sn = Ie[1], Ue <= r ? sn > r && (In - De) * (r - Ue) > (sn - Ue) * (n - De) && ++k : sn <= r && (In - De) * (r - Ue) < (sn - Ue) * (n - De) && --k;
      return k;
    }
    function A() {
      c = f, h = [], g = [], T = !0;
    ...
    function x(k, Q) {
      var _t = i(k, Q);
      if (g && p.push([k, Q]), L)
        v = k, d = Q, y = _t, L = !1, _t && (c.lineStart(), c.point(k, Q));
      else if (_t && N)
        c.point(k, Q);
      else {
        ...
        Vf(Kt, zt, n, t, e, r) ? (N || (c.lineStart(), c.point(Kt[0], Kt[1])), c.point(zt[0], zt[1]), _t || c.lineEnd(), T = !1) : _t && (c.lineStart(), c.point(k, Q), T = !1);
      }
      I = k, C = Q, N = _t;
    }
    return R;
...
function Qf(n) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      oe(u - ut) < vt ? (n.point(t, e = (e + s) / 2 > 0 ? jr : -jr), n.point(r, e), n.lineEnd(), n.lineStart(), n.point(a, e), n.point(o, e), i = 0) : r !== a && u >= ut && (oe(t - r) < vt && (t -= r * vt), oe(o - a) < vt && (o -= a * vt), e = Kf(t, e, o, s), n.point(r, e), n.lineEnd(), n.lineStart(), n.point(a, e), i = 0), n.point(t = o, e = s), r = a;
    },
    lineEnd: function() {
      n.lineEnd(), t = e = NaN;
    },
