...
var Je = (i, e, t) => (ii(i, typeof e != "symbol" ? e + "" : e, t), t);
import { forwardRef as ri, useRef as st, useEffect as Xe, useImperativeHandle as ni, createElement as oi } from "react";
function A() {
}
function si(i, e) {
  for (const t in e)
...
function Rt() {
  ...
  do {
    ...
    for (Ne(null), we.length = 0, ye = 0; xe.length; )
      xe.pop()();
...
function Si(i, e, t, r, o, l, n, a, d, u, f, b) {
  ...
  for (W = p; W--; ) {
    const v = b(o, l, W), N = t(v);
    let m = n.get(N);
    m ? r && R.push(() => m.p(v, e)) : (m = u(N, v), m.c()), w.set(N, y[W] = m), N in F && P.set(N, Math.abs(W - F[N]));
  }
  const E = /* @__PURE__ */ new Set(), g = /* @__PURE__ */ new Set();
  function I(v) {
    H(v, 1), v.m(a, f), n.set(v.key, v), f = v.first, p--;
  }
  for (; h && p; ) {
    const v = y[p - 1], N = i[h - 1], m = v.key, L = N.key;
    v === N ? (f = v.first, h--, p--) : w.has(L) ? !n.has(m) || E.has(m) ? I(v) : g.has(L) ? h-- : P.get(m) > P.get(L) ? (g.add(m), I(v)) : (E.add(L), h--) : (d(N, n), h--);
  }
  for (; h--; ) {
    const v = i[h];
    w.has(v.key) || d(v, n);
...
function te(i, e, t) {
  ...
  r && r.m(e, t), et(() => {
    const l = i.$$.on_mount.map(Ct).filter(Tt);
    i.$$.on_destroy ? i.$$.on_destroy.push(...l) : re(l), i.$$.on_mount = [];
  }), o.forEach(et);
}
function ie(i, e) {
  const t = i.$$;
  t.fragment !== null && (wi(t.after_update), re(t.on_destroy), t.fragment && t.fragment.d(e), t.on_destroy = t.fragment = null, t.ctx = []);
}
function pi(i, e) {
  i.$$.dirty[0] === -1 && (we.push(i), Li(), i.$$.dirty.fill(0)), i.$$.dirty[e / 31 | 0] |= 1 << e % 31;
}
function me(i, e, t, r, o, l, n = null, a = [-1]) {
  ...
  if (u.ctx = t ? t(i, e.props || {}, (b, h, ...p) => {
    ...
    return u.ctx && o(u.ctx[b], u.ctx[b] = W) && (!u.skip_bound && u.bound[b] && u.bound[b](W), f && pi(i, b)), h;
  }) : [], u.update(), f = !0, re(u.before_update), u.fragment = r ? r(u.ctx) : !1, e.target) {
    if (e.hydrate) {
      const b = gi(e.target);
      u.fragment && u.fragment.l(b), b.forEach(B);
    } else
      u.fragment && u.fragment.c();
    e.intro && H(i.$$.fragment), te(i, e.target, e.anchor), Rt();
  }
  Ne(d);
}
class ge {
...
function Di(i) {
  ...
  function R(m, L) {
    ...
    m[5] ? Bi : (
      ...
      m[0].address ? Ui : (
        ...
        ((M = m[0].properties) == null ? void 0 : M.kind) === "road_relation" ? Oi : (t == null && (t = !!/*feature*/
        m[0].id.startsWith("address.")), t ? Ii : (r == null && (r = !!/*feature*/
        m[0].id.startsWith("postal_code.")), r ? Ri : (o == null && (o = !!/*feature*/
        m[0].id.startsWith("poi.")), o ? Wi : (
          /*isReverse*/
          m[7] ? Mi : Ti
        ))))
      )
  ...
  let E = R(i, -1), g = E(i), I = h && mt(i);
  return {
    c() {
      e = O("li"), g.c(), l = V(), n = O("span"), a = O("span"), d = O("span"), f = ae(u), b = V(), I && I.c(), p = V(), W = O("span"), y = ae(F), c(d, "class", "primary svelte-ltkwvy"), c(a, "class", "svelte-ltkwvy"), c(W, "class", "line2 svelte-ltkwvy"), c(n, "class", "texts svelte-ltkwvy"), c(e, "tabindex", "0"), c(
        e,
        "data-selected",
        /*selected*/
        i[1]
      ), c(e, "class", "svelte-ltkwvy"), oe(
        e,
        "selected",
        /*selected*/
        i[1]
    ...
    m(m, L) {
      z(m, e, L), g.m(e, null), T(e, l), T(e, n), T(n, a), T(a, d), T(d, f), T(a, b), I && I.m(a, null), T(n, p), T(n, W), T(W, y), w || (P = [
        q(
          e,
          "mouseenter",
          /*mouseenter_handler*/
    ...
    p(m, [L]) {
      ...
      )) + "") && ke(f, u), L & /*showPlaceType, feature, imageUrl*/
      37 && (h = /*showPlaceType*/
      ...
      m[5]) && !/*isReverse*/
      m[7]), h ? I ? I.p(m, L) : (I = mt(m), I.c(), I.m(a, null)) : I && (I.d(1), I = null), L & /*feature*/
      1 && F !== (F = /*isReverse*/
      (m[7] ? "" : (
        /*feature*/
...
const ht = /(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?/i, bt = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?/i, vt = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?/i, _t = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?/i;
function Ki(i) {
...
function Lt(i, e) {
  ...
  if (e == "DM") {
    let a = Vi(o, 3).toFixed(3).padStart(6, "0");
    return `${r}° ${a}'`;
  }
...
const ir = tr();
tt.formats = ir.map((i) => i.verbatimCoordinates);
const rr = tt;
function wt(i, e, t) {
  const r = i.slice();
...
function nr(i) {
  let e, t = [], r = /* @__PURE__ */ new Map(), o, l, n, a = ft(
    /*listFeatures*/
    i[14]
  );
  const d = (u) => (
  ...
  return {
    ...
    p(u, f) {
      ...
      17880064 && (a = ft(
        /*listFeatures*/
        u[14]
      ), Ae(), t = Si(t, f, d, 1, u, a, r, e, Ei, pt, null, wt), ze());
    },
    i(u) {
      if (!o) {
...
function or(i) {
  ...
  return t = new Ot({}), {
    c() {
      e = O("div"), le(t.$$.fragment), r = V(), o = O("div"), l = ae(
        /*noResultsMessage*/
        i[7]
      ), c(o, "class", "svelte-1r7dvt7"), c(e, "class", "no-results svelte-1r7dvt7");
    },
    m(a, d) {
      z(a, e, d), te(t, e, null), T(e, r), T(e, o), T(o, l), n = !0;
    },
    p(a, d) {
...
function ar(i) {
  ...
  return t = new Ot({}), d = new It({}), {
    c() {
      e = O("div"), le(t.$$.fragment), r = V(), o = O("div"), l = ae(
        /*errorMessage*/
        i[6]
      ), n = V(), a = O("button"), le(d.$$.fragment), c(o, "class", "svelte-1r7dvt7"), c(a, "class", "svelte-1r7dvt7"), c(e, "class", "error svelte-1r7dvt7");
    },
    m(h, p) {
      z(h, e, p), te(t, e, null), T(e, r), T(e, o), T(o, l), T(e, n), T(e, a), te(d, a, null), u = !0, f || (b = q(
        a,
        "click",
        /*click_handler_3*/
        i[68]
...
function pt(i, e) {
  ...
  return r = new zi({
    ...
    first: null,
    c() {
      t = fi(), le(r.$$.fragment), this.first = t;
    },
    m(a, d) {
      z(a, t, d), te(r, a, d), o = !0;
    },
    p(a, d) {
      e = a;
      const u = {};
...
function lr(i) {
  let e, t, r, o, l, n, a, d, u, f, b, h, p, W, F, y, w, P, R, E, g, I = !1;
  l = new Gi({}), b = new It({});
  let v = (
    /*abortController*/
    i[19] && Et()
  ...
  return ~(y = he(i)) && (w = M[y] = X[y](i)), {
    c() {
      e = V(), t = O("form"), r = O("div"), o = O("button"), le(l.$$.fragment), n = V(), a = O("input"), d = V(), u = O("div"), f = O("button"), le(b.$$.fragment), h = V(), v && v.c(), p = V(), N && N.c(), W = V(), L && L.c(), F = V(), w && w.c(), c(o, "class", "search-button svelte-1r7dvt7"), c(o, "type", "button"), c(
        a,
        "placeholder",
        /*placeholder*/
        i[8]
        ...
        /*placeholder*/
        i[8]
      ), c(a, "class", "svelte-1r7dvt7"), c(f, "type", "button"), c(
        f,
        "title",
        /*clearButtonTitle*/
        i[3]
      ), c(f, "class", "svelte-1r7dvt7"), c(u, "class", "clear-button-container svelte-1r7dvt7"), oe(
        u,
        "displayable",
        /*searchValue*/
        i[1] !== ""
      ), c(r, "class", "input-group svelte-1r7dvt7"), c(t, "tabindex", "0"), c(t, "class", P = lt(
        /*className*/
        i[2]
      ) + " svelte-1r7dvt7"), oe(
        t,
    ...
    m(_, D) {
      z(_, e, D), z(_, t, D), T(t, r), T(r, o), te(l, o, null), T(r, n), T(r, a), i[61](a), ct(
        a,
        /*searchValue*/
        i[1]
      ), T(r, d), T(r, u), T(u, f), te(b, f, null), T(u, h), v && v.m(u, null), T(r, p), N && N.m(r, null), T(r, W), L && L.m(r, null), T(t, F), ~y && M[y].m(t, null), R = !0, E || (g = [
        q(
          o,
          "click",
          /*click_handler*/
    ...
    p(_, D) {
      ...
      524288 && H(v, 1) : (v = Et(), v.c(), H(v, 1), v.m(u, null)) : v && (Ae(), G(v, 1, 1, () => {
        v = null;
      }), ze()), (!R || D[0] & /*searchValue*/
      2) && oe(
        u,
        "displayable",
        /*searchValue*/
      ...
      _[5] === !0 ? N ? (N.p(_, D), D[0] & /*enableReverse*/
      32 && H(N, 1)) : (N = St(_), N.c(), H(N, 1), N.m(r, W)) : N && (Ae(), G(N, 1, 1, () => {
        N = null;
      }), ze()), L && L.p && (!R || D[1] & /*$$scope*/
      134217728) && ui(
        L,
        m,
        _,
      ...
      let K = y;
      y = he(_), y === K ? ~y && M[y].p(_, D) : (w && (Ae(), G(M[K], 1, 1, () => {
        M[K] = null;
      }), ze()), ~y ? (w = M[y], w ? w.p(_, D) : (w = M[y] = X[y](_), w.c()), H(w, 1), w.m(t, null)) : w = null), (!R || D[0] & /*className*/
      4 && P !== (P = lt(
        /*className*/
        _[2]
      ) + " svelte-1r7dvt7")) && c(t, "class", P), (!R || D[0] & /*className, collapsed, searchValue*/
      22) && oe(
        t,
        "can-collapse",
        /*collapsed*/
    ...
    i(_) {
      R || (H(I), H(l.$$.fragment, _), H(b.$$.fragment, _), H(v), H(N), H(L, _), H(w), R = !0);
    },
    o(_) {
      G(I), G(l.$$.fragment, _), G(b.$$.fragment, _), G(v), G(N), G(L, _), G(w), R = !1;
    },
    d(_) {
      _ && (B(e), B(t)), ie(l), i[61](null), ie(b), v && v.d(), N && N.d(), L && L.d(_), ~y && M[y].d(), E = !1, re(g);
    }
  };
}
function cr(i, e, t) {
  let r, { $$slots: o = {}, $$scope: l } = e, { class: n = void 0 } = e, { apiKey: a } = e, { bbox: d = void 0 } = e, { clearButtonTitle: u = "clear" } = e, { clearOnBlur: f = !1 } = e, { collapsed: b = !1 } = e, { country: h = void 0 } = e, { debounceSearch: p = 200 } = e, { enableReverse: W = !1 } = e, { errorMessage: F = "Something went wrong…" } = e, { filter: y = () => !0 } = e, { flyTo: w = !0 } = e, { fuzzyMatch: P = !0 } = e, { language: R = void 0 } = e, { limit: E = void 0 } = e, { mapController: g = void 0 } = e, { minLength: I = 2 } = e, { noResultsMessage: v = "Oops! Looks like you're trying to predict something that's not quite right. We can't seem to find what you're looking for. Maybe try double-checking your spelling or try a different search term. Keep on typing - we'll do our best to get you where you need to go!" } = e, { placeholder: N = "Search" } = e, { proximity: m = [{ type: "server-geolocation" }] } = e, { reverseActive: L = W === "always" } = e, { reverseButtonTitle: X = "toggle reverse geocoding" } = e, { searchValue: M = "" } = e, { showFullGeometry: he = !0 } = e, { showPlaceType: _ = "ifNeeded" } = e, { showResultsWhileTyping: D = !0 } = e, { selectFirst: K = !0 } = e, { flyToSelected: be = !1 } = e, { markerOnSelected: Te = !0 } = e, { types: ce = void 0 } = e, { excludeTypes: Me = !1 } = e, { zoom: Se = 16 } = e, { maxZoom: ve = 18 } = e, { apiUrl: Fe = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: Pe = {} } = e, { iconsBaseUrl: it = "https://cdn.maptiler.com/maptiler-geocoding-control/v1.2.0/icons/" } = e, { adjustUrlQuery: He = (s) => {
  } } = e;
  function Ut() {
    Y.focus();
  }
  ...
  function rt(s, Z = !0) {
    t(1, M = s), Z ? (t(15, U = -1), ot()) : (Qe(), setTimeout(() => {
      Y.focus(), Y.select();
    }));
  }
  function Dt() {
    t(14, k = void 0), t(55, S = void 0), t(15, U = -1);
  }
  function At() {
    t(54, j = []), t(55, S = void 0);
  }
  let _e = !1, k, j, S, nt = "", Y, U = -1, x, We = [], ue, Le, Re, je;
  const zt = /* @__PURE__ */ new Set(), ne = vi();
  bi(() => {
    g && (g.setEventHandler(void 0), g.indicateReverse(!1), g.setSelectedMarker(-1), g.setMarkers(void 0, void 0));
  });
  function ot(s) {
    if (Le && (clearTimeout(Le), Le = void 0), U > -1 && k)
      t(55, S = k[U]), t(1, M = S.place_type[0] === "reverse" ? S.place_name : S.place_name.replace(/,.*/, "")), t(18, x = void 0), t(54, j = void 0), t(15, U = -1);
    else if (M) {
      const Z = s || !Ze(M);
      Ge(M, { exact: !0 }).then(() => {
        t(54, j = k), t(55, S = void 0), Z && Ft();
      }).catch(($) => t(18, x = $));
    }
  }
  function Ze(s) {
  ...
  async function Ge(s, { byId: Z = !1, exact: $ = !1 } = {}) {
    t(18, x = void 0), ue == null || ue.abort();
    const ee = new AbortController();
    t(19, ue = ee);
    try {
      const C = Ze(s), J = new URLSearchParams();
      if (R !== void 0 && J.set("language", Array.isArray(R) ? R.join(",") : R ?? ""), ce && J.set("types", ce.join(",")), Me && J.set("excludeTypes", String(Me)), d && J.set("bbox", d.map((Oe) => Oe.toFixed(6)).join(",")), h && J.set("country", Array.isArray(h) ? h.join(",") : h), !Z && !C) {
        const Oe = await qi(g, m, ee);
        Oe && J.set("proximity", Oe), ($ || !D) && J.set("autocomplete", "false"), J.set("fuzzyMatch", String(P));
      }
      E !== void 0 && (!C || (ce == null ? void 0 : ce.length) === 1) && J.set("limit", String(E)), J.set("key", a), He(J);
      const Ie = Fe + "/" + encodeURIComponent(C ? C.decimalLongitude + "," + C.decimalLatitude : s) + ".json?" + J.toString();
      if (Ie === nt) {
        Z ? (t(14, k = void 0), t(55, S = We[0])) : t(14, k = We);
        return;
      }
      nt = Ie;
      const Ke = await fetch(Ie, { signal: ee.signal, ...Pe });
      if (!Ke.ok)
        throw new Error(await Ke.text());
      const Ve = await Ke.json();
      ne("response", { url: Ie, featureCollection: Ve }), Z ? (t(14, k = void 0), t(55, S = Ve.features[0]), We = [S]) : (t(14, k = Ve.features.filter(y)), C && k.unshift({
        type: "Feature",
        properties: {},
    ...
    for (const ee of j)
      if (Z || !ee.matching_text)
        for (const C of [0, 1, 2, 3])
          s[C] = Math[C < 2 ? "min" : "max"](s[C], (($ = ee.bbox) == null ? void 0 : $[C]) ?? ee.center[C % 2]);
    g && j.length > 0 && (S && s[0] === s[2] && s[1] === s[3] ? g.flyTo(S.center, Se) : g.fitBounds(gt(s), 50, ve));
  }
  function Pt(s) {
    t(0, L = W === "always"), t(14, k = void 0), t(55, S = void 0), t(15, U = -1), rt(s[1].toFixed(6) + ", " + Qi(s[0], [-180, 180], !0).toFixed(6), !1);
  }
  function Ht(s) {
    if (!k)
      return;
    let Z = s.key === "ArrowDown" ? 1 : s.key === "ArrowUp" ? -1 : 0;
    Z && (U === (K ? 0 : -1) && Z === -1 && t(15, U = k.length), t(15, U += Z), U >= k.length && t(15, U = -1), U < 0 && K && t(15, U = 0), s.preventDefault());
  }
  function Qe(s = !0) {
    if (t(18, x = void 0), D) {
      ...
      t(14, k = void 0), t(18, x = void 0);
  }
  function qe(s) {
    t(55, S = s), t(1, M = s.place_name), t(15, U = -1);
  }
  const jt = () => Y.focus();
  function Zt(s) {
    xe[s ? "unshift" : "push"](() => {
  ...
  const Qt = () => t(13, _e = !0), qt = () => t(13, _e = !1), Kt = () => Qe(), Vt = () => {
    t(1, M = ""), Y.focus();
  }, Jt = () => t(0, L = !L), Xt = () => t(18, x = void 0), Yt = (s) => t(15, U = s), xt = (s) => qe(s), $t = () => {
    K || t(15, U = -1);
  }, ei = () => {
  };
  return i.$$set = (s) => {
    "class" in s && t(2, n = s.class), "apiKey" in s && t(25, a = s.apiKey), "bbox" in s && t(26, d = s.bbox), "clearButtonTitle" in s && t(3, u = s.clearButtonTitle), "clearOnBlur" in s && t(27, f = s.clearOnBlur), "collapsed" in s && t(4, b = s.collapsed), "country" in s && t(28, h = s.country), "debounceSearch" in s && t(29, p = s.debounceSearch), "enableReverse" in s && t(5, W = s.enableReverse), "errorMessage" in s && t(6, F = s.errorMessage), "filter" in s && t(30, y = s.filter), "flyTo" in s && t(31, w = s.flyTo), "fuzzyMatch" in s && t(32, P = s.fuzzyMatch), "language" in s && t(33, R = s.language), "limit" in s && t(34, E = s.limit), "mapController" in s && t(35, g = s.mapController), "minLength" in s && t(36, I = s.minLength), "noResultsMessage" in s && t(7, v = s.noResultsMessage), "placeholder" in s && t(8, N = s.placeholder), "proximity" in s && t(37, m = s.proximity), "reverseActive" in s && t(0, L = s.reverseActive), "reverseButtonTitle" in s && t(9, X = s.reverseButtonTitle), "searchValue" in s && t(1, M = s.searchValue), "showFullGeometry" in s && t(38, he = s.showFullGeometry), "showPlaceType" in s && t(10, _ = s.showPlaceType), "showResultsWhileTyping" in s && t(39, D = s.showResultsWhileTyping), "selectFirst" in s && t(11, K = s.selectFirst), "flyToSelected" in s && t(40, be = s.flyToSelected), "markerOnSelected" in s && t(41, Te = s.markerOnSelected), "types" in s && t(42, ce = s.types), "excludeTypes" in s && t(43, Me = s.excludeTypes), "zoom" in s && t(44, Se = s.zoom), "maxZoom" in s && t(45, ve = s.maxZoom), "apiUrl" in s && t(46, Fe = s.apiUrl), "fetchParameters" in s && t(47, Pe = s.fetchParameters), "iconsBaseUrl" in s && t(12, it = s.iconsBaseUrl), "adjustUrlQuery" in s && t(48, He = s.adjustUrlQuery), "$$scope" in s && t(58, l = s.$$scope);
  }, i.$$.update = () => {
    ...
    32 && M.length < I && (t(55, S = void 0), t(14, k = void 0), t(18, x = void 0), t(54, j = k)), i.$$.dirty[1] & /*showFullGeometry, picked*/
    16777344 && he && S && !S.address && S.geometry.type === "Point" && S.place_type[0] !== "reverse" && Ge(S.id, { byId: !0 }).catch((s) => t(18, x = s)), i.$$.dirty[1] & /*mapController, picked, prevIdToFly, flyTo, maxZoom, zoom*/
    50356241 && (g && S && S.id !== je && w && (!S.bbox || S.bbox[0] === S.bbox[2] && S.bbox[1] === S.bbox[3] ? g.flyTo(S.center, S.id.startsWith("poi.") || S.id.startsWith("address.") ? ve : Se) : g.fitBounds(gt(S.bbox), 50, ve), t(14, k = void 0), t(54, j = void 0), t(15, U = -1)), t(56, je = S == null ? void 0 : S.id)), i.$$.dirty[0] & /*selectFirst, listFeatures*/
    18432 && K && k != null && k.length && t(15, U = 0), i.$$.dirty[0] & /*selectFirst, searchValue*/
    2050 && (K || t(15, U = -1)), i.$$.dirty[0] & /*listFeatures*/
    16384 | i.$$.dirty[1] & /*markedFeatures*/
    8388608 && j !== k && t(54, j = void 0), i.$$.dirty[0] & /*reverseActive, listFeatures, focusedDelayed*/
    ...
    8388624 && g && g.setEventHandler((s) => {
      switch (s.type) {
        ...
        case "markerClick":
          {
            const Z = k == null ? void 0 : k.find(($) => $.id === s.id);
            Z && qe(Z);
          }
          break;
        case "markerMouseEnter":
          j && t(15, U = Re ? (k == null ? void 0 : k.findIndex((Z) => Z.id === s.id)) ?? -1 : -1);
          break;
    ...
    49152 && t(57, r = k == null ? void 0 : k[U]), i.$$.dirty[1] & /*mapController, selected, flyTo, flyToSelected, maxZoom, zoom*/
    67133969 && g && r && w && be && g.flyTo(r.center, r.id.startsWith("poi.") || r.id.startsWith("address.") ? ve : Se), i.$$.dirty[1] & /*markerOnSelected, mapController*/
    ...
    25165840 && g && g.setMarkers(j, S), i.$$.dirty[0] & /*selectedItemIndex*/
    32768 | i.$$.dirty[1] & /*markedFeatures, mapController*/
    8388624 && j && g && g.setSelectedMarker(U), i.$$.dirty[0] & /*searchValue*/
    ...
    i.$$.dirty[1] & /*selected*/
    67108864 && ne("select", r), i.$$.dirty[1] & /*picked*/
    16777216 && ne("pick", S), i.$$.dirty[0] & /*focusedDelayed, listFeatures*/
    81920 && ne("optionsVisibilityChange", Re && !!k), i.$$.dirty[0] & /*listFeatures*/
    16384 && ne("featuresListed", k), i.$$.dirty[1] & /*markedFeatures*/
    8388608 && ne("featuresMarked", j), i.$$.dirty[0] & /*reverseActive*/
    1 && ne("reverseToggle", L), i.$$.dirty[0] & /*searchValue*/
    2 && ne("queryChange", M), i.$$.dirty[0] & /*reverseActive*/
