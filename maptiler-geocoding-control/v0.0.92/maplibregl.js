...
function eu(r, t, e, n) {
  return r[1] && n ? _l(e.ctx.slice(), r[1](n(t))) : e.ctx;
}
function Cl(r, t, e, n) {
  if (r[2] && n) {
    const i = r[2](n(e));
...
function bl(r, t, { bubbles: e = !1, cancelable: n = !1 } = {}) {
...
const _i = [], Ns = [];
let Ii = [];
const fa = [], Ol = /* @__PURE__ */ Promise.resolve();
let xs = !1;
function Tl() {
  xs || (xs = !0, Ol.then(ru));
}
...
function Fl(r, t, e, n, i, o, s, a, u, l, c, f) {
...
function cr(r, t) {
  const e = r.$$;
  e.fragment !== null && (Ml(e.after_update), Er(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function Bl(r, t) {
  r.$$.dirty[0] === -1 && (_i.push(r), Tl(), r.$$.dirty.fill(0)), r.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function Ur(r, t, e, n, i, o, s, a = [-1]) {
  ...
  if (l.ctx = e ? e(r, t.props || {}, (f, h, ...g) => {
    ...
    t.intro && Gt(r.$$.fragment), lr(r, t.target, t.anchor, t.customElement), ru();
  }
  Ji(u);
}
class qr {
  ...
  function N(L, F) {
    ...
    L[5] ? Wl : (
      ...
      L[0].address ? Yl : (
        ...
        ((R = L[0].properties) == null ? void 0 : R.kind) === "road_relation" ? Xl : (e == null && (e = !!/*feature*/
        L[0].id.startsWith("address.")), e ? ql : (n == null && (n = !!/*feature*/
        L[0].id.startsWith("postal_code.")), n ? Ul : (i == null && (i = !!/*feature*/
        L[0].id.startsWith("poi.")), i ? zl : Vl)))
      )
    );
  }
  let S = N(r, -1), C = S(r), w = h && ha(r);
  return {
    c() {
    ...
    p(L, [F]) {
      ...
      L[5])), h ? w ? w.p(L, F) : (w = ha(L), w.c(), w.m(a, null)) : w && (w.d(1), w = null), F & /*feature*/
      1 && v !== (v = /*feature*/
...
function nc(r) {
  ...
  return {
    ...
    p(l, c) {
      ...
      l[13], Ao(), e = Fl(e, c, u, 1, l, a, n, t, Al, va, null, ga), Fo());
    },
    i(l) {
      if (!i) {
...
function va(r, t) {
  ...
  return n = new Kl({
    ...
    first: null,
    c() {
      e = Sl(), Rr(n.$$.fragment), this.first = e;
    },
    m(a, u) {
  ...
  return ~(v = X(r)) && (y = F[v] = L[v](r)), {
    c() {
      t = ht("form"), e = ht("div"), n = ht("button"), Rr(i.$$.fragment), o = nn(), s = ht("input"), a = nn(), u = ht("div"), l = ht("button"), Rr(c.$$.fragment), f = nn(), C && C.c(), h = nn(), w && w.c(), g = nn(), A && A.c(), p = nn(), y && y.c(), b(n, "class", "search-button svelte-1r7dvt7"), b(n, "type", "button"), b(
        ...
        /*searchValue*/
        r[1] !== ""
      ), b(e, "class", "input-group svelte-1r7dvt7"), b(t, "tabindex", "0"), b(t, "class", _ = ua(
        /*className*/
        r[2]
      ) + " svelte-1r7dvt7"), on(
        t,
    ...
    m(R, Y) {
      Dt(R, t, Y), nt(t, e), nt(e, n), lr(i, n, null), nt(e, o), nt(e, s), r[55](s), la(
        s,
        /*searchValue*/
        r[1]
    ...
    p(R, Y) {
      ...
      262144 && Gt(C, 1) : (C = pa(), C.c(), Gt(C, 1), C.m(u, null)) : C && (Ao(), le(C, 1, 1, () => {
        C = null;
      ...
      32 && Gt(w, 1)) : (w = da(R), w.c(), Gt(w, 1), w.m(e, g)) : w && (Ao(), le(w, 1, 1, () => {
        w = null;
...
function uc(r, t, e) {
  ...
  function or(x, kt = !0) {
    e(1, R = x), kt ? (e(14, Bt = -1), ia()) : (gs(), setTimeout(() => {
      kn.focus(), kn.select();
    }));
  }
  let di = !1, ct, _e, ot, ra = "", kn, Bt = -1, Gn, So = [], Wr, vi, wo, fs;
  const el = /* @__PURE__ */ new Set(), Ir = Rl();
  Pl(() => {
  ...
  async function hs(x, { byId: kt = !1, exact: Vn = !1 } = {}) {
    e(17, Gn = void 0);
    const yi = oa(), ze = new URLSearchParams();
  ...
  function nl() {
    ...
    C && _e.length > 0 && (ot && x[0] === x[2] && x[1] === x[3] ? C.flyTo(ot.center, Ht) : C.fitBounds(ya(x), 50, Jt));
  }
  function rl(x) {
    e(0, F = p === "always"), or(ac(x[0], [-180, 180], !0).toFixed(6) + "," + x[1].toFixed(6));
  }
  function il(x) {
    if (!ct)
      return;
  ...
  const ul = () => e(12, di = !0), ll = () => e(12, di = !1), cl = () => gs(), fl = () => {
    e(1, R = ""), kn.focus();
  }, hl = () => e(0, F = !F), gl = () => e(17, Gn = void 0), pl = (x) => e(14, Bt = x), dl = (x) => ps(x), vl = () => e(14, Bt = -1), yl = () => {
  };
  return r.$$set = (x) => {
    ...
    789521 && (C && ot && ot.id !== fs && _ && (!ot.bbox || ot.bbox[0] === ot.bbox[2] && ot.bbox[1] === ot.bbox[3] ? C.flyTo(ot.center, ot.id.startsWith("poi.") || ot.id.startsWith("address.") ? Jt : Ht) : C.fitBounds(ya(ot.bbox), 50, Jt), e(13, ct = void 0), e(48, _e = void 0), e(14, Bt = -1)), e(50, fs = ot == null ? void 0 : ot.id)), r.$$.dirty[0] & /*listFeatures*/
...
var Vs = (
  ...
  function() {
    function r(t) {
      t === void 0 && (t = fc), this._root = null, this._size = 0, this._comparator = t;
    }
    return r.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = _s(e, n, a, i) : s = _s(e, n, s, i), this._root = hc(s, a, i);
...
var vc = wr * wr, Os = function(t, e) {
  if (-wr < t && t < wr && -wr < e && e < wr)
    return 0;
  var n = t - e;
  return n * n < vc * t * e ? 0 : t < e ? -1 : 1;
  ...
  return Se(r, [{
    ...
    value: function(e) {
      var n = this, i = /* @__PURE__ */ new Map(), o = function(a) {
        var u = a.otherSE;
        i.set(a, {
          sine: mc(n.point, e.point, u.point),
          cosine: _c(n.point, e.point, u.point)
        });
      };
      return function(s, a) {
  ...
  function r(t, e, n, i) {
    mn(this, r), this.id = ++Ic, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = n, this.windings = i;
  }
  return Se(r, [{
    key: "replaceRightSE",
...
}(), La = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, wc = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, Lc = /* @__PURE__ */ function() {
  function r() {
    mn(this, r);
  }
  return Se(r, [{
    ...
    value: function(e, n, i) {
      ...
      for (var v = new Vs(Yn.compare), y = 0, _ = o.length; y < _; y++)
        for (var m = o[y].getSweepEvents(), N = 0, S = m.length; N < S; N++)
          if (v.insert(m[N]), v.size > La)
            throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");
      for (var C = new Sc(v), w = v.size, T = v.pop(); T; ) {
        var A = T.key;
        if (v.size === w) {
          var L = A.segment;
      ...
      no.reset();
      var D = Nc.factory(C.segments), W = new xc(D);
      return W.getGeom();
    }
  }]), r;
}(), xn = new Lc(), bc = function(t) {
...
function Ac(r, t, e) {
  e === void 0 && (e = {});
  var n = zo(r), i = zo(t), o = au.union(n.coordinates, i.coordinates);
...
class kc extends qr {
  constructor(t) {
    super(), Ur(this, t, Bc, Fc, zr, { displayIn: 0 });
  }
}
function fu(r, t, e) {
  if (r !== null)
...
Kt.prototype.fixAfterInsertion = function(r) {
  ...
  for (r.color = Nr; r != null && r !== this.root_ && r.parent.color === Nr; )
    if (st(r) === Es(st(st(r)))) {
      var e = Oa(st(st(r)));
      Ra(e) === Nr ? (Un(st(r), Wn), Un(e, Wn), Un(st(st(r)), Nr), r = st(st(r))) : (r === Oa(st(r)) && (r = st(r), t.rotateLeft(r)), Un(st(r), Wn), Un(st(st(r)), Nr), t.rotateRight(st(st(r))));
    } else {
      var n = Es(st(st(r)));
      Ra(n) === Nr ? (Un(st(r), Wn), Un(n, Wn), Un(st(st(r)), Nr), r = st(st(r))) : (r === Es(st(r)) && (r = st(r), t.rotateRight(r)), Un(st(r), Wn), Un(st(st(r)), Nr), t.rotateLeft(st(st(r))));
    }
  this.root_.color = Wn;
};
...
Te.getStackTrace = function() {
  if (arguments.length === 1) {
    var t = arguments[0], e = new Wc(), n = new qc();
    return t.printStackTrace(n), e.toString();
  } else if (arguments.length === 2) {
    var i = arguments[0], o = arguments[1], s = "";
    new Xc(Te.getStackTrace(i));
...
var Kc = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], os = function(t) {
  this.geometryFactory = t || new H();
};
os.prototype.read = function(t) {
  ...
  return Kc.indexOf(n) !== -1 ? en[n].apply(this, [e.coordinates]) : n === "GeometryCollection" ? en[n].apply(this, [e.geometries]) : en[n].apply(this, [e]);
};
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.buildMinimalRings = function() {
    ...
    do {
      if (o.getMinEdgeRing() === null) {
        var s = new Qc(o, n._geometryFactory);
        i.add(s);
      }
      o = o.getNext();
...
ve.prototype.buildMaximalEdgeRings = function(t) {
  for (var e = this, n = new O(), i = t.iterator(); i.hasNext(); ) {
    ...
    if (o.isInResult() && o.getLabel().isArea() && o.getEdgeRing() === null) {
      var s = new Zc(o, e._geometryFactory);
...
var Ks = function(r) {
  function t(n) {
    n ? r.call(this, n) : r.call(this), this._monoChains = new O(), this._index = new xu(), this._idCounter = 0, this._nodedSegStrings = null, this._nOverlaps = 0;
  }
  r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t;
...
ti.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (V(arguments[2], qe) && arguments[0] instanceof d && arguments[1] instanceof Ms)
...
var Mi = function() {
  ...
  var t = arguments[0];
  this._index = t;
}, Tu = { HotPixelSnapAction: { configurable: !0 } };
...
Tu.HotPixelSnapAction.get = function() {
  return Du;
};
Object.defineProperties(Mi, Tu);
var Du = function(r) {
  function t() {
...
An.prototype.buildLevel = function(t, e) {
  ...
  for (var n = 0; n < t.size(); n += 2) {
    ...
    if (o === null)
      ...
      var s = new nf(t.get(n), t.get(n + 1));
      e.add(s);
    }
  }
};
...
St.prototype.union = function() {
  ...
  for (var t = new xu(St.STRTREE_NODE_CAPACITY), e = this._inputPolys.iterator(); e.hasNext(); ) {
    var n = e.next();
...
var vt = 1e-6, it = Math.PI, Hn = it / 2, Aa = it / 4, er = it * 2, xr = 180 / it, tn = it / 180, ne = Math.abs, rf = Math.atan, Vi = Math.atan2, bt = Math.cos, Pt = Math.sin, Hi = Math.sqrt;
function Vu(r) {
...
ks.invert = ks;
function sf(r, t, e) {
  return (r %= er) ? t || e ? zu(Va(r), za(t, e)) : Va(r) : t || e ? za(t, e) : ks;
}
function Ga(r) {
  return function(t, e) {
...
function af(r, t, e, n, i, o) {
  if (e) {
    ...
    i == null ? (i = t + n * er, o = t - u / 2) : (i = Ua(s, i), o = Ua(s, o), (n > 0 ? i < o : i > o) && (i += n * er));
...
function ff(r, t, e, n) {
  ...
  return function(l) {
    var c = l, f = Uu(), h, g, p, v, y, _, m, N, S, C, w, T = {
      point: A,
      lineStart: R,
      lineEnd: Y,
      polygonStart: F,
    ...
    function X() {
      var W = L(), ut = w && W, dt = (h = Yu(h)).length;
    ...
    function D(W, ut) {
      ...
      if (g && p.push([W, ut]), C)
        ...
        uf(Ht, Jt, r, t, e, n) ? (S || (c.lineStart(), c.point(Ht[0], Ht[1])), c.point(Jt[0], Jt[1]), dt || c.lineEnd(), w = !1) : dt && (c.lineStart(), c.point(W, ut), w = !1);
      }
      m = W, N = ut, S = dt;
    }
    return T;
...
function hf(r, t) {
  ...
  for (var a = 0, u = r.length; a < u; ++a)
    if (c = (l = r[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + Aa, p = Pt(g), v = bt(g), y = 0; y < c; ++y, h = m, p = S, v = C, f = _) {
        var _ = l[y], m = _[0], N = _[1] / 2 + Aa, S = Pt(N), C = bt(N), w = m - h, T = w >= 0 ? 1 : -1, A = T * w, L = A > it, F = p * S;
        if (Cs.add(Vi(F * T * Pt(A), v * C + F * bt(A))), o += L ? w + T * er : w, L ^ h >= e ^ m >= e) {
          var X = Ko(zi(f), zi(_));
          Bs(X);
          var R = Ko(i, X);
          Bs(R);
...
function Wu(r, t, e, n) {
  return function(i, o) {
    var s = t(o), a = i.invert(n[0], n[1]), u = Uu(), l = t(u), c = !1, f, h, g, p = {
      ...
      polygonEnd: function() {
        p.point = v, p.lineStart = _, p.lineEnd = m, h = Yu(h);
        var w = hf(f, a);
        h.length ? (c || (o.polygonStart(), c = !0), qu(h, df, w, e, o)) : w && (c || (o.polygonStart(), c = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), h = f = null;
      },
      sphere: function() {
    ...
    function C() {
      ...
      if (g.pop(), f.push(g), g = null, !!L) {
        ...
        L > 1 && w & 2 && T.push(T.pop().concat(T.shift())), h.push(T.filter(pf));
      }
    }
    return p;
  };
...
function vf(r) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      ne(u - it) < vt ? (r.point(t, e = (e + s) / 2 > 0 ? Hn : -Hn), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), r.point(o, e), i = 0) : n !== a && u >= it && (ne(t - n) < vt && (t -= n * vt), ne(o - a) < vt && (o -= a * vt), e = yf(t, e, o, s), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), i = 0), r.point(t = o, e = s), n = a;
    },
    lineEnd: function() {
      r.lineEnd(), t = e = NaN;
    },
...
function yf(r, t, e, n) {
  var i, o, s = Pt(r - e);
  return ne(s) > vt ? rf((Pt(t) * (o = bt(n)) * Pt(e) - Pt(n) * (i = bt(t)) * Pt(r)) / (i * o * s)) : (t + n) / 2;
}
function mf(r, t, e, n) {
  var i;
  if (r == null)
...
function ju(r, t, e) {
  ...
  r.scale(150).translate([0, 0]), o != null && r.clipExtent(null), of(e, r.stream(Ya));
...
var Ha = 16, If = bt(30 * tn);
function ja(r, t) {
  return +t ? Nf(r, t) : Cf(r);
}
function Cf(r) {
  return Hu({
    point: function(t, e) {
...
function Nf(r, t) {
  function e(n, i, o, s, a, u, l, c, f, h, g, p, v, y) {
    ...
    if (N > 4 * t && v--) {
      ...
      (W * W / N > t || ne((_ * Y + m * D) / N - 0.5) > 0.3 || s * h + a * g + u * p < If) && (e(n, i, o, s, a, u, X, R, L, S /= T, C /= T, w, v, y), y.point(X, R), e(X, R, L, S, C, w, l, c, f, h, g, p, v, y));
    }
  }
  return function(n) {
    ...
    function N(A, L) {
      ...
      e(f, h, c, g, p, v, f = X[0], h = X[1], c = A, g = F[0], p = F[1], v = F[2], Ha, n), n.point(f, h);
    }
    function S() {
      y.point = _, n.lineEnd();
    }
    ...
    function T() {
      e(f, h, c, g, p, v, o, s, i, a, u, l, Ha, n), y.lineEnd = S, S();
    }
    return y;
  };
}
...
function wf(r) {
  var t, e = 150, n = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, g, p = null, v = Wa, y = null, _, m, N, S = Xa, C = 0.5, w = ja(X, C), T, A;
  function L(D) {
  ...
  L.stream = function(D) {
    return T && A === D ? T : T = xf(v(h, w(S(A = D))));
  }, L.clipAngle = function(D) {
    return arguments.length ? (v = +D ? _f(p = D * tn, 6 * tn) : (p = null, Wa), Y()) : p * xr;
  }, L.clipExtent = function(D) {
    return arguments.length ? (S = D == null ? (y = _ = m = N = null, Xa) : ff(y = +D[0][0], _ = +D[0][1], m = +D[1][0], N = +D[1][1]), Y()) : y == null ? null : [[y, _], [m, N]];
  }, L.scale = function(D) {
    ...
    return arguments.length ? (w = ja(X, C = D * D), Y()) : Hi(C);
...
var Lf = Ku(function(r) {
  return Hi(2 / (1 + r));
});
Lf.invert = Qu(function(r) {
  return 2 * ui(r / 2);
});
var Zu = Ku(function(r) {
  return (r = Vu(r)) && r / Pt(r);
});
...
function ko(r, t, e, n) {
  ...
  }, l = new js(), c = l.read(u), f = Dc(Mc(t, e), "meters"), h = zt.bufferOp(c, f, n), g = new Cu();
...
function Of(r, t) {
  var e = zo(r), n = zo(t), i = r.properties || {}, o = au.difference(
    e.coordinates,
    n.coordinates
  );
...
function Tf(r, t, e = !0, n = !0, i = {}, o = {}, s = {
  ...
  function v(_ = !1) {
    ...
    return _ && m.classList.add("marker-interactive"), new kc({
...
class Df extends EventTarget {
  ...
  onAdd(e) {
    ...
    Lo(this, Cn, new lc({ target: n, props: h }));
    for (const g of [
      "select",
      "pick",
      "featuresListed",
...
export {
  Ff as GeocodingControl,
  Tf as createMapLibreGlMapController
};
