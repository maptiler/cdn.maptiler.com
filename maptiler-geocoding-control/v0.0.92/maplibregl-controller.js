...
var Go = (
  ...
  function() {
    ...
    return n.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = yo(e, r, a, i) : s = yo(e, r, s, i), this._root = Ua(s, a, i);
...
}(), fs = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, ru = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, nu = /* @__PURE__ */ function() {
  function n() {
    Qe(this, n);
  }
  return ae(n, [{
    ...
    value: function(e, r, i) {
      ...
      for (var b = new eu(y), P = y.size, D = y.pop(); D; ) {
        var G = D.key;
        if (y.size === P) {
          var A = G.segment;
...
const bn = [], ds = [];
let On = [];
const vs = [], yu = /* @__PURE__ */ Promise.resolve();
let bo = !1;
function mu() {
  bo || (bo = !0, yu.then(Ks));
}
...
function Ks() {
  ...
  do {
    ...
    for (ci(null), bn.length = 0, Pn = 0; ds.length; )
      ds.pop()();
...
function xu(n, t) {
  const e = n.$$;
  e.fragment !== null && (Eu(e.after_update), no(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function Su(n, t) {
  n.$$.dirty[0] === -1 && (bn.push(n), mu(), n.$$.dirty.fill(0)), n.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
...
var zu = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], co = function(t) {
  this.geometryFactory = t || new k();
};
...
ur.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new jo(), this._pointSnapper = new Xn(this._noder.getIndex()), this.snapRound(t, this._li);
};
...
var at = 1e-6, Z = Math.PI, _r = Z / 2, Ns = Z / 4, Lr = Z * 2, Xr = 180 / Z, Ae = Z / 180, Ut = Math.abs, Ku = Math.atan, Qn = Math.atan2, Et = Math.cos, It = Math.sin, ni = Math.sqrt;
function Sa(n) {
  ...
  return function(l) {
    ...
    function w(X, ft) {
      ...
      if (p && g.push([X, ft]), b)
        ...
        $u(pe, Te, n, t, e, r) ? (x || (c.lineStart(), c.point(pe[0], pe[1])), c.point(Te[0], Te[1]), Gt || c.lineEnd(), P = !1) : Gt && (c.lineStart(), c.point(X, ft), P = !1);
      }
      I = X, C = ft, x = Gt;
    }
    return D;
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], p = f[1] / 2 + Ns, g = It(p), y = Et(p), m = 0; m < c; ++m, h = I, g = x, y = b, f = _) {
        ...
        if (Io.add(Qn(et * D * It(G), y * b + et * Et(G))), o += A ? P + D * Lr : P, A ^ h >= e ^ I >= e) {
          var K = $i(Jn(f), Jn(_));
          Ao(K);
          var nt = $i(i, K);
          Ao(nt);
...
an();
an();
var Zn = 1 / 0, to = Zn, Li = -Zn, eo = Li, Ts = {
  point: il,
  lineStart: ai,
  lineEnd: ai,
  polygonStart: ai,
...
function Ta(n, t, e) {
  ...
  n.scale(150).translate([0, 0]), o != null && n.clipExtent(null), Qu(e, n.stream(Ts));
...
function gl(n, t) {
  function e(r, i, o, s, a, u, l, c, f, h, p, g, y, m) {
    ...
    if (C > 4 * t && y--) {
      ...
      (X * X / C > t || Ut((_ * ct + I * w) / C - 0.5) > 0.3 || s * h + a * p + u * g < hl) && (e(r, i, o, s, a, u, K, nt, A, x /= D, b /= D, P, y, m), m.point(K, nt), e(K, nt, A, x, b, P, l, c, f, h, p, g, y, m));
    }
  }
  return function(r) {
...
function yl(n) {
  ...
  A.stream = function(w) {
    return D && G === w ? D : D = dl(y(h, P(x(G = w))));
  }, A.clipAngle = function(w) {
    return arguments.length ? (y = +w ? cl(g = w * Ae, 6 * Ae) : (g = null, Ms), ct()) : g * Xr;
  }, A.clipExtent = function(w) {
    return arguments.length ? (x = w == null ? (m = _ = I = C = null, Ds) : rl(m = +w[0][0], _ = +w[0][1], I = +w[1][0], C = +w[1][1]), ct()) : m == null ? null : [[m, _], [I, C]];
  }, A.scale = function(w) {
    ...
    return arguments.length ? (P = Fs(K, b = w * w), ct()) : ni(b);
...
function Ui(n, t, e, r) {
  ...
  }, l = new Wo(), c = l.read(u), f = lu(cu(t, e), "meters"), h = Pt.bufferOp(c, f, r), p = new aa();
...
export {
  Nl as createMapLibreGlMapController
};
