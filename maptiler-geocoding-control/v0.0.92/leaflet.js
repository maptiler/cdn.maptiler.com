...
var Vn = (r, t, e) => (aa(r, t, "read from private field"), e ? e.call(r) : t.get(r)), ms = (r, t, e) => {
  if (t.has(r))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(r) : t.set(r, e);
}, bo = (r, t, e, n) => (aa(r, t, "write to private field"), n ? n.call(r, e) : t.set(r, e), e);
...
let Po;
function Me(r, t) {
  return Po || (Po = document.createElement("a")), Po.href = t, r === Po.href;
}
function _l(r) {
...
const Ei = [], Ss = [];
let Ci = [];
const ha = [], Rl = /* @__PURE__ */ Promise.resolve();
let xs = !1;
function Ol() {
  xs || (xs = !0, Rl.then(ru));
}
...
function ru() {
  ...
  do {
    ...
    for ($i(null), Ei.length = 0, _i = 0; Ss.length; )
      Ss.pop()();
...
function cr(r, t, e, n) {
  ...
  i && i.m(t, e), n || ws(() => {
    const s = r.$$.on_mount.map($a).filter(tu);
    r.$$.on_destroy ? r.$$.on_destroy.push(...s) : Ir(s), r.$$.on_mount = [];
  }), o.forEach(ws);
}
function fr(r, t) {
  const e = r.$$;
  e.fragment !== null && (Tl(e.after_update), Ir(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function Fl(r, t) {
  r.$$.dirty[0] === -1 && (Ei.push(r), Ol(), r.$$.dirty.fill(0)), r.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function qr(r, t, e, n, i, o, s, a = [-1]) {
  ...
  if (l.ctx = e ? e(r, t.props || {}, (f, h, ...g) => {
    ...
    t.intro && Gt(r.$$.fragment), cr(r, t.target, t.anchor, t.customElement), ru();
  }
  $i(u);
}
class Xr {
  ...
  function C(w, F) {
    ...
    w[5] ? Yl : (
      ...
      w[0].address ? Xl : (
        ...
        ((R = w[0].properties) == null ? void 0 : R.kind) === "road_relation" ? ql : (e == null && (e = !!/*feature*/
        w[0].id.startsWith("address.")), e ? Ul : (n == null && (n = !!/*feature*/
        w[0].id.startsWith("postal_code.")), n ? Vl : (i == null && (i = !!/*feature*/
        w[0].id.startsWith("poi.")), i ? zl : Gl)))
      )
    );
  }
  let L = C(r, -1), N = L(r), x = h && ga(r);
  return {
    c() {
      t = ht("li"), N.c(), o = nn(), s = ht("span"), a = ht("span"), u = ht("span"), c = Rr(l), f = nn(), x && x.c(), g = nn(), p = ht("span"), d = Rr(y), b(u, "class", "primary svelte-ltkwvy"), b(a, "class", "svelte-ltkwvy"), b(p, "class", "line2 svelte-ltkwvy"), b(s, "class", "texts svelte-ltkwvy"), b(t, "tabindex", "0"), b(
        t,
        "data-selected",
        /*selected*/
        r[1]
    ...
    p(w, [F]) {
      ...
      w[5])), h ? x ? x.p(w, F) : (x = ga(w), x.c(), x.m(a, null)) : x && (x.d(1), x = null), F & /*feature*/
      1 && y !== (y = /*feature*/
...
function va(r) {
  ...
  return e = new Jl({}), {
    c() {
      t = ht("button"), Or(e.$$.fragment), b(t, "type", "button"), b(
        t,
        "title",
        /*reverseButtonTitle*/
        r[9]
...
function ec(r) {
  ...
  return {
    ...
    p(l, c) {
      ...
      8940544 && (a = /*listFeatures*/
      l[13], Fo(), e = Al(e, c, u, 1, l, a, n, t, Ml, ya, null, pa), Bo());
    },
    i(l) {
      if (!i) {
...
function ic(r) {
  ...
  return e = new ou({}), u = new iu({}), {
    c() {
      t = ht("div"), Or(e.$$.fragment), n = nn(), i = ht("div"), o = Rr(
        /*errorMessage*/
        r[6]
      ), s = nn(), a = ht("button"), Or(u.$$.fragment), b(i, "class", "svelte-1r7dvt7"), b(a, "class", "svelte-1r7dvt7"), b(t, "class", "error svelte-1r7dvt7");
    },
    m(h, g) {
...
function ya(r, t) {
  ...
  return n = new jl({
    ...
    first: null,
    c() {
      e = Sl(), Or(n.$$.fragment), this.first = e;
    },
    m(a, u) {
...
function oc(r) {
  ...
  return ~(y = X(r)) && (d = F[y] = w[y](r)), {
    c() {
      t = ht("form"), e = ht("div"), n = ht("button"), Or(i.$$.fragment), o = nn(), s = ht("input"), a = nn(), u = ht("div"), l = ht("button"), Or(c.$$.fragment), f = nn(), N && N.c(), h = nn(), x && x.c(), g = nn(), A && A.c(), p = nn(), d && d.c(), b(n, "class", "search-button svelte-1r7dvt7"), b(n, "type", "button"), b(
        s,
        "placeholder",
        /*placeholder*/
        r[8]
        ...
        /*searchValue*/
        r[1] !== ""
      ), b(e, "class", "input-group svelte-1r7dvt7"), b(t, "tabindex", "0"), b(t, "class", m = la(
        /*className*/
        r[2]
      ) + " svelte-1r7dvt7"), on(
        t,
    ...
    m(R, Y) {
      Tt(R, t, Y), nt(t, e), nt(e, n), cr(i, n, null), nt(e, o), nt(e, s), r[55](s), ca(
        s,
        /*searchValue*/
        r[1]
    ...
    p(R, Y) {
      ...
      262144 && Gt(N, 1) : (N = da(), N.c(), Gt(N, 1), N.m(u, null)) : N && (Fo(), le(N, 1, 1, () => {
        N = null;
      ...
      32 && Gt(x, 1)) : (x = va(R), x.c(), Gt(x, 1), x.m(e, g)) : x && (Fo(), le(x, 1, 1, () => {
        x = null;
      ...
      4 && m !== (m = la(
        /*className*/
        R[2]
      ) + " svelte-1r7dvt7")) && b(t, "class", m), (!_ || Y[0] & /*className, collapsed, searchValue*/
      22) && on(
        t,
        "can-collapse",
        /*collapsed*/
...
function ac(r, t, e) {
  ...
  function or(S, kt = !0) {
    e(1, R = S), kt ? (e(14, Bt = -1), oa()) : (ps(), setTimeout(() => {
      kn.focus(), kn.select();
    }));
  }
  let vi = !1, ct, _e, ot, ia = "", kn, Bt = -1, Gn, wo = [], Hr, yi, Lo, hs;
  const el = /* @__PURE__ */ new Set(), Cr = Pl();
  bl(() => {
  ...
  function oa(S) {
    if (yi && (clearTimeout(yi), yi = void 0), Bt > -1 && ct)
      ...
      const kt = S || !sa();
      gs(R, { exact: !0 }).then(() => {
        e(48, _e = ct), e(49, ot = void 0), kt && nl();
      }).catch((zn) => e(17, Gn = zn));
    }
  }
  function sa() {
  ...
  async function gs(S, { byId: kt = !1, exact: zn = !1 } = {}) {
    e(17, Gn = void 0);
    const mi = sa(), Ve = new URLSearchParams();
  ...
  function nl() {
    ...
    N && _e.length > 0 && (ot && S[0] === S[2] && S[1] === S[3] ? N.flyTo(ot.center, Ht) : N.fitBounds(ma(S), 50, Jt));
  }
  function rl(S) {
    e(0, F = p === "always"), or(sc(S[0], [-180, 180], !0).toFixed(6) + "," + S[1].toFixed(6));
  }
  function il(S) {
    if (!ct)
      return;
  ...
  const ul = () => e(12, vi = !0), ll = () => e(12, vi = !1), cl = () => ps(), fl = () => {
    e(1, R = ""), kn.focus();
  }, hl = () => e(0, F = !F), gl = () => e(17, Gn = void 0), pl = (S) => e(14, Bt = S), dl = (S) => ds(S), vl = () => e(14, Bt = -1), yl = () => {
  };
  return r.$$set = (S) => {
    ...
    789521 && (N && ot && ot.id !== hs && m && (!ot.bbox || ot.bbox[0] === ot.bbox[2] && ot.bbox[1] === ot.bbox[3] ? N.flyTo(ot.center, ot.id.startsWith("poi.") || ot.id.startsWith("address.") ? Jt : Ht) : N.fitBounds(ma(ot.bbox), 50, Jt), e(13, ct = void 0), e(48, _e = void 0), e(14, Bt = -1)), e(50, hs = ot == null ? void 0 : ot.id)), r.$$.dirty[0] & /*listFeatures*/
...
var Vs = (
  ...
  function() {
    ...
    return r.prototype.insert = function(t, e) {
      ...
      var i = this._comparator, o = _a(t, this._root, i), s = o.left, a = o.right;
      i(t, e) < 0 ? a = Es(e, n, a, i) : s = Es(e, n, s, i), this._root = fc(s, a, i);
    }, r.prototype.split = function(t) {
      return _a(t, this._root, this._comparator);
...
function xe(r, t, e) {
  return t && Ea(r.prototype, t), e && Ea(r, e), r;
}
var Ki = function(t, e) {
...
var dc = Lr * Lr, Ds = function(t, e) {
  ...
  return xe(r, [{
    key: "reset",
    value: function() {
      this.xRounder = new Ia(), this.yRounder = new Ia();
    }
  }, {
    key: "round",
    value: function(e, n) {
  ...
  function r() {
    mn(this, r), this.tree = new Vs(), this.round(0);
  }
  return xe(r, [{
    key: "round",
    value: function(e) {
  ...
  function r(t, e) {
    if (mn(this, r), !Array.isArray(t))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new xa(t[0], this, !0), this.bbox = {
      ll: {
  ...
  return xe(r, [{
    ...
    value: function() {
      for (var e = this.events[0].point, n = [e], i = 1, o = this.events.length - 1; i < o; i++) {
        ...
        Ca(s, e, a) !== 0 && (n.push(s), e = s);
      }
      if (n.length === 1)
        return null;
      var u = n[0], l = n[1];
      Ca(u, e, l) === 0 && n.shift(), n.push(n[0]);
      ...
      for (var n = [], i = 0, o = e.length; i < o; i++) {
        ...
        if (!s.poly)
          if (s.isExteriorRing())
            ...
            a.poly || n.push(new La(a)), a.poly.addInterior(s);
          }
      }
      return n;
    }
  ...
  function r(t) {
    ...
    mn(this, r), this.queue = t, this.tree = new Vs(e), this.segments = [];
  }
  return xe(r, [{
    key: "process",
    value: function(e) {
...
}(), ba = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, xc = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, wc = /* @__PURE__ */ function() {
  function r() {
    mn(this, r);
  }
  return xe(r, [{
    ...
    value: function(e, n, i) {
      Sn.type = e, ro.reset();
      for (var o = [new wa(n, !0)], s = 0, a = i.length; s < a; s++)
        o.push(new wa(i[s], !1));
      ...
      for (var y = new Vs(Yn.compare), d = 0, m = o.length; d < m; d++)
        for (var _ = o[d].getSweepEvents(), C = 0, L = _.length; C < L; C++)
          if (y.insert(_[C]), y.size > ba)
            throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");
      for (var N = new Sc(y), x = y.size, D = y.pop(); D; ) {
        var A = D.key;
        if (y.size === x) {
          var w = A.segment;
      ...
      ro.reset();
      var T = Cc.factory(N.segments), W = new Nc(T);
      return W.getGeom();
    }
  }]), r;
}(), Sn = new wc(), Lc = function(t) {
...
function Mc(r, t, e) {
  e === void 0 && (e = {});
  var n = Uo(r), i = Uo(t), o = au.union(n.coordinates, i.coordinates);
  return o.length === 0 ? null : o.length === 1 ? lu(o[0], e.properties) : cu(o, e.properties);
}
function Ac(r) {
  let t, e, n;
  return {
...
class Bc extends Xr {
  constructor(t) {
    super(), qr(this, t, Fc, Ac, Ur, { displayIn: 0 });
  }
}
function fu(r, t, e) {
  if (r !== null)
...
gu.MAX_VALUE.get = function() {
  return Number.MAX_VALUE;
};
Object.defineProperties(V, gu);
var ke = function() {
}, ts = function() {
}, Ni = function() {
};
...
var ce = function() {
}, du = { DP_SAFE_EPSILON: { configurable: !0 } };
...
Kt.prototype.fixAfterInsertion = function(r) {
  ...
  for (r.color = Sr; r != null && r !== this.root_ && r.parent.color === Sr; )
    if (st(r) === Is(st(st(r)))) {
      var e = Da(st(st(r)));
      Oa(e) === Sr ? (Un(st(r), Wn), Un(e, Wn), Un(st(st(r)), Sr), r = st(st(r))) : (r === Da(st(r)) && (r = st(r), t.rotateLeft(r)), Un(st(r), Wn), Un(st(st(r)), Sr), t.rotateRight(st(st(r))));
    } else {
      var n = Is(st(st(r)));
      Oa(n) === Sr ? (Un(st(r), Wn), Un(n, Wn), Un(st(st(r)), Sr), r = st(st(r))) : (r === Is(st(r)) && (r = st(r), t.rotateRight(r)), Un(st(r), Wn), Un(st(st(r)), Sr), t.rotateLeft(st(st(r))));
    }
  this.root_.color = Wn;
};
...
Object.defineProperties(H, Iu);
var jc = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], ss = function(t) {
  this.geometryFactory = t || new H();
};
...
var Qs = function(r) {
  function t(n) {
    n ? r.call(this, n) : r.call(this), this._monoChains = new O(), this._index = new Su(), this._idCounter = 0, this._nodedSegStrings = null, this._nOverlaps = 0;
  }
  r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t;
  ...
  return t.prototype.getMonotoneChains = function() {
    ...
    for (var i = this, o = new Ma(this._segInt), s = this._monoChains.iterator(); s.hasNext(); )
...
}, wu = { COORDINATE_ARRAY_TYPE: { configurable: !0 } };
...
wu.COORDINATE_ARRAY_TYPE.get = function() {
  return new Array(0).fill(null);
};
Object.defineProperties(be, wu);
var K = function() {
...
lt.prototype.addLimitedMitreJoin = function(t, e, n, i) {
  ...
  this._side === P.LEFT ? (this._segList.addPt(_), this._segList.addPt(C)) : (this._segList.addPt(C), this._segList.addPt(_));
};
...
var ei = function() {
  ...
  var t = arguments[0];
  this._subgraphs = t;
}, Lu = { DepthSegment: { configurable: !0 } };
ei.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (z(arguments[2], qe) && arguments[0] instanceof v && arguments[1] instanceof As)
...
Lu.DepthSegment.get = function() {
  return Ar;
};
Object.defineProperties(ei, Lu);
var Ar = function() {
...
Pu.NULL_VALUE.get = function() {
  return -1;
};
Object.defineProperties(Ut, Pu);
var Yo = function(r) {
  function t() {
...
re.prototype.buffer = function(t, e) {
  ...
  this.computeNodedEdges(s, n), this._graph = new pt(new bu()), this._graph.addEdges(this._edgeList.getEdges());
...
Ru.fact.get = function() {
  return new H();
};
Object.defineProperties(dn, Ru);
var he = function() {
...
}, Ou = { SAFE_ENV_EXPANSION_FACTOR: { configurable: !0 } };
...
Ou.SAFE_ENV_EXPANSION_FACTOR.get = function() {
  return 0.75;
};
Object.defineProperties(he, Ou);
var po = function() {
...
var Ai = function() {
  ...
  var t = arguments[0];
  this._index = t;
}, Du = { HotPixelSnapAction: { configurable: !0 } };
Ai.prototype.snap = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return this.snap(t, null, -1);
  } else if (arguments.length === 3) {
    var e = arguments[0], n = arguments[1], i = arguments[2], o = e.getSafeEnvelope(), s = new Tu(e, n, i);
...
Du.HotPixelSnapAction.get = function() {
  return Tu;
};
Object.defineProperties(Ai, Du);
var Tu = function(r) {
  function t() {
...
Dn.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new Qs(), this._pointSnapper = new Ai(this._noder.getIndex()), this.snapRound(t, this._li);
};
...
Mu.INSIDE_AREA.get = function() {
  return -1;
};
Object.defineProperties(ee, Mu);
var ur = function(t) {
  this._pts = t || null;
};
...
}, Au = { SNAP_PRECISION_FACTOR: { configurable: !0 } };
Et.prototype.snapTo = function(t, e) {
  var n = this.extractTargetCoordinates(t), i = new Fu(e, n);
  return i.transform(this._srcGeom);
};
Et.prototype.snapToSelf = function(t, e) {
  var n = this.extractTargetCoordinates(this._srcGeom), i = new Fu(t, n, !0), o = i.transform(this._srcGeom), s = o;
...
Au.SNAP_PRECISION_FACTOR.get = function() {
  return 1e-9;
};
Object.defineProperties(Et, Au);
var Fu = function(r) {
  function t(e, n, i) {
...
var Qi = function(r) {
  function t() {
    if (r.call(this), this._parentGeom = null, this._lineEdgeMap = new Eu(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new Ke(), arguments.length === 2) {
...
var U = function(r) {
  function t() {
    var e = arguments[0], n = arguments[1];
    r.call(this, e, n), this._ptLocator = new Ke(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new je(), this._resultPolyList = new O(), this._resultLineList = new O(), this._resultPointList = new O(), this._graph = new pt(new bu()), this._geomFact = e.getFactory();
  }
...
}, Gu = { STRTREE_NODE_CAPACITY: { configurable: !0 } };
...
xt.prototype.union = function() {
  ...
  for (var t = new Su(xt.STRTREE_NODE_CAPACITY), e = this._inputPolys.iterator(); e.hasNext(); ) {
    var n = e.next();
...
Gu.STRTREE_NODE_CAPACITY.get = function() {
  return 4;
};
Object.defineProperties(xt, Gu);
var Ho = function() {
};
Ho.prototype.interfaces_ = function() {
  return [];
...
jo.prototype = {
  ...
  add: function(r) {
    Aa(Ro, r, this.t), Aa(this, Ro.s, this.s), this.s ? this.t += Ro.t : this.s = Ro.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var vt = 1e-6, it = Math.PI, Hn = it / 2, Fa = it / 4, er = it * 2, xr = 180 / it, tn = it / 180, ne = Math.abs, nf = Math.atan, Vi = Math.atan2, bt = Math.cos, Pt = Math.sin, ji = Math.sqrt;
function zu(r) {
...
function rf(r, t) {
  r && Ba.hasOwnProperty(r.type) ? Ba[r.type](r, t) : Ko(r, t);
}
Wr();
Wr();
function Bs(r) {
...
Gs.invert = Gs;
function of(r, t, e) {
  return (r %= er) ? t || e ? Vu(Va(r), Ua(t, e)) : Va(r) : t || e ? Ua(t, e) : Gs;
}
function za(r) {
  return function(t, e) {
...
function sf(r, t, e, n, i, o) {
  if (e) {
    ...
    i == null ? (i = t + n * er, o = t - u / 2) : (i = qa(s, i), o = qa(s, o), (n > 0 ? i < o : i > o) && (i += n * er));
...
function qu(r, t, e, n, i) {
  ...
  if (r.forEach(function(p) {
    ...
    for (s.sort(t), Xa(o), Xa(s), a = 0, u = s.length; a < u; ++a)
      s[a].e = e = !e;
    for (var l = o[0], c, f; ; ) {
      for (var h = l, g = !0; h.v; )
        if ((h = h.n) === l)
...
function cf(r, t, e, n) {
  ...
  return function(l) {
    var c = l, f = Uu(), h, g, p, y, d, m, _, C, L, N, x, D = {
      point: A,
      lineStart: R,
      lineEnd: Y,
      polygonStart: F,
    ...
    function X() {
      var W = w(), ut = x && W, dt = (h = Yu(h)).length;
      (ut || dt) && (l.polygonStart(), ut && (l.lineStart(), o(null, null, 1, l), l.lineEnd()), dt && qu(h, a, W, o, l), l.polygonEnd()), c = l, h = g = p = null;
    }
    function R() {
    ...
    function T(W, ut) {
      ...
      if (g && p.push([W, ut]), N)
        ...
        af(Ht, Jt, r, t, e, n) ? (L || (c.lineStart(), c.point(Ht[0], Ht[1])), c.point(Jt[0], Jt[1]), dt || c.lineEnd(), x = !1) : dt && (c.lineStart(), c.point(W, ut), x = !1);
      }
      _ = W, C = ut, L = dt;
    }
    return D;
...
function ff(r, t) {
  ...
  for (var a = 0, u = r.length; a < u; ++a)
    if (c = (l = r[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + Fa, p = Pt(g), y = bt(g), d = 0; d < c; ++d, h = _, p = L, y = N, f = m) {
        var m = l[d], _ = m[0], C = m[1] / 2 + Fa, L = Pt(C), N = bt(C), x = _ - h, D = x >= 0 ? 1 : -1, A = D * x, w = A > it, F = p * L;
        if (Ns.add(Vi(F * D * Pt(A), y * N + F * bt(A))), o += w ? x + D * er : x, w ^ h >= e ^ _ >= e) {
          var X = Qo(Ui(f), Ui(m));
          ks(X);
          var R = Qo(i, X);
          ks(R);
...
Wr();
Wr();
var qi = 1 / 0, Zo = qi, mo = -qi, Jo = mo, Wa = {
  point: hf,
  lineStart: Zi,
  lineEnd: Zi,
  polygonStart: Zi,
...
function Wu(r, t, e, n) {
  return function(i, o) {
    var s = t(o), a = i.invert(n[0], n[1]), u = Uu(), l = t(u), c = !1, f, h, g, p = {
      point: y,
      lineStart: m,
      lineEnd: _,
      ...
      polygonEnd: function() {
        p.point = y, p.lineStart = m, p.lineEnd = _, h = Yu(h);
        var x = ff(f, a);
        h.length ? (c || (o.polygonStart(), c = !0), qu(h, pf, x, e, o)) : x && (c || (o.polygonStart(), c = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), h = f = null;
      },
      sphere: function() {
    ...
    function N() {
      ...
      if (g.pop(), f.push(g), g = null, !!w) {
        ...
        w > 1 && x & 2 && D.push(D.pop().concat(D.shift())), h.push(D.filter(gf));
      }
    }
    return p;
  };
...
function df(r) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      ne(u - it) < vt ? (r.point(t, e = (e + s) / 2 > 0 ? Hn : -Hn), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), r.point(o, e), i = 0) : n !== a && u >= it && (ne(t - n) < vt && (t -= n * vt), ne(o - a) < vt && (o -= a * vt), e = vf(t, e, o, s), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), i = 0), r.point(t = o, e = s), n = a;
    },
    lineEnd: function() {
      r.lineEnd(), t = e = NaN;
    },
...
function ju(r, t, e) {
  ...
  r.scale(150).translate([0, 0]), o != null && r.clipExtent(null), rf(e, r.stream(Wa));
  var s = Wa.result(), a = Math.min(n / (s[1][0] - s[0][0]), i / (s[1][1] - s[0][1])), u = +t[0][0] + (n - a * (s[1][0] + s[0][0])) / 2, l = +t[0][1] + (i - a * (s[1][1] + s[0][1])) / 2;
  return o != null && r.clipExtent(o), r.scale(a * 150).translate([u, l]);
}
function _f(r, t, e) {
  return ju(r, [[0, 0], t], e);
}
var ja = 16, Ef = bt(30 * tn);
function Ka(r, t) {
...
function Cf(r, t) {
  function e(n, i, o, s, a, u, l, c, f, h, g, p, y, d) {
    ...
    if (C > 4 * t && y--) {
      ...
      (W * W / C > t || ne((m * Y + _ * T) / C - 0.5) > 0.3 || s * h + a * g + u * p < Ef) && (e(n, i, o, s, a, u, X, R, w, L /= D, N /= D, x, y, d), d.point(X, R), e(X, R, w, L, N, x, l, c, f, h, g, p, y, d));
    }
  }
  return function(n) {
    ...
    function C(A, w) {
      ...
      e(f, h, c, g, p, y, f = X[0], h = X[1], c = A, g = F[0], p = F[1], y = F[2], ja, n), n.point(f, h);
    }
    function L() {
      d.point = m, n.lineEnd();
    }
    ...
    function D() {
      e(f, h, c, g, p, y, o, s, i, a, u, l, ja, n), d.lineEnd = L, L();
    }
    return d;
  };
}
...
function xf(r) {
  var t, e = 150, n = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, g, p = null, y = Ha, d = null, m, _, C, L = Ya, N = 0.5, x = Ka(X, N), D, A;
  function w(T) {
  ...
  w.stream = function(T) {
    return D && A === T ? D : D = Nf(y(h, x(L(A = T))));
  }, w.clipAngle = function(T) {
    return arguments.length ? (y = +T ? mf(p = T * tn, 6 * tn) : (p = null, Ha), Y()) : p * xr;
  }, w.clipExtent = function(T) {
    return arguments.length ? (L = T == null ? (d = m = _ = C = null, Ya) : cf(d = +T[0][0], m = +T[0][1], _ = +T[1][0], C = +T[1][1]), Y()) : d == null ? null : [[d, m], [_, C]];
  }, w.scale = function(T) {
    ...
    return arguments.length ? (x = Ka(X, N = T * T), Y()) : ji(N);
...
var wf = Ku(function(r) {
  return ji(2 / (1 + r));
});
wf.invert = Qu(function(r) {
  return 2 * li(r / 2);
});
var Zu = Ku(function(r) {
  return (r = zu(r)) && r / Pt(r);
});
Zu.invert = Qu(function(r) {
  return r;
});
function Lf() {
  return Sf(Zu).scale(79.4188).clipAngle(180 - 1e-3);
}
function Qa(r, t) {
  return [r, t];
}
...
function bf(r, t, e) {
  ...
  switch (r.type) {
    case "GeometryCollection":
      return hu(r, function(s) {
        var a = Go(s, t, n, i);
        a && o.push(a);
      }), Ts(o);
    case "FeatureCollection":
      return Ra(r, function(s) {
        var a = Go(s, t, n, i);
        a && Ra(a, function(u) {
          u && o.push(u);
        });
...
function Go(r, t, e, n) {
  ...
  var a = Pf(o), u = {
    type: o.type,
    coordinates: $u(o.coordinates, a)
  }, l = new Ks(), c = l.read(u), f = Dc(Tc(t, e), "meters"), h = Vt.bufferOp(c, f, n), g = new Cu();
  if (h = g.write(h), !Ju(h.coordinates)) {
    var p = {
      type: h.type,
      coordinates: tl(h.coordinates, a)
    };
    return $o(p, i);
  }
}
function Ju(r) {
  return Array.isArray(r[0]) ? Ju(r[0]) : isNaN(r[0]);
}
function $u(r, t) {
...
function Rf(r, t) {
  var e = Uo(r), n = Uo(t), i = r.properties || {}, o = au.difference(
    e.coordinates,
    n.coordinates
  );
  return o.length === 0 ? null : o.length === 1 ? lu(o[0], i) : cu(o, i);
}
function Za(r) {
  let t;
  for (const e of r)
...
function Of(r, t = !0, e = !0, n = {}, i = {}, o = (s) => {
  ...
  function p(d, m = !1) {
    ...
    return new Bc({ props: { displayIn: "leaflet" }, target: _ }), new sr.Marker(d, {
      interactive: m,
      icon: new sr.DivIcon({
        html: _,
        className: "",
...
class Df extends sr.Control {
  ...
  onAdd(e) {
    ...
    const {
      ...
      fullGeometryStyle: a,
      ...u
    } = Vn(this, Qr), l = typeof s == "boolean" ? {} : s, c = Of(
      e,
      i,
      o,
      l,
...
window.L && typeof window.L == "object" && typeof window.L.control == "function" && (window.L.control.maptilerGeocoding = Tf);
export {
