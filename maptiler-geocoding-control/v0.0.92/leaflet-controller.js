...
var Vo = (
  ...
  function() {
    function n(t) {
      t === void 0 && (t = za), this._root = null, this._size = 0, this._comparator = t;
    }
    return n.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = mo(e, r, a, i) : s = mo(e, r, s, i), this._root = Ua(s, a, i);
...
var Ha = Hr * Hr, Po = function(t, e) {
  if (-Hr < t && t < Hr && -Hr < e && e < Hr)
    return 0;
  var r = t - e;
  return r * r < Ha * t * e ? 0 : t < e ? -1 : 1;
    ...
    value: function(e) {
      var r = this, i = /* @__PURE__ */ new Map(), o = function(a) {
        ...
        i.set(a, {
          ...
          cosine: Ka(r.point, e.point, u.point)
        });
      };
      return function(s, a) {
  ...
  function n(t, e, r, i) {
    Qe(this, n), this.id = ++Ja, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = r, this.windings = i;
  }
  return ae(n, [{
    key: "replaceRightSE",
    ...
    value: function(e) {
      ...
      if (h)
        return l;
      var g = Qa(s, this.vector(), u, e.vector());
...
}(), hs = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, ru = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, nu = /* @__PURE__ */ function() {
  function n() {
    Qe(this, n);
  }
  return ae(n, [{
    ...
    value: function(e, r, i) {
      ...
      for (var b = new eu(E), P = E.size, D = E.pop(); D; ) {
        var G = D.key;
        if (E.size === P) {
          var A = G.segment;
      ...
      hi.reset();
      var w = $a.factory(b.segments), X = new tu(w);
      return X.getGeom();
    }
  }]), n;
}(), tr = new nu(), iu = function(t) {
...
const Rn = [], vs = [];
let Dn = [];
const ys = [], yu = /* @__PURE__ */ Promise.resolve();
let Ro = !1;
function mu() {
  Ro || (Ro = !0, yu.then(Ks));
}
...
function Ks() {
  ...
  do {
    ...
    for (fi(null), Rn.length = 0, bn = 0; vs.length; )
      vs.pop()();
...
function xu(n, t) {
  const e = n.$$;
  e.fragment !== null && (Eu(e.after_update), io(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function Su(n, t) {
  n.$$.dirty[0] === -1 && (Rn.push(n), mu(), n.$$.dirty.fill(0)), n.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function Lu(n, t, e, r, i, o, s, a = [-1]) {
  const u = ko;
  fi(n);
  const l = n.$$ = {
    fragment: null,
  ...
  if (l.ctx = e ? e(n, t.props || {}, (f, h, ...p) => {
    ...
    return l.ctx && i(l.ctx[f], l.ctx[f] = g) && (!l.skip_bound && l.bound[f] && l.bound[f](g), c && Su(n, f)), h;
    ...
    t.intro && Cu(n.$$.fragment), Nu(n, t.target, t.anchor, t.customElement), Ks();
  }
  fi(u);
}
class wu {
  $destroy() {
    xu(this, 1), this.$destroy = pi;
  }
  $on(t, e) {
    if (!Ws(e))
      return pi;
  ...
  $set(t) {
    this.$$set && !pu(t) && (this.$$.skip_bound = !0, this.$$set(t), this.$$.skip_bound = !1);
  }
}
function Pu(n) {
  let t, e, r;
...
class Ru extends wu {
  constructor(t) {
    super(), Lu(this, t, bu, Pu, hu, { displayIn: 0 });
  }
}
function Qs(n, t, e) {
  if (n !== null)
...
var k = function n() {
  this._precisionModel = new W(), this._SRID = 0, this._coordinateSequenceFactory = n.getDefaultCoordinateSequenceFactory(), arguments.length === 0 || (arguments.length === 1 ? M(arguments[0], Mn) ? this._coordinateSequenceFactory = arguments[0] : arguments[0] instanceof W && (this._precisionModel = arguments[0]) : arguments.length === 2 ? (this._precisionModel = arguments[0], this._SRID = arguments[1]) : arguments.length === 3 && (this._precisionModel = arguments[0], this._SRID = arguments[1], this._coordinateSequenceFactory = arguments[2]));
...
var la = function(n) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[0] instanceof t && M(arguments[1], qn)) {
...
ur.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new Ko(), this._pointSnapper = new Yn(this._noder.getIndex()), this.snapRound(t, this._li);
};
...
var ai = function(n) {
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(r, i) {
    ...
    return M(this._parentGeom, Mr) && this._parentGeom.getNumGeometries() > 50 ? (this._areaPtLocator === null && (this._areaPtLocator = new Wn(this._parentGeom)), this._areaPtLocator.locate(r)) : this._ptLocator.locate(r, this._parentGeom);
...
var at = 1e-6, Z = Math.PI, _r = Z / 2, xs = Z / 4, Lr = Z * 2, Xr = 180 / Z, Ae = Z / 180, Ut = Math.abs, Ku = Math.atan, Jn = Math.atan2, Et = Math.cos, It = Math.sin, ii = Math.sqrt;
function Sa(n) {
  ...
  return function(l) {
    ...
    function A() {
      for (var X = 0, ft = 0, Gt = p.length; ft < Gt; ++ft)
        for (var pe = p[ft], Te = 1, oi = pe.length, br = pe[0], un, Rr, Ai = br[0], wn = br[1]; Te < oi; ++Te)
          un = Ai, Rr = wn, br = pe[Te], Ai = br[0], wn = br[1], Rr <= r ? wn > r && (Ai - un) * (r - Rr) > (wn - Rr) * (n - un) && ++X : wn <= r && (Ai - un) * (r - Rr) < (wn - Rr) * (n - un) && --X;
      return X;
    }
    function et() {
      c = f, h = [], p = [], P = !0;
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], p = f[1] / 2 + xs, g = It(p), E = Et(p), v = 0; v < c; ++v, h = I, g = S, E = b, f = m) {
        ...
        if (Co.add(Jn(et * D * It(G), E * b + et * Et(G))), o += A ? P + D * Lr : P, A ^ h >= e ^ I >= e) {
          var K = to(Zn(f), Zn(m));
          Fo(K);
          var nt = to(i, K);
          Fo(nt);
...
function cl(n, t) {
  ...
  function u(c, f, h) {
    ...
    if (!(nt < 0)) {
      var ct = ii(nt), w = Vi(A, (-et - ct) / K);
      if (Io(w, D), w = Ao(w), !h)
        return w;
      var X = c[0], ft = f[0], Gt = c[1], pe = f[1], Te;
      ft < X && (Te = X, X = ft, ft = Te);
      var oi = ft - X, br = Ut(oi - Z) < at, un = br || oi < at;
      if (!br && pe < Gt && (Te = Gt, Gt = pe, pe = Te), un ? br ? Gt + pe > 0 ^ w[1] < (Ut(w[0] - X) < at ? Gt : pe) : Gt <= w[1] && w[1] <= pe : oi > Z ^ (X <= w[0] && w[0] <= ft)) {
        var Rr = Vi(A, (-et + ct) / K);
...
function gl(n, t) {
  function e(r, i, o, s, a, u, l, c, f, h, p, g, E, v) {
    ...
    if (C > 4 * t && E--) {
      var S = s + h, b = a + p, P = u + g, D = ii(S * S + b * b + P * P), G = In(P /= D), A = Ut(Ut(P) - 1) < at || Ut(o - f) < at ? (o + f) / 2 : Jn(b, S), et = n(A, G), K = et[0], nt = et[1], ct = K - r, w = nt - i, X = I * ct - m * w;
...
function yl(n) {
  ...
  A.stream = function(w) {
    ...
    return arguments.length ? (P = Bs(K, b = w * w), ct()) : ii(b);
...
function qi(n, t, e, r) {
  ...
  }, l = new jo(), c = l.read(u), f = lu(cu(t, e), "meters"), h = Pt.bufferOp(c, f, r), p = new aa();
...
function Nl(n, t = !0, e = !0, r = {}, i = {}, o = (s) => {
  ...
  function g(v, m = !1) {
    ...
    return new Ru({ props: { displayIn: "leaflet" }, target: I }), new Pn.Marker(v, {
      interactive: m,
      icon: new Pn.DivIcon({
        html: I,
        className: "",
  ...
  return {
    ...
    fitBounds(v, m, I) {
      n.flyToBounds(
        ...
        { padding: [m, m], duration: 2, maxZoom: I, ...i }
      );
    },
    indicateReverse(v) {
...
export {
  Nl as createLeafletMapController
};
