...
function us(i, e, t) {
  ...
  const be = void 0;
  let { reverseGeocodingExcludeTypes: Oe = be } = e, { zoom: ge = g } = e, { apiUrl: ce = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: J = {} } = e, { iconsBaseUrl: yi = "https://cdn.maptiler.com/maptiler-geocoding-control/v2.1.3/icons/" } = e, { adjustUrlQuery: Vt = () => {
  } } = e, { adjustUrl: Ht = () => {
  } } = e;
  function _n(L) {
    Ne.focus(L);
