...
var Et = (a, r, i) => (Do(a, r, "read from private field"), i ? i.call(a) : r.get(a)), Is = (a, r, i) => r.has(a) ? Ao("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(a) : r.set(a, i), ii = (a, r, i, u) => (Do(a, r, "write to private field"), u ? u.call(a, i) : r.set(a, i), i);
import * as Fh from "maplibre-gl";
function Te() {
}
function Bh(a, r) {
...
const Jn = [], Zs = [];
let tr = [];
const zo = [], Qh = /* @__PURE__ */ Promise.resolve();
let Qs = !1;
function Kh() {
  Qs || (Qs = !0, Qh.then(sc));
}
...
function Jh(a) {
  if (a.fragment !== null) {
    ...
    const r = a.dirty;
    a.dirty = [-1], a.fragment && a.fragment.p(a.ctx, r), a.after_update.forEach(Ks);
  }
}
function $h(a) {
  const r = [], i = [];
...
function Be(a, r) {
  a && a.i && (yi.delete(a), a.i(r));
}
function Ye(a, r, i, u) {
  if (a && a.o) {
    if (yi.has(a)) return;
    yi.add(a), Nn.c.push(() => {
      yi.delete(a), u && (i && a.d(1), u());
    }), a.o(r);
  } else u && u();
}
function Uo(a) {
...
function tg(a, r, i, u, l, f, g, v, m, _, k, p) {
  let x = a.length, S = f.length, b = x;
  const R = {};
  for (; b--; ) R[a[b].key] = b;
  const L = [], T = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), P = [];
  for (b = S; b--; ) {
    const q = p(l, f, b), U = i(q);
    let D = g.get(U);
    D ? P.push(() => D.p(q, r)) : (D = _(U, q), D.c()), T.set(U, L[b] = D), U in R && M.set(U, Math.abs(b - R[U]));
  }
  const A = /* @__PURE__ */ new Set(), O = /* @__PURE__ */ new Set();
  function z(q) {
    Be(q, 1), q.m(v, k), g.set(q.key, q), k = q.first, S--;
  }
  for (; x && S; ) {
    const q = L[S - 1], U = a[x - 1], D = q.key, H = U.key;
    q === U ? (k = q.first, x--, S--) : T.has(H) ? !g.has(D) || A.has(D) ? z(q) : O.has(H) ? x-- : M.get(D) > M.get(H) ? (O.add(D), z(q)) : (A.add(H), x--) : (m(U, g), x--);
  }
  for (; x--; ) {
    const q = a[x];
    T.has(q.key) || m(q, g);
...
function gn(a, r, i, u, l, f, g = null, v = [-1]) {
  ...
  if (_.ctx = i ? i(a, r.props || {}, (p, x, ...S) => {
    ...
    return _.ctx && l(_.ctx[p], _.ctx[p] = b) && (!_.skip_bound && _.bound[p] && _.bound[p](b), k && ng(a, p)), x;
    ...
    r.intro && Be(a.$$.fragment), Kt(a, r.target, r.anchor), sc();
  }
  Dr(m);
}
class yn {
...
function yg(a) {
  ...
  return {
    c() {
      r = ke("li"), O.c(), f = ht(), g = ke("span"), v = ke("span"), m = ke("span"), k = ln(_), p = ht(), z && z.c(), S = ht(), b = ke("span"), L = ln(R), Y(m, "class", "primary svelte-ltkwvy"), Y(v, "class", "svelte-ltkwvy"), Y(b, "class", "line2 svelte-ltkwvy"), Y(g, "class", "texts svelte-ltkwvy"), Y(r, "tabindex", "0"), Y(
        r,
        "data-selected",
        /*selected*/
        a[1]
    ...
    m(D, H) {
      Re(D, r, H), O.m(r, null), ve(r, f), ve(r, g), ve(g, v), ve(v, m), ve(m, k), ve(v, p), z && z.m(v, null), ve(g, S), ve(g, b), ve(b, L), T || (M = [
        et(
          r,
          "mouseenter",
          /*mouseenter_handler*/
    ...
    p(D, [H]) {
      ...
      D[5]) && !/*isReverse*/
      D[7]), x ? z ? z.p(D, H) : (z = Yo(D), z.c(), z.m(v, null)) : z && (z.d(1), z = null), H & /*feature*/
      1 && R !== (R = /*isReverse*/
      (D[7] ? "" : (
        /*feature*/
...
function vg(a, r, i) {
  ...
  const M = () => R();
  return a.$$set = (A) => {
    "feature" in A && i(0, f = A.feature), "selected" in A && i(1, g = A.selected), "showPlaceType" in A && i(2, v = A.showPlaceType), "missingIconsCache" in A && i(9, m = A.missingIconsCache), "iconsBaseUrl" in A && i(3, _ = A.iconsBaseUrl);
  }, a.$$.update = () => {
    var A, O, z, q;
...
function Qo(a, r) {
  ...
  if (r == "DM") {
    let v = Tg(l, 3).toFixed(3).padStart(6, "0");
    return `${u}° ${v}'`;
  }
...
function Ta(a, r) {
  ...
  if (v) {
    ...
    if (l && l == f)
      throw new Error("invalid coordinates format");
    let m = /S|SOUTH/i;
    m.test(l) && i > 0 && (i = -1 * i), m = /W|WEST/i, m.test(f) && u > 0 && (u = -1 * u);
    const _ = g[0].trim();
    let k, p;
    const x = /[,/;\u0020]/g, S = _.match(x);
    if (S == null) {
      const L = Math.floor(a.length / 2);
      k = _.substring(0, L).trim(), p = _.substring(L).trim();
    } else {
      let L;
      S.length % 2 == 1 ? L = Math.floor(S.length / 2) : L = S.length / 2 - 1;
      let T = 0;
      if (L == 0)
        T = _.indexOf(S[0]), k = _.substring(0, T).trim(), p = _.substring(T + 1).trim();
      else {
        let M = 0, P = 0;
        for (; M <= L; )
          T = _.indexOf(S[M], P), P = T + 1, M++;
        k = _.substring(0, T).trim(), p = _.substring(T + 1).trim();
      }
    }
    const b = k.split(".");
...
function Lr(a) {
  ...
  for (let f = 0; f < l; f++) {
    const g = r[f], v = r[f + l], m = i.test(g) && i.test(v), _ = u.test(g) && u.test(v), k = g == v;
    if (!(g == null && v == null)) {
      if (g == null || v == null)
        return !1;
      if (m || _ || k)
...
function Cg(a) {
  if (a.includes(",")) {
    ...
    return Ko(this.decimalLatitude, Number(r[0])) && Ko(this.decimalLongitude, r[1]);
  } else
...
function eu(a) {
  ...
  return i = new Sg({}), {
    ...
    m(g, v) {
      Re(g, r, v), Kt(i, r, null), u = !0, l || (f = et(
        r,
        "click",
        /*click_handler_2*/
        a[67]
  ...
  return {
    ...
    p(_, k) {
      ...
      17880064 && (v = Uo(
        /*listFeatures*/
        _[14]
      ), vi(), i = tg(i, k, m, 1, _, v, u, r, eg, tu, null, Jo), di());
    },
    i(_) {
      if (!l) {
...
function qg(a) {
  ...
  return i = new oc({}), {
    ...
    m(v, m) {
      Re(v, r, m), Kt(i, r, null), ve(r, u), ve(r, l), ve(l, f), g = !0;
    },
    p(v, m) {
      (!g || m[0] & /*noResultsMessage*/
      128) && zr(
        f,
        /*noResultsMessage*/
        v[7]
  ...
  return i = new oc({}), m = new ac({}), {
    c() {
      r = ke("div"), cn(i.$$.fragment), u = ht(), l = ke("div"), f = ln(
        /*errorMessage*/
        a[6]
      ), g = ht(), v = ke("button"), cn(m.$$.fragment), Y(l, "class", "svelte-zh3kmv"), Y(v, "class", "svelte-zh3kmv"), Y(r, "class", "error svelte-zh3kmv");
    },
    m(x, S) {
      Re(x, r, S), Kt(i, r, null), ve(r, u), ve(r, l), ve(l, f), ve(r, g), ve(r, v), Kt(m, v, null), _ = !0, k || (p = et(
        v,
        "click",
        /*click_handler_3*/
        a[68]
...
function Yg(a) {
  ...
  return ~(L = ae(a)) && (T = Z[L] = ee[L](a)), {
    c() {
      r = ht(), i = ke("form"), u = ke("div"), l = ke("button"), cn(f.$$.fragment), g = ht(), v = ke("input"), m = ht(), _ = ke("div"), k = ke("button"), cn(p.$$.fragment), x = ht(), q && q.c(), S = ht(), U && U.c(), b = ht(), H && H.c(), R = ht(), T && T.c(), Y(l, "class", "search-button svelte-zh3kmv"), Y(l, "type", "button"), Y(
        v,
        "placeholder",
        /*placeholder*/
        a[8]
        ...
        /*placeholder*/
        a[8]
      ), Y(v, "class", "svelte-zh3kmv"), Y(k, "type", "button"), Y(
        k,
        "title",
        /*clearButtonTitle*/
        a[3]
        ...
        /*searchValue*/
        a[1] !== ""
      ), Y(u, "class", "input-group svelte-zh3kmv"), Y(i, "tabindex", "0"), Y(i, "class", M = Bo(
        /*className*/
        a[2]
      ) + " svelte-zh3kmv"), St(
        i,
    ...
    m(F, Q) {
      Re(F, r, Q), Re(F, i, Q), ve(i, u), ve(u, l), Kt(f, l, null), ve(u, g), ve(u, v), a[61](v), Go(
        v,
        /*searchValue*/
        a[1]
      ), ve(u, m), ve(u, _), ve(_, k), Kt(p, k, null), ve(_, x), q && q.m(_, null), ve(u, S), U && U.m(u, null), ve(u, b), H && H.m(u, null), ve(i, R), ~L && Z[L].m(i, null), P = !0, A || (O = [
        et(
          l,
          "click",
          /*click_handler*/
    ...
    p(F, Q) {
      ...
      524288 && Be(q, 1) : (q = $o(), q.c(), Be(q, 1), q.m(_, null)) : q && (vi(), Ye(q, 1, 1, () => {
        q = null;
      }), di()), (!P || Q[0] & /*searchValue*/
      2) && St(
        _,
        "displayable",
        /*searchValue*/
      ...
      32 && Be(U, 1)) : (U = eu(F), U.c(), Be(U, 1), U.m(u, b)) : U && (vi(), Ye(U, 1, 1, () => {
        U = null;
      }), di()), H && H.p && (!P || Q[1] & /*$$scope*/
      134217728) && Uh(
        H,
        D,
        F,
      ...
      let ie = L;
      L = ae(F), L === ie ? ~L && Z[L].p(F, Q) : (T && (vi(), Ye(Z[ie], 1, 1, () => {
        Z[ie] = null;
      }), di()), ~L ? (T = Z[L], T ? T.p(F, Q) : (T = Z[L] = ee[L](F), T.c()), Be(T, 1), T.m(i, null)) : T = null), (!P || Q[0] & /*className*/
      4 && M !== (M = Bo(
        /*className*/
        F[2]
      ) + " svelte-zh3kmv")) && Y(i, "class", M), (!P || Q[0] & /*className, collapsed, searchValue*/
      22) && St(
        i,
        "can-collapse",
        /*collapsed*/
...
function Wg(a, r, i) {
  ...
  async function En(G, { byId: Le = !1, exact: Ge = !1 } = {}) {
    ...
    try {
      ...
      if (P !== void 0 && Ke.set("language", Array.isArray(P) ? P.join(",") : P ?? ""), Se && Ke.set("types", Se.join(",")), K && Ke.set("excludeTypes", String(K)), m && Ke.set("bbox", m.map((Gn) => Gn.toFixed(6)).join(",")), x && Ke.set("country", Array.isArray(x) ? x.join(",") : x), !Le && !he) {
        const Gn = await Ng(O, D, Qe);
        Gn && Ke.set("proximity", Gn), (Ge || !Q) && Ke.set("autocomplete", "false"), Ke.set("fuzzyMatch", String(M));
      }
      A !== void 0 && (!he || (Se == null ? void 0 : Se.length) === 1) && Ke.set("limit", String(A)), Ke.set("key", v), vr(Ke);
      const vt = ze + "/" + encodeURIComponent(he ? he.decimalLongitude + "," + he.decimalLatitude : G) + ".json?" + Ke.toString();
      if (vt === dr) {
        Le ? (i(14, le = void 0), i(55, oe = pn[0])) : i(14, le = pn);
        return;
      }
      dr = vt;
      const Bn = await fetch(vt, { signal: Qe.signal, ...fe });
      if (!Bn.ok)
  ...
  function se(G) {
    i(0, H = b === "always"), i(14, le = void 0), i(55, oe = void 0), i(15, Ie = -1), Zr(G[1].toFixed(6) + ", " + wg(G[0], [-180, 180], !0).toFixed(6), !1, !0);
  }
  function rs(G) {
    if (!le)
      return;
...
function Vg() {
  ...
  if (!Object.keys) {
    ...
    a = function(S) {
      var b = S !== null && typeof S == "object", R = i.call(S) === "[object Function]", L = u(S), T = b && i.call(S) === "[object String]", M = [];
      if (!b && !R && !L)
      ...
      if (L && S.length > 0)
        ...
        for (var z in S)
          !(P && z === "prototype") && r.call(S, z) && M.push(String(z));
      if (f)
        for (var q = p(S), U = 0; U < v.length; ++U)
          !(q && v[U] === "constructor") && r.call(S, v[U]) && M.push(v[U]);
      return M;
    };
  }
  return ws = a, ws;
}
var Hg = Array.prototype.slice, Zg = lc, iu = Object.keys, mi = iu ? function(r) {
  return iu(r);
} : Vg(), su = Object.keys;
mi.shim = function() {
  if (Object.keys) {
...
var Ca = mi, Qg = Error, Kg = EvalError, Jg = RangeError, $g = ReferenceError, cc = SyntaxError, vn = TypeError, ey = URIError, Ji = function() {
  ...
  }, g = ay(0, i.length - u.length), v = [], m = 0; m < g; m++)
    v[m] = "$" + m;
  if (l = Function("binder", "return function (" + ly(v, ",") + "){ return binder.apply(this,arguments); }")(f), i.prototype) {
    var _ = function() {
    };
    _.prototype = i.prototype, l.prototype = new _(), _.prototype = null;
  }
  return l;
}, fy = cy, Ra = Function.prototype.bind || fy, hy = Function.prototype.call, gy = Object.prototype.hasOwnProperty, yy = Ra, fc = yy.call(hy, gy), ye, vy = Qg, dy = Kg, my = Jg, py = $g, rr = cc, nr = vn, _y = ey, hc = Function, Ls = function(a) {
  try {
...
var Iy = function a(r) {
...
}, jr = Ra, Li = fc, by = jr.call(Function.call, Array.prototype.concat), wy = jr.call(Function.apply, Array.prototype.splice), lu = jr.call(Function.call, String.prototype.replace), Ti = jr.call(Function.call, String.prototype.slice), Ny = jr.call(Function.call, RegExp.prototype.exec), Ly = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, Ty = /\\(\\)?/g, Cy = function(r) {
  ...
  var l = [];
  return lu(r, Ly, function(f, g, v, m) {
    l[l.length] = v ? lu(m, Ty, "$1") : g || f;
  }), l;
}, Oy = function(r, i) {
  var u = r, l;
  if (Li(uu, u) && (l = uu[u], u = "%" + l[0] + "%"), Li(Cn, u)) {
    var f = Cn[u];
  ...
  var u = Cy(r), l = u.length > 0 ? u[0] : "", f = Oy("%" + l + "%", i), g = f.name, v = f.value, m = !1, _ = f.alias;
  ...
  return v;
}, Ry = Ut, pi = Ry("%Object.defineProperty%", !0) || !1;
if (pi)
  try {
    pi({}, "a", { value: 1 });
  } catch {
...
var Ma = pi, My = Ut, _i = My("%Object.getOwnPropertyDescriptor%", !0);
if (_i)
  try {
    _i([], "length");
  } catch {
...
var Pa = _i, cu = Ma, Py = cc, Qn = vn, fu = Pa, Aa = function(r, i, u) {
  if (!r || typeof r != "object" && typeof r != "function")
    throw new Qn("`obj` must be an object or a function`");
  if (typeof i != "string" && typeof i != "symbol")
    throw new Qn("`property` must be a string or a symbol`");
  if (arguments.length > 3 && typeof arguments[3] != "boolean" && arguments[3] !== null)
    throw new Qn("`nonEnumerable`, if provided, must be a boolean or null");
  if (arguments.length > 4 && typeof arguments[4] != "boolean" && arguments[4] !== null)
    throw new Qn("`nonWritable`, if provided, must be a boolean or null");
  if (arguments.length > 5 && typeof arguments[5] != "boolean" && arguments[5] !== null)
    throw new Qn("`nonConfigurable`, if provided, must be a boolean or null");
  if (arguments.length > 6 && typeof arguments[6] != "boolean")
    throw new Qn("`loose`, if provided, must be a boolean");
  var l = arguments.length > 3 ? arguments[3] : null, f = arguments.length > 4 ? arguments[4] : null, g = arguments.length > 5 ? arguments[5] : null, v = arguments.length > 6 ? arguments[6] : !1, m = !!fu && fu(r, i);
  if (cu)
    cu(r, i, {
...
(function(a) {
  var r = Ra, i = Ut, u = Wy, l = vn, f = i("%Function.prototype.apply%"), g = i("%Function.prototype.call%"), v = i("%Reflect.apply%", !0) || r.call(g, f), m = Ma, _ = i("%Math.max%");
  a.exports = function(x) {
    if (typeof x != "function")
      throw new l("a function is required");
    var S = v(r, g, arguments);
    return u(
      S,
...
var lr = dc.exports, mc = Ut, pc = lr, Xy = pc(mc("String.prototype.indexOf")), bt = function(r, i) {
  ...
  for (var l = 1; l < arguments.length; ++l) {
    var f = du(arguments[l]), g = jy(f), v = _c && (Object.getOwnPropertySymbols || Hy);
    if (v)
  ...
  return !Object.assign || Zy() || Qy() ? Cs : Object.assign;
}, Ky = Rn, Jy = xc, $y = function() {
  var r = Jy();
  return Ky(
    Object,
    { assign: r },
...
Yr.functionsHaveConfigurableNames = function() {
  if (!Yr() || !Fr)
    return !1;
  var r = Fr(function() {
  }, "name");
...
Yr.boundFunctionsHaveNames = function() {
  return Yr() && typeof av == "function" && (function() {
  }).bind().name !== "";
};
var ov = Yr, pu = Aa, uv = Da(), lv = ov.functionsHaveConfigurableNames(), cv = vn, fv = function(r, i) {
  if (typeof r != "function")
...
var Tv = Lc, Ei = { exports: {} }, Cv = Ji, Mn = function() {
...
var na = Dv, Lu = na.custom, Tu = Pc(Lu) ? Lu : null, jv = function a(r, i, u, l) {
  ...
  var g = rn(f, "customInspect") ? f.customInspect : !0;
  ...
  if (od(r)) {
    for (var L = "<" + Su.call(String(r.nodeName)), T = r.attributes || [], M = 0; M < T.length; M++)
      L += " " + T[M].name + "=" + Mc(Vv(T[M].value), "double", f);
  ...
  if (nd(r)) {
    ...
    }), Ou("Map", Ci.call(r), O, p);
  }
  if (sd(r)) {
    var z = [];
    return ku && ku.call(r, function(ae) {
      z.push(x(ae, r));
    }), Ou("Set", Oi.call(r), z, p);
  }
  if (rd(r))
    return Ps("WeakMap");
  if (ad(r))
  ...
  if (!Hv(r) && !Cu(r)) {
    var q = ai(r, x), U = wu ? wu(r) === Object.prototype : r instanceof Object || r.constructor === Object, D = r instanceof Object ? "" : "null prototype", H = !U && Ze && Object(r) === r && Ze in r ? Ga.call(dn(r), 8, -1) : D ? "Object" : "", ee = U || typeof r.constructor != "function" ? "" : r.constructor.name ? r.constructor.name + " " : "", Z = ee + (H || D ? "[" + Bt.call(Iu.call([], H || [], D || []), ": ") + "] " : "");
...
function ai(a, r) {
  ...
  var f = typeof Ms == "function" ? Ms(a) : [], g;
  if (ir) {
    g = {};
  ...
  for (var m in a)
    rn(a, m) && (i && String(Number(m)) === m && m < a.length || ir && g["$" + m] instanceof Symbol || (Oc.call(/[^\w$]/, m) ? u.push(r(m, a) + ": " + r(a[m], a)) : u.push(m + ": " + r(a[m], a))));
  if (typeof Ms == "function")
    for (var _ = 0; _ < f.length; _++)
      Rc.call(a, f[_]) && u.push("[" + r(f[_]) + "]: " + r(a[f[_]], a));
  return u;
}
var Fc = Ut, cr = bt, fd = jv, hd = vn, oi = Fc("%WeakMap%", !0), ui = Fc("%Map%", !0), gd = cr("WeakMap.prototype.get", !0), yd = cr("WeakMap.prototype.set", !0), vd = cr("WeakMap.prototype.has", !0), dd = cr("Map.prototype.get", !0), md = cr("Map.prototype.set", !0), pd = cr("Map.prototype.has", !0), qa = function(a, r) {
  ...
  var r, i, u, l = {
    ...
    get: function(f) {
      if (oi && f && (typeof f == "object" || typeof f == "function")) {
        if (r)
          return gd(r, f);
      } else if (ui) {
        if (i)
    ...
    set: function(f, g) {
      oi && f && (typeof f == "object" || typeof f == "function") ? (r || (r = new oi()), yd(r, f, g)) : ui ? (i || (i = new ui()), md(i, f, g)) : (u || (u = { key: {}, next: null }), Ed(u, f, g));
    }
  };
  return l;
...
}, Ua = typeof Map == "function" && Map.prototype ? Map : null, Rd = typeof Set == "function" && Set.prototype ? Set : null, Ri;
Ua || (Ri = function(r) {
  return !1;
});
...
var Uc = Ri || function(r) {
  ...
  return !1;
}, Md = typeof Map == "function" && Map.prototype ? Map : null, Ya = typeof Set == "function" && Set.prototype ? Set : null, Mi;
Ya || (Mi = function(r) {
  return !1;
});
...
var Yd = Ei.exports, Vu = function(a) {
  return a !== a;
}, Xc = function(r, i) {
...
}, Hd = Rn, Zd = lr, Qd = Xc, Vc = jc, Kd = Vd, Hc = Zd(Vc(), Object);
Hd(Hc, {
  getPolyfill: Vc,
  implementation: Qd,
  shim: Kd
});
var Jd = Hc, $d = lr, Zc = bt, em = Ut, sa = em("%ArrayBuffer%", !0), ki = Zc("ArrayBuffer.prototype.byteLength", !0), tm = Zc("Object.prototype.toString"), Hu = !!sa && !ki && new sa(0).slice, Zu = !!Hu && $d(Hu), Qc = ki || Zu ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    return ki ? ki(r) : Zu(r, 0), !0;
  } catch {
    return !1;
  }
} : sa ? function(r) {
...
var um = aa("Object.prototype.toString"), lm = Object.getOwnPropertyDescriptor, cm = "[object RegExp]", fm = Kc ? function(r) {
  if (!r || typeof r != "object")
    return !1;
...
}, hm = bt, Qu = hm("SharedArrayBuffer.prototype.byteLength", !0), gm = Qu ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    return Qu(r), !0;
...
var Om = la.exports, ca = { exports: {} }, Ku = typeof BigInt < "u" && BigInt, Rm = function() {
...
var Dm = ca.exports, Fm = qc, Bm = _m, Gm = bm, qm = Om, zm = Dm, Um = function(r) {
  ...
  if (zm(r))
    return "BigInt";
}, Pi = typeof WeakMap == "function" && WeakMap.prototype ? WeakMap : null, Ju = typeof WeakSet == "function" && WeakSet.prototype ? WeakSet : null, Ai;
Pi || (Ai = function(r) {
  return !1;
});
var fa = Pi ? Pi.prototype.has : null, Bs = Ju ? Ju.prototype.has : null;
!Ai && !fa && (Ai = function(r) {
  return !1;
});
var Ym = Ai || function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    if (fa.call(r, fa), Bs)
...
var jm = ha.exports, Vm = Uc, Hm = Wc, Zm = Ym, Qm = jm, Km = function(r) {
  if (r && typeof r == "object") {
    if (Vm(r))
      return "Map";
    if (Hm(r))
  ...
  return !1;
}, nf = Function.prototype.toString, er = typeof Reflect == "object" && Reflect !== null && Reflect.apply, ga, xi;
...
}, Si = Object.prototype.toString, $m = "[object Object]", ep = "[object Function]", tp = "[object GeneratorFunction]", np = "[object HTMLAllCollection]", rp = "[object HTML document.all class]", ip = "[object HTMLCollection]", sp = typeof Symbol == "function" && !!Symbol.toStringTag, ap = !(0 in [,]), va = function() {
  return !1;
};
if (typeof document == "object") {
  var op = document.all;
  Si.call(op) === Si.call(document.all) && (va = function(r) {
...
var up = er ? function(r) {
  ...
  "BigInt64Array",
  "BigUint64Array"
], Us = dp, mp = typeof globalThis > "u" ? Ki : globalThis, pp = function() {
  for (var r = [], i = 0; i < Us.length; i++)
    typeof mp[Us[i]] == "function" && (r[r.length] = Us[i]);
  return r;
}, Di = vp, _p = pp, $u = lr, Wa = bt, Ii = Pa, Ep = Wa("Object.prototype.toString"), sf = Mn(), el = typeof globalThis > "u" ? Ki : globalThis, da = _p(), Xa = Wa("String.prototype.slice"), Ys = Object.getPrototypeOf, kp = Wa("Array.prototype.indexOf", !0) || function(r, i) {
  for (var u = 0; u < r.length; u += 1)
    if (r[u] === i)
      return u;
  return -1;
}, Fi = { __proto__: null };
sf && Ii && Ys ? Di(da, function(a) {
  var r = new el[a]();
...
var xp = function(r) {
  ...
  return Ii ? xp(r) : null;
}, bp = bt, tl = bp("ArrayBuffer.prototype.byteLength", !0), wp = Qc, Np = function(r) {
  return wp(r) ? tl ? tl(r) : r.byteLength : NaN;
}, af = sv, Yt = bt, nl = Tv, Lp = Ut, sr = Yd, Tp = Bc, rl = Jd, il = Cc, sl = Gc, al = Qc, ol = om, ul = fm, ll = gm, cl = Ca, fl = Um, hl = Km, gl = Ip, yl = Np, vl = Yt("SharedArrayBuffer.prototype.byteLength", !0), dl = Yt("Date.prototype.getTime"), Ws = Object.getPrototypeOf, ml = Yt("Object.prototype.toString"), Bi = Lp("%Set%", !0), ma = Yt("Map.prototype.has", !0), Gi = Yt("Map.prototype.get", !0), pl = Yt("Map.prototype.size", !0), qi = Yt("Set.prototype.add", !0), of = Yt("Set.prototype.delete", !0), zi = Yt("Set.prototype.has", !0), bi = Yt("Set.prototype.size", !0);
function _l(a, r, i, u) {
...
function Rt(a, r, i, u) {
  ...
  if (v && m) {
    ...
    _ = {};
  return v || u.set(a, _), m || u.set(r, _), Pp(a, r, l, u);
}
function kl(a) {
  ...
  if (m) {
    for (; (v = f.next()) && !v.done; )
      if (v.value && typeof v.value == "object") {
        if (!_l(m, v.value, i.strict, u))
          return !1;
      } else if (!i.strict && !zi(a, v.value) && !_l(m, v.value, i.strict, u))
        return !1;
    return bi(m) === 0;
  }
  return !0;
  ...
  if (m) {
    for (; (v = f.next()) && !v.done; )
      if (_ = v.value[0], p = v.value[1], _ && typeof _ == "object") {
        if (!El(m, a, _, p, i, u))
          return !1;
      } else if (!i.strict && (!a.has(_) || !Rt(Gi(a, _), p, i, u)) && !El(m, a, _, p, af({}, i, { strict: !1 }), u))
        return !1;
    return bi(m) === 0;
  }
  return !0;
...
var Fp = Object.defineProperty, Ee = (a, r) => Fp(a, "name", { value: r, configurable: !0 }), Bp = class {
  ...
  compareLine(r, i, u = 0, l = !1) {
    ...
    if (l && !this.compareCoord(f[0], g[0])) {
      const m = this.fixStartIndex(g, f);
      if (m)
        g = m;
      else
        return !1;
...
var Ha = (
  ...
  function() {
    ...
    return a.prototype.insert = function(r, i) {
      ...
      var l = this._comparator, f = sn(r, this._root, l), g = l(r, f.key);
      ...
      for (var f = [], g = this._comparator, v = this._root, m; f.length !== 0 || v; )
        if (v)
          f.push(v), v = v.left;
        else {
          if (v = f.pop(), m = g(v.key, i), m > 0)
            break;
      ...
      if (u && xa(r, i, 0, l - 1, f), this._root === null)
        ...
        var g = r0(this.toList(), t0(r, i), f);
        l = this._size + l, this._root = ka({ head: g }, 0, l);
      }
      return this;
      ...
      l(r, i) < 0 ? v = Xs(i, u, v, l) : g = Xs(i, u, g, l), this._root = e0(g, v, l);
...
function Ea(a, r, i, u) {
  var l = u - i;
  if (l > 0) {
    var f = i + Math.floor(l / 2), g = a[f], v = r[f], m = new fn(g, v);
...
function ka(a, r, i) {
  var u = i - r;
  if (u > 0) {
    var l = r + Math.floor(u / 2), f = ka(a, r, l), g = a.head;
    return g.left = f, a.head = a.head.next, g.right = ka(a, l + 1, i), g;
  }
  return null;
}
function r0(a, r, i) {
  for (var u = new fn(null, null), l = u, f = a, g = r; f !== null && g !== null; )
  ...
  if (!(i >= u)) {
    for (var f = a[i + u >> 1], g = i - 1, v = u + 1; ; ) {
      ...
      if (g >= v)
        break;
      var m = a[g];
      a[g] = a[v], a[v] = m, m = r[g], r[g] = r[v], r[v] = m;
    }
    xa(a, r, i, v, l), xa(a, r, v + 1, u, l);
  }
}
const Qt = 11102230246251565e-32, Ve = 134217729, i0 = (3 + 8 * Qt) * Qt;
function js(a, r, i, u, l) {
  let f, g, v, m, _ = r[0], k = u[0], p = 0, x = 0;
  k > _ == k > -_ ? (f = _, _ = r[++p]) : (f = k, k = u[++x]);
  let S = 0;
  if (p < a && x < i)
    for (k > _ == k > -_ ? (g = _ + f, v = f - (g - _), _ = r[++p]) : (g = k + f, v = f - (g - k), k = u[++x]), f = g, v !== 0 && (l[S++] = v); p < a && x < i; )
      k > _ == k > -_ ? (g = f + _, m = g - f, v = f - (g - m) + (_ - m), _ = r[++p]) : (g = f + k, m = g - f, v = f - (g - m) + (k - m), k = u[++x]), f = g, v !== 0 && (l[S++] = v);
  for (; p < a; )
    g = f + _, m = g - f, v = f - (g - m) + (_ - m), _ = r[++p], f = g, v !== 0 && (l[S++] = v);
  for (; x < i; )
    g = f + k, m = g - f, v = f - (g - m) + (k - m), k = u[++x], f = g, v !== 0 && (l[S++] = v);
...
const a0 = (3 + 16 * Qt) * Qt, o0 = (2 + 12 * Qt) * Qt, u0 = (9 + 64 * Qt) * Qt * Qt, Kn = Vr(4), Il = Vr(8), bl = Vr(12), wl = Vr(16), $e = Vr(4);
function l0(a, r, i, u, l, f, g) {
  let v, m, _, k, p, x, S, b, R, L, T, M, P, A, O, z, q, U;
  const D = a - l, H = i - l, ee = r - f, Z = u - f;
  A = D * Z, x = Ve * D, S = x - (x - D), b = D - S, x = Ve * Z, R = x - (x - Z), L = Z - R, O = b * L - (A - S * R - b * R - S * L), z = ee * H, x = Ve * ee, S = x - (x - ee), b = ee - S, x = Ve * H, R = x - (x - H), L = H - R, q = b * L - (z - S * R - b * R - S * L), T = O - q, p = O - T, Kn[0] = O - (T + p) + (p - q), M = A + T, p = M - A, P = A - (M - p) + (T - p), T = P - z, p = P - T, Kn[1] = P - (T + p) + (p - z), U = M + T, p = U - M, Kn[2] = M - (U - p) + (T - p), Kn[3] = U;
  let ae = s0(4, Kn), F = o0 * g;
  if (ae >= F || -ae >= F || (p = a - D, v = a - (D + p) + (p - l), p = i - H, _ = i - (H + p) + (p - l), p = r - ee, m = r - (ee + p) + (p - f), p = u - Z, k = u - (Z + p) + (p - f), v === 0 && m === 0 && _ === 0 && k === 0) || (F = u0 * g + i0 * Math.abs(ae), ae += D * k + Z * v - (ee * _ + H * m), ae >= F || -ae >= F)) return ae;
...
const Wr = new h0(), wi = (a, r) => a.x * r.y - a.y * r.x, gf = (a, r) => a.x * r.x + a.y * r.y, Tl = (a, r, i) => {
  const u = c0(a.x, a.y, r.x, r.y, i.x, i.y);
  return u > 0 ? -1 : u < 0 ? 1 : 0;
}, Yi = (a) => Math.sqrt(gf(a, a)), g0 = (a, r, i) => {
  const u = {
    x: r.x - a.x,
    y: r.y - a.y
  }, l = {
...
class xt {
  ...
  getLeftmostComparator(r) {
    ...
    return (l, f) => {
      ...
      return g >= 0 && m >= 0 ? v < _ ? 1 : v > _ ? -1 : 0 : g < 0 && m < 0 ? v < _ ? -1 : v > _ ? 1 : 0 : m < g ? -1 : m > g ? 1 : 0;
    };
  }
}
let d0 = 0;
class un {
  ...
  static compare(r, i) {
    ...
    if (g < u) return 1;
    if (f < l) return -1;
    const v = r.leftSE.point.y, m = i.leftSE.point.y, _ = r.rightSE.point.y, k = i.rightSE.point.y;
    if (u < l) {
      if (m < v && m < _) return 1;
      if (m > v && m > _) return -1;
    ...
    if (f !== g) {
      const p = _ - v, x = f - u, S = k - m, b = g - l;
      if (p > x && S < b) return 1;
      if (p < x && S > b) return -1;
    }
    return f > g ? 1 : f < g || _ < k ? -1 : _ > k ? 1 : r.id < i.id ? -1 : r.id > i.id ? 1 : 0;
  }
  ...
  comparePoint(r) {
    ...
    if (r.x === g) return 0;
    const v = (r.x - i.x) / l.x, m = i.y + v * l.y;
  ...
  getIntersection(r) {
    ...
    const f = this.leftSE.point, g = this.rightSE.point, v = r.leftSE.point, m = r.rightSE.point, _ = Rr(i, v) && this.comparePoint(v) === 0, k = Rr(u, f) && r.comparePoint(f) === 0, p = Rr(i, m) && this.comparePoint(m) === 0, x = Rr(u, g) && r.comparePoint(g) === 0;
    if (k && _)
      return x && !p ? g : !x && p ? m : null;
    if (k)
      return p && f.x === m.x && f.y === m.y ? null : f;
    if (_)
      return x && g.x === v.x && g.y === v.y ? null : v;
    if (x && p) return null;
    if (x) return g;
    if (p) return m;
    const S = v0(f, this.vector(), v, r.vector());
    return S === null || !Rr(l, S) ? null : Wr.round(S.x, S.y);
  }
  /**
   ...
   */
  split(r) {
    const i = [], u = r.events !== void 0, l = new xt(r, !0), f = new xt(r, !1), g = this.rightSE;
    this.replaceRightSE(f), i.push(f), i.push(l);
    const v = new un(l, g, this.rings.slice(), this.windings.slice());
    return xt.comparePoints(v.leftSE.point, v.rightSE.point) > 0 && v.swapEvents(), xt.comparePoints(this.leftSE.point, this.rightSE.point) > 0 && this.swapEvents(), u && (l.checkForConsuming(), f.checkForConsuming()), i;
  }
  ...
  consume(r) {
    ...
    if (l !== 0) {
      ...
      for (let f = 0, g = u.rings.length; f < g; f++) {
        const v = u.rings[f], m = u.windings[f], _ = i.rings.indexOf(v);
        _ === -1 ? (i.rings.push(v), i.windings.push(m)) : i.windings[_] += m;
      }
  ...
  afterState() {
    ...
    for (let v = 0, m = this.rings.length; v < m; v++) {
      const _ = this.rings[v], k = this.windings[v], p = i.indexOf(_);
      p === -1 ? (i.push(_), u.push(k)) : u[p] += k;
    }
    const f = [], g = [];
    for (let v = 0, m = i.length; v < m; v++) {
      if (u[v] === 0) continue;
      const _ = i[v], k = _.poly;
      if (g.indexOf(k) === -1)
        if (_.isExterior) f.push(k);
        else {
          g.indexOf(k) === -1 && g.push(k);
...
class Wi {
  ...
  static factory(r) {
    ...
    for (let u = 0, l = r.length; u < l; u++) {
      ...
      let g = null, v = f.leftSE, m = f.rightSE;
      const _ = [v], k = v.point, p = [];
      for (; g = v, v = m, _.push(v), v.point !== k; )
        for (; ; ) {
          const x = v.getAvailableLinkedEvents();
          if (x.length === 0) {
            const R = _[0].point, L = _[_.length - 1].point;
            throw new Error(`Unable to complete output ring starting at [${R.x}, ${R.y}]. Last matching segment found ends at [${L.x}, ${L.y}].`);
          }
          if (x.length === 1) {
            m = x[0].otherSE;
            break;
          ...
          const b = v.getLeftmostComparator(g);
  ...
  getGeom() {
    ...
    for (let _ = g; _ != v; _ += f) m.push([i[_].x, i[_].y]);
    return m;
  }
  isExteriorRing() {
...
class _0 {
  ...
  process(r) {
    ...
    for (; m === void 0; )
      g = this.tree.next(g), g === null ? m = null : g.key.consumedBy === void 0 && (m = g.key);
    if (r.isLeft) {
      let _ = null;
      if (v) {
        const p = v.getIntersection(i);
        if (p !== null && (i.isAnEndpoint(p) || (_ = p), !v.isAnEndpoint(p))) {
          const x = this._splitSafely(v, p);
      ...
      if (v && m) {
        const _ = v.getIntersection(m);
        if (_ !== null) {
          if (!v.isAnEndpoint(_)) {
            const k = this._splitSafely(v, _);
  ...
  run(r, i, u) {
    ...
    if (Ct.type === "intersection")
      for (let p = 0, x = l.length; p < x; p++) {
        const S = l[p];
        for (let b = p + 1, R = l.length; b < R; b++)
          if (Sa(S.bbox, l[b].bbox) === null) return [];
      }
    const f = new Ha(xt.compare);
    for (let p = 0, x = l.length; p < x; p++) {
      const S = l[p].getSweepEvents();
      for (let b = 0, R = S.length; b < R; b++)
        if (f.insert(S[b]), f.size > Al)
          throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big).");
    }
    const g = new _0(f);
    let v = f.size, m = f.pop();
    for (; m; ) {
      const p = m.key;
      if (f.size === v) {
        const S = p.segment;
      ...
      if (g.segments.length > E0)
        throw new Error("Infinite loop when passing sweep line over endpoints (too many sweep line segments).");
      const x = g.process(p);
      for (let S = 0, b = x.length; S < b; S++) {
        const R = x[S];
        R.consumedBy === void 0 && f.insert(R);
      }
      v = f.size, m = f.pop();
    }
    Wr.reset();
...
function hr(a, r, i) {
  if (a !== null)
    for (var u, l, f, g, v, m, _, k = 0, p = 0, x, S = a.type, b = S === "FeatureCollection", R = S === "Feature", L = b ? a.features.length : 1, T = 0; T < L; T++) {
      _ = b ? a.features[T].geometry : R ? a.geometry : a, x = _ ? _.type === "GeometryCollection" : !1, v = x ? _.geometries.length : 1;
      for (var M = 0; M < v; M++) {
        var P = 0, A = 0;
        if (g = x ? _.geometries[M] : _, g !== null) {
          m = g.coordinates;
          var O = g.type;
...
Xe(C0, "coordAll");
function Pn(a, r) {
  var i, u, l, f, g, v, m, _, k, p, x = 0, S = a.type === "FeatureCollection", b = a.type === "Feature", R = S ? a.features.length : 1;
  for (i = 0; i < R; i++) {
    for (v = S ? a.features[i].geometry : b ? a.geometry : a, _ = S ? a.features[i].properties : b ? a.properties : {}, k = S ? a.features[i].bbox : b ? a.bbox : void 0, p = S ? a.features[i].id : b ? a.id : void 0, m = v ? v.type === "GeometryCollection" : !1, g = m ? v.geometries.length : 1, l = 0; l < g; l++) {
      if (f = m ? v.geometries[l] : v, f === null) {
        if (r(
          null,
          x,
          _,
...
function D0(a, r) {
  ...
  switch (v.type) {
    case "Point":
      return Gt(m, g, r);
    case "MultiPoint":
      return u < 0 && (u = m.length + u), Gt(m[u], g, r);
    case "LineString":
      return f < 0 && (f = m.length + f), Gt(m[f], g, r);
    case "Polygon":
      return l < 0 && (l = m.length + l), f < 0 && (f = m[l].length + f), Gt(m[l][f], g, r);
    case "MultiLineString":
      return u < 0 && (u = m.length + u), f < 0 && (f = m[u].length + f), Gt(m[u][f], g, r);
    case "MultiPolygon":
  ...
  (function(i, u) {
    ...
    function b(o, e, t) {
      return b = typeof Reflect < "u" && Reflect.get ? Reflect.get : function(n, s, c) {
        var h = function(d, E) {
          for (; !Object.prototype.hasOwnProperty.call(d, E) && (d = g(d)) !== null; ) ;
          return d;
        }(n, s);
        if (h) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    K.NaN = NaN, K.isNaN = function(o) {
      ...
      if (y = s + H, c = e === 0, e = o - e, s < 52 && e !== 0) for (n = 0; ; ) {
        if ((t = 2 * e) >= 1 ? (e = t - 1, c ? (y--, c = !1) : (n <<= 1, n |= 1, s++)) : (e = t, c ? --y == 0 && (s++, c = !1) : (n <<= 1, s++)), s === 20) d |= n, n = 0;
        else if (s === 52) {
          E |= n;
          break;
        }
    ...
    }(), gt = new ArrayBuffer(8), vr = new Float64Array(gt), Hr = new Int32Array(gt), C = function() {
      function o() {
        i(this, o), o.constructor_.apply(this, arguments);
      }
    ...
    C.DimensionalComparator = Zr, C.NULL_ORDINATE = K.NaN, C.X = 0, C.Y = 1, C.Z = 2, C.M = 3;
    var xe = function() {
      function o() {
        i(this, o), o.constructor_.apply(this, arguments);
      }
      return l(o, [{ key: "getArea", value: function() {
        ...
        if (arguments.length === 0) this.setToNull();
          ...
          var c = arguments[0], h = arguments[1], y = arguments[2], d = arguments[3];
          c < h ? (this._minx = c, this._maxx = h) : (this._minx = h, this._maxx = c), y < d ? (this._miny = y, this._maxy = d) : (this._miny = d, this._maxy = y);
        }
        ...
        if (arguments.length === 4) {
          var s = arguments[0], c = arguments[1], h = arguments[2], y = arguments[3], d = Math.min(h.x, y.x), E = Math.max(h.x, y.x), w = Math.min(s.x, c.x), N = Math.max(s.x, c.x);
          return !(w > E) && !(N < d) && (d = Math.min(h.y, y.y), E = Math.max(h.y, y.y), w = Math.min(s.y, c.y), N = Math.max(s.y, c.y), !(w > E) && !(N < d));
        }
      } }]), o;
    }(), J = function() {
      function o() {
    ...
    var _n = function() {
      ...
      return l(o, [{ key: "le", value: function(e) {
        ...
        for (var h = s + 1, y = new _n(), d = o.MAX_PRINT_DIGITS - 1, E = 0; E <= d; E++) {
          e && E === h && y.append(".");
        ...
        if (arguments.length === 1) {
          ...
          var n = arguments[0], s = arguments[1], c = null, h = null, y = null, d = null, E = null, w = null, N = null, B = null;
          return E = this._hi / n, B = (c = (w = o.SPLIT * E) - (c = w - E)) * (y = (B = o.SPLIT * n) - (y = B - n)) - (N = E * n) + c * (d = n - y) + (h = E - c) * y + h * d, B = E + (w = (this._hi - N - B + this._lo - E * s) / n), this._hi = B, this._lo = E - B + w, this;
        }
      } }, { key: "dump", value: function() {
        return "DD<" + this._hi + ", " + this._lo + ">";
      } }, { key: "divide", value: function() {
        if (arguments[0] instanceof o) {
          var e = arguments[0], t = null, n = null, s = null, c = null, h = null, y = null, d = null, E = null;
          n = (h = this._hi / e._hi) - (t = (y = o.SPLIT * h) - (t = y - h)), E = t * (s = (E = o.SPLIT * e._hi) - (s = E - e._hi)) - (d = h * e._hi) + t * (c = e._hi - s) + n * s + n * c;
          var w = E = h + (y = (this._hi - d - E + this._lo - h * e._lo) / e._hi), N = h - E + y;
          return new o(w, N);
        }
        if (typeof arguments[0] == "number") {
          var B = arguments[0];
        ...
        if (arguments.length === 1) {
          ...
          if (typeof arguments[0] == "number") {
            var t = arguments[0], n = null, s = null, c = null, h = null, y = null, d = null;
            return h = (c = this._hi + t) - (y = c - this._hi), s = (d = (h = t - y + (this._hi - h)) + this._lo) + (c - (n = c + d)), this._hi = n + s, this._lo = s + (n - this._hi), this;
          }
        } else if (arguments.length === 2) {
        ...
        if (arguments.length === 1) {
          ...
          var n = arguments[0], s = arguments[1], c = null, h = null, y = null, d = null, E = null, w = null;
          c = (E = o.SPLIT * this._hi) - this._hi, w = o.SPLIT * n, c = E - c, h = this._hi - c, y = w - n;
          var N = (E = this._hi * n) + (w = c * (y = w - y) - E + c * (d = n - y) + h * y + h * d + (this._hi * s + this._lo * n)), B = w + (c = E - N);
        ...
        var e, t, n, s, c = null, h = null, y = null, d = null;
        e = (n = 1 / this._hi) - (c = (y = o.SPLIT * n) - (c = y - n)), h = (d = o.SPLIT * this._hi) - this._hi;
        var E = n + (y = (1 - (s = n * this._hi) - (d = c * (h = d - h) - s + c * (t = this._hi - h) + e * h + e * t) - n * this._lo) / this._hi);
        ...
        if (arguments[3] instanceof o && arguments[2] instanceof o && arguments[0] instanceof o && arguments[1] instanceof o) {
          var c = arguments[0], h = arguments[1], y = arguments[2], d = arguments[3], E = c.multiply(d).selfSubtract(h.multiply(y));
          return E;
        }
        ...
        for (var h = new o(), y = 0, d = 0, E = 0, w = !1; !(t >= n); ) {
          var N = e.charAt(t);
          if (t++, Dn.isDigit(N)) {
            var B = N - "0";
    ...
    var En = function() {
      ...
      return l(o, null, [{ key: "orientationIndex", value: function(e, t, n) {
        ...
        if (s <= 1) return s;
        var c = te.valueOf(t.x).selfAdd(-e.x), h = te.valueOf(t.y).selfAdd(-e.y), y = te.valueOf(n.x).selfAdd(-t.x), d = te.valueOf(n.y).selfAdd(-t.y);
        return c.selfMultiply(d).selfSubtract(h.selfMultiply(y)).signum();
    ...
    var rs = function() {
      ...
      return l(o, null, [{ key: "intersection", value: function(e, t, n, s) {
        ...
        return K.isNaN(ks) || K.isInfinite(ks) || K.isNaN(xs) || K.isInfinite(xs) ? null : new C(ks + j, xs + X);
      } }]), o;
    }(), rt = function() {
      function o() {
        i(this, o);
...
` }[e];
      ...
      return l(o, null, [{ key: "log10", value: function(e) {
        ...
        if (arguments.length === 4) {
          var c = arguments[0], h = arguments[1], y = arguments[2], d = arguments[3], E = c;
          return h > E && (E = h), y > E && (E = y), d > E && (E = d), E;
        }
    ...
    var yt = function() {
      ...
      return l(o, null, [{ key: "segmentToSegment", value: function(e, t, n, s) {
        ...
        if (xe.intersects(e, t, n, s)) {
          ...
          if (h === 0) c = !0;
            ...
            var y = (e.y - n.y) * (s.x - n.x) - (e.x - n.x) * (s.y - n.y), d = ((e.y - n.y) * (t.x - e.x) - (e.x - n.x) * (t.y - e.y)) / h, E = y / h;
            (E < 0 || E > 1 || d < 0 || d > 1) && (c = !0);
          }
        } else c = !0;
      ...
      return l(o, null, [{ key: "copyCoord", value: function(e, t, n, s) {
        ...
        if (arguments.length === 2) {
          ...
          var h = arguments[0], y = arguments[1], d = arguments[2], E = y;
          if (E <= 0) return null;
          for (var w = h.copy(), N = d ? h.size() - 1 : h.size(), B = 0; B < N; B++) for (var j = 0; j < h.getDimension(); j++) h.setOrdinate(B, j, w.getOrdinate((y + B) % N, j));
        ...
        for (var s = Math.min(e.getDimension(), t.getDimension()), c = 0; c < n; c++) for (var h = 0; h < s; h++) {
          var y = e.getOrdinate(c, h), d = t.getOrdinate(c, h);
          if (e.getOrdinate(c, h) !== t.getOrdinate(c, h) && (!K.isNaN(y) || !K.isNaN(d))) return !1;
        }
        return !0;
        ...
        if (arguments.length === 3) {
          for (var t = arguments[0], n = arguments[1], s = arguments[2], c = -1, h = null, y = n; y <= s; y++) {
            var d = t.getCoordinate(y);
            (h === null || h.compareTo(d) > 0) && (h = d, c = y);
          }
          return c;
        }
    ...
    var G = function() {
      ...
      return l(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        return b(g(t.prototype), "equalsExact", this).apply(this, arguments);
      ...
      return l(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        for (var y = 0; y < this._holes.length; y++) for (var d = this._holes[y].getCoordinates(), E = 0; E < d.length; E++) n[++s] = d[E];
        return n;
      } }, { key: "getArea", value: function() {
        var n = 0;
        ...
        if (arguments.length === 2) {
          var h = arguments[0], y = arguments[1], d = h, E = this._shell, w = d._shell, N = E.compareToSameClass(w, y);
          if (N !== 0) return N;
          for (var B = this.getNumInteriorRing(), j = d.getNumInteriorRing(), X = 0; X < B && X < j; ) {
            var $ = this.getInteriorRingN(X), re = d.getInteriorRingN(X), ce = $.compareToSameClass(re, y);
            if (ce !== 0) return ce;
            X++;
          }
      ...
      return l(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        if (arguments.length === 2) {
          for (var h = arguments[0], y = arguments[1], d = h, E = this.getNumGeometries(), w = d.getNumGeometries(), N = 0; N < E && N < w; ) {
            var B = this.getGeometryN(N), j = d.getGeometryN(N), X = B.compareToSameClass(j, y);
            if (X !== 0) return X;
            N++;
          }
        ...
        if (ue(arguments[0], Fn)) for (var n = arguments[0], s = 0; s < this._geometries.length; s++) this._geometries[s].apply(n);
          ...
          var y = arguments[0];
          y.filter(this);
          for (var d = 0; d < this._geometries.length; d++) this._geometries[d].apply(y);
        } else if (ue(arguments[0], z)) {
          var E = arguments[0];
          E.filter(this);
      ...
      return l(t, [{ key: "copyInternal", value: function() {
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof J) {
          var n = arguments[0], s = arguments[1];
          return !!this.isEquivalentClass(n) && b(g(t.prototype), "equalsExact", this).call(this, n, s);
        }
        return b(g(t.prototype), "equalsExact", this).apply(this, arguments);
      } }, { key: "getCoordinate", value: function() {
        ...
        return b(g(t.prototype), "getCoordinate", this).apply(this, arguments);
      } }, { key: "getBoundaryDimension", value: function() {
        return V.FALSE;
      } }, { key: "getTypeCode", value: function() {
      ...
      return l(t, [{ key: "copyInternal", value: function() {
        ...
        return !!this.isEmpty() || b(g(t.prototype), "isClosed", this).call(this);
      } }, { key: "reverseInternal", value: function() {
        var n = this._points.copy();
        ...
        if (!this.isEmpty() && !b(g(t.prototype), "isClosed", this).call(this)) throw new O("Points of LinearRing do not form a closed linestring");
    ...
    var Sn = function(o) {
      ...
      return l(t, [{ key: "getM", value: function() {
        ...
        if (this._m = null, arguments.length === 0) C.constructor_.call(this), this._m = 0;
          ...
          C.constructor_.call(this, c, h, C.NULL_ORDINATE), this._m = y;
        }
      } }]), t;
    }(C);
    ...
    var us = function(o) {
      ...
      return l(t, [{ key: "getM", value: function() {
        ...
        if (this._m = null, arguments.length === 0) C.constructor_.call(this), this._m = 0;
          ...
          var c = arguments[0], h = arguments[1], y = arguments[2], d = arguments[3];
          C.constructor_.call(this, c, h, y), this._m = d;
        }
      } }]), t;
    }(C), Jr = function() {
      function o() {
      ...
      return l(t, [{ key: "getCoordinate", value: function(n) {
        ...
        return b(g(t.prototype), "addAll", this).apply(this, arguments);
      } }, { key: "clone", value: function() {
        for (var n = b(g(t.prototype), "clone", this).call(this), s = 0; s < this.size(); s++) n.add(s, this.get(s).clone());
        return n;
      } }, { key: "toCoordinateArray", value: function() {
        ...
        if (arguments.length === 1) {
          var n = arguments[0];
          return b(g(t.prototype), "add", this).call(this, n);
        }
        if (arguments.length === 2) {
          ...
          if (arguments[0] instanceof C && typeof arguments[1] == "boolean") {
            ...
            b(g(t.prototype), "add", this).call(this, h);
          ...
          if (typeof arguments[2] == "boolean" && Number.isInteger(arguments[0]) && arguments[1] instanceof C) {
            ...
            b(g(t.prototype), "add", this).call(this, re, ce);
          }
        } else if (arguments.length === 4) {
    ...
    var qe = function() {
      ...
      return l(o, null, [{ key: "isRing", value: function(e) {
        ...
        if (arguments.length === 5) for (var s = arguments[0], c = arguments[1], h = arguments[2], y = arguments[3], d = arguments[4], E = 0; E < d; E++) h[y + E] = s[c + E].copy();
      ...
      return l(o, [{ key: "compare", value: function(e, t) {
        ...
        if (n.length > s.length) return 1;
        if (n.length === 0) return 0;
        for (var c = qe.increasingDirection(n), h = qe.increasingDirection(s), y = c > 0 ? 0 : n.length - 1, d = h > 0 ? 0 : n.length - 1, E = 0; E < n.length; E++) {
          var w = n[y].compareTo(s[d]);
          if (w !== 0) return w;
          y += c, d += h;
        }
        return 0;
    ...
    var $r = function() {
      ...
      return l(o, [{ key: "getM", value: function(e) {
        ...
        return Jr.create(this.getDimension(), this.getMeasures());
      } }, { key: "getDimension", value: function() {
        ...
        if (this._coordinates.length > 0) {
          var e = new $r(17 * this._coordinates.length);
        ...
        if (this._dimension = 3, this._measures = 0, this._coordinates = null, arguments.length === 1) {
          ...
          if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            ...
            for (var w = 0; w < d; w++) this._coordinates[w] = Jr.create(E);
          }
        } else if (arguments.length === 3) {
      ...
      return l(o, [{ key: "readResolve", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          if (arguments.length === 3) {
            var c = arguments[0], h = arguments[1], y = arguments[2], d = h - y;
            return y > 1 && (y = 1), d > 3 && (d = 3), d < 2 && (d = 2), new kr(c, d + y, y);
          }
        }
      } }, { key: "interfaces_", get: function() {
        return [Qr, D];
    ...
    }(), hs = "XY", zf = "XYZ", Uf = "XYM", Yf = "XYZM", eo = { POINT: "Point", LINE_STRING: "LineString", LINEAR_RING: "LinearRing", POLYGON: "Polygon", MULTI_POINT: "MultiPoint", MULTI_LINE_STRING: "MultiLineString", MULTI_POLYGON: "MultiPolygon", GEOMETRY_COLLECTION: "GeometryCollection", CIRCLE: "Circle" }, to = "EMPTY", ei = 1, Xt = 2, tn = 3, no = 4, Un = 5, Wf = 6;
...
`;
        ...
        else if (this.isAlpha_(t)) e = ei, s = this.readText_();
        else {
      ...
      return l(o, [{ key: "consume_", value: function() {
        ...
        var e = this.isTokenType(ei) && this.token_.value == to;
        ...
        if (this.match(ei)) {
          ...
          switch (c) {
            case "POINT":
              ...
              return y ? e.createPoint(_(C, R(y))) : e.createPoint();
            case "LINESTRING":
    ...
    var Zf = function() {
      ...
      return l(o, [{ key: "getIndexAlongSegment", value: function(e, t) {
        ...
        if (e.equals(t)) h = 0;
          ...
          var y = Math.abs(e.x - t.x), d = Math.abs(e.y - t.y);
          (h = s > c ? y : d) !== 0 || e.equals(t) || (h = Math.max(y, d));
        }
    ...
    var In = function(o) {
      ...
      return l(t, [{ key: "isInSegmentEnvelopes", value: function(n) {
        ...
        if (arguments.length !== 3) return b(g(t.prototype), "computeIntersection", this).apply(this, arguments);
        var n = arguments[0], s = arguments[1], c = arguments[2];
      ...
      return l(o, [{ key: "countSegment", value: function(e, t) {
        ...
        if (arguments[0] instanceof C && arguments[1] instanceof Array) {
          for (var y = arguments[0], d = arguments[1], E = new o(y), w = 1; w < d.length; w++) {
            var N = d[w], B = d[w - 1];
      ...
      return l(o, null, [{ key: "isOnLine", value: function() {
        if (arguments[0] instanceof C && ue(arguments[1], ge)) {
          for (var e = arguments[0], t = arguments[1], n = new In(), s = new C(), c = new C(), h = t.size(), y = 1; y < h; y++) if (t.getCoordinate(y - 1, s), t.getCoordinate(y, c), n.computeIntersection(e, s, c), n.hasIntersection()) return !0;
          return !1;
        }
        if (arguments[0] instanceof C && arguments[1] instanceof Array) {
      ...
      return l(o, [{ key: "getGeometryCount", value: function() {
        ...
        if (this.elt = new Array(2).fill(null), arguments.length === 1) {
          ...
          var n = arguments[0], s = arguments[1];
          this.elt[0] = new dt(I.NONE), this.elt[1] = new dt(I.NONE), this.elt[n].setLocation(s);
        } else if (arguments.length === 3) {
          var c = arguments[0], h = arguments[1], y = arguments[2];
          this.elt[0] = new dt(c, h, y), this.elt[1] = new dt(c, h, y);
        } else if (arguments.length === 4) {
          var d = arguments[0], E = arguments[1], w = arguments[2], N = arguments[3];
          this.elt[0] = new dt(I.NONE, I.NONE, I.NONE), this.elt[1] = new dt(I.NONE, I.NONE, I.NONE), this.elt[d].setLocations(E, w, N);
        }
      ...
      return l(o, [{ key: "computeRing", value: function() {
        ...
        if (t) {
          ...
          var y = s.length - 2;
          n && (y = s.length - 1);
          for (var d = y; d >= 0; d--) this._pts.add(s[d]);
        }
        ...
        if (this._startDe = null, this._maxNodeDegree = -1, this._edges = new ne(), this._pts = new ne(), this._label = new mt(I.NONE), this._ring = null, this._isHole = null, this._shell = null, this._holes = new ne(), this._geometryFactory = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var e = arguments[0], t = arguments[1];
      ...
      return l(t, [{ key: "isIncidentEdgeInResult", value: function() {
        ...
        if (arguments.length !== 2 || !Number.isInteger(arguments[1]) || !Number.isInteger(arguments[0])) return b(g(t.prototype), "setLabel", this).apply(this, arguments);
        var n = arguments[0], s = arguments[1];
        ...
        if (arguments[0] instanceof t) {
          ...
          y === I.NONE && this._label.setLocation(c, h);
        }
      } }, { key: "add", value: function(n) {
    ...
    var co = function() {
      ...
      return l(t, [{ key: "getNextMin", value: function() {
        ...
        b(g(t.prototype), "print", this).call(this, n), n.print(" " + this._depth[W.LEFT] + "/" + this._depth[W.RIGHT]), n.print(" (" + this.getDepthDelta() + ")"), this._isInResult && n.print(" inResult");
        ...
        var h = 1;
        n === W.LEFT && (h = -1);
        var y = W.opposite(n), d = s + c * h;
        this.setDepth(n, s), this.setDepth(y, d);
      ...
      return l(o, [{ key: "sortShellsAndHoles", value: function(e, t, n) {
        ...
        for (var s = new ne(), c = e.iterator(); c.hasNext(); ) {
          ...
          if (h.getMaxNodeDegree() > 2) {
            ...
            var y = h.buildMinimalRings(), d = this.findShell(y);
            d !== null ? (this.placePolygonHoles(d, y), t.add(d)) : n.addAll(y);
          } else s.add(h);
        }
        return s;
        ...
        for (var n = e.getLinearRing(), s = n.getEnvelopeInternal(), c = n.getCoordinateN(0), h = null, y = null, d = t.iterator(); d.hasNext(); ) {
      ...
      return l(o, null, [{ key: "maxDistance", value: function(e, t, n, s, c, h, y, d) {
        var E = o.distance(e, t, c, h);
        return E = Math.max(E, o.distance(e, t, y, d)), E = Math.max(E, o.distance(n, s, c, h)), E = Math.max(E, o.distance(n, s, y, d));
        ...
        var n = e.getMinX(), s = e.getMinY(), c = e.getMaxX(), h = e.getMaxY(), y = t.getMinX(), d = t.getMinY(), E = t.getMaxX(), w = t.getMaxY(), N = o.maxDistance(n, s, n, h, y, d, y, w);
        return N = Math.min(N, o.maxDistance(n, s, n, h, y, d, E, d)), N = Math.min(N, o.maxDistance(n, s, n, h, E, w, y, w)), N = Math.min(N, o.maxDistance(n, s, n, h, E, w, E, d)), N = Math.min(N, o.maxDistance(n, s, c, s, y, d, y, w)), N = Math.min(N, o.maxDistance(n, s, c, s, y, d, E, d)), N = Math.min(N, o.maxDistance(n, s, c, s, E, w, y, w)), N = Math.min(N, o.maxDistance(n, s, c, s, E, w, E, d)), N = Math.min(N, o.maxDistance(c, h, n, h, y, d, y, w)), N = Math.min(N, o.maxDistance(c, h, n, h, y, d, E, d)), N = Math.min(N, o.maxDistance(c, h, n, h, E, w, y, w)), N = Math.min(N, o.maxDistance(c, h, n, h, E, w, E, d)), N = Math.min(N, o.maxDistance(c, h, c, s, y, d, y, w)), N = Math.min(N, o.maxDistance(c, h, c, s, y, d, E, d)), N = Math.min(N, o.maxDistance(c, h, c, s, E, w, y, w)), N = Math.min(N, o.maxDistance(c, h, c, s, E, w, E, d));
      } }]), o;
    }(), Wn = function() {
      function o() {
        i(this, o), o.constructor_.apply(this, arguments);
      ...
      return l(o, [{ key: "maximumDistance", value: function() {
        ...
        for (var h = e.getChildBoundables().iterator(); h.hasNext(); ) {
          var y = h.next(), d = null;
          (d = n ? new o(t, y, this._itemDistance) : new o(y, t, this._itemDistance)).getDistance() < c && s.add(d);
        }
      ...
      return l(o, [{ key: "queryInternal", value: function() {
        ...
        else if (ue(arguments[2], nt) && arguments[0] instanceof Object && arguments[1] instanceof pt) for (var y = arguments[0], d = arguments[1], E = arguments[2], w = d.getChildBoundables(), N = 0; N < w.size(); N++) {
          var B = w.get(N);
          this.getIntersectsOp().intersects(B.getBounds(), y) && (B instanceof pt ? this.queryInternal(y, B, E) : B instanceof jt ? E.add(B.getItem()) : fe.shouldNeverReachHere());
        }
        ...
        if (arguments.length === 3) {
          ...
          for (var h = s.getChildBoundables().iterator(); h.hasNext(); ) {
            var y = h.next();
            y instanceof pt ? this.boundablesAtLevel(n, y, c) : (fe.isTrue(y instanceof jt), n === -1 && c.add(y));
          }
          return null;
        }
      } }, { key: "query", value: function() {
        ...
        if (arguments.length === 3) {
          ...
          if (h) return !0;
          for (var y = null, d = s.getChildBoundables().iterator(); d.hasNext(); ) {
            var E = d.next();
    ...
    var rh = function() {
      ...
      return l(t, [{ key: "createParentBoundablesFromVerticalSlices", value: function(n, s) {
        ...
        if (arguments.length === 3) {
          var c = arguments[0], h = arguments[1], y = arguments[2], d = h, E = new ri();
          E.add(c);
          for (var w = new ri(); !E.isEmpty() && d >= 0; ) {
        ...
        return arguments.length === 0 ? b(g(t.prototype), "size", this).call(this) : b(g(t.prototype), "size", this).apply(this, arguments);
      } }, { key: "insert", value: function() {
        if (!(arguments.length === 2 && arguments[1] instanceof Object && arguments[0] instanceof xe)) return b(g(t.prototype), "insert", this).apply(this, arguments);
        var n = arguments[0], s = arguments[1];
        if (n.isNull()) return null;
        b(g(t.prototype), "insert", this).call(this, n, s);
      } }, { key: "getIntersectsOp", value: function() {
        return t.intersectsOp;
      } }, { key: "verticalSlices", value: function(n, s) {
        for (var c = Math.trunc(Math.ceil(n.size() / s)), h = new Array(s).fill(null), y = n.iterator(), d = 0; d < s; d++) {
          h[d] = new ne();
        ...
        if (arguments.length === 1) {
          var n = arguments[0];
          return b(g(t.prototype), "query", this).call(this, n);
        }
        if (arguments.length === 2) {
          var s = arguments[0], c = arguments[1];
          b(g(t.prototype), "query", this).call(this, s, c);
        }
      } }, { key: "getComparator", value: function() {
        return t.yComparator;
      } }, { key: "createParentBoundablesFromVerticalSlice", value: function(n, s) {
        return b(g(t.prototype), "createParentBoundables", this).call(this, n, s);
      } }, { key: "remove", value: function() {
        if (arguments.length === 2 && arguments[1] instanceof Object && arguments[0] instanceof xe) {
          var n = arguments[0], s = arguments[1];
          return b(g(t.prototype), "remove", this).call(this, n, s);
        }
        return b(g(t.prototype), "remove", this).apply(this, arguments);
      } }, { key: "depth", value: function() {
        return arguments.length === 0 ? b(g(t.prototype), "depth", this).call(this) : b(g(t.prototype), "depth", this).apply(this, arguments);
        ...
        if (arguments.length === 1) {
          ...
          if (arguments[0] instanceof Wn) {
            var c = arguments[0], h = K.POSITIVE_INFINITY, y = null, d = new ri();
            for (d.add(c); !d.isEmpty() && h > 0; ) {
              var E = d.poll(), w = E.getDistance();
              if (w >= h) break;
              E.isLeaves() ? (h = w, y = E) : E.expandToQueue(d, h);
            }
        ...
        if (arguments.length === 2) {
          var n = arguments[0], s = arguments[1], c = K.POSITIVE_INFINITY, h = new ri();
          for (h.add(n); !h.isEmpty(); ) {
            var y = h.poll(), d = y.getDistance();
            if (d > s) return !1;
    ...
    var ih = function() {
      ...
      return l(o, [{ key: "getSplitCoordinates", value: function() {
        ...
        h[y++] = new C(e.coord);
        for (var d = e.segmentIndex + 1; d <= t.segmentIndex; d++) h[y++] = this._edge.getCoordinate(d);
        return c && (h[y] = new C(t.coord)), h;
      } }, { key: "print", value: function(e) {
      ...
      return l(o, null, [{ key: "octant", value: function() {
        ...
        if (arguments[0] instanceof C && arguments[1] instanceof C) {
          var c = arguments[0], h = arguments[1], y = h.x - c.x, d = h.y - c.y;
          if (y === 0 && d === 0) throw new O("Cannot compute the octant for two identical points " + c);
          return o.octant(y, d);
        }
      } }]), o;
    }(), lh = function() {
      ...
      return l(o, [{ key: "minX", value: function() {
        ...
        if (arguments[0] instanceof o) {
          ...
          return h < 0 && (d = this.p0), h > 1 && (d = this.p1), new o(y, d);
        }
      } }, { key: "normalize", value: function() {
        ...
        var n = this.p0.x + e * (this.p1.x - this.p0.x), s = this.p0.y + e * (this.p1.y - this.p0.y), c = this.p1.x - this.p0.x, h = this.p1.y - this.p0.y, y = Math.sqrt(c * c + h * h), d = 0, E = 0;
        if (t !== 0) {
        ...
        var t = this.p1.getY() - this.p0.getY(), n = this.p0.getX() - this.p1.getX(), s = this.p0.getY() * (this.p1.getX() - this.p0.getX()) - this.p0.getX() * (this.p1.getY() - this.p0.getY()), c = t * t + n * n, h = t * t - n * n, y = e.getX(), d = e.getY();
        return new C((-h * y - 2 * t * n * d - 2 * t * s) / c, (h * d - 2 * t * n * y - 2 * n * s) / c);
      } }, { key: "distance", value: function() {
        if (arguments[0] instanceof o) {
          var e = arguments[0];
        ...
        if (this.p0 = null, this.p1 = null, arguments.length === 0) o.constructor_.call(this, new C(), new C());
          ...
          var s = arguments[0], c = arguments[1], h = arguments[2], y = arguments[3];
          o.constructor_.call(this, new C(s, c), new C(h, y));
        }
      ...
      return l(o, [{ key: "getLineSegment", value: function(e, t) {
        ...
        if (arguments.length === 2) {
          ...
          var n = arguments[0], s = arguments[1], c = arguments[2], h = arguments[3], y = arguments[4], d = arguments[5];
          if (s - n == 1 && y - h == 1) return d.overlap(this, n, c, h), null;
          if (!this.overlaps(n, s, c, h, y)) return null;
          var E = Math.trunc((n + s) / 2), w = Math.trunc((h + y) / 2);
          n < E && (h < w && this.computeOverlaps(n, E, c, h, w, d), w < y && this.computeOverlaps(n, E, c, w, y, d)), E < s && (h < w && this.computeOverlaps(E, s, c, h, w, d), w < y && this.computeOverlaps(E, s, c, w, y, d));
        }
      ...
      return l(o, null, [{ key: "findChainEnd", value: function(e, t) {
        ...
        if (arguments.length === 2) {
          ...
          do {
            var h = o.findChainEnd(t, c), y = new mo(t, c, h, n);
            s.add(y), c = h;
          } while (c < t.length - 1);
          return s;
        }
      ...
      return l(t, [{ key: "overlap", value: function() {
        if (arguments.length !== 4) return b(g(t.prototype), "overlap", this).apply(this, arguments);
        var n = arguments[0], s = arguments[1], c = arguments[2], h = arguments[3], y = n.getContext(), d = c.getContext();
        this._si.processIntersections(y, s, d, h);
      } }], [{ key: "constructor_", value: function() {
        this._si = null;
        var n = arguments[0];
        this._si = n;
    ...
    var Ir = function() {
      ...
      return l(o, [{ key: "addNextSegment", value: function(e, t) {
        ...
        var h = t.x - e.x, y = t.y - e.y, d = Math.atan2(y, h);
        ...
        var h = t.x - e.x, y = t.y - e.y, d = Math.atan2(y, h), E = n.x - e.x, w = n.y - e.y, N = Math.atan2(w, E);
        ...
        var c = this._seg0.p1, h = lt.angle(c, this._seg0.p0), y = lt.angleBetweenOriented(this._seg0.p0, c, this._seg1.p1) / 2, d = lt.normalize(h + y), E = lt.normalize(d + Math.PI), w = s * n, N = n - w * Math.abs(Math.sin(y)), B = c.x + w * Math.cos(E), j = c.y + w * Math.sin(E), X = new C(B, j), $ = new ut(c, X), re = $.pointAlongOffset(1, N), ce = $.pointAlongOffset(1, -N);
        ...
        var h = s === se.CLOCKWISE ? -1 : 1, y = Math.abs(t - n), d = Math.trunc(y / this._filletAngleQuantum + 0.5);
        if (d < 1) return null;
        for (var E = y / d, w = new C(), N = 0; N < d; N++) {
          var B = t + h * N * E;
          w.x = e.x + c * Math.cos(B), w.y = e.y + c * Math.sin(B), this._segList.addPt(w);
        }
      } }, { key: "computeOffsetSegment", value: function(e, t, n, s) {
        var c = t === W.LEFT ? 1 : -1, h = e.p1.x - e.p0.x, y = e.p1.y - e.p0.y, d = Math.sqrt(h * h + y * y), E = c * n * h / d, w = c * n * y / d;
    ...
    var gh = function() {
      ...
      return l(o, [{ key: "getOffsetCurve", value: function(e, t) {
        ...
        var y = Nt.simplify(e, -n), d = y.length - 1;
        t.initSideSegments(y[d], y[d - 1], W.LEFT);
        for (var E = d - 2; E >= 0; E--) t.addNextSegment(y[E], !0);
      ...
      return l(o, [{ key: "findStabbedSegments", value: function() {
        ...
        if (arguments.length === 3) {
          if (ue(arguments[2], nt) && arguments[0] instanceof C && arguments[1] instanceof ds) for (var h = arguments[0], y = arguments[1], d = arguments[2], E = y.getEdge().getCoordinates(), w = 0; w < E.length - 1; w++) {
    ...
    var So = function(o) {
      ...
      return l(o, [{ key: "getY", value: function() {
        var e = this.y / this.w;
        if (K.isNaN(e) || K.isInfinite(e)) throw new So();
        return e;
      } }, { key: "getX", value: function() {
        var e = this.x / this.w;
        if (K.isNaN(e) || K.isInfinite(e)) throw new So();
      ...
      return l(o, [{ key: "area", value: function() {
        ...
        var c = t.x, h = t.y, y = n.x - c, d = s.x - c, E = n.y - h, w = s.y - h, N = y * w - d * E, B = e.x - c, j = e.y - h, X = (w * B - d * j) / N, $ = (-E * B + y * j) / N;
        ...
        var s = te.valueOf(e.x).subtract(n.x), c = te.valueOf(e.y).subtract(n.y), h = te.valueOf(t.x).subtract(n.x), y = te.valueOf(t.y).subtract(n.y), d = te.determinant(s, c, h, y).multiply(2), E = s.sqr().add(c.sqr()), w = h.sqr().add(y.sqr()), N = te.determinant(c, E, y, w), B = te.determinant(s, E, h, w), j = te.valueOf(n.x).subtract(N.divide(d)).doubleValue(), X = te.valueOf(n.y).add(B.divide(d)).doubleValue();
        return new C(j, X);
      } }, { key: "isAcute", value: function(e, t, n) {
        ...
        var s = t.x - e.x, c = t.y - e.y, h = t.getZ() - e.getZ(), y = n.x - e.x, d = n.y - e.y, E = n.getZ() - e.getZ(), w = c * E - h * d, N = h * y - s * E, B = s * d - c * y, j = w * w + N * N + B * B, X = Math.sqrt(j) / 2;
        return X;
      ...
      return l(o, [{ key: "addRingSide", value: function(e, t, n, s, c) {
        ...
        var h = s, y = c;
        e.length >= _r.MINIMUM_VALID_SIZE && se.isCCW(e) && (h = c, y = s, n = W.opposite(n));
        ...
        for (var h = 0; h < e.getNumInteriorRing(); h++) {
          var y = e.getInteriorRingN(h), d = qe.removeRepeatedPoints(y.getCoordinates());
        ...
        var s = new bn(e, new mt(0, I.BOUNDARY, t, n));
      ...
      return l(o, [{ key: "locate", value: function(e) {
        ...
        for (var c = 0; c < t.getNumInteriorRing(); c++) {
          ...
          if (y === I.BOUNDARY) return I.BOUNDARY;
          if (y === I.INTERIOR) return I.EXTERIOR;
        }
        return I.INTERIOR;
      ...
      return l(o, [{ key: "getNextCW", value: function(e) {
        ...
        for (var c = t, h = this.iterator(); h.hasNext(); ) {
          ...
          if (d.getLocation(e, W.ON) === I.NONE && d.setLocation(e, W.ON, c), d.isArea(e)) {
            ...
            if (w !== I.NONE) {
              ...
              E === I.NONE && fe.shouldNeverReachHere("found single null side (at " + y.getCoordinate() + ")"), c = E;
        ...
        for (var c = s, h = this.iterator(); h.hasNext(); ) {
          ...
          var d = y.getLocation(e, W.LEFT), E = y.getLocation(e, W.RIGHT);
          if (d === E || E !== c) return !1;
          c = d;
        }
        return !0;
        ...
        return this._ptInAreaLocation[e] === I.NONE && (this._ptInAreaLocation[e] = ph.locate(t, n[e].getGeometry())), this._ptInAreaLocation[e];
      } }, { key: "toString", value: function() {
        var e = new _n();
...
`);
        ...
        for (var h = this.iterator(); h.hasNext(); ) for (var y = h.next(), d = y.getLabel(), E = 0; E < 2; E++) if (d.isAnyNull(E)) {
          var w = I.NONE;
          if (t[E]) w = I.EXTERIOR;
          else {
      ...
      return l(t, [{ key: "linkResultDirectedEdges", value: function() {
        ...
        for (var n = null, s = null, c = this._SCANNING_FOR_INCOMING, h = 0; h < this._resultAreaEdgeList.size(); h++) {
          var y = this._resultAreaEdgeList.get(h), d = y.getSym();
        ...
        var c = n.get(0);
        if (s === 1) return c;
        var h = n.get(s - 1), y = c.getQuadrant(), d = h.getQuadrant();
        return Je.isNorthern(y) && Je.isNorthern(d) ? c : Je.isNorthern(y) || Je.isNorthern(d) ? c.getDy() !== 0 ? c : h.getDy() !== 0 ? h : (fe.shouldNeverReachHere("found two horizontal edges incident on node"), null) : h;
      } }, { key: "print", value: function(n) {
        ...
        if (arguments.length === 1) {
          var n = arguments[0], s = this.findIndex(n), c = n.getDepth(W.LEFT), h = n.getDepth(W.RIGHT), y = this.computeDepths(s + 1, this._edgeList.size(), c), d = this.computeDepths(0, s, y);
        ...
        for (var s = null, c = null, h = this._SCANNING_FOR_INCOMING, y = this._resultAreaEdgeList.size() - 1; y >= 0; y--) {
          var d = this._resultAreaEdgeList.get(y), E = d.getSym();
        ...
        if (arguments.length === 1) {
          for (var h = arguments[0], y = 0, d = this.iterator(); d.hasNext(); ) {
            var E = d.next();
            E.getEdgeRing() === h && y++;
          }
          return y;
        ...
        for (var y = n, d = this.iterator(); d.hasNext(); ) {
          var E = d.next(), w = E.getSym();
          E.isLineEdge() ? E.getEdge().setCovered(y === I.INTERIOR) : (E.isInResult() && (y = I.EXTERIOR), w.isInResult() && (y = I.INTERIOR));
        }
      } }, { key: "computeLabelling", value: function(n) {
        b(g(t.prototype), "computeLabelling", this).call(this, n), this._label = new mt(I.NONE);
        for (var s = this.iterator(); s.hasNext(); ) for (var c = s.next().getEdge().getLabel(), h = 0; h < 2; h++) {
          var y = c.getLocation(h);
          y !== I.INTERIOR && y !== I.BOUNDARY || this._label.setLocation(h, I.INTERIOR);
        }
      } }], [{ key: "constructor_", value: function() {
      ...
      return l(o, [{ key: "compareTo", value: function(e) {
        ...
        for (var c = t ? 1 : -1, h = s ? 1 : -1, y = t ? e.length : -1, d = s ? n.length : -1, E = t ? 0 : e.length - 1, w = s ? 0 : n.length - 1; ; ) {
      ...
      return l(o, [{ key: "print", value: function(e) {
        ...
        var h = new Array(n).fill(null), y = 0;
        h[y++] = new C(e.coord);
        for (var d = e.segmentIndex + 1; d <= t.segmentIndex; d++) h[y++] = this.edge.pts[d];
      ...
      return l(o, [{ key: "isIntersects", value: function() {
        ...
        for (var e = new $r("123456789"), t = 0; t < 3; t++) for (var n = 0; n < 3; n++) e.setCharAt(3 * t + n, V.toDimensionSymbol(this._matrix[t][n]));
        return e.toString();
      ...
      return l(o, [{ key: "getCoordinates", value: function() {
        ...
        if (arguments.length === 4) {
          ...
          var c = arguments[0], h = arguments[1], y = arguments[2], d = arguments[3], E = arguments[4], w = arguments[5];
          if (h - c == 1 && E - d == 1) return w.addIntersections(this.e, c, y.e, d), null;
          if (!this.overlaps(c, h, y, d, E)) return null;
          var N = Math.trunc((c + h) / 2), B = Math.trunc((d + E) / 2);
          c < N && (d < B && this.computeIntersectsForChain(c, N, y, d, B, w), B < E && this.computeIntersectsForChain(c, N, y, B, E, w)), N < h && (d < B && this.computeIntersectsForChain(N, h, y, d, B, w), B < E && this.computeIntersectsForChain(N, h, y, B, E, w));
        }
      } }, { key: "overlaps", value: function(e, t, n, s, c) {
    ...
    var No = function(o) {
      ...
      return l(t, [{ key: "getDepth", value: function() {
        ...
        for (var c = !0, h = !0, y = this.pts.length, d = 0; d < this.pts.length; d++) if (this.pts[d].equals2D(s.pts[d]) || (c = !1), this.pts[d].equals2D(s.pts[--y]) || (h = !1), !c && !h) return !1;
        return !0;
      } }, { key: "getCoordinate", value: function() {
        ...
        var y = new C(n.getIntersection(h)), d = s, E = n.getEdgeDistance(c, h), w = d + 1;
        if (w < this.pts.length) {
          var N = this.pts[w];
          y.equals2D(N) && (d = w, E = 0);
        }
        this.eiList.add(y, d, E);
      } }, { key: "toString", value: function() {
        var n = new $r();
        ...
        if (!(arguments.length === 2 && arguments[1] instanceof wh && arguments[0] instanceof mt)) return b(g(t), "updateIM", this).apply(this, arguments);
        var n = arguments[0], s = arguments[1];
      ...
      return l(o, [{ key: "setWorkingPrecisionModel", value: function(e) {
        ...
        for (var n = new ne(), s = e.iterator(); s.hasNext(); ) {
          var c = s.next(), h = c.getRightmostCoordinate(), y = new ko(n).getDepth(h);
        ...
        for (var s = n.getNodedSubstrings().iterator(); s.hasNext(); ) {
          ...
          if (h.length !== 2 || !h[0].equals2D(h[1])) {
            var y = c.getData(), d = new No(c.getCoordinates(), new mt(y));
      ...
      return l(o, [{ key: "rescale", value: function() {
        ...
        if (arguments[0] instanceof Array) {
          for (var c = arguments[0], h = new Array(c.length).fill(null), y = 0; y < c.length; y++) h[y] = new C(Math.round((c[y].x - this._offsetX) * this._scaleFactor), Math.round((c[y].y - this._offsetY) * this._scaleFactor), c[y].getZ());
      ...
      return l(o, [{ key: "checkEndPtVertexIntersections", value: function() {
        if (arguments.length === 0) for (var e = this._segStrings.iterator(); e.hasNext(); ) {
          ...
          for (var s = arguments[0], c = arguments[1], h = c.iterator(); h.hasNext(); ) for (var y = h.next(), d = y.getCoordinates(), E = 1; E < d.length - 1; E++) if (d[E].equals(s)) throw new we("found endpt/interior pt intersection at index " + E + " :pt " + s);
        }
        ...
        else if (arguments.length === 2) for (var c = arguments[0], h = arguments[1], y = c.getCoordinates(), d = h.getCoordinates(), E = 0; E < y.length - 1; E++) for (var w = 0; w < d.length - 1; w++) this.checkInteriorIntersections(c, E, h, w);
        else if (arguments.length === 4) {
    ...
    var Es = function() {
      ...
      return l(o, [{ key: "intersectsScaled", value: function(e, t) {
        ...
        return fe.isTrue(!(y && d), "Found bad envelope test"), d;
    ...
    var Oh = function() {
      ...
      return l(t, [{ key: "isNodeAdded", value: function() {
        ...
        if (!(arguments.length === 2 && Number.isInteger(arguments[1]) && arguments[0] instanceof mo)) return b(g(t.prototype), "select", this).apply(this, arguments);
    ...
    var Rh = function() {
      ...
      return l(o, [{ key: "processIntersections", value: function(e, t, n, s) {
        if (e === n && t === s) return null;
        var c = e.getCoordinates()[t], h = e.getCoordinates()[t + 1], y = n.getCoordinates()[s], d = n.getCoordinates()[s + 1];
        if (this._li.computeIntersection(c, h, y, d), this._li.hasIntersection() && this._li.isInteriorIntersection()) {
      ...
      return l(o, [{ key: "bufferFixedPrecision", value: function(e) {
        ...
        if (arguments.length === 3) {
          if (Number.isInteger(arguments[2]) && arguments[0] instanceof J && typeof arguments[1] == "number") {
            var c = arguments[0], h = arguments[1], y = arguments[2], d = new o(c);
            d.setQuadrantSegments(y);
    ...
    var Ph = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], Ro = function() {
      ...
      for (var e = _t.coordinates.call(this, o[0]), t = this.geometryFactory.createLinearRing(e), n = [], s = 1; s < o.length; ++s) {
        var c = o[s], h = _t.coordinates.call(this, c), y = this.geometryFactory.createLinearRing(h);
        n.push(y);
      }
...
ji.prototype = {
  ...
  add: function(a) {
    Dl(li, a, this.t), Dl(this, li.s, this.s), this.s ? this.t += li.t : this.s = li.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var Bl = {
  ...
  FeatureCollection: function(a, r) {
    for (var i = a.features, u = -1, l = i.length; ++u < l; ) Vi(i[u].geometry, r);
  }
}, Gl = {
  Sphere: function(a, r) {
    r.sphere();
  ...
  GeometryCollection: function(a, r) {
    for (var i = a.geometries, u = -1, l = i.length; ++u < l; ) Vi(i[u], r);
  }
};
function Ia(a, r, i) {
...
function V0(a, r) {
  a && Bl.hasOwnProperty(a.type) ? Bl[a.type](a, r) : Vi(a, r);
}
mn();
mn();
function ba(a) {
...
function Yl(a, r) {
  ...
  return g.invert = function(v, m) {
    var _ = Ae(m), k = Ae(v) * _, p = De(v) * _, x = De(m), S = x * l - p * f;
    return [
      ar(p * l + x * f, k * i + S * u),
      On(S * i - k * u)
    ];
...
function Z0(a, r, i, u, l, f) {
  if (i) {
    ...
    l == null ? (l = r + u * zt, f = r - m / 2) : (l = Wl(g, l), f = Wl(g, f), (u > 0 ? l < f : l > f) && (l += u * zt));
...
function Q0(a, r, i, u, l, f) {
  var g = a[0], v = a[1], m = r[0], _ = r[1], k = 0, p = 1, x = m - g, S = _ - v, b;
  if (b = i - g, !(!x && b > 0)) {
    if (b /= x, x < 0) {
      if (b < k) return;
      b < p && (p = b);
    ...
    if (b = l - g, !(!x && b < 0)) {
      ...
      if (b = u - v, !(!S && b > 0)) {
        ...
        if (b = f - v, !(!S && b < 0)) {
          ...
          return k > 0 && (a[0] = g + k * x, a[1] = v + k * S), p < 1 && (r[0] = g + p * x, r[1] = v + p * S), !0;
        }
      }
    }
  }
...
function bf(a, r, i, u, l) {
  ...
  if (a.forEach(function(b) {
    if (!((R = b.length - 1) <= 0)) {
      var R, L = b[0], T = b[R], M;
      if (Ni(L, T)) {
        for (l.lineStart(), v = 0; v < R; ++v) l.point((L = b[v])[0], L[1]);
        l.lineEnd();
        return;
      }
    ...
    for (g.sort(r), Xl(f), Xl(g), v = 0, m = g.length; v < m; ++v)
      g[v].e = i = !i;
    for (var _ = f[0], k, p; ; ) {
      ...
      do {
        if (x.v = x.o.v = !0, x.e) {
          if (S)
            for (v = 0, m = k.length; v < m; ++v) l.point((p = k[v])[0], p[1]);
          else
            u(x.x, x.n.x, 1, l);
          x = x.n;
        } else {
          if (S)
            for (k = x.p.z, v = k.length - 1; v >= 0; --v) l.point((p = k[v])[0], p[1]);
          else
            u(x.x, x.p.x, -1, l);
          x = x.p;
        }
...
function $0(a, r, i, u) {
  ...
  function f(_, k, p, x) {
    var S = 0, b = 0;
    if (_ == null || (S = g(_, p)) !== (b = g(k, p)) || m(_, k) < 0 ^ p > 0)
      do
  ...
  return function(_) {
    var k = _, p = If(), x, S, b, R, L, T, M, P, A, O, z, q = {
      point: U,
      lineStart: Z,
      lineEnd: ae,
      polygonStart: H,
    ...
    function D() {
      for (var Q = 0, ie = 0, de = S.length; ie < de; ++ie)
        for (var Me = S[ie], Se = 1, K = Me.length, Fe = Me[0], we, ze, fe = Fe[0], gt = Fe[1]; Se < K; ++Se)
          we = fe, ze = gt, Fe = Me[Se], fe = Fe[0], gt = Fe[1], ze <= u ? gt > u && (fe - we) * (u - ze) > (gt - ze) * (a - we) && ++Q : gt <= u && (fe - we) * (u - ze) < (gt - ze) * (a - we) && --Q;
      return Q;
    }
    function H() {
      k = p, x = [], S = [], z = !0;
    ...
    function ee() {
      var Q = D(), ie = z && Q, de = (x = Nf(x)).length;
      (ie || de) && (_.polygonStart(), ie && (_.lineStart(), f(null, null, 1, _), _.lineEnd()), de && bf(x, v, Q, f, _), _.polygonEnd()), k = _, x = S = b = null;
    }
    function Z() {
      q.point = F, S && S.push(b = []), O = !0, A = !1, M = P = NaN;
    }
    function ae() {
      x && (F(R, L), T && A && p.rejoin(), x.push(p.result())), q.point = U, A && k.lineEnd();
    }
    function F(Q, ie) {
      var de = l(Q, ie);
      if (S && b.push([Q, ie]), O)
        R = Q, L = ie, T = de, O = !1, de && (k.lineStart(), k.point(Q, ie));
      else if (de && A) k.point(Q, ie);
      else {
        var Me = [M = Math.max(gi, Math.min(Ar, M)), P = Math.max(gi, Math.min(Ar, P))], Se = [Q = Math.max(gi, Math.min(Ar, Q)), ie = Math.max(gi, Math.min(Ar, ie))];
        Q0(Me, Se, a, r, i, u) ? (A || (k.lineStart(), k.point(Me[0], Me[1])), k.point(Se[0], Se[1]), de || k.lineEnd(), z = !1) : de && (k.lineStart(), k.point(Q, ie), z = !1);
      }
      M = Q, P = ie, A = de;
    }
    return q;
...
function e_(a, r) {
  ...
  for (var v = 0, m = a.length; v < m; ++v)
    if (k = (_ = a[v]).length)
      for (var _, k, p = _[k - 1], x = p[0], S = p[1] / 2 + Fl, b = De(S), R = Ae(S), L = 0; L < k; ++L, x = M, b = A, R = O, p = T) {
        var T = _[L], M = T[0], P = T[1] / 2 + Fl, A = De(P), O = Ae(P), z = M - x, q = z >= 0 ? 1 : -1, U = q * z, D = U > me, H = b * A;
...
mn();
mn();
var ur = 1 / 0, Zi = ur, Xr = -ur, Qi = Xr, Vl = {
  point: t_,
  lineStart: Pr,
  lineEnd: Pr,
  polygonStart: Pr,
  ...
  result: function() {
    var a = [[ur, Zi], [Xr, Qi]];
    return Xr = Qi = -(Zi = ur = 1 / 0), a;
  }
};
function t_(a, r) {
  a < ur && (ur = a), a > Xr && (Xr = a), r < Zi && (Zi = r), r > Qi && (Qi = r);
}
mn();
function Lf(a, r, i, u) {
  return function(l, f) {
    var g = r(f), v = l.invert(u[0], u[1]), m = If(), _ = r(m), k = !1, p, x, S, b = {
      point: R,
      lineStart: T,
      lineEnd: M,
      ...
      polygonEnd: function() {
        b.point = R, b.lineStart = T, b.lineEnd = M, x = Nf(x);
        var z = e_(p, v);
...
function i_(a) {
  ...
  return {
    ...
    point: function(f, g) {
      var v = f > 0 ? me : -me, m = We(f - r);
      We(m - me) < be ? (a.point(r, i = (i + g) / 2 > 0 ? qt : -qt), a.point(u, i), a.lineEnd(), a.lineStart(), a.point(v, i), a.point(f, i), l = 0) : u !== v && m >= me && (We(r - u) < be && (r -= u * be), We(f - v) < be && (f -= v * be), i = s_(r, i, f, g), a.point(u, i), a.lineEnd(), a.lineStart(), a.point(v, i), l = 0), a.point(r = f, i = g), u = v;
    },
    lineEnd: function() {
      a.lineEnd(), r = i = NaN;
    },
...
function s_(a, r, i, u) {
  var l, f, g = De(a - i);
  return We(g) > be ? j0((De(r) * (f = Ae(u)) * De(i) - De(u) * (l = Ae(r)) * De(a)) / (l * f * g)) : (r + u) / 2;
}
function a_(a, r, i, u) {
  var l;
  if (a == null)
...
function o_(a, r) {
  ...
  function m(k, p, x) {
    ...
    if (!(Z < 0)) {
      var ae = gr(Z), F = fi(D, (-H - ae) / ee);
      if (Vs(F, q), F = ba(F), !x) return F;
      var Q = k[0], ie = p[0], de = k[1], Me = p[1], Se;
      ie < Q && (Se = Q, Q = ie, ie = Se);
      var K = ie - Q, Fe = We(K - me) < be, we = Fe || K < be;
      if (!Fe && Me < de && (Se = de, de = Me, Me = Se), we ? Fe ? de + Me > 0 ^ F[1] < (We(F[0] - Q) < be ? de : Me) : de <= F[1] && F[1] <= Me : K > me ^ (Q <= F[0] && F[0] <= ie)) {
        var ze = fi(D, (-H + ae) / ee);
...
function Cf(a, r, i) {
  ...
  var g = Vl.result(), v = Math.min(u / (g[1][0] - g[0][0]), l / (g[1][1] - g[0][1])), m = +r[0][0] + (u - v * (g[1][0] + g[0][0])) / 2, _ = +r[0][1] + (l - v * (g[1][1] + g[0][1])) / 2;
...
function f_(a, r) {
  function i(u, l, f, g, v, m, _, k, p, x, S, b, R, L) {
    var T = _ - u, M = k - l, P = T * T + M * M;
    if (P > 4 * r && R--) {
      var A = g + x, O = v + S, z = m + b, q = gr(A * A + O * O + z * z), U = On(z /= q), D = We(We(z) - 1) < be || We(f - p) < be ? (f + p) / 2 : ar(O, A), H = a(D, U), ee = H[0], Z = H[1], ae = ee - u, F = Z - l, Q = M * ae - T * F;
      (Q * Q / P > r || We((T * ae + M * F) / P - 0.5) > 0.3 || g * x + v * S + m * b < l_) && (i(u, l, f, g, v, m, ee, Z, D, A /= q, O /= q, z, R, L), L.point(ee, Z), i(ee, Z, D, A, O, z, _, k, p, x, S, b, R, L));
    }
  }
  return function(u) {
    var l, f, g, v, m, _, k, p, x, S, b, R, L = {
      point: T,
      lineStart: M,
      lineEnd: A,
      polygonStart: function() {
    ...
    function P(U, D) {
      ...
      i(p, x, k, S, b, R, p = ee[0], x = ee[1], k = U, S = H[0], b = H[1], R = H[2], Zl, u), u.point(p, x);
    }
    function A() {
      L.point = T, u.lineEnd();
    }
    function O() {
      M(), L.point = z, L.lineEnd = q;
    }
    function z(U, D) {
      P(l = U, D), f = p, g = x, v = S, m = b, _ = R, L.point = P;
    }
    function q() {
      i(p, x, k, S, b, R, f, g, l, v, m, _, Zl, u), L.lineEnd = A, A();
    }
    return L;
  };
}
...
function y_(a) {
  var r, i = 150, u = 480, l = 250, f, g, v = 0, m = 0, _ = 0, k = 0, p = 0, x, S, b = null, R = Hl, L = null, T, M, P, A = jl, O = 0.5, z = Ql(ee, O), q, U;
  function D(F) {
    return F = S(F[0] * kt, F[1] * kt), [F[0] * i + f, g - F[1] * i];
  }
  function H(F) {
    return F = S.invert((F[0] - f) / i, (g - F[1]) / i), F && [F[0] * nn, F[1] * nn];
  }
  function ee(F, Q) {
    return F = r(F, Q), [F[0] * i + f, g - F[1] * i];
  }
  D.stream = function(F) {
    return q && U === F ? q : q = h_(R(x, z(A(U = F))));
  }, D.clipAngle = function(F) {
    return arguments.length ? (R = +F ? o_(b = F * kt, 6 * kt) : (b = null, Hl), ae()) : b * nn;
  }, D.clipExtent = function(F) {
    return arguments.length ? (A = F == null ? (L = T = M = P = null, jl) : $0(L = +F[0][0], T = +F[0][1], M = +F[1][0], P = +F[1][1]), ae()) : L == null ? null : [[L, T], [M, P]];
  }, D.scale = function(F) {
    return arguments.length ? (i = +F, Z()) : i;
  }, D.translate = function(F) {
    return arguments.length ? (u = +F[0], l = +F[1], Z()) : [u, l];
  }, D.center = function(F) {
    return arguments.length ? (v = F[0] % 360 * kt, m = F[1] % 360 * kt, Z()) : [v * nn, m * nn];
  }, D.rotate = function(F) {
    return arguments.length ? (_ = F[0] % 360 * kt, k = F[1] % 360 * kt, p = F.length > 2 ? F[2] % 360 * kt : 0, Z()) : [_ * nn, k * nn, p * nn];
  }, D.precision = function(F) {
    return arguments.length ? (z = Ql(ee, O = F * F), ae()) : gr(O);
...
function b_(a, r, i = !0, u = !0, l = {}, f = {}, g = {
  ...
  function x() {
    !a.getSource("full-geom") && (g != null && g.fill || g != null && g.line) && a.addSource("full-geom", {
      ...
      type: "fill",
      source: "full-geom"
    }), !a.getLayer("full-geom-line") && (g != null && g.line) && a.addLayer({
      ...g == null ? void 0 : g.line,
      id: "full-geom-line",
      type: "line",
      source: "full-geom"
    }), p && R(p);
  ...
  return {
    setEventHandler(L) {
      L ? (v = L, a.on("click", S)) : (v = void 0, a.off("click", S));
    },
    flyTo(L, T) {
    ...
    setReverseMarker(L) {
      !r || !i || (k ? L ? k.setLngLat(L) : (k.remove(), k = void 0) : L && (k = (typeof i == "object" ? new r.Marker(i) : b()).setLngLat(L).addTo(a), k.getElement().classList.add("marker-reverse")));
    },
    setMarkers(L, T) {
      if (i) {
        for (const M of m)
          M.remove();
        if (m.length = 0, R(ec), !!r) {
          if (T) {
            let M = !1;
            ...
            i && m.push(
              (typeof i == "object" ? new r.Marker(i) : b()).setLngLat(T.center).addTo(a)
            );
          }
          if (u)
            for (const M of L ?? []) {
              if (M === T)
                continue;
              const P = (typeof u == "object" ? new r.Marker(u) : b(!0)).setLngLat(M.center).setPopup(
                new r.Popup({
                  offset: [1, -27],
                  closeButton: !1,
                  closeOnMove: !0,
                  ...
                  M.place_type[0] === "reverse" ? M.place_name : M.place_name.replace(/,.*/, "")
                )
              ).addTo(a), A = P.getElement();
              A.addEventListener("click", (O) => {
                O.stopPropagation(), v == null || v({ type: "markerClick", id: M.id });
              }), A.addEventListener("mouseenter", () => {
                v == null || v({ type: "markerMouseEnter", id: M.id }), P.togglePopup();
              }), A.addEventListener("mouseleave", () => {
                v == null || v({ type: "markerMouseLeave", id: M.id }), P.togglePopup();
              }), m.push(P);
            }
        }
      }
...
class w_ extends EventTarget {
  ...
  onAddInt(i) {
    ...
    const {
      ...
      fullGeometryStyle: v,
      ...m
    } = Et(this, Ln), _ = typeof g == "boolean" ? {} : g, k = this.getExtraProps(i, u), x = {
      mapController: b_(
        i,
        this.getMapLibreGl(),
        l,
    ...
    ii(this, ft, new Xg({ target: u, props: x }));
    for (const S of [
      "select",
      "pick",
      "featuresListed",
      ...
      Et(this, ft).$on(S, (b) => this.dispatchEvent(b));
    return u;
  }
  setOptions(i) {
    var m;
