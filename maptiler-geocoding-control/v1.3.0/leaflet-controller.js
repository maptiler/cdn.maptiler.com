...
var qf = Array.prototype.slice, zf = Ju, Ha = Object.keys, Er = Ha ? function(r) {
  return Ha(r);
} : Bf(), Za = Object.keys;
Er.shim = function() {
  if (Object.keys) {
...
var Ps = Er, Yf = Error, Uf = EvalError, Xf = RangeError, jf = ReferenceError, Qu = SyntaxError, Rt = TypeError, Vf = URIError, ni = function() {
...
}, Qn = Ms, Cr = Ku, dh = Qn.call(Function.call, Array.prototype.concat), _h = Qn.call(Function.apply, Array.prototype.splice), eo = Qn.call(Function.call, String.prototype.replace), Pr = Qn.call(Function.call, String.prototype.slice), xh = Qn.call(Function.call, RegExp.prototype.exec), Eh = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, kh = /\\(\\)?/g, Ih = function(r) {
...
var Ds = kr, wh = ft, Ir = wh("%Object.getOwnPropertyDescriptor%", !0);
if (Ir)
  try {
    Ir([], "length");
  } catch {
...
var Fs = Ir, to = Ds, bh = Qu, sn = Rt, no = Fs, $s = function(r, a, l) {
...
var eg = Wn, lo = $s, tg = Gs(), ng = eg.functionsHaveConfigurableNames(), rg = Rt, ig = function(r, a) {
  if (typeof r != "function")
...
var kg = pl, Sr = { exports: {} }, Ig = ni, jt = function() {
...
var is = Tg, xo = is.custom, Eo = kl(xo) ? xo : null, Gg = function o(r, a, l, c) {
  ...
  if (Hg(r)) {
    ...
    }), Io("Map", Ar.call(r), M, m);
  }
  if (Qg(r)) {
    var B = [];
    return ho && ho.call(r, function(ae) {
      B.push(k(ae, r));
    }), Io("Set", Mr.call(r), B, m);
  }
  if (Zg(r))
    return $i("WeakMap");
  if (Kg(r))
  ...
  if (!qg(r) && !ko(r)) {
    var Y = hr(r, k), U = mo ? mo(r) === Object.prototype : r instanceof Object || r.constructor === Object, X = r instanceof Object ? "" : "null prototype", ie = !U && Le && Object(r) === r && Le in r ? zs.call(Ct(r), 8, -1) : X ? "Object" : "", ee = U || typeof r.constructor != "function" ? "" : r.constructor.name ? r.constructor.name + " " : "", te = ee + (ie || X ? "[" + at.call(vo.call([], ie || [], X || []), ": ") + "] " : "");
...
var Nl = ft, xn = We, iy = Gg, sy = Rt, gr = Nl("%WeakMap%", !0), yr = Nl("%Map%", !0), ay = xn("WeakMap.prototype.get", !0), oy = xn("WeakMap.prototype.set", !0), uy = xn("WeakMap.prototype.has", !0), ly = xn("Map.prototype.get", !0), cy = xn("Map.prototype.set", !0), fy = xn("Map.prototype.has", !0), Ys = function(o, r) {
...
var Dy = Sr.exports, Go = function(o) {
  return o !== o;
}, Pl = function(r, a) {
...
var Xy = Dl, jy = _n, Fl = We, Vy = ft, os = Vy("%ArrayBuffer%", !0), Nr = Fl("ArrayBuffer.prototype.byteLength", !0), Wy = Fl("Object.prototype.toString"), Bo = !!os && !Nr && new os(0).slice, qo = !!Bo && jy(Bo), $l = Nr || qo ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    return Nr ? Nr(r) : qo(r, 0), !0;
  } catch {
    return !1;
  }
} : os ? function(r) {
...
var Tv = hs.exports, Lv = Ol, Rv = hv, Cv = dv, Pv = Sv, Av = Tv, Mv = function(r) {
  ...
  if (Av(r))
    return "BigInt";
}, $r = typeof WeakMap == "function" && WeakMap.prototype ? WeakMap : null, Uo = typeof WeakSet == "function" && WeakSet.prototype ? WeakSet : null, Gr;
$r || (Gr = function(r) {
  return !1;
});
var gs = $r ? $r.prototype.has : null, zi = Uo ? Uo.prototype.has : null;
!Gr && !gs && (Gr = function(r) {
  return !1;
});
...
var Gv = ys.exports, Bv = Ll, qv = Cl, zv = Dv, Yv = Gv, Uv = function(r) {
  ...
  return !1;
}, Ul = Function.prototype.toString, cn = typeof Reflect == "object" && Reflect !== null && Reflect.apply, vs, wr;
...
var tp = cn ? function(r) {
  ...
  "BigInt64Array",
  "BigUint64Array"
], ji = lp, cp = typeof globalThis > "u" ? ti : globalThis, fp = function() {
  for (var r = [], a = 0; a < ji.length; a++)
    typeof cp[ji[a]] == "function" && (r[r.length] = ji[a]);
  return r;
}, Br = up, hp = fp, Xo = _n, Vs = We, Or = Fs, gp = Vs("Object.prototype.toString"), jl = jt(), jo = typeof globalThis > "u" ? ti : globalThis, ds = hp(), Ws = Vs("String.prototype.slice"), Vi = Object.getPrototypeOf, yp = Vs("Array.prototype.indexOf", !0) || function(r, a) {
  for (var l = 0; l < r.length; l += 1)
    if (r[l] === a)
      return l;
  return -1;
}, qr = { __proto__: null };
jl && Or && Vi ? Br(ds, function(o) {
  var r = new jo[o]();
    ...
    for (; (p = h.next()) && !p.done; )
      if (p.value && typeof p.value == "object") {
        if (!fu(_, p.value, a.strict, l))
          return !1;
      } else if (!a.strict && !Xr(o, p.value) && !fu(_, p.value, a.strict, l))
        return !1;
    return Tr(_) === 0;
  }
  return !0;
  ...
  if (_) {
    for (; (p = h.next()) && !p.done; )
      if (x = p.value[0], m = p.value[1], x && typeof x == "object") {
        if (!hu(_, o, x, m, a, l))
          return !1;
      } else if (!a.strict && (!o.has(x) || !et(Yr(o, x), m, a, l)) && !hu(_, o, x, m, Vl({}, a, { strict: !1 }), l))
        return !1;
    return Tr(_) === 0;
  }
  return !0;
...
const Kp = (3 + 16 * xt) * xt, em = (2 + 12 * xt) * xt, tm = (9 + 64 * xt) * xt * xt, an = Kn(4), pu = Kn(8), mu = Kn(12), du = Kn(16), Pe = Kn(4);
...
const Hn = new sm(), Lr = (o, r) => o.x * r.y - o.y * r.x, ec = (o, r) => o.x * r.x + o.y * r.y, Eu = (o, r, a) => {
...
class Tt {
  ...
  getIntersection(r) {
    ...
    return E === null || !Gn(c, E) ? null : Hn.round(E.x, E.y);
  }
  /**
...
` }[e];
      ...
      return c(s, [{ key: "getM", value: function(e) {
        ...
        if (this._dimension = 3, this._measures = 0, this._coordinates = null, arguments.length === 1) {
          ...
          if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            ...
            for (var w = 0; w < y; w++) this._coordinates[w] = ar.create(d);
          }
        } else if (arguments.length === 3) {
    ...
    }(), di = "XY", zc = "XYZ", Yc = "XYM", Uc = "XYZM", ga = { POINT: "Point", LINE_STRING: "LineString", LINEAR_RING: "LinearRing", POLYGON: "Polygon", MULTI_POINT: "MultiPoint", MULTI_LINE_STRING: "MultiLineString", MULTI_POLYGON: "MultiPolygon", GEOMETRY_COLLECTION: "GeometryCollection", CIRCLE: "Circle" }, ya = "EMPTY", ur = 1, vt = 2, kt = 3, va = 4, Zt = 5, Xc = 6;
...
`;
      ...
      return c(s, [{ key: "consume_", value: function() {
        ...
        var e = this.isTokenType(ur) && this.token_.value == ya;
    ...
    var sf = function() {
      ...
      return c(t, [{ key: "createParentBoundablesFromVerticalSlices", value: function(n, i) {
        ...
        if (arguments.length === 3) {
          ...
          d.add(u);
          for (var w = new fr(); !d.isEmpty() && y >= 0; ) {
...
Zr.prototype = {
  ...
  add: function(o) {
    Cu(pr, o, this.t), Cu(this, pr.s, this.s), this.s ? this.t += pr.t : this.s = pr.t;
  },
  valueOf: function() {
    return this.s;
  }
...
function ad(o, r) {
  o && Au.hasOwnProperty(o.type) ? Au[o.type](o, r) : Jr(o, r);
}
Pt();
Pt();
function Ts(o) {
...
function pc(o, r, a, l, c) {
  ...
  if (o.forEach(function(N) {
    if (!((T = N.length - 1) <= 0)) {
      ...
      h.push(P = new _r(R, N, null, !0)), v.push(P.o = new _r(R, null, P, !1)), h.push(P = new _r(A, N, null, !1)), v.push(P.o = new _r(A, null, P, !0));
    }
  }), !!h.length) {
  ...
  return function(x) {
    ...
    function q(ne, ue) {
      ...
      if (E && N.push([ne, ue]), M)
        ...
        var ke = [P = Math.max(xr, Math.min(zn, P)), C = Math.max(xr, Math.min(zn, C))], Ie = [ne = Math.max(xr, Math.min(zn, ne)), ue = Math.max(xr, Math.min(zn, ue))];
...
Pt();
Pt();
var dn = 1 / 0, Kr = dn, Jn = -dn, ei = Jn, Yu = {
  point: yd,
  lineStart: qn,
  lineEnd: qn,
  polygonStart: qn,
  ...
  result: function() {
    var o = [[dn, Kr], [Jn, ei]];
    return Jn = ei = -(Kr = dn = 1 / 0), o;
  }
};
function yd(o, r) {
  o < dn && (dn = o), o > Jn && (Jn = o), r < Kr && (Kr = r), r > ei && (ei = r);
}
Pt();
function _c(o, r, a, l) {
  return function(c, h) {
...
function xd(o, r) {
  ...
  function _(I, m, k) {
    var E = mn(I), N = mn(m), T = [1, 0, 0], R = Qr(E, N), A = mr(R, R), P = R[0], C = A - P * P;
    if (!C) return !k && I;
    var F = a * A / C, M = -a * P / C, B = Qr(T, R), Y = dr(T, F), U = dr(R, M);
    Qi(Y, U);
    var X = B, ie = mr(Y, X), ee = mr(X, X), te = ie * ie - ee * (mr(Y, Y) - 1);
    if (!(te < 0)) {
      var ae = In(te), q = dr(X, (-ie - ae) / ee);
