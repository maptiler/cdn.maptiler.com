...
function dr(i, e, t) {
  let r, { $$slots: o = {}, $$scope: l } = e, { class: n = void 0 } = e, { apiKey: a } = e, { bbox: d = void 0 } = e, { clearButtonTitle: u = "clear" } = e, { clearOnBlur: f = !1 } = e, { collapsed: b = !1 } = e, { country: h = void 0 } = e, { debounceSearch: k = 200 } = e, { enableReverse: W = !1 } = e, { errorMessage: F = "Something went wrong…" } = e, { filter: y = () => !0 } = e, { flyTo: w = !0 } = e, { fuzzyMatch: P = !0 } = e, { language: R = void 0 } = e, { limit: E = void 0 } = e, { mapController: g = void 0 } = e, { minLength: I = 2 } = e, { noResultsMessage: v = "Oops! Looks like you're trying to predict something that's not quite right. We can't seem to find what you're looking for. Maybe try double-checking your spelling or try a different search term. Keep on typing - we'll do our best to get you where you need to go!" } = e, { placeholder: S = "Search" } = e, { proximity: m = [{ type: "server-geolocation" }] } = e, { reverseActive: _ = W === "always" } = e, { reverseButtonTitle: x = "toggle reverse geocoding" } = e, { searchValue: M = "" } = e, { showFullGeometry: he = !0 } = e, { showPlaceType: L = "ifNeeded" } = e, { showResultsWhileTyping: B = !0 } = e, { selectFirst: K = !0 } = e, { flyToSelected: be = !1 } = e, { markerOnSelected: Me = !0 } = e, { types: ce = void 0 } = e, { excludeTypes: We = !1 } = e, { zoom: pe = 16 } = e, { maxZoom: ve = 18 } = e, { apiUrl: Pe = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: He = {} } = e, { iconsBaseUrl: rt = "https://cdn.maptiler.com/maptiler-geocoding-control/v1.2.3/icons/" } = e, { adjustUrlQuery: je = (s) => {
  } } = e;
  function Bt() {
    $.focus();
  }
