...
var yo = (n, t, e) => (Ua(n, typeof t != "symbol" ? t + "" : t, e), e);
/**
 * splaytree v3.1.2
...
var Vo = (
  ...
  function() {
    ...
    return n.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = mo(e, r, a, i) : s = mo(e, r, s, i), this._root = Ya(s, a, i);
...
var Ka = Hr * Hr, Po = function(t, e) {
  ...
  var s = {
    x: r.x - t.x,
    y: r.y - t.y
  }, a = li(s, e) / o, u = li(s, i) / o, l = t.x + u * e.x, c = r.x + a * i.x, f = t.y + u * e.y, h = r.y + a * i.y, g = (l + c) / 2, p = (f + h) / 2;
  return {
    x: g,
    y: p
  };
  ...
  return ae(n, [{
    ...
    value: function(e) {
      ...
      if (o === null)
        return null;
      var s = this.leftSE.point, a = this.rightSE.point, u = e.leftSE.point, l = e.rightSE.point, c = oi(r, u) && this.comparePoint(u) === 0, f = oi(i, s) && e.comparePoint(s) === 0, h = oi(r, l) && this.comparePoint(l) === 0, g = oi(i, a) && e.comparePoint(a) === 0;
      if (f && c)
      ...
      if (h)
        return l;
      var p = $a(s, this.vector(), u, e.vector());
      return p === null || !oi(o, p) ? null : fi.round(p.x, p.y);
    }
    /**
        ...
        if (!(!s.isInResult() || s.ringOut)) {
          for (var a = null, u = s.leftSE, l = s.rightSE, c = [u], f = u.point, h = []; a = u, u = l, c.push(u), u.point !== f; )
            for (; ; ) {
              ...
              for (var m = null, E = 0, I = h.length; E < I; E++)
              ...
              var D = u.getLeftmostComparator(a);
              l = g.sort(D)[0].otherSE;
              break;
            }
          r.push(new n(c));
        }
    ...
    value: function(e) {
      ...
      if (e.isLeft) {
        ...
        if (l) {
          ...
          if (m !== null && (r.isAnEndpoint(m) || (v = m), !l.isAnEndpoint(m)))
            for (var E = this._splitSafely(l, m), I = 0, C = E.length; I < C; I++)
              i.push(E[I]);
        }
        if (c !== null || v !== null) {
          var S = null;
          if (c === null)
            ...
            var D = vr.comparePoints(c, v);
            S = D <= 0 ? c : v;
          }
          this.queue.remove(r.rightSE), i.push(r.rightSE);
          for (var R = r.split(S), F = 0, G = R.length; F < G; F++)
            i.push(R[F]);
        }
...
}(), hs = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, ou = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, su = /* @__PURE__ */ function() {
  function n() {
    Qe(this, n);
  }
  return ae(n, [{
      ...
      if (tr.type === "intersection") {
        for (var c = 0, f = o.length; c < f; c++)
          for (var h = o[c], g = c + 1, p = o.length; g < p; g++)
            if (wo(h.bbox, o[g].bbox) === null)
              return [];
      }
      for (var v = new Vo(vr.compare), m = 0, E = o.length; m < E; m++)
        for (var I = o[m].getSweepEvents(), C = 0, S = I.length; C < S; C++)
          if (v.insert(I[C]), v.size > hs)
            throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");
      for (var D = new iu(v), R = v.size, F = v.pop(); F; ) {
        var G = F.key;
        if (v.size === R) {
          var M = G.segment;
        ...
        if (D.segments.length > ou)
          throw new Error("Infinite loop when passing sweep line over endpoints (too many sweep line segments). Please file a bug report.");
        for (var et = D.process(G), K = 0, nt = et.length; K < nt; K++) {
          var ct = et[K];
          ct.consumedBy === void 0 && v.insert(ct);
        }
        R = v.size, F = v.pop();
      }
      fi.reset();
      var w = ru.factory(D.segments), X = new nu(w);
      return X.getGeom();
    }
  }]), n;
...
function gu(n, t, e) {
  e === void 0 && (e = {});
  var r = Yi(n), i = Yi(t), o = qs.union(r.coordinates, i.coordinates);
...
const bn = [], vs = [];
let On = [];
const ys = [], Eu = /* @__PURE__ */ Promise.resolve();
let Ro = !1;
function Iu() {
  Ro || (Ro = !0, Eu.then(Qs));
}
...
function Lu(n, t, e) {
  ...
  r && r.m(t, e), Oo(() => {
    ...
    n.$$.on_destroy ? n.$$.on_destroy.push(...o) : no(o), n.$$.on_mount = [];
  }), i.forEach(Oo);
}
function wu(n, t) {
  const e = n.$$;
  e.fragment !== null && (Nu(e.after_update), no(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function Pu(n, t) {
  n.$$.dirty[0] === -1 && (bn.push(n), Iu(), n.$$.dirty.fill(0)), n.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function bu(n, t, e, r, i, o, s = null, a = [-1]) {
  ...
  if (l.ctx = e ? e(n, t.props || {}, (f, h, ...g) => {
    ...
    return l.ctx && i(l.ctx[f], l.ctx[f] = p) && (!l.skip_bound && l.bound[f] && l.bound[f](p), c && Pu(n, f)), h;
...
function Du(n) {
  ...
  return {
    c() {
      t = ds("svg"), e = ds("path"), Ur(e, "stroke-width", "4"), Ur(e, "d", "M 5,33.103579 C 5,17.607779 18.457,5 35,5 C 51.543,5 65,17.607779 65,33.103579 C 65,56.388679 40.4668,76.048179 36.6112,79.137779 C 36.3714,79.329879 36.2116,79.457979 36.1427,79.518879 C 35.8203,79.800879 35.4102,79.942779 35,79.942779 C 34.5899,79.942779 34.1797,79.800879 33.8575,79.518879 C 33.7886,79.457979 33.6289,79.330079 33.3893,79.138079 C 29.5346,76.049279 5,56.389379 5,33.103579 Z M 35.0001,49.386379 C 43.1917,49.386379 49.8323,42.646079 49.8323,34.331379 C 49.8323,26.016779 43.1917,19.276479 35.0001,19.276479 C 26.8085,19.276479 20.1679,26.016779 20.1679,34.331379 C 20.1679,42.646079 26.8085,49.386379 35.0001,49.386379 Z"), Ur(e, "class", "svelte-gzo3ar"), Ur(t, "width", r = /*displayIn*/
      n[0] === "list" ? 20 : void 0), Ur(t, "viewBox", "0 0 70 85"), Ur(t, "fill", "none"), Ur(t, "class", "svelte-gzo3ar"), Ai(
        t,
        "in-map",
        /*displayIn*/
        n[0] !== "list"
...
function Js(n, t, e) {
  if (n !== null)
    for (var r, i, o, s, a, u, l, c = 0, f = 0, h, g = n.type, p = g === "FeatureCollection", v = g === "Feature", m = p ? n.features.length : 1, E = 0; E < m; E++) {
      l = p ? n.features[E].geometry : v ? n.geometry : n, h = l ? l.type === "GeometryCollection" : !1, a = h ? l.geometries.length : 1;
      for (var I = 0; I < a; I++) {
        var C = 0, S = 0;
          ...
          switch (c = 0, D) {
            ...
            case "MultiLineString":
              for (r = 0; r < u.length; r++) {
                ...
                D === "MultiLineString" && C++, D === "Polygon" && S++;
              }
              D === "Polygon" && C++;
              break;
            case "MultiPolygon":
...
var y = function() {
}, wi = { INTERIOR: { configurable: !0 }, BOUNDARY: { configurable: !0 }, EXTERIOR: { configurable: !0 }, NONE: { configurable: !0 } };
...
wi.INTERIOR.get = function() {
  return 0;
};
wi.BOUNDARY.get = function() {
  return 1;
};
wi.EXTERIOR.get = function() {
  return 2;
};
wi.NONE.get = function() {
  return -1;
};
Object.defineProperties(y, wi);
var T = function(n, t) {
...
pi.isWhitespace = function(t) {
  return t <= 32 && t >= 0 || t === 127;
};
pi.toUpperCase = function(t) {
...
_.prototype.selfAdd = function() {
  if (arguments.length === 1) {
    ...
    var l = arguments[0], c = arguments[1], f = null, h = null, g = null, p = null, v = null, m = null, E = null, I = null;
    v = this._hi + l, g = this._lo + c, E = v - this._hi, I = g - this._lo, m = v - E, p = g - I, m = l - E + (this._hi - m), p = c - I + (this._lo - p), E = m + g, f = v + E, h = E + (v - f), E = p + h;
    var C = f + E, S = E + (f - C);
...
_.parse = function(t) {
  for (var e = 0, r = t.length; pi.isWhitespace(t.charAt(e)); )
    e++;
  var i = !1;
  if (e < r) {
    var o = t.charAt(e);
...
var q = function() {
}, Pi = { X: { configurable: !0 }, Y: { configurable: !0 }, Z: { configurable: !0 }, M: { configurable: !0 } };
Pi.X.get = function() {
  return 0;
};
Pi.Y.get = function() {
...
var Ce = function n() {
  if (this.x = null, this.y = null, this.w = null, arguments.length === 0)
    ...
    var f = arguments[0], h = arguments[1], g = arguments[2], p = arguments[3], v = f.y - h.y, m = h.x - f.x, E = f.x * h.y - h.x * f.y, I = g.y - p.y, C = p.x - g.x, S = g.x * p.y - p.x * g.y;
    this.x = m * S - C * E, this.y = I * E - v * S, this.w = v * C - I * m;
  }
};
...
Ce.intersection = function(t, e, r, i) {
  ...
  if (A.isNaN(p) || A.isInfinite(p) || A.isNaN(v) || A.isInfinite(v))
    throw new $n();
  return new d(p, v);
};
var P = function n() {
...
var sn = function(n) {
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.isInSegmentEnvelopes = function(r) {
    ...
    var u = r.x < i.x ? r.x : i.x, l = r.y < i.y ? r.y : i.y, c = r.x > i.x ? r.x : i.x, f = r.y > i.y ? r.y : i.y, h = o.x < s.x ? o.x : s.x, g = o.y < s.y ? o.y : s.y, p = o.x > s.x ? o.x : s.x, v = o.y > s.y ? o.y : s.y, m = u > h ? u : h, E = c < p ? c : p, I = l > g ? l : g, C = f < v ? f : v, S = (m + E) / 2, D = (I + C) / 2;
    a.x = S, a.y = D, r.x -= a.x, r.y -= a.y, i.x -= a.x, i.y -= a.y, o.x -= a.x, o.y -= a.y, s.x -= a.x, s.y -= a.y;
...
O.prototype.isGeometryCollection = function() {
  return this.getSortIndex() === O.SORTINDEX_GEOMETRYCOLLECTION;
};
O.prototype.getFactory = function() {
  return this._factory;
};
O.prototype.getGeometryN = function(t) {
  return this;
};
O.prototype.getArea = function() {
  return 0;
};
O.prototype.isRectangle = function() {
  return !1;
};
...
O.prototype.equalsExact = function(t) {
  return this === t || this.equalsExact(t, 0);
};
O.prototype.geometryChanged = function() {
  this.apply(O.geometryChangedFilter);
};
O.prototype.geometryChangedAction = function() {
  this._envelope = null;
};
O.prototype.equalsNorm = function(t) {
  return t === null ? !1 : this.norm().equalsExact(t.norm());
};
O.prototype.getLength = function() {
  return 0;
};
O.prototype.getNumGeometries = function() {
  return 1;
};
O.prototype.compareTo = function() {
  if (arguments.length === 1) {
...
O.prototype.getSRID = function() {
  return this._SRID;
};
O.prototype.getEnvelope = function() {
  return this.getFactory().toGeometry(this.getEnvelopeInternal());
};
O.prototype.checkNotGeometryCollection = function(t) {
  if (t.getSortIndex() === O.SORTINDEX_GEOMETRYCOLLECTION)
    throw new it("This method does not support GeometryCollection arguments");
};
O.prototype.equal = function(t, e, r) {
...
O.prototype.getPrecisionModel = function() {
  return this._factory.getPrecisionModel();
};
O.prototype.getEnvelopeInternal = function() {
  return this._envelope === null && (this._envelope = this.computeEnvelopeInternal()), new P(this._envelope);
};
O.prototype.setSRID = function(t) {
  this._SRID = t;
};
O.prototype.setUserData = function(t) {
  this._userData = t;
};
O.prototype.compare = function(t, e) {
...
O.prototype.isGeometryCollectionOrDerived = function() {
  return this.getSortIndex() === O.SORTINDEX_GEOMETRYCOLLECTION || this.getSortIndex() === O.SORTINDEX_MULTIPOINT || this.getSortIndex() === O.SORTINDEX_MULTILINESTRING || this.getSortIndex() === O.SORTINDEX_MULTIPOLYGON;
};
...
O.hasNonEmptyElements = function(t) {
  for (var e = 0; e < t.length; e++)
    if (!t[e].isEmpty())
      return !0;
  return !1;
};
O.hasNullElements = function(t) {
  for (var e = 0; e < t.length; e++)
    if (t[e] === null)
      return !0;
  return !1;
...
z.intersection = function(t, e) {
  for (var r = new bi(), i = 0; i < t.length; i++)
...
Gn.prototype.compare = function(t, e) {
  var r = t, i = e;
...
Gn.prototype.OLDcompare = function(t, e) {
  var r = t, i = e;
  if (r.length < i.length)
    return -1;
  if (r.length > i.length)
...
Ri.prototype.name = "OperationNotSupported";
function ao() {
}
ao.prototype = new _t();
...
At.prototype.fixAfterInsertion = function(n) {
  ...
  for (n.color = qr; n != null && n !== this.root_ && n.parent.color === qr; )
    if ($(n) === Eo($($(n)))) {
      var e = Es($($(n)));
      _s(e) === qr ? (pr($(n), yr), pr(e, yr), pr($($(n)), qr), n = $($(n))) : (n === Es($(n)) && (n = $(n), t.rotateLeft(n)), pr($(n), yr), pr($($(n)), qr), t.rotateRight($($(n))));
    } else {
      var r = Eo($($(n)));
      _s(r) === qr ? (pr($(n), yr), pr(r, yr), pr($($(n)), qr), n = $($(n))) : (n === Eo($(n)) && (n = $(n), t.rotateRight(n)), pr($(n), yr), pr($($(n)), qr), t.rotateLeft($($(n))));
    }
  this.root_.color = yr;
};
...
At.prototype.entrySet = function() {
  var n = new qo(), t = this.getFirstEntry();
  if (t !== null)
...
var Xt = function(n) {
  ...
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    if (arguments.length === 1) {
      ...
      for (var u = arguments[0], l = arguments[1], c = u, f = this.getNumGeometries(), h = c.getNumGeometries(), g = 0; g < f && g < h; ) {
        var p = i.getGeometryN(g), v = c.getGeometryN(g), m = p.compareToSameClass(v, l);
        if (m !== 0)
          return m;
        g++;
      }
  ...
  return t.prototype.getSortIndex = function() {
    return O.SORTINDEX_MULTILINESTRING;
  }, t.prototype.equalsExact = function() {
    if (arguments.length === 2) {
      var i = arguments[0], o = arguments[1];
...
var Nt = function(n) {
  ...
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    if (arguments.length === 1) {
      ...
      if (g !== 0)
        return g;
      for (var p = this.getNumInteriorRing(), v = c.getNumInteriorRing(), m = 0; m < p && m < v; ) {
        var E = i.getInteriorRingN(m), I = c.getInteriorRingN(m), C = E.compareToSameClass(I, l);
        if (C !== 0)
          return C;
        m++;
      }
      return m < p ? 1 : m < v ? -1 : 0;
    }
  ...
  var e = { serialVersionUID: { configurable: !0 } };
  return t.prototype.getSortIndex = function() {
    return O.SORTINDEX_MULTIPOLYGON;
  }, t.prototype.equalsExact = function() {
    if (arguments.length === 2) {
      var i = arguments[0], o = arguments[1];
      return this.isEquivalentClass(i) ? n.prototype.equalsExact.call(this, i, o) : !1;
...
me.prototype.editGeometryCollection = function(t, e) {
  ...
  return i.getClass() === Vn ? this._factory.createMultiPoint(o.toArray([])) : i.getClass() === Qr ? this._factory.createMultiLineString(o.toArray([])) : i.getClass() === er ? this._factory.createMultiPolygon(o.toArray([])) : this._factory.createGeometryCollection(o.toArray([]));
};
...
var or = function() {
}, Yo = { serialVersionUID: { configurable: !0 }, instanceObject: { configurable: !0 } };
...
Yo.instanceObject.get = function() {
  return new or();
};
Object.defineProperties(or, Yo);
var sa = function(n) {
  function t() {
...
}, Ho = { serialVersionUID: { configurable: !0 }, maximumPreciseValue: { configurable: !0 } };
...
Ho.maximumPreciseValue.get = function() {
  return 9007199254740992;
};
Object.defineProperties(W, Ho);
var qe = function n(t) {
  this._name = t || null, n.nameToTypeMap.put(t, this);
}, Wo = { serialVersionUID: { configurable: !0 }, nameToTypeMap: { configurable: !0 } };
...
Wo.nameToTypeMap.get = function() {
  return new sa();
};
Object.defineProperties(qe, Wo);
W.Type = qe;
...
k.prototype.createMultiPoint = function() {
  var t = this;
  if (arguments.length === 0)
    return new Vn(null, this);
  if (arguments.length === 1) {
    if (arguments[0] instanceof Array) {
      var e = arguments[0];
      return new Vn(e, this);
    } else if (arguments[0] instanceof Array) {
      var r = arguments[0];
...
var Yu = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], co = function(t) {
  this.geometryFactory = t || new k();
};
...
jo.prototype.reducePrecision = function(t) {
  var e = this, r, i;
  if (t.coordinate)
...
Yt.prototype.computeDepths = function(t) {
  var e = this, r = new qo(), i = new po(), o = t.getNode();
...
var J = function() {
}, Oi = { NE: { configurable: !0 }, NW: { configurable: !0 }, SW: { configurable: !0 }, SE: { configurable: !0 } };
...
kn.prototype.createNode = function(t) {
...
zn.prototype.getBounds = function() {
};
...
xt.prototype.query = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (T(arguments[2], Mr) && arguments[0] instanceof Object && arguments[1] instanceof Ct)
      ...
      for (var h = arguments[0], g = arguments[1], p = arguments[2], v = g.getChildBoundables(), m = 0; m < v.size(); m++) {
        var E = v.get(m);
        t.getIntersectsOp().intersects(E.getBounds(), h) && (E instanceof Ct ? t.query(h, E, p) : E instanceof Le ? p.add(E.getItem()) : V.shouldNeverReachHere());
      }
  }
};
...
var ca = function(n) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[0] instanceof t && T(arguments[1], Un)) {
        ...
        var c = arguments[0], f = arguments[1], h = f, g = null, p = new Nr();
        for (p.add(c); !p.isEmpty() && h > 0; ) {
          var v = p.poll(), m = v.getDistance();
          if (m >= h)
            break;
          v.isLeaves() ? (h = m, g = v) : v.expandToQueue(p, h);
        }
        return [g.getBoundable(0).getItem(), g.getBoundable(1).getItem()];
      }
    } else if (arguments.length === 3) {
      var E = arguments[0], I = arguments[1], C = arguments[2], S = new Le(E, I), D = new vt(this.getRoot(), S, C);
...
Ei.prototype.addIntersection = function(t, e) {
};
...
Ci.prototype.setSegmentIntersector = function(t) {
  this._segInt = t;
};
...
var Ko = function(n) {
  ...
  return t.prototype.getMonotoneChains = function() {
    ...
    for (var i = this, o = new Cs(this._segInt), s = this._monoChains.iterator(); s.hasNext(); )
...
}, Di = { INIT: { configurable: !0 }, DELETE: { configurable: !0 }, KEEP: { configurable: !0 }, NUM_PTS_TO_CHECK: { configurable: !0 } };
...
lt.prototype.collapseLine = function() {
  for (var t = this, e = new bi(), r = 0; r < this._inputLine.length; r++)
...
Di.INIT.get = function() {
  return 0;
};
Di.DELETE.get = function() {
  return 1;
};
Di.KEEP.get = function() {
  return 1;
};
Di.NUM_PTS_TO_CHECK.get = function() {
  return 10;
};
...
}, Ti = { OFFSET_SEGMENT_SEPARATION_FACTOR: { configurable: !0 }, INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR: { configurable: !0 }, CURVE_VERTEX_SNAP_DISTANCE_FACTOR: { configurable: !0 }, MAX_CLOSING_SEG_LEN_FACTOR: { configurable: !0 } };
...
rt.prototype.addLimitedMitreJoin = function(t, e, r, i) {
  var o = this._seg0.p1, s = U.angle(o, this._seg0.p0), a = U.angleBetweenOriented(this._seg0.p0, o, this._seg1.p1), u = a / 2, l = U.normalize(s + u), c = U.normalize(l + Math.PI), f = i * r, h = f * Math.abs(Math.sin(u)), g = r - h, p = o.x + f * Math.cos(c), v = o.y + f * Math.sin(c), m = new d(p, v), E = new b(o, m), I = E.pointAlongOffset(1, g), C = E.pointAlongOffset(1, -g);
...
Ti.OFFSET_SEGMENT_SEPARATION_FACTOR.get = function() {
  return 1e-3;
};
Ti.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR.get = function() {
  return 1e-3;
};
Ti.CURVE_VERTEX_SNAP_DISTANCE_FACTOR.get = function() {
  return 1e-6;
};
Ti.MAX_CLOSING_SEG_LEN_FACTOR.get = function() {
  return 80;
};
Object.defineProperties(rt, Ti);
var Qt = function() {
...
pn.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (T(arguments[2], Ne) && arguments[0] instanceof d && arguments[1] instanceof To)
      for (var a = arguments[0], u = arguments[1], l = arguments[2], c = u.getEdge().getCoordinates(), f = 0; f < c.length - 1; f++) {
        ...
        if (!(h < a.x) && !t._seg.isHorizontal() && !(a.y < t._seg.p0.y || a.y > t._seg.p1.y) && L.computeOrientation(t._seg.p0, t._seg.p1, a) !== L.RIGHT) {
          var g = u.getDepth(N.LEFT);
          t._seg.p0.equals(c[f]) || (g = u.getDepth(N.RIGHT));
          var p = new Zr(t._seg, g);
          l.add(p);
        }
      }
    else if (T(arguments[2], Ne) && arguments[0] instanceof d && T(arguments[1], Ne))
      for (var v = arguments[0], m = arguments[1], E = arguments[2], I = m.iterator(); I.hasNext(); ) {
        var C = I.next();
        C.isForward() && t.findStabbedSegments(v, C, E);
      }
  }
};
...
j.interpolateZ = function(t, e, r, i) {
  var o = e.x, s = e.y, a = r.x - o, u = i.x - o, l = r.y - s, c = i.y - s, f = a * c - u * l, h = t.x - o, g = t.y - s, p = (c * h - u * g) / f, v = (-l * h + a * g) / f, m = e.z + p * (r.z - e.z) + v * (i.z - e.z);
  return m;
};
...
j.circumcentre = function(t, e, r) {
  var i = r.x, o = r.y, s = t.x - i, a = t.y - o, u = e.x - i, l = e.y - o, c = 2 * j.det(s, a, u, l), f = j.det(a, s * s + a * a, l, u * u + l * l), h = j.det(s, s * s + a * a, u, u * u + l * l), g = i - f / c, p = o + h / c;
  return new d(g, p);
};
...
_e.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof Nt ? this.addPolygon(t) : t instanceof ut ? this.addLineString(t) : t instanceof te ? this.addPoint(t) : t instanceof Vn ? this.addCollection(t) : t instanceof Qr ? this.addCollection(t) : t instanceof er ? this.addCollection(t) : t instanceof Xt && this.addCollection(t);
};
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.linkResultDirectedEdges = function() {
    ...
    if (arguments.length === 1) {
      ...
      for (var c = arguments[0], f = arguments[1], h = arguments[2], g = h, p = c; p < f; p++) {
        ...
        v.setEdgeDepths(N.RIGHT, g), g = v.getDepth(N.LEFT);
      }
      return g;
    }
...
xr.prototype.computeIntersectsForChain = function() {
  if (arguments.length === 4) {
    ...
    if (this.env1.init(f, h), this.env2.init(g, p), !this.env1.intersects(this.env2))
      return null;
    var v = Math.trunc((o + s) / 2), m = Math.trunc((u + l) / 2);
    o < v && (u < m && this.computeIntersectsForChain(o, v, a, u, m, c), m < l && this.computeIntersectsForChain(o, v, a, m, l, c)), v < s && (u < m && this.computeIntersectsForChain(v, s, a, u, m, c), m < l && this.computeIntersectsForChain(v, s, a, m, l, c));
  }
};
...
We.prototype.checkInteriorIntersections = function() {
  ...
  if (arguments.length === 0)
    ...
    if (h === p && g === v)
      return null;
    var m = h.getCoordinates()[g], E = h.getCoordinates()[g + 1], I = p.getCoordinates()[v], C = p.getCoordinates()[v + 1];
    if (this._li.computeIntersection(m, E, I, C), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, m, E) || this.hasInteriorIntersection(this._li, I, C)))
      throw new Er("found non-noded intersection at " + m + "-" + E + " and " + I + "-" + C);
  }
};
...
ur.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new Ko(), this._pointSnapper = new Xn(this._noder.getIndex()), this.snapRound(t, this._li);
};
...
Pt.bufferOp = function() {
  if (arguments.length === 2) {
    ...
    if (Number.isInteger(arguments[2]) && arguments[0] instanceof O && typeof arguments[1] == "number") {
      var o = arguments[0], s = arguments[1], a = arguments[2], u = new Pt(o);
      u.setQuadrantSegments(a);
      var l = u.getResultGeometry(s);
      return l;
    } else if (arguments[2] instanceof H && arguments[0] instanceof O && typeof arguments[1] == "number") {
      var c = arguments[0], f = arguments[1], h = arguments[2], g = new Pt(c, h), p = g.getResultGeometry(f);
      return p;
    }
  } else if (arguments.length === 4) {
    var v = arguments[0], m = arguments[1], E = arguments[2], I = arguments[3], C = new Pt(v);
...
$e.computeDistance = function() {
  if (arguments[2] instanceof kt && arguments[0] instanceof ut && arguments[1] instanceof d)
    ...
    if (h instanceof ut)
      $e.computeDistance(h, g, p);
    else if (h instanceof Nt)
      $e.computeDistance(h, g, p);
    else if (h instanceof Xt)
      for (var v = h, m = 0; m < v.getNumGeometries(); m++) {
        var E = v.getGeometryN(m);
        $e.computeDistance(E, g, p);
      }
    else
      p.setMinimum(h.getCoordinate(), g);
  } else if (arguments[2] instanceof kt && arguments[0] instanceof b && arguments[1] instanceof d) {
    var I = arguments[0], C = arguments[1], S = arguments[2], D = I.closestPoint(C);
    S.setMinimum(D, C);
  }
};
var en = function(t) {
  this._maxPtDist = new kt(), this._inputGeom = t || null;
}, Qo = { MaxPointDistanceFilter: { configurable: !0 }, MaxMidpointDistanceFilter: { configurable: !0 } };
...
Qo.MaxMidpointDistanceFilter.get = function() {
  return Gr;
};
Object.defineProperties(en, Qo);
var dn = function(t) {
...
wt.getLines = function() {
  if (arguments.length === 1) {
    ...
    if (T(arguments[0], _t) && T(arguments[1], _t)) {
      ...
      return r;
    } else if (arguments[0] instanceof O && typeof arguments[1] == "boolean") {
      var s = arguments[0], a = arguments[1], u = new x();
      return s.apply(new wt(u, a)), u;
    } else if (arguments[0] instanceof O && T(arguments[1], _t)) {
    ...
    if (typeof arguments[2] == "boolean" && T(arguments[0], _t) && T(arguments[1], _t)) {
      ...
      return h;
    } else if (typeof arguments[2] == "boolean" && arguments[0] instanceof O && T(arguments[1], _t)) {
      var m = arguments[0], E = arguments[1], I = arguments[2];
      return m.apply(new wt(E, I)), E;
    }
  }
};
var be = function() {
...
Ot.prototype.computeContainmentDistance = function() {
  ...
  if (arguments.length === 0) {
    ...
    if (arguments[2] instanceof Array && T(arguments[0], Ne) && T(arguments[1], Ne)) {
      ...
      var p = arguments[0], v = arguments[1], m = arguments[2], E = p.getCoordinate();
      if (y.EXTERIOR !== this._ptLocator.locate(E, v))
        return this._minDistance = 0, m[0] = p, m[1] = new zt(v, E), null;
    }
  }
};
  ...
  if (arguments.length === 0) {
    ...
    if (arguments[2] instanceof Array && arguments[0] instanceof ut && arguments[1] instanceof te) {
      ...
      if (f.getEnvelopeInternal().distance(h.getEnvelopeInternal()) > this._minDistance)
        return null;
      for (var p = f.getCoordinates(), v = h.getCoordinates(), m = 0; m < p.length - 1; m++)
        for (var E = 0; E < v.length - 1; E++) {
          var I = L.distanceLineLine(p[m], p[m + 1], v[E], v[E + 1]);
          if (I < t._minDistance) {
            t._minDistance = I;
            var C = new b(p[m], p[m + 1]), S = new b(v[E], v[E + 1]), D = C.closestPoints(S);
            g[0] = new zt(f, m, D[0]), g[1] = new zt(h, E, D[1]);
          }
          if (t._minDistance <= t._terminateDistance)
            return null;
        }
...
Be.computeDistance = function() {
  if (arguments[2] instanceof Mt && arguments[0] instanceof ut && arguments[1] instanceof d)
    ...
    var h = arguments[0], g = arguments[1], p = arguments[2];
    if (h instanceof ut)
      Be.computeDistance(h, g, p);
    else if (h instanceof Nt)
      Be.computeDistance(h, g, p);
    else if (h instanceof Xt)
      for (var v = h, m = 0; m < v.getNumGeometries(); m++) {
        var E = v.getGeometryN(m);
        Be.computeDistance(E, g, p);
      }
    else
      p.setMinimum(h.getCoordinate(), g);
...
}, Jo = { MaxPointDistanceFilter: { configurable: !0 }, MaxDensifiedByFractionDistanceFilter: { configurable: !0 } };
...
Jo.MaxDensifiedByFractionDistanceFilter.get = function() {
  return Vr;
};
Object.defineProperties(ve, Jo);
var yn = function() {
...
}, Zo = { VERBOSE: { configurable: !0 }, MAX_DISTANCE_DIFF_FRAC: { configurable: !0 } };
...
Zo.MAX_DISTANCE_DIFF_FRAC.get = function() {
  return 0.012;
};
Object.defineProperties($t, Zo);
...
}, $o = { VERBOSE: { configurable: !0 }, MAX_ENV_DIFF_FRAC: { configurable: !0 } };
...
$o.MAX_ENV_DIFF_FRAC.get = function() {
  return 0.012;
};
Object.defineProperties(Dt, $o);
var je = function() {
...
}, ts = { CommonCoordinateFilter: { configurable: !0 }, Translater: { configurable: !0 } };
...
ts.CommonCoordinateFilter.get = function() {
  return En;
};
ts.Translater.get = function() {
  return zr;
};
Object.defineProperties(kr, ts);
var En = function() {
...
xi.prototype.computeIntersections = function(t, e) {
...
}, es = { INSERT: { configurable: !0 }, DELETE: { configurable: !0 } };
...
es.INSERT.get = function() {
  return 1;
};
es.DELETE.get = function() {
  return 2;
};
...
var Qu = function(n) {
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.prepareEvents = function() {
    ...
    for (var o = this, s = r.getMonotoneChainEdge(), a = s.getStartIndexes(), u = 0; u < a.length - 1; u++) {
      var l = new xi(s, u), c = new ne(i, s.getMinX(u), l);
...
Si.prototype.compare = function(t, e) {
...
Yn.prototype.getItems = function() {
  return this._items;
};
Yn.prototype.interfaces_ = function() {
  return [Mr];
...
}, rs = { SegmentVisitor: { configurable: !0 }, IntervalIndexedGeometry: { configurable: !0 } };
Hn.prototype.locate = function(t) {
  var e = new Ge(t), r = new Wn(e);
...
rs.SegmentVisitor.get = function() {
  return Wn;
};
rs.IntervalIndexedGeometry.get = function() {
  return nn;
};
Object.defineProperties(Hn, rs);
var Wn = function() {
  this._counter = null;
  var t = arguments[0];
  this._counter = t;
};
Wn.prototype.visitItem = function(t) {
  var e = t;
...
nn.prototype.query = function() {
  if (arguments.length === 2) {
    var t = arguments[0], e = arguments[1], r = new Yn();
...
var si = function(n) {
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(r, i) {
    ...
    var o = new ji(i, new Q(this._argIndex, y.INTERIOR));
    ...
    var a = i, u = o;
    L.isCCW(s) && (a = o, u = i);
    var l = new ji(s, new Q(this._argIndex, y.BOUNDARY, a, u));
    ...
    return T(this._parentGeom, Tr) && this._parentGeom.getNumGeometries() > 50 ? (this._areaPtLocator === null && (this._areaPtLocator = new Hn(this._parentGeom)), this._areaPtLocator.locate(r)) : this._ptLocator.locate(r, this._parentGeom);
  ...
  if (this._li = new sn(), this._resultPrecisionModel = null, this._arg = null, arguments.length === 1) {
    var t = arguments[0];
    this.setComputationPrecision(t.getPrecisionModel()), this._arg = new Array(1).fill(null), this._arg[0] = new si(0, t);
  } else if (arguments.length === 2) {
    var e = arguments[0], r = arguments[1], i = ye.OGC_SFS_BOUNDARY_RULE;
    e.getPrecisionModel().compareTo(r.getPrecisionModel()) >= 0 ? this.setComputationPrecision(e.getPrecisionModel()) : this.setComputationPrecision(r.getPrecisionModel()), this._arg = new Array(2).fill(null), this._arg[0] = new si(0, e, i), this._arg[1] = new si(1, r, i);
  } else if (arguments.length === 3) {
    var o = arguments[0], s = arguments[1], a = arguments[2];
    o.getPrecisionModel().compareTo(s.getPrecisionModel()) >= 0 ? this.setComputationPrecision(o.getPrecisionModel()) : this.setComputationPrecision(s.getPrecisionModel()), this._arg = new Array(2).fill(null), this._arg[0] = new si(0, o, a), this._arg[1] = new si(1, s, a);
  }
};
jn.prototype.getArgGeometry = function(t) {
  return this._arg[t].getGeometry();
};
jn.prototype.setComputationPrecision = function(t) {
...
jr.map = function() {
  if (arguments[0] instanceof O && T(arguments[1], jr.MapOp)) {
...
yt.prototype.reduceToGeometries = function(t) {
  for (var e = this, r = new x(), i = t.iterator(); i.hasNext(); ) {
    var o = i.next(), s = null;
    T(o, Ne) ? s = e.unionTree(o) : o instanceof O && (s = o), r.add(s);
  }
  return r;
};
...
var at = 1e-6, Z = Math.PI, mr = Z / 2, xs = Z / 4, Sr = Z * 2, Xr = 180 / Z, Ae = Z / 180, Ut = Math.abs, $u = Math.atan, Qn = Math.atan2, Et = Math.cos, It = Math.sin, ni = Math.sqrt;
function La(n) {
...
function Zi(n, t) {
  n && Ls.hasOwnProperty(n.type) && Ls[n.type](n, t);
}
var Ss = {
...
function tl(n, t) {
  n && Ss.hasOwnProperty(n.type) ? Ss[n.type](n, t) : Zi(n, t);
}
an();
an();
function Ao(n) {
...
Bo.invert = Bo;
function el(n, t, e) {
  return (n %= Sr) ? t || e ? wa(bs(n), Rs(t, e)) : bs(n) : t || e ? Rs(t, e) : Bo;
}
function Ps(n) {
  return function(t, e) {
...
function bs(n) {
  var t = Ps(n);
  return t.invert = Ps(-n), t;
}
function Rs(n, t) {
  var e = Et(n), r = It(n), i = Et(t), o = It(t);
  function s(a, u) {
    var l = Et(u), c = Et(a) * l, f = It(a) * l, h = It(u), g = h * e + c * r;
    return [
      Qn(f * i - g * o, c * e - h * r),
      In(g * i + f * o)
    ];
  ...
  return s.invert = function(a, u) {
    var l = Et(u), c = Et(a) * l, f = It(a) * l, h = It(u), g = h * i - f * o;
    return [
      Qn(f * i + h * o, c * e + g * r),
      In(g * e - c * r)
    ];
...
function rl(n, t, e, r, i, o) {
  if (e) {
    ...
    i == null ? (i = t + r * Sr, o = t - u / 2) : (i = Os(s, i), o = Os(s, o), (r > 0 ? i < o : i > o) && (i += r * Sr));
    for (var l, c = i; r > 0 ? c > o : c < o; c -= u)
      l = Ao([s, -a * Et(c), -a * It(c)]), n.point(l[0], l[1]);
  }
}
function Os(n, t) {
  t = Jn(t), t[0] -= n, Fo(t);
...
function ba(n, t, e, r, i) {
  ...
  if (n.forEach(function(p) {
    if (!((v = p.length - 1) <= 0)) {
      ...
      o.push(I = new Vi(m, p, null, !0)), s.push(I.o = new Vi(m, null, I, !1)), o.push(I = new Vi(E, p, null, !1)), s.push(I.o = new Vi(E, null, I, !0));
    }
  }), !!o.length) {
...
function sl(n, t, e, r) {
  ...
  return function(l) {
    var c = l, f = Pa(), h, g, p, v, m, E, I, C, S, D, R, F = {
      point: G,
      lineStart: nt,
      lineEnd: ct,
      polygonStart: et,
    ...
    function M() {
      for (var X = 0, ft = 0, Gt = g.length; ft < Gt; ++ft)
        for (var pe = g[ft], Te = 1, ii = pe.length, Pr = pe[0], un, br, Mi = Pr[0], wn = Pr[1]; Te < ii; ++Te)
    ...
    function K() {
      var X = M(), ft = R && X, Gt = (h = Oa(h)).length;
      (ft || Gt) && (l.polygonStart(), ft && (l.lineStart(), o(null, null, 1, l), l.lineEnd()), Gt && ba(h, a, X, o, l), l.polygonEnd()), c = l, h = g = p = null;
    }
    function nt() {
      F.point = w, g && g.push(p = []), D = !0, S = !1, I = C = NaN;
    }
    function ct() {
      h && (w(v, m), E && S && f.rejoin(), h.push(f.result())), F.point = G, S && c.lineEnd();
    }
    function w(X, ft) {
      var Gt = i(X, ft);
      if (g && p.push([X, ft]), D)
        v = X, m = ft, E = Gt, D = !1, Gt && (c.lineStart(), c.point(X, ft));
      else if (Gt && S)
        c.point(X, ft);
      else {
        ...
        nl(pe, Te, n, t, e, r) ? (S || (c.lineStart(), c.point(pe[0], pe[1])), c.point(Te[0], Te[1]), Gt || c.lineEnd(), R = !1) : Gt && (c.lineStart(), c.point(X, ft), R = !1);
      }
      I = X, C = ft, S = Gt;
    }
    return F;
...
function al(n, t) {
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + xs, p = It(g), v = Et(g), m = 0; m < c; ++m, h = I, p = S, v = D, f = E) {
        var E = l[m], I = E[0], C = E[1] / 2 + xs, S = It(C), D = Et(C), R = I - h, F = R >= 0 ? 1 : -1, G = F * R, M = G > Z, et = p * S;
        if (Co.add(Qn(et * F * It(G), v * D + et * Et(G))), o += M ? R + F * Sr : R, M ^ h >= e ^ I >= e) {
          var K = $i(Jn(f), Jn(E));
          Fo(K);
          var nt = $i(i, K);
          Fo(nt);
          var ct = (M ^ R >= 0 ? -1 : 1) * In(nt[2]);
          (r > ct || r === ct && (K[0] || K[1])) && (s += M ^ R >= 0 ? 1 : -1);
        }
      }
...
an();
an();
var Zn = 1 / 0, to = Zn, Li = -Zn, eo = Li, Ms = {
  point: ul,
  lineStart: ai,
  lineEnd: ai,
  polygonStart: ai,
  ...
  result: function() {
    var n = [[Zn, to], [Li, eo]];
    return Li = eo = -(to = Zn = 1 / 0), n;
  }
};
function ul(n, t) {
  n < Zn && (Zn = n), n > Li && (Li = n), t < to && (to = t), t > eo && (eo = t);
}
an();
function Da(n, t, e, r) {
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = Pa(), l = t(u), c = !1, f, h, g, p = {
      point: v,
      lineStart: E,
      lineEnd: I,
      polygonStart: function() {
        p.point = C, p.lineStart = S, p.lineEnd = D, h = [], f = [];
      },
      polygonEnd: function() {
        p.point = v, p.lineStart = E, p.lineEnd = I, h = Oa(h);
        var R = al(f, a);
        h.length ? (c || (o.polygonStart(), c = !0), ba(h, cl, R, e, o)) : R && (c || (o.polygonStart(), c = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), h = f = null;
      },
      sphere: function() {
    ...
    function D() {
      ...
      var R = l.clean(), F = u.result(), G, M = F.length, et, K, nt;
      if (g.pop(), f.push(g), g = null, !!M) {
        if (R & 1) {
        ...
        M > 1 && R & 2 && F.push(F.pop().concat(F.shift())), h.push(F.filter(ll));
      }
    }
    return p;
  };
...
function gl(n, t) {
  ...
  function a(c) {
    ...
    return {
      ...
      point: function(m, E) {
        var I = [m, E], C, S = s(m, E), D = r ? S ? 0 : l(m, E) : S ? l(m + (m < 0 ? Z : -Z), E) : 0;
        if (!f && (p = g = S) && c.lineStart(), S !== g && (C = u(f, I), (!C || zi(f, C) || zi(I, C)) && (I[0] += at, I[1] += at, S = s(I[0], I[1]))), S !== g)
          v = 0, S ? (c.lineStart(), C = u(I, f), c.point(C[0], C[1])) : (C = u(f, I), c.point(C[0], C[1]), c.lineEnd()), f = C;
        else if (i && f && r ^ S) {
          var R;
          !(D & h) && (R = u(I, f, !0)) && (v = 0, r ? (c.lineStart(), c.point(R[0][0], R[0][1]), c.point(R[1][0], R[1][1]), c.lineEnd()) : (c.point(R[1][0], R[1][1]), c.lineEnd(), c.lineStart(), c.point(R[0][0], R[0][1])));
        }
        S && (!f || !zi(f, I)) && c.point(I[0], I[1]), f = I, g = S, h = D;
      },
      lineEnd: function() {
        g && c.lineEnd(), f = null;
      },
  ...
  function u(c, f, h) {
    var g = Jn(c), p = Jn(f), v = [1, 0, 0], m = $i(g, p), E = Bi(m, m), I = m[0], C = E - I * I;
    if (!C)
      return !h && c;
    var S = e * E / C, D = -e * I / C, R = $i(v, m), F = Gi(v, S), G = Gi(m, D);
    Io(F, G);
    var M = R, et = Bi(F, M), K = Bi(M, M), nt = et * et - K * (Bi(F, F) - 1);
    if (!(nt < 0)) {
      ...
      var ii = ft - X, Pr = Ut(ii - Z) < at, un = Pr || ii < at;
      if (!Pr && pe < Gt && (Te = Gt, Gt = pe, pe = Te), un ? Pr ? Gt + pe > 0 ^ w[1] < (Ut(w[0] - X) < at ? Gt : pe) : Gt <= w[1] && w[1] <= pe : ii > Z ^ (X <= w[0] && w[0] <= ft)) {
        var br = Gi(M, (-et + ct) / K);
        return Io(br, F), [w, Ao(br)];
      }
    }
  }
  function l(c, f) {
...
function Ma(n, t, e) {
  ...
  n.scale(150).translate([0, 0]), o != null && n.clipExtent(null), tl(e, n.stream(Ms));
...
function ml(n, t) {
  function e(r, i, o, s, a, u, l, c, f, h, g, p, v, m) {
    var E = l - r, I = c - i, C = E * E + I * I;
    if (C > 4 * t && v--) {
      var S = s + h, D = a + g, R = u + p, F = ni(S * S + D * D + R * R), G = In(R /= F), M = Ut(Ut(R) - 1) < at || Ut(o - f) < at ? (o + f) / 2 : Qn(D, S), et = n(M, G), K = et[0], nt = et[1], ct = K - r, w = nt - i, X = I * ct - E * w;
      (X * X / C > t || Ut((E * ct + I * w) / C - 0.5) > 0.3 || s * h + a * g + u * p < vl) && (e(r, i, o, s, a, u, K, nt, M, S /= F, D /= F, R, v, m), m.point(K, nt), e(K, nt, M, S, D, R, l, c, f, h, g, p, v, m));
    }
  }
  return function(r) {
    var i, o, s, a, u, l, c, f, h, g, p, v, m = {
      point: E,
      lineStart: I,
      lineEnd: S,
      polygonStart: function() {
        r.polygonStart(), m.lineStart = D;
      },
      polygonEnd: function() {
    ...
    function C(G, M) {
      ...
      e(f, h, c, g, p, v, f = K[0], h = K[1], c = G, g = et[0], p = et[1], v = et[2], Fs, r), r.point(f, h);
    }
    function S() {
      m.point = E, r.lineEnd();
    }
    function D() {
      I(), m.point = R, m.lineEnd = F;
    }
    function R(G, M) {
      C(i = G, M), o = f, s = h, a = g, u = p, l = v, m.point = C;
    }
    function F() {
      e(f, h, c, g, p, v, o, s, i, a, u, l, Fs, r), m.lineEnd = S, S();
    }
    return m;
  };
}
...
function Il(n) {
  var t, e = 150, r = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, g, p = null, v = As, m = null, E, I, C, S = Ts, D = 0.5, R = Bs(K, D), F, G;
  function M(w) {
    return w = g(w[0] * Ae, w[1] * Ae), [w[0] * e + o, s - w[1] * e];
  }
  function et(w) {
    return w = g.invert((w[0] - o) / e, (s - w[1]) / e), w && [w[0] * Xr, w[1] * Xr];
  }
  function K(w, X) {
    return w = t(w, X), [w[0] * e + o, s - w[1] * e];
  }
  M.stream = function(w) {
    return F && G === w ? F : F = _l(v(h, R(S(G = w))));
  }, M.clipAngle = function(w) {
    return arguments.length ? (v = +w ? gl(p = w * Ae, 6 * Ae) : (p = null, As), ct()) : p * Xr;
  }, M.clipExtent = function(w) {
    return arguments.length ? (S = w == null ? (m = E = I = C = null, Ts) : sl(m = +w[0][0], E = +w[0][1], I = +w[1][0], C = +w[1][1]), ct()) : m == null ? null : [[m, E], [I, C]];
  }, M.scale = function(w) {
    ...
    return arguments.length ? (R = Bs(K, D = w * w), ct()) : ni(D);
...
function Ui(n, t, e, r) {
  ...
  }, l = new jo(), c = l.read(u), f = hu(pu(t, e), "meters"), h = Pt.bufferOp(c, f, r), g = new ua();
  if (h = g.write(h), !Ga(h.coordinates)) {
    var p = {
      type: h.type,
...
function Ll(n, t) {
  var e = Yi(n), r = Yi(t), i = n.properties || {}, o = qs.difference(
    e.coordinates,
    r.coordinates
  );
...
function Pl(n, t, e = !0, r = !0, i = {}, o = {}, s = {
  ...
  function g(p = !1) {
    ...
    return p && v.classList.add("marker-interactive"), new Mu({
  ...
  return {
    setEventHandler(p) {
      p ? (a = p, n.on("click", h)) : (a = void 0, n.off("click", h));
    },
    flyTo(p, v) {
      n.flyTo({ center: p, zoom: v, ...i });
    },
    fitBounds(p, v, m) {
      n.fitBounds(
        [
    ...
    setReverseMarker(p) {
      !t || !e || (c ? p ? c.setLngLat(p) : (c.remove(), c = void 0) : p && (c = (typeof e == "object" ? new t.Marker(e) : g()).setLngLat(p).addTo(n), c.getElement().classList.add("marker-reverse")));
    },
    setMarkers(p, v) {
      if (!e)
        return;
      function m(E) {
        var I;
        (I = n.getSource("full-geom")) == null || I.setData(E);
      }
      for (const E of u)
        E.remove();
      if (u.length = 0, m(zs), !!t) {
        if (v) {
          ...
          e && u.push(
            (typeof e == "object" ? new t.Marker(e) : g()).setLngLat(v.center).addTo(n)
          );
        }
        if (r)
          for (const E of p ?? []) {
...
export {
  Pl as createMapLibreGlMapController
};
