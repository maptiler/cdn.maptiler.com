...
var Ns = (n, t, e) => (Bl(n, typeof t != "symbol" ? t + "" : t, e), e), pa = (n, t, e) => {
  if (!t.has(n))
    throw TypeError("Cannot " + e);
};
var xr = (n, t, e) => (pa(n, t, "read from private field"), e ? e.call(n) : t.get(n)), Ss = (n, t, e) => {
  if (t.has(n))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(n) : t.set(n, e);
}, Ro = (n, t, e, r) => (pa(n, t, "write to private field"), r ? r.call(n, e) : t.set(n, e), e);
...
let Oo;
function me(n, t) {
  return n === t ? !0 : (Oo || (Oo = document.createElement("a")), Oo.href = t, n === Oo.href);
}
function zl(n) {
...
function vu(n, t, e, r) {
  return n[1] && r ? Gl(e.ctx.slice(), n[1](r(t))) : e.ctx;
}
function Ul(n, t, e, r) {
  if (n[2] && r) {
    const i = n[2](r(e));
...
function jl(n, t, { bubbles: e = !1, cancelable: r = !1 } = {}) {
...
function yu() {
  ...
  do {
    ...
    for ($i(null), yi.length = 0, mi = 0; Rs.length; )
      Rs.pop()();
...
function rc(n, t, e, r, i, o, s, a, u, l, c, f) {
  ...
  for (p = g; p--; ) {
    ...
    let b = s.get(D);
    b ? C.push(() => b.p(R, t)) : (b = l(D, R), b.c()), _.set(D, d[p] = b), D in v && I.set(D, Math.abs(p - v[D]));
  }
...
function hn(n, t) {
  const e = n.$$;
  e.fragment !== null && (tc(e.after_update), In(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function nc(n, t) {
  n.$$.dirty[0] === -1 && (yi.push(n), Jl(), n.$$.dirty.fill(0)), n.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function Xn(n, t, e, r, i, o, s = null, a = [-1]) {
  ...
  if (l.ctx = e ? e(n, t.props || {}, (f, h, ...g) => {
    ...
    return l.ctx && i(l.ctx[f], l.ctx[f] = p) && (!l.skip_bound && l.bound[f] && l.bound[f](p), c && nc(n, f)), h;
    ...
    t.intro && Ft(n.$$.fragment), fn(n, t.target, t.anchor), yu();
  }
  $i(u);
}
class Yn {
...
const ic = "4";
typeof window < "u" && (window.__svelte || (window.__svelte = { v: /* @__PURE__ */ new Set() })).v.add(ic);
function oc(n) {
  let t, e;
  return {
    c() {
...
function dc(n) {
  ...
  function C(b, A) {
    ...
    b[5] ? pc : (
      ...
      b[0].address ? gc : (
        ...
        ((G = b[0].properties) == null ? void 0 : G.kind) === "road_relation" ? hc : (e == null && (e = !!/*feature*/
        b[0].id.startsWith("address.")), e ? fc : (r == null && (r = !!/*feature*/
        b[0].id.startsWith("postal_code.")), r ? cc : (i == null && (i = !!/*feature*/
        b[0].id.startsWith("poi.")), i ? lc : (
          /*isReverse*/
          b[7] ? uc : ac
        ))))
      )
  ...
  return {
    c() {
      t = ht("li"), L.c(), o = Xe(), s = ht("span"), a = ht("span"), u = ht("span"), c = On(l), f = Xe(), T && T.c(), g = Xe(), p = ht("span"), d = On(v), w(u, "class", "primary svelte-ltkwvy"), w(a, "class", "svelte-ltkwvy"), w(p, "class", "line2 svelte-ltkwvy"), w(s, "class", "texts svelte-ltkwvy"), w(t, "tabindex", "0"), w(
        t,
        "data-selected",
        /*selected*/
        n[1]
      ), w(t, "class", "svelte-ltkwvy"), lr(
        t,
        "selected",
        /*selected*/
        n[1]
    ...
    p(b, [A]) {
      ...
      )) + "") && eo(c, l), A & /*showPlaceType, feature, imageUrl*/
      37 && (h = /*showPlaceType*/
...
function Ec(n) {
  ...
  return {
    c() {
      ...
      n[0] === "list" ? 20 : void 0), w(t, "viewBox", "0 0 70 85"), w(t, "fill", "none"), w(t, "class", "svelte-gzo3ar"), lr(
        t,
        "in-map",
        /*displayIn*/
        n[0] !== "list"
...
class Ic extends Yn {
  constructor(t) {
    super(), Xn(this, t, Cc, Ec, qn, { displayIn: 0 });
  }
}
function Nc(n) {
  let t, e;
...
function xc(n) {
  ...
  return {
    c() {
      t = wr("svg"), e = wr("circle"), r = wr("path"), w(e, "cx", "4.789"), w(e, "cy", "4.787"), w(e, "r", "3.85"), To(e, "stroke-width", "1.875"), To(e, "fill", "none"), w(r, "d", "M12.063 12.063 7.635 7.635"), To(r, "stroke-width", "1.875"), To(r, "stroke-linecap", "round"), w(t, "xmlns", "http://www.w3.org/2000/svg"), w(t, "width", "13"), w(t, "height", "13"), w(t, "viewBox", "0 0 13 13"), w(t, "class", "svelte-1bpbt60");
    },
    m(i, o) {
...
const Na = /([+-]?[0-8]?[0-9])\s+([0-5]?[0-9]\.\d{3,})[\s,]{1,}([+-]?[0-1]?[0-9]?[0-9])\s+([0-5]?[0-9]\.\d{3,})/, Sa = /(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?/i, xa = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?/i, La = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?/i, ba = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?/i;
function Pc(n) {
...
function wa(n, t) {
  ...
  if (t == "DM") {
    let a = Rc(i, 3).toFixed(3).padStart(6, "0");
    return `${r}° ${a}'`;
  }
...
function Oc(n) {
  if (n.includes(",")) {
    ...
    return Pa(this.decimalLatitude, Number(t[0])) && Pa(this.decimalLongitude, t[1]);
  } else
...
function kc() {
  const n = [];
  return Dc.forEach((t) => {
    t.decimalLatitude ? n.push(t) : n.push({ ...t, ...Mc });
  }), [...n, ...Ac, ...Fc];
}
const Bc = kc();
Hs.formats = Bc.map((n) => n.verbatimCoordinates);
const Gc = Hs;
function Ra(n, t, e) {
  const r = n.slice();
  ...
  return {
    ...
    p(l, c) {
      ...
      17880064 && (a = Ea(
        /*listFeatures*/
        l[14]
      ), Go(), e = rc(e, c, u, 1, l, a, r, t, ec, Da, null, Ra), zo());
    },
    i(l) {
      if (!i) {
...
function Vc(n) {
  ...
  return e = new Eu({}), {
    c() {
      t = ht("div"), Tn(e.$$.fragment), r = Xe(), i = ht("div"), o = On(
        /*noResultsMessage*/
        n[7]
  ...
  return e = new Eu({}), u = new _u({}), {
    c() {
      t = ht("div"), Tn(e.$$.fragment), r = Xe(), i = ht("div"), o = On(
        /*errorMessage*/
        n[6]
      ), s = Xe(), a = ht("button"), Tn(u.$$.fragment), w(i, "class", "svelte-zh3kmv"), w(a, "class", "svelte-zh3kmv"), w(t, "class", "error svelte-zh3kmv");
    },
    m(h, g) {
...
function Da(n, t) {
  ...
  return r = new mc({
    ...
    first: null,
    c() {
      e = Yl(), Tn(r.$$.fragment), this.first = e;
    },
    m(a, u) {
...
function Xc(n) {
  ...
  return ~(d = at(n)) && (_ = G[d] = Y[d](n)), {
    c() {
      t = Xe(), e = ht("form"), r = ht("div"), i = ht("button"), Tn(o.$$.fragment), s = Xe(), a = ht("input"), u = Xe(), l = ht("div"), c = ht("button"), Tn(f.$$.fragment), h = Xe(), R && R.c(), g = Xe(), D && D.c(), p = Xe(), A && A.c(), v = Xe(), _ && _.c(), w(i, "class", "search-button svelte-zh3kmv"), w(i, "type", "button"), w(
        a,
        "placeholder",
        /*placeholder*/
        n[8]
        ...
        /*clearButtonTitle*/
        n[3]
      ), w(c, "class", "svelte-zh3kmv"), w(l, "class", "clear-button-container svelte-zh3kmv"), lr(
        l,
        "displayable",
        /*searchValue*/
        n[1] !== ""
    ...
    p(x, B) {
      ...
      524288 && Ft(R, 1) : (R = Oa(), R.c(), Ft(R, 1), R.m(l, null)) : R && (Go(), ee(R, 1, 1, () => {
        R = null;
      ...
      32 && Ft(D, 1)) : (D = Ta(x), D.c(), Ft(D, 1), D.m(r, p)) : D && (Go(), ee(D, 1, 1, () => {
        D = null;
...
function Yc(n, t, e) {
  ...
  function fa(S, Ut = !0, qe = !1) {
    e(1, G = S), Ut ? (e(15, Lt = -1), ga()) : (_s(!qe, qe), setTimeout(() => {
      Ur.focus(), Ur.select();
    }));
  }
  function yl() {
  ...
  let di = !1, it, Vt, Z, ha = "", Ur, Lt = -1, qr, Lo = [], jn, vi, bo, vs;
  const El = /* @__PURE__ */ new Set(), Sn = Kl();
  Ql(() => {
  ...
  async function ys(S, { byId: Ut = !1, exact: qe = !1 } = {}) {
    e(18, qr = void 0), jn == null || jn.abort();
    const rr = new AbortController();
    e(19, jn = rr);
    try {
      const ot = ms(S), nr = new URLSearchParams();
      if (C !== void 0 && nr.set("language", Array.isArray(C) ? C.join(",") : C ?? ""), zt && nr.set("types", zt.join(",")), Vr && nr.set("excludeTypes", String(Vr)), u && nr.set("bbox", u.map((Po) => Po.toFixed(6)).join(",")), h && nr.set("country", Array.isArray(h) ? h.join(",") : h), !Ut && !ot) {
        const Po = await wc(L, b, rr);
        Po && nr.set("proximity", Po), (qe || !B) && nr.set("autocomplete", "false"), nr.set("fuzzyMatch", String(I));
      }
      N !== void 0 && (!ot || (zt == null ? void 0 : zt.length) === 1) && nr.set("limit", String(N)), nr.set("key", a), ds(nr);
      const wo = Ue + "/" + encodeURIComponent(ot ? ot.decimalLongitude + "," + ot.decimalLatitude : S) + ".json?" + nr.toString();
      if (wo === ha) {
        Ut ? (e(14, it = void 0), e(55, Z = Lo[0])) : e(14, it = Lo);
        return;
      }
      ha = wo;
      const Cs = await fetch(wo, { signal: rr.signal, ...Nn });
      if (!Cs.ok)
        throw new Error(await Cs.text());
      const Is = await Cs.json();
      Sn("response", { url: wo, featureCollection: Is }), Ut ? (e(14, it = void 0), e(55, Z = Is.features[0]), Lo = [Z]) : (e(14, it = Is.features.filter(d)), ot && it.unshift({
        type: "Feature",
        properties: {},
  ...
  function Cl() {
    ...
    if (!(Vt != null && Vt.length) || !_)
      return;
    const S = [180, 90, -180, -90], Ut = !Vt.some((rr) => !rr.matching_text);
    for (const rr of Vt)
      if (Ut || !rr.matching_text)
        for (const ot of [0, 1, 2, 3])
          S[ot] = Math[ot < 2 ? "min" : "max"](S[ot], ((qe = rr.bbox) == null ? void 0 : qe[ot]) ?? rr.center[ot % 2]);
    L && Vt.length > 0 && (Z && S[0] === S[2] && S[1] === S[3] ? L.flyTo(Z.center, Ie) : L.fitBounds(Ia(S), 50, De));
  }
  function Il(S) {
    e(0, A = p === "always"), e(14, it = void 0), e(55, Z = void 0), e(15, Lt = -1), fa(S[1].toFixed(6) + ", " + bc(S[0], [-180, 180], !0).toFixed(6), !1, !0);
  }
  function Nl(S) {
    if (!it)
      return;
  ...
  return n.$$set = (S) => {
    ...
    16777344 && at && Z && !Z.address && Z.geometry.type === "Point" && Z.place_type[0] !== "reverse" && ys(Z.id, { byId: !0 }).catch((S) => e(18, qr = S)), n.$$.dirty[1] & /*mapController, picked, prevIdToFly, flyTo, maxZoom, zoom*/
    ...
    8388624 && L && L.setEventHandler((S) => {
      switch (S.type) {
        ...
        case "markerMouseEnter":
          Vt && e(15, Lt = bo ? (it == null ? void 0 : it.findIndex((Ut) => Ut.id === S.id)) ?? -1 : -1);
          break;
    ...
    81920 && Sn("optionsVisibilityChange", bo && !!it), n.$$.dirty[0] & /*listFeatures*/
...
var js = (
  ...
  function() {
    function n(t) {
      t === void 0 && (t = jc), this._root = null, this._size = 0, this._comparator = t;
    }
    return n.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = Ls(e, r, a, i) : s = Ls(e, r, s, i), this._root = Qc(s, a, i);
...
function be(n, t, e) {
  return t && Aa(n.prototype, t), e && Aa(n, e), n;
}
var Qi = function(t, e) {
...
var $c = wn * wn, Bs = function(t, e) {
  ...
  function n() {
    Ir(this, n), this.tree = new js(), this.round(0);
  }
  return be(n, [{
    key: "round",
    value: function(e) {
  ...
  var s = {
    x: r.x - t.x,
    y: r.y - t.y
  }, a = to(s, e) / o, u = to(s, i) / o, l = t.x + u * e.x, c = r.x + a * i.x, f = t.y + u * e.y, h = r.y + a * i.y, g = (l + c) / 2, p = (f + h) / 2;
  return {
    x: g,
    y: p
  };
  ...
  function n(t, e) {
    Ir(this, n), t.events === void 0 ? t.events = [this] : t.events.push(this), this.point = t, this.isLeft = e;
  }
  return be(n, [{
    key: "link",
    value: function(e) {
    ...
    value: function(e) {
      var r = this, i = /* @__PURE__ */ new Map(), o = function(a) {
        var u = a.otherSE;
        i.set(a, {
          sine: ef(r.point, e.point, u.point),
          cosine: rf(r.point, e.point, u.point)
        });
      };
      return function(s, a) {
  ...
  function n(t, e, r, i) {
    Ir(this, n), this.id = ++of, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = r, this.windings = i;
  }
  return be(n, [{
    key: "replaceRightSE",
    ...
    value: function(e) {
      ...
      if (o === null)
        return null;
      var s = this.leftSE.point, a = this.rightSE.point, u = e.leftSE.point, l = e.rightSE.point, c = Qi(r, u) && this.comparePoint(u) === 0, f = Qi(i, s) && e.comparePoint(s) === 0, h = Qi(r, l) && this.comparePoint(l) === 0, g = Qi(i, a) && e.comparePoint(a) === 0;
      if (f && c)
      ...
      if (h)
        return l;
      var p = nf(s, this.vector(), u, e.vector());
      return p === null || !Qi(o, p) ? null : no.round(p.x, p.y);
    }
    /**
  ...
  function n(t, e, r) {
    if (Ir(this, n), !Array.isArray(t) || t.length === 0)
  ...
  function n(t, e) {
    if (Ir(this, n), !Array.isArray(t))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new za(t[0], this, !0), this.bbox = {
      ll: {
  ...
  return be(n, [{
    ...
    value: function() {
      for (var e = this.events[0].point, r = [e], i = 1, o = this.events.length - 1; i < o; i++) {
        ...
        ka(s, e, a) !== 0 && (r.push(s), e = s);
      }
      if (r.length === 1)
        return null;
      var u = r[0], l = r[1];
      ka(u, e, l) === 0 && r.shift(), r.push(r[0]);
  ...
  function n(t) {
    Ir(this, n), this.exteriorRing = t, t.poly = this, this.interiorRings = [];
  }
  return be(n, [{
    key: "addInterior",
    value: function(e) {
  ...
  function n(t) {
    Ir(this, n), this.rings = t, this.polys = this._composePolys(t);
  }
  return be(n, [{
    key: "getGeom",
    value: function() {
      ...
      for (var r = [], i = 0, o = e.length; i < o; i++) {
        ...
        if (!s.poly)
          if (s.isExteriorRing())
            ...
            a.poly || r.push(new Ua(a)), a.poly.addInterior(s);
          }
      }
      return r;
    }
  ...
  function n(t) {
    ...
    Ir(this, n), this.queue = t, this.tree = new js(e), this.segments = [];
  }
  return be(n, [{
    key: "process",
    value: function(e) {
...
}(), qa = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, cf = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, ff = /* @__PURE__ */ function() {
  function n() {
    Ir(this, n);
  }
  return be(n, [{
    ...
    value: function(e, r, i) {
      br.type = e, no.reset();
      for (var o = [new Va(r, !0)], s = 0, a = i.length; s < a; s++)
        o.push(new Va(i[s], !1));
      ...
      for (var v = new js(Hr.compare), d = 0, _ = o.length; d < _; d++)
        for (var I = o[d].getSweepEvents(), C = 0, N = I.length; C < N; C++)
          if (v.insert(I[C]), v.size > qa)
            throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");
      for (var L = new lf(v), T = v.size, R = v.pop(); R; ) {
        var D = R.key;
        if (v.size === T) {
          var b = D.segment;
      ...
      no.reset();
      var x = af.factory(L.segments), B = new uf(x);
      return B.getGeom();
    }
  }]), n;
}(), br = new ff(), hf = function(t) {
...
function _f(n, t, e) {
  e === void 0 && (e = {});
  var r = Yo(n), i = Yo(t), o = Iu.union(r.coordinates, i.coordinates);
...
Nr.prototype.append = function(t) {
  this.str += t;
};
Nr.prototype.setCharAt = function(t, e) {
  this.str = this.str.substr(0, t) + e + this.str.substr(t + 1);
};
Nr.prototype.toString = function(t) {
  return this.str;
};
var hr = function(t) {
  this.value = t;
};
hr.prototype.intValue = function() {
  return this.value;
};
...
}, tr = { PI: { configurable: !0 }, TWO_PI: { configurable: !0 }, PI_2: { configurable: !0 }, E: { configurable: !0 }, NaN: { configurable: !0 }, EPS: { configurable: !0 }, SPLIT: { configurable: !0 }, MAX_PRINT_DIGITS: { configurable: !0 }, TEN: { configurable: !0 }, ONE: { configurable: !0 }, SCI_NOT_EXPONENT_CHAR: { configurable: !0 }, SCI_NOT_ZERO: { configurable: !0 } };
...
E.prototype.extractSignificantDigits = function(t, e) {
  ...
  for (var s = i + 1, a = new Nr(), u = E.MAX_PRINT_DIGITS - 1, l = 0; l <= u; l++) {
    t && l === s && a.append(".");
...
E.parse = function(t) {
  for (var e = 0, r = t.length; io.isWhitespace(t.charAt(e)); )
    e++;
  var i = !1;
  if (e < r) {
    var o = t.charAt(e);
...
is.prototype.read = function(t) {
  ...
  if (t.search("EMPTY") !== -1 && (o = ir.emptyTypeStr.exec(t), o[2] = void 0), o && (r = o[1].toLowerCase(), i = o[2], _i[r] && (e = _i[r].apply(this, [i]))), e === void 0)
...
var Yr = {
  ...
  multipoint: function(t) {
    ...
    for (var r, i = t.trim().split(","), o = [], s = 0, a = i.length; s < a; ++s)
      r = i[s].replace(ir.trimParens, "$1"), o.push(_i.point.apply(e, [r]));
  ...
  multilinestring: function(t) {
    ...
    for (var r, i = t.trim().split(ir.parenComma), o = [], s = 0, a = i.length; s < a; ++s)
      r = i[s].replace(ir.trimParens, "$1"), o.push(_i.linestring.apply(e, [r]));
  ...
  polygon: function(t) {
    ...
    for (var r, i, o, s = t.trim().split(ir.parenComma), a, u = [], l = 0, c = s.length; l < c; ++l)
      r = s[l].replace(ir.trimParens, "$1"), i = _i.linestring.apply(e, [r]), o = e.geometryFactory.createLinearRing(i._points), l === 0 ? a = o : u.push(o);
  ...
  multipolygon: function(t) {
    ...
    for (var r, i = t.trim().split(ir.doubleParenComma), o = [], s = 0, a = i.length; s < a; ++s)
      r = i[s].replace(ir.trimParens, "$1"), o.push(_i.polygon.apply(e, [r]));
...
cr.prototype.countSegment = function(t, e) {
...
cr.locatePointInRing = function() {
  if (arguments[0] instanceof m && V(arguments[1], K)) {
    for (var t = arguments[0], e = arguments[1], r = new cr(t), i = new m(), o = new m(), s = 1; s < e.size(); s++)
    ...
    for (var a = arguments[0], u = arguments[1], l = new cr(a), c = 1; c < u.length; c++) {
      var f = u[c], h = u[c - 1];
...
M.locatePointInRing = function(t, e) {
  return cr.locatePointInRing(t, e);
};
...
H.intersection = function(t, e) {
  for (var r = new Co(), i = 0; i < t.length; i++)
...
Jt.prototype.fixAfterInsertion = function(n) {
  ...
  for (n.color = xn; n != null && n !== this.root_ && n.parent.color === xn; )
    if (lt(n) === bs(lt(lt(n)))) {
      var e = Ha(lt(lt(n)));
      Wa(e) === xn ? (Xr(lt(n), jr), Xr(e, jr), Xr(lt(lt(n)), xn), n = lt(lt(n))) : (n === Ha(lt(n)) && (n = lt(n), t.rotateLeft(n)), Xr(lt(n), jr), Xr(lt(lt(n)), xn), t.rotateRight(lt(lt(n))));
    } else {
      var r = bs(lt(lt(n)));
      Wa(r) === xn ? (Xr(lt(n), jr), Xr(r, jr), Xr(lt(lt(n)), xn), n = lt(lt(n))) : (n === bs(lt(n)) && (n = lt(n), t.rotateRight(n)), Xr(lt(n), jr), Xr(lt(lt(n)), xn), t.rotateLeft(lt(lt(n))));
    }
  this.root_.color = jr;
};
...
gr.prototype = new Du();
gr.prototype.contains = function(n) {
...
gr.prototype.addAll = function(n) {
  for (var t = this, e = n.iterator(); e.hasNext(); )
    t.add(e.next());
  return !0;
};
gr.prototype.remove = function(n) {
  throw new Io();
};
...
var J = function() {
}, er = { P: { configurable: !0 }, L: { configurable: !0 }, A: { configurable: !0 }, FALSE: { configurable: !0 }, TRUE: { configurable: !0 }, DONTCARE: { configurable: !0 }, SYM_FALSE: { configurable: !0 }, SYM_TRUE: { configurable: !0 }, SYM_DONTCARE: { configurable: !0 }, SYM_P: { configurable: !0 }, SYM_L: { configurable: !0 }, SYM_A: { configurable: !0 } };
er.P.get = function() {
  return 0;
};
er.L.get = function() {
...
var ae = function(n) {
  ...
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    var i = this;
    if (arguments.length === 1) {
      var o = arguments[0], s = new gr(Pn.asList(this._geometries)), a = new gr(Pn.asList(o._geometries));
...
Ae.getStackTrace = function() {
  if (arguments.length === 1) {
    var t = arguments[0], e = new bf(), r = new Sf();
    return t.printStackTrace(r), e.toString();
  } else if (arguments.length === 2) {
    var i = arguments[0], o = arguments[1], s = "";
    new xf(Ae.getStackTrace(i));
    for (var a = new Pf(), u = 0; u < o; u++)
      try {
...
Be.prototype.editGeometryCollection = function(t, e) {
  ...
  return i.getClass() === wi ? this._factory.createMultiPoint(o.toArray([])) : i.getClass() === Mn ? this._factory.createMultiLineString(o.toArray([])) : i.getClass() === Pr ? this._factory.createMultiPolygon(o.toArray([])) : this._factory.createGeometryCollection(o.toArray([]));
};
...
tt.prototype.compareTo = function(t) {
  ...
  return new hr(r).compareTo(new hr(i));
};
...
dr.prototype.readResolve = function() {
  return dr.nameToTypeMap.get(this._name);
};
...
Object.defineProperties(dr, ea);
tt.Type = dr;
tt.FIXED = new dr("FIXED");
tt.FLOATING = new dr("FLOATING");
tt.FLOATING_SINGLE = new dr("FLOATING SINGLE");
var W = function n() {
...
var Rf = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], ls = function(t) {
  this.geometryFactory = t || new W();
};
ls.prototype.read = function(t) {
  ...
  return Rf.indexOf(r) !== -1 ? ar[r].apply(this, [e.coordinates]) : r === "GeometryCollection" ? ar[r].apply(this, [e.geometries]) : ar[r].apply(this, [e]);
};
...
var ar = {
  ...
  Feature: function(n) {
    ...
    return n.bbox && (t.bbox = ar.bbox.apply(this, [n.bbox])), t;
  },
  /**
  ...
  LineString: function(n) {
    var t = ar.coordinates.apply(this, [n]);
  ...
  MultiLineString: function(n) {
    for (var t = this, e = [], r = 0; r < n.length; ++r)
      e.push(ar.LineString.apply(t, [n[r]]));
   ...
   */
  Polygon: function(n) {
    for (var t = this, e = ar.coordinates.apply(this, [n[0]]), r = this.geometryFactory.createLinearRing(e), i = [], o = 1; o < n.length; ++o) {
      var s = n[o], a = ar.coordinates.apply(t, [s]), u = t.geometryFactory.createLinearRing(a);
      i.push(u);
    }
...
Sr.prototype.push = function(n) {
  return this.array_.push(n), n;
};
Sr.prototype.pop = function(n) {
...
Sr.prototype.search = function(n) {
...
vr.prototype.getRightmostSide = function(t, e) {
...
vr.prototype.findRightmostEdgeAtVertex = function() {
...
vr.prototype.getRightmostSideOfSegment = function(t, e) {
...
vr.prototype.getEdge = function() {
  return this._orientedDe;
};
vr.prototype.checkForRightmostCoordinate = function(t) {
...
vr.prototype.findRightmostEdgeAtNode = function() {
...
vr.prototype.findEdge = function(t) {
...
var ue = function() {
  this._finder = null, this._dirEdgeList = new O(), this._nodes = new O(), this._rightMostCoord = null, this._env = null, this._finder = new vr();
};
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.buildMinimalRings = function() {
    ...
    do {
      if (o.getMinEdgeRing() === null) {
        var s = new Of(o, r._geometryFactory);
        i.add(s);
      }
      o = o.getNext();
...
mr.prototype.getBoundaryNodes = function(t) {
...
var dt = function() {
  if (this._edges = new O(), this._nodes = null, this._edgeEndList = new O(), arguments.length === 0)
    this._nodes = new mr(new Pi());
  else if (arguments.length === 1) {
    var t = arguments[0];
    this._nodes = new mr(t);
  }
};
...
_e.prototype.buildMaximalEdgeRings = function(t) {
  for (var e = this, r = new O(), i = t.iterator(); i.hasNext(); ) {
    ...
    if (o.isInResult() && o.getLabel().isArea() && o.getEdgeRing() === null) {
      var s = new Tf(o, e._geometryFactory);
  ...
  if (arguments.length === 1) {
    ...
    if (V(arguments[2], pn) && arguments[0] instanceof Object && arguments[1] instanceof Mt)
      ...
      for (var h = arguments[0], g = arguments[1], p = arguments[2], v = g.getChildBoundables(), d = 0; d < v.size(); d++) {
        var _ = v.get(d);
        t.getIntersectsOp().intersects(_.getBounds(), h) && (_ instanceof Mt ? t.query(h, _, p) : _ instanceof Qe ? p.add(_.getItem()) : X.shouldNeverReachHere());
      }
  }
};
...
var Gu = function(n) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    if (arguments.length === 1) {
      ...
      var _ = arguments[0], I = arguments[1], C = arguments[2], N = new Qe(_, I), L = new bt(this.getRoot(), N, C);
...
fr.getChainStartIndices = function(t) {
  var e = 0, r = new O();
  r.add(new hr(e));
  do {
    var i = fr.findChainEnd(t, e);
    r.add(new hr(i)), e = i;
  } while (e < t.length - 1);
  var o = fr.toIntArray(r);
  return o;
};
fr.findChainEnd = function(t, e) {
...
fr.getChains = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return fr.getChains(t, null);
  } else if (arguments.length === 2) {
    for (var e = arguments[0], r = arguments[1], i = new O(), o = fr.getChainStartIndices(e), s = 0; s < o.length - 1; s++) {
...
var na = function(n) {
  ...
  return t.prototype.getMonotoneChains = function() {
    ...
    for (var o = this, s = fr.getChains(i.getCoordinates(), i), a = s.iterator(); a.hasNext(); ) {
      var u = a.next();
    ...
    for (var i = this, o = new Qa(this._segInt), s = this._monoChains.iterator(); s.hasNext(); )
...
yt.prototype.collapseLine = function() {
  for (var t = this, e = new Co(), r = 0; r < this._inputLine.length; r++)
...
ei.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (V(arguments[2], We) && arguments[0] instanceof m && arguments[1] instanceof Vs)
...
Ge.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof At ? this.addPolygon(t) : t instanceof mt ? this.addLineString(t) : t instanceof ye ? this.addPoint(t) : t instanceof wi ? this.addCollection(t) : t instanceof Mn ? this.addCollection(t) : t instanceof Pr ? this.addCollection(t) : t instanceof ae && this.addCollection(t);
};
...
yr.prototype.getSegmentIndex = function() {
  return this.segmentIndex;
};
yr.prototype.getCoordinate = function() {
  return this.coord;
};
yr.prototype.print = function(t) {
  t.print(this.coord), t.print(" seg # = " + this.segmentIndex), t.println(" dist = " + this.dist);
};
yr.prototype.compareTo = function(t) {
  var e = t;
  return this.compare(e.segmentIndex, e.dist);
};
yr.prototype.isEndPoint = function(t) {
...
yr.prototype.compare = function(t, e) {
...
Ar.prototype.add = function(t, e, r) {
  var i = new yr(t, e, r), o = this._nodeMap.get(i);
...
_r.prototype.checkEndPtVertexIntersections = function() {
  var t = this;
  if (arguments.length === 0)
...
_r.prototype.checkInteriorIntersections = function() {
  var t = this;
  if (arguments.length === 0)
    for (var e = this._segStrings.iterator(); e.hasNext(); )
...
_r.prototype.checkValid = function() {
  this.checkEndPtVertexIntersections(), this.checkInteriorIntersections(), this.checkCollapses();
};
_r.prototype.checkCollapses = function() {
  var t = this;
  if (arguments.length === 0)
    for (var e = this._segStrings.iterator(); e.hasNext(); ) {
      var r = e.next();
...
_r.prototype.hasInteriorIntersection = function(t, e, r) {
...
_r.prototype.checkCollapse = function(t, e, r) {
  if (t.equals(r))
    throw new Zr("found non-noded collapse at " + _r.fact.createLineString([t, e, r]));
};
...
Fr.prototype.checkCorrectness = function(t) {
  var e = xt.getNodedSubstrings(t), r = new _r(e);
  try {
    r.checkValid();
  } catch (i) {
    if (i instanceof Ou)
...
Xt.prototype.bufferFixedPrecision = function(t) {
  var e = new mn(new Fr(new tt(1)), t.getScale()), r = new se(this._bufParams);
...
Qu.INSIDE_AREA.get = function() {
  return -1;
};
Object.defineProperties(ie, Qu);
var ln = function(t) {
  this._pts = t || null;
};
...
ln.getPoints = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return t instanceof ye ? Ke.singletonList(t) : ln.getPoints(t, new O());
  } else if (arguments.length === 2) {
    var e = arguments[0], r = arguments[1];
...
ur.computeDistance = function() {
  if (arguments[2] instanceof Zt && arguments[0] instanceof mt && arguments[1] instanceof m)
    ...
    var u = arguments[0], l = arguments[1], c = arguments[2];
    ur.computeDistance(u.getExteriorRing(), l, c);
    for (var f = 0; f < u.getNumInteriorRing(); f++)
      ur.computeDistance(u.getInteriorRingN(f), l, c);
  } else if (arguments[2] instanceof Zt && arguments[0] instanceof z && arguments[1] instanceof m) {
    var h = arguments[0], g = arguments[1], p = arguments[2];
    if (h instanceof mt)
      ur.computeDistance(h, g, p);
    else if (h instanceof At)
      ur.computeDistance(h, g, p);
    else if (h instanceof ae)
      for (var v = h, d = 0; d < v.getNumGeometries(); d++) {
        var _ = v.getGeometryN(d);
        ur.computeDistance(_, g, p);
      }
    else
      p.setMinimum(h.getCoordinate(), g);
...
var oi = function() {
  this._maxPtDist = new Zt(), this._minPtDist = new Zt(), this._euclideanDist = new ur(), this._geom = null;
  var t = arguments[0];
  this._geom = t;
};
oi.prototype.filter = function(t) {
  this._minPtDist.initialize(), ur.computeDistance(this._geom, t, this._minPtDist), this._maxPtDist.setMaximum(this._minPtDist);
};
...
_n.prototype.filter = function(t, e) {
  ...
  for (var i = t.getCoordinate(e - 1), o = t.getCoordinate(e), s = (o.x - i.x) / this._numSubSegs, a = (o.y - i.y) / this._numSubSegs, u = 0; u < this._numSubSegs; u++) {
    ...
    r._minPtDist.initialize(), ur.computeDistance(r._geom, f, r._minPtDist), r._maxPtDist.setMaximum(r._minPtDist);
  }
};
...
Er.prototype.getCoordinate = function(t) {
  return this._pts[t];
};
Er.prototype.isClosed = function() {
  return this._pts[0].equals(this._pts[this._pts.length - 1]);
};
Er.prototype.getSegmentOctant = function(t) {
  return t === this._pts.length - 1 ? -1 : ti.octant(this.getCoordinate(t), this.getCoordinate(t + 1));
};
Er.prototype.setData = function(t) {
  this._data = t;
};
...
var zn = function n() {
  this._nv = null;
  var t = arguments[0];
  this._nv = new $e(n.toSegmentStrings(t));
};
...
zn.toSegmentStrings = function(t) {
  for (var e = new O(), r = t.iterator(); r.hasNext(); ) {
    var i = r.next();
    e.add(new Er(i.getCoordinates(), i));
  }
  return e;
};
...
Cr.prototype.collectLines = function(t) {
...
Cr.prototype.labelIsolatedLine = function(t, e) {
...
Cr.prototype.labelIsolatedLines = function(t) {
  for (var e = this, r = t.iterator(); r.hasNext(); ) {
    var i = r.next(), o = i.getLabel();
    i.isIsolated() && (o.isNull(0) ? e.labelIsolatedLine(i, 0) : e.labelIsolatedLine(i, 1));
  }
};
Cr.prototype.buildLines = function(t) {
...
Cr.prototype.collectBoundaryTouchEdge = function(t, e, r) {
  var i = t.getLabel();
...
Ct.prototype.extractTargetCoordinates = function(t) {
  for (var e = new gr(), r = t.getCoordinates(), i = 0; i < r.length; i++)
    e.add(r[i]);
...
var Af = function(n) {
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.prepareEvents = function() {
    ...
    for (var o = this, s = r.getMonotoneChainEdge(), a = s.getStartIndexes(), u = 0; u < a.length - 1; u++) {
      var l = new vo(s, u), c = new Ce(i, s.getMinX(u), l);
...
Gr.prototype.buildTree = function() {
  var t = this;
  Ke.sort(this._leaves, new Br.NodeComparator());
...
Gr.prototype.buildLevel = function(t, e) {
  ...
  for (var r = 0; r < t.size(); r += 2) {
    ...
    if (o === null)
      ...
      var s = new kf(t.get(r), t.get(r + 1));
      e.add(s);
    }
  }
};
...
var Ki = function(n) {
  function t() {
    if (n.call(this), this._parentGeom = null, this._lineEdgeMap = new Au(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new Je(), arguments.length === 2) {
...
var q = function(n) {
  function t() {
    var e = arguments[0], r = arguments[1];
    n.call(this, e, r), this._ptLocator = new Je(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new Ze(), this._resultPolyList = new O(), this._resultLineList = new O(), this._resultPointList = new O(), this._graph = new dt(new qu()), this._geomFact = e.getFactory();
  }
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.insertUniqueEdge = function(r) {
    ...
    var s = new Cr(this, this._geomFact, this._ptLocator);
...
Zo.prototype = {
  ...
  add: function(n) {
    Ka(Do, n, this.t), Ka(this, Do.s, this.s), this.s ? this.t += Do.t : this.s = Do.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var vt = 1e-6, ut = Math.PI, Qr = ut / 2, Za = ut / 4, rn = ut * 2, Ln = 180 / ut, or = ut / 180, oe = Math.abs, Bf = Math.atan, Gi = Math.atan2, Tt = Math.cos, Dt = Math.sin, Wi = Math.sqrt;
function el(n) {
...
function Gf(n, t) {
  n && Ja.hasOwnProperty(n.type) ? Ja[n.type](n, t) : Jo(n, t);
}
Hn();
Hn();
function qs(n) {
...
Ys.invert = Ys;
function zf(n, t, e) {
  return (n %= rn) ? t || e ? rl(ru(n), nu(t, e)) : ru(n) : t || e ? nu(t, e) : Ys;
}
function eu(n) {
  return function(t, e) {
...
function Vf(n, t, e, r, i, o) {
  if (e) {
    ...
    i == null ? (i = t + r * rn, o = t - u / 2) : (i = iu(s, i), o = iu(s, o), (r > 0 ? i < o : i > o) && (i += r * rn));
...
function il(n, t, e, r, i) {
  ...
  if (n.forEach(function(p) {
    ...
    for (s.sort(t), ou(o), ou(s), a = 0, u = s.length; a < u; ++a)
      s[a].e = e = !e;
    for (var l = o[0], c, f; ; ) {
      for (var h = l, g = !0; h.v; )
        if ((h = h.n) === l)
...
function Yf(n, t, e, r) {
  ...
  return function(l) {
    var c = l, f = nl(), h, g, p, v, d, _, I, C, N, L, T, R = {
      point: D,
      lineStart: G,
      lineEnd: at,
      polygonStart: A,
    ...
    function b() {
      for (var B = 0, Q = 0, _t = g.length; Q < _t; ++Q)
        for (var Kt = g[Q], zt = 1, Vr = Kt.length, Ie = Kt[0], De, Ue, Nn = Ie[0], sn = Ie[1]; zt < Vr; ++zt)
    ...
    function Y() {
      var B = b(), Q = T && B, _t = (h = sl(h)).length;
      (Q || _t) && (l.polygonStart(), Q && (l.lineStart(), o(null, null, 1, l), l.lineEnd()), _t && il(h, a, B, o, l), l.polygonEnd()), c = l, h = g = p = null;
    }
    function G() {
    ...
    function x(B, Q) {
      ...
      if (g && p.push([B, Q]), L)
        ...
        var Kt = [I = Math.max(ko, Math.min(Ji, I)), C = Math.max(ko, Math.min(Ji, C))], zt = [B = Math.max(ko, Math.min(Ji, B)), Q = Math.max(ko, Math.min(Ji, Q))];
        Uf(Kt, zt, n, t, e, r) ? (N || (c.lineStart(), c.point(Kt[0], Kt[1])), c.point(zt[0], zt[1]), _t || c.lineEnd(), T = !1) : _t && (c.lineStart(), c.point(B, Q), T = !1);
      }
      I = B, C = Q, N = _t;
    }
    return R;
...
function Wf(n, t) {
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + Za, p = Dt(g), v = Tt(g), d = 0; d < c; ++d, h = I, p = N, v = L, f = _) {
        var _ = l[d], I = _[0], C = _[1] / 2 + Za, N = Dt(C), L = Tt(C), T = I - h, R = T >= 0 ? 1 : -1, D = R * T, b = D > ut, A = p * N;
...
Hn();
Hn();
var Vi = 1 / 0, ts = Vi, yo = -Vi, es = yo, au = {
  point: Hf,
  lineStart: Zi,
  lineEnd: Zi,
  polygonStart: Zi,
  ...
  result: function() {
    var n = [[Vi, ts], [yo, es]];
    return yo = es = -(ts = Vi = 1 / 0), n;
  }
};
function Hf(n, t) {
  n < Vi && (Vi = n), n > yo && (yo = n), t < ts && (ts = t), t > es && (es = t);
}
Hn();
function al(n, t, e, r) {
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = nl(), l = t(u), c = !1, f, h, g, p = {
      ...
      polygonEnd: function() {
        p.point = v, p.lineStart = _, p.lineEnd = I, h = sl(h);
        var T = Wf(f, a);
    ...
    function L() {
      ...
      if (g.pop(), f.push(g), g = null, !!b) {
        ...
        b > 1 && T & 2 && R.push(R.pop().concat(R.shift())), h.push(R.filter(jf));
      }
    }
    return p;
  };
...
function Kf(n) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      oe(u - ut) < vt ? (n.point(t, e = (e + s) / 2 > 0 ? Qr : -Qr), n.point(r, e), n.lineEnd(), n.lineStart(), n.point(a, e), n.point(o, e), i = 0) : r !== a && u >= ut && (oe(t - r) < vt && (t -= r * vt), oe(o - a) < vt && (o -= a * vt), e = Zf(t, e, o, s), n.point(r, e), n.lineEnd(), n.lineStart(), n.point(a, e), i = 0), n.point(t = o, e = s), r = a;
    },
    lineEnd: function() {
      n.lineEnd(), t = e = NaN;
    },
...
function Zf(n, t, e, r) {
  var i, o, s = Dt(n - e);
  return oe(s) > vt ? Bf((Dt(t) * (o = Tt(r)) * Dt(e) - Dt(r) * (i = Tt(t)) * Dt(n)) / (i * o * s)) : (t + r) / 2;
}
function Jf(n, t, e, r) {
  var i;
  if (n == null)
...
function $f(n, t) {
  ...
  function u(c, f, h) {
    ...
    if (!(G < 0)) {
      ...
      Q < B && (zt = B, B = Q, Q = zt);
      var Vr = Q - B, Ie = oe(Vr - ut) < vt, De = Ie || Vr < vt;
      if (!Ie && Kt < _t && (zt = _t, _t = Kt, Kt = zt), De ? Ie ? _t + Kt > 0 ^ x[1] < (oe(x[0] - B) < vt ? _t : Kt) : _t <= x[1] && x[1] <= Kt : Vr > ut ^ (B <= x[0] && x[0] <= Q)) {
        var Ue = Ao(b, (-A + at) / Y);
...
function ll(n, t, e) {
  ...
  n.scale(150).translate([0, 0]), o != null && n.clipExtent(null), Gf(e, n.stream(au));
  var s = au.result(), a = Math.min(r / (s[1][0] - s[0][0]), i / (s[1][1] - s[0][1])), u = +t[0][0] + (r - a * (s[1][0] + s[0][0])) / 2, l = +t[0][1] + (i - a * (s[1][1] + s[0][1])) / 2;
  return o != null && n.clipExtent(o), n.scale(a * 150).translate([u, l]);
}
function th(n, t, e) {
  return ll(n, [[0, 0], t], e);
}
var lu = 16, eh = Tt(30 * or);
function cu(n, t) {
  return +t ? nh(n, t) : rh(n);
}
function rh(n) {
  return ul({
    point: function(t, e) {
...
function nh(n, t) {
  function e(r, i, o, s, a, u, l, c, f, h, g, p, v, d) {
    ...
    if (C > 4 * t && v--) {
      ...
      (B * B / C > t || oe((_ * at + I * x) / C - 0.5) > 0.3 || s * h + a * g + u * p < eh) && (e(r, i, o, s, a, u, Y, G, b, N /= R, L /= R, T, v, d), d.point(Y, G), e(Y, G, b, N, L, T, l, c, f, h, g, p, v, d));
    }
  }
  return function(r) {
    ...
    function C(D, b) {
      ...
      e(f, h, c, g, p, v, f = Y[0], h = Y[1], c = D, g = A[0], p = A[1], v = A[2], lu, r), r.point(f, h);
    }
    function N() {
      d.point = _, r.lineEnd();
    }
    ...
    function R() {
      e(f, h, c, g, p, v, o, s, i, a, u, l, lu, r), d.lineEnd = N, N();
    }
    return d;
  };
}
...
function sh(n) {
  var t, e = 150, r = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, g, p = null, v = uu, d = null, _, I, C, N = su, L = 0.5, T = cu(Y, L), R, D;
  function b(x) {
  ...
  b.stream = function(x) {
    return R && D === x ? R : R = ih(v(h, T(N(D = x))));
  }, b.clipAngle = function(x) {
    return arguments.length ? (v = +x ? $f(p = x * or, 6 * or) : (p = null, uu), at()) : p * Ln;
  }, b.clipExtent = function(x) {
    return arguments.length ? (N = x == null ? (d = _ = I = C = null, su) : Yf(d = +x[0][0], _ = +x[0][1], I = +x[1][0], C = +x[1][1]), at()) : d == null ? null : [[d, _], [I, C]];
  }, b.scale = function(x) {
    return arguments.length ? (e = +x, G()) : e;
  }, b.translate = function(x) {
    return arguments.length ? (r = +x[0], i = +x[1], G()) : [r, i];
  }, b.center = function(x) {
    return arguments.length ? (a = x[0] % 360 * or, u = x[1] % 360 * or, G()) : [a * Ln, u * Ln];
  }, b.rotate = function(x) {
    return arguments.length ? (l = x[0] % 360 * or, c = x[1] % 360 * or, f = x.length > 2 ? x[2] % 360 * or : 0, G()) : [l * Ln, c * Ln, f * Ln];
  }, b.precision = function(x) {
    return arguments.length ? (T = cu(Y, L = x * x), at()) : Wi(L);
...
var ah = cl(function(n) {
  return Wi(2 / (1 + n));
});
ah.invert = fl(function(n) {
  return 2 * li(n / 2);
});
...
function uh() {
  return oh(hl).scale(79.4188).clipAngle(180 - 1e-3);
}
function fu(n, t) {
  return [n, t];
}
...
function Uo(n, t, e, r) {
  ...
  }, l = new ra(), c = l.read(u), f = mf(yf(t, e), "meters"), h = Xt.bufferOp(c, f, r), g = new ku();
...
function ch(n) {
  var t = Ef(n).geometry.coordinates, e = [-t[0], -t[1]];
  return uh().rotate(e).scale(Ne);
}
function fh(n, t) {
  var e = Yo(n), r = Yo(t), i = n.properties || {}, o = Iu.difference(
    e.coordinates,
    r.coordinates
  );
...
function hh(n, t = !0, e = !0, r = {}, i = {}, o = (s) => {
  ...
  function h(g, p = !1) {
    ...
    return new Ic({ props: { displayIn: "leaflet" }, target: v }), new an.Marker(g, {
      interactive: p,
      icon: new an.DivIcon({
        html: v,
        className: "",
...
class gh extends an.Control {
  ...
  onAdd(e) {
    ...
    const {
      ...
      fullGeometryStyle: a,
      ...u
    } = xr(this, Kn), l = typeof s == "boolean" ? {} : s, c = hh(
      e,
      i,
      o,
      l,
  ...
  setOptions(e) {
    ...
    (u = xr(this, sr)) == null || u.$set(a);
  }
  setQuery(e, r = !0) {
    var i;
    (i = xr(this, sr)) == null || i.setQuery(e, r);
  }
  clearMap() {
    var e;
    (e = xr(this, sr)) == null || e.clearMap();
  }
  clearList() {
    var e;
    (e = xr(this, sr)) == null || e.clearList();
  }
  focus() {
    var e;
    (e = xr(this, sr)) == null || e.focus();
  }
  blur() {
    var e;
    (e = xr(this, sr)) == null || e.blur();
  }
  onRemove() {
    var e;
    (e = xr(this, sr)) == null || e.$destroy();
  }
}
sr = new WeakMap(), Kn = new WeakMap();
function ph(...n) {
  return new gh(...n);
}
window.L && typeof window.L == "object" && typeof window.L.control == "function" && (window.L.control.maptilerGeocoding = ph);
export {
  gh as GeocodingControl,
  hh as createLeafletMapController
};
