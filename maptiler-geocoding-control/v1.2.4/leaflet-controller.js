...
var Ka = Hr * Hr, bo = function(t, e) {
  ...
  return ae(n, [{
    ...
    value: function(e, r, i) {
      ...
      for (var D = new iu(m), R = m.size, F = m.pop(); F; ) {
        var G = F.key;
        if (m.size === R) {
          var M = G.segment;
...
var sn = function(n) {
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.isInSegmentEnvelopes = function(r) {
    ...
    var u = r.x < i.x ? r.x : i.x, l = r.y < i.y ? r.y : i.y, c = r.x > i.x ? r.x : i.x, f = r.y > i.y ? r.y : i.y, h = o.x < s.x ? o.x : s.x, p = o.y < s.y ? o.y : s.y, g = o.x > s.x ? o.x : s.x, m = o.y > s.y ? o.y : s.y, v = u > h ? u : h, E = c < g ? c : g, I = l > p ? l : p, C = f < m ? f : m, S = (v + E) / 2, D = (I + C) / 2;
    ...
    if (arguments[2] instanceof Array && arguments[0] instanceof ut && arguments[1] instanceof te) {
      ...
      for (var g = f.getCoordinates(), m = h.getCoordinates(), v = 0; v < g.length - 1; v++)
        for (var E = 0; E < m.length - 1; E++) {
          ...
          if (I < t._minDistance) {
            t._minDistance = I;
            var C = new b(g[v], g[v + 1]), S = new b(m[E], m[E + 1]), D = C.closestPoints(S);
            p[0] = new zt(f, v, D[0]), p[1] = new zt(h, E, D[1]);
          }
          if (t._minDistance <= t._terminateDistance)
            return null;
        }
...
function sl(n, t, e, r) {
  ...
  return function(l) {
    var c = l, f = Pa(), h, p, g, m, v, E, I, C, S, D, R, F = {
      point: G,
      lineStart: nt,
      lineEnd: ct,
      polygonStart: et,
    ...
    function nt() {
      F.point = w, p && p.push(g = []), D = !0, S = !1, I = C = NaN;
    }
    function ct() {
    ...
    function w(X, ft) {
      var Gt = i(X, ft);
      if (p && g.push([X, ft]), D)
        m = X, v = ft, E = Gt, D = !1, Gt && (c.lineStart(), c.point(X, ft));
      else if (Gt && S)
        c.point(X, ft);
      else {
...
function al(n, t) {
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], p = f[1] / 2 + Ss, g = It(p), m = Et(p), v = 0; v < c; ++v, h = I, g = S, m = D, f = E) {
        var E = l[v], I = E[0], C = E[1] / 2 + Ss, S = It(C), D = Et(C), R = I - h, F = R >= 0 ? 1 : -1, G = F * R, M = G > Z, et = g * S;
        if (No.add(Jn(et * F * It(G), m * D + et * Et(G))), o += M ? R + F * Sr : R, M ^ h >= e ^ I >= e) {
          var K = to(Zn(f), Zn(E));
          Bo(K);
          var nt = to(i, K);
          Bo(nt);
  ...
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = Pa(), l = t(u), c = !1, f, h, p, g = {
      ...
      polygonStart: function() {
        g.point = C, g.lineStart = S, g.lineEnd = D, h = [], f = [];
      },
      polygonEnd: function() {
...
function gl(n, t) {
  ...
  function a(c) {
    ...
    return {
      ...
      point: function(v, E) {
        var I = [v, E], C, S = s(v, E), D = r ? S ? 0 : l(v, E) : S ? l(v + (v < 0 ? Z : -Z), E) : 0;
        if (!f && (g = p = S) && c.lineStart(), S !== p && (C = u(f, I), (!C || Ui(f, C) || Ui(I, C)) && (I[0] += at, I[1] += at, S = s(I[0], I[1]))), S !== p)
          ...
          var R;
          !(D & h) && (R = u(I, f, !0)) && (m = 0, r ? (c.lineStart(), c.point(R[0][0], R[0][1]), c.point(R[1][0], R[1][1]), c.lineEnd()) : (c.point(R[1][0], R[1][1]), c.lineEnd(), c.lineStart(), c.point(R[0][0], R[0][1])));
        }
        S && (!f || !Ui(f, I)) && c.point(I[0], I[1]), f = I, p = S, h = D;
      },
      lineEnd: function() {
        p && c.lineEnd(), f = null;
      },
  ...
  function u(c, f, h) {
    ...
    if (!C)
      return !h && c;
    var S = e * E / C, D = -e * I / C, R = to(m, v), F = Vi(m, S), G = Vi(v, D);
    Co(F, G);
...
function ml(n, t) {
  function e(r, i, o, s, a, u, l, c, f, h, p, g, m, v) {
    ...
    if (C > 4 * t && m--) {
      var S = s + h, D = a + p, R = u + g, F = ii(S * S + D * D + R * R), G = In(R /= F), M = Ut(Ut(R) - 1) < at || Ut(o - f) < at ? (o + f) / 2 : Jn(D, S), et = n(M, G), K = et[0], nt = et[1], ct = K - r, w = nt - i, X = I * ct - E * w;
      (X * X / C > t || Ut((E * ct + I * w) / C - 0.5) > 0.3 || s * h + a * p + u * g < vl) && (e(r, i, o, s, a, u, K, nt, M, S /= F, D /= F, R, m, v), v.point(K, nt), e(K, nt, M, S, D, R, l, c, f, h, p, g, m, v));
    }
  }
  return function(r) {
...
function Il(n) {
  var t, e = 150, r = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, p, g = null, m = Fs, v = null, E, I, C, S = Ms, D = 0.5, R = Gs(K, D), F, G;
  function M(w) {
  ...
  M.stream = function(w) {
    return F && G === w ? F : F = _l(m(h, R(S(G = w))));
    ...
    return arguments.length ? (R = Gs(K, D = w * w), ct()) : ii(D);
