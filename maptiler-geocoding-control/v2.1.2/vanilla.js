...
function Gn(i, e, t) {
  ...
  const Nt = void 0;
  let { reverseGeocodingExcludeTypes: qe = Nt } = e, { zoom: Qe = d } = e, { apiUrl: rt = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: st = {} } = e, { iconsBaseUrl: kt = "https://cdn.maptiler.com/maptiler-geocoding-control/v2.1.2/icons/" } = e, { adjustUrlQuery: ot = () => {
  } } = e, { adjustUrl: at = () => {
  } } = e;
  function di(o) {
    ne.focus(o);
