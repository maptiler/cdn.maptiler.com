...
function is(i, e, t) {
  ...
  const be = void 0;
  let { reverseGeocodingExcludeTypes: Ce = be } = e, { zoom: ge = g } = e, { apiUrl: ce = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: J = {} } = e, { iconsBaseUrl: di = "https://cdn.maptiler.com/maptiler-geocoding-control/v2.1.2/icons/" } = e, { adjustUrlQuery: Ut = () => {
  } } = e, { adjustUrl: qt = () => {
  } } = e;
  function vn(L) {
    Me.focus(L);
