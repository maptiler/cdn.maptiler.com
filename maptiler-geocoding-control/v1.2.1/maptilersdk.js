...
var Is = (n, t, e) => (kl(n, typeof t != "symbol" ? t + "" : t, e), e), ga = (n, t, e) => {
  if (!t.has(n))
    throw TypeError("Cannot " + e);
};
var nr = (n, t, e) => (ga(n, t, "read from private field"), e ? e.call(n) : t.get(n)), Ns = (n, t, e) => {
  if (t.has(n))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(n) : t.set(n, e);
}, wo = (n, t, e, r) => (ga(n, t, "write to private field"), r ? r.call(n, e) : t.set(n, e), e);
import * as Bl from "@maptiler/sdk";
function It() {
}
function Gl(n, t) {
  for (const e in t)
...
const mi = [], Ps = [];
let _i = [];
const ya = [], Zl = /* @__PURE__ */ Promise.resolve();
let Rs = !1;
function Jl() {
  Rs || (Rs = !0, Zl.then(mu));
}
...
function mu() {
  ...
  do {
    ...
    for (Zi(null), mi.length = 0, vi = 0; Ps.length; )
      Ps.pop()();
...
function fn(n, t) {
  const e = n.$$;
  e.fragment !== null && (tc(e.after_update), Cn(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function nc(n, t) {
  n.$$.dirty[0] === -1 && (mi.push(n), Jl(), n.$$.dirty.fill(0)), n.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function qn(n, t, e, r, i, o, s = null, a = [-1]) {
  ...
  if (l.ctx = e ? e(n, t.props || {}, (f, h, ...g) => {
    ...
    t.intro && Ft(n.$$.fragment), cn(n, t.target, t.anchor), mu();
  }
  Zi(u);
}
class Xn {
...
function dc(n) {
  ...
  return {
    ...
    m(b, A) {
      Pt(b, t, A), L.m(t, null), rt(t, o), rt(t, s), rt(s, a), rt(a, u), rt(u, c), rt(a, f), T && T.m(a, null), rt(s, g), rt(s, p), rt(p, d), y || (I = [
        Se(
          t,
          "mouseenter",
          /*mouseenter_handler*/
...
function Ec(n) {
  ...
  return {
    c() {
      ...
      n[0] === "list" ? 20 : void 0), w(t, "viewBox", "0 0 70 85"), w(t, "fill", "none"), w(t, "class", "svelte-gzo3ar"), ur(
        t,
        "in-map",
        /*displayIn*/
        n[0] !== "list"
...
class Ic extends Xn {
  constructor(t) {
    super(), qn(this, t, Cc, Ec, Un, { displayIn: 0 });
  }
}
function Nc(n) {
  let t, e;
...
function xc(n) {
  ...
  return {
    c() {
      t = Lr("svg"), e = Lr("circle"), r = Lr("path"), w(e, "cx", "4.789"), w(e, "cy", "4.787"), w(e, "r", "3.85"), Ro(e, "stroke-width", "1.875"), Ro(e, "fill", "none"), w(r, "d", "M12.063 12.063 7.635 7.635"), Ro(r, "stroke-width", "1.875"), Ro(r, "stroke-linecap", "round"), w(t, "xmlns", "http://www.w3.org/2000/svg"), w(t, "width", "13"), w(t, "height", "13"), w(t, "viewBox", "0 0 13 13"), w(t, "class", "svelte-1bpbt60");
    },
    m(i, o) {
...
const Ia = /(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?/i, Na = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?/i, Sa = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?/i, xa = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?/i;
function Pc(n) {
...
function Oc(n) {
  if (n.includes(",")) {
    ...
    return ba(this.decimalLatitude, Number(t[0])) && ba(this.decimalLongitude, t[1]);
  } else
...
const Bc = kc();
Ws.formats = Bc.map((n) => n.verbatimCoordinates);
const Gc = Ws;
function wa(n, t, e) {
  const r = n.slice();
  ...
  return {
    ...
    p(l, c) {
      ...
      17880064 && (a = _a(
        /*listFeatures*/
        l[14]
      ), Bo(), e = rc(e, c, u, 1, l, a, r, t, ec, Oa, null, wa), Go());
    },
    i(l) {
      if (!i) {
  ...
  return e = new _u({}), u = new yu({}), {
    c() {
      t = ht("div"), On(e.$$.fragment), r = Xe(), i = ht("div"), o = Rn(
        /*errorMessage*/
        n[6]
      ), s = Xe(), a = ht("button"), On(u.$$.fragment), w(i, "class", "svelte-zh3kmv"), w(a, "class", "svelte-zh3kmv"), w(t, "class", "error svelte-zh3kmv");
    },
    m(h, g) {
...
function Oa(n, t) {
  ...
  return r = new mc({
    ...
    first: null,
    c() {
      e = Yl(), On(r.$$.fragment), this.first = e;
    },
    m(a, u) {
...
function Xc(n) {
  let t, e, r, i, o, s, a, u, l, c, f, h, g, p, v, d, y, I, C, N, L, T = !1;
  o = new Lc({}), f = new yu({});
  let R = (
    /*abortController*/
    n[19] && Pa()
  ...
  return ~(d = at(n)) && (y = G[d] = Y[d](n)), {
    c() {
      t = Xe(), e = ht("form"), r = ht("div"), i = ht("button"), On(o.$$.fragment), s = Xe(), a = ht("input"), u = Xe(), l = ht("div"), c = ht("button"), On(f.$$.fragment), h = Xe(), R && R.c(), g = Xe(), D && D.c(), p = Xe(), A && A.c(), v = Xe(), y && y.c(), w(i, "class", "search-button svelte-zh3kmv"), w(i, "type", "button"), w(
        a,
        "placeholder",
        /*placeholder*/
        n[8]
        ...
        /*clearButtonTitle*/
        n[3]
      ), w(c, "class", "svelte-zh3kmv"), w(l, "class", "clear-button-container svelte-zh3kmv"), ur(
        l,
        "displayable",
        /*searchValue*/
        n[1] !== ""
      ), w(r, "class", "input-group svelte-zh3kmv"), w(e, "tabindex", "0"), w(e, "class", I = da(
        /*className*/
        n[2]
      ) + " svelte-zh3kmv"), ur(
        e,
    ...
    m(x, B) {
      Pt(x, t, B), Pt(x, e, B), rt(e, r), rt(r, i), cn(o, i, null), rt(r, s), rt(r, a), n[61](a), va(
        ...
        /*searchValue*/
        n[1]
      ), rt(r, u), rt(r, l), rt(l, c), cn(f, c, null), rt(l, h), R && R.m(l, null), rt(r, g), D && D.m(r, null), rt(r, p), A && A.m(r, null), rt(e, v), ~d && G[d].m(e, null), C = !0, N || (L = [
        Se(
          i,
          "click",
          /*click_handler*/
    ...
    p(x, B) {
      ...
      524288 && Ft(R, 1) : (R = Pa(), R.c(), Ft(R, 1), R.m(l, null)) : R && (Bo(), ee(R, 1, 1, () => {
        R = null;
      }), Go()), (!C || B[0] & /*searchValue*/
      2) && ur(
        l,
        "displayable",
        /*searchValue*/
      ...
      32 && Ft(D, 1)) : (D = Ra(x), D.c(), Ft(D, 1), D.m(r, p)) : D && (Bo(), ee(D, 1, 1, () => {
        D = null;
      }), Go()), A && A.p && (!C || B[1] & /*$$scope*/
      134217728) && ql(
        A,
        b,
        x,
      ...
      let K = d;
      d = at(x), d === K ? ~d && G[d].p(x, B) : (y && (Bo(), ee(G[K], 1, 1, () => {
        G[K] = null;
      }), Go()), ~d ? (y = G[d], y ? y.p(x, B) : (y = G[d] = Y[d](x), y.c()), Ft(y, 1), y.m(e, null)) : y = null), (!C || B[0] & /*className*/
      4 && I !== (I = da(
        /*className*/
        x[2]
    ...
    i(x) {
      C || (Ft(T), Ft(o.$$.fragment, x), Ft(f.$$.fragment, x), Ft(R), Ft(D), Ft(A, x), Ft(y), C = !0);
    },
    o(x) {
      ee(T), ee(o.$$.fragment, x), ee(f.$$.fragment, x), ee(R), ee(D), ee(A, x), ee(y), C = !1;
    },
    d(x) {
...
function Yc(n, t, e) {
  ...
  function ca(S, Ut = !0) {
    e(1, G = S), Ut ? (e(15, Lt = -1), ha()) : (ys(), setTimeout(() => {
      zr.focus(), zr.select();
    }));
  }
  function ml() {
  ...
  let pi = !1, it, Vt, Z, fa = "", zr, Lt = -1, Vr, So = [], Hn, di, xo, ds;
  const _l = /* @__PURE__ */ new Set(), Nn = Ql();
  Kl(() => {
  ...
  async function ms(S, { byId: Ut = !1, exact: Ur = !1 } = {}) {
    e(18, Vr = void 0), Hn == null || Hn.abort();
    const qr = new AbortController();
    e(19, Hn = qr);
    try {
      const ot = vs(S), rr = new URLSearchParams();
      if (C !== void 0 && rr.set("language", Array.isArray(C) ? C.join(",") : C ?? ""), zt && rr.set("types", zt.join(",")), Gr && rr.set("excludeTypes", String(Gr)), u && rr.set("bbox", u.map((bo) => bo.toFixed(6)).join(",")), h && rr.set("country", Array.isArray(h) ? h.join(",") : h), !Ut && !ot) {
        const bo = await wc(L, b, qr);
        bo && rr.set("proximity", bo), (Ur || !B) && rr.set("autocomplete", "false"), rr.set("fuzzyMatch", String(I));
      }
      N !== void 0 && (!ot || (zt == null ? void 0 : zt.length) === 1) && rr.set("limit", String(N)), rr.set("key", a), ps(rr);
      const Lo = Ue + "/" + encodeURIComponent(ot ? ot.decimalLongitude + "," + ot.decimalLatitude : S) + ".json?" + rr.toString();
      if (Lo === fa) {
        Ut ? (e(14, it = void 0), e(55, Z = So[0])) : e(14, it = So);
        return;
      }
      fa = Lo;
      const Es = await fetch(Lo, { signal: qr.signal, ...In });
      if (!Es.ok)
        throw new Error(await Es.text());
      const Cs = await Es.json();
      Nn("response", { url: Lo, featureCollection: Cs }), Ut ? (e(14, it = void 0), e(55, Z = Cs.features[0]), So = [Z]) : (e(14, it = Cs.features.filter(d)), ot && it.unshift({
        type: "Feature",
        properties: {},
  ...
  function Cl(S) {
    e(0, A = p === "always"), e(14, it = void 0), e(55, Z = void 0), e(15, Lt = -1), ca(S[1].toFixed(6) + ", " + bc(S[0], [-180, 180], !0).toFixed(6), !1);
  }
  function Il(S) {
    if (!it)
      return;
  ...
  return n.$$set = (S) => {
    ...
    16777344 && at && Z && !Z.address && Z.geometry.type === "Point" && Z.place_type[0] !== "reverse" && ms(Z.id, { byId: !0 }).catch((S) => e(18, Vr = S)), n.$$.dirty[1] & /*mapController, picked, prevIdToFly, flyTo, maxZoom, zoom*/
    50356241 && (L && Z && Z.id !== ds && y && (!Z.bbox || Z.bbox[0] === Z.bbox[2] && Z.bbox[1] === Z.bbox[3] ? L.flyTo(Z.center, Z.id.startsWith("poi.") || Z.id.startsWith("address.") ? De : Ie) : L.fitBounds(Ca(Z.bbox), 50, De), e(14, it = void 0), e(54, Vt = void 0), e(15, Lt = -1)), e(56, ds = Z == null ? void 0 : Z.id)), n.$$.dirty[0] & /*selectFirst, listFeatures*/
    ...
    8388624 && L && L.setEventHandler((S) => {
      switch (S.type) {
        ...
        case "markerMouseEnter":
          Vt && e(15, Lt = xo ? (it == null ? void 0 : it.findIndex((Ut) => Ut.id === S.id)) ?? -1 : -1);
          break;
    ...
    67133969 && L && r && y && _t && L.flyTo(r.center, r.id.startsWith("poi.") || r.id.startsWith("address.") ? De : Ie), n.$$.dirty[1] & /*markerOnSelected, mapController*/
    ...
    81920 && Nn("optionsVisibilityChange", xo && !!it), n.$$.dirty[0] & /*listFeatures*/
...
var Hs = (
  ...
  function() {
    ...
    return n.prototype.insert = function(t, e) {
      ...
      var i = this._comparator, o = Ta(t, this._root, i), s = o.left, a = o.right;
      i(t, e) < 0 ? a = xs(e, r, a, i) : s = xs(e, r, s, i), this._root = Kc(s, a, i);
    }, n.prototype.split = function(t) {
      return Ta(t, this._root, this._comparator);
...
function be(n, t, e) {
  return t && Da(n.prototype, t), e && Da(n, e), n;
}
var Hi = function(t, e) {
...
var $c = bn * bn, ks = function(t, e) {
  ...
  function n() {
    Cr(this, n), this.tree = new Hs(), this.round(0);
  }
  return be(n, [{
    key: "round",
    value: function(e) {
  ...
  function n(t, e) {
    Cr(this, n), t.events === void 0 ? t.events = [this] : t.events.push(this), this.point = t, this.isLeft = e;
  }
  return be(n, [{
    key: "link",
    value: function(e) {
  ...
  function n(t, e, r, i) {
    Cr(this, n), this.id = ++of, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = r, this.windings = i;
  }
  return be(n, [{
    key: "replaceRightSE",
  ...
  function n(t, e, r) {
    if (Cr(this, n), !Array.isArray(t) || t.length === 0)
  ...
  return be(n, [{
    ...
    value: function() {
      for (var e = this.events[0].point, r = [e], i = 1, o = this.events.length - 1; i < o; i++) {
        ...
        Aa(s, e, a) !== 0 && (r.push(s), e = s);
      }
      if (r.length === 1)
        return null;
      var u = r[0], l = r[1];
      Aa(u, e, l) === 0 && r.shift(), r.push(r[0]);
  ...
  function n(t) {
    Cr(this, n), this.exteriorRing = t, t.poly = this, this.interiorRings = [];
  }
  return be(n, [{
    key: "addInterior",
    value: function(e) {
  ...
  function n(t) {
    Cr(this, n), this.rings = t, this.polys = this._composePolys(t);
  }
  return be(n, [{
    key: "getGeom",
    value: function() {
      ...
      for (var r = [], i = 0, o = e.length; i < o; i++) {
        ...
        if (!s.poly)
          if (s.isExteriorRing())
            ...
            a.poly || r.push(new za(a)), a.poly.addInterior(s);
          }
      }
      return r;
    }
  ...
  function n(t) {
    ...
    Cr(this, n), this.queue = t, this.tree = new Hs(e), this.segments = [];
  }
  return be(n, [{
    key: "process",
    value: function(e) {
...
}(), Va = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, cf = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, ff = /* @__PURE__ */ function() {
  function n() {
    Cr(this, n);
  }
  return be(n, [{
    ...
    value: function(e, r, i) {
      xr.type = e, eo.reset();
      for (var o = [new Ga(r, !0)], s = 0, a = i.length; s < a; s++)
        o.push(new Ga(i[s], !1));
      ...
      for (var v = new Hs(Hr.compare), d = 0, y = o.length; d < y; d++)
        for (var I = o[d].getSweepEvents(), C = 0, N = I.length; C < N; C++)
          if (v.insert(I[C]), v.size > Va)
...
function _f(n, t, e) {
  e === void 0 && (e = {});
  var r = Xo(n), i = Xo(t), o = Cu.union(r.coordinates, i.coordinates);
  return o.length === 0 ? null : o.length === 1 ? Nu(o[0], e.properties) : Su(o, e.properties);
}
function xu(n, t, e) {
  if (n !== null)
    for (var r, i, o, s, a, u, l, c = 0, f = 0, h, g = n.type, p = g === "FeatureCollection", v = g === "Feature", d = p ? n.features.length : 1, y = 0; y < d; y++) {
      l = p ? n.features[y].geometry : v ? n.geometry : n, h = l ? l.type === "GeometryCollection" : !1, a = h ? l.geometries.length : 1;
      for (var I = 0; I < a; I++) {
        var C = 0, N = 0;
...
var Q = function() {
}, yo = { X: { configurable: !0 }, Y: { configurable: !0 }, Z: { configurable: !0 }, M: { configurable: !0 } };
yo.X.get = function() {
  return 0;
};
yo.Y.get = function() {
...
Jt.prototype.fixAfterInsertion = function(n) {
  ...
  for (n.color = Sn; n != null && n !== this.root_ && n.parent.color === Sn; )
    if (lt(n) === Ls(lt(lt(n)))) {
      var e = Ya(lt(lt(n)));
      Xa(e) === Sn ? (Xr(lt(n), jr), Xr(e, jr), Xr(lt(lt(n)), Sn), n = lt(lt(n))) : (n === Ya(lt(n)) && (n = lt(n), t.rotateLeft(n)), Xr(lt(n), jr), Xr(lt(lt(n)), Sn), t.rotateRight(lt(lt(n))));
    } else {
      var r = Ls(lt(lt(n)));
      Xa(r) === Sn ? (Xr(lt(n), jr), Xr(r, jr), Xr(lt(lt(n)), Sn), n = lt(lt(n))) : (n === Ls(lt(n)) && (n = lt(n), t.rotateRight(n)), Xr(lt(n), jr), Xr(lt(lt(n)), Sn), t.rotateLeft(lt(lt(n))));
    }
  this.root_.color = jr;
};
...
hr.prototype = new Tu();
hr.prototype.contains = function(n) {
...
hr.prototype.addAll = function(n) {
  for (var t = this, e = n.iterator(); e.hasNext(); )
    t.add(e.next());
  return !0;
};
hr.prototype.remove = function(n) {
  throw new Eo();
};
...
Be.prototype.editGeometryCollection = function(t, e) {
  ...
  return i.getClass() === bi ? this._factory.createMultiPoint(o.toArray([])) : i.getClass() === Dn ? this._factory.createMultiLineString(o.toArray([])) : i.getClass() === br ? this._factory.createMultiPolygon(o.toArray([])) : this._factory.createGeometryCollection(o.toArray([]));
};
...
var Rf = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], us = function(t) {
  this.geometryFactory = t || new W();
};
us.prototype.read = function(t) {
  ...
  return Rf.indexOf(r) !== -1 ? sr[r].apply(this, [e.coordinates]) : r === "GeometryCollection" ? sr[r].apply(this, [e.geometries]) : sr[r].apply(this, [e]);
};
...
var sr = {
  ...
  Feature: function(n) {
    ...
    return n.bbox && (t.bbox = sr.bbox.apply(this, [n.bbox])), t;
  },
  /**
  ...
  LineString: function(n) {
    var t = sr.coordinates.apply(this, [n]);
  ...
  MultiLineString: function(n) {
    for (var t = this, e = [], r = 0; r < n.length; ++r)
      e.push(sr.LineString.apply(t, [n[r]]));
   ...
   */
  Polygon: function(n) {
    for (var t = this, e = sr.coordinates.apply(this, [n[0]]), r = this.geometryFactory.createLinearRing(e), i = [], o = 1; o < n.length; ++o) {
      var s = n[o], a = sr.coordinates.apply(t, [s]), u = t.geometryFactory.createLinearRing(a);
      i.push(u);
    }
...
Nr.prototype.push = function(n) {
  return this.array_.push(n), n;
};
Nr.prototype.pop = function(n) {
...
Nr.prototype.search = function(n) {
...
kt.prototype.size = function() {
  ...
  if (arguments.length === 1) {
    for (var e = arguments[0], r = 0, i = e.getChildBoundables().iterator(); i.hasNext(); ) {
      var o = i.next();
      o instanceof Mt ? r += t.size(o) : o instanceof Ke && (r += 1);
    }
    return r;
  }
};
kt.prototype.removeItem = function(t, e) {
  for (var r = null, i = t.getChildBoundables().iterator(); i.hasNext(); ) {
    var o = i.next();
    o instanceof Ke && o.getItem() === e && (r = o);
  }
  ...
  if (arguments.length === 0) {
    ...
    for (var r = arguments[0], i = new O(), o = r.getChildBoundables().iterator(); o.hasNext(); ) {
      ...
      if (s instanceof Mt) {
        ...
        s instanceof Ke ? i.add(s.getItem()) : X.shouldNeverReachHere();
    }
    return i.size() <= 0 ? null : i;
  }
};
kt.prototype.insert = function(t, e) {
  X.isTrue(!this._built, "Cannot insert items into an STR packed R-tree after it has been built."), this._itemBoundables.add(new Ke(t, e));
};
kt.prototype.boundablesAtLevel = function() {
  ...
  if (arguments.length === 1) {
    ...
    for (var a = o.getChildBoundables().iterator(); a.hasNext(); ) {
      var u = a.next();
      u instanceof Mt ? t.boundablesAtLevel(i, u, s) : (X.isTrue(u instanceof Ke), i === -1 && s.add(u));
    }
    return null;
  }
};
  ...
  if (arguments.length === 1) {
    ...
    if (V(arguments[2], gn) && arguments[0] instanceof Object && arguments[1] instanceof Mt)
      for (var s = arguments[0], a = arguments[1], u = arguments[2], l = a.getChildBoundables(), c = 0; c < l.size(); c++) {
        var f = l.get(c);
        t.getIntersectsOp().intersects(f.getBounds(), s) && (f instanceof Mt ? t.query(s, f, u) : f instanceof Ke ? u.visitItem(f.getItem()) : X.shouldNeverReachHere());
      }
      ...
      for (var h = arguments[0], g = arguments[1], p = arguments[2], v = g.getChildBoundables(), d = 0; d < v.size(); d++) {
        var y = v.get(d);
        t.getIntersectsOp().intersects(y.getBounds(), h) && (y instanceof Mt ? t.query(h, y, p) : y instanceof Ke ? p.add(y.getItem()) : X.shouldNeverReachHere());
      }
  }
};
...
var Bu = function(n) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    if (arguments.length === 1) {
      ...
      var y = arguments[0], I = arguments[1], C = arguments[2], N = new Ke(y, I), L = new bt(this.getRoot(), N, C);
...
var ra = function(n) {
  ...
  return t.prototype.getMonotoneChains = function() {
    ...
    for (var i = this, o = new Ha(this._segInt), s = this._monoChains.iterator(); s.hasNext(); )
...
}, Io = { INIT: { configurable: !0 }, DELETE: { configurable: !0 }, KEEP: { configurable: !0 }, NUM_PTS_TO_CHECK: { configurable: !0 } };
...
ft.prototype.addLimitedMitreJoin = function(t, e, r, i) {
  var o = this._seg0.p1, s = j.angle(o, this._seg0.p0), a = j.angleBetweenOriented(this._seg0.p0, o, this._seg1.p1), u = a / 2, l = j.normalize(s + u), c = j.normalize(l + Math.PI), f = i * r, h = f * Math.abs(Math.sin(u)), g = r - h, p = o.x + f * Math.cos(c), v = o.y + f * Math.sin(c), d = new m(p, v), y = new k(o, d), I = y.pointAlongOffset(1, g), C = y.pointAlongOffset(1, -g);
...
ti.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (V(arguments[2], We) && arguments[0] instanceof m && arguments[1] instanceof zs)
...
Ge.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof At ? this.addPolygon(t) : t instanceof mt ? this.addLineString(t) : t instanceof ye ? this.addPoint(t) : t instanceof bi ? this.addCollection(t) : t instanceof Dn ? this.addCollection(t) : t instanceof br ? this.addCollection(t) : t instanceof ae && this.addCollection(t);
};
...
Xt.prototype.bufferFixedPrecision = function(t) {
  var e = new vn(new Mr(new tt(1)), t.getScale()), r = new se(this._bufParams);
...
un.getPoints = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return t instanceof ye ? Qe.singletonList(t) : un.getPoints(t, new O());
  } else if (arguments.length === 2) {
    var e = arguments[0], r = arguments[1];
    ...
    if (arguments[2] instanceof Array && arguments[0] instanceof mt && arguments[1] instanceof ye) {
      ...
      for (var p = f.getCoordinates(), v = h.getCoordinates(), d = 0; d < p.length - 1; d++)
        for (var y = 0; y < v.length - 1; y++) {
          ...
          if (I < t._minDistance) {
            t._minDistance = I;
            var C = new k(p[d], p[d + 1]), N = new k(v[y], v[y + 1]), L = C.closestPoints(N);
...
Ct.prototype.snapToSelf = function(t, e) {
  var r = this.extractTargetCoordinates(this._srcGeom), i = new Qu(t, r, !0), o = i.transform(this._srcGeom), s = o;
...
var Af = function(n) {
  ...
  return n && (t.__proto__ = n), t.prototype = Object.create(n && n.prototype), t.prototype.constructor = t, t.prototype.prepareEvents = function() {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[2] instanceof Kt && V(arguments[0], We) && V(arguments[1], We)) {
        var a = arguments[0], u = arguments[1], l = arguments[2];
        this.addEdges(a, a), this.addEdges(u, u), this.computeIntersections(l);
      } else if (typeof arguments[2] == "boolean" && V(arguments[0], We) && arguments[1] instanceof Kt) {
        var c = arguments[0], f = arguments[1], h = arguments[2];
...
var ji = function(n) {
  function t() {
    if (n.call(this), this._parentGeom = null, this._lineEdgeMap = new Mu(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new Je(), arguments.length === 2) {
...
var q = function(n) {
  function t() {
    var e = arguments[0], r = arguments[1];
    n.call(this, e, r), this._ptLocator = new Je(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new Ze(), this._resultPolyList = new O(), this._resultLineList = new O(), this._resultPointList = new O(), this._graph = new dt(new Uu()), this._geomFact = e.getFactory();
  }
...
Qo.prototype = {
  ...
  add: function(n) {
    ja(To, n, this.t), ja(this, To.s, this.s), this.s ? this.t += To.t : this.s = To.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var vt = 1e-6, ut = Math.PI, Kr = ut / 2, Ka = ut / 4, rn = ut * 2, xn = 180 / ut, or = ut / 180, oe = Math.abs, Bf = Math.atan, Bi = Math.atan2, Tt = Math.cos, Dt = Math.sin, Yi = Math.sqrt;
function tl(n) {
...
function Gf(n, t) {
  n && Qa.hasOwnProperty(n.type) ? Qa[n.type](n, t) : Zo(n, t);
}
Wn();
Wn();
function Us(n) {
...
Xs.invert = Xs;
function zf(n, t, e) {
  return (n %= rn) ? t || e ? el(tu(n), eu(t, e)) : tu(n) : t || e ? eu(t, e) : Xs;
}
function $a(n) {
  return function(t, e) {
...
function Vf(n, t, e, r, i, o) {
  if (e) {
    ...
    i == null ? (i = t + r * rn, o = t - u / 2) : (i = ru(s, i), o = ru(s, o), (r > 0 ? i < o : i > o) && (i += r * rn));
...
function nl(n, t, e, r, i) {
  ...
  if (n.forEach(function(p) {
    if (!((v = p.length - 1) <= 0)) {
      ...
      o.push(I = new Ao(d, p, null, !0)), s.push(I.o = new Ao(d, null, I, !1)), o.push(I = new Ao(y, p, null, !1)), s.push(I.o = new Ao(y, null, I, !0));
    }
  }), !!o.length) {
    for (s.sort(t), nu(o), nu(s), a = 0, u = s.length; a < u; ++a)
      s[a].e = e = !e;
    for (var l = o[0], c, f; ; ) {
      for (var h = l, g = !0; h.v; )
        if ((h = h.n) === l)
...
function Yf(n, t, e, r) {
  ...
  return function(l) {
    var c = l, f = rl(), h, g, p, v, d, y, I, C, N, L, T, R = {
      point: D,
      lineStart: G,
      lineEnd: at,
      polygonStart: A,
    ...
    function b() {
      for (var B = 0, K = 0, _t = g.length; K < _t; ++K)
        for (var Qt = g[K], zt = 1, Gr = Qt.length, Ie = Qt[0], De, Ue, In = Ie[0], sn = Ie[1]; zt < Gr; ++zt)
    ...
    function Y() {
      var B = b(), K = T && B, _t = (h = ol(h)).length;
      (K || _t) && (l.polygonStart(), K && (l.lineStart(), o(null, null, 1, l), l.lineEnd()), _t && nl(h, a, B, o, l), l.polygonEnd()), c = l, h = g = p = null;
    }
    function G() {
    ...
    function x(B, K) {
      var _t = i(B, K);
      if (g && p.push([B, K]), L)
        v = B, d = K, y = _t, L = !1, _t && (c.lineStart(), c.point(B, K));
      else if (_t && N)
        c.point(B, K);
      else {
        var Qt = [I = Math.max(Fo, Math.min(Qi, I)), C = Math.max(Fo, Math.min(Qi, C))], zt = [B = Math.max(Fo, Math.min(Qi, B)), K = Math.max(Fo, Math.min(Qi, K))];
        Uf(Qt, zt, n, t, e, r) ? (N || (c.lineStart(), c.point(Qt[0], Qt[1])), c.point(zt[0], zt[1]), _t || c.lineEnd(), T = !1) : _t && (c.lineStart(), c.point(B, K), T = !1);
      }
      I = B, C = K, N = _t;
    }
    return R;
...
function Wf(n, t) {
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + Ka, p = Dt(g), v = Tt(g), d = 0; d < c; ++d, h = I, p = N, v = L, f = y) {
        var y = l[d], I = y[0], C = y[1] / 2 + Ka, N = Dt(C), L = Tt(C), T = I - h, R = T >= 0 ? 1 : -1, D = R * T, b = D > ut, A = p * N;
        if (ws.add(Bi(A * R * Dt(D), v * L + A * Tt(D))), o += b ? T + R * rn : T, b ^ h >= e ^ I >= e) {
          var Y = Jo(Gi(f), Gi(y));
          qs(Y);
          var G = Jo(i, Y);
          qs(G);
...
Wn();
Wn();
var zi = 1 / 0, $o = zi, vo = -zi, ts = vo, ou = {
  point: Hf,
  lineStart: Ki,
  lineEnd: Ki,
  polygonStart: Ki,
  ...
  result: function() {
    var n = [[zi, $o], [vo, ts]];
    return vo = ts = -($o = zi = 1 / 0), n;
  }
};
function Hf(n, t) {
  n < zi && (zi = n), n > vo && (vo = n), t < $o && ($o = t), t > ts && (ts = t);
}
Wn();
function sl(n, t, e, r) {
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = rl(), l = t(u), c = !1, f, h, g, p = {
      ...
      polygonEnd: function() {
        p.point = v, p.lineStart = y, p.lineEnd = I, h = ol(h);
        var T = Wf(f, a);
        h.length ? (c || (o.polygonStart(), c = !0), nl(h, Kf, T, e, o)) : T && (c || (o.polygonStart(), c = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), h = f = null;
      },
      sphere: function() {
...
function Qf(n) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      oe(u - ut) < vt ? (n.point(t, e = (e + s) / 2 > 0 ? Kr : -Kr), n.point(r, e), n.lineEnd(), n.lineStart(), n.point(a, e), n.point(o, e), i = 0) : r !== a && u >= ut && (oe(t - r) < vt && (t -= r * vt), oe(o - a) < vt && (o -= a * vt), e = Zf(t, e, o, s), n.point(r, e), n.lineEnd(), n.lineStart(), n.point(a, e), i = 0), n.point(t = o, e = s), r = a;
    },
    lineEnd: function() {
      n.lineEnd(), t = e = NaN;
    },
...
function $f(n, t) {
  ...
  function a(c) {
    ...
    return {
      ...
      point: function(d, y) {
        ...
        if (!f && (p = g = N) && c.lineStart(), N !== g && (C = u(f, I), (!C || zo(f, C) || zo(I, C)) && (I[0] += vt, I[1] += vt, N = s(I[0], I[1]))), N !== g)
        ...
        N && (!f || !zo(f, I)) && c.point(I[0], I[1]), f = I, g = N, h = L;
      },
      lineEnd: function() {
        g && c.lineEnd(), f = null;
      },
  ...
  function u(c, f, h) {
    var g = Gi(c), p = Gi(f), v = [1, 0, 0], d = Jo(g, p), y = Do(d, d), I = d[0], C = y - I * I;
    if (!C)
      return !h && c;
    var N = e * y / C, L = -e * I / C, T = Jo(v, d), R = Mo(v, N), D = Mo(d, L);
    bs(R, D);
    ...
    if (!(G < 0)) {
      ...
      K < B && (zt = B, B = K, K = zt);
      var Gr = K - B, Ie = oe(Gr - ut) < vt, De = Ie || Gr < vt;
      if (!Ie && Qt < _t && (zt = _t, _t = Qt, Qt = zt), De ? Ie ? _t + Qt > 0 ^ x[1] < (oe(x[0] - B) < vt ? _t : Qt) : _t <= x[1] && x[1] <= Qt : Gr > ut ^ (B <= x[0] && x[0] <= K)) {
        var Ue = Mo(b, (-A + at) / Y);
...
function ul(n, t, e) {
  ...
  n.scale(150).translate([0, 0]), o != null && n.clipExtent(null), Gf(e, n.stream(ou));
  var s = ou.result(), a = Math.min(r / (s[1][0] - s[0][0]), i / (s[1][1] - s[0][1])), u = +t[0][0] + (r - a * (s[1][0] + s[0][0])) / 2, l = +t[0][1] + (i - a * (s[1][1] + s[0][1])) / 2;
  return o != null && n.clipExtent(o), n.scale(a * 150).translate([u, l]);
}
function th(n, t, e) {
  return ul(n, [[0, 0], t], e);
}
var au = 16, eh = Tt(30 * or);
function uu(n, t) {
...
function nh(n, t) {
  function e(r, i, o, s, a, u, l, c, f, h, g, p, v, d) {
    ...
    if (C > 4 * t && v--) {
      var N = s + h, L = a + g, T = u + p, R = Yi(N * N + L * L + T * T), D = ui(T /= R), b = oe(oe(T) - 1) < vt || oe(o - f) < vt ? (o + f) / 2 : Bi(L, N), A = n(b, D), Y = A[0], G = A[1], at = Y - r, x = G - i, B = I * at - y * x;
      (B * B / C > t || oe((y * at + I * x) / C - 0.5) > 0.3 || s * h + a * g + u * p < eh) && (e(r, i, o, s, a, u, Y, G, b, N /= R, L /= R, T, v, d), d.point(Y, G), e(Y, G, b, N, L, T, l, c, f, h, g, p, v, d));
    }
  }
  return function(r) {
    ...
    function C(D, b) {
      ...
      e(f, h, c, g, p, v, f = Y[0], h = Y[1], c = D, g = A[0], p = A[1], v = A[2], au, r), r.point(f, h);
    }
    function N() {
      d.point = y, r.lineEnd();
    }
    ...
    function R() {
      e(f, h, c, g, p, v, o, s, i, a, u, l, au, r), d.lineEnd = N, N();
    }
    return d;
  };
}
...
function sh(n) {
  var t, e = 150, r = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, g, p = null, v = su, d = null, y, I, C, N = iu, L = 0.5, T = uu(Y, L), R, D;
  function b(x) {
  ...
  b.stream = function(x) {
    ...
    return arguments.length ? (v = +x ? $f(p = x * or, 6 * or) : (p = null, su), at()) : p * xn;
  }, b.clipExtent = function(x) {
    return arguments.length ? (N = x == null ? (d = y = I = C = null, iu) : Yf(d = +x[0][0], y = +x[0][1], I = +x[1][0], C = +x[1][1]), at()) : d == null ? null : [[d, y], [I, C]];
  }, b.scale = function(x) {
    ...
    return arguments.length ? (T = uu(Y, L = x * x), at()) : Yi(L);
...
var ah = ll(function(n) {
  return Yi(2 / (1 + n));
});
ah.invert = cl(function(n) {
  return 2 * ui(n / 2);
});
...
function uh() {
  return oh(fl).scale(79.4188).clipAngle(180 - 1e-3);
}
function lu(n, t) {
  return [n, t];
}
...
function Vo(n, t, e, r) {
  ...
  }, l = new ea(), c = l.read(u), f = mf(yf(t, e), "meters"), h = Xt.bufferOp(c, f, r), g = new Fu();
...
function fh(n, t) {
  var e = Xo(n), r = Xo(t), i = n.properties || {}, o = Cu.difference(
    e.coordinates,
    r.coordinates
  );
...
function hh(n, t, e = !0, r = !0, i = {}, o = {}, s = {
  ...
  function g(p = !1) {
    ...
    return p && v.classList.add("marker-interactive"), new Ic({
  ...
  return {
    ...
    setMarkers(p, v) {
      ...
      function d(y) {
        var I;
        (I = n.getSource("full-geom")) == null || I.setData(y);
      }
      for (const y of u)
        y.remove();
      if (u.length = 0, d(hu), !!t) {
        if (v) {
          let y = !1;
...
class gh extends EventTarget {
  ...
  onAdd(e) {
    ...
    const {
      ...
      fullGeometryStyle: a,
      ...u
    } = nr(this, Kn), l = typeof s == "boolean" ? {} : s, c = this.getExtraProps(e, r), h = {
      mapController: hh(
        e,
        this.getMapLibreGl(),
        i,
    ...
    wo(this, qe, new Wc({ target: r, props: h }));
    for (const g of [
      "select",
      "pick",
      "featuresListed",
...
export {
  vh as GeocodingControl,
  hh as createMapLibreGlMapController
};
