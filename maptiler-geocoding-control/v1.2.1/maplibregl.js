...
function Xc(n) {
  ...
  return ~(d = at(n)) && (y = G[d] = Y[d](n)), {
    ...
    p(x, B) {
      ...
      let Q = d;
      d = at(x), d === Q ? ~d && G[d].p(x, B) : (y && (Bo(), ee(G[Q], 1, 1, () => {
        G[Q] = null;
...
function Yc(n, t, e) {
  ...
  const _l = /* @__PURE__ */ new Set(), Nn = Kl();
  Ql(() => {
...
kr.prototype.buildTree = function() {
  var t = this;
  Ke.sort(this._leaves, new Fr.NodeComparator());
...
var vt = 1e-6, ut = Math.PI, Qr = ut / 2, Qa = ut / 4, rn = ut * 2, xn = 180 / ut, or = ut / 180, oe = Math.abs, Bf = Math.atan, Bi = Math.atan2, Tt = Math.cos, Dt = Math.sin, Yi = Math.sqrt;
function tl(n) {
  ...
  return function(l) {
    ...
    function b() {
      for (var B = 0, Q = 0, _t = g.length; Q < _t; ++Q)
        for (var Kt = g[Q], zt = 1, Gr = Kt.length, Ie = Kt[0], De, Ue, In = Ie[0], sn = Ie[1]; zt < Gr; ++zt)
          De = In, Ue = sn, Ie = Kt[zt], In = Ie[0], sn = Ie[1], Ue <= r ? sn > r && (In - De) * (r - Ue) > (sn - Ue) * (n - De) && ++B : sn <= r && (In - De) * (r - Ue) < (sn - Ue) * (n - De) && --B;
      return B;
    }
    function A() {
      c = f, h = [], g = [], T = !0;
    ...
    function x(B, Q) {
      var _t = i(B, Q);
      if (g && p.push([B, Q]), L)
        v = B, d = Q, y = _t, L = !1, _t && (c.lineStart(), c.point(B, Q));
      else if (_t && N)
        c.point(B, Q);
      else {
        var Kt = [I = Math.max(Fo, Math.min(Ki, I)), C = Math.max(Fo, Math.min(Ki, C))], zt = [B = Math.max(Fo, Math.min(Ki, B)), Q = Math.max(Fo, Math.min(Ki, Q))];
...
function Wf(n, t) {
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + Qa, p = Dt(g), v = Tt(g), d = 0; d < c; ++d, h = I, p = N, v = L, f = y) {
        var y = l[d], I = y[0], C = y[1] / 2 + Qa, N = Dt(C), L = Tt(C), T = I - h, R = T >= 0 ? 1 : -1, D = R * T, b = D > ut, A = p * N;
  ...
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = rl(), l = t(u), c = !1, f, h, g, p = {
      ...
      polygonEnd: function() {
        ...
        var T = Wf(f, a);
        h.length ? (c || (o.polygonStart(), c = !0), nl(h, Qf, T, e, o)) : T && (c || (o.polygonStart(), c = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), h = f = null;
      },
      sphere: function() {
