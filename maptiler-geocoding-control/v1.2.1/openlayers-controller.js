...
function sg(i) {
  ...
  return function() {
    ...
    return (!t || this !== r || !ps(s, n)) && (t = !0, r = this, n = s, e = i.apply(this, arguments)), e;
  };
}
function wu(i) {
  for (const t in i)
...
class og extends eg {
   ...
   */
  disposeInternal() {
    this.listeners_ && wu(this.listeners_);
  }
  /**
  ...
  removeEventListener(t, e) {
    ...
    if (n) {
      const r = n.indexOf(e);
      r !== -1 && (this.pendingRemovals_ && t in this.pendingRemovals_ ? (n[r] = Fs, ++this.pendingRemovals_[t]) : (n.splice(r, 1), n.length === 0 && delete this.listeners_[t]));
    }
  }
}
const th = og, hn = {
...
function Qn(i) {
  i && i.target && (i.target.removeEventListener(i.type, i.listener), wu(i));
}
class ga extends th {
  constructor() {
   ...
   */
  changed() {
    ++this.revision_, this.dispatchEvent(hn.CHANGE);
  }
  /**
...
let ug = 0;
function Kt(i) {
  return i.ol_uid || (i.ol_uid = String(++ug));
}
class wl extends lo {
  /**
...
class lg extends eh {
  ...
  notify(t, e) {
    let n;
    n = `change:${t}`, this.hasListener(n) && this.dispatchEvent(new wl(n, t, e)), n = Qc.PROPERTYCHANGE, this.hasListener(n) && this.dispatchEvent(new wl(n, t, e));
  }
  /**
   * @param {string} key Key name.
   * @param {import("./events.js").Listener} listener Listener.
...
class Nu extends Ir {
  ...
  clone() {
    const t = (
      ...
      new Nu(this.hasProperties() ? this.getProperties() : null)
    );
  ...
  handleGeometryChanged_() {
    this.geometryChangeKey_ && (Qn(this.geometryChangeKey_), this.geometryChangeKey_ = null);
    const t = this.getGeometry();
    t && (this.geometryChangeKey_ = Jn(
      t,
      hn.CHANGE,
   ...
   */
  setStyle(t) {
    this.style_ = t, this.styleFunction_ = t ? fg(t) : void 0, this.changed();
  }
  /**
...
const ci = Nu, Xi = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "";
Xi.includes("firefox");
const gg = Xi.includes("safari") && !Xi.includes("chrom");
gg && (Xi.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(Xi));
Xi.includes("webkit") && Xi.includes("edge");
Xi.includes("macintosh");
const Lu = typeof WorkerGlobalScope < "u" && typeof OffscreenCanvas < "u" && self instanceof WorkerGlobalScope, pg = typeof Image < "u" && Image.prototype.decode;
(function() {
  let i = !1;
  try {
...
function Lg(i, t) {
  let e;
  return e = t(sh(i)), e || (e = t(oh(i)), e) || (e = t(uh(i)), e) || (e = t(ah(i)), e) ? e : !1;
}
function sh(i) {
  return [i[0], i[1]];
}
...
function Pg(i, t, e, n, r) {
  const [s, o, a, u, l, c, h, f] = Tg(
    i,
    t,
    e,
    n
...
const hh = Ag, ho = 6378137, zr = Math.PI * ho, Fg = [-zr, -zr, zr, zr], kg = [-180, -85, 180, 85], Lo = ho * Math.log(Math.tan(Math.PI / 2));
class br extends hh {
  /**
...
const Pl = [
  ...
  new br("EPSG:102113"),
  new br("EPSG:900913"),
  new br("http://www.opengis.net/def/crs/EPSG/0/3857"),
  new br("http://www.opengis.net/gml/srs/epsg.xml#3857")
];
function Gg(i, t, e) {
  const n = i.length;
...
function Bg(i, t, e) {
  ...
  e = e > 1 ? e : 2, t === void 0 && (e > 2 ? t = i.slice() : t = new Array(n));
  for (let r = 0; r < n; r += e)
    t[r] = 180 * i[r] / zr, t[r + 1] = 360 * Math.atan(Math.exp(i[r + 1] / ho)) / Math.PI - 90;
  return t;
}
const zg = 6378137, Tl = [-180, -90, 180, 90], Vg = Math.PI * zg / 180;
class er extends hh {
  /**
   * @param {string} code Code.
...
function Xo(i, t, e) {
  ...
  n in Xr || (Xr[n] = {}), Xr[n][r] = e;
}
function Ug(i, t) {
  let e;
  return i in Xr && t in Xr[i] && (e = Xr[i][t]), e;
}
function he(i, t, e) {
  return Math.min(Math.max(i, t), e);
}
function Wg(i, t, e, n, r, s) {
  const o = r - e, a = s - n;
  if (o !== 0 || a !== 0) {
...
function Kg(i, t) {
  if (t.canWrapX()) {
    const e = un(t.getExtent()), n = Jg(i, t, e);
    n && (i[0] -= n * e);
  }
  return i;
}
...
function ep(i) {
  Yg(i.getCode(), i), Xo(i, i, ph);
}
function np(i) {
  i.forEach(ep);
}
function Wr(i) {
  return typeof i == "string" ? Xg(
    /** @type {string} */
    i
  ) : (
    /** @type {Projection} */
...
function Ml(i, t) {
  ...
  return (n < -180 || n > 180) && (e[0] = Qa(n + 180, 360) - 180), e;
}
function rp(i, t) {
...
function sp(i, t, e, n) {
  const r = Uo(t, e);
  return Mg(i, r, void 0, n);
}
function Dl(i, t) {
  return i;
}
function Li(i, t) {
  return $a && !Yo(i, [0, 0]) && i[0] >= -180 && i[0] <= 180 && i[1] >= -90 && i[1] <= 90 && ($a = !1, $g(
...
const Al = Bi();
let lp = class extends Ir {
  constructor() {
    super(), this.extent_ = ur(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = sg(function(t, e, n) {
      if (!n)
   ...
   */
  transform(t, e) {
    const n = Wr(t), r = n.getUnits() == "tile-pixels" ? function(s, o, a) {
      const u = n.getExtent(), l = n.getWorldExtent(), c = Gs(l) / Gs(u);
      return co(
        Al,
        l[0],
        l[3],
...
class cp extends yh {
  ...
  setFlatCoordinates(t, e) {
    this.stride = Fl(t), this.layout = t, this.flatCoordinates = e;
  }
  /**
   * @abstract
...
function gp(i, t, e, n, r) {
  for (let s = 0, o = e.length; s < o; ++s) {
    const a = e[s];
    r = Du(i, t, a, n, r), t = a[a.length - 1];
  }
  return r;
}
function Au(i, t, e, n, r, s, o, a, u, l, c) {
  if (t == e)
    return l;
  let h, f;
  if (r === 0) {
...
function Fu(i, t, e, n, r, s, o, a, u, l, c) {
  c = c || [NaN, NaN];
...
function pp(i, t, e, n, r, s, o, a, u, l, c) {
  c = c || [NaN, NaN];
  for (let h = 0, f = e.length; h < f; ++h) {
    const g = e[h];
    l = Fu(
...
function Gu(i, t, e, n, r, s, o) {
  ...
  for (; l.length > 0; ) {
    ...
    for (let y = f + n; y < h; y += n) {
      const E = i[y], I = i[y + 1], S = Wg(E, I, p, d, _, m);
      S > g && (c = y, g = S);
    }
...
function yp(i, t, e, n, r, s, o) {
  ...
  let l, c;
  do
    if (l = nr(i[t], r), c = nr(i[t + 1], r), t += n, t == e)
      return s[o++] = l, s[o++] = c, o;
  while (l == a && c == u);
  for (; t < e; ) {
    const h = nr(i[t], r), f = nr(i[t + 1], r);
    if (t += n, h == l && f == c)
      continue;
...
function Ep(i, t, e, n) {
  ...
  for (let s = 0, o = e.length; s < o; ++s) {
    const a = e[s];
    r += xh(i, t, a, n), t = a[a.length - 1];
  }
  return r;
}
let xp = class eu extends Rr {
  /**
   ...
   */
  clone() {
    return new eu(this.flatCoordinates.slice(), this.layout);
  }
  /**
   * @param {number} x X.
   * @param {number} y Y.
   ...
   */
  closestPointXY(t, e, n, r) {
    return r < Sr(this.getExtent(), t, e) ? r : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(
      Mu(
        this.flatCoordinates,
        0,
        this.flatCoordinates.length,
...
let Cp = class Ch extends Rr {
   ...
   */
  intersectsExtent(t) {
    return Tu(t, this.flatCoordinates[0], this.flatCoordinates[1]);
  }
  /**
   * @param {!Array<*>} coordinates Coordinates.
   * @param {import("./Geometry.js").GeometryLayout} [layout] Layout.
   ...
   */
  setCoordinates(t, e) {
    this.setLayout(e, t, 0), this.flatCoordinates || (this.flatCoordinates = []), this.flatCoordinates.length = dp(
      this.flatCoordinates,
      0,
      t,
      this.stride
...
function Ih(i, t, e, n, r, s, o) {
  ...
  let _ = NaN, m = -1 / 0;
  for (d.sort(As), c = d[0], a = 1, u = d.length; a < u; ++a) {
    h = d[a];
    const y = Math.abs(h - c);
    y > m && (l = (c + h) / 2, Bu(i, t, e, n, l, p) && (_ = l, m = y)), c = h;
  }
...
function _a(i, t, e, n, r) {
  ...
  return Ln(r, s) ? Br(r, s) || s[0] >= r[0] && s[2] <= r[2] || s[1] >= r[1] && s[3] <= r[3] ? !0 : Sh(
    i,
    t,
    e,
    n,
...
function nu(i, t, e, n, r) {
  ...
  for (let s = 0, o = e.length; s < o; ++s) {
    ...
    (s === 0 ? r && u || !r && !u : r && !u || !r && u) && Pp(i, t, a, n), t = a;
  }
  return t;
}
function Bl(i, t, e, n, r) {
  for (let s = 0, o = e.length; s < o; ++s)
    t = nu(
      i,
      t,
...
let Lh = class iu extends Rr {
  ...
  closestPointXY(t, e, n, r) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), Fu(
      this.flatCoordinates,
      0,
      this.ends_,
      this.stride,
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), nu(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, Bs(e, 0, this.ends_, this.stride);
  }
  /**
   ...
   */
  getInteriorPoint() {
    return new Yr(this.getFlatInteriorPoint(), "XYM");
  }
  /**
   ...
   */
  getLinearRing(t) {
    return t < 0 || this.ends_.length <= t ? null : new Gl(
      this.flatCoordinates.slice(
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      Nh(t, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = nu(
...
function Ph(i, t, e, n, r, s, o) {
  ...
  if (l === 1)
    ...
    const p = r * f, d = ng(g, p);
    d < 0 ? (u = (p - g[-d - 2]) / (g[-d - 1] - g[-d - 2]), a = t + (-d - 2) * n) : a = t + d * n;
  }
  o = o > 1 ? o : 2, s = s || new Array(o);
  for (let c = 0; c < o; ++c)
    s[c] = a === void 0 ? NaN : u === void 0 ? i[a + c] : Ve(i[a + c], i[a + n + c], u);
  return s;
}
function ru(i, t, e, n, r, s) {
  if (e == t)
    return null;
  let o;
  if (r < i[t + n - 1])
...
let bp = class su extends Rr {
  ...
  getCoordinateAtM(t, e) {
    return this.layout != "XYM" && this.layout != "XYZM" ? null : (e = e !== void 0 ? e : !1, ru(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
const Oh = Xu, Mp = /^#([a-f0-9]{3}|[a-f0-9]{4}(?:[a-f0-9]{2}){0,2})$/i, Dp = /^([a-z]*)$|^hsla?\(.*\)$/i;
function bh(i) {
  return typeof i == "string" ? i : Mh(i);
}
function Ap(i) {
...
function Zo(i) {
  return Array.isArray(i) ? i : Fp(i);
}
function kp(i) {
  let t, e, n, r, s;
  if (Dp.exec(i) && (i = Ap(i)), Mp.exec(i)) {
    const o = i.length - 1;
    let a;
    o <= 4 ? a = 1 : a = 2;
    const u = o === 4 || o === 8;
    ...
    i.startsWith("rgba(") ? (s = i.slice(5, -1).split(",").map(Number), Vl(s)) : i.startsWith("rgb(") ? (s = i.slice(4, -1).split(",").map(Number), s.push(1), Vl(s)) : Ut(!1, 14);
  return s;
}
function Vl(i) {
...
function Zn(i) {
  return Array.isArray(i) ? Mh(i) : i;
}
function bn(i, t, e, n) {
  let r;
  return e && e.length ? r = e.shift() : Lu ? r = new OffscreenCanvas(i || 300, t || 300) : r = document.createElement("canvas"), i && (r.width = i), t && (r.height = t), /** @type {CanvasRenderingContext2D} */
  r.getContext("2d", n);
}
function Gp(i) {
  const t = i.canvas;
...
const Bp = new RegExp(
  ...
  for (let n = 0, r = Xl.length; n < r; ++n) {
    const s = t[n + 1];
    s !== void 0 && (e[Xl[n]] = s);
  }
  return e.families = e.family.split(/,\s?/), e;
}, Ah = "10px sans-serif", Pe = "#000", Ko = "round", di = [], _i = 0, qr = "round", Xs = 10, Ys = "#000", Us = "center", Jo = "middle", rr = [0, 0, 0, 0], Ws = 1, Pi = new Ir();
let Ar = null, ou;
const au = {}, zp = function() {
...
`)) ? (wu(au), Ar = null, ou = void 0, Pi.set(g, 100)) : (Pi.set(g, Pi.get(g) + 1, !0), l = !1));
    }
...
` + c.weight + `
` + p;
      Pi.get(d) === void 0 && (Pi.set(d, 100, !0), a(c.style, c.weight, p) || (Pi.set(d, 0, !0), s === void 0 && (s = setInterval(u, 32))));
    }
  };
...
function Fh(i, t) {
  return Ar || (Ar = bn(1, 1)), i != ou && (Ar.font = i, ou = Ar.font), Ar.measureText(t);
}
function Qo(i, t) {
  return Fh(i, t).width;
}
...
function Yp(i, t, e, n, r, s, o, a, u, l, c) {
  i.save(), e !== 1 && (i.globalAlpha *= e), t && i.setTransform.apply(i, t), /** @type {*} */
  n.contextInstructions ? (i.translate(u, l), i.scale(c[0], c[1]), Up(
    /** @type {Label} */
    n,
    i
...
class Yu extends Oh {
   ...
   */
  clone() {
    const t = this.getScale(), e = new Yu({
  ...
  getImage(t) {
    ...
    if (!e) {
      const n = this.renderOptions_, r = bn(
        n.size * t,
        n.size * t
      );
   ...
   */
  createRenderOptions() {
    let t = qr, e = 0, n = null, r = 0, s, o = 0;
    this.stroke_ && (s = this.stroke_.getColor(), s === null && (s = Ys), s = Zn(s), o = this.stroke_.getWidth(), o === void 0 && (o = Ws), n = this.stroke_.getLineDash(), r = this.stroke_.getLineDashOffset(), t = this.stroke_.getLineJoin(), t === void 0 && (t = qr), e = this.stroke_.getMiterLimit(), e === void 0 && (e = Xs));
  ...
  draw_(t, e, n) {
    if (e.scale(n, n), e.translate(t.size / 2, t.size / 2), this.createPath_(e), this.fill_) {
      ...
      r === null && (r = Pe), e.fillStyle = Zn(r), e.fill();
    }
...
class Uu extends kh {
   ...
   */
  clone() {
    const t = this.getScale(), e = new Uu({
      fill: this.getFill() ? this.getFill().clone() : void 0,
      stroke: this.getStroke() ? this.getStroke().clone() : void 0,
      radius: this.getRadius(),
      scale: Array.isArray(t) ? t.slice() : t,
...
class ma {
   ...
   */
  constructor(t) {
    t = t || {}, this.geometry_ = null, this.geometryFunction_ = Ul, t.geometry !== void 0 && this.setGeometry(t.geometry), this.fill_ = t.fill !== void 0 ? t.fill : null, this.image_ = t.image !== void 0 ? t.image : null, this.renderer_ = t.renderer !== void 0 ? t.renderer : null, this.hitDetectionRenderer_ = t.hitDetectionRenderer !== void 0 ? t.hitDetectionRenderer : null, this.stroke_ = t.stroke !== void 0 ? t.stroke : null, this.text_ = t.text !== void 0 ? t.text : null, this.zIndex_ = t.zIndex;
  }
  /**
   * Clones the style.
  ...
  setGeometry(t) {
    ...
    }) : this.geometryFunction_ = Ul, this.geometry_ = t;
  }
  /**
   * Set the z-index.
   *
...
class Wu {
   ...
   */
  constructor(t) {
    t = t || {}, this.font_ = t.font, this.rotation_ = t.rotation, this.rotateWithView_ = t.rotateWithView, this.scale_ = t.scale, this.scaleArray_ = jo(t.scale !== void 0 ? t.scale : 1), this.text_ = t.text, this.textAlign_ = t.textAlign, this.justify_ = t.justify, this.repeat_ = t.repeat, this.textBaseline_ = t.textBaseline, this.fill_ = t.fill !== void 0 ? t.fill : new Vs({ color: Hp }), this.maxAngle_ = t.maxAngle !== void 0 ? t.maxAngle : Math.PI / 4, this.placement_ = t.placement !== void 0 ? t.placement : "point", this.overflow_ = !!t.overflow, this.stroke_ = t.stroke !== void 0 ? t.stroke : null, this.offsetX_ = t.offsetX !== void 0 ? t.offsetX : 0, this.offsetY_ = t.offsetY !== void 0 ? t.offsetY : 0, this.backgroundFill_ = t.backgroundFill ? t.backgroundFill : null, this.backgroundStroke_ = t.backgroundStroke ? t.backgroundStroke : null, this.padding_ = t.padding === void 0 ? null : t.padding;
  }
  /**
   * Clones the style.
...
function Qp(i, t, e, n) {
  ...
  function(r, s, o, a) {
    if (r !== void 0) {
      const u = i[0], l = i[i.length - 1], c = e ? qu(
        u,
        e,
        o,
        n
      ...
      const h = Math.min(c, r), f = Math.floor($c(i, h, s));
      return i[f] > c && f < i.length - 1 ? i[f + 1] : i[f];
    }
  };
}
function $p(i, t, e, n, r, s) {
...
class od extends Ir {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = bu(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && gh(), t.center && (t.center = Li(t.center, this.projection_)), t.extent && (t.extent = Ps(t.extent, this.projection_)), this.applyOptions_(t);
  }
  /**
  ...
  applyOptions_(t) {
    ...
    const r = ad(t), s = n.constraint, o = ld(t);
    this.constraints_ = {
      center: r,
      resolution: s,
      rotation: o
  ...
  animateInternal(t) {
    ...
    for (; r < e; ++r) {
      ...
      if (c.center && (h.sourceCenter = o, h.targetCenter = c.center.slice(), o = h.targetCenter), c.zoom !== void 0 ? (h.sourceResolution = a, h.targetResolution = this.getResolutionForZoom(c.zoom), a = h.targetResolution) : c.resolution && (h.sourceResolution = a, h.targetResolution = c.resolution, a = h.targetResolution), c.rotation !== void 0) {
        h.sourceRotation = u;
        const f = Qa(c.rotation - u + Math.PI, 2 * Math.PI) - Math.PI;
        h.targetRotation = u + f, u = h.targetRotation;
      }
      cd(h) ? h.complete = !0 : s += h.duration, l.push(h);
    }
    ...
    for (let n = this.animations_.length - 1; n >= 0; --n) {
      ...
      for (let o = 0, a = r.length; o < a; ++o) {
        ...
        if (u.sourceRotation !== void 0 && u.targetRotation !== void 0) {
          const f = h === 1 ? Qa(u.targetRotation + Math.PI, 2 * Math.PI) - Math.PI : u.sourceRotation + h * (u.targetRotation - u.sourceRotation);
          if (u.anchor) {
  ...
  calculateCenterRotate(t, e) {
    ...
    return r !== void 0 && (n = [r[0] - e[0], r[1] - e[1]], Zg(n, t - this.getRotation()), jg(n, e)), n;
  }
  /**
  ...
  getCenter() {
    ...
    return t && Dl(t, this.getProjection());
  }
  /**
  ...
  calculateExtent(t) {
    ...
    return _h(e, this.getProjection());
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    return Ut(r !== void 0, 3), Pg(e, n, r, t);
  }
  /**
  ...
  fit(t, e) {
    ...
    if (Ut(
      ...
      Ut(!Ou(t), 25);
      const r = Ps(t, this.getProjection());
      n = zl(r);
      ...
      n = zl(r), n.rotate(this.getRotation(), Ur(r));
    } else
      n = t;
  ...
  fitInternal(t, e) {
    ...
    const l = this.getRotation(), c = Math.sin(l), h = Math.cos(l), f = Ur(a);
    f[0] += (r[1] - r[3]) / 2 * u, f[1] += (r[0] - r[2]) / 2 * u;
    const g = f[0] * h - f[1] * c, p = f[1] * h + f[0] * c, d = this.getConstrainedCenter([g, p], u), _ = e.callback ? e.callback : Fs;
  ...
  calculateCenterShift(t, e, n, r) {
    ...
    if (o && t) {
      const a = this.getViewportSizeMinusPadding_(-n), u = za(
        t,
        r,
        [a[0] / 2 + o[3], a[1] / 2 + o[0]],
        e,
   ...
   */
  adjustCenter(t) {
    const e = Dl(this.targetCenter_, this.getProjection());
    this.setCenter([
      e[0] + t[0],
      e[1] + t[1]
    ]);
  ...
  applyTargetState_(t, e) {
    ...
    this.get(Rn.ROTATION) !== r && this.set(Rn.ROTATION, r), this.get(Rn.RESOLUTION) !== o && (this.set(Rn.RESOLUTION, o), this.set("zoom", this.getZoom(), !0)), (!a || !this.get(Rn.CENTER) || !Yo(this.get(Rn.CENTER), a)) && this.set(Rn.CENTER, a), this.getAnimating() && !t && this.cancelAnimations(), this.cancelAnchor_ = void 0;
  }
  /**
...
function ad(i) {
  if (i.extent !== void 0) {
    ...
    return Wl(i.extent, i.constrainOnlyCenter, e);
  }
  const t = bu(i.projection, "EPSG:3857");
  if (i.multiWorld !== !0 && t.isGlobal()) {
    const e = t.getExtent().slice();
    return e[0] = -1 / 0, e[2] = 1 / 0, Wl(e, !1, !1);
  }
  return Jp;
}
function ud(i) {
  let t, e, n, o = i.minZoom !== void 0 ? i.minZoom : Ba, a = i.maxZoom !== void 0 ? i.maxZoom : 28;
  const u = i.zoomFactor !== void 0 ? i.zoomFactor : 2, l = i.multiWorld !== void 0 ? i.multiWorld : !1, c = i.smoothResolutionConstraint !== void 0 ? i.smoothResolutionConstraint : !0, h = i.showFullExtent !== void 0 ? i.showFullExtent : !1, f = bu(i.projection, "EPSG:3857"), g = f.getExtent();
  let p = i.constrainOnlyCenter, d = i.extent;
  if (!l && !d && f.isGlobal() && (p = !1, d = g), i.resolutions !== void 0) {
    const _ = i.resolutions;
    e = _[o], n = _[a] !== void 0 ? _[a] : _[_.length - 1], i.constrainResolution ? t = Qp(
      _,
      c,
      !p && d,
      h
    ...
    const m = (g ? Math.max(un(g), Gs(g)) : (
      // use an extent that can fit the whole world if need be
      360 * ch.degrees / f.getMetersPerUnit()
    )) / Kp / Math.pow(2, Ba), y = m / Math.pow(2, 28 - Ba);
    ...
    ), n = e / Math.pow(u, a - o), i.constrainResolution ? t = $p(
      u,
      e,
      n,
      c,
...
function ld(i) {
  if (i.enableRotation !== void 0 ? i.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? nd() : e === !1 ? Hl : typeof e == "number" ? ed(e) : Hl;
  }
  return td;
}
function cd(i) {
...
class hd extends Zp {
  ...
  handleSourcePropertyChange_() {
    this.sourceChangeKey_ && (Qn(this.sourceChangeKey_), this.sourceChangeKey_ = null), this.sourceReady_ = !1;
    const t = this.getSource();
    t && (this.sourceChangeKey_ = Jn(
      t,
      hn.CHANGE,
  ...
  isVisible(t) {
    ...
    !t && n && (t = n.getView()), t instanceof jl ? e = {
    ...
    return fd(r, e.viewState) && (!s || Ln(s, e.extent));
  }
  /**
  ...
  getAttributions(t) {
    ...
    if (n && (e = n.getAttributions()), !e)
      return [];
    const r = t instanceof jl ? t.getViewStateAndExtent() : t;
    let s = e(r);
   ...
   */
  setMap(t) {
    this.mapPrecomposeKey_ && (Qn(this.mapPrecomposeKey_), this.mapPrecomposeKey_ = null), t || this.changed(), this.mapRenderKey_ && (Qn(this.mapRenderKey_), this.mapRenderKey_ = null), t && (this.mapPrecomposeKey_ = Jn(
      t,
      zs.PRECOMPOSE,
      function(e) {
      ...
      this
    ), this.mapRenderKey_ = Jn(this, hn.CHANGE, t.render, t), this.changed());
  }
  /**
...
const gd = hd;
function pd(i, t, e, n, r) {
  zh(i, t, e || 0, n || i.length - 1, r || dd);
}
function zh(i, t, e, n, r) {
  for (; n > e; ) {
    ...
    var f = i[t], g = e, p = n;
    for (Rs(i, e, t), r(i[n], f) > 0 && Rs(i, e, n); g < p; ) {
      for (Rs(i, g, p), g++, p--; r(i[g], f) < 0; )
        g++;
      for (; r(i[p], f) > 0; )
        p--;
    }
    r(i[e], f) === 0 ? Rs(i, e, p) : (p++, Rs(i, p, n)), p <= t && (e = p + 1), t <= p && (n = p - 1);
  }
}
function Rs(i, t, e) {
  var n = i[t];
...
let Vh = class {
  ...
  search(t) {
    ...
    for (; e; ) {
      for (let o = 0; o < e.children.length; o++) {
        ...
        bo(t, u) && (e.leaf ? n.push(a) : Xa(t, u) ? this._all(a, n) : s.push(a));
      }
      e = s.pop();
    }
    return n;
  ...
  remove(t, e) {
    ...
    for (; n || s.length; ) {
      if (n || (n = s.pop(), u = s[s.length - 1], a = o.pop(), l = !0), n.leaf) {
        const c = _d(t, n.children, e);
        if (c !== -1)
          return n.children.splice(c, 1), s.push(n), this._condense(s), this;
      }
      !l && !n.leaf && Xa(n, r) ? (s.push(n), o.push(a), a = 0, u = n, n = n.children[0]) : u ? (a++, n = u.children[a], l = !1) : n = null;
    }
    return this;
  }
  toBBox(t) {
  ...
  _build(t, e, n, r) {
    ...
    if (s <= o)
      return a = Fr(t.slice(e, n + 1)), Mr(a, this.toBBox), a;
    r || (r = Math.ceil(Math.log(s) / Math.log(o)), o = Math.ceil(s / Math.pow(o, r - 1))), a = Fr([]), a.leaf = !1, a.height = r;
    const u = Math.ceil(s / o), l = u * Math.ceil(Math.sqrt(o));
    Zl(t, e, n, l, this.compareMinX);
    for (let c = e; c <= n; c += l) {
      const h = Math.min(c + l - 1, n);
      Zl(t, c, h, u, this.compareMinY);
      for (let f = c; f <= h; f += u) {
  ...
  _chooseSubtree(t, e, n, r) {
    for (; r.push(e), !(e.leaf || r.length - 1 === n); ) {
      ...
      for (let u = 0; u < e.children.length; u++) {
        const l = e.children[u], c = Va(l), h = vd(t, l) - c;
  ...
  _insert(t, e, n) {
    ...
    for (o.children.push(t), Os(o, r); e >= 0 && s[e].children.length > this._maxEntries; )
      this._split(s, e), e--;
  ...
  _split(t, e) {
    ...
    const o = this._chooseSplitIndex(n, s, r), a = Fr(n.children.splice(o, n.children.length - o));
    a.height = n.height, a.leaf = n.leaf, Mr(n, this.toBBox), Mr(a, this.toBBox), e ? t[e - 1].children.push(a) : this._splitRoot(n, a);
  }
  _splitRoot(t, e) {
    this.data = Fr([t, e]), this.data.height = t.height + 1, this.data.leaf = !1, Mr(this.data, this.toBBox);
  }
  _chooseSplitIndex(t, e, n) {
    let r, s = 1 / 0, o = 1 / 0;
    for (let a = e; a <= n - e; a++) {
      const u = Ts(t, 0, a, this.toBBox), l = Ts(t, a, n, this.toBBox), c = Ed(u, l), h = Va(u) + Va(l);
  ...
  _chooseSplitAxis(t, e, n) {
    const r = t.leaf ? this.compareMinX : md, s = t.leaf ? this.compareMinY : yd, o = this._allDistMargin(t, e, n, r), a = this._allDistMargin(t, e, n, s);
    o < a && t.children.sort(r);
  }
  // total margin of all possible split distributions where each node is at least m full
  _allDistMargin(t, e, n, r) {
    t.children.sort(r);
    const s = this.toBBox, o = Ts(t, 0, e, s), a = Ts(t, n - e, n, s);
    let u = Oo(o) + Oo(a);
    for (let l = e; l < n - e; l++) {
      const c = t.children[l];
      Os(o, t.leaf ? s(c) : c), u += Oo(o);
    }
    for (let l = n - e - 1; l >= e; l--) {
      const c = t.children[l];
      Os(a, t.leaf ? s(c) : c), u += Oo(a);
    }
    return u;
  }
  ...
  _condense(t) {
    for (let e = t.length - 1, n; e >= 0; e--)
      t[e].children.length === 0 ? e > 0 ? (n = t[e - 1].children, n.splice(n.indexOf(t[e]), 1)) : this.clear() : Mr(t[e], this.toBBox);
  }
};
function _d(i, t, e) {
  if (!e)
...
function Mr(i, t) {
  Ts(i, 0, i.children.length, t, i);
}
function Ts(i, t, e, n, r) {
  r || (r = Fr(null)), r.minX = 1 / 0, r.minY = 1 / 0, r.maxX = -1 / 0, r.maxY = -1 / 0;
  for (let s = t; s < e; s++) {
...
function Cd(i, t, e) {
  ...
  let r = !0, s = !1, o = !1;
  const a = [
    Vo(n, hn.LOAD, function() {
      o = !0, s || t();
    })
  ];
  return n.src && pg ? (s = !0, n.decode().then(function() {
    r && t();
  }).catch(function(u) {
    r && (o ? t() : e());
  })) : a.push(Vo(n, hn.ERROR, e)), function() {
    r = !1, a.forEach(Qn);
  };
}
let ws = null;
class Id extends th {
  ...
  getHitDetectionImage() {
    if (this.image_ || this.initializeImage_(), !this.hitDetectionImage_)
      if (this.isTainted_()) {
        const t = this.size_[0], e = this.size_[1], n = bn(t, e);
  ...
  replaceColor_(t) {
    ...
    r.scale(t, t), r.drawImage(e, 0, 0), r.globalCompositeOperation = "multiply", r.fillStyle = bh(this.color_), r.fillRect(0, 0, n.width / t, n.height / t), r.globalCompositeOperation = "destination-in", r.drawImage(e, 0, 0), this.canvas_[t] = n;
  }
  /**
...
function Sd(i, t, e, n, r, s) {
  let o = Jl.get(t, n, s);
  return o || (o = new Id(i, t, e, n, r, s), Jl.set(t, n, s, o)), o;
}
function Ql(i, t, e, n) {
...
class ju extends Oh {
  ...
  constructor(t) {
    ...
    if (this.color_ = t.color !== void 0 ? Zo(t.color) : null, this.iconImage_ = Sd(
      o,
      /** @type {string} */
      a,
  ...
  clone() {
    let t, e, n;
    return this.initialOptions_ ? (e = this.initialOptions_.width, n = this.initialOptions_.height) : (t = this.getScale(), t = Array.isArray(t) ? t.slice() : t), new ju({
   ...
   */
  listenImageChange(t) {
    this.iconImage_.addEventListener(hn.CHANGE, t);
  }
  /**
   * Load not yet loaded URI.
   ...
   */
  unlistenImageChange(t) {
    this.iconImage_.removeEventListener(hn.CHANGE, t);
  }
}
const Zu = ju;
function $l(i) {
...
function qs(i, t) {
  ...
  if (e)
    return e === "none" ? null : new Vs({ color: e });
}
function Hs(i, t) {
...
class Nd extends gd {
   ...
   */
  renderDeclutter(t) {
    t.declutterTree || (t.declutterTree = new Vh(9)), this.getRenderer().renderDeclutter(t);
  }
  /**
  ...
  setStyle(t) {
    ...
    if (t === void 0)
      ...
      for (let s = 0; s < n; ++s) {
        const o = t[s];
        o instanceof $o ? r[s] = o : r[s] = $l(o);
      }
      e = r;
    } else
      e = $l(t);
    this.style_ = e, this.styleFunction_ = t === null ? void 0 : Wp(this.style_), this.changed();
  }
}
const Ld = Nd, fo = {
  BEGIN_GEOMETRY: 0,
  ...
  SET_STROKE_STYLE: 11,
  STROKE: 12
}, Mo = [fo.FILL], ki = [fo.STROKE], sr = [fo.BEGIN_PATH], ec = [fo.CLOSE_PATH], H = fo;
class Pd {
  /**
...
class Td extends Xh {
  ...
  appendFlatPointCoordinates(t, e) {
    ...
    for (let a = 0, u = t.length; a < u; a += e)
      r[0] = t[a], r[1] = t[a + 1], Ig(n, r) && (s[o++] = r[0], s[o++] = r[1]);
    return o;
  }
  /**
   * @param {Array<number>} flatCoordinates Flat coordinates.
  ...
  appendFlatLineCoordinates(t, e, n, r, s, o) {
    ...
    let g = !0, p, d, _;
    for (p = e + r; p < n; p += r)
      f[0] = t[p], f[1] = t[p + 1], _ = Ka(l, f), _ !== d ? (g && (a[u++] = c, a[u++] = h, g = !1), a[u++] = f[0], a[u++] = f[1]) : _ === Zt.INTERSECTING ? (a[u++] = f[0], a[u++] = f[1], g = !1) : g = !0, c = f[0], h = f[1], d = _;
  ...
  reverseHitDetectionInstructions() {
    ...
    for (e = 0; e < n; ++e)
      ...
      r[0], s == H.END_GEOMETRY ? o = e : s == H.BEGIN_GEOMETRY && (r[2] = e, ig(this.hitDetectionInstructions, o, e), o = -1);
  }
  /**
   * @param {import("../../style/Fill.js").default} fillStyle Fill style.
   * @param {import("../../style/Stroke.js").default} strokeStyle Stroke style.
  ...
  updateStrokeStyle(t, e) {
    ...
    (t.currentStrokeStyle != n || t.currentLineCap != r || s != t.currentLineDash && !ps(t.currentLineDash, s) || t.currentLineDashOffset != o || t.currentLineJoin != a || t.currentLineWidth != u || t.currentMiterLimit != l) && (n !== void 0 && e.call(this, t), t.currentStrokeStyle = n, t.currentLineCap = r, t.currentLineDash = s, t.currentLineDashOffset = o, t.currentLineJoin = a, t.currentLineWidth = u, t.currentMiterLimit = l);
  }
  /**
   * @param {import("../../Feature.js").FeatureLike} feature Feature.
   */
  ...
  getBufferedMaxExtent() {
    if (!this.bufferedMaxExtent_ && (this.bufferedMaxExtent_ = Cg(this.maxExtent), this.maxLineWidth > 0)) {
      ...
      Pu(this.bufferedMaxExtent_, t, this.bufferedMaxExtent_);
    }
...
class Ad extends go {
  ...
  drawFlatCoordinatess_(t, e, n, r) {
    ...
    for (let l = 0; l < u; ++l) {
      ...
      this.instructions.push(g), this.hitDetectionInstructions.push(g), a && (this.instructions.push(ec), this.hitDetectionInstructions.push(ec)), e = c;
    }
    return o && (this.instructions.push(Mo), this.hitDetectionInstructions.push(Mo)), a && (this.instructions.push(ki), this.hitDetectionInstructions.push(ki)), e;
  }
  /**
   * @param {import("../../geom/Circle.js").default} circleGeometry Circle geometry.
   * @param {import("../../Feature.js").default} feature Feature.
  ...
  drawCircle(t, e) {
    ...
    const l = [H.CIRCLE, u];
    this.instructions.push(sr, l), this.hitDetectionInstructions.push(sr, l), n.fillStyle !== void 0 && (this.instructions.push(Mo), this.hitDetectionInstructions.push(Mo)), n.strokeStyle !== void 0 && (this.instructions.push(ki), this.hitDetectionInstructions.push(ki)), this.endGeometry(e);
  }
  /**
   * @param {import("../../geom/Polygon.js").default|import("../Feature.js").default} polygonGeometry Polygon geometry.
   * @param {import("../../Feature.js").FeatureLike} feature Feature.
...
function Fd(i, t, e, n, r) {
  ...
  for (; a < i && o + r < n; ) {
    ...
    if (a += g, a >= i) {
      const p = (i - a + g) / g, d = Ve(l, h, p), _ = Ve(c, f, p);
      ...
      const p = g - a, d = Ve(l, h, p / g), _ = Ve(c, f, p / g);
      u.push(d, _), s.push(u), u = [d, _], a = 0, o += r;
    }
  }
  return a > 0 && s.push(u), s;
}
function kd(i, t, e, n, r) {
...
class Gd extends go {
  ...
  drawText(t, e) {
    ...
    if (s.placement === "line" && (u == "LineString" || u == "MultiLineString" || u == "Polygon" || u == "MultiPolygon")) {
      if (!Ln(this.getBufferedMaxExtent(), t.getExtent()))
        return;
      let h;
      ...
      switch (u) {
        ...
        case "MultiPolygon":
          ...
          l = [];
          for (let y = 0, E = m.length; y < E; y += 3)
      ...
      if (h && (f - a) / 2 !== l.length / c) {
        let m = a / 2;
        h = h.filter((y, E) => {
          const I = o[(m + E) * 2] === l[E * c] && o[(m + E) * 2 + 1] === l[E * c + 1];
          return I || --m, I;
        });
      }
      ...
      if (g != rr && (s.scale[0] < 0 || s.scale[1] < 0)) {
        let m = s.padding[0], y = s.padding[1], E = s.padding[2], I = s.padding[3];
        s.scale[0] < 0 && (y = -y, I = -I), s.scale[1] < 0 && (m = -m, E = -E), g = [m, y, E, I];
      }
  ...
  drawChars_(t, e) {
    ...
    const u = this.pixelRatio, l = ta[r.textBaseline], c = this.textOffsetY_ * u, h = this.text_, f = n ? n.lineWidth * Math.abs(r.scale[0]) / 2 : 0;
    this.instructions.push([
      H.DRAW_CHARS,
      t,
      e,
  ...
  setTextStyle(t, e) {
    ...
    if (!t)
      ...
      {}, this.textFillState_ = r), r.fillStyle = Zn(
        o.getColor() || Pe
      ...
      if (!a)
        ...
        s.lineCap = a.getLineCap() || Ko, s.lineDash = p ? p.slice() : di, s.lineDashOffset = d === void 0 ? _i : d, s.lineJoin = a.getLineJoin() || qr, s.lineWidth = _ === void 0 ? Ws : _, s.miterLimit = m === void 0 ? Xs : m, s.strokeStyle = Zn(
          a.getColor() || Ys
        );
      }
      n = this.textState_;
      const u = t.getFont() || Ah;
      zp(u);
      const l = t.getScaleArray();
      n.overflow = t.getOverflow(), n.font = u, n.maxAngle = t.getMaxAngle(), n.placement = t.getPlacement(), n.textAlign = t.getTextAlign(), n.repeat = t.getRepeat(), n.justify = t.getJustify(), n.textBaseline = t.getTextBaseline() || Jo, n.backgroundFill = t.getBackgroundFill(), n.backgroundStroke = t.getBackgroundStroke(), n.padding = t.getPadding() || rr, n.scale = l === void 0 ? [1, 1] : l;
...
class Vd extends eh {
  ...
  loadImage(t) {
    let e = t.getState();
    return e != bt.LOADED && e != bt.ERROR && t.addEventListener(hn.CHANGE, this.boundHandleImageChange_), e == bt.IDLE && (t.load(), e = t.getState()), e == bt.LOADED;
  }
  /**
   * @protected
   */
...
class qd extends Xd {
   ...
   */
  getImageData(t, e, n) {
    kr || Wd(), kr.clearRect(0, 0, 1, 1);
    let r;
    try {
      kr.drawImage(t, e, n, 1, 1, 0, 0, 1, 1), r = kr.getImageData(0, 0, 1, 1).data;
    } catch {
      return kr = null, null;
    }
    return r;
  ...
  useContainer(t, e, n) {
    ...
    let s, o;
    if (t && t.className === r && (!n || t && t.style.backgroundColor && ps(
    ...
    if (o && o.canvas.style.transform === e ? (this.container = t, this.context = o, this.containerReused = !0) : this.containerReused ? (this.container = null, this.context = null, this.containerReused = !1) : this.container && (this.container.style.backgroundColor = null), !this.container) {
      ...
      let a = s.style;
      a.position = "absolute", a.width = "100%", a.height = "100%", o = bn();
      const u = o.canvas;
   ...
   */
  clipUnrotated(t, e, n) {
    const r = ah(n), s = uh(n), o = oh(n), a = sh(n);
   ...
   */
  preRender(t, e) {
    this.frameState = e, this.dispatchRenderEvent_(zs.PRERENDER, t, e);
  }
  /**
   * @param {CanvasRenderingContext2D} context Context.
   * @param {import("../../Map.js").FrameState} frameState Frame state.
   ...
   */
  postRender(t, e) {
    this.dispatchRenderEvent_(zs.POSTRENDER, t, e);
  }
  /**
...
const Hd = qd;
function jd(i, t, e, n, r, s, o, a, u, l, c, h) {
  ...
  while (t < e - n && m + _ < s);
  let E = _ === 0 ? 0 : (s - m) / _;
  const I = Ve(p, f, E), S = Ve(d, g, E), w = t - n, b = m, L = s + a * u(l, r, c);
  for (; t < e - n && m + _ < L; )
    y();
  E = _ === 0 ? 0 : (L - m) / _;
  const P = Ve(p, f, E), G = Ve(d, g, E);
  let B;
  if (h) {
    const k = [I, S, P, G];
    mh(k, 0, 4, 2, h, k, k), B = k[0] > k[2];
  } else
    B = I > P;
  ...
  for (let k = 0, z = r.length; k < z; ) {
    ...
    let It = 0;
    for (; k < z; ++k) {
      const me = B ? z - k - 1 : k, Ge = a * u(l, r[me], c);
    ...
    E = _ === 0 ? 0 : (s + It / 2 - m) / _;
    const D = Ve(p, f, E), $e = Ve(d, g, E);
    U.push([D, $e, It / 2, Z, Ft]), s += It;
  }
  return U;
}
const Dr = ur(), Ti = [], hi = [], fi = [], Oi = [];
function sc(i) {
...
function Ya(i, t) {
  return t === "start" ? t = oc.test(i) ? "right" : "left" : t === "end" && (t = oc.test(i) ? "left" : "right"), ta[t];
}
function Zd(i, t, e) {
  return e > 0 && i.push(`
`, ""), i.push(t, ""), i;
...
class Kd {
  ...
  createLabel(t, e, n, r) {
    ...
    const o = r ? this.strokeStates[r] : null, a = n ? this.fillStates[n] : null, u = this.textStates[e], l = this.pixelRatio, c = [
      u.scale[0] * l,
      u.scale[1] * l
    ], h = Array.isArray(t), f = u.justify ? ta[u.justify] : Ya(
      Array.isArray(t) ? t[0] : t,
      u.textAlign || Us
    ), g = r && o.lineWidth ? o.lineWidth : 0, p = h ? t : t.split(`
`).reduce(Zd, []), { width: d, height: _, widths: m, heights: y, lineWidths: E } = Xp(
      u,
      p
...
`) {
  ...
  calculateImageOrLabelDimensions_(t, e, n, r, s, o, a, u, l, c, h, f, g, p, d, _) {
    ...
    (d || h !== 0) && (Ti[0] = b, Oi[0] = b, Ti[1] = L, hi[1] = L, hi[0] = b + S, fi[0] = hi[0], fi[1] = L + w, Oi[1] = fi[1]);
    let P;
    return h !== 0 ? (P = co(
      Bi(),
      n,
      ...
      -n,
      -r
    ), Le(P, Ti), Le(P, hi), Le(P, fi), Le(P, Oi), lr(
      Math.min(Ti[0], hi[0], fi[0], Oi[0]),
      Math.min(Ti[1], hi[1], fi[1], Oi[1]),
      Math.max(Ti[0], hi[0], fi[0], Oi[0]),
      Math.max(Ti[1], hi[1], fi[1], Oi[1]),
      Dr
    )) : lr(
      Math.min(b, b + S),
      Math.min(L, L + w),
  ...
  drawLabelWithPointPlacement_(t, e, n, r) {
    const s = this.textStates[e], o = this.createLabel(t, e, r, n), a = this.strokeStates[n], u = this.pixelRatio, l = Ya(
      Array.isArray(t) ? t[0] : t,
      s.textAlign || Us
    ), c = ta[s.textBaseline || Jo], h = a && a.lineWidth ? a.lineWidth : 0, f = o.width / u - 2 * s.scale[0], g = l * f + 2 * (0.5 - l) * h, p = c * o.height / u + 2 * (0.5 - c) * h;
    return {
      label: o,
      anchorX: g,
      anchorY: p
  ...
  execute_(t, e, n, r, s, o, a, u) {
    let l;
    this.pixelCoordinates_ && ps(n, this.renderedTransform_) ? l = this.pixelCoordinates_ : (this.pixelCoordinates_ || (this.pixelCoordinates_ = []), l = ar(
      this.coordinates,
      0,
    ...
    for (; c < h; ) {
      ...
      switch (
        ...
        case H.BEGIN_GEOMETRY:
          ...
          D[1], Ft = D[3], Z.getGeometry() ? a !== void 0 && !Ln(a, Ft.getExtent()) ? c = /** @type {number} */
        ...
        case H.CIRCLE:
          f = /** @type {number} */
          D[1];
          const me = l[f], Ge = l[f + 1], Bf = l[f + 2], zf = l[f + 3], gl = Bf - me, pl = zf - Ge, dl = Math.sqrt(gl * gl + pl * pl);
          t.moveTo(me + dl, Ge), t.arc(me, Ge, dl, 0, 2 * Math.PI, !0), ++c;
          break;
        case H.CLOSE_PATH:
          t.closePath(), ++c;
          break;
        case H.CUSTOM:
          ...
          const Vf = (
            ...
            D[3]
          ), Xf = D[4], _l = D.length == 6 ? D[5] : void 0;
          k.geometry = Vf, k.feature = Z, c in U || (U[c] = []);
          const Es = U[c];
          _l ? _l(l, f, g, 2, Es) : (Es[0] = l[f], Es[1] = l[f + 1], Es.length = 2), Xf(Es, k), ++c;
          break;
        case H.DRAW_IMAGE:
          f = /** @type {number} */
          D[1], g = /** @type {number} */
          ...
          if (!I && D.length >= 20) {
            ...
            p = (Be.anchorX - Or) * this.pixelRatio, D[4] = p;
            const tn = (
              /** @type {number} */
              D[24]
            );
            d = (Be.anchorY - tn) * this.pixelRatio, D[5] = d, Oa = I.height, D[6] = Oa, Co = I.width, D[13] = Co;
          }
          let Ma;
          D.length > 25 && (Ma = /** @type {number} */
          D[25]);
          let Da, Io, So;
          D.length > 17 ? (Da = /** @type {Array<number>} */
          D[16], Io = /** @type {boolean} */
          D[17], So = /** @type {boolean} */
          D[18]) : (Da = rr, Io = !1, So = !1), ml && O ? ba += T : !ml && !O && (ba -= T);
          let Hf = 0;
          for (; f < g; f += 2) {
            if (Ma && Ma[Hf++] < Co / this.pixelRatio)
              continue;
            ...
            if (u) {
              ...
              if (yl === "obstacle") {
                ...
                if (xs) {
                  ...
                  if (tn = xs[ze], delete xs[ze], ui = sc(tn), u.collides(ui))
                    continue;
                }
                if (u.collides(Be.declutterBox))
                  continue;
                tn && (u.insert(ui), this.replayImageOrLabel_.apply(this, tn)), u.insert(Be.declutterBox);
              }
            }
            this.replayImageOrLabel_.apply(this, Or);
          }
          ++c;
          break;
        case H.DRAW_CHARS:
          ...
          const Il = [
            ...
            /** @type {number} */
            D[13]
          ], ka = this.textStates[w], Cs = ka.font, Is = [
            ka.scale[0] * xl,
            ka.scale[1] * xl
          ];
          let Ss;
          Cs in this.widths_ ? Ss = this.widths_[Cs] : (Ss = {}, this.widths_[Cs] = Ss);
          const Sl = Th(l, vl, El, 2), Rl = Math.abs(Is[0]) * Yl(Cs, S, Ss);
          if (jf || Rl <= Sl) {
            const Be = this.textStates[w].textAlign, Or = (Sl - Rl) * Ya(S, Be), tn = jd(
              l,
              vl,
              El,
              2,
            ...
            t:
              if (tn) {
                ...
                let ze, Ro, wo, Ne, en;
                if (b)
                  for (ze = 0, Ro = tn.length; ze < Ro; ++ze) {
                    en = tn[ze], wo = /** @type {string} */
                    en[4], Ne = this.createLabel(wo, w, "", b), p = /** @type {number} */
                    en[2] + (Is[0] < 0 ? -Fa : Fa), d = Aa * Ne.height + (0.5 - Aa) * 2 * Fa * Is[1] / Is[0] - Cl;
                    ...
                    if (u && u.collides(li.declutterBox))
                      break t;
                    ui.push([
                      t,
                      e,
                ...
                if (L)
                  for (ze = 0, Ro = tn.length; ze < Ro; ++ze) {
                    en = tn[ze], wo = /** @type {string} */
                    en[4], Ne = this.createLabel(wo, w, L, ""), p = /** @type {number} */
                    en[2], d = Aa * Ne.height - Cl;
                    const li = this.calculateImageOrLabelDimensions_(
                      Ne.width,
                      Ne.height,
                      en[0],
                ...
                u && u.load(ui.map(sc));
                for (let li = 0, Kf = ui.length; li < Kf; ++li)
                  this.replayImageOrLabel_.apply(this, ui[li]);
              }
          }
          ++c;
          break;
...
const Jd = Kd, Ua = ["Polygon", "Circle", "LineString", "Image", "Text", "Default"];
class Qd {
  /**
  ...
  forEachFeatureAtCoordinate(t, e, n, r, s, o) {
    ...
    l && (this.hitDetectionContext_ = bn(
      a,
      a,
      void 0,
      { willReadFrequently: !0 }
    ...
    let h;
    this.renderBuffer_ !== void 0 && (h = ur(), wg(h, t), Pu(
      h,
    ...
    for (_ = d.length - 1; _ >= 0; --_) {
      ...
      for (y = this.executorsByZIndex_[S], m = Ua.length - 1; m >= 0; --m)
        if (g = Ua[m], E = y[g], E !== void 0 && (I = E.executeHitDetection(
          c,
          u,
          n,
          p,
  ...
  execute(t, e, n, r, s, o, a) {
    ...
    u.sort(As), this.maxExtent_ && (t.save(), this.clip(t, n)), o = o || Ua;
    let l, c, h, f, g, p;
...
class t_ extends Xh {
  ...
  constructor(t, e, n, r, s, o, a) {
    super(), this.context_ = t, this.pixelRatio_ = e, this.extent_ = n, this.transform_ = r, this.transformRotation_ = r ? Hg(Math.atan2(r[1], r[0]), 10) : 0, this.viewRotation_ = s, this.squaredTolerance_ = o, this.userTransform_ = a, this.contextFillState_ = null, this.contextStrokeState_ = null, this.contextTextState_ = null, this.fillState_ = null, this.strokeState_ = null, this.image_ = null, this.imageAnchorX_ = 0, this.imageAnchorY_ = 0, this.imageHeight_ = 0, this.imageOpacity_ = 0, this.imageOriginX_ = 0, this.imageOriginY_ = 0, this.imageRotateWithView_ = !1, this.imageRotation_ = 0, this.imageScale_ = [0, 0], this.imageWidth_ = 0, this.text_ = "", this.textOffsetX_ = 0, this.textOffsetY_ = 0, this.textRotateWithView_ = !1, this.textRotation_ = 0, this.textScale_ = [0, 0], this.textFillState_ = null, this.textStrokeState_ = null, this.textState_ = null, this.pixelCoordinates_ = [], this.tmpLocalTransform_ = Bi();
  }
  /**
   * @param {Array<number>} flatCoordinates Flat coordinates.
   * @param {number} offset Offset.
  ...
  setContextStrokeState_(t) {
    ...
    n ? (n.lineCap != t.lineCap && (n.lineCap = t.lineCap, e.lineCap = t.lineCap), ps(n.lineDash, t.lineDash) || e.setLineDash(
  ...
  setFillStrokeStyle(t, e) {
    ...
    if (!e)
      ...
      const n = e.getColor(), r = e.getLineCap(), s = e.getLineDash(), o = e.getLineDashOffset(), a = e.getLineJoin(), u = e.getWidth(), l = e.getMiterLimit(), c = s || di;
      this.strokeState_ = {
        lineCap: r !== void 0 ? r : Ko,
        lineDash: this.pixelRatio_ === 1 ? c : c.map((h) => h * this.pixelRatio_),
        lineDashOffset: (o || _i) * this.pixelRatio_,
        lineJoin: a !== void 0 ? a : qr,
...
function n_(i, t, e, n, r, s, o) {
  const a = i[0] * jn, u = i[1] * jn, l = bn(a, u);
  ...
  const d = Object.keys(p).map(Number).sort(As);
  for (let _ = 0, m = d.length; _ < m; ++_) {
    const y = p[d[_]];
    for (const E in y) {
      const I = y[E];
...
function i_(i, t, e) {
  const n = [];
  if (e) {
    const r = Math.floor(Math.round(i[0]) * jn), s = Math.floor(Math.round(i[1]) * jn), o = (he(r, 0, e.width - 1) + he(s, 0, e.height - 1) * e.width) * 4, a = e.data[o], u = e.data[o + 1], c = e.data[o + 2] + 256 * (u + 256 * a), h = Math.floor((256 * 256 * 256 - 1) / t.length);
...
class __ extends Hd {
   ...
   */
  renderWorlds(t, e, n) {
    const r = e.extent, s = e.viewState, o = s.center, a = s.resolution, u = s.projection, l = s.rotation, c = u.getExtent(), h = this.getLayer().getSource(), f = e.pixelRatio, g = e.viewHints, p = !(g[sn.ANIMATING] || g[sn.INTERACTING]), d = this.compositionContext_, _ = Math.round(e.size[0] * f), m = Math.round(e.size[1] * f), y = h.getWrapX() && u.canWrapX(), E = y ? un(c) : null, I = y ? Math.ceil((r[2] - c[2]) / E) + 1 : 1;
  ...
  releaseCompositionContext_() {
    if (this.opacity_ !== 1) {
      ...
      this.context.globalAlpha = this.opacity_, this.context.drawImage(this.compositionContext_.canvas, 0, 0), this.context.globalAlpha = t, Gp(this.compositionContext_), rc.push(this.compositionContext_.canvas), this.compositionContext_ = null;
    }
  }
  /**
   * Render declutter items for this layer
  ...
  renderFrame(t, e) {
    ...
    mg(this.pixelTransform, 1 / n, 1 / n), yg(this.inversePixelTransform, this.pixelTransform);
    ...
    if (!c && !(this.getLayer().hasListener(zs.PRERENDER) || this.getLayer().hasListener(zs.POSTRENDER)))
      return null;
    ...
    if (c && r.extent && this.clipping) {
      const d = Ps(r.extent);
      c = Ln(d, t.extent), p = c && !Br(d, t.extent), p && this.clipUnrotated(this.compositionContext_, t, d);
    }
    return c && this.renderWorlds(u, t), p && this.compositionContext_.restore(), this.releaseCompositionContext_(), this.postRender(o, t), this.renderedRotation_ !== g.rotation && (this.renderedRotation_ = g.rotation, this.hitDetectionImageData_ = null), this.container;
  }
  /**
   * Asynchronous layer level hit detection.
   * @param {import("../../pixel.js").Pixel} pixel Pixel.
  ...
  getFeatures(t) {
    return new Promise((e) => {
      if (!this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
        ...
        const r = this.renderedCenter_, s = this.renderedResolution_, o = this.renderedRotation_, a = this.renderedProjection_, u = this.wrappedRenderedExtent_, l = this.getLayer(), c = [], h = n[0] * jn, f = n[1] * jn;
        c.push(
        ...
        if (g.getWrapX() && a.canWrapX() && !Br(p, u)) {
          let d = u[0];
          const _ = un(p);
          let m = 0, y;
          for (; d < p[0]; )
  ...
  prepareFrame(t) {
    ...
    d === void 0 && (d = s_);
    const _ = l.center.slice(), m = Pu(
      u,
      p * h
    ), y = m.slice(), E = [m.slice()], I = c.getExtent();
    if (n.getWrapX() && c.canWrapX() && !Br(I, t.extent)) {
      const O = un(I), k = Math.max(un(m) / 2, O);
      m[0] = I[0] - k, m[2] = I[2] + k, Kg(_, c);
      const z = lh(E[0], c);
    ...
    if (this.ready && this.renderedResolution_ == h && this.renderedRevision_ == g && this.renderedRenderOrder_ == d && Br(this.wrappedRenderedExtent_, m))
      return ps(this.renderedExtent_, y) || (this.hitDetectionImageData_ = null, this.renderedExtent_ = y), this.renderedCenter_ = _, this.replayGroupChanged = !1, !0;
    ...
    let w;
    this.getLayer().getDeclutter() && (w = new ic(
      uu(h, f),
      m,
      h,
      f
    ...
    return w && (this.declutterExecutorGroup = new ac(
      m,
      h,
      f,
      n.getOverlaps(),
...
class E_ {
   ...
   */
  constructor(t) {
    this.rbush_ = new Vh(t), this.items_ = {};
  }
  /**
  ...
  update(t, e) {
    ...
    ih(r, t) || (this.remove(e), this.insert(t, e));
  }
  /**
...
class x_ extends Ir {
   ...
   */
  constructor(t) {
    super(), this.projection = Wr(t.projection), this.attributions_ = cc(t.attributions), this.attributionsCollapsible_ = t.attributionsCollapsible !== void 0 ? t.attributionsCollapsible : !0, this.loading = !1, this.state_ = t.state !== void 0 ? t.state : "ready", this.wrapX_ = t.wrapX !== void 0 ? t.wrapX : !1, this.interpolate_ = !!t.interpolate, this.viewResolver = null, this.viewRejector = null;
    const e = this;
   ...
   */
  setAttributions(t) {
    this.attributions_ = cc(t), this.changed();
  }
  /**
...
class w_ extends C_ {
  ...
  constructor(t) {
    ...
    }), this.on, this.once, this.un, this.loader_ = Fs, this.format_ = t.format, this.overlaps_ = t.overlaps === void 0 ? !0 : t.overlaps, this.url_ = t.url, t.loader !== void 0 ? this.loader_ = t.loader : this.url_ !== void 0 && (Ut(this.format_, 7), this.loader_ = hc(
      this.url_,
      /** @type {import("../format/Feature.js").default} */
      this.format_
    )), this.strategy_ = t.strategy !== void 0 ? t.strategy : I_;
    const e = t.useSpatialIndex !== void 0 ? t.useSpatialIndex : !0;
    this.featuresRtree_ = e ? new lc() : null, this.loadedExtentsRtree_ = new lc(), this.loadingExtentsCount_ = 0, this.nullGeometryFeatures_ = {}, this.idIndex_ = {}, this.uidIndex_ = {}, this.featureChangeKeys_ = {}, this.featuresCollection_ = null;
    let n, r;
    Array.isArray(t.features) ? r = t.features : t.features && (n = t.features, r = n.getArray()), !e && n === void 0 && (n = new hg(r)), r !== void 0 && this.addFeaturesInternal(r), n !== void 0 && this.bindFeaturesCollection_(n);
  }
  /**
  ...
  setupChangeEvents_(t, e) {
    this.featureChangeKeys_[t] = [
      Jn(e, hn.CHANGE, this.handleFeatureChange_, this),
      Jn(
        e,
        Qc.PROPERTYCHANGE,
  ...
  clear(t) {
    if (t) {
      for (const n in this.featureChangeKeys_)
        this.featureChangeKeys_[n].forEach(Qn);
  ...
  getFeatures() {
    let t;
    return this.featuresCollection_ ? t = this.featuresCollection_.getArray().slice(0) : this.featuresRtree_ && (t = this.featuresRtree_.getAll(), ks(this.nullGeometryFeatures_) || pi(t, Object.values(this.nullGeometryFeatures_))), /** @type {Array<import("../Feature.js").default<Geometry>>} */
    t;
  }
  /**
  ...
  getClosestFeatureToCoordinate(t, e) {
    ...
    return e = e || rg, this.featuresRtree_.forEachInExtent(
      u,
      /**
       * @param {import("../Feature.js").default<Geometry>} feature Feature.
       */
  ...
  loadFeatures(t, e, n) {
    ...
    for (let o = 0, a = s.length; o < a; ++o) {
      ...
      r.forEachInExtent(
         ...
         */
        function(c) {
          return Br(c.extent, u);
        }
      ) || (++this.loadingExtentsCount_, this.dispatchEvent(
        new bi(wn.FEATURESLOADSTART)
      ), this.loader_.call(
        this,
        u,
        e,
   ...
   */
  setUrl(t) {
    Ut(this.format_, 7), this.url_ = t, this.setLoader(hc(t, this.format_));
  }
}
const N_ = w_;
let L_ = class lu extends yh {
  /**
  ...
  unlistenGeometriesChange_() {
    this.changeEventsKeys_.forEach(Qn), this.changeEventsKeys_.length = 0;
  }
  /**
   * @private
   */
    ...
    if (this.geometries_)
      for (let t = 0, e = this.geometries_.length; t < e; ++t)
        this.changeEventsKeys_.push(
          Jn(this.geometries_[t], hn.CHANGE, this.changed, this)
        );
  }
  /**
   * Make a complete copy of the geometry.
  ...
  constructor(t, e, n) {
    if (super(), this.ends_ = [], this.maxDelta_ = -1, this.maxDeltaRevision_ = -1, Array.isArray(t[0]))
      ...
      for (let u = 0, l = s.length; u < l; ++u) {
        const c = s[u];
        u === 0 && (r = c.getLayout()), pi(o, c.getFlatCoordinates()), a.push(o.length);
      }
...
let O_ = class Wh extends Rr {
  ...
  getPoints() {
    ...
    for (let s = 0, o = t.length; s < o; s += n) {
      const a = new Yr(t.slice(s, s + n), e);
      r.push(a);
    }
    return r;
  }
...
let D_ = class hu extends Rr {
    ...
    if (super(), this.endss_ = [], this.flatInteriorPointsRevision_ = -1, this.flatInteriorPoints_ = null, this.maxDelta_ = -1, this.maxDeltaRevision_ = -1, this.orientedRevision_ = -1, this.orientedFlatCoordinates_ = null, !n && !Array.isArray(t[0])) {
      ...
      for (let u = 0, l = s.length; u < l; ++u) {
        ...
        for (let g = 0, p = f.length; g < p; ++g)
          f[g] += h;
        pi(o, c.getFlatCoordinates()), a.push(f);
      }
      e = r, t = o, n = a;
    }
  ...
  closestPointXY(t, e, n, r) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), pp(
      this.getOrientedFlatCoordinates(),
      0,
      this.endss_,
      this.stride,
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), Bl(
      e,
      0,
      this.endss_,
      this.stride,
      t
    )) : e = this.flatCoordinates, tu(
      e,
      0,
      this.endss_,
      this.stride
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      const t = this.flatCoordinates;
      Tp(t, 0, this.endss_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = Bl(
        this.orientedFlatCoordinates_,
        0,
        this.endss_,
        this.stride
...
function z_(i, t) {
  t === void 0 && (t = {});
  var e = gu(i), n = (e[0] + e[2]) / 2, r = (e[1] + e[3]) / 2;
...
cr.prototype.equalsWithTolerance = function(t, e, n) {
...
Zh.MAX_VALUE.get = function() {
  return Number.MAX_VALUE;
};
Object.defineProperties(W, Zh);
var Fe = function() {
}, va = function() {
}, Hr = function() {
};
...
}, wr = { DimensionalComparator: { configurable: !0 }, serialVersionUID: { configurable: !0 }, NULL_ORDINATE: { configurable: !0 }, X: { configurable: !0 }, Y: { configurable: !0 }, Z: { configurable: !0 } };
...
v.prototype.equals2D = function() {
  if (arguments.length === 1) {
    ...
    return !(!cr.equalsWithTolerance(this.x, e.x, n) || !cr.equalsWithTolerance(this.y, e.y, n));
  }
};
...
v.prototype.equalInZ = function(t, e) {
  return cr.equalsWithTolerance(this.z, t.z, e);
};
...
wr.DimensionalComparator.get = function() {
  return gi;
};
wr.serialVersionUID.get = function() {
  return 6683108902428367e3;
};
wr.NULL_ORDINATE.get = function() {
  return W.NaN;
};
wr.X.get = function() {
  return 0;
...
Kh.LOG_10.get = function() {
  return Math.log(10);
};
Object.defineProperties(xe, Kh);
var Cn = function(t) {
  this.str = t;
};
...
var ae = function() {
}, Jh = { DP_SAFE_EPSILON: { configurable: !0 } };
...
Jh.DP_SAFE_EPSILON.get = function() {
  return 1e-15;
};
Object.defineProperties(ae, Jh);
var $ = function() {
...
Ea.prototype.read = function(t) {
  ...
  if (t.search("EMPTY") !== -1 && (s = nn.emptyTypeStr.exec(t), s[2] = void 0), s && (n = s[1].toLowerCase(), r = s[2], Vr[n] && (e = Vr[n].apply(this, [r]))), e === void 0)
...
Ea.prototype.extractGeometry = function(t) {
  var e = t.getGeometryType().toLowerCase();
  if (!Un[e])
    return null;
  var n = e.toUpperCase(), r;
  return t.isEmpty() ? r = n + " EMPTY" : r = n + "(" + Un[e].apply(this, [t]) + ")", r;
};
var Un = {
  ...
  multipoint: function(t) {
    for (var e = this, n = [], r = 0, s = t._geometries.length; r < s; ++r)
      n.push("(" + Un.point.apply(e, [t._geometries[r]]) + ")");
    return n.join(",");
  },
  /**
  ...
  linestring: function(t) {
    for (var e = this, n = [], r = 0, s = t._points._coordinates.length; r < s; ++r)
      n.push(Un.coordinate.apply(e, [t._points._coordinates[r]]));
    return n.join(",");
  },
  ...
  multilinestring: function(t) {
    for (var e = this, n = [], r = 0, s = t._geometries.length; r < s; ++r)
      n.push("(" + Un.linestring.apply(e, [t._geometries[r]]) + ")");
    return n.join(",");
  },
  /**
  ...
  polygon: function(t) {
    ...
    for (var r = 0, s = t._holes.length; r < s; ++r)
      n.push("(" + Un.linestring.apply(e, [t._holes[r]]) + ")");
    return n.join(",");
  },
  /**
  ...
  multipolygon: function(t) {
    for (var e = this, n = [], r = 0, s = t._geometries.length; r < s; ++r)
      n.push("(" + Un.polygon.apply(e, [t._geometries[r]]) + ")");
    return n.join(",");
  },
  /**
  ...
  multipoint: function(t) {
    ...
    for (var n, r = t.trim().split(","), s = [], o = 0, a = r.length; o < a; ++o)
      n = r[o].replace(nn.trimParens, "$1"), s.push(Vr.point.apply(e, [n]));
  ...
  multilinestring: function(t) {
    ...
    for (var n, r = t.trim().split(nn.parenComma), s = [], o = 0, a = r.length; o < a; ++o)
      n = r[o].replace(nn.trimParens, "$1"), s.push(Vr.linestring.apply(e, [n]));
  ...
  polygon: function(t) {
    ...
    for (var n, r, s, o = t.trim().split(nn.parenComma), a, u = [], l = 0, c = o.length; l < c; ++l)
      n = o[l].replace(nn.trimParens, "$1"), r = Vr.linestring.apply(e, [n]), s = e.geometryFactory.createLinearRing(r._points), l === 0 ? a = s : u.push(s);
  ...
  multipolygon: function(t) {
    ...
    for (var n, r = t.trim().split(nn.doubleParenComma), s = [], o = 0, a = r.length; o < a; ++o)
      n = r[o].replace(nn.trimParens, "$1"), s.push(Vr.polygon.apply(e, [n]));
...
j.shouldNeverReachHere = function() {
  if (arguments.length === 0)
    ...
    var t = arguments[0];
    throw new ea("Should never reach here" + (t !== null ? ": " + t : ""));
  }
};
j.isTrue = function() {
  var t, e;
...
j.equals = function() {
  ...
  if (arguments.length === 2)
    ...
    throw new ea("Expected " + t + " but encountered " + e + (n !== null ? ": " + n : ""));
};
var pt = function() {
...
}, Nr = { DONT_INTERSECT: { configurable: !0 }, DO_INTERSECT: { configurable: !0 }, COLLINEAR: { configurable: !0 }, NO_INTERSECTION: { configurable: !0 }, POINT_INTERSECTION: { configurable: !0 }, COLLINEAR_INTERSECTION: { configurable: !0 } };
...
Nr.DONT_INTERSECT.get = function() {
  return 0;
};
Nr.DO_INTERSECT.get = function() {
  return 1;
};
Nr.COLLINEAR.get = function() {
  return 2;
};
Nr.NO_INTERSECTION.get = function() {
  return 0;
};
Nr.POINT_INTERSECTION.get = function() {
  return 1;
};
Nr.COLLINEAR_INTERSECTION.get = function() {
  return 2;
};
Object.defineProperties(pt, Nr);
var $i = function(i) {
  function t() {
...
hr.orientationIndex = function(t, e, n) {
  var r = e.x - t.x, s = e.y - t.y, o = n.x - e.x, a = n.y - e.y;
  return hr.signOfDet2x2(r, s, o, a);
};
hr.signOfDet2x2 = function(t, e, n, r) {
...
ln.prototype.countSegment = function(t, e) {
  ...
  if (t.y > this._p.y && e.y <= this._p.y || e.y > this._p.y && t.y <= this._p.y) {
    var s = t.x - this._p.x, o = t.y - this._p.y, a = e.x - this._p.x, u = e.y - this._p.y, l = hr.signOfDet2x2(s, o, a, u);
    if (l === 0)
      return this._isPointOnSegment = !0, null;
...
ln.locatePointInRing = function() {
  if (arguments[0] instanceof v && X(arguments[1], $)) {
    ...
    for (var a = arguments[0], u = arguments[1], l = new ln(a), c = 1; c < u.length; c++) {
      var h = u[c], f = u[c - 1];
...
var M = function() {
}, Lr = { CLOCKWISE: { configurable: !0 }, RIGHT: { configurable: !0 }, COUNTERCLOCKWISE: { configurable: !0 }, LEFT: { configurable: !0 }, COLLINEAR: { configurable: !0 }, STRAIGHT: { configurable: !0 } };
...
Lr.RIGHT.get = function() {
  return M.CLOCKWISE;
};
Lr.COUNTERCLOCKWISE.get = function() {
  return 1;
};
Lr.LEFT.get = function() {
  return M.COUNTERCLOCKWISE;
};
Lr.COLLINEAR.get = function() {
  return 0;
};
Lr.STRAIGHT.get = function() {
  return M.COLLINEAR;
};
Object.defineProperties(M, Lr);
var ei = function() {
};
...
Xn.SORTINDEX_POINT.get = function() {
  return 0;
};
Xn.SORTINDEX_MULTIPOINT.get = function() {
  return 1;
};
Xn.SORTINDEX_LINESTRING.get = function() {
  return 2;
};
Xn.SORTINDEX_LINEARRING.get = function() {
  return 3;
};
Xn.SORTINDEX_MULTILINESTRING.get = function() {
  return 4;
};
Xn.SORTINDEX_POLYGON.get = function() {
  return 5;
};
Xn.SORTINDEX_MULTIPOLYGON.get = function() {
  return 6;
};
Xn.SORTINDEX_GEOMETRYCOLLECTION.get = function() {
  return 7;
};
Xn.geometryChangedFilter.get = function() {
  return Ku;
};
Object.defineProperties(V, Xn);
var Ku = function() {
};
Ku.interfaces_ = function() {
  return [ei];
};
...
oi.Mod2BoundaryNodeRule.get = function() {
  return Zr;
};
oi.EndPointBoundaryNodeRule.get = function() {
  return Kr;
};
oi.MultiValentEndPointBoundaryNodeRule.get = function() {
  return Jr;
};
oi.MonoValentEndPointBoundaryNodeRule.get = function() {
  return Qr;
};
oi.MOD2_BOUNDARY_RULE.get = function() {
  return new Zr();
};
oi.ENDPOINT_BOUNDARY_RULE.get = function() {
  return new Kr();
};
oi.MULTIVALENT_ENDPOINT_BOUNDARY_RULE.get = function() {
  return new Jr();
};
oi.MONOVALENT_ENDPOINT_BOUNDARY_RULE.get = function() {
  return new Qr();
};
oi.OGC_SFS_BOUNDARY_RULE.get = function() {
  return Me.MOD2_BOUNDARY_RULE;
};
Object.defineProperties(Me, oi);
var Zr = function() {
};
...
Ju.prototype.name = "IndexOutOfBoundsException";
var _s = function() {
};
_s.prototype.hasNext = function() {
};
_s.prototype.next = function() {
};
...
ms.prototype.name = "NoSuchElementException";
var N = function(i) {
  function t() {
...
}, xa = { ForwardComparator: { configurable: !0 }, BidirectionalComparator: { configurable: !0 }, coordArrayType: { configurable: !0 } };
xa.ForwardComparator.get = function() {
  return Zs;
};
xa.BidirectionalComparator.get = function() {
  return $r;
};
xa.coordArrayType.get = function() {
  return new Array(0).fill(null);
};
J.prototype.interfaces_ = function() {
  return [];
...
$r.prototype.OLDcompare = function(t, e) {
  var n = t, r = e;
  if (n.length < r.length)
    return -1;
  if (n.length > r.length)
...
Pr.prototype.put = function() {
};
Pr.prototype.size = function() {
};
Pr.prototype.values = function() {
};
Pr.prototype.entrySet = function() {
};
var X_ = function(i) {
  function t() {
    i.apply(this, arguments);
...
Ca.prototype = new Nt();
Ca.prototype.contains = function() {
};
var Qu = function(i) {
  function t() {
    i.call(this), this.array_ = [], arguments[0] instanceof Nt && this.addAll(arguments[0]);
...
qt.prototype.fixAfterInsertion = function(i) {
  ...
  for (i.color = Mi; i != null && i !== this.root_ && i.parent.color === Mi; )
    if (ut(i) === qa(ut(ut(i)))) {
      var e = yc(ut(ut(i)));
      mc(e) === Mi ? (Yn(ut(i), qn), Yn(e, qn), Yn(ut(ut(i)), Mi), i = ut(ut(i))) : (i === yc(ut(i)) && (i = ut(i), t.rotateLeft(i)), Yn(ut(i), qn), Yn(ut(ut(i)), Mi), t.rotateRight(ut(ut(i))));
    } else {
      var n = qa(ut(ut(i)));
      mc(n) === Mi ? (Yn(ut(i), qn), Yn(n, qn), Yn(ut(ut(i)), Mi), i = ut(ut(i))) : (i === qa(ut(i)) && (i = ut(i), t.rotateRight(i)), Yn(ut(i), qn), Yn(ut(ut(i)), Mi), t.rotateLeft(ut(ut(i))));
    }
  this.root_.color = qn;
};
...
Te.prototype.addEndpoint = function(t) {
  ...
  e === null && (e = new na(), this._endpointMap.put(t, e)), e.count++;
};
...
Oe.toString = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return Oe.SIMPLE_ORDINATE_FORMAT.format(t);
  }
};
Oe.spaces = function(t) {
  return Oe.chars(" ", t);
};
...
xt.toString = function() {
  if (arguments.length === 1) {
    ...
    for (var s = 0; s < e; s++) {
      s > 0 && r.append(" ");
      for (var o = 0; o < n; o++)
        o > 0 && r.append(","), r.append(Oe.toString(t.getOrdinate(s, o)));
    }
...
}, Sa = { NoOpGeometryOperation: { configurable: !0 }, CoordinateOperation: { configurable: !0 }, CoordinateSequenceOperation: { configurable: !0 } };
...
De.prototype.editGeometryCollection = function(t, e) {
  ...
  return r.getClass() === ts ? this._factory.createMultiPoint(s.toArray([])) : r.getClass() === Yi ? this._factory.createMultiLineString(s.toArray([])) : r.getClass() === Tn ? this._factory.createMultiPolygon(s.toArray([])) : this._factory.createGeometryCollection(s.toArray([]));
};
...
Sa.NoOpGeometryOperation.get = function() {
  return Qs;
};
Sa.CoordinateOperation.get = function() {
  return $s;
};
Sa.CoordinateSequenceOperation.get = function() {
  return to;
};
Object.defineProperties(De, Sa);
var Qs = function() {
};
...
$s.prototype.edit = function(t, e) {
  ...
  return n === null ? t : t instanceof Dn ? e.createLinearRing(n) : t instanceof mt ? e.createLineString(n) : t instanceof ge ? n.length > 0 ? e.createPoint(n[0]) : e.createPoint() : t;
};
...
to.prototype.edit = function(t, e) {
  return t instanceof Dn ? e.createLinearRing(this.edit(t.getCoordinateSequence(), t)) : t instanceof mt ? e.createLineString(this.edit(t.getCoordinateSequence(), t)) : t instanceof ge ? e.createPoint(this.edit(t.getCoordinateSequence(), t)) : t;
};
...
}, ef = { serialVersionUID: { configurable: !0 } };
...
ef.serialVersionUID.get = function() {
  return -915438501601840600;
};
Object.defineProperties(vt, ef);
var An = function() {
}, tl = { serialVersionUID: { configurable: !0 }, instanceObject: { configurable: !0 } };
An.prototype.readResolve = function() {
  return An.instance();
};
An.prototype.create = function() {
  if (arguments.length === 1) {
    if (arguments[0] instanceof Array) {
      var t = arguments[0];
      return new vt(t);
...
An.instance = function() {
  return An.instanceObject;
};
tl.serialVersionUID.get = function() {
  return -4099577099607551500;
};
tl.instanceObject.get = function() {
  return new An();
};
Object.defineProperties(An, tl);
var nf = function(i) {
  function t() {
...
}, el = { serialVersionUID: { configurable: !0 }, maximumPreciseValue: { configurable: !0 } };
...
el.serialVersionUID.get = function() {
  return 7777263578777804e3;
};
el.maximumPreciseValue.get = function() {
  return 9007199254740992;
};
Object.defineProperties(nt, el);
var dn = function i(t) {
  this._name = t || null, i.nameToTypeMap.put(t, this);
}, nl = { serialVersionUID: { configurable: !0 }, nameToTypeMap: { configurable: !0 } };
...
nl.nameToTypeMap.get = function() {
  return new nf();
};
Object.defineProperties(dn, nl);
nt.Type = dn;
...
}, rf = { serialVersionUID: { configurable: !0 } };
...
rf.serialVersionUID.get = function() {
  return -6820524753094096e3;
};
Object.defineProperties(K, rf);
var K_ = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], Ra = function(t) {
  this.geometryFactory = t || new K();
};
Ra.prototype.read = function(t) {
  ...
  return K_.indexOf(n) !== -1 ? on[n].apply(this, [e.coordinates]) : n === "GeometryCollection" ? on[n].apply(this, [e.geometries]) : on[n].apply(this, [e]);
};
Ra.prototype.write = function(t) {
  var e = t.getGeometryType();
  if (!Wn[e])
    throw new Error("Geometry is not supported");
  return Wn[e].apply(this, [t]);
};
var on = {
  /**
   ...
   */
  Point: function(i) {
    var t = Wn.coordinate.apply(this, [i.getCoordinate()]);
    return {
      type: "Point",
      coordinates: t
    };
  ...
  MultiPoint: function(i) {
    for (var t = this, e = [], n = 0; n < i._geometries.length; ++n) {
      var r = i._geometries[n], s = Wn.Point.apply(t, [r]);
  ...
  LineString: function(i) {
    for (var t = this, e = [], n = i.getCoordinates(), r = 0; r < n.length; ++r) {
      var s = n[r];
      e.push(Wn.coordinate.apply(t, [s]));
    }
    return {
      type: "LineString",
      coordinates: e
  ...
  MultiLineString: function(i) {
    for (var t = this, e = [], n = 0; n < i._geometries.length; ++n) {
      var r = i._geometries[n], s = Wn.LineString.apply(t, [r]);
      e.push(s.coordinates);
    }
    return {
   ...
   */
  Polygon: function(i) {
    var t = this, e = [], n = Wn.LineString.apply(this, [i._shell]);
    e.push(n.coordinates);
    for (var r = 0; r < i._holes.length; ++r) {
      var s = i._holes[r], o = Wn.LineString.apply(t, [s]);
  ...
  MultiPolygon: function(i) {
    for (var t = this, e = [], n = 0; n < i._geometries.length; ++n) {
      var r = i._geometries[n], s = Wn.Polygon.apply(t, [r]);
      e.push(s.coordinates);
    }
    return {
      type: "MultiPolygon",
  ...
  this.geometryFactory = t || new K(), this.precisionModel = this.geometryFactory.getPrecisionModel(), this.parser = new Ra(this.geometryFactory);
};
il.prototype.read = function(t) {
  var e = this.parser.read(t);
  return this.precisionModel.getType() === nt.FIXED && this.reducePrecision(e), e;
};
il.prototype.reducePrecision = function(t) {
  var e = this, n, r;
  if (t.coordinate)
...
var sf = function() {
  this.parser = new Ra(this.geometryFactory);
};
sf.prototype.write = function(t) {
  return this.parser.write(t);
};
var R = function() {
}, wa = { ON: { configurable: !0 }, LEFT: { configurable: !0 }, RIGHT: { configurable: !0 } };
R.prototype.interfaces_ = function() {
  return [];
};
R.prototype.getClass = function() {
...
wa.LEFT.get = function() {
  return 1;
};
wa.RIGHT.get = function() {
  return 2;
};
Object.defineProperties(R, wa);
function Na(i) {
  this.message = i || "";
}
Na.prototype = new Error();
Na.prototype.name = "EmptyStackException";
function In() {
  this.array_ = [];
}
In.prototype = new Ye();
...
La.prototype.addLast = function(t) {
  this.array_.push(t);
};
La.prototype.removeFirst = function() {
...
ie.prototype.computeNodeDepth = function(t) {
  ...
  if (n === null)
    throw new ni("unable to find edge to compute depths at " + t.getCoordinate());
...
ie.prototype.computeDepths = function(t) {
  var e = this, n = new Qu(), r = new La(), s = t.getNode();
...
wt.prototype.computePoints = function(t) {
  ...
  do {
    if (n === null)
      throw new ni("Found null DirectedEdge");
    if (n.getEdgeRing() === e)
      throw new ni("Directed Edge visited twice during ring-building at " + n.getCoordinate());
    e._edges.add(n);
    var s = n.getLabel();
...
var pu = function(i) {
  ...
  return i && (t.__proto__ = i), t.prototype = Object.create(i && i.prototype), t.prototype.constructor = t, t.prototype.getNextMin = function() {
    ...
    if (this._depth[n] !== -999 && this._depth[n] !== r)
      throw new ni("assigned depths do not match", this.getCoordinate());
    this._depth[n] = r;
...
es.prototype.createNode = function(t) {
  return new Pa(t, null);
};
...
pe.prototype.placeFreeHoles = function(t, e) {
  for (var n = this, r = e.iterator(); r.hasNext(); ) {
    ...
    if (s.getShell() === null) {
      ...
      if (o === null)
        throw new ni("unable to assign hole to a shell", s.getCoordinate(0));
      s.setShell(o);
    }
  }
};
...
ns.prototype.getBounds = function() {
};
...
ii.prototype.reorder = function(t) {
...
fr.prototype.insert = function(t, e) {
};
fr.prototype.remove = function(t, e) {
};
fr.prototype.query = function() {
};
...
}, of = { serialVersionUID: { configurable: !0 } };
...
of.serialVersionUID.get = function() {
  return 6493722185909574e3;
};
Object.defineProperties(Tt, of);
var He = function() {
};
...
}, Ta = { IntersectsOp: { configurable: !0 }, serialVersionUID: { configurable: !0 }, DEFAULT_NODE_CAPACITY: { configurable: !0 } };
...
Mt.prototype.query = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (X(arguments[2], Ei) && arguments[0] instanceof Object && arguments[1] instanceof Tt)
      for (var o = arguments[0], a = arguments[1], u = arguments[2], l = a.getChildBoundables(), c = 0; c < l.size(); c++) {
        var h = l.get(c);
        t.getIntersectsOp().intersects(h.getBounds(), o) && (h instanceof Tt ? t.query(o, h, u) : h instanceof qe ? u.visitItem(h.getItem()) : j.shouldNeverReachHere());
      }
...
Ta.IntersectsOp.get = function() {
  return $_;
};
Ta.serialVersionUID.get = function() {
  return -3886435814360241e3;
};
Ta.DEFAULT_NODE_CAPACITY.get = function() {
  return 10;
};
Object.defineProperties(Mt, Ta);
var $_ = function() {
}, is = function() {
};
is.prototype.distance = function(t, e) {
};
...
var af = function(i) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(r, s) {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[0] instanceof t && X(arguments[1], is)) {
        ...
        var c = arguments[0], h = arguments[1], f = h, g = null, p = new ii();
      ...
      var m = arguments[0], y = arguments[1], E = arguments[2], I = new qe(m, y), S = new St(this.getRoot(), I, E);
...
xi.prototype.getCoordinate = function() {
  return this.coord;
};
xi.prototype.print = function(t) {
  t.print(this.coord), t.print(" seg # = " + this.segmentIndex);
};
xi.prototype.compareTo = function(t) {
  var e = t;
...
xi.prototype.isEndPoint = function(t) {
  return this.segmentIndex === 0 && !this._isInterior || this.segmentIndex === t;
};
xi.prototype.isInterior = function() {
...
re.prototype.add = function(t, e) {
  var n = new xi(this._edge, t, e, this._edge.getSegmentOctant(e)), r = this._nodeMap.get(n);
...
re.prototype.checkSplitEdgesCorrectness = function(t) {
  ...
  if (!r.equals2D(e[0]))
    throw new ti("bad split edge start point at " + r);
  var s = t.get(t.size() - 1), o = s.getCoordinates(), a = o[o.length - 1];
  if (!a.equals2D(e[e.length - 1]))
    throw new ti("bad split edge end point at " + a);
};
...
Fn.prototype.getCoordinate = function(t) {
};
Fn.prototype.isClosed = function() {
};
Fn.prototype.setData = function(t) {
};
...
Ct.prototype.safeOctant = function(t, e) {
  return t.equals2D(e) ? 0 : gr.octant(t, e);
};
...
}, uf = { serialVersionUID: { configurable: !0 } };
...
uf.serialVersionUID.get = function() {
...
cn.getChainStartIndices = function(t) {
  var e = 0, n = new N();
  n.add(new fn(e));
  do {
    var r = cn.findChainEnd(t, e);
    n.add(new fn(r)), e = r;
  } while (e < t.length - 1);
  var s = cn.toIntArray(n);
  return s;
};
cn.findChainEnd = function(t, e) {
...
cn.getChains = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return cn.getChains(t, null);
  } else if (arguments.length === 2) {
    for (var e = arguments[0], n = arguments[1], r = new N(), s = cn.getChainStartIndices(e), o = 0; o < s.length - 1; o++) {
...
var rl = function(i) {
  function t(n) {
    n ? i.call(this, n) : i.call(this), this._monoChains = new N(), this._index = new af(), this._idCounter = 0, this._nodedSegStrings = null, this._nOverlaps = 0;
  }
  i && (t.__proto__ = i), t.prototype = Object.create(i && i.prototype), t.prototype.constructor = t;
  ...
  return t.prototype.getMonotoneChains = function() {
    ...
    for (var s = this, o = cn.getChains(r.getCoordinates(), r), a = o.iterator(); a.hasNext(); ) {
      var u = a.next();
    ...
    for (var r = this, s = new Ec(this._segInt), o = this._monoChains.iterator(); o.hasNext(); )
...
}, ai = { CAP_ROUND: { configurable: !0 }, CAP_FLAT: { configurable: !0 }, CAP_SQUARE: { configurable: !0 }, JOIN_ROUND: { configurable: !0 }, JOIN_MITRE: { configurable: !0 }, JOIN_BEVEL: { configurable: !0 }, DEFAULT_QUADRANT_SEGMENTS: { configurable: !0 }, DEFAULT_MITRE_LIMIT: { configurable: !0 }, DEFAULT_SIMPLIFY_FACTOR: { configurable: !0 } };
...
ai.CAP_ROUND.get = function() {
  return 1;
};
ai.CAP_FLAT.get = function() {
  return 2;
};
ai.CAP_SQUARE.get = function() {
  return 3;
};
ai.JOIN_ROUND.get = function() {
  return 1;
};
ai.JOIN_MITRE.get = function() {
  return 2;
};
ai.JOIN_BEVEL.get = function() {
  return 3;
};
ai.DEFAULT_QUADRANT_SEGMENTS.get = function() {
  return 8;
};
ai.DEFAULT_MITRE_LIMIT.get = function() {
  return 5;
};
ai.DEFAULT_SIMPLIFY_FACTOR.get = function() {
  return 0.01;
};
Object.defineProperties(et, ai);
var yt = function(t) {
...
}, lf = { COORDINATE_ARRAY_TYPE: { configurable: !0 } };
...
lf.COORDINATE_ARRAY_TYPE.get = function() {
  return new Array(0).fill(null);
};
Object.defineProperties(Ie, lf);
var Q = function() {
}, Tr = { PI_TIMES_2: { configurable: !0 }, PI_OVER_2: { configurable: !0 }, PI_OVER_4: { configurable: !0 }, COUNTERCLOCKWISE: { configurable: !0 }, CLOCKWISE: { configurable: !0 }, NONE: { configurable: !0 } };
...
Tr.PI_TIMES_2.get = function() {
  return 2 * Math.PI;
};
Tr.PI_OVER_2.get = function() {
  return Math.PI / 2;
};
Tr.PI_OVER_4.get = function() {
  return Math.PI / 4;
};
...
Tr.NONE.get = function() {
  return M.COLLINEAR;
};
Object.defineProperties(Q, Tr);
var ht = function i() {
...
var pr = function() {
  ...
  var t = arguments[0];
  this._subgraphs = t;
}, cf = { DepthSegment: { configurable: !0 } };
pr.prototype.findStabbedSegments = function() {
  var t = this;
  if (arguments.length === 1) {
    ...
    if (X(arguments[2], Ye) && arguments[0] instanceof v && arguments[1] instanceof pu)
...
pr.prototype.getDepth = function(t) {
...
cf.DepthSegment.get = function() {
  return Wi;
};
Object.defineProperties(pr, cf);
var Wi = function() {
...
Ae.prototype.addPolygonRing = function(t, e, n, r, s) {
  if (e === 0 && t.length < Dn.MINIMUM_VALID_SIZE)
    return null;
  var o = r, a = s;
  t.length >= Dn.MINIMUM_VALID_SIZE && M.isCCW(t) && (o = s, a = r, n = R.opposite(n));
...
Ae.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof Ot ? this.addPolygon(t) : t instanceof mt ? this.addLineString(t) : t instanceof ge ? this.addPoint(t) : t instanceof ts ? this.addCollection(t) : t instanceof Yi ? this.addCollection(t) : t instanceof Tn ? this.addCollection(t) : t instanceof ne && this.addCollection(t);
};
...
rs.prototype.locate = function(t) {
};
...
jt.prototype.propagateSideLabels = function(t) {
  ...
  for (var o = e, a = this.iterator(); a.hasNext(); ) {
    ...
    if (l.getLocation(t, R.ON) === x.NONE && l.setLocation(t, R.ON, o), l.isArea(t)) {
      ...
      if (h !== x.NONE) {
        if (h !== o)
          throw new ni("side location conflict", u.getCoordinate());
...
var tm = function(i) {
  ...
  return i && (t.__proto__ = i), t.prototype = Object.create(i && i.prototype), t.prototype.constructor = t, t.prototype.linkResultDirectedEdges = function() {
    ...
    if (o === this._LINKING_TO_OUTGOING) {
      if (r === null)
        throw new ni("no outgoing dirEdge found", this.getCoordinate());
    ...
    if (arguments.length === 1) {
      ...
      if (l !== a)
        throw new ni("depth mismatch at " + r.getCoordinate());
    } else if (arguments.length === 3) {
...
kn.prototype.createSplitEdge = function(t, e) {
  ...
  for (var l = t.segmentIndex + 1; l <= e.segmentIndex; l++)
    a[u++] = n.edge.pts[l];
  return o && (a[u] = e.coord), new ia(a, new rt(this.edge._label));
};
...
ri.prototype.getMaxX = function(t) {
  var e = this.pts[this.startIndex[t]].x, n = this.pts[this.startIndex[t + 1]].x;
  return e > n ? e : n;
};
ri.prototype.getMinX = function(t) {
  var e = this.pts[this.startIndex[t]].x, n = this.pts[this.startIndex[t + 1]].x;
  return e < n ? e : n;
};
ri.prototype.computeIntersectsForChain = function() {
  if (arguments.length === 4) {
    var t = arguments[0], e = arguments[1], n = arguments[2], r = arguments[3];
...
ri.prototype.getStartIndexes = function() {
  return this.startIndex;
};
ri.prototype.computeIntersects = function(t, e) {
...
ff.NULL_VALUE.get = function() {
  return -1;
};
Object.defineProperties(Bt, ff);
var ia = function(i) {
  function t() {
    if (i.call(this), this.pts = null, this._env = null, this.eiList = new kn(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new Bt(), this._depthDelta = 0, arguments.length === 1) {
      var e = arguments[0];
      t.call(this, e, null);
    } else if (arguments.length === 2) {
      var n = arguments[0], r = arguments[1];
  ...
  return i && (t.__proto__ = i), t.prototype = Object.create(i && i.prototype), t.prototype.constructor = t, t.prototype.getDepth = function() {
    ...
    return this._mce === null && (this._mce = new ri(this)), this._mce;
...
ee.prototype.buildSubgraphs = function(t, e) {
  for (var n = new N(), r = t.iterator(); r.hasNext(); ) {
    var s = r.next(), o = s.getRightmostCoordinate(), a = new pr(n), u = a.getDepth(o);
...
ee.prototype.buffer = function(t, e) {
  ...
  this.computeNodedEdges(o, n), this._graph = new dt(new hf()), this._graph.addEdges(this._edgeList.getEdges());
...
ee.prototype.computeNodedEdges = function(t, e) {
  ...
  for (var s = r.getNodedSubstrings(), o = s.iterator(); o.hasNext(); ) {
    ...
    if (!(u.length === 2 && u[0].equals2D(u[1]))) {
      var l = a.getData(), c = new ia(a.getCoordinates(), new rt(l));
  ...
  if (arguments.length === 0)
    ...
    for (var s = arguments[0], o = arguments[1], a = o.iterator(); a.hasNext(); )
      for (var u = a.next(), l = u.getCoordinates(), c = 1; c < l.length - 1; c++)
        if (l[c].equals(s))
          throw new ti("found endpt/interior pt intersection at index " + c + " :pt " + s);
  }
};
vn.prototype.checkInteriorIntersections = function() {
  ...
  if (arguments.length === 0)
    ...
    if (this._li.computeIntersection(_, m, y, E), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, _, m) || this.hasInteriorIntersection(this._li, y, E)))
      throw new ti("found non-noded intersection at " + _ + "-" + m + " and " + y + "-" + E);
  }
};
...
vn.prototype.checkCollapse = function(t, e, n) {
  if (t.equals(n))
    throw new ti("found non-noded collapse at " + vn.fact.createLineString([t, e, n]));
};
...
gf.fact.get = function() {
  return new K();
};
Object.defineProperties(vn, gf);
var le = function() {
...
}, pf = { SAFE_ENV_EXPANSION_FACTOR: { configurable: !0 } };
...
pf.SAFE_ENV_EXPANSION_FACTOR.get = function() {
  return 0.75;
};
Object.defineProperties(le, pf);
var ro = function() {
...
var ss = function() {
  ...
  var t = arguments[0];
  this._index = t;
}, df = { HotPixelSnapAction: { configurable: !0 } };
ss.prototype.snap = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return this.snap(t, null, -1);
  } else if (arguments.length === 3) {
    var e = arguments[0], n = arguments[1], r = arguments[2], s = e.getSafeEnvelope(), o = new _f(e, n, r);
...
dr.prototype.processIntersections = function(t, e, n, r) {
  var s = this;
  if (t === n && e === r)
    return null;
...
dr.prototype.getInteriorIntersections = function() {
...
Gn.prototype.checkCorrectness = function(t) {
...
Gn.prototype.getNodedSubstrings = function() {
  return Ct.getNodedSubstrings(this._nodedSegStrings);
};
Gn.prototype.snapRound = function(t, e) {
  var n = this.findInteriorIntersections(t, e);
  this.computeIntersectionSnaps(n), this.computeVertexSnaps(t);
};
Gn.prototype.findInteriorIntersections = function(t, e) {
  var n = new dr(e);
  return this._noder.setSegmentIntersector(n), this._noder.computeNodes(t), n.getInteriorIntersections();
};
Gn.prototype.computeVertexSnaps = function() {
  var t = this;
  if (X(arguments[0], Nt))
    for (var e = arguments[0], n = e.iterator(); n.hasNext(); ) {
      var r = n.next();
...
Gn.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new rl(), this._pointSnapper = new ss(this._noder.getIndex()), this.snapRound(t, this._li);
};
Gn.prototype.computeIntersectionSnaps = function(t) {
  for (var e = this, n = t.iterator(); n.hasNext(); ) {
...
}, ys = { CAP_ROUND: { configurable: !0 }, CAP_BUTT: { configurable: !0 }, CAP_FLAT: { configurable: !0 }, CAP_SQUARE: { configurable: !0 }, MAX_PRECISION_DIGITS: { configurable: !0 } };
Gt.prototype.bufferFixedPrecision = function(t) {
  var e = new Ii(new Gn(new nt(1)), t.getScale()), n = new ee(this._bufParams);
...
ys.CAP_ROUND.get = function() {
  return et.CAP_ROUND;
};
ys.CAP_BUTT.get = function() {
  return et.CAP_FLAT;
};
ys.CAP_FLAT.get = function() {
  return et.CAP_FLAT;
};
ys.CAP_SQUARE.get = function() {
  return et.CAP_SQUARE;
};
ys.MAX_PRECISION_DIGITS.get = function() {
  return 12;
};
Object.defineProperties(Gt, ys);
var Qt = function() {
...
Nn.computeDistance = function() {
  if (arguments[2] instanceof Qt && arguments[0] instanceof mt && arguments[1] instanceof v)
    ...
    for (var h = 0; h < u.getNumInteriorRing(); h++)
      Nn.computeDistance(u.getInteriorRingN(h), l, c);
...
Si.prototype.filter = function(t, e) {
  ...
  this._minPtDist.initialize(), Nn.computeDistance(this._geom, s, this._minPtDist), this._maxPtDist.setMaximum(this._minPtDist);
};
...
$n.getPolygons = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return $n.getPolygons(t, new N());
  } else if (arguments.length === 2) {
    var e = arguments[0], n = arguments[1];
    return e instanceof Ot ? n.add(e) : e instanceof ne && e.apply(new $n(n)), n;
  }
};
var kt = function() {
...
kt.prototype.filter = function(t) {
  if (this._isForcedToLineString && t instanceof Dn) {
...
mf.INSIDE_AREA.get = function() {
  return -1;
};
Object.defineProperties($t, mf);
var mi = function(t) {
  this._pts = t || null;
};
...
mr.prototype.filter = function(t) {
...
mr.getLocations = function(t) {
  var e = new N();
  return t.apply(new mr(e)), e;
};
var Vt = function() {
  if (this._geom = null, this._terminateDistance = 0, this._ptLocator = new Ze(), this._minDistanceLocation = null, this._minDistance = W.MAX_VALUE, arguments.length === 2) {
    var t = arguments[0], e = arguments[1];
...
Vt.prototype.computeContainmentDistance = function() {
  ...
  if (arguments.length === 0) {
    ...
    var n = arguments[0], r = arguments[1], s = 1 - n, o = $n.getPolygons(this._geom[n]);
    if (o.size() > 0) {
      var a = mr.getLocations(this._geom[s]);
...
an.computeDistance = function() {
  if (arguments[2] instanceof Wt && arguments[0] instanceof mt && arguments[1] instanceof v)
    ...
    var u = arguments[0], l = arguments[1], c = arguments[2];
    an.computeDistance(u.getExteriorRing(), l, c);
    for (var h = 0; h < u.getNumInteriorRing(); h++)
      an.computeDistance(u.getInteriorRingN(h), l, c);
...
}, ol = { MaxPointDistanceFilter: { configurable: !0 }, MaxDensifiedByFractionDistanceFilter: { configurable: !0 } };
be.prototype.getCoordinates = function() {
  return this._ptDist.getCoordinates();
};
be.prototype.setDensifyFraction = function(t) {
  if (t > 1 || t <= 0)
    throw new gt("Fraction is not in range (0.0 - 1.0]");
  this._densifyFrac = t;
};
be.prototype.compute = function(t, e) {
  this.computeOrientedDistance(t, e, this._ptDist), this.computeOrientedDistance(e, t, this._ptDist);
};
be.prototype.distance = function() {
  return this.compute(this._g0, this._g1), this._ptDist.getDistance();
};
be.prototype.computeOrientedDistance = function(t, e, n) {
  var r = new yr(e);
...
be.prototype.orientedDistance = function() {
...
be.distance = function() {
  if (arguments.length === 2) {
    var t = arguments[0], e = arguments[1], n = new be(t, e);
    return n.distance();
  } else if (arguments.length === 3) {
    var r = arguments[0], s = arguments[1], o = arguments[2], a = new be(r, s);
    return a.setDensifyFraction(o), a.distance();
  }
};
ol.MaxPointDistanceFilter.get = function() {
  return yr;
};
ol.MaxDensifiedByFractionDistanceFilter.get = function() {
  return Ri;
};
Object.defineProperties(be, ol);
var yr = function() {
...
Ri.prototype.filter = function(t, e) {
  ...
  for (var r = t.getCoordinate(e - 1), s = t.getCoordinate(e), o = (s.x - r.x) / this._numSubSegs, a = (s.y - r.y) / this._numSubSegs, u = 0; u < this._numSubSegs; u++) {
    ...
    n._minPtDist.initialize(), an.computeDistance(n._geom, h, n._minPtDist), n._maxPtDist.setMaximum(n._minPtDist);
  }
};
...
}, al = { VERBOSE: { configurable: !0 }, MAX_DISTANCE_DIFF_FRAC: { configurable: !0 } };
...
fe.prototype.checkNegativeValid = function() {
  if (!(this._input instanceof Ot || this._input instanceof Tn || this._input instanceof ne))
    return null;
...
fe.prototype.getPolygonLines = function(t) {
  for (var e = new N(), n = new kt(e), r = $n.getPolygons(t), s = r.iterator(); s.hasNext(); ) {
    var o = s.next();
    o.apply(n);
  }
...
al.VERBOSE.get = function() {
  return !1;
};
al.MAX_DISTANCE_DIFF_FRAC.get = function() {
  return 0.012;
};
Object.defineProperties(fe, al);
...
}, ul = { VERBOSE: { configurable: !0 }, MAX_ENV_DIFF_FRAC: { configurable: !0 } };
...
Xt.prototype.checkPolygonal = function() {
  this._result instanceof Ot || this._result instanceof Tn || (this._isValid = !1), this._errorMsg = "Result is not polygonal", this._errorIndicator = this._result, this.report("Polygonal");
};
...
ul.VERBOSE.get = function() {
  return !1;
};
ul.MAX_ENV_DIFF_FRAC.get = function() {
  return 0.012;
};
Object.defineProperties(Xt, ul);
var En = function() {
...
En.prototype.getCoordinate = function(t) {
  return this._pts[t];
};
En.prototype.isClosed = function() {
  return this._pts[0].equals(this._pts[this._pts.length - 1]);
};
En.prototype.getSegmentOctant = function(t) {
  return t === this._pts.length - 1 ? -1 : gr.octant(this.getCoordinate(t), this.getCoordinate(t + 1));
};
En.prototype.setData = function(t) {
  this._data = t;
};
...
Ke.prototype.checkValid = function() {
  if (this.execute(), !this._isValid)
    throw new ni(this.getErrorMessage(), this._segInt.getInteriorIntersection());
};
...
Zi.toSegmentStrings = function(t) {
  for (var e = new N(), n = t.iterator(); n.hasNext(); ) {
    var r = n.next();
    e.add(new En(r.getCoordinates(), r));
  }
  return e;
};
...
xn.prototype.collectLineEdge = function(t, e, n) {
...
xn.prototype.collectBoundaryTouchEdge = function(t, e, n) {
  var r = t.getLabel();
...
Er.prototype.filterCoveredNodeToPoint = function(t) {
...
Er.prototype.extractNonCoveredResultNodes = function(t) {
...
Bn.prototype.snapVertices = function(t, e) {
...
Bn.prototype.findSnapForVertex = function(t, e) {
...
Bn.prototype.findSegmentIndexToSnap = function(t, e) {
...
Bn.prototype.setAllowSnappingToSourceVertices = function(t) {
...
Bn.isClosed = function(t) {
  return t.length <= 1 ? !1 : t[0].equals2D(t[t.length - 1]);
};
var Et = function(t) {
  this._srcGeom = t || null;
}, yf = { SNAP_PRECISION_FACTOR: { configurable: !0 } };
Et.prototype.snapTo = function(t, e) {
  var n = this.extractTargetCoordinates(t), r = new vf(e, n);
  return r.transform(this._srcGeom);
};
Et.prototype.snapToSelf = function(t, e) {
  var n = this.extractTargetCoordinates(this._srcGeom), r = new vf(t, n, !0), s = r.transform(this._srcGeom), o = s;
...
yf.SNAP_PRECISION_FACTOR.get = function() {
  return 1e-9;
};
Object.defineProperties(Et, yf);
var vf = function(i) {
  function t(e, n, r) {
  ...
  return i && (t.__proto__ = i), t.prototype = Object.create(i && i.prototype), t.prototype.constructor = t, t.prototype.snapLine = function(n, r) {
    var s = new Bn(n, this._snapTolerance);
...
var wi = function() {
  this._commonCoord = null, this._ccFilter = new xr();
}, ll = { CommonCoordinateFilter: { configurable: !0 }, Translater: { configurable: !0 } };
...
ll.CommonCoordinateFilter.get = function() {
  return xr;
};
ll.Translater.get = function() {
  return Ni;
};
Object.defineProperties(wi, ll);
var xr = function() {
...
xr.prototype.getCommonCoordinate = function() {
...
}, cl = { INSERT: { configurable: !0 }, DELETE: { configurable: !0 } };
...
cl.INSERT.get = function() {
  return 1;
};
cl.DELETE.get = function() {
  return 2;
};
Object.defineProperties(_e, cl);
var ra = function() {
};
...
}, Ef = { NodeComparator: { configurable: !0 } };
zn.prototype.getMin = function() {
  return this._min;
};
zn.prototype.intersects = function(t, e) {
  return !(this._min > e || this._max < t);
};
zn.prototype.getMax = function() {
  return this._max;
};
...
Ef.NodeComparator.get = function() {
  return oo;
};
Object.defineProperties(zn, Ef);
var oo = function() {
};
...
Vn.prototype.buildTree = function() {
  var t = this;
  He.sort(this._leaves, new zn.NodeComparator());
...
Vn.prototype.insert = function(t, e, n) {
  if (this._root !== null)
    throw new Error("Index cannot be added to once it has been queried");
  this._leaves.add(new nm(t, e, n));
};
Vn.prototype.query = function(t, e, n) {
  this.init(), this._root.query(t, e, n);
};
Vn.prototype.buildRoot = function() {
  if (this._root !== null)
    return null;
  this._root = this.buildTree();
};
Vn.prototype.printNode = function(t) {
...
Vn.prototype.buildLevel = function(t, e) {
  this._level++, e.clear();
...
os.prototype.getItems = function() {
  return this._items;
};
...
}, hl = { SegmentVisitor: { configurable: !0 }, IntervalIndexedGeometry: { configurable: !0 } };
as.prototype.locate = function(t) {
  var e = new ln(t), n = new us(e);
...
hl.SegmentVisitor.get = function() {
  return us;
};
hl.IntervalIndexedGeometry.get = function() {
  return Ki;
};
Object.defineProperties(as, hl);
var us = function() {
  this._counter = null;
  var t = arguments[0];
  this._counter = t;
};
us.prototype.visitItem = function(t) {
  var e = t;
...
Ki.prototype.query = function() {
  if (arguments.length === 2) {
    var t = arguments[0], e = arguments[1], n = new os();
...
var Ns = function(i) {
  function t() {
    if (i.call(this), this._parentGeom = null, this._lineEdgeMap = new nf(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new Ze(), arguments.length === 2) {
  ...
  return i && (t.__proto__ = i), t.prototype = Object.create(i && i.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(n, r) {
    ...
    if (arguments.length === 2) {
      ...
      var l = this.createEdgeSetIntersector(), c = this._parentGeom instanceof Dn || this._parentGeom instanceof Ot || this._parentGeom instanceof Tn, h = o || !c;
    ...
    var s = new ia(r, new rt(this._argIndex, x.INTERIOR));
    ...
    var a = r, u = s;
    M.isCCW(o) && (a = s, u = r);
    var l = new ia(o, new rt(this._argIndex, x.BOUNDARY, a, u));
    ...
    if (arguments.length === 1) {
      ...
      if (n.isEmpty())
        return null;
      if (n instanceof Tn && (this._useBoundaryDeterminationRule = !1), n instanceof Ot)
        this.addPolygon(n);
      else if (n instanceof mt)
        this.addLineString(n);
      else if (n instanceof ge)
        this.addPoint(n);
      else if (n instanceof ts)
    ...
    return X(this._parentGeom, vi) && this._parentGeom.getNumGeometries() > 50 ? (this._areaPtLocator === null && (this._areaPtLocator = new as(this._parentGeom)), this._areaPtLocator.locate(n)) : this._ptLocator.locate(n, this._parentGeom);
  ...
  if (this._li = new $i(), this._resultPrecisionModel = null, this._arg = null, arguments.length === 1) {
    var t = arguments[0];
    this.setComputationPrecision(t.getPrecisionModel()), this._arg = new Array(1).fill(null), this._arg[0] = new Ns(0, t);
  } else if (arguments.length === 2) {
    var e = arguments[0], n = arguments[1], r = Me.OGC_SFS_BOUNDARY_RULE;
    e.getPrecisionModel().compareTo(n.getPrecisionModel()) >= 0 ? this.setComputationPrecision(e.getPrecisionModel()) : this.setComputationPrecision(n.getPrecisionModel()), this._arg = new Array(2).fill(null), this._arg[0] = new Ns(0, e, r), this._arg[1] = new Ns(1, n, r);
  } else if (arguments.length === 3) {
    var s = arguments[0], o = arguments[1], a = arguments[2];
    s.getPrecisionModel().compareTo(o.getPrecisionModel()) >= 0 ? this.setComputationPrecision(s.getPrecisionModel()) : this.setComputationPrecision(o.getPrecisionModel()), this._arg = new Array(2).fill(null), this._arg[0] = new Ns(0, s, a), this._arg[1] = new Ns(1, o, a);
  }
};
ls.prototype.getArgGeometry = function(t) {
  return this._arg[t].getGeometry();
};
ls.prototype.setComputationPrecision = function(t) {
...
var q = function(i) {
  function t() {
    var e = arguments[0], n = arguments[1];
    i.call(this, e, n), this._ptLocator = new Ze(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new je(), this._resultPolyList = new N(), this._resultLineList = new N(), this._resultPointList = new N(), this._graph = new dt(new hf()), this._geomFact = e.getFactory();
  }
  return i && (t.__proto__ = i), t.prototype = Object.create(i && i.prototype), t.prototype.constructor = t, t.prototype.insertUniqueEdge = function(n) {
    ...
    var o = new xn(this, this._geomFact, this._ptLocator);
    this._resultLineList = o.build(n);
    var a = new Er(this, this._geomFact, this._ptLocator);
...
cs.prototype.getLinework = function() {
...
xf.TOLERANCE.get = function() {
  return 1e-6;
};
Object.defineProperties(Re, xf);
var ve = function i(t) {
...
}, Cf = { STRTREE_NODE_CAPACITY: { configurable: !0 } };
...
Rt.prototype.union = function() {
  ...
  for (var t = new af(Rt.STRTREE_NODE_CAPACITY), e = this._inputPolys.iterator(); e.hasNext(); ) {
    var n = e.next();
...
oa.prototype = {
  ...
  add: function(i) {
    xc(Do, i, this.t), xc(this, Do.s, this.s), this.s ? this.t += Do.t : this.s = Do.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var _t = 1e-6, ot = Math.PI, Kn = ot / 2, Cc = ot / 4, si = ot * 2, Di = 180 / ot, rn = ot / 180, te = Math.abs, rm = Math.atan, hs = Math.atan2, Lt = Math.cos, Pt = Math.sin, vs = Math.sqrt;
function If(i) {
  return i > 1 ? 0 : i < -1 ? ot : Math.acos(i);
}
function Cr(i) {
  return i > 1 ? Kn : i < -1 ? -Kn : Math.asin(i);
}
function bs() {
}
function aa(i, t) {
  i && Sc.hasOwnProperty(i.type) && Sc[i.type](i, t);
}
var Ic = {
...
function sm(i, t) {
  i && Ic.hasOwnProperty(i.type) ? Ic[i.type](i, t) : aa(i, t);
}
tr();
tr();
function _u(i) {
  return [hs(i[1], i[0]), Cr(i[2])];
}
function fs(i) {
...
function mu(i) {
  var t = vs(i[0] * i[0] + i[1] * i[1] + i[2] * i[2]);
  i[0] /= t, i[1] /= t, i[2] /= t;
}
tr();
function Sf(i, t) {
...
function yu(i, t) {
  return [i > ot ? i - si : i < -ot ? i + si : i, t];
}
yu.invert = yu;
function om(i, t, e) {
  return (i %= si) ? t || e ? Sf(Nc(i), Lc(t, e)) : Nc(i) : t || e ? Lc(t, e) : yu;
}
function wc(i) {
  return function(t, e) {
    return t += i, [t > ot ? t - si : t < -ot ? t + si : t, e];
  };
}
function Nc(i) {
  var t = wc(i);
  return t.invert = wc(-i), t;
}
function Lc(i, t) {
...
function am(i, t, e, n, r, s) {
  if (e) {
    ...
    r == null ? (r = t + n * si, s = t - u / 2) : (r = Pc(o, r), s = Pc(o, s), (n > 0 ? r < s : r > s) && (r += n * si));
    for (var l, c = r; n > 0 ? c > s : c < s; c -= u)
      l = _u([o, -a * Lt(c), -a * Pt(c)]), i.point(l[0], l[1]);
  }
}
function Pc(i, t) {
  t = fs(t), t[0] -= i, mu(t);
  var e = If(-t[1]);
  return ((-t[2] < 0 ? -e : e) + si - _t) % si;
}
function Rf() {
  var i = [], t;
  return {
...
function wf(i, t, e, n, r) {
  ...
  if (i.forEach(function(p) {
    ...
    for (o.sort(t), Tc(s), Tc(o), a = 0, u = o.length; a < u; ++a)
      o[a].e = e = !e;
    for (var l = s[0], c, h; ; ) {
      for (var f = l, g = !0; f.v; )
        if ((f = f.n) === l)
...
function hm(i, t, e, n) {
  ...
  return function(l) {
    var c = l, h = Rf(), f, g, p, d, _, m, y, E, I, S, w, b = {
      point: L,
      lineStart: Y,
      lineEnd: U,
      polygonStart: G,
    ...
    function P() {
      for (var O = 0, k = 0, z = g.length; k < z; ++k)
        for (var Z = g[k], at = 1, It = Z.length, Ft = Z[0], D, $e, me = Ft[0], Ge = Ft[1]; at < It; ++at)
          D = me, $e = Ge, Ft = Z[at], me = Ft[0], Ge = Ft[1], $e <= n ? Ge > n && (me - D) * (n - $e) > (Ge - $e) * (i - D) && ++O : Ge <= n && (me - D) * (n - $e) < (Ge - $e) * (i - D) && --O;
      return O;
    }
    function G() {
      c = h, f = [], g = [], w = !0;
    ...
    function B() {
      var O = P(), k = w && O, z = (f = Lf(f)).length;
      (k || z) && (l.polygonStart(), k && (l.lineStart(), s(null, null, 1, l), l.lineEnd()), z && wf(f, a, O, s, l), l.polygonEnd()), c = l, f = g = p = null;
    }
    function Y() {
    ...
    function T(O, k) {
      ...
      if (g && p.push([O, k]), S)
        ...
        var Z = [y = Math.max(Go, Math.min(Ms, y)), E = Math.max(Go, Math.min(Ms, E))], at = [O = Math.max(Go, Math.min(Ms, O)), k = Math.max(Go, Math.min(Ms, k))];
...
function fm(i, t) {
  ...
  for (var a = 0, u = i.length; a < u; ++a)
    if (c = (l = i[a]).length)
      for (var l, c, h = l[c - 1], f = h[0], g = h[1] / 2 + Cc, p = Pt(g), d = Lt(g), _ = 0; _ < c; ++_, f = y, p = I, d = S, h = m) {
        var m = l[_], y = m[0], E = m[1] / 2 + Cc, I = Pt(E), S = Lt(E), w = y - f, b = w >= 0 ? 1 : -1, L = b * w, P = L > ot, G = p * I;
        if (ja.add(hs(G * b * Pt(L), d * S + G * Lt(L))), s += P ? w + b * si : w, P ^ f >= e ^ y >= e) {
          var B = ua(fs(h), fs(m));
          mu(B);
          var Y = ua(r, B);
          mu(Y);
          var U = (P ^ w >= 0 ? -1 : 1) * Cr(Y[2]);
...
tr();
tr();
var gs = 1 / 0, la = gs, ao = -gs, ca = ao, bc = {
  point: gm,
  lineStart: bs,
  lineEnd: bs,
  polygonStart: bs,
  ...
  result: function() {
    var i = [[gs, la], [ao, ca]];
    return ao = ca = -(la = gs = 1 / 0), i;
  }
};
function gm(i, t) {
  i < gs && (gs = i), i > ao && (ao = i), t < la && (la = t), t > ca && (ca = t);
}
tr();
function Pf(i, t, e, n) {
  return function(r, s) {
    var o = t(s), a = r.invert(n[0], n[1]), u = Rf(), l = t(u), c = !1, h, f, g, p = {
      point: d,
      lineStart: m,
      lineEnd: y,
      ...
      polygonEnd: function() {
        p.point = d, p.lineStart = m, p.lineEnd = y, f = Lf(f);
        var w = fm(h, a);
        f.length ? (c || (s.polygonStart(), c = !0), wf(f, dm, w, e, s)) : w && (c || (s.polygonStart(), c = !0), s.lineStart(), e(null, null, 1, s), s.lineEnd()), c && (s.polygonEnd(), c = !1), f = h = null;
      },
      sphere: function() {
...
function dm(i, t) {
  return ((i = i.x)[0] < 0 ? i[1] - Kn - _t : Kn - i[1]) - ((t = t.x)[0] < 0 ? t[1] - Kn - _t : Kn - t[1]);
}
const Mc = Pf(
  function() {
    return !0;
...
function _m(i) {
  ...
  return {
    ...
    point: function(s, o) {
      ...
      te(u - ot) < _t ? (i.point(t, e = (e + o) / 2 > 0 ? Kn : -Kn), i.point(n, e), i.lineEnd(), i.lineStart(), i.point(a, e), i.point(s, e), r = 0) : n !== a && u >= ot && (te(t - n) < _t && (t -= n * _t), te(s - a) < _t && (s -= a * _t), e = mm(t, e, s, o), i.point(n, e), i.lineEnd(), i.lineStart(), i.point(a, e), r = 0), i.point(t = s, e = o), n = a;
    },
    lineEnd: function() {
      i.lineEnd(), t = e = NaN;
    },
...
function ym(i, t, e, n) {
  var r;
  if (i == null)
    r = e * Kn, n.point(-ot, r), n.point(0, r), n.point(ot, r), n.point(ot, 0), n.point(ot, -r), n.point(0, -r), n.point(-ot, -r), n.point(-ot, 0), n.point(-ot, r);
...
function vm(i, t) {
  ...
  function u(c, h, f) {
    var g = fs(c), p = fs(h), d = [1, 0, 0], _ = ua(g, p), m = Ao(_, _), y = _[0], E = m - y * y;
    if (!E)
      return !f && c;
    var I = e * m / E, S = -e * y / E, w = ua(d, _), b = Fo(d, I), L = Fo(_, S);
    Ha(b, L);
    var P = w, G = Ao(b, P), B = Ao(P, P), Y = G * G - B * (Ao(b, b) - 1);
    if (!(Y < 0)) {
      var U = vs(Y), T = Fo(P, (-G - U) / B);
      if (Ha(T, b), T = _u(T), !f)
        return T;
...
function Of(i, t, e) {
  ...
  i.scale(150).translate([0, 0]), s != null && i.clipExtent(null), sm(e, i.stream(bc));
  var o = bc.result(), a = Math.min(n / (o[1][0] - o[0][0]), r / (o[1][1] - o[0][1])), u = +t[0][0] + (n - a * (o[1][0] + o[0][0])) / 2, l = +t[0][1] + (r - a * (o[1][1] + o[0][1])) / 2;
  return s != null && i.clipExtent(s), i.scale(a * 150).translate([u, l]);
}
function Em(i, t, e) {
  return Of(i, [[0, 0], t], e);
}
var Dc = 16, xm = Lt(30 * rn);
function Ac(i, t) {
...
function Im(i, t) {
  function e(n, r, s, o, a, u, l, c, h, f, g, p, d, _) {
    ...
    if (E > 4 * t && d--) {
      var I = o + f, S = a + g, w = u + p, b = vs(I * I + S * S + w * w), L = Cr(w /= b), P = te(te(w) - 1) < _t || te(s - h) < _t ? (s + h) / 2 : hs(S, I), G = i(P, L), B = G[0], Y = G[1], U = B - n, T = Y - r, O = y * U - m * T;
  ...
  return function(n) {
    ...
    function E(L, P) {
      var G = fs([L, P]), B = i(L, P);
      e(h, f, c, g, p, d, h = B[0], f = B[1], c = L, g = G[0], p = G[1], d = G[2], Dc, n), n.point(h, f);
    }
    function I() {
      _.point = m, n.lineEnd();
    }
    ...
    function b() {
      e(h, f, c, g, p, d, s, o, r, a, u, l, Dc, n), _.lineEnd = I, I();
    }
    return _;
  };
}
...
function wm(i) {
  var t, e = 150, n = 480, r = 250, s, o, a = 0, u = 0, l = 0, c = 0, h = 0, f, g, p = null, d = Mc, _ = null, m, y, E, I = Oc, S = 0.5, w = Ac(B, S), b, L;
  function P(T) {
  ...
  P.stream = function(T) {
    ...
    return arguments.length ? (d = +T ? vm(p = T * rn, 6 * rn) : (p = null, Mc), U()) : p * Di;
  }, P.clipExtent = function(T) {
    return arguments.length ? (I = T == null ? (_ = m = y = E = null, Oc) : hm(_ = +T[0][0], m = +T[0][1], y = +T[1][0], E = +T[1][1]), U()) : _ == null ? null : [[_, m], [y, E]];
  }, P.scale = function(T) {
    ...
    return arguments.length ? (l = T[0] % 360 * rn, c = T[1] % 360 * rn, h = T.length > 2 ? T[2] % 360 * rn : 0, Y()) : [l * Di, c * Di, h * Di];
  }, P.precision = function(T) {
    return arguments.length ? (w = Ac(B, S = T * T), U()) : vs(S);
...
function Mf(i) {
  return function(t, e) {
    var n = vs(t * t + e * e), r = i(n), s = Pt(r), o = Lt(r);
    return [
      hs(t * s, n * o),
      Cr(n && e * s / n)
    ];
...
var Nm = bf(function(i) {
  return vs(2 / (1 + i));
});
Nm.invert = Mf(function(i) {
  return 2 * Cr(i / 2);
});
var Df = bf(function(i) {
  return (i = If(i)) && i / Pt(i);
});
Df.invert = Mf(function(i) {
  return i;
});
function Lm() {
  return Rm(Df).scale(79.4188).clipAngle(180 - 1e-3);
}
function Fc(i, t) {
  return [i, t];
}
...
function Pm(i, t, e) {
  ...
  switch (i.type) {
    case "GeometryCollection":
      return jh(i, function(o) {
        var a = zo(o, t, n, r);
        a && s.push(a);
      }), fu(s);
    case "FeatureCollection":
      return _c(i, function(o) {
        var a = zo(o, t, n, r);
        a && _c(a, function(u) {
          u && s.push(u);
        });
...
function zo(i, t, e, n) {
  ...
  var a = Tm(s), u = {
    type: s.type,
    coordinates: Ff(s.coordinates, a)
  }, l = new il(), c = l.read(u), h = G_(B_(t, e), "meters"), f = Gt.bufferOp(c, h, n), g = new sf();
  if (f = g.write(f), !Af(f.coordinates)) {
    var p = {
      type: f.type,
      coordinates: kf(f.coordinates, a)
    };
    return ya(p, r);
  }
}
function Af(i) {
  return Array.isArray(i[0]) ? Af(i[0]) : isNaN(i[0]);
}
function Ff(i, t) {
...
`);
    var s = t + (e ? "    " : "│   ");
    i.left && Eu(i.left, s, !1, n, r), i.right && Eu(i.right, s, !0, n, r);
  }
}
var fl = (
  /** @class */
  function() {
    ...
    return i.prototype.insert = function(t, e) {
      return this._size++, this._root = Za(t, e, this._root, this._comparator);
      ...
      if (n && Iu(t, e, 0, r - 1, s), this._root === null)
        this._root = xu(t, e, 0, r), this._size = r;
      else {
        var o = Fm(this.toList(), Dm(t, e), s);
        r = this._size + r, this._root = Cu({ head: o }, 0, r);
      }
      return this;
      ...
      var e = [];
      return Eu(this._root, "", !0, function(n) {
        return e.push(n);
      }, t), e.join("");
    }, i.prototype.update = function(t, e, n) {
      var r = this._comparator, s = kc(t, this._root, r), o = s.left, a = s.right;
      r(t, e) < 0 ? a = Za(e, n, a, r) : o = Za(e, n, o, r), this._root = Mm(o, a, r);
    }, i.prototype.split = function(t) {
      return kc(t, this._root, this._comparator);
...
function xu(i, t, e, n) {
  ...
  if (r > 0) {
    ...
    return u.left = xu(i, t, e, s), u.right = xu(i, t, s + 1, n), u;
  }
  return null;
}
function Dm(i, t) {
...
function Cu(i, t, e) {
  var n = e - t;
  if (n > 0) {
    var r = t + Math.floor(n / 2), s = Cu(i, t, r), o = i.head;
    return o.left = s, i.head = i.head.next, o.right = Cu(i, r + 1, e), o;
  }
  return null;
}
function Fm(i, t, e) {
...
function we(i, t, e) {
  return t && Gc(i.prototype, t), e && Gc(i, e), i;
}
var Ls = function(t, e) {
...
var km = Gi * Gi, Ru = function(t, e) {
  ...
  return we(i, [{
    key: "reset",
    value: function() {
      this.xRounder = new Bc(), this.yRounder = new Bc();
    }
  }, {
    key: "round",
    value: function(e, n) {
  ...
  function i() {
    Sn(this, i), this.tree = new fl(), this.round(0);
  }
  return we(i, [{
    key: "round",
    value: function(e) {
      var n = this.tree.add(e), r = this.tree.prev(n);
      if (r !== null && Ru(n.key, r.key) === 0)
        return this.tree.remove(e), r.key;
      var s = this.tree.next(n);
      return s !== null && Ru(n.key, s.key) === 0 ? (this.tree.remove(e), s.key) : e;
    }
  }]), i;
}(), uo = new Gm(), Ds = function(t, e) {
  ...
  var o = {
    x: n.x - t.x,
    y: n.y - t.y
  }, a = Ds(o, e) / s, u = Ds(o, r) / s, l = t.x + u * e.x, c = n.x + a * r.x, h = t.y + u * e.y, f = n.y + a * r.y, g = (l + c) / 2, p = (h + f) / 2;
  return {
    x: g,
    y: p
  };
  ...
  we(i, null, [{
    ...
    value: function(e, n) {
      ...
      return r !== 0 ? r : (e.point !== n.point && e.link(n), e.isLeft !== n.isLeft ? e.isLeft ? 1 : -1 : fa.compare(e.segment, n.segment));
    }
  ...
  function i(t, e, n, r) {
    Sn(this, i), this.id = ++Xm, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = n, this.windings = r;
  }
  return we(i, [{
    key: "replaceRightSE",
    ...
    key: "getIntersection",
    value: function(e) {
      var n = this.bbox(), r = e.bbox(), s = Su(n, r);
      if (s === null)
        return null;
      var o = this.leftSE.point, a = this.rightSE.point, u = e.leftSE.point, l = e.rightSE.point, c = Ls(n, u) && this.comparePoint(u) === 0, h = Ls(r, o) && e.comparePoint(o) === 0, f = Ls(n, l) && this.comparePoint(l) === 0, g = Ls(r, a) && e.comparePoint(a) === 0;
      if (h && c)
      ...
      return p === null || !Ls(s, p) ? null : uo.round(p.x, p.y);
    }
    /**
    ...
    key: "split",
    value: function(e) {
      var n = [], r = e.events !== void 0, s = new Hn(e, !0), o = new Hn(e, !1), a = this.rightSE;
      this.replaceRightSE(o), n.push(o), n.push(s);
      var u = new i(s, a, this.rings.slice(), this.windings.slice());
      return Hn.comparePoints(u.leftSE.point, u.rightSE.point) > 0 && u.swapEvents(), Hn.comparePoints(this.leftSE.point, this.rightSE.point) > 0 && this.swapEvents(), r && (s.checkForConsuming(), o.checkForConsuming()), n;
    }
    ...
    value: function() {
      ...
      switch (Pn.type) {
        ...
        case "intersection": {
          var o, a;
          e.length < n.length ? (o = e.length, a = n.length) : (o = n.length, a = e.length), this._isInResult = a === Pn.numMultiPolys && o < a;
          break;
        }
        case "xor": {
        ...
        default:
          throw new Error("Unrecognized operation type found ".concat(Pn.type));
      }
      return this._isInResult;
    }
  }], [{
    ...
    value: function(e, n, r) {
      var s, o, a, u = Hn.comparePoints(e, n);
      if (u < 0)
        s = e, o = n, a = 1;
      else if (u > 0)
        s = n, o = e, a = -1;
  ...
  function i(t, e, n) {
    ...
    for (var s = r, o = 1, a = t.length; o < a; o++) {
      ...
      u.x === s.x && u.y === s.y || (this.segments.push(fa.fromRing(s, u, this)), u.x < this.bbox.ll.x && (this.bbox.ll.x = u.x), u.y < this.bbox.ll.y && (this.bbox.ll.y = u.y), u.x > this.bbox.ur.x && (this.bbox.ur.x = u.x), u.y > this.bbox.ur.y && (this.bbox.ur.y = u.y), s = u);
    }
    (r.x !== s.x || r.y !== s.y) && this.segments.push(fa.fromRing(s, r, this));
  }
  return we(i, [{
    key: "getSweepEvents",
    value: function() {
  ...
  function i(t, e) {
    if (Sn(this, i), !Array.isArray(t))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new Yc(t[0], this, !0), this.bbox = {
      ll: {
  ...
  return we(i, [{
    ...
    value: function() {
      for (var e = this.events[0].point, n = [e], r = 1, s = this.events.length - 1; r < s; r++) {
        ...
        zc(o, e, a) !== 0 && (n.push(o), e = o);
      }
      if (n.length === 1)
        return null;
      var u = n[0], l = n[1];
      zc(u, e, l) === 0 && n.shift(), n.push(n[0]);
      ...
      for (var n = [], r = 0, s = e.length; r < s; r++) {
        ...
        if (!o.poly)
          if (o.isExteriorRing())
            ...
            a.poly || n.push(new Wc(a)), a.poly.addInterior(o);
          }
      }
      return n;
    }
  ...
  function i(t) {
    var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : fa.compare;
    Sn(this, i), this.queue = t, this.tree = new fl(e), this.segments = [];
  }
  return we(i, [{
    key: "process",
    value: function(e) {
...
}(), qc = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, Hm = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, jm = /* @__PURE__ */ function() {
  function i() {
    Sn(this, i);
  }
  return we(i, [{
    ...
    value: function(e, n, r) {
      Pn.type = e, uo.reset();
      for (var s = [new Uc(n, !0)], o = 0, a = r.length; o < a; o++)
        s.push(new Uc(r[o], !1));
      if (Pn.numMultiPolys = s.length, Pn.type === "difference")
        for (var u = s[0], l = 1; l < s.length; )
          Su(s[l].bbox, u.bbox) !== null ? l++ : s.splice(l, 1);
      if (Pn.type === "intersection") {
        for (var c = 0, h = s.length; c < h; c++)
          for (var f = s[c], g = c + 1, p = s.length; g < p; g++)
            if (Su(f.bbox, s[g].bbox) === null)
              return [];
      }
      for (var d = new fl(Hn.compare), _ = 0, m = s.length; _ < m; _++)
        for (var y = s[_].getSweepEvents(), E = 0, I = y.length; E < I; E++)
          if (d.insert(y[E]), d.size > qc)
...
}(), Pn = new jm(), Zm = function(t) {
  for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++)
    n[r - 1] = arguments[r];
  return Pn.run("union", t, n);
}, Km = function(t) {
  for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++)
    n[r - 1] = arguments[r];
  return Pn.run("intersection", t, n);
}, Jm = function(t) {
  for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++)
    n[r - 1] = arguments[r];
  return Pn.run("xor", t, n);
}, Qm = function(t) {
  for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++)
    n[r - 1] = arguments[r];
  return Pn.run("difference", t, n);
}, $m = {
  union: Zm,
  intersection: Km,
  xor: Jm,
...
function ty(i, t) {
  var e = Hc(i), n = Hc(t), r = i.properties || {}, s = $m.difference(
    e.coordinates,
    n.coordinates
  );
...
function ey(i) {
  ...
  return new $o({
    ...
    text: t.isSelected && t.tooltip ? new Bh({
      backgroundFill: new Vs({ color: "white" }),
      text: t.tooltip,
      offsetY: -40,
...
function sy(i, t = {}, e = {}, n = ey) {
  ...
  function h(g) {
    return g.transform(Kc, i.getView().getProjection());
  }
  const f = (g) => {
    o == null || o({
      type: "mapClick",
      coordinates: Ml(g.coordinate, i.getView().getProjection())
    });
  };
  return {
    setEventHandler(g) {
    ...
    fitBounds(g, p, d) {
      i.getView().fit(sp(g, Kc, i.getView().getProjection()), {
        padding: [p, p, p, p],
        maxZoom: d,
        duration: 2e3,
        ...e
    ...
    setReverseMarker(g) {
      ...
      ) : (c.removeFeature(a), a.dispose(), a = void 0) : g && (a = new ci(
        new Yr(Po(g, i.getView().getProjection()))
      ...
      function d(_) {
        ...
        if (_)
          for (const y of _.features) {
            const E = y.geometry.type === "Polygon" ? new Wo(y.geometry.coordinates) : y.geometry.type === "MultiPolygon" ? new pc(y.geometry.coordinates) : null;
            E && c.addFeature(
              new ci({
      ...
      if (c.clear(), a && c.addFeature(a), d(), p) {
        ...
        if (p.geometry.type === "GeometryCollection") {
          const m = p.geometry.geometries.map(
            (y) => y.type === "Polygon" ? new Wo(y.coordinates) : y.type === "MultiPolygon" ? new pc(y.coordinates) : null
          ).filter((y) => !!y);
          if (m.length > 0)
            c.addFeature(
              new ci(h(new P_(m)))
        ...
        if (!_) {
          if (p.geometry.type === "Polygon")
            ...
            c.addFeature(
              new ci(
                h(new gc(p.geometry.coordinates))
              )
            );
            return;
          }
        }
        c.addFeature(new ci(h(new Yr(p.center))));
      }
      for (const _ of g ?? []) {
        if (_ === p)
          continue;
        const m = new ci(
          new Yr(Po(_.center, i.getView().getProjection()))
        );
