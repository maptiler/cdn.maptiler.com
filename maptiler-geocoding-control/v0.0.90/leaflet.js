...
function Ka(r, t, e, n) {
  return r[1] && n ? fl(e.ctx.slice(), r[1](n(t))) : e.ctx;
}
function pl(r, t, e, n) {
  if (r[2] && n) {
    const i = r[2](n(e));
...
function El(r, t, { bubbles: e = !1, cancelable: n = !1 } = {}) {
...
const di = [], ms = [];
let yi = [];
const sa = [], Nl = /* @__PURE__ */ Promise.resolve();
let _s = !1;
function xl() {
  _s || (_s = !0, Nl.then(Ja));
}
...
function Ja() {
  ...
  do {
    try {
      ...
      throw di.length = 0, pi = 0, t;
    }
    for (Ki(null), di.length = 0, pi = 0; ms.length; )
      ms.pop()();
    for (let t = 0; t < yi.length; t += 1) {
      const e = yi[t];
      gs.has(e) || (gs.add(e), e());
    }
    yi.length = 0;
...
function wl(r) {
  const t = [], e = [];
  yi.forEach((n) => r.indexOf(n) === -1 ? t.push(n) : e.push(n)), e.forEach((n) => n()), yi = t;
}
...
function ur(r, t) {
  const e = r.$$;
  e.fragment !== null && (wl(e.after_update), Br(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function Ll(r, t) {
  r.$$.dirty[0] === -1 && (di.push(r), xl(), r.$$.dirty.fill(0)), r.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function kr(r, t, e, n, i, o, s, a = [-1]) {
  ...
  if (l.ctx = e ? e(r, t.props || {}, (f, h, ...g) => {
    ...
    return l.ctx && i(l.ctx[f], l.ctx[f] = p) && (!l.skip_bound && l.bound[f] && l.bound[f](p), c && Ll(r, f)), h;
...
function Rl(r) {
  ...
  return {
    ...
    p(y, [d]) {
      d & /*feature*/
      1 && o !== (o = /*feature*/
      y[0].place_name.replace(/,.*/, "") + "") && Ji(s, o), d & /*feature*/
      1 && l !== (l = /*feature*/
      y[0].place_name.replace(/[^,]*,?\s*/, "") + "") && Ji(c, l), /*showPlaceType*/
...
function Yl(r, t, e) {
  ...
  async function as(N, { byId: Bt = !1, exact: kn = !1 } = {}) {
    e(16, Gn = void 0);
    const Xi = ta(), ze = new URLSearchParams();
    C != null && ze.set("language", Array.isArray(C) ? C.join(",") : C), St && ze.set("types", St.join(",")), Xi || (u && ze.set("bbox", u.map((_r) => _r.toFixed(6)).join(",")), h && ze.set("country", Array.isArray(h) ? h.join(",") : h)), Bt || (A && ze.set("proximity", A.map((_r) => _r.toFixed(6)).join(",")), (kn || !Y) && ze.set("autocomplete", "false"), ze.set("fuzzyMatch", String(I))), L !== void 0 && ze.set("limit", String(L)), ze.set("key", a);
    ...
    mr("response", { url: Yr, featureCollection: fs }), Bt ? (e(12, nt = void 0), e(45, vt = fs.features[0]), Co = [vt]) : (e(12, nt = fs.features.filter(d)), Co = nt, Xi && Bn.focus());
  }
  function Ku() {
    var kn, Xi, ze, Yr;
    ...
    for (const _e of Ot)
      (Bt || !_e.matching_text) && (N[0] = Math.min(N[0], ((kn = _e.bbox) == null ? void 0 : kn[0]) ?? _e.center[0]), N[1] = Math.min(N[1], ((Xi = _e.bbox) == null ? void 0 : Xi[1]) ?? _e.center[1]), N[2] = Math.max(N[2], ((ze = _e.bbox) == null ? void 0 : ze[2]) ?? _e.center[0]), N[3] = Math.max(N[3], ((Yr = _e.bbox) == null ? void 0 : Yr[3]) ?? _e.center[1]));
    x && Ot.length > 0 && (vt && N[0] === N[2] && N[1] === N[3] ? x.flyTo(vt.center, Ht) : x.fitBounds(ha(N), 50));
  }
  function Qu(N) {
    e(0, q = p === "always"), Fn(Xl(N[0], [-180, 180], !0).toFixed(6) + "," + N[1].toFixed(6));
  }
  function Ju(N) {
    if (!nt)
      return;
  ...
  function us(N = !0) {
    if (e(16, Gn = void 0), Y) {
      if (gi && clearTimeout(gi), P.length < w)
        return;
      const Bt = P;
  ...
  const el = () => e(11, ge = !0), nl = () => e(11, ge = !1), rl = () => us(), il = () => {
    e(1, P = ""), Bn.focus();
  }, ol = () => e(0, q = !q), sl = () => e(16, Gn = void 0), al = (N) => e(13, Ft = N), ul = (N) => ls(N), ll = () => e(13, Ft = -1), cl = () => {
  };
  return r.$$set = (N) => {
    ...
    8 && P.length < w && (e(45, vt = void 0), e(12, nt = void 0), e(16, Gn = void 0), e(44, Ot = nt)), r.$$.dirty[1] & /*showFullGeometry, picked*/
...
var As = (
  ...
  function() {
    function r(t) {
      t === void 0 && (t = jl), this._root = null, this._size = 0, this._comparator = t;
    }
    return r.prototype.insert = function(t, e) {
      ...
      i(t, e) < 0 ? a = ps(e, n, a, i) : s = ps(e, n, s, i), this._root = Kl(s, a, i);
...
var $l = Nr * Nr, ws = function(t, e) {
  if (-Nr < t && t < Nr && -Nr < e && e < Nr)
    return 0;
  var n = t - e;
  return n * n < $l * t * e ? 0 : t < e ? -1 : 1;
  ...
  var s = {
    x: n.x - t.x,
    y: n.y - t.y
  }, a = Qi(s, e) / o, u = Qi(s, i) / o, l = t.x + u * e.x, c = n.x + a * i.x, f = t.y + u * e.y, h = n.y + a * i.y, g = (l + c) / 2, p = (f + h) / 2;
  return {
    x: g,
    y: p
  };
  ...
  return Ne(r, [{
    ...
    value: function(e) {
      var n = this, i = /* @__PURE__ */ new Map(), o = function(a) {
        var u = a.otherSE;
        i.set(a, {
          sine: ec(n.point, e.point, u.point),
  ...
  function r(t, e, n, i) {
    vn(this, r), this.id = ++ic, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = n, this.windings = i;
  }
  return Ne(r, [{
    key: "replaceRightSE",
    ...
    value: function(e) {
      ...
      if (o === null)
        return null;
      var s = this.leftSE.point, a = this.rightSE.point, u = e.leftSE.point, l = e.rightSE.point, c = Yi(n, u) && this.comparePoint(u) === 0, f = Yi(i, s) && e.comparePoint(s) === 0, h = Yi(n, l) && this.comparePoint(l) === 0, g = Yi(i, a) && e.comparePoint(a) === 0;
      if (f && c)
      ...
      if (h)
        return l;
      var p = rc(s, this.vector(), u, e.vector());
      return p === null || !Yi(o, p) ? null : $i.round(p.x, p.y);
    }
    /**
...
}(), Ca = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, lc = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6, cc = /* @__PURE__ */ function() {
  function r() {
    vn(this, r);
  }
  return Ne(r, [{
    ...
    value: function(e, n, i) {
      ...
      for (var x = new uc(y), w = y.size, M = y.pop(); M; ) {
        var B = M.key;
        if (y.size === w) {
          var A = B.segment;
      ...
      $i.reset();
      var R = sc.factory(x.segments), Y = new ac(R);
      return Y.getGeom();
    }
  }]), r;
}(), Nn = new cc(), fc = function(t) {
...
class Ic extends zr {
  constructor(t) {
    super(), kr(this, t, Ec, _c, Gr, { displayIn: 0 });
  }
}
function ou(r, t, e) {
  if (r !== null)
...
to.isWhitespace = function(t) {
  return t <= 32 && t >= 0 || t === 127;
};
to.toUpperCase = function(t) {
...
E.parse = function(t) {
  for (var e = 0, n = t.length; to.isWhitespace(t.charAt(e)); )
    e++;
  var i = !1;
  if (e < n) {
    var o = t.charAt(e);
...
var Q = function() {
}, vo = { X: { configurable: !0 }, Y: { configurable: !0 }, Z: { configurable: !0 }, M: { configurable: !0 } };
vo.X.get = function() {
  return 0;
};
vo.Y.get = function() {
...
Qo.prototype.read = function(t) {
  ...
  if (t.search("EMPTY") !== -1 && (o = Ze.emptyTypeStr.exec(t), o[2] = void 0), o && (n = o[1].toLowerCase(), i = o[2], vi[n] && (e = vi[n].apply(this, [i]))), e === void 0)
...
var Un = {
  ...
  multipoint: function(t) {
    ...
    for (var n, i = t.trim().split(","), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Ze.trimParens, "$1"), o.push(vi.point.apply(e, [n]));
  ...
  multilinestring: function(t) {
    ...
    for (var n, i = t.trim().split(Ze.parenComma), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Ze.trimParens, "$1"), o.push(vi.linestring.apply(e, [n]));
  ...
  polygon: function(t) {
    ...
    for (var n, i, o, s = t.trim().split(Ze.parenComma), a, u = [], l = 0, c = s.length; l < c; ++l)
      n = s[l].replace(Ze.trimParens, "$1"), i = vi.linestring.apply(e, [n]), o = e.geometryFactory.createLinearRing(i._points), l === 0 ? a = o : u.push(o);
  ...
  multipolygon: function(t) {
    ...
    for (var n, i = t.trim().split(Ze.doubleParenComma), o = [], s = 0, a = i.length; s < a; ++s)
      n = i[s].replace(Ze.trimParens, "$1"), o.push(vi.polygon.apply(e, [n]));
...
W.intersection = function(t, e) {
  for (var n = new yo(), i = 0; i < t.length; i++)
...
xi.prototype.OLDcompare = function(t, e) {
  var n = t, i = e;
  if (n.length < i.length)
    return -1;
  if (n.length > i.length)
...
mo.prototype.name = "OperationNotSupported";
function Zo() {
}
Zo.prototype = new wt();
...
De.getStackTrace = function() {
  if (arguments.length === 1) {
    var t = arguments[0], e = new Pc(), n = new wc();
    return t.printStackTrace(n), e.toString();
  } else if (arguments.length === 2) {
    var i = arguments[0], o = arguments[1], s = "";
    new Lc(De.getStackTrace(i));
    for (var a = new Oc(), u = 0; u < o; u++)
      try {
...
Ae.prototype.editGeometryCollection = function(t, e) {
  ...
  return i.getClass() === Si ? this._factory.createMultiPoint(o.toArray([])) : i.getClass() === br ? this._factory.createMultiLineString(o.toArray([])) : i.getClass() === xn ? this._factory.createMultiPolygon(o.toArray([])) : this._factory.createGeometryCollection(o.toArray([]));
};
...
var H = function r() {
  this._precisionModel = new $(), this._SRID = 0, this._coordinateSequenceFactory = r.getDefaultCoordinateSequenceFactory(), arguments.length === 0 || (arguments.length === 1 ? k(arguments[0], _i) ? this._coordinateSequenceFactory = arguments[0] : arguments[0] instanceof $ && (this._precisionModel = arguments[0]) : arguments.length === 2 ? (this._precisionModel = arguments[0], this._SRID = arguments[1]) : arguments.length === 3 && (this._precisionModel = arguments[0], this._SRID = arguments[1], this._coordinateSequenceFactory = arguments[2]));
...
var Dc = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], es = function(t) {
  this.geometryFactory = t || new H();
};
es.prototype.read = function(t) {
  ...
  return Dc.indexOf(n) !== -1 ? tn[n].apply(this, [e.coordinates]) : n === "GeometryCollection" ? tn[n].apply(this, [e.geometries]) : tn[n].apply(this, [e]);
};
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.buildMinimalRings = function() {
    ...
    do {
      if (o.getMinEdgeRing() === null) {
        var s = new Tc(o, n._geometryFactory);
        i.add(s);
      }
      o = o.getNext();
...
var it = function() {
}, _o = { NE: { configurable: !0 }, NW: { configurable: !0 }, SW: { configurable: !0 }, SE: { configurable: !0 } };
...
ve.prototype.buildMaximalEdgeRings = function(t) {
  for (var e = this, n = new b(), i = t.iterator(); i.hasNext(); ) {
    ...
    if (o.isInResult() && o.getLabel().isArea() && o.getEdgeRing() === null) {
      var s = new Mc(o, e._geometryFactory);
...
bi.prototype.distance = function(t, e) {
};
...
var mu = function(r) {
  ...
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[0] instanceof t && k(arguments[1], bi)) {
...
ao.prototype.addIntersection = function(t, e) {
};
...
lo.prototype.setSegmentIntersector = function(t) {
  this._segInt = t;
};
...
dt.prototype.collapseLine = function() {
  for (var t = this, e = new yo(), n = 0; n < this._inputLine.length; n++)
...
}, Io = { OFFSET_SEGMENT_SEPARATION_FACTOR: { configurable: !0 }, INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR: { configurable: !0 }, CURVE_VERTEX_SNAP_DISTANCE_FACTOR: { configurable: !0 }, MAX_CLOSING_SEG_LEN_FACTOR: { configurable: !0 } };
...
Io.OFFSET_SEGMENT_SEPARATION_FACTOR.get = function() {
  return 1e-3;
};
Io.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR.get = function() {
  return 1e-3;
};
Io.CURVE_VERTEX_SNAP_DISTANCE_FACTOR.get = function() {
  return 1e-6;
};
Io.MAX_CLOSING_SEG_LEN_FACTOR.get = function() {
  return 80;
};
Object.defineProperties(lt, Io);
var le = function() {
...
Fe.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof Rt ? this.addPolygon(t) : t instanceof pt ? this.addLineString(t) : t instanceof de ? this.addPoint(t) : t instanceof Si ? this.addCollection(t) : t instanceof br ? this.addCollection(t) : t instanceof xn ? this.addCollection(t) : t instanceof ne && this.addCollection(t);
};
...
Pi.prototype.locate = function(t) {
};
...
On.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new Xs(), this._pointSnapper = new Ri(this._noder.getIndex()), this.snapRound(t, this._li);
};
...
fo.prototype.computeIntersections = function(t, e) {
...
var Bc = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.prepareEvents = function() {
    ...
    for (var o = this, s = n.getMonotoneChainEdge(), a = s.getStartIndexes(), u = 0; u < a.length - 1; u++) {
      var l = new fo(s, u), c = new me(i, s.getMinX(u), l);
...
ho.prototype.compare = function(t, e) {
...
Mn.prototype.buildLevel = function(t, e) {
  ...
  for (var n = 0; n < t.size(); n += 2) {
    ...
    if (o === null)
      ...
      var s = new kc(t.get(n), t.get(n + 1));
      e.add(s);
    }
  }
};
...
Oi.prototype.visitItem = function(t) {
  this._items.add(t);
};
Oi.prototype.getItems = function() {
  return this._items;
};
Oi.prototype.interfaces_ = function() {
  return [cr];
...
Ar.prototype.query = function() {
  if (arguments.length === 2) {
    var t = arguments[0], e = arguments[1], n = new Oi();
...
var Hi = function(r) {
  ...
  return r && (t.__proto__ = r), t.prototype = Object.create(r && r.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(n, i) {
    ...
    return k(this._parentGeom, lr) && this._parentGeom.getNumGeometries() > 50 ? (this._areaPtLocator === null && (this._areaPtLocator = new Di(this._parentGeom)), this._areaPtLocator.locate(n)) : this._ptLocator.locate(n, this._parentGeom);
  ...
  if (this._li = new Vr(), this._resultPrecisionModel = null, this._arg = null, arguments.length === 1) {
    var t = arguments[0];
    this.setComputationPrecision(t.getPrecisionModel()), this._arg = new Array(1).fill(null), this._arg[0] = new Hi(0, t);
  } else if (arguments.length === 2) {
    var e = arguments[0], n = arguments[1], i = Me.OGC_SFS_BOUNDARY_RULE;
    e.getPrecisionModel().compareTo(n.getPrecisionModel()) >= 0 ? this.setComputationPrecision(e.getPrecisionModel()) : this.setComputationPrecision(n.getPrecisionModel()), this._arg = new Array(2).fill(null), this._arg[0] = new Hi(0, e, i), this._arg[1] = new Hi(1, n, i);
  } else if (arguments.length === 3) {
    var o = arguments[0], s = arguments[1], a = arguments[2];
    o.getPrecisionModel().compareTo(s.getPrecisionModel()) >= 0 ? this.setComputationPrecision(o.getPrecisionModel()) : this.setComputationPrecision(s.getPrecisionModel()), this._arg = new Array(2).fill(null), this._arg[0] = new Hi(0, o, a), this._arg[1] = new Hi(1, s, a);
  }
};
Mi.prototype.getArgGeometry = function(t) {
  return this._arg[t].getGeometry();
};
Mi.prototype.setComputationPrecision = function(t) {
...
Ai.prototype.getLinework = function() {
...
var gt = 1e-6, ot = Math.PI, Hn = ot / 2, Ra = ot / 4, tr = ot * 2, Ir = 180 / ot, $e = ot / 180, te = Math.abs, zc = Math.atan, Fi = Math.atan2, Lt = Math.cos, bt = Math.sin, qi = Math.sqrt;
function Mu(r) {
...
function Ds(r) {
  var t = qi(r[0] * r[0] + r[1] * r[1] + r[2] * r[2]);
  r[0] /= t, r[1] /= t, r[2] /= t;
}
Ur();
function Au(r, t) {
  ...
  return function(l) {
    ...
    function R(Y, ut) {
      ...
      if (g && p.push([Y, ut]), x)
        ...
        var Ht = [I = Math.max(Po, Math.min(ji, I)), C = Math.max(Po, Math.min(ji, C))], he = [Y = Math.max(Po, Math.min(ji, Y)), ut = Math.max(Po, Math.min(ji, ut))];
        Xc(Ht, he, r, t, e, n) ? (L || (c.lineStart(), c.point(Ht[0], Ht[1])), c.point(he[0], he[1]), St || c.lineEnd(), w = !1) : St && (c.lineStart(), c.point(Y, ut), w = !1);
      }
      I = Y, C = ut, L = St;
    }
    return M;
  ...
  for (var a = 0, u = r.length; a < u; ++a)
    if (c = (l = r[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + Ra, p = bt(g), y = Lt(g), d = 0; d < c; ++d, h = I, p = L, y = x, f = m) {
        ...
        if (ys.add(Fi(q * M * bt(B), y * x + q * Lt(B))), o += A ? w + M * tr : w, A ^ h >= e ^ I >= e) {
          var j = Yo(Bi(f), Bi(m));
          Ds(j);
          var P = Yo(i, j);
          Ds(P);
          var X = (A ^ w >= 0 ? -1 : 1) * ai(P[2]);
...
Ur();
Ur();
var Gi = 1 / 0, Ho = Gi, go = -Gi, Wo = go, za = {
  point: Kc,
  lineStart: Wi,
  lineEnd: Wi,
  polygonStart: Wi,
  ...
  result: function() {
    var r = [[Gi, Ho], [go, Wo]];
    return go = Wo = -(Ho = Gi = 1 / 0), r;
  }
};
function Kc(r, t) {
  r < Gi && (Gi = r), r > go && (go = r), t < Ho && (Ho = t), t > Wo && (Wo = t);
}
Ur();
function zu(r, t, e, n) {
  return function(i, o) {
    var s = t(o), a = i.invert(n[0], n[1]), u = Fu(), l = t(u), c = !1, f, h, g, p = {
      ...
      polygonEnd: function() {
        ...
        var w = jc(f, a);
        h.length ? (c || (o.polygonStart(), c = !0), Bu(h, Jc, w, e, o)) : w && (c || (o.polygonStart(), c = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), h = f = null;
      },
      sphere: function() {
    ...
    function x() {
      ...
      if (g.pop(), f.push(g), g = null, !!A) {
        ...
        A > 1 && w & 2 && M.push(M.pop().concat(M.shift())), h.push(M.filter(Qc));
      }
    }
    return p;
  };
...
function Zc(r) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      te(u - ot) < gt ? (r.point(t, e = (e + s) / 2 > 0 ? Hn : -Hn), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), r.point(o, e), i = 0) : n !== a && u >= ot && (te(t - n) < gt && (t -= n * gt), te(o - a) < gt && (o -= a * gt), e = $c(t, e, o, s), r.point(n, e), r.lineEnd(), r.lineStart(), r.point(a, e), i = 0), r.point(t = o, e = s), n = a;
    },
    lineEnd: function() {
      r.lineEnd(), t = e = NaN;
    },
...
function $c(r, t, e, n) {
  var i, o, s = bt(r - e);
  return te(s) > gt ? zc((bt(t) * (o = Lt(n)) * bt(e) - bt(n) * (i = Lt(t)) * bt(r)) / (i * o * s)) : (t + n) / 2;
}
function tf(r, t, e, n) {
  var i;
  if (r == null)
...
function Uu(r, t, e) {
  ...
  r.scale(150).translate([0, 0]), o != null && r.clipExtent(null), Vc(e, r.stream(za));
...
var Ua = 16, rf = Lt(30 * $e);
function qa(r, t) {
  return +t ? sf(r, t) : of(r);
}
function of(r) {
  return Vu({
    point: function(t, e) {
...
function sf(r, t) {
  function e(n, i, o, s, a, u, l, c, f, h, g, p, y, d) {
    ...
    if (C > 4 * t && y--) {
      var L = s + h, x = a + g, w = u + p, M = qi(L * L + x * x + w * w), B = ai(w /= M), A = te(te(w) - 1) < gt || te(o - f) < gt ? (o + f) / 2 : Fi(x, L), q = r(A, B), j = q[0], P = q[1], X = j - n, R = P - i, Y = I * X - m * R;
      (Y * Y / C > t || te((m * X + I * R) / C - 0.5) > 0.3 || s * h + a * g + u * p < rf) && (e(n, i, o, s, a, u, j, P, A, L /= M, x /= M, w, y, d), d.point(j, P), e(j, P, A, L, x, w, l, c, f, h, g, p, y, d));
    }
  }
  return function(n) {
...
function lf(r) {
  ...
  A.stream = function(R) {
    return M && B === R ? M : M = af(y(h, w(L(B = R))));
  }, A.clipAngle = function(R) {
    return arguments.length ? (y = +R ? ef(p = R * $e, 6 * $e) : (p = null, Va), X()) : p * Ir;
  }, A.clipExtent = function(R) {
    return arguments.length ? (L = R == null ? (d = m = I = C = null, ka) : Wc(d = +R[0][0], m = +R[0][1], I = +R[1][0], C = +R[1][1]), X()) : d == null ? null : [[d, m], [I, C]];
  }, A.scale = function(R) {
    ...
    return arguments.length ? (w = qa(j, x = R * R), X()) : qi(x);
...
function Xu(r) {
  return function(t, e) {
    var n = qi(t * t + e * e), i = r(n), o = bt(i), s = Lt(i);
    return [
      Fi(t * o, n * s),
      ai(n && e * o / n)
    ];
...
var cf = qu(function(r) {
  return qi(2 / (1 + r));
});
cf.invert = Xu(function(r) {
  return 2 * ai(r / 2);
});
...
function ff() {
  return uf(Yu).scale(79.4188).clipAngle(180 - 1e-3);
}
function Xa(r, t) {
  return [r, t];
}
...
function Mo(r, t, e, n) {
  ...
  }, l = new qs(), c = l.read(u), f = vc(yc(t, e), "meters"), h = zt.bufferOp(c, f, n), g = new vu();
...
function gf(r) {
  var t = Cc(r).geometry.coordinates, e = [-t[0], -t[1]];
  return ff().rotate(e).scale(Ee);
}
function pf(r, t) {
...
function df(r, t = !0, e = !0, n = {}, i = {}, o = (s) => {
  ...
  function p(d, m = !1) {
    ...
    return new Ic({ props: { displayIn: "leaflet" }, target: I }), new rr.Marker(d, {
      interactive: m,
      icon: new rr.DivIcon({
        html: I,
        className: "",
...
class vf extends rr.Control {
  ...
  onAdd(e) {
    ...
    const {
      ...
      fullGeometryStyle: a,
      ...u
    } = zn(this, Wr), l = typeof s == "boolean" ? {} : s, c = df(
      e,
      i,
      o,
      l,
...
window.L && typeof window.L == "object" && typeof window.L.control == "function" && (window.L.control.maptilerGeocoding = yf);
export {
  vf as GeocodingControl,
  df as createLeafletMapController
};
