...
var si = (l, u, a) => Pa(l, typeof u != "symbol" ? u + "" : u, a);
import * as Oe from "leaflet";
...
function Ga(l, u) {
  ...
  function w(x) {
    ...
    for (; a; ) try {
      if (f = 1, h && (g = x[0] & 2 ? h.return : x[0] ? h.throw || ((g = h.return) && g.call(h), 0) : h.next) && !(g = g.call(h, x[1])).done) return g;
      switch (h = 0, g && (x = [x[0] & 2, g.value]), x[0]) {
        case 0:
        case 1:
          g = x;
          break;
        ...
        case 7:
          ...
          continue;
        default:
          if (g = a.trys, !(g = g.length > 0 && g[g.length - 1]) && (x[0] === 6 || x[0] === 2)) {
            a = 0;
            continue;
          }
          ...
          if (x[0] === 6 && a.label < g[1]) {
            a.label = g[1], g = x;
            break;
          }
          if (g && a.label < g[2]) {
            a.label = g[2], a.ops.push(x);
            break;
          }
...
function ci(l, u, a, f, h) {
  if (l) {
    f("" + u + (a ? "└── " : "├── ") + h(l) + `
`);
    var g = u + (a ? "    " : "│   ");
    l.left && ci(l.left, g, !1, f, h), l.right && ci(l.right, g, !0, f, h);
  }
}
var Ni = (
  /** @class */
  function() {
    ...
    return l.prototype.insert = function(u, a) {
      return this._size++, this._root = ai(u, a, this._root, this._comparator);
      ...
      if (f && vi(u, a, 0, h - 1, g), this._root === null)
        this._root = fi(u, a, 0, h), this._size = h;
      else {
        var d = Xa(this.toList(), za(u, a), g);
        h = this._size + h, this._root = gi({ head: d }, 0, h);
      }
      return this;
      ...
      var a = [];
      return ci(this._root, "", !0, function(f) {
        return a.push(f);
      }, u), a.join("");
    }, l.prototype.update = function(u, a, f) {
      var h = this._comparator, g = pr(u, this._root, h), d = g.left, p = g.right;
      h(u, a) < 0 ? p = ai(a, f, p, h) : d = ai(a, f, d, h), this._root = Ya(d, p, h);
    }, l.prototype.split = function(u) {
      return pr(u, this._root, this._comparator);
...
function fi(l, u, a, f) {
  ...
  if (h > 0) {
    ...
    return w.left = fi(l, u, a, g), w.right = fi(l, u, g + 1, f), w;
  }
  return null;
}
function za(l, u) {
...
function gi(l, u, a) {
  var f = a - u;
  if (f > 0) {
    var h = u + Math.floor(f / 2), g = gi(l, u, h), d = l.head;
    return d.left = g, l.head = l.head.next, d.right = gi(l, h + 1, a), d;
  }
  return null;
}
function Xa(l, u, a) {
...
function vi(l, u, a, f, h) {
  if (!(a >= f)) {
    ...
    vi(l, u, a, p, h), vi(l, u, p + 1, f, h);
  }
}
const re = 11102230246251565e-32, St = 134217729, Ua = (3 + 8 * re) * re;
function ui(l, u, a, f, h) {
  let g, d, p, w, x = u[0], N = f[0], m = 0, I = 0;
  N > x == N > -x ? (g = x, x = u[++m]) : (g = N, N = f[++I]);
  let _ = 0;
  if (m < l && I < a)
    for (N > x == N > -x ? (d = x + g, p = g - (d - x), x = u[++m]) : (d = N + g, p = g - (d - N), N = f[++I]), g = d, p !== 0 && (h[_++] = p); m < l && I < a; )
      N > x == N > -x ? (d = g + x, w = d - g, p = g - (d - w) + (x - w), x = u[++m]) : (d = g + N, w = d - g, p = g - (d - w) + (N - w), N = f[++I]), g = d, p !== 0 && (h[_++] = p);
  for (; m < l; )
    d = g + x, w = d - g, p = g - (d - w) + (x - w), x = u[++m], g = d, p !== 0 && (h[_++] = p);
  for (; I < a; )
    d = g + N, w = d - g, p = g - (d - w) + (N - w), N = f[++I], g = d, p !== 0 && (h[_++] = p);
  return (g !== 0 || _ === 0) && (h[_++] = g), _;
}
function Va(l, u) {
  let a = u[0];
...
const Ha = (3 + 16 * re) * re, Za = (2 + 12 * re) * re, $a = (9 + 64 * re) * re * re, be = un(4), _r = un(8), xr = un(12), kr = un(16), Tt = un(4);
function ja(l, u, a, f, h, g, d) {
  let p, w, x, N, m, I, _, S, R, O, A, M, b, q, G, B, X, V;
  const U = l - h, st = a - h, et = u - g, rt = f - g;
  q = U * rt, I = St * U, _ = I - (I - U), S = U - _, I = St * rt, R = I - (I - rt), O = rt - R, G = S * O - (q - _ * R - S * R - _ * O), B = et * st, I = St * et, _ = I - (I - et), S = et - _, I = St * st, R = I - (I - st), O = st - R, X = S * O - (B - _ * R - S * R - _ * O), A = G - X, m = G - A, be[0] = G - (A + m) + (m - X), M = q + A, m = M - q, b = q - (M - m) + (A - m), A = b - B, m = b - A, be[1] = b - (A + m) + (m - B), V = M + A, m = V - M, be[2] = M - (V - m) + (A - m), be[3] = V;
  let ut = Va(4, be), z = Za * d;
  if (ut >= z || -ut >= z || (m = l - U, p = l - (U + m) + (m - h), m = a - st, x = a - (st + m) + (m - h), m = u - et, w = u - (et + m) + (m - g), m = f - rt, N = f - (rt + m) + (m - g), p === 0 && w === 0 && x === 0 && N === 0) || (z = $a * d + Ua * Math.abs(ut), ut += U * N + rt * p - (et * x + st * w), ut >= z || -ut >= z)) return ut;
  q = p * rt, I = St * p, _ = I - (I - p), S = p - _, I = St * rt, R = I - (I - rt), O = rt - R, G = S * O - (q - _ * R - S * R - _ * O), B = w * st, I = St * w, _ = I - (I - w), S = w - _, I = St * st, R = I - (I - st), O = st - R, X = S * O - (B - _ * R - S * R - _ * O), A = G - X, m = G - A, Tt[0] = G - (A + m) + (m - X), M = q + A, m = M - q, b = q - (M - m) + (A - m), A = b - B, m = b - A, Tt[1] = b - (A + m) + (m - B), V = M + A, m = V - M, Tt[2] = M - (V - m) + (A - m), Tt[3] = V;
  const nt = ui(4, be, 4, Tt, _r);
  q = U * N, I = St * U, _ = I - (I - U), S = U - _, I = St * N, R = I - (I - N), O = N - R, G = S * O - (q - _ * R - S * R - _ * O), B = et * x, I = St * et, _ = I - (I - et), S = et - _, I = St * x, R = I - (I - x), O = x - R, X = S * O - (B - _ * R - S * R - _ * O), A = G - X, m = G - A, Tt[0] = G - (A + m) + (m - X), M = q + A, m = M - q, b = q - (M - m) + (A - m), A = b - B, m = b - A, Tt[1] = b - (A + m) + (m - B), V = M + A, m = V - M, Tt[2] = M - (V - m) + (A - m), Tt[3] = V;
  const ot = ui(nt, _r, 4, Tt, xr);
  q = p * N, I = St * p, _ = I - (I - p), S = p - _, I = St * N, R = I - (I - N), O = N - R, G = S * O - (q - _ * R - S * R - _ * O), B = w * x, I = St * w, _ = I - (I - w), S = w - _, I = St * x, R = I - (I - x), O = x - R, X = S * O - (B - _ * R - S * R - _ * O), A = G - X, m = G - A, Tt[0] = G - (A + m) + (m - X), M = q + A, m = M - q, b = q - (M - m) + (A - m), A = b - B, m = b - A, Tt[1] = b - (A + m) + (m - B), V = M + A, m = V - M, Tt[2] = M - (V - m) + (A - m), Tt[3] = V;
  const ft = ui(ot, xr, 4, Tt, kr);
  return kr[ft - 1];
}
function Wa(l, u, a, f, h, g) {
  const d = (u - g) * (a - h), p = (l - h) * (f - g), w = d - p, x = Math.abs(d + p);
  return Math.abs(w) >= Ha * x ? w : -ja(l, u, a, f, h, g, x);
}
const Je = (l, u) => l.ll.x <= u.x && u.x <= l.ur.x && l.ll.y <= u.y && u.y <= l.ur.y, yi = (l, u) => {
...
class Ja {
  ...
  reset() {
    this.xRounder = new Ir(), this.yRounder = new Ir();
  }
  round(u, a) {
    return {
...
class Ir {
  ...
  round(u) {
    ...
    if (f !== null && Er(a.key, f.key) === 0)
      return this.tree.remove(u), f.key;
    const h = this.tree.next(a);
    return h !== null && Er(a.key, h.key) === 0 ? (this.tree.remove(u), h.key) : u;
  }
}
const nn = new Ja(), wn = (l, u) => l.x * u.y - l.y * u.x, ns = (l, u) => l.x * u.x + l.y * u.y, Nr = (l, u, a) => {
  const f = Wa(l.x, l.y, u.x, u.y, a.x, a.y);
  return f > 0 ? -1 : f < 0 ? 1 : 0;
}, Cn = (l) => Math.sqrt(ns(l, l)), Ka = (l, u, a) => {
  const f = {
    x: u.x - l.x,
    y: u.y - l.y
  }, h = {
  ...
  if (u.y === 0) return Sr(a, f, l.y);
  if (f.y === 0) return Sr(l, u, a.y);
  const h = wn(u, f);
  if (h == 0) return null;
  const g = {
    x: a.x - l.x,
    y: a.y - l.y
  }, d = wn(g, u) / h, p = wn(g, f) / h, w = l.x + p * u.x, x = a.x + d * f.x, N = l.y + p * u.y, m = a.y + d * f.y, I = (w + x) / 2, _ = (N + m) / 2;
  return {
    x: I,
    y: _
  };
...
class zt {
  ...
  getLeftmostComparator(u) {
    const a = /* @__PURE__ */ new Map(), f = (h) => {
      const g = h.otherSE;
      a.set(h, {
        sine: Ka(this.point, u.point, g.point),
    ...
    return (h, g) => {
      ...
      return d >= 0 && w >= 0 ? p < x ? 1 : p > x ? -1 : 0 : d < 0 && w < 0 ? p < x ? -1 : p > x ? 1 : 0 : w < d ? -1 : w > d ? 1 : 0;
    };
  }
}
let nu = 0;
class ce {
  ...
  static compare(u, a) {
    ...
    if (d < f) return 1;
    if (g < h) return -1;
    const p = u.leftSE.point.y, w = a.leftSE.point.y, x = u.rightSE.point.y, N = a.rightSE.point.y;
    if (f < h) {
      if (w < p && w < x) return 1;
      if (w > p && w > x) return -1;
    ...
    if (g !== d) {
      const m = x - p, I = g - f, _ = N - w, S = d - h;
      if (m > I && _ < S) return 1;
      if (m < I && _ > S) return -1;
    }
    return g > d ? 1 : g < d || x < N ? -1 : x > N ? 1 : u.id < a.id ? -1 : u.id > a.id ? 1 : 0;
  }
  ...
  static fromRing(u, a, f) {
    ...
    const w = new zt(h, !0), x = new zt(g, !1);
    return new ce(w, x, [f], [d]);
  }
   ...
   */
  getIntersection(u) {
    const a = this.bbox(), f = u.bbox(), h = yi(a, f);
    if (h === null) return null;
    const g = this.leftSE.point, d = this.rightSE.point, p = u.leftSE.point, w = u.rightSE.point, x = Je(a, p) && this.comparePoint(p) === 0, N = Je(f, g) && u.comparePoint(g) === 0, m = Je(a, w) && this.comparePoint(w) === 0, I = Je(f, d) && u.comparePoint(d) === 0;
    if (N && x)
    ...
    if (I) return d;
    if (m) return w;
    const _ = eu(g, this.vector(), p, u.vector());
    return _ === null || !Je(h, _) ? null : nn.round(_.x, _.y);
  }
  /**
  ...
  consume(u) {
    ...
    if (h !== 0) {
      ...
      for (let g = 0, d = f.rings.length; g < d; g++) {
        const p = f.rings[g], w = f.windings[g], x = a.rings.indexOf(p);
        x === -1 ? (a.rings.push(p), a.windings.push(w)) : a.windings[x] += w;
      }
  ...
  afterState() {
    ...
    for (let p = 0, w = this.rings.length; p < w; p++) {
      const x = this.rings[p], N = this.windings[p], m = a.indexOf(x);
      m === -1 ? (a.push(x), f.push(N)) : f[m] += N;
    }
    const g = [], d = [];
    for (let p = 0, w = a.length; p < w; p++) {
      if (f[p] === 0) continue;
      const x = a[p], N = x.poly;
      if (d.indexOf(N) === -1)
        if (x.isExterior) g.push(N);
        else {
          d.indexOf(N) === -1 && d.push(N);
          const m = g.indexOf(x.poly);
          m !== -1 && g.splice(m, 1);
        }
    }
    for (let p = 0, w = g.length; p < w; p++) {
      const x = g[p].multiPoly;
...
class iu {
  constructor(u, a) {
    if (!Array.isArray(u))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new Lr(u[0], this, !0), this.bbox = {
      ll: {
...
class Rn {
  ...
  static factory(u) {
    ...
    for (let f = 0, h = u.length; f < h; f++) {
      ...
      const x = [p], N = p.point, m = [];
      for (; d = p, p = w, x.push(p), p.point !== N; )
        for (; ; ) {
          const I = p.getAvailableLinkedEvents();
          if (I.length === 0) {
            const R = x[0].point, O = x[x.length - 1].point;
            throw new Error(`Unable to complete output ring starting at [${R.x}, ${R.y}]. Last matching segment found ends at [${O.x}, ${O.y}].`);
          }
          if (I.length === 1) {
            w = I[0].otherSE;
            break;
          ...
          for (let R = 0, O = m.length; R < O; R++)
            if (m[R].point === p.point) {
              _ = R;
              break;
            }
          if (_ !== null) {
            const R = m.splice(_)[0], O = x.splice(R.index);
            O.unshift(O[0].otherSE), a.push(new Rn(O.reverse()));
            continue;
          }
          m.push({
            index: x.length,
  ...
  getGeom() {
    ...
    const a = [u];
    for (let x = 1, N = this.events.length - 1; x < N; x++) {
      const m = this.events[x].point, I = this.events[x + 1].point;
      Nr(m, u, I) !== 0 && (a.push(m), u = m);
    }
    if (a.length === 1) return null;
    const f = a[0], h = a[1];
    Nr(f, u, h) === 0 && a.shift(), a.push(a[0]);
    const g = this.isExteriorRing() ? 1 : -1, d = this.isExteriorRing() ? 0 : a.length - 1, p = this.isExteriorRing() ? a.length : -1, w = [];
    for (let x = d; x != p; x += g) w.push([a[x].x, a[x].y]);
    return w;
  }
  isExteriorRing() {
...
class ru {
  ...
  _composePolys(u) {
    ...
    for (let f = 0, h = u.length; f < h; f++) {
      const g = u[f];
      if (!g.poly)
        if (g.isExteriorRing()) a.push(new Cr(g));
        else {
          const d = g.enclosingRing();
          d.poly || a.push(new Cr(d)), d.poly.addInterior(g);
        }
    }
    return a;
  }
...
class su {
  constructor(u) {
    ...
    this.queue = u, this.tree = new Ni(a), this.segments = [];
  }
  process(u) {
    const a = u.segment, f = [];
    if (u.consumedBy)
    ...
    if (u.isLeft) {
      ...
      if (x !== null || N !== null) {
        let m = null;
        x === null ? m = N : N === null ? m = x : m = zt.comparePoints(x, N) <= 0 ? x : N, this.queue.remove(a.rightSE), f.push(a.rightSE);
        const I = a.split(m);
        for (let _ = 0, S = I.length; _ < S; _++)
          f.push(I[_]);
      }
      ...
      if (p && w) {
        const x = p.getIntersection(w);
        if (x !== null) {
          if (!p.isAnEndpoint(x)) {
            const N = this._splitSafely(p, x);
            for (let m = 0, I = N.length; m < I; m++)
              f.push(N[m]);
          }
          if (!w.isAnEndpoint(x)) {
            const N = this._splitSafely(w, x);
            for (let m = 0, I = N.length; m < I; m++)
              f.push(N[m]);
          }
        }
...
const Rr = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, au = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6;
class uu {
  run(u, a, f) {
    Vt.type = u, nn.reset();
    const h = [new Tr(a, !0)];
    ...
    if (Vt.numMultiPolys = h.length, Vt.type === "difference") {
      ...
      let I = 1;
      for (; I < h.length; )
        yi(h[I].bbox, m.bbox) !== null ? I++ : h.splice(I, 1);
    }
    if (Vt.type === "intersection")
      for (let m = 0, I = h.length; m < I; m++) {
        const _ = h[m];
        for (let S = m + 1, R = h.length; S < R; S++)
          if (yi(_.bbox, h[S].bbox) === null) return [];
      }
    const g = new Ni(zt.compare);
    for (let m = 0, I = h.length; m < I; m++) {
      const _ = h[m].getSweepEvents();
      for (let S = 0, R = _.length; S < R; S++)
        if (g.insert(_[S]), g.size > Rr)
    ...
    for (; w; ) {
      ...
      if (g.size === p) {
        const _ = m.segment;
        throw new Error(`Unable to pop() ${m.isLeft ? "left" : "right"} SweepEvent [${m.point.x}, ${m.point.y}] from segment #${_.id} [${_.leftSE.point.x}, ${_.leftSE.point.y}] -> [${_.rightSE.point.x}, ${_.rightSE.point.y}] from queue.`);
      }
      if (g.size > Rr)
    ...
    nn.reset();
    const x = Rn.factory(d.segments);
    return new ru(x).getGeom();
  }
}
...
function rs(l, u, a) {
  if (l !== null)
    for (var f, h, g, d, p, w, x, N = 0, m = 0, I, _ = l.type, S = _ === "FeatureCollection", R = _ === "Feature", O = S ? l.features.length : 1, A = 0; A < O; A++) {
      x = S ? l.features[A].geometry : R ? l.geometry : l, I = x ? x.type === "GeometryCollection" : !1, p = I ? x.geometries.length : 1;
      for (var M = 0; M < p; M++) {
        var b = 0, q = 0;
        if (d = I ? x.geometries[M] : x, d !== null) {
          w = d.coordinates;
          var G = d.type;
          switch (N = 0, G) {
            case null:
            ...
            case "MultiLineString":
              for (f = 0; f < w.length; f++) {
                ...
                G === "MultiLineString" && b++, G === "Polygon" && q++;
              }
              G === "Polygon" && b++;
              break;
            case "MultiPolygon":
              for (f = 0; f < w.length; f++) {
                for (q = 0, h = 0; h < w[f].length; h++) {
...
function Dn(l, u) {
  var a, f, h, g, d, p, w, x, N, m, I = 0, _ = l.type === "FeatureCollection", S = l.type === "Feature", R = _ ? l.features.length : 1;
  for (a = 0; a < R; a++) {
    for (p = _ ? l.features[a].geometry : S ? l.geometry : l, x = _ ? l.features[a].properties : S ? l.properties : {}, N = _ ? l.features[a].bbox : S ? l.bbox : void 0, m = _ ? l.features[a].id : S ? l.id : void 0, w = p ? p.type === "GeometryCollection" : !1, d = w ? p.geometries.length : 1, h = 0; h < d; h++) {
...
function fu(l, u = {}) {
  ...
  return f.length === 0 ? null : f.length === 1 ? Ii(f[0], u.properties) : es(f, u.properties);
}
var gu = fu;
function rn() {
}
...
const Pe = [], Pr = [];
let Ae = [];
const Ar = [], _u = /* @__PURE__ */ Promise.resolve();
let mi = !1;
function xu() {
  mi || (mi = !0, _u.then(os));
}
...
function os() {
  ...
  do {
    ...
    for (en(null), Pe.length = 0, Me = 0; Pr.length; ) Pr.pop()();
...
function ku(l) {
  if (l.fragment !== null) {
    l.update(), Fn(l.before_update);
    const u = l.dirty;
    l.dirty = [-1], l.fragment && l.fragment.p(l.ctx, u), l.after_update.forEach(di);
  }
}
function Eu(l) {
  const u = [], a = [];
...
function Su(l, u, a) {
  ...
  f && f.m(u, a), di(() => {
    ...
    l.$$.on_destroy ? l.$$.on_destroy.push(...g) : Fn(g), l.$$.on_mount = [];
  }), h.forEach(di);
}
function wu(l, u) {
  const a = l.$$;
  a.fragment !== null && (Eu(a.after_update), Fn(a.on_destroy), a.fragment && a.fragment.d(u), a.on_destroy = a.fragment = null, a.ctx = []);
}
function Lu(l, u) {
...
function Tu(l, u, a, f, h, g, d = null, p = [-1]) {
  ...
  d && d(x.root);
  let N = !1;
  if (x.ctx = a ? a(l, u.props || {}, (m, I, ..._) => {
    const S = _.length ? _[0] : I;
    return x.ctx && h(x.ctx[m], x.ctx[m] = S) && (!x.skip_bound && x.bound[m] && x.bound[m](S), N && Lu(l, m)), I;
  }) : [], x.update(), N = !0, Fn(x.before_update), x.fragment = f ? f(x.ctx) : !1, u.target) {
    if (u.hydrate) {
      const m = pu(u.target);
      x.fragment && x.fragment.l(m), m.forEach(us);
    } else
      x.fragment && x.fragment.c();
    u.intro && Nu(l.$$.fragment), Su(l, u.target, u.anchor), os();
  }
  en(w);
}
class Cu {
...
(function(l, u) {
  (function(a, f) {
    ...
    function x(r, t, e) {
      return x = w() ? Reflect.construct : function(n, i, s) {
        var o = [null];
        o.push.apply(o, i);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    b.CAP_ROUND = 1, b.CAP_FLAT = 2, b.CAP_SQUARE = 3, b.JOIN_ROUND = 1, b.JOIN_MITRE = 2, b.JOIN_BEVEL = 3, b.DEFAULT_QUADRANT_SEGMENTS = 8, b.DEFAULT_MITRE_LIMIT = 5, b.DEFAULT_SIMPLIFY_FACTOR = 0.01;
    var q = function(r) {
      g(e, r);
      var t = _(e);
      function e(n) {
    ...
    var Et = function(r) {
    ...
    }(), Kt = new ArrayBuffer(8), Ss = new Float64Array(Kt), wi = new Int32Array(Kt), T = function() {
      function r() {
        a(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getM", value: function() {
        ...
        switch (t) {
          ...
          case r.Z:
            ...
            break;
          default:
            throw new G("Invalid ordinate index: " + t);
        }
      ...
      return h(r, [{ key: "compare", value: function(t, e) {
        ...
        if (this._dimensionsToTest = 2, arguments.length === 0) r.constructor_.call(this, 2);
          ...
          var t = arguments[0];
          if (t !== 2 && t !== 3) throw new G("only 2 or 3 dimensions may be specified");
    ...
    T.DimensionalComparator = ws, T.NULL_ORDINATE = H.NaN, T.X = 0, T.Y = 1, T.Z = 2, T.M = 3;
    var vt = function() {
      function r() {
        a(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getArea", value: function() {
        ...
        if (arguments.length === 4) {
          var i = arguments[0], s = arguments[1], o = arguments[2], c = arguments[3], v = Math.min(o.x, c.x), y = Math.max(o.x, c.x), E = Math.min(i.x, s.x), L = Math.max(i.x, s.x);
          return !(E > y) && !(L < v) && (v = Math.min(o.y, c.y), y = Math.max(o.y, c.y), E = Math.min(i.y, s.y), L = Math.max(i.y, s.y), !(E > y) && !(L < v));
        }
      } }]), r;
    }(), $ = function() {
      function r() {
      ...
      return h(r, [{ key: "isGeometryCollection", value: function() {
        ...
        if (t.getTypeCode() === r.TYPECODE_GEOMETRYCOLLECTION) throw new G("This method does not support GeometryCollection arguments");
    ...
    var k = function() {
      ...
      return h(r, null, [{ key: "toLocationSymbol", value: function(t) {
        ...
        throw new G("Unknown location value: " + t);
      } }]), r;
    }();
    k.INTERIOR = 0, k.BOUNDARY = 1, k.EXTERIOR = 2, k.NONE = -1;
    var Ht = function() {
      function r() {
        a(this, r);
      }
    ...
    }(Li, Symbol.iterator), Ls = function() {
      function r(t) {
    ...
    var Ti = function(r) {
      ...
      return h(e, [{ key: "add", value: function(n) {
        ...
        if (n < 0 || n >= this.size()) throw new Ci();
        return this.array[n];
    ...
    var ze = function() {
      ...
      return h(r, [{ key: "le", value: function(t) {
        ...
        for (var o = i + 1, c = new ze(), v = r.MAX_PRINT_DIGITS - 1, y = 0; y <= v; y++) {
          t && y === o && c.append(".");
          var E = Math.trunc(n._hi);
          if (E < 0) break;
          var L = !1, C = 0;
          E > 9 ? (L = !0, C = "9") : C = "0" + E, c.append(C), n = n.subtract(r.valueOf(E)).multiply(r.TEN), L && n.selfAdd(r.TEN);
          var D = !0, P = r.magnitude(n._hi);
          if (P < 0 && Math.abs(P) >= v - y && (D = !1), !D) break;
        }
        ...
        if (arguments.length === 1) {
          ...
          var n = arguments[0], i = arguments[1], s = null, o = null, c = null, v = null, y = null, E = null, L = null, C = null;
          return y = this._hi / n, C = (s = (E = r.SPLIT * y) - (s = E - y)) * (c = (C = r.SPLIT * n) - (c = C - n)) - (L = y * n) + s * (v = n - c) + (o = y - s) * c + o * v, C = y + (E = (this._hi - L - C + this._lo - y * i) / n), this._hi = C, this._lo = y - C + E, this;
        }
        ...
        if (arguments[0] instanceof r) {
          ...
          var E = y = o + (c = (this._hi - v - y + this._lo - o * t._lo) / t._hi), L = o - y + c;
          return new r(E, L);
        }
        if (typeof arguments[0] == "number") {
          var C = arguments[0];
        ...
        if (arguments.length === 1) {
          ...
          var y = arguments[0], E = arguments[1], L = null, C = null, D = null, P = null, Z = null, j = null, K = null;
          P = this._hi + y, C = this._lo + E, Z = P - (j = P - this._hi), D = C - (K = C - this._lo);
          var ct = (L = P + (j = (Z = y - j + (this._hi - Z)) + C)) + (j = (D = E - K + (this._lo - D)) + (j + (P - L))), mt = j + (L - ct);
        ...
        if (arguments.length === 1) {
          ...
          var n = arguments[0], i = arguments[1], s = null, o = null, c = null, v = null, y = null, E = null;
          s = (y = r.SPLIT * this._hi) - this._hi, E = r.SPLIT * n, s = y - s, o = this._hi - s, c = E - n;
          var L = (y = this._hi * n) + (E = s * (c = E - c) - y + s * (v = n - c) + o * c + o * v + (this._hi * i + this._lo * n)), C = E + (s = y - L);
        ...
        for (var e = 0, n = t.length; qn.isWhitespace(t.charAt(e)); ) e++;
        var i = !1;
        if (e < n) {
          var s = t.charAt(e);
          s !== "-" && s !== "+" || (e++, s === "-" && (i = !0));
        }
        for (var o = new r(), c = 0, v = 0, y = 0, E = !1; !(e >= n); ) {
          var L = t.charAt(e);
          if (e++, qn.isDigit(L)) {
            var C = L - "0";
            ...
            if (L !== ".") {
              if (L === "e" || L === "E") {
                ...
                try {
                  ...
                  throw ct instanceof NumberFormatException ? new NumberFormatException("Invalid exponent " + D + " in string " + t) : ct;
                }
                break;
              }
        ...
        for (var n = new ze(), i = 0; i < e; i++) n.append(t);
        return n.toString();
      } }]), r;
    }();
    ...
    var J = function() {
      ...
      return h(r, null, [{ key: "index", value: function(t, e, n) {
        return Yn.orientationIndex(t, e, n);
      } }, { key: "isCCW", value: function() {
        if (arguments[0] instanceof Array) {
          var t = arguments[0], e = t.length - 1;
          if (e < 3) throw new G("Ring has fewer than 4 points, so orientation cannot be determined");
          ...
          var y = t[c], E = t[v];
          if (y.equals2D(n) || E.equals2D(n) || y.equals2D(E)) return !1;
          var L = r.index(y, n, E), C = null;
          return C = L === 0 ? y.x > E.x : L > 0, C;
        }
        if (tt(arguments[0], at)) {
          var D = arguments[0], P = D.size() - 1;
          if (P < 3) throw new G("Ring has fewer than 4 points, so orientation cannot be determined");
          for (var Z = D.getCoordinate(0), j = 0, K = 1; K <= P; K++) {
            var ct = D.getCoordinate(K);
            ct.y > Z.y && (Z = ct, j = K);
          }
          var mt = null, Nt = j;
          do
            (Nt -= 1) < 0 && (Nt = P), mt = D.getCoordinate(Nt);
          while (mt.equals2D(Z) && Nt !== j);
          var Pt = null, Ut = j;
          do
            Ut = (Ut + 1) % P, Pt = D.getCoordinate(Ut);
    ...
    J.CLOCKWISE = -1, J.RIGHT = J.CLOCKWISE, J.COUNTERCLOCKWISE = 1, J.LEFT = J.COUNTERCLOCKWISE, J.COLLINEAR = 0, J.STRAIGHT = J.COLLINEAR;
    var Cs = function() {
      function r() {
        a(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getCoordinate", value: function() {
        ...
        var e = t[this._minIndex - 1], n = t[this._minIndex + 1], i = J.index(this._minCoord, n, e), s = !1;
        (e.y < this._minCoord.y && n.y < this._minCoord.y && i === J.COUNTERCLOCKWISE || e.y > this._minCoord.y && n.y > this._minCoord.y && i === J.CLOCKWISE) && (s = !0), s && (this._minIndex = this._minIndex - 1);
      } }, { key: "getRightmostSideOfSegment", value: function(t, e) {
        var n = t.getEdge().getCoordinates();
        if (e < 0 || e + 1 >= n.length || n[e].y === n[e + 1].y) return -1;
        var i = F.LEFT;
        return n[e].y < n[e + 1].y && (i = F.RIGHT), i;
      ...
      return h(n, [{ key: "interfaces_", get: function() {
        ...
        if (i < 0 || i >= this.size()) throw new Ci();
        return this.array[i];
      } }, { key: "isEmpty", value: function() {
        return this.array.length === 0;
      ...
      return h(r, [{ key: "next", value: function() {
        if (this.position === this.arrayList.size()) throw new on();
      ...
      return h(r, [{ key: "clearVisitedEdges", value: function() {
        ...
        e.getNode(), e.getLabel(), e.setEdgeDepths(F.RIGHT, t), this.copySymDepths(e), this.computeDepths(e);
      } }, { key: "create", value: function(t) {
        this.addReachable(t), this._finder.findEdge(this._dirEdgeList), this._rightMostCoord = this._finder.getCoordinate();
      } }, { key: "findResultEdges", value: function() {
        for (var t = this._dirEdgeList.iterator(); t.hasNext(); ) {
          var e = t.next();
          e.getDepth(F.RIGHT) >= 1 && e.getDepth(F.LEFT) <= 0 && !e.isInteriorAreaEdge() && e.setInResult(!0);
        }
      } }, { key: "computeDepths", value: function(t) {
        var e = new Gn(), n = new Rs(), i = t.getNode();
        ...
        var e = t.getSym();
        e.setDepth(F.LEFT, t.getDepth(F.RIGHT)), e.setDepth(F.RIGHT, t.getDepth(F.LEFT));
      ...
      return h(r, null, [{ key: "intersection", value: function(t, e, n, i) {
        var s = t.x < e.x ? t.x : e.x, o = t.y < e.y ? t.y : e.y, c = t.x > e.x ? t.x : e.x, v = t.y > e.y ? t.y : e.y, y = n.x < i.x ? n.x : i.x, E = n.y < i.y ? n.y : i.y, L = n.x > i.x ? n.x : i.x, C = n.y > i.y ? n.y : i.y, D = ((s > y ? s : y) + (c < L ? c : L)) / 2, P = ((o > E ? o : E) + (v < C ? v : C)) / 2, Z = t.x - D, j = t.y - P, K = e.x - D, ct = e.y - P, mt = n.x - D, Nt = n.y - P, Pt = i.x - D, Ut = i.y - P, ie = j - ct, ke = K - Z, We = Z * ct - K * j, Qe = Nt - Ut, Re = Pt - mt, yr = mt * Ut - Pt * Nt, mr = ie * Re - Qe * ke, ii = (ke * yr - Re * We) / mr, ri = (Qe * We - ie * yr) / mr;
        return H.isNaN(ii) || H.isInfinite(ii) || H.isNaN(ri) || H.isInfinite(ri) ? null : new T(ii + D, ri + P);
      } }]), r;
    }(), At = function() {
      function r() {
        a(this, r);
...
` }[t];
    ...
    var Zt = function() {
      ...
      return h(r, null, [{ key: "segmentToSegment", value: function(t, e, n, i) {
        ...
        return s ? Be.min(r.pointToSegment(t, n, i), r.pointToSegment(e, n, i), r.pointToSegment(n, t, e), r.pointToSegment(i, t, e)) : 0;
        ...
        if (e.length === 0) throw new G("Line array must contain at least one vertex");
      ...
      return h(r, null, [{ key: "ofLine", value: function(t) {
        ...
        for (var s = i.x, o = i.y, c = 1; c < e; c++) {
          t.getCoordinate(c, i);
          var v = i.x, y = i.y, E = v - s, L = y - o;
          n += Math.sqrt(E * E + L * L), s = v, o = y;
        }
        return n;
      } }]), r;
    }(), Oi = function r() {
      ...
      return h(r, null, [{ key: "copyCoord", value: function(t, e, n, i) {
        ...
        if (arguments.length === 2) {
          ...
          if (y <= 0) return null;
          for (var E = o.copy(), L = v ? o.size() - 1 : o.size(), C = 0; C < L; C++) for (var D = 0; D < o.getDimension(); D++) o.setOrdinate(C, D, E.getOrdinate((c + C) % L, D));
          if (v) for (var P = 0; P < o.getDimension(); P++) o.setOrdinate(L, P, o.getOrdinate(0, P));
        }
      ...
      return h(r, null, [{ key: "toDimensionSymbol", value: function(t) {
        ...
        throw new G("Unknown dimension value: " + t);
      } }, { key: "toDimensionValue", value: function(t) {
        switch (qn.toUpperCase(t)) {
          case r.SYM_FALSE:
            return r.FALSE;
          case r.SYM_TRUE:
            return r.TRUE;
        ...
        throw new G("Unknown dimension symbol: " + t);
      } }]), r;
    }();
    ...
    var cn = function() {
      ...
      return h(e, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        return S(d(e.prototype), "equalsExact", this).apply(this, arguments);
        ...
        if (arguments.length === 2) {
          var v = arguments[0], y = arguments[1], E = v;
          return y.compare(this._points, E._points);
        }
      } }, { key: "apply", value: function() {
        if (tt(arguments[0], hn)) for (var n = arguments[0], i = 0; i < this._points.size(); i++) n.filter(this._points.getCoordinate(i));
        else if (tt(arguments[0], fn)) {
          var s = arguments[0];
      ...
      return h(r, null, [{ key: "ofRing", value: function() {
        ...
        if (tt(arguments[0], at)) {
          ...
          if (y < 3) return 0;
          var E = new T(), L = new T(), C = new T();
          v.getCoordinate(0, L), v.getCoordinate(1, C);
          var D = L.x;
          C.x -= D;
          for (var P = 0, Z = 1; Z < y - 1; Z++) E.y = L.y, L.x = C.x, L.y = C.y, v.getCoordinate(Z + 1, C), C.x -= D, P += L.x * (E.y - C.y);
          return P / 2;
        }
      } }]), r;
    }(), me = function() {
      ...
      return h(r, null, [{ key: "sort", value: function() {
        ...
        if (arguments.length === 1) e.sort(function(D, P) {
          return D.compareTo(P);
        });
        else if (arguments.length === 2) e.sort(function(D, P) {
          return t[1].compare(D, P);
        });
        else if (arguments.length === 3) {
      ...
      return h(e, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        var n = 0;
        n += Mi.ofRing(this._shell.getCoordinateSequence());
        for (var i = 0; i < this._holes.length; i++) n -= Mi.ofRing(this._holes[i].getCoordinateSequence());
        return n;
      } }, { key: "copyInternal", value: function() {
        ...
        for (var v = n.getX(0), y = n.getY(0), E = 1; E <= 4; E++) {
          var L = n.getX(E), C = n.getY(E);
          if (L !== v == (C !== y)) return !1;
          v = L, y = C;
        }
        return !0;
        ...
        if (arguments.length === 0) {
          ...
          ye.scroll(o, c, !0), J.isCCW(o) === s && ye.reverse(o);
        }
      } }, { key: "getCoordinate", value: function() {
        ...
        if (arguments.length === 2) {
          var o = arguments[0], c = arguments[1], v = o, y = this._shell, E = v._shell, L = y.compareToSameClass(E, c);
          if (L !== 0) return L;
          for (var C = this.getNumInteriorRing(), D = v.getNumInteriorRing(), P = 0; P < C && P < D; ) {
            var Z = this.getInteriorRingN(P), j = v.getInteriorRingN(P), K = Z.compareToSameClass(j, c);
            if (K !== 0) return K;
            P++;
          }
          return P < C ? 1 : P < D ? -1 : 0;
        }
      } }, { key: "apply", value: function() {
        if (tt(arguments[0], hn)) {
          var n = arguments[0];
        ...
        var n = arguments[0], i = arguments[1], s = arguments[2];
        if ($.constructor_.call(this, s), n === null && (n = this.getFactory().createLinearRing()), i === null && (i = []), $.hasNullElements(i)) throw new G("holes must not contain null elements");
        if (n.isEmpty() && $.hasNonEmptyElements(i)) throw new G("shell is empty but holes are not");
      ...
      return h(r, [{ key: "next", value: function() {
        if (this.position === this.array.length) throw new on();
      ...
      return h(e, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        if (arguments.length === 1) {
          var n = arguments[0], i = new Ai(me.asList(this._geometries)), s = new Ai(me.asList(n._geometries));
          return this.compare(i, s);
        }
        if (arguments.length === 2) {
          for (var o = arguments[0], c = arguments[1], v = o, y = this.getNumGeometries(), E = v.getNumGeometries(), L = 0; L < y && L < E; ) {
            var C = this.getGeometryN(L), D = v.getGeometryN(L), P = C.compareToSameClass(D, c);
            if (P !== 0) return P;
            L++;
          }
          return L < y ? 1 : L < E ? -1 : 0;
        }
      } }, { key: "apply", value: function() {
        if (tt(arguments[0], hn)) for (var n = arguments[0], i = 0; i < this._geometries.length; i++) this._geometries[i].apply(n);
        else if (tt(arguments[0], fn)) {
          var s = arguments[0];
          ...
          var y = arguments[0];
          y.filter(this);
          for (var E = 0; E < this._geometries.length; E++) this._geometries[E].apply(y);
        }
      } }, { key: "getBoundary", value: function() {
        ...
        if (this._geometries = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var n = arguments[0], i = arguments[1];
            if ($.constructor_.call(this, i), n === null && (n = []), $.hasNullElements(n)) throw new G("geometries must not contain null elements");
            this._geometries = n;
          }
        }
      } }]), e;
      ...
      return h(e, [{ key: "copyInternal", value: function() {
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof $) {
          var n = arguments[0], i = arguments[1];
          return !!this.isEquivalentClass(n) && S(d(e.prototype), "equalsExact", this).call(this, n, i);
        }
        return S(d(e.prototype), "equalsExact", this).apply(this, arguments);
      } }, { key: "getCoordinate", value: function() {
        ...
        return S(d(e.prototype), "getCoordinate", this).apply(this, arguments);
      } }, { key: "getBoundaryDimension", value: function() {
        return Y.FALSE;
      } }, { key: "getTypeCode", value: function() {
      ...
      return h(e, [{ key: "copyInternal", value: function() {
        ...
        return !!this.isEmpty() || S(d(e.prototype), "isClosed", this).call(this);
      } }, { key: "reverseInternal", value: function() {
        var n = this._points.copy();
        ...
        if (!this.isEmpty() && !S(d(e.prototype), "isClosed", this).call(this)) throw new G("Points of LinearRing do not form a closed linestring");
        if (this.getCoordinateSequence().size() >= 1 && this.getCoordinateSequence().size() < e.MINIMUM_VALID_SIZE) throw new G("Invalid number of points in LinearRing (found " + this.getCoordinateSequence().size() + " - must be 0 or >= 4)");
      } }, { key: "getGeometryType", value: function() {
        return $.TYPENAME_LINEARRING;
      } }], [{ key: "constructor_", value: function() {
        var n = arguments[0], i = arguments[1];
        Xe.constructor_.call(this, n, i), this.validateConstruction();
      } }]), e;
    }(Xe);
    Ue.MINIMUM_VALID_SIZE = 4;
    var de = function(r) {
      g(e, r);
      var t = _(e);
      function e() {
    ...
    var Un = function(r) {
      ...
      return h(r, null, [{ key: "measures", value: function(t) {
        return t instanceof de ? 0 : t instanceof pe || t instanceof Un ? 1 : 0;
      } }, { key: "dimension", value: function(t) {
        return t instanceof de ? 2 : t instanceof pe ? 3 : t instanceof Un ? 4 : 3;
        ...
        if (arguments.length === 2) {
          var e = arguments[0], n = arguments[1];
          return e === 2 ? new de() : e === 3 && n === 0 ? new T() : e === 3 && n === 1 ? new pe() : e === 4 && n === 1 ? new Un() : new T();
        }
      } }]), r;
    }(), Ve = function(r) {
      g(e, r);
      ...
      return h(e, [{ key: "getCoordinate", value: function(n) {
        ...
        return S(d(e.prototype), "addAll", this).apply(this, arguments);
      } }, { key: "clone", value: function() {
        for (var n = S(d(e.prototype), "clone", this).call(this), i = 0; i < this.size(); i++) n.add(i, this.get(i).clone());
        return n;
      } }, { key: "toCoordinateArray", value: function() {
        ...
        if (arguments.length === 1) {
          var n = arguments[0];
          return S(d(e.prototype), "add", this).call(this, n);
        }
        if (arguments.length === 2) {
          ...
          if (arguments[0] instanceof T && typeof arguments[1] == "boolean") {
            ...
            S(d(e.prototype), "add", this).call(this, o);
          } else if (arguments[0] instanceof Object && typeof arguments[1] == "boolean") {
            var y = arguments[0], E = arguments[1];
            return this.add(y, E), !0;
          }
        } else if (arguments.length === 3) {
          if (typeof arguments[2] == "boolean" && arguments[0] instanceof Array && typeof arguments[1] == "boolean") {
            var L = arguments[0], C = arguments[1], D = arguments[2];
            if (D) for (var P = 0; P < L.length; P++) this.add(L[P], C);
            else for (var Z = L.length - 1; Z >= 0; Z--) this.add(L[Z], C);
            return !0;
          }
          if (typeof arguments[2] == "boolean" && Number.isInteger(arguments[0]) && arguments[1] instanceof T) {
            var j = arguments[0], K = arguments[1], ct = arguments[2];
            if (!ct) {
              var mt = this.size();
              if (mt > 0) {
                if (j > 0) {
                  var Nt = this.get(j - 1);
                  if (Nt.equals2D(K)) return null;
                }
                if (j < mt) {
                  var Pt = this.get(j);
                  if (Pt.equals2D(K)) return null;
                }
              }
            }
            S(d(e.prototype), "add", this).call(this, j, K);
          }
        } else if (arguments.length === 4) {
          var Ut = arguments[0], ie = arguments[1], ke = arguments[2], We = arguments[3], Qe = 1;
          ke > We && (Qe = -1);
          for (var Re = ke; Re !== We; Re += Qe) this.add(Ut[Re], ie);
          return !0;
        }
    ...
    Ve.coordArrayType = new Array(0).fill(null);
    var _t = function() {
      function r() {
        a(this, r);
      }
      return h(r, null, [{ key: "isRing", value: function(t) {
        ...
        for (var n = new Ve(), i = 0; i < t.length; i++) e.intersects(t[i]) && n.add(t[i], !0);
        ...
        return r.hasRepeatedPoints(t) ? new Ve(t, !1).toCoordinateArray() : t;
      } }, { key: "reverse", value: function(t) {
        ...
        e = Be.clamp(e, 0, t.length);
        var i = (n = Be.clamp(n, -1, t.length)) - e + 1;
    ...
    var yn = function() {
      ...
      return h(r, [{ key: "getM", value: function(t) {
        ...
        return vn.create(this.getDimension(), this.getMeasures());
      } }, { key: "getDimension", value: function() {
        ...
        if (this._coordinates.length > 0) {
          var t = new yn(17 * this._coordinates.length);
        ...
        if (this._dimension = 3, this._measures = 0, this._coordinates = null, arguments.length === 1) {
          ...
          if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            ...
            for (var E = 0; E < v; E++) this._coordinates[E] = vn.create(y);
          }
        } else if (arguments.length === 3) {
          if (Number.isInteger(arguments[2]) && arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            var L = arguments[0], C = arguments[1], D = arguments[2];
            this._dimension = C, this._measures = D, this._coordinates = L === null ? new Array(0).fill(null) : L;
          } else if (Number.isInteger(arguments[2]) && Number.isInteger(arguments[0]) && Number.isInteger(arguments[1])) {
            var P = arguments[0], Z = arguments[1], j = arguments[2];
            this._coordinates = new Array(P).fill(null), this._dimension = Z, this._measures = j;
            for (var K = 0; K < P; K++) this._coordinates[K] = this.createCoordinate();
          }
        }
      } }]), r;
    }(), Vn = function() {
      ...
      return h(r, [{ key: "readResolve", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          if (arguments.length === 2) {
            var n = arguments[0], i = arguments[1];
            return i > 3 && (i = 3), i < 2 && (i = 2), new He(n, i);
          }
          if (arguments.length === 3) {
            var s = arguments[0], o = arguments[1], c = arguments[2], v = o - c;
            return c > 1 && (c = 1), v > 3 && (v = 3), v < 2 && (v = 2), new He(s, v + c, c);
          }
        }
      } }, { key: "interfaces_", get: function() {
        return [Ri, U];
    ...
    Ie.nameToTypeMap = new Gs(), Bt.Type = Ie, Bt.FIXED = new Ie("FIXED"), Bt.FLOATING = new Ie("FLOATING"), Bt.FLOATING_SINGLE = new Ie("FLOATING SINGLE"), Bt.maximumPreciseValue = 9007199254740992;
    var Zn = function(r) {
      g(e, r);
      var t = _(e);
      function e() {
      ...
      return h(r, [{ key: "createEmpty", value: function(t) {
        switch (t) {
          ...
          default:
            throw new G("Invalid dimension: " + t);
        }
        ...
        if (arguments.length === 0) return new Zn(null, this);
        if (arguments.length === 1) {
          var t = arguments[0];
          return new Zn(t, this);
        }
        ...
        if (t.size() > 1) {
          if (v instanceof gn) return this.createMultiPolygon(r.toPolygonArray(t));
          if (v instanceof Xe) return this.createMultiLineString(r.toLineStringArray(t));
          if (v instanceof Bn) return this.createMultiPoint(r.toPointArray(t));
        ...
        if (arguments.length === 0) return new Xn(null, this);
        if (arguments.length === 1) {
          if (arguments[0] instanceof Array) {
            var t = arguments[0];
    ...
    }(), $n = "XY", qs = "XYZ", Ys = "XYM", zs = "XYZM", Fi = { POINT: "Point", LINE_STRING: "LineString", LINEAR_RING: "LinearRing", POLYGON: "Polygon", MULTI_POINT: "MultiPoint", MULTI_LINE_STRING: "MultiLineString", MULTI_POLYGON: "MultiPolygon", GEOMETRY_COLLECTION: "GeometryCollection", CIRCLE: "Circle" }, Gi = "EMPTY", mn = 1, ee = 2, ae = 3, qi = 4, Se = 5, Bs = 6;
    for (var Xs in Fi) Fi[Xs].toUpperCase();
    var Us = function() {
      function r(t) {
...
`;
        ...
        else if (this.isNumeric_(e) || e == "-") t = qi, i = this.readNumber_();
        else if (this.isAlpha_(e)) t = mn, i = this.readText_();
        else {
      ...
      function r(t, e) {
        a(this, r), this.lexer_ = t, this.token_, this.layout_ = $n, this.factory = e;
      }
      return h(r, [{ key: "consume_", value: function() {
        ...
        var t = $n, e = this.token_;
        if (this.isTokenType(mn)) {
          var n = e.value;
          n === "Z" ? t = qs : n === "M" ? t = Ys : n === "ZM" && (t = zs), t !== $n && this.consume_();
        }
        return t;
        ...
        var t = this.isTokenType(mn) && this.token_.value == Gi;
        ...
        var t = this.factory, e = function(j) {
          ...
          var K = j.map(function(ct) {
            return t.createLinearRing(ct.map(e));
          });
          return K.length > 1 ? t.createPolygon(K[0], K.slice(1)) : t.createPolygon(K[0]);
        }, i = this.token_;
        if (this.match(mn)) {
          var s = i.value;
          ...
          switch (s) {
            case "POINT":
              ...
              return c ? t.createPoint(x(T, R(c))) : t.createPoint();
            case "LINESTRING":
            ...
            case "POLYGON":
              var E = this.parsePolygonText_();
              return E && E.length !== 0 ? n(E) : t.createPolygon();
            case "MULTIPOINT":
              var L = this.parseMultiPointText_();
              if (!L || L.length === 0) return t.createMultiPoint();
              var C = L.map(e).map(function(j) {
            ...
            case "MULTIPOLYGON":
              ...
              if (!P || P.length === 0) return t.createMultiPolygon();
              var Z = P.map(n);
    ...
    function zi(r) {
      var t = [];
      t.push("(" + Ze(r.getExteriorRing()) + ")");
      for (var e = 0, n = r.getNumInteriorRing(); e < n; ++e) t.push("(" + Ze(r.getInteriorRingN(e)) + ")");
      return t.join(", ");
    }
    var Hs = { Point: Yi, LineString: Ze, LinearRing: Ze, Polygon: zi, MultiPoint: function(r) {
      for (var t = [], e = 0, n = r.getNumGeometries(); e < n; ++e) t.push("(" + Yi(r.getGeometryN(e)) + ")");
      return t.join(", ");
    }, MultiLineString: function(r) {
      for (var t = [], e = 0, n = r.getNumGeometries(); e < n; ++e) t.push("(" + Ze(r.getGeometryN(e)) + ")");
      return t.join(", ");
    }, MultiPolygon: function(r) {
      for (var t = [], e = 0, n = r.getNumGeometries(); e < n; ++e) t.push("(" + zi(r.getGeometryN(e)) + ")");
      return t.join(", ");
    }, GeometryCollection: function(r) {
      for (var t = [], e = 0, n = r.getNumGeometries(); e < n; ++e) t.push(Bi(r.getGeometryN(e)));
      return t.join(", ");
    } };
    function Bi(r) {
      ...
      return n.length > 0 && (t += " " + n), r.isEmpty() ? t + " " + Gi : t + " (" + e(r) + ")";
    }
    var Zs = function() {
      function r(t) {
        a(this, r), this.geometryFactory = t || new Ne(), this.precisionModel = this.geometryFactory.getPrecisionModel();
      }
      ...
      return h(r, [{ key: "getIndexAlongSegment", value: function(t, e) {
        ...
        return jn.toLineString(this._inputLines[0][0], this._inputLines[0][1]) + " - " + jn.toLineString(this._inputLines[1][0], this._inputLines[1][1]) + this.getTopologySummary();
    ...
    var _e = function(r) {
      ...
      return h(e, [{ key: "isInSegmentEnvelopes", value: function(n) {
        ...
        if (arguments.length !== 3) return S(d(e.prototype), "computeIntersection", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1], s = arguments[2];
        if (this._isProper = !1, vt.intersects(i, s, n) && J.index(i, s, n) === 0 && J.index(s, i, n) === 0) return this._isProper = !0, (n.equals(i) || n.equals(s)) && (this._isProper = !1), this._result = yt.POINT_INTERSECTION, null;
        ...
        var v = Yn.intersection(n, i, s, o), y = this.isInSegmentEnvelopes(v);
        ...
        var c = zn.intersection(n, i, s, o);
        return c === null && (c = e.nearestEndpoint(n, i, s, o)), c;
      } }, { key: "computeCollinearIntersection", value: function(n, i, s, o) {
        var c = vt.intersects(n, i, s), v = vt.intersects(n, i, o), y = vt.intersects(s, o, n), E = vt.intersects(s, o, i);
        return c && v ? (this._intPt[0] = s, this._intPt[1] = o, yt.COLLINEAR_INTERSECTION) : y && E ? (this._intPt[0] = n, this._intPt[1] = i, yt.COLLINEAR_INTERSECTION) : c && y ? (this._intPt[0] = s, this._intPt[1] = n, !s.equals(n) || v || E ? yt.COLLINEAR_INTERSECTION : yt.POINT_INTERSECTION) : c && E ? (this._intPt[0] = s, this._intPt[1] = i, !s.equals(i) || v || y ? yt.COLLINEAR_INTERSECTION : yt.POINT_INTERSECTION) : v && y ? (this._intPt[0] = o, this._intPt[1] = n, !o.equals(n) || c || E ? yt.COLLINEAR_INTERSECTION : yt.POINT_INTERSECTION) : v && E ? (this._intPt[0] = o, this._intPt[1] = i, !o.equals(i) || c || y ? yt.COLLINEAR_INTERSECTION : yt.POINT_INTERSECTION) : yt.NO_INTERSECTION;
      } }, { key: "computeIntersect", value: function(n, i, s, o) {
        if (this._isProper = !1, !vt.intersects(n, i, s, o)) return yt.NO_INTERSECTION;
        var c = J.index(n, i, s), v = J.index(n, i, o);
        if (c > 0 && v > 0 || c < 0 && v < 0) return yt.NO_INTERSECTION;
        var y = J.index(s, o, n), E = J.index(s, o, i);
        return y > 0 && E > 0 || y < 0 && E < 0 ? yt.NO_INTERSECTION : c === 0 && v === 0 && y === 0 && E === 0 ? this.computeCollinearIntersection(n, i, s, o) : (c === 0 || v === 0 || y === 0 || E === 0 ? (this._isProper = !1, n.equals2D(s) || n.equals2D(o) ? this._intPt[0] = n : i.equals2D(s) || i.equals2D(o) ? this._intPt[0] = i : c === 0 ? this._intPt[0] = new T(s) : v === 0 ? this._intPt[0] = new T(o) : y === 0 ? this._intPt[0] = new T(n) : E === 0 && (this._intPt[0] = new T(i))) : (this._isProper = !0, this._intPt[0] = this.intersection(n, i, s, o)), yt.POINT_INTERSECTION);
      ...
      return h(r, [{ key: "countSegment", value: function(t, e) {
        ...
        if (t.y > this._p.y && e.y <= this._p.y || e.y > this._p.y && t.y <= this._p.y) {
          var s = J.index(t, e, this._p);
          if (s === J.COLLINEAR) return this._isPointOnSegment = !0, null;
          e.y < t.y && (s = -s), s === J.LEFT && this._crossingCount++;
        }
      } }, { key: "isPointInPolygon", value: function() {
        return this.getLocation() !== k.EXTERIOR;
      } }, { key: "getLocation", value: function() {
        return this._isPointOnSegment ? k.BOUNDARY : this._crossingCount % 2 == 1 ? k.INTERIOR : k.EXTERIOR;
        ...
        if (arguments[0] instanceof T && arguments[1] instanceof Array) {
          for (var c = arguments[0], v = arguments[1], y = new r(c), E = 1; E < v.length; E++) {
            var L = v[E], C = v[E - 1];
            if (y.countSegment(L, C), y.isOnSegment()) return y.getLocation();
          }
      ...
      return h(r, null, [{ key: "isOnLine", value: function() {
        ...
        if (arguments[0] instanceof T && arguments[1] instanceof Array) {
          for (var v = arguments[0], y = arguments[1], E = new _e(), L = 1; L < y.length; L++) {
            var C = y[L - 1], D = y[L];
            if (E.computeIntersection(v, C, D), E.hasIntersection()) return !0;
          }
          return !1;
        }
        ...
        return r.locateInRing(t, e) !== k.EXTERIOR;
      } }]), r;
    }(), Dt = function() {
      function r() {
        a(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, [{ key: "setAllLocations", value: function(t) {
        ...
        for (var t = 0; t < this.location.length; t++) if (this.location[t] !== k.NONE) return !1;
        return !0;
      } }, { key: "setAllLocationsIfNull", value: function(t) {
        for (var e = 0; e < this.location.length; e++) this.location[e] === k.NONE && (this.location[e] = t);
      } }, { key: "isLine", value: function() {
        return this.location.length === 1;
      } }, { key: "merge", value: function(t) {
        if (t.location.length > this.location.length) {
          var e = new Array(3).fill(null);
          e[F.ON] = this.location[F.ON], e[F.LEFT] = k.NONE, e[F.RIGHT] = k.NONE, this.location = e;
        }
        for (var n = 0; n < this.location.length; n++) this.location[n] === k.NONE && n < t.location.length && (this.location[n] = t.location[n]);
      } }, { key: "getLocations", value: function() {
        return this.location;
      } }, { key: "flip", value: function() {
        if (this.location.length <= 1) return null;
        var t = this.location[F.LEFT];
        this.location[F.LEFT] = this.location[F.RIGHT], this.location[F.RIGHT] = t;
      } }, { key: "toString", value: function() {
        var t = new ze();
        return this.location.length > 1 && t.append(k.toLocationSymbol(this.location[F.LEFT])), t.append(k.toLocationSymbol(this.location[F.ON])), this.location.length > 1 && t.append(k.toLocationSymbol(this.location[F.RIGHT])), t.toString();
      } }, { key: "setLocations", value: function(t, e, n) {
        this.location[F.ON] = t, this.location[F.LEFT] = e, this.location[F.RIGHT] = n;
      } }, { key: "get", value: function(t) {
        return t < this.location.length ? this.location[t] : k.NONE;
      } }, { key: "isArea", value: function() {
        return this.location.length > 1;
      } }, { key: "isAnyNull", value: function() {
        for (var t = 0; t < this.location.length; t++) if (this.location[t] === k.NONE) return !0;
        return !1;
      } }, { key: "setLocation", value: function() {
        if (arguments.length === 1) {
          var t = arguments[0];
          this.setLocation(F.ON, t);
        } else if (arguments.length === 2) {
          var e = arguments[0], n = arguments[1];
          this.location[e] = n;
        }
      } }, { key: "init", value: function(t) {
        this.location = new Array(t).fill(null), this.setAllLocations(k.NONE);
        ...
        if (this.location = null, arguments.length === 1) {
          if (arguments[0] instanceof Array) {
            ...
            var e = arguments[0];
            this.init(1), this.location[F.ON] = e;
          } else if (arguments[0] instanceof r) {
            var n = arguments[0];
      ...
      return h(r, [{ key: "getGeometryCount", value: function() {
        ...
        if (this.elt = new Array(2).fill(null), arguments.length === 1) {
          ...
          var n = arguments[0], i = arguments[1];
          this.elt[0] = new Dt(k.NONE), this.elt[1] = new Dt(k.NONE), this.elt[n].setLocation(i);
        } else if (arguments.length === 3) {
          var s = arguments[0], o = arguments[1], c = arguments[2];
          this.elt[0] = new Dt(s, o, c), this.elt[1] = new Dt(s, o, c);
        } else if (arguments.length === 4) {
          var v = arguments[0], y = arguments[1], E = arguments[2], L = arguments[3];
          this.elt[0] = new Dt(k.NONE, k.NONE, k.NONE), this.elt[1] = new Dt(k.NONE, k.NONE, k.NONE), this.elt[v].setLocations(y, E, L);
        }
      } }, { key: "toLineLabel", value: function(t) {
        for (var e = new r(k.NONE), n = 0; n < 2; n++) e.setLocation(n, t.getLocation(n));
        return e;
      } }]), r;
    }(), dn = function() {
      function r() {
      ...
      return h(r, [{ key: "computeRing", value: function() {
        ...
        if (!e.getEnvelopeInternal().contains(t) || !Wn.isInRing(t, e.getCoordinates())) return !1;
        ...
        if (arguments.length === 1) {
          ...
          var e = arguments[0], n = arguments[1], i = e.getLocation(n, F.RIGHT);
          if (i === k.NONE) return null;
          if (this._label.getLocation(n) === k.NONE) return this._label.setLocation(n, i), null;
        }
        ...
        if (this._startDe = null, this._maxNodeDegree = -1, this._edges = new W(), this._pts = new W(), this._label = new Ft(k.NONE), this._ring = null, this._isHole = null, this._shell = null, this._holes = new W(), this._geometryFactory = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var t = arguments[0], e = arguments[1];
      ...
      return h(e, [{ key: "isIncidentEdgeInResult", value: function() {
        ...
        if (arguments.length !== 2 || !Number.isInteger(arguments[1]) || !Number.isInteger(arguments[0])) return S(d(e.prototype), "setLabel", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
        ...
        if (arguments[0] instanceof e) {
          ...
          c === k.NONE && this._label.setLocation(s, o);
        }
      } }, { key: "add", value: function(n) {
        ...
        var n = arguments[0], i = arguments[1];
        this._coord = n, this._edges = i, this._label = new Ft(0, k.NONE);
      } }]), e;
    }(Xi), Qs = function(r) {
      g(e, r);
      var t = _(e);
    ...
    var $e = function(r) {
      ...
      return h(e, [{ key: "get", value: function(n) {
        ...
        var i;
        for (n.color = 1; n != null && n !== this.root_ && n.parent.color === 1; ) ht(n) === Qn(ht(ht(n))) ? Ui(i = Vi(ht(ht(n)))) === 1 ? ($t(ht(n), 0), $t(i, 0), $t(ht(ht(n)), 1), n = ht(ht(n))) : (n === Vi(ht(n)) && (n = ht(n), this.rotateLeft(n)), $t(ht(n), 0), $t(ht(ht(n)), 1), this.rotateRight(ht(ht(n)))) : Ui(i = Qn(ht(ht(n)))) === 1 ? ($t(ht(n), 0), $t(i, 0), $t(ht(ht(n)), 1), n = ht(ht(n))) : (n === Qn(ht(n)) && (n = ht(n), this.rotateRight(n)), $t(ht(n), 0), $t(ht(ht(n)), 1), this.rotateLeft(ht(ht(n))));
        this.root_.color = 0;
      } }, { key: "values", value: function() {
        ...
        var n = new Gn(), i = this.getFirstEntry();
      ...
      return h(r, [{ key: "find", value: function(t) {
        ...
        for (var e = new W(), n = this.iterator(); n.hasNext(); ) {
          var i = n.next();
          i.getLabel().getLocation(t) === k.BOUNDARY && e.add(i);
        }
        return e;
        ...
        this.nodeMap = new $e(), this.nodeFact = null;
        var t = arguments[0];
        this.nodeFact = t;
      } }]), r;
    }(), Lt = function() {
      ...
      return h(r, null, [{ key: "isNorthern", value: function(t) {
        ...
        if (typeof arguments[0] == "number" && typeof arguments[1] == "number") {
          var t = arguments[0], e = arguments[1];
          if (t === 0 && e === 0) throw new G("Cannot compute the quadrant for point ( " + t + ", " + e + " )");
    ...
    var Zi = function() {
      ...
      return h(r, [{ key: "compareDirection", value: function(t) {
        return this._dx === t._dx && this._dy === t._dy ? 0 : this._quadrant > t._quadrant ? 1 : this._quadrant < t._quadrant ? -1 : J.index(t._p0, t._p1, this._p1);
      ...
      return h(e, [{ key: "getNextMin", value: function() {
        ...
        for (var n = !0, i = 0; i < 2; i++) this._label.isArea(i) && this._label.getLocation(i, F.LEFT) === k.INTERIOR && this._label.getLocation(i, F.RIGHT) === k.INTERIOR || (n = !1);
        return n;
      } }, { key: "setNextMin", value: function(n) {
        this._nextMin = n;
      } }, { key: "print", value: function(n) {
        S(d(e.prototype), "print", this).call(this, n), n.print(" " + this._depth[F.LEFT] + "/" + this._depth[F.RIGHT]), n.print(" (" + this.getDepthDelta() + ")"), this._isInResult && n.print(" inResult");
      } }, { key: "setMinEdgeRing", value: function(n) {
        this._minEdgeRing = n;
      } }, { key: "isLineEdge", value: function() {
        var n = this._label.isLine(0) || this._label.isLine(1), i = !this._label.isArea(0) || this._label.allPositionsEqual(0, k.EXTERIOR), s = !this._label.isArea(1) || this._label.allPositionsEqual(1, k.EXTERIOR);
        return n && i && s;
        ...
        var n = arguments[0], i = arguments[1];
        if (Zi.constructor_.call(this, n), this._isForward = i, i) this.init(n.getCoordinate(0), n.getCoordinate(1));
        else {
        ...
        return n === k.EXTERIOR && i === k.INTERIOR ? 1 : n === k.INTERIOR && i === k.EXTERIOR ? -1 : 0;
      } }]), e;
    }(Zi), $i = function() {
      function r() {
        a(this, r);
      ...
      return h(r, [{ key: "printEdges", value: function(t) {
        ...
        if (n === null) return !1;
        var i = n.getLabel();
        return i !== null && i.getLocation(t) === k.BOUNDARY;
        ...
        return !!t.equals(n) && J.index(t, e, i) === J.COLLINEAR && Lt.quadrant(t, e) === Lt.quadrant(n, i);
        ...
        if (this._edges = new W(), this._nodes = null, this._edgeEndList = new W(), arguments.length === 0) this._nodes = new Hi(new $i());
        else if (arguments.length === 1) {
          var t = arguments[0];
          this._nodes = new Hi(t);
        }
      ...
      return h(r, [{ key: "sortShellsAndHoles", value: function(t, e, n) {
        ...
        for (var n = t.getLinearRing(), i = n.getEnvelopeInternal(), s = n.getCoordinateN(0), o = null, c = null, v = e.iterator(); v.hasNext(); ) {
          var y = v.next(), E = y.getLinearRing(), L = E.getEnvelopeInternal();
          if (!L.equals(i) && L.contains(i)) {
            s = _t.ptNotInList(n.getCoordinates(), E.getCoordinates());
            var C = !1;
            Wn.isInRing(s, E.getCoordinates()) && (C = !0), C && (o === null || c.contains(L)) && (c = (o = y).getLinearRing().getEnvelopeInternal());
          }
        }
        return o;
      } }]), r;
      ...
      return h(r, [{ key: "queryInternal", value: function() {
        if (tt(arguments[2], Qi) && arguments[0] instanceof Object && arguments[1] instanceof Gt) for (var t = arguments[0], e = arguments[1], n = arguments[2], i = e.getChildBoundables(), s = 0; s < i.size(); s++) {
          var o = i.get(s);
        ...
        else if (tt(arguments[2], ve) && arguments[0] instanceof Object && arguments[1] instanceof Gt) for (var c = arguments[0], v = arguments[1], y = arguments[2], E = v.getChildBoundables(), L = 0; L < E.size(); L++) {
          var C = E.get(L);
    ...
    Te.IntersectsOp = function() {
    }, Te.DEFAULT_NODE_CAPACITY = 10;
    var ea = function() {
      function r() {
        a(this, r);
      }
      ...
      return h(e, [{ key: "createParentBoundablesFromVerticalSlices", value: function(n, i) {
        ...
        if (arguments.length === 3) {
          var s = arguments[0], o = arguments[1], c = arguments[2], v = o, y = new _n();
          y.add(s);
          for (var E = new _n(); !y.isEmpty() && v >= 0; ) {
            var L = y.poll(), C = L.getDistance();
            if (C >= v) break;
            if (L.isLeaves()) if (E.size() < c) E.add(L);
            else {
              var D = E.peek();
              D.getDistance() > C && (E.poll(), E.add(L));
              var P = E.peek();
              v = P.getDistance();
            }
            else L.expandToQueue(y, v);
          }
          return e.getItems(E);
        }
        ...
        return arguments.length === 0 ? S(d(e.prototype), "size", this).call(this) : S(d(e.prototype), "size", this).apply(this, arguments);
      } }, { key: "insert", value: function() {
        if (!(arguments.length === 2 && arguments[1] instanceof Object && arguments[0] instanceof vt)) return S(d(e.prototype), "insert", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
        if (n.isNull()) return null;
        S(d(e.prototype), "insert", this).call(this, n, i);
        ...
        if (arguments.length === 1) {
          var n = arguments[0];
          return S(d(e.prototype), "query", this).call(this, n);
        }
        if (arguments.length === 2) {
          var i = arguments[0], s = arguments[1];
          S(d(e.prototype), "query", this).call(this, i, s);
        }
      } }, { key: "getComparator", value: function() {
        return e.yComparator;
      } }, { key: "createParentBoundablesFromVerticalSlice", value: function(n, i) {
        return S(d(e.prototype), "createParentBoundables", this).call(this, n, i);
      } }, { key: "remove", value: function() {
        if (arguments.length === 2 && arguments[1] instanceof Object && arguments[0] instanceof vt) {
          var n = arguments[0], i = arguments[1];
          return S(d(e.prototype), "remove", this).call(this, n, i);
        }
        return S(d(e.prototype), "remove", this).apply(this, arguments);
      } }, { key: "depth", value: function() {
        return arguments.length === 0 ? S(d(e.prototype), "depth", this).call(this) : S(d(e.prototype), "depth", this).apply(this, arguments);
      } }, { key: "createParentBoundables", value: function(n, i) {
        it.isTrue(!n.isEmpty());
        var s = Math.trunc(Math.ceil(n.size() / this.getNodeCapacity())), o = new W(n);
        we.sort(o, e.xComparator);
        ...
        if (arguments.length === 1) {
          if (tt(arguments[0], ea)) {
            var n = arguments[0];
            if (this.isEmpty()) return null;
            var i = new Le(this.getRoot(), this.getRoot(), n);
            return this.nearestNeighbour(i);
          }
          if (arguments[0] instanceof Le) {
            var s = arguments[0], o = H.POSITIVE_INFINITY, c = null, v = new _n();
            for (v.add(s); !v.isEmpty() && o > 0; ) {
              var y = v.poll(), E = y.getDistance();
              if (E >= o) break;
              y.isLeaves() ? (o = E, c = y) : y.expandToQueue(v, o);
            }
          ...
          if (arguments.length === 2) {
            ...
            var D = new Le(this.getRoot(), L.getRoot(), C);
            return this.nearestNeighbour(D);
          }
          if (arguments.length === 3) {
            var P = arguments[0], Z = arguments[1], j = arguments[2], K = new ne(P, Z), ct = new Le(this.getRoot(), K, j);
            return this.nearestNeighbour(ct)[0];
          }
          if (arguments.length === 4) {
            var mt = arguments[0], Nt = arguments[1], Pt = arguments[2], Ut = arguments[3], ie = new ne(mt, Nt), ke = new Le(this.getRoot(), ie, Pt);
            return this.nearestNeighbourK(ke, Ut);
          }
        }
      } }, { key: "isWithinDistance", value: function() {
        if (arguments.length === 2) {
          var n = arguments[0], i = arguments[1], s = H.POSITIVE_INFINITY, o = new _n();
        ...
        if (arguments.length === 3) {
          var y = arguments[0], E = arguments[1], L = arguments[2], C = new Le(this.getRoot(), y.getRoot(), E);
          return this.isWithinDistance(C, L);
        }
      } }, { key: "interfaces_", get: function() {
        return [Ks, U];
      } }], [{ key: "constructor_", value: function() {
    ...
    jt.STRtreeNode = Ji, jt.xComparator = new (function() {
      function r() {
        a(this, r);
      }
      return h(r, [{ key: "interfaces_", get: function() {
        ...
        return Te.compareDoubles(jt.centreX(t.getBounds()), jt.centreX(e.getBounds()));
      } }]), r;
      ...
      return h(r, [{ key: "interfaces_", get: function() {
        ...
        return Te.compareDoubles(jt.centreY(t.getBounds()), jt.centreY(e.getBounds()));
      } }]), r;
    ...
    var na = function() {
      ...
      return h(r, [{ key: "getSplitCoordinates", value: function() {
        ...
        for (var e = 0; e < this._edge.size() - 2; e++) {
          ...
          n.equals2D(i) && t.add(ln.valueOf(e + 1));
        }
        ...
        for (var e = new Array(1).fill(null), n = this.iterator(), i = n.next(); n.hasNext(); ) {
          var s = n.next();
          this.findCollapseIndex(i, s, e) && t.add(ln.valueOf(e[0])), i = s;
        }
      } }, { key: "getEdge", value: function() {
        return this._edge;
        ...
        this._nodeMap = new $e(), this._edge = null;
        var t = arguments[0];
        this._edge = t;
      } }]), r;
    }(), aa = function() {
      ...
      return h(r, null, [{ key: "octant", value: function() {
        if (typeof arguments[0] == "number" && typeof arguments[1] == "number") {
          var t = arguments[0], e = arguments[1];
          if (t === 0 && e === 0) throw new G("Cannot compute the octant for point ( " + t + ", " + e + " )");
      ...
      return h(r, [{ key: "getCoordinates", value: function() {
        ...
        return jn.toLineString(new He(this._pts));
      ...
      return h(r, [{ key: "minX", value: function() {
        ...
        if (arguments[0] instanceof r) {
          var t = arguments[0], e = J.index(this.p0, this.p1, t.p0), n = J.index(this.p0, this.p1, t.p1);
          return e >= 0 && n >= 0 || e <= 0 && n <= 0 ? Math.max(e, n) : 0;
        }
        if (arguments[0] instanceof T) {
          var i = arguments[0];
          return J.index(this.p0, this.p1, i);
        }
      } }, { key: "toGeometry", value: function(t) {
        ...
        return zn.intersection(this.p0, this.p1, t.p0, t.p1);
      ...
      return h(r, [{ key: "getLineSegment", value: function(t, e) {
        ...
        if (arguments.length === 2) {
          ...
          var y = Math.trunc((n + i) / 2), E = Math.trunc((o + c) / 2);
          n < y && (o < E && this.computeOverlaps(n, y, s, o, E, v), E < c && this.computeOverlaps(n, y, s, E, c, v)), y < i && (o < E && this.computeOverlaps(y, i, s, o, E, v), E < c && this.computeOverlaps(y, i, s, E, c, v));
        }
      ...
      return h(e, [{ key: "getMonotoneChains", value: function() {
        ...
        for (var n = new er(this._segInt), i = this._monoChains.iterator(); i.hasNext(); ) for (var s = i.next(), o = this._index.query(s.getEnvelope()).iterator(); o.hasNext(); ) {
          var c = o.next();
      ...
      return h(e, [{ key: "overlap", value: function() {
        if (arguments.length !== 4) return S(d(e.prototype), "overlap", this).apply(this, arguments);
    ...
    var Xt = function() {
      ...
      return h(r, [{ key: "isDeletable", value: function(t, e, n, i) {
        ...
        return J.index(t, e, n) === this._angleOrientation && Zt.pointToSegment(e, t, n) < i;
        ...
        var i = J.index(t, e, n) === this._angleOrientation;
        return i;
      } }, { key: "simplify", value: function(t) {
        this._distanceTol = Math.abs(t), t < 0 && (this._angleOrientation = J.CLOCKWISE), this._isDeleted = new Array(this._inputLine.length).fill(null);
        var e = !1;
        do
        ...
        for (var t = new Ve(), e = 0; e < this._inputLine.length; e++) this._isDeleted[e] !== r.DELETE && t.add(this._inputLine[e]);
        return t.toCoordinateArray();
      } }], [{ key: "constructor_", value: function() {
        this._inputLine = null, this._distanceTol = null, this._isDeleted = null, this._angleOrientation = J.COUNTERCLOCKWISE;
        var t = arguments[0];
        this._inputLine = t;
    ...
    nr.COORDINATE_ARRAY_TYPE = new Array(0).fill(null);
    var Mt = function() {
      function r() {
        a(this, r);
      }
    ...
    Mt.PI_TIMES_2 = 2 * Math.PI, Mt.PI_OVER_2 = Math.PI / 2, Mt.PI_OVER_4 = Math.PI / 4, Mt.COUNTERCLOCKWISE = J.COUNTERCLOCKWISE, Mt.CLOCKWISE = J.CLOCKWISE, Mt.NONE = J.COLLINEAR;
    var je = function() {
      function r() {
        a(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "addNextSegment", value: function(t, e) {
        ...
        var n = J.index(this._s0, this._s1, this._s2), i = n === J.CLOCKWISE && this._side === F.LEFT || n === J.COUNTERCLOCKWISE && this._side === F.RIGHT;
        ...
        switch (this._bufParams.getEndCapStyle()) {
          case b.CAP_ROUND:
            this._segList.addPt(i.p1), this.addDirectedFillet(e, v + Math.PI / 2, v - Math.PI / 2, J.CLOCKWISE, this._distance), this._segList.addPt(s.p1);
            break;
          case b.CAP_FLAT:
          ...
          case b.CAP_SQUARE:
            ...
            var E = new T(i.p1.x + y.x, i.p1.y + y.y), L = new T(s.p1.x + y.x, s.p1.y + y.y);
            this._segList.addPt(E), this._segList.addPt(L);
        }
      } }, { key: "getCoordinates", value: function() {
        return this._segList.getCoordinates();
      } }, { key: "addMitreJoin", value: function(t, e, n, i) {
        var s = zn.intersection(e.p0, e.p1, n.p0, n.p1);
        ...
        this._bufParams.getJoinStyle() === b.JOIN_MITRE ? this.addMitreJoin(this._s1, this._offset0, this._offset1, this._distance) : this._bufParams.getJoinStyle() === b.JOIN_BEVEL ? this.addBevelJoin(this._offset0, this._offset1) : (e && this._segList.addPt(this._offset0.p1), this.addCornerFillet(this._s1, this._offset0.p1, this._offset1.p0, t, this._distance), this._segList.addPt(this._offset1.p0));
        ...
        var o = e.x - t.x, c = e.y - t.y, v = Math.atan2(c, o), y = n.x - t.x, E = n.y - t.y, L = Math.atan2(E, y);
        i === J.CLOCKWISE ? v <= L && (v += 2 * Math.PI) : v >= L && (v -= 2 * Math.PI), this._segList.addPt(e), this.addDirectedFillet(t, v, L, i, s), this._segList.addPt(n);
        ...
        var s = this._seg0.p1, o = Mt.angle(s, this._seg0.p0), c = Mt.angleBetweenOriented(this._seg0.p0, s, this._seg1.p1) / 2, v = Mt.normalize(o + c), y = Mt.normalize(v + Math.PI), E = i * n, L = n - E * Math.abs(Math.sin(c)), C = s.x + E * Math.cos(y), D = s.y + E * Math.sin(y), P = new T(C, D), Z = new bt(s, P), j = Z.pointAlongOffset(1, L), K = Z.pointAlongOffset(1, -L);
        this._side === F.LEFT ? (this._segList.addPt(j), this._segList.addPt(K)) : (this._segList.addPt(K), this._segList.addPt(j));
      } }, { key: "addDirectedFillet", value: function(t, e, n, i, s) {
        var o = i === J.CLOCKWISE ? -1 : 1, c = Math.abs(e - n), v = Math.trunc(c / this._filletAngleQuantum + 0.5);
        if (v < 1) return null;
        for (var y = c / v, E = new T(), L = 0; L < v; L++) {
          var C = e + o * L * y;
          E.x = t.x + s * Math.cos(C), E.y = t.y + s * Math.sin(C), this._segList.addPt(E);
        }
      } }, { key: "computeOffsetSegment", value: function(t, e, n, i) {
        var s = e === F.LEFT ? 1 : -1, o = t.p1.x - t.p0.x, c = t.p1.y - t.p0.y, v = Math.sqrt(o * o + c * c), y = s * n * o / v, E = s * n * c / v;
        i.p0.x = t.p0.x - E, i.p0.y = t.p0.y + y, i.p1.x = t.p1.x - E, i.p1.y = t.p1.y + y;
        ...
        this._distance = t, this._maxCurveSegmentError = t * (1 - Math.cos(this._filletAngleQuantum / 2)), this._segList = new nr(), this._segList.setPrecisionModel(this._precisionModel), this._segList.setMinimumVertexDistance(t * r.CURVE_VERTEX_SNAP_DISTANCE_FACTOR);
        ...
        var t = arguments[0], e = arguments[1], n = arguments[2];
        this._precisionModel = t, this._bufParams = e, this._li = new _e(), this._filletAngleQuantum = Math.PI / 2 / e.getQuadrantSegments(), e.getQuadrantSegments() >= 8 && e.getJoinStyle() === b.JOIN_ROUND && (this._closingSegLengthFactor = r.MAX_CLOSING_SEG_LEN_FACTOR), this.init(n);
      } }]), r;
    }();
    je.OFFSET_SEGMENT_SEPARATION_FACTOR = 1e-3, je.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR = 1e-3, je.CURVE_VERTEX_SNAP_DISTANCE_FACTOR = 1e-6, je.MAX_CLOSING_SEG_LEN_FACTOR = 80;
    var ca = function() {
      function r() {
        a(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getOffsetCurve", value: function(t, e) {
        ...
        if (e) {
          ...
          for (var E = 2; E <= y; E++) n.addNextSegment(v[E], !0);
        }
        ...
        return new je(this._precisionModel, this._bufParams, t);
      } }], [{ key: "constructor_", value: function() {
      ...
      return h(r, [{ key: "findStabbedSegments", value: function() {
        ...
        if (arguments.length === 3) {
          if (tt(arguments[2], ve) && arguments[0] instanceof T && arguments[1] instanceof Jn) for (var o = arguments[0], c = arguments[1], v = arguments[2], y = c.getEdge().getCoordinates(), E = 0; E < y.length - 1; E++) {
            this._seg.p0 = y[E], this._seg.p1 = y[E + 1], this._seg.p0.y > this._seg.p1.y && this._seg.reverse();
            var L = Math.max(this._seg.p0.x, this._seg.p1.x);
            if (!(L < o.x) && !(this._seg.isHorizontal() || o.y < this._seg.p0.y || o.y > this._seg.p1.y || J.index(this._seg.p0, this._seg.p1, o) === J.RIGHT)) {
              var C = c.getDepth(F.LEFT);
              this._seg.p0.equals(y[E]) || (C = c.getDepth(F.RIGHT));
              var D = new rr(this._seg, C);
              v.add(D);
            }
          }
          else if (tt(arguments[2], ve) && arguments[0] instanceof T && tt(arguments[1], ve)) for (var P = arguments[0], Z = arguments[1], j = arguments[2], K = Z.iterator(); K.hasNext(); ) {
            var ct = K.next();
            ct.isForward() && this.findStabbedSegments(P, ct, j);
          }
        }
      } }, { key: "getDepth", value: function(t) {
        var e = this.findStabbedSegments(t);
        return e.size() === 0 ? 0 : we.min(e)._leftDepth;
      } }], [{ key: "constructor_", value: function() {
    ...
    var sr = function(r) {
      ...
      return h(r, [{ key: "getY", value: function() {
        var t = this.y / this.w;
        if (H.isNaN(t) || H.isInfinite(t)) throw new sr();
        return t;
      } }, { key: "getX", value: function() {
        var t = this.x / this.w;
        if (H.isNaN(t) || H.isInfinite(t)) throw new sr();
        ...
        if (this.x = null, this.y = null, this.w = null, arguments.length === 0) this.x = 0, this.y = 0, this.w = 1;
          ...
          var v = arguments[0], y = arguments[1], E = arguments[2];
          this.x = v, this.y = y, this.w = E;
        } else if (arguments.length === 4) {
          var L = arguments[0], C = arguments[1], D = arguments[2], P = arguments[3], Z = L.y - C.y, j = C.x - L.x, K = L.x * C.y - C.x * L.y, ct = D.y - P.y, mt = P.x - D.x, Nt = D.x * P.y - P.x * D.y;
          this.x = j * Nt - mt * K, this.y = ct * K - Z * Nt, this.w = Z * mt - ct * j;
        }
      } }]), r;
    }(), fa = function() {
      function r() {
      ...
      return h(r, [{ key: "area", value: function() {
        ...
        if (t === null) throw new G("Supplied point is null.");
        ...
        var s = e.x, o = e.y, c = n.x - s, v = i.x - s, y = n.y - o, E = i.y - o, L = c * E - v * y, C = t.x - s, D = t.y - o, P = (E * C - v * D) / L, Z = (-y * C + c * D) / L;
        return e.getZ() + P * (n.getZ() - e.getZ()) + Z * (i.getZ() - e.getZ());
        ...
        var i = Q.valueOf(t.x).subtract(n.x), s = Q.valueOf(t.y).subtract(n.y), o = Q.valueOf(e.x).subtract(n.x), c = Q.valueOf(e.y).subtract(n.y), v = Q.determinant(i, s, o, c).multiply(2), y = i.sqr().add(s.sqr()), E = o.sqr().add(c.sqr()), L = Q.determinant(s, y, c, E), C = Q.determinant(i, y, o, E), D = Q.valueOf(n.x).subtract(L.divide(v)).doubleValue(), P = Q.valueOf(n.y).add(C.divide(v)).doubleValue();
        return new T(D, P);
      } }, { key: "isAcute", value: function(t, e, n) {
        return !!Mt.isAcute(t, e, n) && !!Mt.isAcute(e, n, t) && !!Mt.isAcute(n, t, e);
      } }, { key: "circumcentre", value: function(t, e, n) {
        var i = n.x, s = n.y, o = t.x - i, c = t.y - s, v = e.x - i, y = e.y - s, E = 2 * r.det(o, c, v, y), L = r.det(c, o * o + c * c, y, v * v + y * y), C = r.det(o, o * o + c * c, v, v * v + y * y);
        return new T(i - L / E, s + C / E);
      } }, { key: "perpendicularBisector", value: function(t, e) {
        var n = e.x - t.x, i = e.y - t.y, s = new ei(t.x + n / 2, t.y + i / 2, 1), o = new ei(t.x - i + n / 2, t.y + n + i / 2, 1);
        return new ei(s, o);
        ...
        var i = e.x - t.x, s = e.y - t.y, o = e.getZ() - t.getZ(), c = n.x - t.x, v = n.y - t.y, y = n.getZ() - t.getZ(), E = s * y - o * v, L = o * c - i * y, C = i * v - s * c, D = E * E + L * L + C * C, P = Math.sqrt(D) / 2;
        return P;
      ...
      return h(r, [{ key: "addRingSide", value: function(t, e, n, i, s) {
        if (e === 0 && t.length < Ue.MINIMUM_VALID_SIZE) return null;
        var o = i, c = s;
        t.length >= Ue.MINIMUM_VALID_SIZE && J.isCCW(t) && (o = s, c = i, n = F.opposite(n));
        var v = this._curveBuilder.getRingCurve(t, n, e);
        this.addCurve(v, o, c);
      } }, { key: "addRingBothSides", value: function(t, e) {
        this.addRingSide(t, e, F.LEFT, k.EXTERIOR, k.INTERIOR), this.addRingSide(t, e, F.RIGHT, k.INTERIOR, k.EXTERIOR);
      } }, { key: "addPoint", value: function(t) {
        if (this._distance <= 0) return null;
        var e = t.getCoordinates(), n = this._curveBuilder.getLineCurve(e, this._distance);
        this.addCurve(n, k.EXTERIOR, k.INTERIOR);
      } }, { key: "addPolygon", value: function(t) {
        var e = this._distance, n = F.LEFT;
        this._distance < 0 && (e = -this._distance, n = F.RIGHT);
        ...
        this.addRingSide(s, e, n, k.EXTERIOR, k.INTERIOR);
        for (var o = 0; o < t.getNumInteriorRing(); o++) {
          var c = t.getInteriorRingN(o), v = _t.removeRepeatedPoints(c.getCoordinates());
          this._distance > 0 && this.isErodedCompletely(c, -this._distance) || this.addRingSide(v, e, F.opposite(n), k.INTERIOR, k.EXTERIOR);
        }
        ...
        var i = new xe(t, new Ft(0, k.BOUNDARY, e, n));
        this._curveList.add(i);
      } }, { key: "getCurves", value: function() {
        return this.add(this._inputGeom), this._curveList;
      } }, { key: "add", value: function(t) {
        if (t.isEmpty()) return null;
        if (t instanceof gn) this.addPolygon(t);
        else if (t instanceof Xe) this.addLineString(t);
        else if (t instanceof Bn) this.addPoint(t);
        else if (t instanceof Xn) this.addCollection(t);
        else if (t instanceof Zn) this.addCollection(t);
      ...
      return h(r, [{ key: "next", value: function() {
        ...
        if (this._index >= this._max) throw new on();
      ...
      return h(r, [{ key: "locate", value: function(t) {
        ...
        if (e.isEmpty()) return k.EXTERIOR;
        var n = e.getExteriorRing(), i = r.locatePointInRing(t, n);
        if (i !== k.INTERIOR) return i;
        for (var s = 0; s < e.getNumInteriorRing(); s++) {
          var o = e.getInteriorRingN(s), c = r.locatePointInRing(t, o);
          if (c === k.BOUNDARY) return k.BOUNDARY;
          if (c === k.INTERIOR) return k.EXTERIOR;
        }
        return k.INTERIOR;
      } }, { key: "locatePointInRing", value: function(t, e) {
        return e.getEnvelopeInternal().intersects(t) ? Wn.locateInRing(t, e.getCoordinates()) : k.EXTERIOR;
      } }, { key: "containsPointInPolygon", value: function(t, e) {
        return k.EXTERIOR !== r.locatePointInPolygon(t, e);
      } }, { key: "locateInGeometry", value: function(t, e) {
        if (e instanceof gn) return r.locatePointInPolygon(t, e);
        if (e instanceof Ot) for (var n = new ya(e); n.hasNext(); ) {
          var i = n.next();
          if (i !== e) {
            var s = r.locateInGeometry(t, i);
            if (s !== k.EXTERIOR) return s;
          }
        }
        return k.EXTERIOR;
      } }, { key: "isContained", value: function(t, e) {
        return k.EXTERIOR !== r.locate(t, e);
      } }, { key: "locate", value: function(t, e) {
        return e.isEmpty() ? k.EXTERIOR : e.getEnvelopeInternal().intersects(t) ? r.locateInGeometry(t, e) : k.EXTERIOR;
      } }]), r;
    }(), da = function() {
      function r() {
        a(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, [{ key: "getNextCW", value: function(t) {
        ...
        for (var e = k.NONE, n = this.iterator(); n.hasNext(); ) {
          var i = n.next().getLabel();
          i.isArea(t) && i.getLocation(t, F.LEFT) !== k.NONE && (e = i.getLocation(t, F.LEFT));
        }
        if (e === k.NONE) return null;
        for (var s = e, o = this.iterator(); o.hasNext(); ) {
          var c = o.next(), v = c.getLabel();
          if (v.getLocation(t, F.ON) === k.NONE && v.setLocation(t, F.ON, s), v.isArea(t)) {
            var y = v.getLocation(t, F.LEFT), E = v.getLocation(t, F.RIGHT);
            if (E !== k.NONE) {
              if (E !== s) throw new te("side location conflict", c.getCoordinate());
              y === k.NONE && it.shouldNeverReachHere("found single null side (at " + c.getCoordinate() + ")"), s = y;
            } else it.isTrue(v.getLocation(t, F.LEFT) === k.NONE, "found single null side"), v.setLocation(t, F.RIGHT, s), v.setLocation(t, F.LEFT, s);
          }
        }
      } }, { key: "getCoordinate", value: function() {
        var t = this.iterator();
        ...
        var n = e.size() - 1, i = e.get(n).getLabel().getLocation(t, F.LEFT);
        it.isTrue(i !== k.NONE, "Found unlabelled area edge");
        for (var s = i, o = this.iterator(); o.hasNext(); ) {
          var c = o.next().getLabel();
          it.isTrue(c.isArea(t), "Found non-area edge");
          var v = c.getLocation(t, F.LEFT), y = c.getLocation(t, F.RIGHT);
          if (v === y || y !== s) return !1;
          s = v;
        }
        return !0;
        ...
        return this._ptInAreaLocation[t] === k.NONE && (this._ptInAreaLocation[t] = ma.locate(e, n[t].getGeometry())), this._ptInAreaLocation[t];
      } }, { key: "toString", value: function() {
        var t = new ze();
...
`);
        ...
        for (var e = [!1, !1], n = this.iterator(); n.hasNext(); ) for (var i = n.next().getLabel(), s = 0; s < 2; s++) i.isLine(s) && i.getLocation(s) === k.BOUNDARY && (e[s] = !0);
        for (var o = this.iterator(); o.hasNext(); ) for (var c = o.next(), v = c.getLabel(), y = 0; y < 2; y++) if (v.isAnyNull(y)) {
          var E = k.NONE;
          if (e[y]) E = k.EXTERIOR;
          else {
            var L = c.getCoordinate();
            E = this.getLocation(y, L, t);
          }
          v.setAllLocationsIfNull(y, E);
        }
        ...
        this._edgeMap = new $e(), this._edgeList = null, this._ptInAreaLocation = [k.NONE, k.NONE];
      } }]), r;
    }(), pa = function(r) {
      g(e, r);
      var t = _(e);
      ...
      return h(e, [{ key: "linkResultDirectedEdges", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          for (var y = arguments[0], E = arguments[1], L = arguments[2], C = L, D = y; D < E; D++) {
            var P = this._edgeList.get(D);
            P.setEdgeDepths(F.RIGHT, C), C = P.getDepth(F.LEFT);
          }
          return C;
        }
        ...
        for (var n = k.NONE, i = this.iterator(); i.hasNext(); ) {
        ...
        for (var c = n, v = this.iterator(); v.hasNext(); ) {
          var y = v.next(), E = y.getSym();
          y.isLineEdge() ? y.getEdge().setCovered(c === k.INTERIOR) : (y.isInResult() && (c = k.EXTERIOR), E.isInResult() && (c = k.INTERIOR));
        }
      } }, { key: "computeLabelling", value: function(n) {
        S(d(e.prototype), "computeLabelling", this).call(this, n), this._label = new Ft(k.NONE);
        for (var i = this.iterator(); i.hasNext(); ) for (var s = i.next().getEdge().getLabel(), o = 0; o < 2; o++) {
          var c = s.getLocation(o);
          c !== k.INTERIOR && c !== k.BOUNDARY || this._label.setLocation(o, k.INTERIOR);
        }
      } }], [{ key: "constructor_", value: function() {
      ...
      return h(r, [{ key: "compareTo", value: function(t) {
        ...
        for (var s = e ? 1 : -1, o = i ? 1 : -1, c = e ? t.length : -1, v = i ? n.length : -1, y = e ? 0 : t.length - 1, E = i ? 0 : n.length - 1; ; ) {
          var L = t[y].compareTo(n[E]);
          if (L !== 0) return L;
          var C = (y += s) === c, D = (E += o) === v;
          if (C && !D) return -1;
          if (!C && D) return 1;
      ...
      return h(r, [{ key: "print", value: function(t) {
        ...
        this._edges = new W(), this._ocaMap = new $e();
      } }]), r;
    }(), ur = function() {
      function r() {
        a(this, r);
      ...
      return h(r, [{ key: "print", value: function(t) {
        ...
        return s && (o[c] = e.coord), new lr(o, new Ft(this.edge._label));
        ...
        this._nodeMap = new $e(), this.edge = null;
        var t = arguments[0];
        this.edge = t;
      } }]), r;
    }(), Na = function() {
      ...
      return h(r, [{ key: "isIntersects", value: function() {
        ...
        return (r.isTrue(this._matrix[k.INTERIOR][k.INTERIOR]) || r.isTrue(this._matrix[k.INTERIOR][k.BOUNDARY]) || r.isTrue(this._matrix[k.BOUNDARY][k.INTERIOR]) || r.isTrue(this._matrix[k.BOUNDARY][k.BOUNDARY])) && this._matrix[k.EXTERIOR][k.INTERIOR] === Y.FALSE && this._matrix[k.EXTERIOR][k.BOUNDARY] === Y.FALSE;
      } }, { key: "isCoveredBy", value: function() {
        return (r.isTrue(this._matrix[k.INTERIOR][k.INTERIOR]) || r.isTrue(this._matrix[k.INTERIOR][k.BOUNDARY]) || r.isTrue(this._matrix[k.BOUNDARY][k.INTERIOR]) || r.isTrue(this._matrix[k.BOUNDARY][k.BOUNDARY])) && this._matrix[k.INTERIOR][k.EXTERIOR] === Y.FALSE && this._matrix[k.BOUNDARY][k.EXTERIOR] === Y.FALSE;
      } }, { key: "set", value: function() {
        ...
        return r.isTrue(this._matrix[k.INTERIOR][k.INTERIOR]) && this._matrix[k.EXTERIOR][k.INTERIOR] === Y.FALSE && this._matrix[k.EXTERIOR][k.BOUNDARY] === Y.FALSE;
        ...
        return r.isTrue(this._matrix[k.INTERIOR][k.INTERIOR]) && this._matrix[k.INTERIOR][k.EXTERIOR] === Y.FALSE && this._matrix[k.BOUNDARY][k.EXTERIOR] === Y.FALSE;
      } }, { key: "isTouches", value: function(t, e) {
        return t > e ? this.isTouches(e, t) : (t === Y.A && e === Y.A || t === Y.L && e === Y.L || t === Y.L && e === Y.A || t === Y.P && e === Y.A || t === Y.P && e === Y.L) && this._matrix[k.INTERIOR][k.INTERIOR] === Y.FALSE && (r.isTrue(this._matrix[k.INTERIOR][k.BOUNDARY]) || r.isTrue(this._matrix[k.BOUNDARY][k.INTERIOR]) || r.isTrue(this._matrix[k.BOUNDARY][k.BOUNDARY]));
      } }, { key: "isOverlaps", value: function(t, e) {
        return t === Y.P && e === Y.P || t === Y.A && e === Y.A ? r.isTrue(this._matrix[k.INTERIOR][k.INTERIOR]) && r.isTrue(this._matrix[k.INTERIOR][k.EXTERIOR]) && r.isTrue(this._matrix[k.EXTERIOR][k.INTERIOR]) : t === Y.L && e === Y.L && this._matrix[k.INTERIOR][k.INTERIOR] === 1 && r.isTrue(this._matrix[k.INTERIOR][k.EXTERIOR]) && r.isTrue(this._matrix[k.EXTERIOR][k.INTERIOR]);
      } }, { key: "isEquals", value: function(t, e) {
        return t === e && r.isTrue(this._matrix[k.INTERIOR][k.INTERIOR]) && this._matrix[k.INTERIOR][k.EXTERIOR] === Y.FALSE && this._matrix[k.BOUNDARY][k.EXTERIOR] === Y.FALSE && this._matrix[k.EXTERIOR][k.INTERIOR] === Y.FALSE && this._matrix[k.EXTERIOR][k.BOUNDARY] === Y.FALSE;
      } }, { key: "toString", value: function() {
        for (var t = new yn("123456789"), e = 0; e < 3; e++) for (var n = 0; n < 3; n++) t.setCharAt(3 * e + n, Y.toDimensionSymbol(this._matrix[e][n]));
        return t.toString();
        ...
        if (t.length !== 9) throw new G("Should be length 9: " + t);
        ...
        return this._matrix[k.INTERIOR][k.INTERIOR] === Y.FALSE && this._matrix[k.INTERIOR][k.BOUNDARY] === Y.FALSE && this._matrix[k.BOUNDARY][k.INTERIOR] === Y.FALSE && this._matrix[k.BOUNDARY][k.BOUNDARY] === Y.FALSE;
      } }, { key: "isCrosses", value: function(t, e) {
        return t === Y.P && e === Y.L || t === Y.P && e === Y.A || t === Y.L && e === Y.A ? r.isTrue(this._matrix[k.INTERIOR][k.INTERIOR]) && r.isTrue(this._matrix[k.INTERIOR][k.EXTERIOR]) : t === Y.L && e === Y.P || t === Y.A && e === Y.P || t === Y.A && e === Y.L ? r.isTrue(this._matrix[k.INTERIOR][k.INTERIOR]) && r.isTrue(this._matrix[k.EXTERIOR][k.INTERIOR]) : t === Y.L && e === Y.L && this._matrix[k.INTERIOR][k.INTERIOR] === 0;
      } }, { key: "interfaces_", get: function() {
        return [V];
      } }], [{ key: "constructor_", value: function() {
        if (this._matrix = null, arguments.length === 0) this._matrix = Array(3).fill().map(function() {
          ...
          if (typeof arguments[0] == "string") {
            ...
            var e = arguments[0];
            r.constructor_.call(this), this._matrix[k.INTERIOR][k.INTERIOR] = e._matrix[k.INTERIOR][k.INTERIOR], this._matrix[k.INTERIOR][k.BOUNDARY] = e._matrix[k.INTERIOR][k.BOUNDARY], this._matrix[k.INTERIOR][k.EXTERIOR] = e._matrix[k.INTERIOR][k.EXTERIOR], this._matrix[k.BOUNDARY][k.INTERIOR] = e._matrix[k.BOUNDARY][k.INTERIOR], this._matrix[k.BOUNDARY][k.BOUNDARY] = e._matrix[k.BOUNDARY][k.BOUNDARY], this._matrix[k.BOUNDARY][k.EXTERIOR] = e._matrix[k.BOUNDARY][k.EXTERIOR], this._matrix[k.EXTERIOR][k.INTERIOR] = e._matrix[k.EXTERIOR][k.INTERIOR], this._matrix[k.EXTERIOR][k.BOUNDARY] = e._matrix[k.EXTERIOR][k.BOUNDARY], this._matrix[k.EXTERIOR][k.EXTERIOR] = e._matrix[k.EXTERIOR][k.EXTERIOR];
          }
        }
      ...
      return h(r, [{ key: "getChainStartIndices", value: function(t) {
        var e = 0, n = new Sa(Math.trunc(t.length / 2));
        n.add(e);
        do {
      ...
      return h(r, [{ key: "getCoordinates", value: function() {
        ...
        if (arguments.length === 4) {
          ...
          var s = arguments[0], o = arguments[1], c = arguments[2], v = arguments[3], y = arguments[4], E = arguments[5];
          if (o - s == 1 && y - v == 1) return E.addIntersections(this.e, s, c.e, v), null;
          if (!this.overlaps(s, o, c, v, y)) return null;
          var L = Math.trunc((s + o) / 2), C = Math.trunc((v + y) / 2);
          s < L && (v < C && this.computeIntersectsForChain(s, L, c, v, C, E), C < y && this.computeIntersectsForChain(s, L, c, C, y, E)), L < o && (v < C && this.computeIntersectsForChain(L, o, c, v, C, E), C < y && this.computeIntersectsForChain(L, o, c, C, y, E));
        }
      } }, { key: "overlaps", value: function(t, e, n, i, s) {
      ...
      return h(r, [{ key: "getDepth", value: function(t, e) {
        ...
        return this._depth[t][F.RIGHT] - this._depth[t][F.LEFT];
      } }, { key: "getLocation", value: function(t, e) {
        return this._depth[t][e] <= 0 ? k.EXTERIOR : k.INTERIOR;
      } }, { key: "toString", value: function() {
        return "A: " + this._depth[0][1] + "," + this._depth[0][2] + " B: " + this._depth[1][1] + "," + this._depth[1][2];
      } }, { key: "add", value: function() {
        if (arguments.length === 1) for (var t = arguments[0], e = 0; e < 2; e++) for (var n = 1; n < 3; n++) {
          var i = t.getLocation(e, n);
          i !== k.EXTERIOR && i !== k.INTERIOR || (this.isNull(e, n) ? this._depth[e][n] = r.depthAtLocation(i) : this._depth[e][n] += r.depthAtLocation(i));
        }
        else if (arguments.length === 3) {
          var s = arguments[0], o = arguments[1], c = arguments[2];
          c === k.INTERIOR && this._depth[s][o]++;
        }
      } }], [{ key: "constructor_", value: function() {
        ...
        return t === k.EXTERIOR ? 0 : t === k.INTERIOR ? 1 : r.NULL_VALUE;
      } }]), r;
    }();
    or.NULL_VALUE = -1;
    var lr = function(r) {
      ...
      return h(e, [{ key: "getDepth", value: function() {
        ...
        var c = new T(n.getIntersection(o)), v = i, y = n.getEdgeDistance(s, o), E = v + 1;
        if (E < this.pts.length) {
          var L = this.pts[E];
          c.equals2D(L) && (v = E, y = 0);
        }
        ...
        if (this.pts = null, this._env = null, this.eiList = new Ia(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new or(), this._depthDelta = 0, arguments.length === 1) {
          var n = arguments[0];
        ...
        if (!(arguments.length === 2 && arguments[1] instanceof Na && arguments[0] instanceof Ft)) return S(d(e), "updateIM", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
      ...
      return h(r, [{ key: "setWorkingPrecisionModel", value: function(t) {
        ...
        for (var n = new W(), i = t.iterator(); i.hasNext(); ) {
          var s = i.next(), o = s.getRightmostCoordinate(), c = new ir(n).getDepth(o);
        ...
        this.computeNodedEdges(s, n), this._graph = new ji(new _a()), this._graph.addEdges(this._edgeList.getEdges());
        var o = this.createSubgraphs(this._graph), c = new Js(this._geomFact);
        ...
        for (var i = n.getNodedSubstrings().iterator(); i.hasNext(); ) {
          ...
          if (o.length !== 2 || !o[0].equals2D(o[1])) {
            var c = s.getData(), v = new lr(s.getCoordinates(), new Ft(c));
        ...
        var e = t.getLocation(0, F.LEFT), n = t.getLocation(0, F.RIGHT);
        return e === k.INTERIOR && n === k.EXTERIOR ? 1 : e === k.EXTERIOR && n === k.INTERIOR ? -1 : 0;
      } }, { key: "convertSegStrings", value: function(t) {
        for (var e = new Ne(), n = new W(); t.hasNext(); ) {
      ...
      return h(r, [{ key: "checkEndPtVertexIntersections", value: function() {
        ...
        else if (arguments.length === 2) for (var s = arguments[0], o = arguments[1], c = s.getCoordinates(), v = o.getCoordinates(), y = 0; y < c.length - 1; y++) for (var E = 0; E < v.length - 1; E++) this.checkInteriorIntersections(s, y, o, E);
        else if (arguments.length === 4) {
          var L = arguments[0], C = arguments[1], D = arguments[2], P = arguments[3];
          if (L === D && C === P) return null;
          var Z = L.getCoordinates()[C], j = L.getCoordinates()[C + 1], K = D.getCoordinates()[P], ct = D.getCoordinates()[P + 1];
          if (this._li.computeIntersection(Z, j, K, ct), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, Z, j) || this.hasInteriorIntersection(this._li, K, ct))) throw new Et("found non-noded intersection at " + Z + "-" + j + " and " + K + "-" + ct);
        }
    ...
    var ni = function() {
      ...
      return h(r, [{ key: "intersectsScaled", value: function(t, e) {
        ...
        var t = arguments[0], e = arguments[1], n = arguments[2];
        if (this._originalPt = t, this._pt = t, this._scaleFactor = e, this._li = n, e <= 0) throw new G("Scale factor must be non-zero");
    ...
    var Ca = function() {
      ...
      return h(r, [{ key: "snap", value: function() {
        ...
        if (arguments.length === 3) {
          var e = arguments[0], n = arguments[1], i = arguments[2], s = e.getSafeEnvelope(), o = new gr(e, n, i);
      ...
      return h(e, [{ key: "isNodeAdded", value: function() {
        ...
        if (!(arguments.length === 2 && Number.isInteger(arguments[1]) && arguments[0] instanceof Ki)) return S(d(e.prototype), "select", this).apply(this, arguments);
    ...
    var Ra = function() {
      ...
      return h(r, [{ key: "checkCorrectness", value: function(t) {
        var e = xe.getNodedSubstrings(t), n = new cr(e);
        try {
          n.checkValid();
        } catch (i) {
        ...
        if (tt(arguments[0], Ht)) for (var t = arguments[0], e = t.iterator(); e.hasNext(); ) {
          ...
          var c = new ni(s[o], this._scaleFactor, this._li), v = this._pointSnapper.snap(c, i, o);
          v && i.addIntersection(s[o], o);
        }
      } }, { key: "computeNodes", value: function(t) {
        this._nodedSegStrings = t, this._noder = new ti(), this._pointSnapper = new fr(this._noder.getIndex()), this.snapRound(t, this._li);
      } }, { key: "computeIntersectionSnaps", value: function(t) {
        for (var e = t.iterator(); e.hasNext(); ) {
          var n = e.next(), i = new ni(n, this._scaleFactor, this._li);
      ...
      return h(r, [{ key: "bufferFixedPrecision", value: function(t) {
        var e = new Ta(new Oa(new Bt(1)), t.getScale()), n = new hr(this._bufParams);
        ...
        if (this._argGeom = null, this._distance = null, this._bufParams = new b(), this._resultGeometry = null, this._saveException = null, arguments.length === 1) {
          var t = arguments[0];
          this._argGeom = t;
        } else if (arguments.length === 2) {
          var e = arguments[0], n = arguments[1];
        ...
        if (arguments.length === 3) {
          ...
          if (arguments[2] instanceof b && arguments[0] instanceof $ && typeof arguments[1] == "number") {
            var E = arguments[0], L = arguments[1], C = arguments[2], D = new r(E, C), P = D.getResultGeometry(L);
            return P;
          }
        } else if (arguments.length === 4) {
          var Z = arguments[0], j = arguments[1], K = arguments[2], ct = arguments[3], mt = new r(Z);
          mt.setQuadrantSegments(K), mt.setEndCapStyle(ct);
          var Nt = mt.getResultGeometry(j);
          return Nt;
        }
      } }, { key: "precisionScaleFactor", value: function(t, e, n) {
        var i = t.getEnvelopeInternal(), s = Be.max(Math.abs(i.getMaxX()), Math.abs(i.getMaxY()), Math.abs(i.getMinX()), Math.abs(i.getMinY())) + 2 * (e > 0 ? e : 0), o = n - Math.trunc(Math.log(s) / Math.log(10) + 1);
        return Math.pow(10, o);
      } }]), r;
    }();
    Ce.CAP_ROUND = b.CAP_ROUND, Ce.CAP_BUTT = b.CAP_FLAT, Ce.CAP_FLAT = b.CAP_FLAT, Ce.CAP_SQUARE = b.CAP_SQUARE, Ce.MAX_PRECISION_DIGITS = 12;
    var ba = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], vr = function() {
      function r(t) {
        a(this, r), this.geometryFactory = t || new Ne();
      }
      return h(r, [{ key: "read", value: function(t) {
    ...
    return { BufferOp: Ce, GeoJSONReader: function() {
      function r(t) {
        a(this, r), this.parser = new vr(t || new Ne());
      }
      return h(r, [{ key: "read", value: function(t) {
      ...
      function r() {
        a(this, r), this.parser = new vr(this.geometryFactory);
      }
      return h(r, [{ key: "write", value: function(t) {
        return this.parser.write(t);
      } }]), r;
...
On.prototype = {
  ...
  add: function(l) {
    Dr(kn, l, this.t), Dr(this, kn.s, this.s), this.s ? this.t += kn.t : this.s = kn.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var gt = 1e-6, lt = Math.PI, Qt = lt / 2, Fr = lt / 4, Jt = lt * 2, oe = 180 / lt, Yt = lt / 180, It = Math.abs, Yu = Math.atan, Fe = Math.atan2, dt = Math.cos, pt = Math.sin, Ye = Math.sqrt;
function hs(l) {
...
function bn(l, u) {
  l && qr.hasOwnProperty(l.type) && qr[l.type](l, u);
}
var Gr = {
  ...
  FeatureCollection: function(l, u) {
    for (var a = l.features, f = -1, h = a.length; ++f < h; ) bn(a[f].geometry, u);
  }
}, qr = {
  Sphere: function(l, u) {
    u.sphere();
  ...
  LineString: function(l, u) {
    pi(l.coordinates, u, 0);
  },
  MultiLineString: function(l, u) {
    for (var a = l.coordinates, f = -1, h = a.length; ++f < h; ) pi(a[f], u, 0);
  },
  Polygon: function(l, u) {
    Yr(l.coordinates, u);
  },
  MultiPolygon: function(l, u) {
    for (var a = l.coordinates, f = -1, h = a.length; ++f < h; ) Yr(a[f], u);
  },
  GeometryCollection: function(l, u) {
    for (var a = l.geometries, f = -1, h = a.length; ++f < h; ) bn(a[f], u);
  }
};
function pi(l, u, a) {
...
function Yr(l, u) {
  var a = -1, f = l.length;
  for (u.polygonStart(); ++a < f; ) pi(l[a], u, 1);
  u.polygonEnd();
}
function zu(l, u) {
  l && Gr.hasOwnProperty(l.type) ? Gr[l.type](l, u) : bn(l, u);
}
ge();
ge();
function _i(l) {
  return [Fe(l[1], l[0]), Ee(l[2])];
}
function Ge(l) {
...
function xi(l) {
  var u = Ye(l[0] * l[0] + l[1] * l[1] + l[2] * l[2]);
  l[0] /= u, l[1] /= u, l[2] /= u;
}
ge();
function cs(l, u) {
...
function ki(l, u) {
  return [l > lt ? l - Jt : l < -lt ? l + Jt : l, u];
}
ki.invert = ki;
function Bu(l, u, a) {
  return (l %= Jt) ? u || a ? cs(Br(l), Xr(u, a)) : Br(l) : u || a ? Xr(u, a) : ki;
}
function zr(l) {
  return function(u, a) {
    return u += l, [u > lt ? u - Jt : u < -lt ? u + Jt : u, a];
  };
}
function Br(l) {
  var u = zr(l);
  return u.invert = zr(-l), u;
}
function Xr(l, u) {
  var a = dt(l), f = pt(l), h = dt(u), g = pt(u);
  function d(p, w) {
    var x = dt(w), N = dt(p) * x, m = pt(p) * x, I = pt(w), _ = I * a + N * f;
    return [
      Fe(m * h - _ * g, N * a - I * f),
      Ee(_ * h + m * g)
    ];
  ...
  return d.invert = function(p, w) {
    var x = dt(w), N = dt(p) * x, m = pt(p) * x, I = pt(w), _ = I * h - m * g;
    return [
      Fe(m * h + I * g, N * a + _ * f),
      Ee(_ * a - N * f)
    ];
...
function Xu(l, u, a, f, h, g) {
  if (a) {
    ...
    h == null ? (h = u + f * Jt, g = u - w / 2) : (h = Ur(d, h), g = Ur(d, g), (f > 0 ? h < g : h > g) && (h += f * Jt));
    for (var x, N = h; f > 0 ? N > g : N < g; N -= w)
      x = _i([d, -p * dt(N), -p * pt(N)]), l.point(x[0], x[1]);
  }
}
function Ur(l, u) {
  u = Ge(u), u[0] -= l, xi(u);
  var a = hs(-u[1]);
  return ((-u[2] < 0 ? -a : a) + Jt - gt) % Jt;
}
function fs() {
  var l = [], u;
  return {
...
function Uu(l, u, a, f, h, g) {
  var d = l[0], p = l[1], w = u[0], x = u[1], N = 0, m = 1, I = w - d, _ = x - p, S;
  if (S = a - d, !(!I && S > 0)) {
    if (S /= I, I < 0) {
      if (S < N) return;
      S < m && (m = S);
    ...
    if (S = h - d, !(!I && S < 0)) {
      ...
      if (S = f - p, !(!_ && S > 0)) {
        ...
        if (S = g - p, !(!_ && S < 0)) {
          ...
          return N > 0 && (l[0] = d + N * I, l[1] = p + N * _), m < 1 && (u[0] = d + m * I, u[1] = p + m * _), !0;
        }
      }
    }
  }
...
function gs(l, u, a, f, h) {
  var g = [], d = [], p, w;
  if (l.forEach(function(S) {
    if (!((R = S.length - 1) <= 0)) {
      var R, O = S[0], A = S[R], M;
      if (Ln(O, A)) {
        for (h.lineStart(), p = 0; p < R; ++p) h.point((O = S[p])[0], O[1]);
        h.lineEnd();
        return;
      }
      g.push(M = new Nn(O, S, null, !0)), d.push(M.o = new Nn(O, null, M, !1)), g.push(M = new Nn(A, S, null, !1)), d.push(M.o = new Nn(A, null, M, !0));
    }
  }), !!g.length) {
    for (d.sort(u), Vr(g), Vr(d), p = 0, w = d.length; p < w; ++p)
      d[p].e = a = !a;
    for (var x = g[0], N, m; ; ) {
      for (var I = x, _ = !0; I.v; ) if ((I = I.n) === x) return;
      N = I.z, h.lineStart();
      do {
        if (I.v = I.o.v = !0, I.e) {
          if (_)
...
function Zu(l, u, a, f) {
  function h(x, N) {
    return l <= x && x <= a && u <= N && N <= f;
  }
  function g(x, N, m, I) {
    var _ = 0, S = 0;
    if (x == null || (_ = d(x, m)) !== (S = d(N, m)) || w(x, N) < 0 ^ m > 0)
      do
        I.point(_ === 0 || _ === 3 ? l : a, _ > 1 ? f : u);
      while ((_ = (_ + m + 4) % 4) !== S);
    else
      I.point(N[0], N[1]);
  }
  function d(x, N) {
    return It(x[0] - l) < gt ? N > 0 ? 0 : 3 : It(x[0] - a) < gt ? N > 0 ? 2 : 1 : It(x[1] - u) < gt ? N > 0 ? 1 : 0 : N > 0 ? 3 : 2;
  }
  function p(x, N) {
    return w(x.x, N.x);
  }
  function w(x, N) {
    var m = d(x, 1), I = d(N, 1);
    return m !== I ? m - I : m === 0 ? N[1] - x[1] : m === 1 ? x[0] - N[0] : m === 2 ? x[1] - N[1] : N[0] - x[0];
  }
  return function(x) {
    var N = x, m = fs(), I, _, S, R, O, A, M, b, q, G, B, X = {
      point: V,
      lineStart: rt,
      lineEnd: ut,
      polygonStart: st,
    ...
    function U() {
      for (var nt = 0, ot = 0, ft = _.length; ot < ft; ++ot)
        for (var xt = _[ot], kt = 1, H = xt.length, wt = xt[0], Et, Ct, it = wt[0], Kt = wt[1]; kt < H; ++kt)
          Et = it, Ct = Kt, wt = xt[kt], it = wt[0], Kt = wt[1], Ct <= f ? Kt > f && (it - Et) * (f - Ct) > (Kt - Ct) * (l - Et) && ++nt : Kt <= f && (it - Et) * (f - Ct) < (Kt - Ct) * (l - Et) && --nt;
      return nt;
    }
    function st() {
      N = m, I = [], _ = [], B = !0;
    ...
    function et() {
      ...
      (ot || ft) && (x.polygonStart(), ot && (x.lineStart(), g(null, null, 1, x), x.lineEnd()), ft && gs(I, p, nt, g, x), x.polygonEnd()), N = x, I = _ = S = null;
    }
    function rt() {
      X.point = z, _ && _.push(S = []), G = !0, q = !1, M = b = NaN;
    }
    function ut() {
      I && (z(R, O), A && q && m.rejoin(), I.push(m.result())), X.point = V, q && N.lineEnd();
    }
    function z(nt, ot) {
      var ft = h(nt, ot);
      if (_ && S.push([nt, ot]), G)
        R = nt, O = ot, A = ft, G = !1, ft && (N.lineStart(), N.point(nt, ot));
      else if (ft && q) N.point(nt, ot);
      else {
        var xt = [M = Math.max(Sn, Math.min(tn, M)), b = Math.max(Sn, Math.min(tn, b))], kt = [nt = Math.max(Sn, Math.min(tn, nt)), ot = Math.max(Sn, Math.min(tn, ot))];
        Uu(xt, kt, l, u, a, f) ? (q || (N.lineStart(), N.point(xt[0], xt[1])), N.point(kt[0], kt[1]), ft || N.lineEnd(), B = !1) : ft && (N.lineStart(), N.point(nt, ot), B = !1);
      }
      M = nt, b = ot, q = ft;
    }
    return X;
...
function $u(l, u) {
  ...
  for (var p = 0, w = l.length; p < w; ++p)
    if (N = (x = l[p]).length)
      for (var x, N, m = x[N - 1], I = m[0], _ = m[1] / 2 + Fr, S = pt(_), R = dt(_), O = 0; O < N; ++O, I = M, S = q, R = G, m = A) {
        var A = x[O], M = A[0], b = A[1] / 2 + Fr, q = pt(b), G = dt(b), B = M - I, X = B >= 0 ? 1 : -1, V = X * B, U = V > lt, st = S * q;
        if (hi.add(Fe(st * X * pt(V), R * G + st * dt(V))), g += U ? B + X * Jt : B, U ^ I >= a ^ M >= a) {
          var et = Mn(Ge(m), Ge(A));
          xi(et);
          var rt = Mn(h, et);
          xi(rt);
          var ut = (U ^ B >= 0 ? -1 : 1) * Ee(rt[2]);
          (f > ut || f === ut && (et[0] || et[1])) && (d += U ^ B >= 0 ? 1 : -1);
        }
      }
  return (g < -gt || g < gt && hi < -gt) ^ d & 1;
}
ge();
function Hr(l) {
  return l;
...
ge();
ge();
var qe = 1 / 0, Pn = qe, sn = -qe, An = sn, Zr = {
  point: ju,
  lineStart: Ke,
  lineEnd: Ke,
  polygonStart: Ke,
  ...
  result: function() {
    var l = [[qe, Pn], [sn, An]];
    return sn = An = -(Pn = qe = 1 / 0), l;
  }
};
function ju(l, u) {
  l < qe && (qe = l), l > sn && (sn = l), u < Pn && (Pn = u), u > An && (An = u);
}
ge();
function ms(l, u, a, f) {
  return function(h, g) {
    var d = u(g), p = h.invert(f[0], f[1]), w = fs(), x = u(w), N = !1, m, I, _, S = {
      point: R,
      lineStart: A,
      lineEnd: M,
      polygonStart: function() {
        S.point = b, S.lineStart = q, S.lineEnd = G, I = [], m = [];
      },
      polygonEnd: function() {
        S.point = R, S.lineStart = A, S.lineEnd = M, I = ys(I);
        var B = $u(m, p);
    ...
    function G() {
      b(_[0][0], _[0][1]), x.lineEnd();
      var B = x.clean(), X = w.result(), V, U = X.length, st, et, rt;
      if (_.pop(), m.push(_), _ = null, !!U) {
        if (B & 1) {
...
function Ju(l) {
  ...
  return {
    ...
    point: function(g, d) {
      ...
      It(w - lt) < gt ? (l.point(u, a = (a + d) / 2 > 0 ? Qt : -Qt), l.point(f, a), l.lineEnd(), l.lineStart(), l.point(p, a), l.point(g, a), h = 0) : f !== p && w >= lt && (It(u - f) < gt && (u -= f * gt), It(g - p) < gt && (g -= p * gt), a = Ku(u, a, g, d), l.point(f, a), l.lineEnd(), l.lineStart(), l.point(p, a), h = 0), l.point(u = g, a = d), f = p;
    },
    lineEnd: function() {
      l.lineEnd(), u = a = NaN;
    },
...
function eo(l, u) {
  ...
  function p(N) {
    ...
    return {
      ...
      point: function(O, A) {
        var M = [O, A], b, q = d(O, A), G = f ? q ? 0 : x(O, A) : q ? x(O + (O < 0 ? lt : -lt), A) : 0;
        if (!m && (S = _ = q) && N.lineStart(), q !== _ && (b = w(m, M), (!b || Ln(m, b) || Ln(M, b)) && (M[0] += gt, M[1] += gt, q = d(M[0], M[1]))), q !== _)
          R = 0, q ? (N.lineStart(), b = w(M, m), N.point(b[0], b[1])) : (b = w(m, M), N.point(b[0], b[1]), N.lineEnd()), m = b;
        else if (h && m && f ^ q) {
          var B;
          !(G & I) && (B = w(M, m, !0)) && (R = 0, f ? (N.lineStart(), N.point(B[0][0], B[0][1]), N.point(B[1][0], B[1][1]), N.lineEnd()) : (N.point(B[1][0], B[1][1]), N.lineEnd(), N.lineStart(), N.point(B[0][0], B[0][1])));
        }
        q && (!m || !Ln(m, M)) && N.point(M[0], M[1]), m = M, _ = q, I = G;
      },
      lineEnd: function() {
        _ && N.lineEnd(), m = null;
      },
  ...
  function w(N, m, I) {
    var _ = Ge(N), S = Ge(m), R = [1, 0, 0], O = Mn(_, S), A = En(O, O), M = O[0], b = A - M * M;
    if (!b) return !I && N;
    var q = a * A / b, G = -a * M / b, B = Mn(R, O), X = In(R, q), V = In(O, G);
    li(X, V);
    var U = B, st = En(X, U), et = En(U, U), rt = st * st - et * (En(X, X) - 1);
    if (!(rt < 0)) {
      var ut = Ye(rt), z = In(U, (-st - ut) / et);
      if (li(z, X), z = _i(z), !I) return z;
      var nt = N[0], ot = m[0], ft = N[1], xt = m[1], kt;
      ot < nt && (kt = nt, nt = ot, ot = kt);
      var H = ot - nt, wt = It(H - lt) < gt, Et = wt || H < gt;
      if (!wt && xt < ft && (kt = ft, ft = xt, xt = kt), Et ? wt ? ft + xt > 0 ^ z[1] < (It(z[0] - nt) < gt ? ft : xt) : ft <= z[1] && z[1] <= xt : H > lt ^ (nt <= z[0] && z[0] <= ot)) {
        var Ct = In(U, (-st + ut) / et);
        return li(Ct, X), [z, _i(Ct)];
      }
    }
  }
  function x(N, m) {
    var I = f ? l : lt - l, _ = 0;
    return N < -I ? _ |= 1 : N > I && (_ |= 2), m < -I ? _ |= 4 : m > I && (_ |= 8), _;
  }
...
function ps(l, u, a) {
  ...
  l.scale(150).translate([0, 0]), g != null && l.clipExtent(null), zu(a, l.stream(Zr));
  var d = Zr.result(), p = Math.min(f / (d[1][0] - d[0][0]), h / (d[1][1] - d[0][1])), w = +u[0][0] + (f - p * (d[1][0] + d[0][0])) / 2, x = +u[0][1] + (h - p * (d[1][1] + d[0][1])) / 2;
  return g != null && l.clipExtent(g), l.scale(p * 150).translate([w, x]);
}
function no(l, u, a) {
  return ps(l, [[0, 0], u], a);
}
var jr = 16, io = dt(30 * Yt);
function Wr(l, u) {
...
function so(l, u) {
  function a(f, h, g, d, p, w, x, N, m, I, _, S, R, O) {
    var A = x - f, M = N - h, b = A * A + M * M;
    if (b > 4 * u && R--) {
      var q = d + I, G = p + _, B = w + S, X = Ye(q * q + G * G + B * B), V = Ee(B /= X), U = It(It(B) - 1) < gt || It(g - m) < gt ? (g + m) / 2 : Fe(G, q), st = l(U, V), et = st[0], rt = st[1], ut = et - f, z = rt - h, nt = M * ut - A * z;
      (nt * nt / b > u || It((A * ut + M * z) / b - 0.5) > 0.3 || d * I + p * _ + w * S < io) && (a(f, h, g, d, p, w, et, rt, U, q /= X, G /= X, B, R, O), O.point(et, rt), a(et, rt, U, q, G, B, x, N, m, I, _, S, R, O));
    }
  }
  return function(f) {
    var h, g, d, p, w, x, N, m, I, _, S, R, O = {
      point: A,
      lineStart: M,
      lineEnd: q,
      polygonStart: function() {
        f.polygonStart(), O.lineStart = G;
      },
      polygonEnd: function() {
        f.polygonEnd(), O.lineStart = M;
      }
    };
    function A(V, U) {
    ...
    function M() {
      m = NaN, O.point = b, f.lineStart();
    }
    function b(V, U) {
      var st = Ge([V, U]), et = l(V, U);
      a(m, I, N, _, S, R, m = et[0], I = et[1], N = V, _ = st[0], S = st[1], R = st[2], jr, f), f.point(m, I);
    }
    function q() {
      O.point = A, f.lineEnd();
    }
    function G() {
      M(), O.point = B, O.lineEnd = X;
    }
    function B(V, U) {
      b(h = V, U), g = m, d = I, p = _, w = S, x = R, O.point = b;
    }
    function X() {
      a(m, I, N, _, S, R, g, d, h, p, w, x, jr, f), O.lineEnd = q, q();
    }
    return O;
  };
}
...
function oo(l) {
  var u, a = 150, f = 480, h = 250, g, d, p = 0, w = 0, x = 0, N = 0, m = 0, I, _, S = null, R = $r, O = null, A, M, b, q = Hr, G = 0.5, B = Wr(et, G), X, V;
  function U(z) {
    return z = _(z[0] * Yt, z[1] * Yt), [z[0] * a + g, d - z[1] * a];
  }
  function st(z) {
    return z = _.invert((z[0] - g) / a, (d - z[1]) / a), z && [z[0] * oe, z[1] * oe];
  }
  function et(z, nt) {
    return z = u(z, nt), [z[0] * a + g, d - z[1] * a];
  }
  U.stream = function(z) {
    return X && V === z ? X : X = ao(R(I, B(q(V = z))));
  }, U.clipAngle = function(z) {
    return arguments.length ? (R = +z ? eo(S = z * Yt, 6 * Yt) : (S = null, $r), ut()) : S * oe;
  }, U.clipExtent = function(z) {
    return arguments.length ? (q = z == null ? (O = A = M = b = null, Hr) : Zu(O = +z[0][0], A = +z[0][1], M = +z[1][0], b = +z[1][1]), ut()) : O == null ? null : [[O, A], [M, b]];
  }, U.scale = function(z) {
    ...
    return arguments.length ? (x = z[0] % 360 * Yt, N = z[1] % 360 * Yt, m = z.length > 2 ? z[2] % 360 * Yt : 0, rt()) : [x * oe, N * oe, m * oe];
  }, U.precision = function(z) {
    return arguments.length ? (B = Wr(et, G = z * z), ut()) : Ye(G);
...
function xs(l) {
  return function(u, a) {
    var f = Ye(u * u + a * a), h = l(f), g = pt(h), d = dt(h);
    return [
      Fe(u * g, f * d),
      Ee(f && a * g / f)
    ];
...
function vo(l, u, a) {
  ...
  switch (l.type) {
    case "GeometryCollection":
      return Dn(l, function(d) {
        var p = Tn(d, u, f, h);
        p && g.push(p);
      }), De(g);
    case "FeatureCollection":
      return Or(l, function(d) {
        var p = Tn(d, u, f, h);
        p && Or(p, function(w) {
          w && g.push(w);
        });
...
function Tn(l, u, a, f) {
  ...
  }, x = new fo(), N = x.read(w), m = Da(Fa(u, a), "meters"), I = co.bufferOp(N, m, f), _ = new go();
  if (I = _.write(I), !Es(I.coordinates)) {
    var S = {
      type: I.type,
...
function po(l) {
  ...
  return f.length === 0 ? null : f.length === 1 ? Ii(f[0], a) : es(f, a);
}
var _o = po;
function Jr(l) {
  let u;
...
function ko(l, u = !0, a = !0, f = {}, h = {}, g = (d) => {
  var x, N, m;
  const p = (x = d == null ? void 0 : d.geometry) == null ? void 0 : x.type, w = (N = d == null ? void 0 : d.properties) != null && N.isMask ? 0 : p === "LineString" || p === "MultiLineString" ? 3 : 2;
  return {
    color: "#3170fe",
    fillColor: "#000",
    fillOpacity: (m = d == null ? void 0 : d.properties) != null && m.isMask ? 0.1 : 0,
    weight: w,
    dashArray: [w, w],
    lineCap: "butt"
  };
  ...
  const p = [];
  let w, x;
  const N = Oe.geoJSON(void 0, {
    style: g,
    interactive: !1
  }).addTo(l), m = (_) => {
    d == null || d({
      type: "mapClick",
      coordinates: [_.latlng.lng, _.latlng.lat]
    });
  };
  function I(_, S = !1) {
    const R = document.createElement("div");
    return new Mu({ props: { displayIn: "leaflet" }, target: R }), new Oe.Marker(_, {
      interactive: S,
      icon: new Oe.DivIcon({
        html: R,
        className: "",
  ...
  return {
    setEventHandler(_) {
      _ ? (d = _, l.on("click", m)) : (d = void 0, l.off("click", m));
    },
    flyTo(_, S) {
      l.flyTo([_[1], _[0]], S, { duration: 2, ...f });
    },
    fitBounds(_, S, R) {
      l.flyToBounds(
        [
        ...
        { padding: [S, S], duration: 2, maxZoom: R, ...h }
      );
    },
    indicateReverse(_) {
      l.getContainer().style.cursor = _ ? "crosshair" : "";
    },
    setReverseMarker(_) {
      var R;
      if (!u)
        return;
      const S = _ && [_[1], _[0]];
      x ? S ? x.setLatLng(S) : (x.remove(), x = void 0) : S && (x = (typeof u == "object" ? new Oe.Marker(S, u) : I(S)).addTo(l), (R = x.getElement()) == null || R.classList.add("marker-reverse"));
    },
    setMarkers(_, S) {
      if (!u)
        return;
      function R(O) {
        N.clearLayers(), O && N.addData(O);
      }
      for (const O of p)
        O.remove();
      if (p.length = 0, R(), S) {
        ...
        if (S.geometry.type === "GeometryCollection") {
          const M = S.geometry.geometries.filter(
          ...
          t: if (M.length > 0) {
            ...
            const b = S.geometry.geometries.filter(
        ...
        if (!O) {
          if (S.geometry.type === "Polygon" || S.geometry.type === "MultiPolygon")
            Kr(S, R);
          else if (S.geometry.type === "LineString" || S.geometry.type === "MultiLineString") {
            R(S);
            return;
          }
        }
        const A = [S.center[1], S.center[0]];
        p.push(
          (typeof u == "object" ? new Oe.Marker(A, u) : I(A)).addTo(l)
        );
      }
      if (a)
        for (const O of _ ?? []) {
          ...
          const A = [
            O.center[1],
            O.center[0]
          ], M = typeof a == "object" ? new Oe.Marker(A, a) : I(A, !0);
          M.addTo(l).bindTooltip(
          ...
          b && (b.addEventListener("click", (q) => {
            q.stopPropagation(), d == null || d({ type: "markerClick", id: O.id });
          }), b.addEventListener("mouseenter", () => {
            d == null || d({ type: "markerMouseEnter", id: O.id });
          }), b.addEventListener("mouseleave", () => {
            d == null || d({ type: "markerMouseLeave", id: O.id });
          }), b.classList.toggle("marker-fuzzy", !!O.matching_text)), p.push(M);
        }
    },
    setSelectedMarker(_) {
      var S, R;
      w && ((S = w.getElement()) == null || S.classList.toggle("marker-selected", !1)), w = _ > -1 ? p[_] : void 0, (R = w == null ? void 0 : w.getElement()) == null || R.classList.toggle("marker-selected", !0);
    },
    getCenterAndZoom() {
      const _ = l.getCenter();
      return [l.getZoom(), _.lng, _.lat];
    }
  };
}
export {
  ko as createLeafletMapController
};
