...
var er = (o, a, s) => Ou(o, typeof a != "symbol" ? a + "" : a, s), as = (o, a, s) => a.has(o) || ss("Cannot " + s);
var Et = (o, a, s) => (as(o, a, "read from private field"), s ? s.call(o) : a.get(o)), tr = (o, a, s) => a.has(o) ? ss("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(o) : a.set(o, s), gi = (o, a, s, l) => (as(o, a, "write to private field"), l ? l.call(o, s) : a.set(o, s), s);
import * as Pt from "leaflet";
function Le() {
}
function Mu(o, a) {
...
let di;
function Xe(o, a) {
  return o === a ? !0 : (di || (di = document.createElement("a")), di.href = a, o === di.href);
}
function Pu(o) {
...
function ua(o, a, s, l) {
  return o[1] && l ? Mu(s.ctx.slice(), o[1](l(a))) : s.ctx;
}
function Du(o, a, s, l) {
  if (o[2] && l) {
    const h = o[2](l(s));
...
function Bu(o, a, { bubbles: s = !1, cancelable: l = !1 } = {}) {
...
const Sn = [], ur = [];
let Ln = [];
const cs = [], Wu = /* @__PURE__ */ Promise.resolve();
let or = !1;
function Vu() {
  or || (or = !0, Wu.then(la));
}
...
function la() {
  ...
  do {
    ...
    for (Qn(null), Sn.length = 0, In = 0; ur.length; ) ur.pop()();
...
function Hu(o) {
  if (o.fragment !== null) {
    ...
    const a = o.dirty;
    o.dirty = [-1], o.fragment && o.fragment.p(o.ctx, a), o.after_update.forEach(lr);
  }
}
function Zu(o) {
  const a = [], s = [];
...
function xi() {
  on.r || Gt(on.c), on = on.p;
}
function De(o, a) {
  o && o.i && (ki.delete(o), o.i(a));
}
function ze(o, a, s, l) {
  if (o && o.o) {
    if (ki.has(o)) return;
    ki.add(o), on.c.push(() => {
      ki.delete(o), l && (s && o.d(1), l());
    }), o.o(a);
  } else l && l();
}
function fs(o) {
...
function Qu(o, a, s, l, h, g, v, m, N, _, k, y) {
  let x = o.length, E = g.length, I = x;
  const R = {};
  for (; I--; ) R[o[I].key] = I;
  const T = [], M = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), C = [];
  for (I = E; I--; ) {
    const z = y(h, g, I), X = s(z);
    let G = v.get(X);
    G ? C.push(() => G.p(z, a)) : (G = _(X, z), G.c()), M.set(X, T[I] = G), X in R && F.set(X, Math.abs(I - R[X]));
  }
  const q = /* @__PURE__ */ new Set(), O = /* @__PURE__ */ new Set();
  function B(z) {
    De(z, 1), z.m(m, k), v.set(z.key, z), k = z.first, E--;
  }
  for (; x && E; ) {
    const z = T[E - 1], X = o[x - 1], G = z.key, Z = X.key;
    z === X ? (k = z.first, x--, E--) : M.has(Z) ? !v.has(G) || q.has(G) ? B(z) : O.has(Z) ? x-- : F.get(G) > F.get(Z) ? (O.add(G), B(z)) : (q.add(Z), x--) : (N(X, v), x--);
  }
  for (; x--; ) {
    const z = o[x];
    M.has(z.key) || N(z, v);
...
function Ft(o, a) {
  const s = o.$$;
  s.fragment !== null && (Zu(s.after_update), Gt(s.on_destroy), s.fragment && s.fragment.d(a), s.on_destroy = s.fragment = null, s.ctx = []);
}
function Ku(o, a) {
  o.$$.dirty[0] === -1 && (Sn.push(o), Vu(), o.$$.dirty.fill(0)), o.$$.dirty[a / 31 | 0] |= 1 << a % 31;
}
function jt(o, a, s, l, h, g, v = null, m = [-1]) {
  const N = Jn;
  Qn(o);
  const _ = o.$$ = {
    fragment: null,
    ...
    before_update: [],
    after_update: [],
    context: new Map(a.context || (N ? N.$$.context : [])),
    // everything else
    callbacks: us(),
    dirty: m,
    skip_bound: !1,
    root: a.target || N.$$.root
  };
  v && v(_.root);
  let k = !1;
  if (_.ctx = s ? s(o, a.props || {}, (y, x, ...E) => {
    const I = E.length ? E[0] : x;
    return _.ctx && h(_.ctx[y], _.ctx[y] = I) && (!_.skip_bound && _.bound[y] && _.bound[y](I), k && Ku(o, y)), x;
    ...
    a.intro && De(o.$$.fragment), Dt(o, a.target, a.anchor), la();
  }
  Qn(N);
}
class Qt {
   ...
   */
  $set(a) {
    this.$$set && !Pu(a) && (this.$$.skip_bound = !0, this.$$set(a), this.$$.skip_bound = !1);
  }
}
const Ju = "4";
typeof window < "u" && (window.__svelte || (window.__svelte = { v: /* @__PURE__ */ new Set() })).v.add(Ju);
function $u(o) {
  let a, s;
  return {
    c() {
      a = Nt("svg"), s = Nt("path"), Y(s, "d", "M13.12.706a.982.982 0 0 0-1.391 0L6.907 5.517 2.087.696a.982.982 0 1 0-1.391 1.39l4.821 4.821L.696 11.73a.982.982 0 1 0 1.39 1.39l4.821-4.821 4.822 4.821a.982.982 0 1 0 1.39-1.39L8.298 6.908l4.821-4.822a.988.988 0 0 0 0-1.38Z"), Y(a, "viewBox", "0 0 14 14"), Y(a, "width", "13"), Y(a, "height", "13"), Y(a, "class", "svelte-en2qvf");
    },
    m(l, h) {
      Ce(l, a, h), de(a, s);
    },
...
function eo(o) {
  ...
  return {
    c() {
      a = Nt("svg"), s = Nt("path"), Y(s, "d", "M15 0C6.705 0 0 6.705 0 15C0 23.295 6.705 30 15 30C23.295 30 30 23.295 30 15C30 6.705 23.295 0 15 0ZM22.5 20.385L20.385 22.5L15 17.115L9.615 22.5L7.5 20.385L12.885 15L7.5 9.615L9.615 7.5L15 12.885L20.385 7.5L22.5 9.615L17.115 15L22.5 20.385Z"), Y(a, "viewBox", "0 0 30 30"), Y(a, "fill", "none"), Y(a, "xmlns", "http://www.w3.org/2000/svg"), Y(a, "class", "svelte-d2loi5");
    },
    m(l, h) {
      Ce(l, a, h), de(a, s);
    },
...
function to(o) {
  ...
  return {
    c() {
      ...
      o[3] + "area.svg") || Y(a, "src", s), Y(
        a,
        "alt",
        /*placeType*/
        o[6]
      ), Y(a, "class", "svelte-ltkwvy");
    },
    m(l, h) {
      Ce(l, a, h);
    },
    p(l, h) {
      ...
      l[3] + "area.svg") && Y(a, "src", s), h & /*placeType*/
      64 && Y(
        a,
        "alt",
        /*placeType*/
...
function no(o) {
  ...
  return {
    ...
    p(l, h) {
      h & /*iconsBaseUrl*/
      8 && !Xe(a.src, s = /*iconsBaseUrl*/
      l[3] + "reverse.svg") && Y(a, "src", s), h & /*placeType*/
      64 && Y(
        a,
        "alt",
        /*placeType*/
...
function io(o) {
  ...
  return {
    ...
    p(l, h) {
      h & /*iconsBaseUrl*/
      8 && !Xe(a.src, s = /*iconsBaseUrl*/
      l[3] + "poi.svg") && Y(a, "src", s), h & /*placeType*/
      64 && Y(
        a,
        "alt",
        /*placeType*/
...
function ro(o) {
  ...
  return {
    c() {
      a = _e("img"), Xe(a.src, s = /*iconsBaseUrl*/
      o[3] + "postal_code.svg") || Y(a, "src", s), Y(
        a,
        "alt",
        /*placeType*/
        o[6]
    ...
    p(l, h) {
      h & /*iconsBaseUrl*/
      8 && !Xe(a.src, s = /*iconsBaseUrl*/
      l[3] + "postal_code.svg") && Y(a, "src", s), h & /*placeType*/
      64 && Y(
        a,
        "alt",
        /*placeType*/
...
function so(o) {
  ...
  return {
    ...
    p(l, h) {
      h & /*iconsBaseUrl*/
      8 && !Xe(a.src, s = /*iconsBaseUrl*/
      l[3] + "street.svg") && Y(a, "src", s), h & /*placeType*/
      64 && Y(
        a,
        "alt",
        /*placeType*/
...
function ao(o) {
  ...
  return {
    ...
    p(l, h) {
      h & /*iconsBaseUrl*/
      8 && !Xe(a.src, s = /*iconsBaseUrl*/
      l[3] + "road.svg") && Y(a, "src", s), h & /*placeType*/
      64 && Y(
        a,
        "alt",
        /*placeType*/
...
function uo(o) {
  ...
  return {
    c() {
      a = _e("img"), Xe(a.src, s = /*iconsBaseUrl*/
      o[3] + "housenumber.svg") || Y(a, "src", s), Y(
        a,
        "alt",
        /*placeType*/
        o[6]
    ...
    p(l, h) {
      h & /*iconsBaseUrl*/
      8 && !Xe(a.src, s = /*iconsBaseUrl*/
      l[3] + "housenumber.svg") && Y(a, "src", s), h & /*placeType*/
      64 && Y(
        a,
        "alt",
        /*placeType*/
  ...
  return {
    c() {
      a = _e("span"), s = Wt(
        /*placeType*/
        o[6]
      ), Y(a, "class", "secondary svelte-ltkwvy");
    },
    m(l, h) {
      Ce(l, a, h), de(a, s);
    },
...
function lo(o) {
  ...
  function C(G, Z) {
    ...
    G[5] ? oo : (
      ...
      G[0].address ? uo : (
        ...
        ((j = G[0].properties) == null ? void 0 : j.kind) === "road_relation" ? ao : (s == null && (s = !!/*feature*/
        G[0].id.startsWith("address.")), s ? so : (l == null && (l = !!/*feature*/
        G[0].id.startsWith("postal_code.")), l ? ro : (h == null && (h = !!/*feature*/
        G[0].id.startsWith("poi.")), h ? io : (
          /*isReverse*/
          G[7] ? no : to
        ))))
      )
  ...
  let q = C(o, -1), O = q(o), B = x && gs(o);
  return {
    c() {
      a = _e("li"), O.c(), g = at(), v = _e("span"), m = _e("span"), N = _e("span"), k = Wt(_), y = at(), B && B.c(), E = at(), I = _e("span"), T = Wt(R), Y(N, "class", "primary svelte-ltkwvy"), Y(m, "class", "svelte-ltkwvy"), Y(I, "class", "line2 svelte-ltkwvy"), Y(v, "class", "texts svelte-ltkwvy"), Y(a, "tabindex", "0"), Y(
        a,
        "data-selected",
        /*selected*/
        o[1]
      ), Y(a, "class", "svelte-ltkwvy"), yt(
        a,
        "selected",
        /*selected*/
        o[1]
    ...
    m(G, Z) {
      Ce(G, a, Z), O.m(a, null), de(a, g), de(a, v), de(v, m), de(m, N), de(N, k), de(m, y), B && B.m(m, null), de(v, E), de(v, I), de(I, T), M || (F = [
        je(
          a,
          "mouseenter",
          /*mouseenter_handler*/
    ...
    p(G, [Z]) {
      var ee, j;
      q === (q = C(G, Z)) && O ? O.p(G, Z) : (O.d(1), O = q(G), O && (O.c(), O.m(a, g))), Z & /*feature*/
      1 && _ !== (_ = /*isReverse*/
      (G[7] ? (
        /*feature*/
        G[0].place_name
      ...
      )) + "") && Kn(k, _), Z & /*showPlaceType, feature, imageUrl*/
      37 && (x = /*showPlaceType*/
      ...
      G[5]) && !/*isReverse*/
      G[7]), x ? B ? B.p(G, Z) : (B = gs(G), B.c(), B.m(m, null)) : B && (B.d(1), B = null), Z & /*feature*/
      1 && R !== (R = /*isReverse*/
      (G[7] ? "" : (
        /*feature*/
    ...
    o: Le,
    d(G) {
      G && be(a), O.d(), B && B.d(), M = !1, Gt(F);
    }
  };
}
function ho(o, a, s) {
  var C;
  let l, h, { feature: g } = a, { selected: v = !1 } = a, { showPlaceType: m } = a, { missingIconsCache: N } = a, { iconsBaseUrl: _ } = a;
  const k = (C = g.properties) == null ? void 0 : C.categories;
  let y, x, E = 0, I = g.place_type[0] === "reverse";
  function R() {
    x && N.add(x), s(10, E++, E);
  }
  function T(q) {
  ...
  const F = () => R();
  return o.$$set = (q) => {
    "feature" in q && s(0, g = q.feature), "selected" in q && s(1, v = q.selected), "showPlaceType" in q && s(2, m = q.showPlaceType), "missingIconsCache" in q && s(9, N = q.missingIconsCache), "iconsBaseUrl" in q && s(3, _ = q.iconsBaseUrl);
  }, o.$$.update = () => {
    var q, O, B, z;
    if (o.$$.dirty & /*loadIconAttempt, index, category, iconsBaseUrl, imageUrl, missingIconsCache*/
    3640)
      do
        s(11, l--, l), s(4, y = k == null ? void 0 : k[l]), s(5, x = y ? _ + y.replace(/ /g, "_") + ".svg" : void 0);
      while (l > -1 && (!x || N.has(x)));
    o.$$.dirty & /*feature*/
    1 && s(6, h = g.id.startsWith("poi.") ? (O = (q = g.properties) == null ? void 0 : q.categories) == null ? void 0 : O.join(", ") : ((z = (B = g.properties) == null ? void 0 : B.place_type_name) == null ? void 0 : z[0]) ?? g.place_type[0]);
...
function mo(o) {
  ...
  return {
    c() {
      a = Nt("svg"), s = Nt("path"), Y(s, "stroke-width", "4"), Y(s, "d", "M 5,33.103579 C 5,17.607779 18.457,5 35,5 C 51.543,5 65,17.607779 65,33.103579 C 65,56.388679 40.4668,76.048179 36.6112,79.137779 C 36.3714,79.329879 36.2116,79.457979 36.1427,79.518879 C 35.8203,79.800879 35.4102,79.942779 35,79.942779 C 34.5899,79.942779 34.1797,79.800879 33.8575,79.518879 C 33.7886,79.457979 33.6289,79.330079 33.3893,79.138079 C 29.5346,76.049279 5,56.389379 5,33.103579 Z M 35.0001,49.386379 C 43.1917,49.386379 49.8323,42.646079 49.8323,34.331379 C 49.8323,26.016779 43.1917,19.276479 35.0001,19.276479 C 26.8085,19.276479 20.1679,26.016779 20.1679,34.331379 C 20.1679,42.646079 26.8085,49.386379 35.0001,49.386379 Z"), Y(s, "class", "svelte-gzo3ar"), Y(a, "width", l = /*displayIn*/
      o[0] === "list" ? 20 : void 0), Y(a, "viewBox", "0 0 70 85"), Y(a, "fill", "none"), Y(a, "class", "svelte-gzo3ar"), yt(
        a,
        "in-map",
        /*displayIn*/
        o[0] !== "list"
    ...
    p(h, [g]) {
      g & /*displayIn*/
      1 && l !== (l = /*displayIn*/
      h[0] === "list" ? 20 : void 0) && Y(a, "width", l), g & /*displayIn*/
      1 && yt(
        a,
        "in-map",
        /*displayIn*/
...
class yo extends Qt {
  constructor(a) {
    super(), jt(this, a, vo, mo, Zt, { displayIn: 0 });
  }
}
function po(o) {
  let a, s;
...
function ko(o) {
  ...
  return {
    c() {
      a = Nt("svg"), s = Nt("circle"), l = Nt("path"), Y(s, "cx", "4.789"), Y(s, "cy", "4.787"), Y(s, "r", "3.85"), Y(s, "class", "svelte-1aq105l"), Y(l, "d", "M12.063 12.063 7.635 7.635"), Y(l, "class", "svelte-1aq105l"), Y(a, "xmlns", "http://www.w3.org/2000/svg"), Y(a, "width", "13"), Y(a, "height", "13"), Y(a, "viewBox", "0 0 13 13"), Y(a, "class", "svelte-1aq105l");
    },
    m(h, g) {
  ...
  for (const h of a ?? [])
    if (!(l && (h.minZoom != null && h.minZoom > l[0] || h.maxZoom != null && h.maxZoom < l[0]))) {
      ...
      e: if (h.type === "client-geolocation") {
        if (Wn && h.cachedLocationExpiry && Wn.time + h.cachedLocationExpiry > Date.now()) {
          if (!Wn.coords)
            break e;
          return Wn.coords;
        }
        ...
        try {
          return g = await new Promise((v, m) => {
            s.signal.addEventListener("abort", () => {
              ...
              (N) => {
                v(
                  [N.coords.longitude, N.coords.latitude].map((_) => _.toFixed(6)).join(",")
                );
              },
              (N) => {
                m(N);
...
const Io = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(EAST|WEST|[EW])?$/i, ms = /^([+-]?[0-8]?[0-9])\s+([0-5]?[0-9]\.\d{3,})[\s,]{1,}([+-]?[0-1]?[0-9]?[0-9])\s+([0-5]?[0-9]\.\d{3,})$/, vs = /^(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?$/i, ys = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?$/i, ps = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?$/i, _s = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?$/i;
function wo(o) {
  if (!["DMS", "DM", "DD"].includes(o))
    throw new Error("invalid format specified");
  if (this.decimalCoordinates && this.decimalCoordinates.trim()) {
    const a = this.decimalCoordinates.split(",").map((E) => Number(E.trim())), s = Number(a[0]), l = Number(a[1]), h = Math.abs(s), g = Math.abs(l), v = s > 0 ? "N" : "S", m = l > 0 ? "E" : "W";
    let N;
    o == "DD" && (N = `${h}° ${v}, ${g}° ${m}`);
    const _ = Math.floor(h), k = Math.floor(g), y = (h - _) * 60, x = (g - k) * 60;
    if (o == "DM") {
      let E = ks(y, 3).toFixed(3).padStart(6, "0"), I = ks(x, 3).toFixed(3).padStart(6, "0");
      E.endsWith(".000") && I.endsWith(".000") && (E = E.replace(/\.000$/, ""), I = I.replace(/\.000$/, "")), N = `${_}° ${E}' ${v}, ${k}° ${I}' ${m}`;
    }
    if (o == "DMS") {
      const E = Math.floor(y), I = Math.floor(x);
      let R = ((y - E) * 60).toFixed(1).padStart(4, "0"), T = ((x - I) * 60).toFixed(1).padStart(4, "0");
      const M = E.toString().padStart(2, "0"), F = I.toString().padStart(2, "0");
      R.endsWith(".0") && T.endsWith(".0") && (R = R.replace(/\.0$/, ""), T = T.replace(/\.0$/, "")), N = `${_}° ${M}' ${R}" ${v}, ${k}° ${F}' ${T}" ${m}`;
    }
    return N;
  } else
...
function kr(o, a) {
  ...
  if (ms.test(o))
    ...
    if (m = _s.exec(o), N = Vn(m), m.filter((_) => _).length <= 5)
  ...
  if (N) {
    ...
    const k = m[0].trim();
    let y, x;
    const E = /[,/;\u0020]/g, I = k.match(E);
    if (I == null) {
      const M = Math.floor(o.length / 2);
      y = k.substring(0, M).trim(), x = k.substring(M).trim();
    } else {
      let M;
      I.length % 2 == 1 ? M = Math.floor(I.length / 2) : M = I.length / 2 - 1;
      let F = 0;
      if (M == 0)
        F = k.indexOf(I[0]), y = k.substring(0, F).trim(), x = k.substring(F + 1).trim();
      else {
        let C = 0, q = 0;
        for (; C <= M; )
          F = k.indexOf(I[C], q), q = F + 1, C++;
        y = k.substring(0, F).trim(), x = k.substring(F + 1).trim();
      }
    }
    const R = y.split(".");
...
function Vn(o) {
  ...
  for (let g = 0; g < h; g++) {
    const v = a[g], m = a[g + h], N = s.test(v) && s.test(m), _ = l.test(v) && l.test(m), k = v == m;
    if (!(v == null && m == null)) {
      if (v == null || m == null)
        return !1;
      if (N || _ || k)
...
function So(o) {
  ...
  if (o.includes(",")) {
    ...
    return Es(this.decimalLatitude, Number(a[0])) && Es(this.decimalLongitude, a[1]);
  } else
...
function Oo() {
  const o = [];
  return bo.forEach((a) => {
    a.decimalLatitude ? o.push(a) : o.push({ ...a, ...To });
  }), [...o, ...Co, ...Ro];
}
const Mo = Oo();
kr.formats = Mo.map((o) => o.verbatimCoordinates);
const Po = kr;
function xs(o, a, s) {
  const l = o.slice();
...
function Is(o) {
  ...
  return s = new _o({}), {
    c() {
      a = _e("button"), Vt(s.$$.fragment), Y(a, "type", "button"), Y(
        a,
        "title",
        /*reverseButtonTitle*/
        o[9]
      ), Y(a, "class", "svelte-zh3kmv"), yt(
        a,
        "active",
        /*reverseActive*/
        o[0]
    ...
    m(v, m) {
      Ce(v, a, m), Dt(s, a, null), l = !0, h || (g = je(
        a,
        "click",
        /*click_handler_2*/
        o[67]
...
function Ao(o) {
  let a, s = [], l = /* @__PURE__ */ new Map(), h, g, v, m = fs(
    /*listFeatures*/
    o[14]
  );
  const N = (_) => (
  ...
  return {
    ...
    p(_, k) {
      ...
      17880064 && (m = fs(
        /*listFeatures*/
        _[14]
      ), Ei(), s = Qu(s, k, N, 1, _, m, l, a, ju, ws, null, xs), xi());
    },
    i(_) {
      if (!h) {
...
function Do(o) {
  ...
  return s = new ca({}), {
    c() {
      a = _e("div"), Vt(s.$$.fragment), l = at(), h = _e("div"), g = Wt(
        /*noResultsMessage*/
        o[7]
      ), Y(h, "class", "svelte-zh3kmv"), Y(a, "class", "no-results svelte-zh3kmv");
    },
    m(m, N) {
      Ce(m, a, N), Dt(s, a, null), de(a, l), de(a, h), de(h, g), v = !0;
    },
    p(m, N) {
      (!v || N[0] & /*noResultsMessage*/
      128) && Kn(
        g,
        /*noResultsMessage*/
        m[7]
...
function Go(o) {
  let a, s, l, h, g, v, m, N, _, k, y;
  return s = new ca({}), N = new ha({}), {
    c() {
      a = _e("div"), Vt(s.$$.fragment), l = at(), h = _e("div"), g = Wt(
        /*errorMessage*/
        o[6]
      ), v = at(), m = _e("button"), Vt(N.$$.fragment), Y(h, "class", "svelte-zh3kmv"), Y(m, "class", "svelte-zh3kmv"), Y(a, "class", "error svelte-zh3kmv");
    },
    m(x, E) {
      Ce(x, a, E), Dt(s, a, null), de(a, l), de(a, h), de(h, g), de(a, v), de(a, m), Dt(N, m, null), _ = !0, k || (y = je(
        m,
        "click",
        /*click_handler_3*/
        o[68]
    ...
    i(x) {
      _ || (De(s.$$.fragment, x), De(N.$$.fragment, x), _ = !0);
    },
    o(x) {
      ze(s.$$.fragment, x), ze(N.$$.fragment, x), _ = !1;
    },
    d(x) {
      x && be(a), Ft(s), Ft(N), k = !1, y();
    }
  };
}
function ws(o, a) {
  ...
  return l = new co({
    ...
    first: null,
    c() {
      s = qu(), Vt(l.$$.fragment), this.first = s;
    },
    m(m, N) {
      Ce(m, s, N), Dt(l, m, N), h = !0;
    },
    p(m, N) {
      a = m;
      const _ = {};
      ...
      a[81]), N[0] & /*showPlaceType*/
      1024 && (_.showPlaceType = /*showPlaceType*/
      a[10]), N[0] & /*selectedItemIndex, listFeatures*/
      49152 && (_.selected = /*selectedItemIndex*/
      a[15] === /*i*/
      a[83]), N[0] & /*iconsBaseUrl*/
...
function qo(o) {
  let a, s, l, h, g, v, m, N, _, k, y, x, E, I, R, T, M, F, C, q, O, B = !1;
  g = new Eo({}), y = new ha({});
  let z = (
    /*abortController*/
    o[19] && Ns()
  ...
  function ce(D, K) {
    ...
    return (
      ...
      D[18] ? 0 : (
        ...
        D[16] ? (
          /*listFeatures*/
          ((se = D[14]) == null ? void 0 : se.length) === 0 ? 2 : (
            /*focusedDelayed*/
            D[16] && /*listFeatures*/
            ((me = D[14]) != null && me.length) ? 3 : -1
          )
        ) : 1
      )
    );
  }
  return ~(T = ce(o)) && (M = j[T] = ee[T](o)), {
    c() {
      a = at(), s = _e("form"), l = _e("div"), h = _e("button"), Vt(g.$$.fragment), v = at(), m = _e("input"), N = at(), _ = _e("div"), k = _e("button"), Vt(y.$$.fragment), x = at(), z && z.c(), E = at(), X && X.c(), I = at(), Z && Z.c(), R = at(), M && M.c(), Y(h, "class", "search-button svelte-zh3kmv"), Y(h, "type", "button"), Y(
        m,
        "placeholder",
        /*placeholder*/
        o[8]
        ...
        /*placeholder*/
        o[8]
      ), Y(m, "class", "svelte-zh3kmv"), Y(k, "type", "button"), Y(
        k,
        "title",
        /*clearButtonTitle*/
        o[3]
      ), Y(k, "class", "svelte-zh3kmv"), Y(_, "class", "clear-button-container svelte-zh3kmv"), yt(
        _,
        "displayable",
        /*searchValue*/
        o[1] !== ""
      ), Y(l, "class", "input-group svelte-zh3kmv"), Y(s, "tabindex", "0"), Y(s, "class", F = os(
        /*className*/
        o[2]
      ) + " svelte-zh3kmv"), yt(
        s,
    ...
    m(D, K) {
      Ce(D, a, K), Ce(D, s, K), de(s, l), de(l, h), Dt(g, h, null), de(l, v), de(l, m), o[61](m), ls(
        m,
        /*searchValue*/
        o[1]
      ), de(l, N), de(l, _), de(_, k), Dt(y, k, null), de(_, x), z && z.m(_, null), de(l, E), X && X.m(l, null), de(l, I), Z && Z.m(l, null), de(s, R), ~T && j[T].m(s, null), C = !0, q || (O = [
        je(
          h,
          "click",
          /*click_handler*/
    ...
    p(D, K) {
      ...
      D[19] ? z ? K[0] & /*abortController*/
      524288 && De(z, 1) : (z = Ns(), z.c(), De(z, 1), z.m(_, null)) : z && (Ei(), ze(z, 1, 1, () => {
        z = null;
      }), xi()), (!C || K[0] & /*searchValue*/
      2) && yt(
        _,
        "displayable",
        /*searchValue*/
      ...
      D[5] === !0 ? X ? (X.p(D, K), K[0] & /*enableReverse*/
      32 && De(X, 1)) : (X = Is(D), X.c(), De(X, 1), X.m(l, I)) : X && (Ei(), ze(X, 1, 1, () => {
        X = null;
      }), xi()), Z && Z.p && (!C || K[1] & /*$$scope*/
      134217728) && Fu(
        Z,
        G,
        D,
      ...
      let se = T;
      T = ce(D), T === se ? ~T && j[T].p(D, K) : (M && (Ei(), ze(j[se], 1, 1, () => {
        j[se] = null;
      }), xi()), ~T ? (M = j[T], M ? M.p(D, K) : (M = j[T] = ee[T](D), M.c()), De(M, 1), M.m(s, null)) : M = null), (!C || K[0] & /*className*/
      4 && F !== (F = os(
        /*className*/
        D[2]
      ) + " svelte-zh3kmv")) && Y(s, "class", F), (!C || K[0] & /*className, collapsed, searchValue*/
      22) && yt(
        s,
        "can-collapse",
        /*collapsed*/
...
function zo(o, a, s) {
  ...
  function ri(A, Se = !0, Fe = !1) {
    s(1, j = A), Se ? (s(15, xe = -1), fn()) : (tt(!Fe, Fe), setTimeout(() => {
      Qe.focus(), Qe.select();
    }));
  }
  function ke() {
  ...
  let w = !1, oe, we, ae, Pn = "", Qe, xe = -1, U, Jt = [], It, Ke, cn, ue;
  const $t = /* @__PURE__ */ new Set(), et = Xu();
  Uu(() => {
  ...
  async function en(A, { byId: Se = !1, exact: Fe = !1 } = {}) {
    s(18, U = void 0), It == null || It.abort();
    const We = new AbortController();
    s(19, It = We);
    try {
      const fe = te(A), Ve = new URLSearchParams();
      if (C !== void 0 && Ve.set("language", Array.isArray(C) ? C.join(",") : C ?? ""), Ee && Ve.set("types", Ee.join(",")), Q && Ve.set("excludeTypes", String(Q)), N && Ve.set("bbox", N.map((mn) => mn.toFixed(6)).join(",")), x && Ve.set("country", Array.isArray(x) ? x.join(",") : x), !Se && !fe) {
        const mn = await No(O, G, We);
        mn && Ve.set("proximity", mn), (Fe || !K) && Ve.set("autocomplete", "false"), Ve.set("fuzzyMatch", String(F));
      }
      q !== void 0 && (!fe || (Ee == null ? void 0 : Ee.length) === 1) && Ve.set("limit", String(q)), Ve.set("key", m), Mn(Ve);
      const lt = qe + "/" + encodeURIComponent(fe ? fe.decimalLongitude + "," + fe.decimalLatitude : A) + ".json?" + Ve.toString();
      if (lt === Pn) {
        Se ? (s(14, oe = void 0), s(55, ae = Jt[0])) : s(14, oe = Jt);
        return;
      }
      Pn = lt;
      const dn = await fetch(lt, { signal: We.signal, ...he });
      if (!dn.ok)
        throw new Error(await dn.text());
      const qt = await dn.json();
      et("response", { url: lt, featureCollection: qt }), Se ? (s(14, oe = void 0), s(55, ae = qt.features[0]), Jt = [ae]) : (s(14, oe = qt.features.filter(T)), fe && oe.unshift({
        type: "Feature",
        properties: {},
  ...
  function ge() {
    var Fe;
    if (!(we != null && we.length) || !M)
      return;
    const A = [180, 90, -180, -90], Se = !we.some((We) => !We.matching_text);
    for (const We of we)
      if (Se || !We.matching_text)
        for (const fe of [0, 1, 2, 3])
          A[fe] = Math[fe < 2 ? "min" : "max"](A[fe], ((Fe = We.bbox) == null ? void 0 : Fe[fe]) ?? We.center[fe % 2]);
    O && we.length > 0 && (ae && A[0] === A[2] && A[1] === A[3] ? O.flyTo(ae.center, Ae) : O.fitBounds(ds(A), 50, Ie));
  }
  function re(A) {
    s(0, Z = I === "always"), s(14, oe = void 0), s(55, ae = void 0), s(15, xe = -1), ri(A[1].toFixed(6) + ", " + xo(A[0], [-180, 180], !0).toFixed(6), !1, !0);
  }
  function Pi(A) {
    if (!oe)
      return;
    let Se = A.key === "ArrowDown" ? 1 : A.key === "ArrowUp" ? -1 : 0;
    Se && (xe === (se ? 0 : -1) && Se === -1 && s(15, xe = oe.length), s(15, xe += Se), xe >= oe.length && s(15, xe = -1), xe < 0 && se && s(15, xe = 0), A.preventDefault());
  }
  function tt(A = !0, Se = !1) {
    if (s(18, U = void 0), K || Se) {
      if (Ke && clearTimeout(Ke), j.length < B)
        return;
      const Fe = j;
      Ke = window.setTimeout(
        () => {
          en(Fe).catch((We) => s(18, U = We));
        },
        A ? E : 0
      );
    } else
  ...
  function An(A) {
    s(55, ae = A), s(1, j = A.place_name), s(15, xe = -1);
  }
  const ne = () => Qe.focus();
  function Ai(A) {
    ur[A ? "unshift" : "push"](() => {
  ...
  return o.$$set = (A) => {
    ...
    32 && j.length < B && (s(55, ae = void 0), s(14, oe = void 0), s(18, U = void 0), s(54, we = oe)), o.$$.dirty[1] & /*showFullGeometry, picked*/
    16777344 && ce && ae && !ae.address && ae.geometry.type === "Point" && ae.place_type[0] !== "reverse" && en(ae.id, { byId: !0 }).catch((A) => s(18, U = A)), o.$$.dirty[1] & /*mapController, picked, prevIdToFly, flyTo, maxZoom, zoom*/
    50356241 && (O && ae && ae.id !== ue && M && (!ae.bbox || ae.bbox[0] === ae.bbox[2] && ae.bbox[1] === ae.bbox[3] ? O.flyTo(ae.center, ae.id.startsWith("poi.") || ae.id.startsWith("address.") ? Ie : Ae) : O.fitBounds(ds(ae.bbox), 50, Ie), s(14, oe = void 0), s(54, we = void 0), s(15, xe = -1)), s(56, ue = ae == null ? void 0 : ae.id)), o.$$.dirty[0] & /*selectFirst, listFeatures*/
    ...
    8388624 && O && O.setEventHandler((A) => {
      switch (A.type) {
        ...
        case "markerClick":
          {
            const Se = oe == null ? void 0 : oe.find((Fe) => Fe.id === A.id);
            Se && An(Se);
          }
          break;
        case "markerMouseEnter":
          we && s(15, xe = cn ? (oe == null ? void 0 : oe.findIndex((Se) => Se.id === A.id)) ?? -1 : -1);
          break;
    ...
    67133969 && O && l && M && me && O.flyTo(l.center, l.id.startsWith("poi.") || l.id.startsWith("address.") ? Ie : Ae), o.$$.dirty[1] & /*markerOnSelected, mapController*/
    1040 && (Re || O == null || O.setMarkers(void 0, void 0)), o.$$.dirty[1] & /*mapController, markerOnSelected, markedFeatures, selected*/
    75498512 && O && Re && !we && (O.setMarkers(l ? [l] : void 0, void 0), O.setSelectedMarker(l ? 0 : -1)), o.$$.dirty[1] & /*mapController, markedFeatures, picked*/
    25165840 && O && O.setMarkers(we, ae), o.$$.dirty[0] & /*selectedItemIndex*/
    32768 | o.$$.dirty[1] & /*markedFeatures, mapController*/
    8388624 && we && O && O.setSelectedMarker(xe), o.$$.dirty[0] & /*searchValue*/
    2 | o.$$.dirty[1] & /*mapController*/
    16 && O) {
      const A = te(j);
      O.setReverseMarker(A ? [A.decimalLongitude, A.decimalLatitude] : void 0);
    }
    o.$$.dirty[1] & /*selected*/
...
function Bt(o, a, s) {
  for (var l = new Ht(null, null), h = l, g = l; ; ) {
    var v = s(o, a.key);
    if (v < 0) {
      if (a.left === null)
        break;
...
function hr(o, a, s, l, h) {
  if (o) {
    l("" + a + (s ? "└── " : "├── ") + h(o) + `
`);
    var g = a + (s ? "    " : "│   ");
    o.left && hr(o.left, g, !1, l, h), o.right && hr(o.right, g, !0, l, h);
  }
}
var xr = (
  /** @class */
  function() {
    function o(a) {
      a === void 0 && (a = Vo), this._root = null, this._size = 0, this._comparator = a;
    }
    return o.prototype.insert = function(a, s) {
      return this._size++, this._root = ir(a, s, this._root, this._comparator);
      ...
      for (var g = [], v = this._comparator, m = this._root, N; g.length !== 0 || m; )
        if (m)
          g.push(m), m = m.left;
        else {
          if (m = g.pop(), N = v(m.key, s), N > 0)
            break;
      ...
      if (l && gr(a, s, 0, h - 1, g), this._root === null)
        this._root = cr(a, s, 0, h), this._size = h;
      else {
        var v = Qo(this.toList(), Zo(a, s), g);
        h = this._size + h, this._root = fr({ head: v }, 0, h);
      }
      return this;
      ...
      var s = [];
      return hr(this._root, "", !0, function(l) {
        return s.push(l);
      }, a), s.join("");
    }, o.prototype.update = function(a, s, l) {
      var h = this._comparator, g = Ls(a, this._root, h), v = g.left, m = g.right;
      h(a, s) < 0 ? m = ir(s, l, m, h) : v = ir(s, l, v, h), this._root = Ho(v, m, h);
    }, o.prototype.split = function(a) {
      return Ls(a, this._root, this._comparator);
    }, o.prototype[Symbol.iterator] = function() {
      var a, s, l;
      return Wo(this, function(h) {
        switch (h.label) {
          case 0:
...
function cr(o, a, s, l) {
  var h = l - s;
  if (h > 0) {
    var g = s + Math.floor(h / 2), v = o[g], m = a[g], N = new Ht(v, m);
    return N.left = cr(o, a, s, g), N.right = cr(o, a, g + 1, l), N;
  }
  return null;
}
function Zo(o, a) {
  for (var s = new Ht(null, null), l = s, h = 0; h < o.length; h++)
    l = l.next = new Ht(o[h], a[h]);
  return l.next = null, s.next;
}
function jo(o) {
  for (var a = o, s = [], l = !1, h = new Ht(null, null), g = h; !l; )
...
function fr(o, a, s) {
  var l = s - a;
  if (l > 0) {
    var h = a + Math.floor(l / 2), g = fr(o, a, h), v = o.head;
    return v.left = g, o.head = o.head.next, v.right = fr(o, h + 1, s), v;
  }
  return null;
}
function Qo(o, a, s) {
  for (var l = new Ht(null, null), h = l, g = o, v = a; g !== null && v !== null; )
    s(g.key, v.key) < 0 ? (h.next = g, g = g.next) : (h.next = v, v = v.next), h = h.next;
  return g !== null ? h.next = g : v !== null && (h.next = v), l.next;
}
function gr(o, a, s, l, h) {
  if (!(s >= l)) {
    for (var g = o[s + l >> 1], v = s - 1, m = l + 1; ; ) {
      ...
      if (v >= m)
        break;
      var N = o[v];
      o[v] = o[m], o[m] = N, N = a[v], a[v] = a[m], a[m] = N;
    }
    gr(o, a, s, m, h), gr(o, a, m + 1, l, h);
  }
}
const At = 11102230246251565e-32, Ue = 134217729, Ko = (3 + 8 * At) * At;
function rr(o, a, s, l, h) {
  let g, v, m, N, _ = a[0], k = l[0], y = 0, x = 0;
  k > _ == k > -_ ? (g = _, _ = a[++y]) : (g = k, k = l[++x]);
  let E = 0;
  if (y < o && x < s)
    for (k > _ == k > -_ ? (v = _ + g, m = g - (v - _), _ = a[++y]) : (v = k + g, m = g - (v - k), k = l[++x]), g = v, m !== 0 && (h[E++] = m); y < o && x < s; )
      k > _ == k > -_ ? (v = g + _, N = v - g, m = g - (v - N) + (_ - N), _ = a[++y]) : (v = g + k, N = v - g, m = g - (v - N) + (k - N), k = l[++x]), g = v, m !== 0 && (h[E++] = m);
  for (; y < o; )
    v = g + _, N = v - g, m = g - (v - N) + (_ - N), _ = a[++y], g = v, m !== 0 && (h[E++] = m);
  for (; x < s; )
    v = g + k, N = v - g, m = g - (v - N) + (k - N), k = l[++x], g = v, m !== 0 && (h[E++] = m);
...
const $o = (3 + 16 * At) * At, el = (2 + 12 * At) * At, tl = (9 + 64 * At) * At * At, wn = ni(4), bs = ni(8), Ts = ni(12), Cs = ni(16), Ze = ni(4);
function nl(o, a, s, l, h, g, v) {
  let m, N, _, k, y, x, E, I, R, T, M, F, C, q, O, B, z, X;
  const G = o - h, Z = s - h, ee = a - g, j = l - g;
  q = G * j, x = Ue * G, E = x - (x - G), I = G - E, x = Ue * j, R = x - (x - j), T = j - R, O = I * T - (q - E * R - I * R - E * T), B = ee * Z, x = Ue * ee, E = x - (x - ee), I = ee - E, x = Ue * Z, R = x - (x - Z), T = Z - R, z = I * T - (B - E * R - I * R - E * T), M = O - z, y = O - M, wn[0] = O - (M + y) + (y - z), F = q + M, y = F - q, C = q - (F - y) + (M - y), M = C - B, y = C - M, wn[1] = C - (M + y) + (y - B), X = F + M, y = X - F, wn[2] = F - (X - y) + (M - y), wn[3] = X;
  let ce = Jo(4, wn), D = el * v;
  if (ce >= D || -ce >= D || (y = o - G, m = o - (G + y) + (y - h), y = s - Z, _ = s - (Z + y) + (y - h), y = a - ee, N = a - (ee + y) + (y - g), y = l - j, k = l - (j + y) + (y - g), m === 0 && N === 0 && _ === 0 && k === 0) || (D = tl * v + Ko * Math.abs(ce), ce += G * k + j * m - (ee * _ + Z * N), ce >= D || -ce >= D)) return ce;
  q = m * j, x = Ue * m, E = x - (x - m), I = m - E, x = Ue * j, R = x - (x - j), T = j - R, O = I * T - (q - E * R - I * R - E * T), B = N * Z, x = Ue * N, E = x - (x - N), I = N - E, x = Ue * Z, R = x - (x - Z), T = Z - R, z = I * T - (B - E * R - I * R - E * T), M = O - z, y = O - M, Ze[0] = O - (M + y) + (y - z), F = q + M, y = F - q, C = q - (F - y) + (M - y), M = C - B, y = C - M, Ze[1] = C - (M + y) + (y - B), X = F + M, y = X - F, Ze[2] = F - (X - y) + (M - y), Ze[3] = X;
  const K = rr(4, wn, 4, Ze, bs);
  q = G * k, x = Ue * G, E = x - (x - G), I = G - E, x = Ue * k, R = x - (x - k), T = k - R, O = I * T - (q - E * R - I * R - E * T), B = ee * _, x = Ue * ee, E = x - (x - ee), I = ee - E, x = Ue * _, R = x - (x - _), T = _ - R, z = I * T - (B - E * R - I * R - E * T), M = O - z, y = O - M, Ze[0] = O - (M + y) + (y - z), F = q + M, y = F - q, C = q - (F - y) + (M - y), M = C - B, y = C - M, Ze[1] = C - (M + y) + (y - B), X = F + M, y = X - F, Ze[2] = F - (X - y) + (M - y), Ze[3] = X;
  const se = rr(K, bs, 4, Ze, Ts);
  q = m * k, x = Ue * m, E = x - (x - m), I = m - E, x = Ue * k, R = x - (x - k), T = k - R, O = I * T - (q - E * R - I * R - E * T), B = N * _, x = Ue * N, E = x - (x - N), I = N - E, x = Ue * _, R = x - (x - _), T = _ - R, z = I * T - (B - E * R - I * R - E * T), M = O - z, y = O - M, Ze[0] = O - (M + y) + (y - z), F = q + M, y = F - q, C = q - (F - y) + (M - y), M = C - B, y = C - M, Ze[1] = C - (M + y) + (y - B), X = F + M, y = X - F, Ze[2] = F - (X - y) + (M - y), Ze[3] = X;
  const me = rr(se, Ts, 4, Ze, Cs);
  return Cs[me - 1];
}
function il(o, a, s, l, h, g) {
  const v = (a - g) * (s - h), m = (o - h) * (l - g), N = v - m, _ = Math.abs(v + m);
  return Math.abs(N) >= $o * _ ? N : -nl(o, a, s, l, h, g, _);
}
const Hn = (o, a) => o.ll.x <= a.x && a.x <= o.ur.x && o.ll.y <= a.y && a.y <= o.ur.y, dr = (o, a) => {
...
let Ut = Number.EPSILON;
Ut === void 0 && (Ut = Math.pow(2, -52));
const rl = Ut * Ut, Rs = (o, a) => {
  if (-Ut < o && o < Ut && -Ut < a && a < Ut)
    return 0;
  const s = o - a;
  return s * s < rl * o * a ? 0 : o < a ? -1 : 1;
};
class sl {
  constructor() {
    this.reset();
...
class Os {
  ...
  round(a) {
    ...
    if (l !== null && Rs(s.key, l.key) === 0)
      return this.tree.remove(a), l.key;
    const h = this.tree.next(s);
    return h !== null && Rs(s.key, h.key) === 0 ? (this.tree.remove(a), h.key) : a;
  }
}
const $n = new sl(), Ni = (o, a) => o.x * a.y - o.y * a.x, da = (o, a) => o.x * a.x + o.y * a.y, Ms = (o, a, s) => {
  const l = il(o.x, o.y, a.x, a.y, s.x, s.y);
  return l > 0 ? -1 : l < 0 ? 1 : 0;
}, Si = (o) => Math.sqrt(da(o, o)), al = (o, a, s) => {
  const l = {
    x: a.x - o.x,
    y: a.y - o.y
  }, h = {
  ...
  if (a.x === 0) return As(s, l, o.x);
  if (l.x === 0) return As(o, a, s.x);
  if (a.y === 0) return Ps(s, l, o.y);
  if (l.y === 0) return Ps(o, a, s.y);
  const h = Ni(a, l);
  if (h == 0) return null;
  const g = {
    x: s.x - o.x,
    y: s.y - o.y
  }, v = Ni(g, a) / h, m = Ni(g, l) / h, N = o.x + m * a.x, _ = s.x + v * l.x, k = o.y + m * a.y, y = s.y + v * l.y, x = (N + _) / 2, E = (k + y) / 2;
  return {
    x,
    y: E
  };
...
class vt {
  ...
  static compare(a, s) {
    const l = vt.comparePoints(a.point, s.point);
    return l !== 0 ? l : (a.point !== s.point && a.link(s), a.isLeft !== s.isLeft ? a.isLeft ? 1 : -1 : Xt.compare(a.segment, s.segment));
  }
  ...
  getLeftmostComparator(a) {
    const s = /* @__PURE__ */ new Map(), l = (h) => {
      const g = h.otherSE;
      s.set(h, {
        sine: al(this.point, a.point, g.point),
        cosine: ul(this.point, a.point, g.point)
      });
    };
    return (h, g) => {
      ...
      return v >= 0 && N >= 0 ? m < _ ? 1 : m > _ ? -1 : 0 : v < 0 && N < 0 ? m < _ ? -1 : m > _ ? 1 : 0 : N < v ? -1 : N > v ? 1 : 0;
    };
  }
}
let ll = 0;
class Xt {
  ...
  static compare(a, s) {
    ...
    if (v < l) return 1;
    if (g < h) return -1;
    const m = a.leftSE.point.y, N = s.leftSE.point.y, _ = a.rightSE.point.y, k = s.rightSE.point.y;
    if (l < h) {
      if (N < m && N < _) return 1;
      if (N > m && N > _) return -1;
      ...
      if (y < 0) return 1;
      if (y > 0) return -1;
      const x = s.comparePoint(a.rightSE.point);
      return x !== 0 ? x : -1;
    }
    if (l > h) {
      if (m < N && m < k) return -1;
      ...
      if (y !== 0) return y;
      const x = a.comparePoint(s.rightSE.point);
  ...
  constructor(a, s, l, h) {
    this.id = ++ll, this.leftSE = a, a.segment = this, a.otherSE = s, this.rightSE = s, s.segment = this, s.otherSE = a, this.rings = l, this.windings = h;
  }
  static fromRing(a, s, l) {
    let h, g, v;
    const m = vt.comparePoints(a, s);
    if (m < 0)
      h = a, g = s, v = 1;
    else if (m > 0)
      h = s, g = a, v = -1;
    else throw new Error(`Tried to create degenerate segment at [${a.x}, ${a.y}]`);
    const N = new vt(h, !0), _ = new vt(g, !1);
    return new Xt(N, _, [l], [v]);
  }
  ...
  comparePoint(a) {
    ...
    if (a.x === v) return 0;
    const m = (a.x - s.x) / h.x, N = s.y + m * h.y;
    return a.y === N ? 0 : a.y < N ? -1 : 1;
  }
  /**
   ...
   */
  getIntersection(a) {
    const s = this.bbox(), l = a.bbox(), h = dr(s, l);
    if (h === null) return null;
    const g = this.leftSE.point, v = this.rightSE.point, m = a.leftSE.point, N = a.rightSE.point, _ = Hn(s, m) && this.comparePoint(m) === 0, k = Hn(l, g) && a.comparePoint(g) === 0, y = Hn(s, N) && this.comparePoint(N) === 0, x = Hn(l, v) && a.comparePoint(v) === 0;
    if (k && _)
      return x && !y ? v : !x && y ? N : null;
    if (k)
      return y && g.x === N.x && g.y === N.y ? null : g;
    if (_)
      return x && v.x === m.x && v.y === m.y ? null : m;
    if (x && y) return null;
    if (x) return v;
    if (y) return N;
    const E = ol(g, this.vector(), m, a.vector());
    return E === null || !Hn(h, E) ? null : $n.round(E.x, E.y);
  }
  /**
   ...
   */
  split(a) {
    const s = [], l = a.events !== void 0, h = new vt(a, !0), g = new vt(a, !1), v = this.rightSE;
    this.replaceRightSE(g), s.push(g), s.push(h);
    const m = new Xt(h, v, this.rings.slice(), this.windings.slice());
    return vt.comparePoints(m.leftSE.point, m.rightSE.point) > 0 && m.swapEvents(), vt.comparePoints(this.leftSE.point, this.rightSE.point) > 0 && this.swapEvents(), l && (h.checkForConsuming(), g.checkForConsuming()), s;
  }
  ...
  consume(a) {
    ...
    if (h !== 0) {
      ...
      for (let g = 0, v = l.rings.length; g < v; g++) {
        const m = l.rings[g], N = l.windings[g], _ = s.rings.indexOf(m);
        _ === -1 ? (s.rings.push(m), s.windings.push(N)) : s.windings[_] += N;
      }
  ...
  afterState() {
    ...
    for (let m = 0, N = this.rings.length; m < N; m++) {
  ...
  constructor(a, s, l) {
    ...
    for (let v = 1, m = a.length; v < m; v++) {
      if (typeof a[v][0] != "number" || typeof a[v][1] != "number")
        throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
      let N = $n.round(a[v][0], a[v][1]);
      N.x === g.x && N.y === g.y || (this.segments.push(Xt.fromRing(g, N, this)), N.x < this.bbox.ll.x && (this.bbox.ll.x = N.x), N.y < this.bbox.ll.y && (this.bbox.ll.y = N.y), N.x > this.bbox.ur.x && (this.bbox.ur.x = N.x), N.y > this.bbox.ur.y && (this.bbox.ur.y = N.y), g = N);
    }
    (h.x !== g.x || h.y !== g.y) && this.segments.push(Xt.fromRing(g, h, this));
  }
  getSweepEvents() {
    const a = [];
...
class hl {
  constructor(a, s) {
    if (!Array.isArray(a))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new Ds(a[0], this, !0), this.bbox = {
      ll: {
...
class Li {
  ...
  static factory(a) {
    ...
    for (let l = 0, h = a.length; l < h; l++) {
      ...
      let v = null, m = g.leftSE, N = g.rightSE;
      const _ = [m], k = m.point, y = [];
      for (; v = m, m = N, _.push(m), m.point !== k; )
        for (; ; ) {
          const x = m.getAvailableLinkedEvents();
          if (x.length === 0) {
            const R = _[0].point, T = _[_.length - 1].point;
            throw new Error(`Unable to complete output ring starting at [${R.x}, ${R.y}]. Last matching segment found ends at [${T.x}, ${T.y}].`);
          }
          if (x.length === 1) {
            N = x[0].otherSE;
            break;
          ...
          for (let R = 0, T = y.length; R < T; R++)
            if (y[R].point === m.point) {
              E = R;
              break;
            }
          if (E !== null) {
            const R = y.splice(E)[0], T = _.splice(R.index);
            T.unshift(T[0].otherSE), s.push(new Li(T.reverse()));
            continue;
          }
          y.push({
            index: _.length,
  ...
  getGeom() {
    ...
    for (let _ = 1, k = this.events.length - 1; _ < k; _++) {
      const y = this.events[_].point, x = this.events[_ + 1].point;
      Ms(y, a, x) !== 0 && (s.push(y), a = y);
    }
    if (s.length === 1) return null;
    const l = s[0], h = s[1];
    Ms(l, a, h) === 0 && s.shift(), s.push(s[0]);
    const g = this.isExteriorRing() ? 1 : -1, v = this.isExteriorRing() ? 0 : s.length - 1, m = this.isExteriorRing() ? s.length : -1, N = [];
    for (let _ = v; _ != m; _ += g) N.push([s[_].x, s[_].y]);
    return N;
  }
  isExteriorRing() {
...
class cl {
  ...
  _composePolys(a) {
    ...
    for (let l = 0, h = a.length; l < h; l++) {
      const g = a[l];
      if (!g.poly)
        if (g.isExteriorRing()) s.push(new Gs(g));
        else {
          const v = g.enclosingRing();
          v.poly || s.push(new Gs(v)), v.poly.addInterior(g);
        }
    }
    return s;
  }
...
class fl {
  constructor(a) {
    let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Xt.compare;
    this.queue = a, this.tree = new xr(s), this.segments = [];
  }
  process(a) {
    const s = a.segment, l = [];
    if (a.consumedBy)
    ...
    for (; N === void 0; )
      v = this.tree.next(v), v === null ? N = null : v.key.consumedBy === void 0 && (N = v.key);
    if (a.isLeft) {
      let _ = null;
      if (m) {
        const y = m.getIntersection(s);
        if (y !== null && (s.isAnEndpoint(y) || (_ = y), !m.isAnEndpoint(y))) {
          const x = this._splitSafely(m, y);
      ...
      let k = null;
      if (N) {
        const y = N.getIntersection(s);
        if (y !== null && (s.isAnEndpoint(y) || (k = y), !N.isAnEndpoint(y))) {
          const x = this._splitSafely(N, y);
          for (let E = 0, I = x.length; E < I; E++)
            l.push(x[E]);
        }
      }
      if (_ !== null || k !== null) {
        let y = null;
        _ === null ? y = k : k === null ? y = _ : y = vt.comparePoints(_, k) <= 0 ? _ : k, this.queue.remove(s.rightSE), l.push(s.rightSE);
        const x = s.split(y);
        for (let E = 0, I = x.length; E < I; E++)
          l.push(x[E]);
      }
      ...
      if (m && N) {
        const _ = m.getIntersection(N);
        if (_ !== null) {
          if (!m.isAnEndpoint(_)) {
            const k = this._splitSafely(m, _);
            for (let y = 0, x = k.length; y < x; y++)
              l.push(k[y]);
          }
          if (!N.isAnEndpoint(_)) {
            const k = this._splitSafely(N, _);
            for (let y = 0, x = k.length; y < x; y++)
              l.push(k[y]);
          }
        }
...
const qs = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, gl = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6;
class dl {
  run(a, s, l) {
    xt.type = a, $n.reset();
    const h = [new Fs(s, !0)];
    ...
    if (xt.numMultiPolys = h.length, xt.type === "difference") {
      ...
      let x = 1;
      for (; x < h.length; )
        dr(h[x].bbox, y.bbox) !== null ? x++ : h.splice(x, 1);
    }
    if (xt.type === "intersection")
      for (let y = 0, x = h.length; y < x; y++) {
        const E = h[y];
        for (let I = y + 1, R = h.length; I < R; I++)
          if (dr(E.bbox, h[I].bbox) === null) return [];
      }
    const g = new xr(vt.compare);
    for (let y = 0, x = h.length; y < x; y++) {
      const E = h[y].getSweepEvents();
      for (let I = 0, R = E.length; I < R; I++)
        if (g.insert(E[I]), g.size > qs)
          throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big).");
    }
    const v = new fl(g);
    let m = g.size, N = g.pop();
    for (; N; ) {
      const y = N.key;
      if (g.size === m) {
        const E = y.segment;
        throw new Error(`Unable to pop() ${y.isLeft ? "left" : "right"} SweepEvent [${y.point.x}, ${y.point.y}] from segment #${E.id} [${E.leftSE.point.x}, ${E.leftSE.point.y}] -> [${E.rightSE.point.x}, ${E.rightSE.point.y}] from queue.`);
      }
      if (g.size > qs)
        throw new Error("Infinite loop when passing sweep line over endpoints (queue size too big).");
      if (v.segments.length > gl)
        throw new Error("Infinite loop when passing sweep line over endpoints (too many sweep line segments).");
      const x = v.process(y);
      for (let E = 0, I = x.length; E < I; E++) {
        const R = x[E];
        R.consumedBy === void 0 && g.insert(R);
      }
      m = g.size, N = g.pop();
    }
    $n.reset();
    const _ = Li.factory(v.segments);
    return new cl(_).getGeom();
  }
}
const xt = new dl(), ml = function(o) {
...
function va(o, a, s) {
  if (o !== null)
    for (var l, h, g, v, m, N, _, k = 0, y = 0, x, E = o.type, I = E === "FeatureCollection", R = E === "Feature", T = I ? o.features.length : 1, M = 0; M < T; M++) {
      _ = I ? o.features[M].geometry : R ? o.geometry : o, x = _ ? _.type === "GeometryCollection" : !1, m = x ? _.geometries.length : 1;
      for (var F = 0; F < m; F++) {
        var C = 0, q = 0;
        if (v = x ? _.geometries[F] : _, v !== null) {
          N = v.coordinates;
          var O = v.type;
          switch (k = 0, O) {
            case null:
            ...
            case "MultiLineString":
              for (l = 0; l < N.length; l++) {
                ...
                O === "MultiLineString" && C++, O === "Polygon" && q++;
              }
              O === "Polygon" && C++;
              break;
            case "MultiPolygon":
              for (l = 0; l < N.length; l++) {
                for (q = 0, h = 0; h < N[l].length; h++) {
                  for (g = 0; g < N[l][h].length - k; g++) {
                    if (a(
                      N[l][h][g],
                      y,
                      M,
...
function Mi(o, a) {
  var s, l, h, g, v, m, N, _, k, y, x = 0, E = o.type === "FeatureCollection", I = o.type === "Feature", R = E ? o.features.length : 1;
  for (s = 0; s < R; s++) {
    for (m = E ? o.features[s].geometry : I ? o.geometry : o, _ = E ? o.features[s].properties : I ? o.properties : {}, k = E ? o.features[s].bbox : I ? o.bbox : void 0, y = E ? o.features[s].id : I ? o.id : void 0, N = m ? m.type === "GeometryCollection" : !1, v = N ? m.geometries.length : 1, h = 0; h < v; h++) {
      if (g = N ? m.geometries[h] : m, g === null) {
        if (a(
          null,
          x,
          _,
...
function _l(o, a = {}) {
  ...
  return l.length === 0 ? null : l.length === 1 ? Er(l[0], a.properties) : ga(l, a.properties);
}
var kl = _l;
function El(o, a = {}) {
...
function xl(o, a = {}) {
  const s = El(o), l = (s[0] + s[2]) / 2, h = (s[1] + s[3]) / 2;
  return Bo([l, h], a.properties, a);
}
...
(function(o, a) {
  (function(s, l) {
    ...
    function _(r, e, t) {
      return _ = N() ? Reflect.construct : function(n, i, u) {
        var c = [null];
        c.push.apply(c, i);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    function T(r, e) {
      if (r) {
        ...
        return t === "Object" && r.constructor && (t = r.constructor.name), t === "Map" || t === "Set" ? Array.from(r) : t === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? M(r, e) : void 0;
      }
    }
    function M(r, e) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var Z, ee, j, ce, D, K, se, me, Re = function() {
      function r() {
        s(this, r);
      }
    ...
    Q.NaN = NaN, Q.isNaN = function(r) {
    ...
    }) : (Z = 1023, ee = Math.log2, j = Math.floor, ce = Math.pow, D = function() {
      for (var r = 53; r > 0; r--) {
        var e = ce(2, r) - 1;
      ...
      if (i = 0, p = 0, (e = j(r)) > 1) if (e <= D) (i = j(ee(e))) <= 20 ? (p = 0, d = e << 20 - i & 1048575) : (p = e % (t = ce(2, n = i - 20)) << 32 - n, d = e / t & 1048575);
    ...
    var Ie = function(r) {
    ...
    }(), ut = new ArrayBuffer(8), Mn = new Float64Array(ut), ii = new Int32Array(ut), b = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getM", value: function() {
        ...
        throw new O("Invalid ordinate index: " + r.M);
    ...
    b.DimensionalComparator = ri, b.NULL_ORDINATE = Q.NaN, b.X = 0, b.Y = 1, b.Z = 2, b.M = 3;
    var ke = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getArea", value: function() {
        ...
        var e = 17;
        return e = 37 * (e = 37 * (e = 37 * (e = 37 * e + b.hashCode(this._minx)) + b.hashCode(this._maxx)) + b.hashCode(this._miny)) + b.hashCode(this._maxy);
      } }, { key: "interfaces_", get: function() {
        return [z, G];
      } }], [{ key: "constructor_", value: function() {
      ...
      return h(r, [{ key: "isGeometryCollection", value: function() {
        ...
        if (e.getTypeCode() === r.TYPECODE_GEOMETRYCOLLECTION) throw new O("This method does not support GeometryCollection arguments");
    ...
    }(Pn, Symbol.iterator), xe = function() {
      function r(e) {
    ...
    var Jt = function(r) {
      ...
      return h(t, [{ key: "add", value: function(n) {
        ...
        if (this.array.length === 0) throw new Jt();
    ...
    var $t = function() {
      ...
      return h(r, [{ key: "le", value: function(e) {
        ...
        for (var c = i + 1, f = new $t(), d = r.MAX_PRINT_DIGITS - 1, p = 0; p <= d; p++) {
          e && p === c && f.append(".");
        ...
        for (var n = new $t(), i = 0; i < t; i++) n.append(e);
        return n.toString();
      } }]), r;
    }();
    ...
    var en = function() {
      ...
      return h(r, null, [{ key: "orientationIndex", value: function(e, t, n) {
        ...
        return Q.isNaN(W) || Q.isInfinite(W) || Q.isNaN($) || Q.isInfinite($) ? null : new b(W, $);
    ...
    var re = function() {
      ...
      return h(r, null, [{ key: "index", value: function(e, t, n) {
        ...
        if (ue(arguments[0], ge)) {
          ...
          if (W < 3) throw new O("Ring has fewer than 4 points, so orientation cannot be determined");
          ...
          var Oe = null, Be = ie;
          do
            (Be -= 1) < 0 && (Be = W), Oe = V.getCoordinate(Be);
          while (Oe.equals2D($) && Be !== ie);
          var st = null, kt = ie;
          do
    ...
    var Pi = function() {
      ...
      function t(n, i) {
        var u;
        return s(this, t), (u = e.call(this, i ? n + " [ " + i + " ]" : n)).pt = i ? new b(i) : void 0, u.name = Object.keys({ TopologyException: t })[0], u;
      }
    ...
    }(Ke, Symbol.iterator), Ai = function() {
      function r(e) {
      ...
      return h(r, [{ key: "clearVisitedEdges", value: function() {
        ...
        var t = new Qe(), n = new An(), i = e.getNode();
        ...
        this._finder = null, this._dirEdgeList = new ne(), this._nodes = new ne(), this._rightMostCoord = null, this._env = null, this._finder = new Pi();
      } }]), r;
    }(), Dn = function() {
      function r() {
        s(this, r);
      ...
      return h(r, null, [{ key: "intersection", value: function(e, t, n, i) {
        var u = e.x < t.x ? e.x : t.x, c = e.y < t.y ? e.y : t.y, f = e.x > t.x ? e.x : t.x, d = e.y > t.y ? e.y : t.y, p = n.x < i.x ? n.x : i.x, S = n.y < i.y ? n.y : i.y, L = n.x > i.x ? n.x : i.x, P = n.y > i.y ? n.y : i.y, V = ((u > p ? u : p) + (f < L ? f : L)) / 2, W = ((c > S ? c : S) + (d < P ? d : P)) / 2, $ = e.x - V, ie = e.y - W, le = t.x - V, pe = t.y - W, Oe = n.x - V, Be = n.y - W, st = i.x - V, kt = i.y - W, Mt = ie - pe, un = le - $, Un = $ * pe - le * ie, Xn = Be - kt, Nn = st - Oe, is = Oe * kt - st * Be, rs = Mt * Nn - Xn * un, Ji = (un * is - Nn * Un) / rs, $i = (Xn * Un - Mt * is) / rs;
        return Q.isNaN(Ji) || Q.isInfinite(Ji) || Q.isNaN($i) || Q.isInfinite($i) ? null : new b(Ji + V, $i + W);
      } }]), r;
    }(), Je = function() {
      function r() {
        s(this, r);
...
` }[e];
    ...
    var ot = function() {
      ...
      return h(r, null, [{ key: "segmentToSegment", value: function(e, t, n, i) {
        ...
        return u ? tn.min(r.pointToSegment(e, n, i), r.pointToSegment(t, n, i), r.pointToSegment(n, e, t), r.pointToSegment(i, e, t)) : 0;
      ...
      return h(r, null, [{ key: "copyCoord", value: function(e, t, n, i) {
        ...
        if (arguments.length === 2) {
          ...
          } else if (ue(arguments[0], ge) && arguments[1] instanceof b) {
    ...
    var A = function() {
      ...
      return h(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        } else if (ue(arguments[0], A)) {
          var f = arguments[0];
          f.filter(this);
        } else if (ue(arguments[0], B)) {
          var d = arguments[0];
          d.filter(this);
        }
      ...
      return h(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        var n = arguments[0], i = arguments[1], u = arguments[2];
        if (J.constructor_.call(this, u), n === null && (n = this.getFactory().createLinearRing()), i === null && (i = []), J.hasNullElements(i)) throw new O("holes must not contain null elements");
        if (n.isEmpty() && J.hasNonEmptyElements(i)) throw new O("shell is empty but holes are not");
      ...
      return h(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        if (arguments.length === 1) {
          var n = arguments[0], i = new Nr(lt.asList(this._geometries)), u = new Nr(lt.asList(n._geometries));
        ...
        if (this._geometries = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var n = arguments[0], i = arguments[1];
            if (J.constructor_.call(this, i), n === null && (n = []), J.hasNullElements(n)) throw new O("geometries must not contain null elements");
            this._geometries = n;
          }
        }
      } }]), t;
      ...
      return h(t, [{ key: "setOrdinate", value: function(n, i) {
        ...
        if (arguments.length === 0) b.constructor_.call(this);
          ...
          if (arguments[0] instanceof t) {
            var n = arguments[0];
            b.constructor_.call(this, n.x, n.y);
          } else if (arguments[0] instanceof b) {
            var i = arguments[0];
            b.constructor_.call(this, i.x, i.y);
          }
        } else if (arguments.length === 2) {
          var u = arguments[0], c = arguments[1];
          b.constructor_.call(this, u, c, b.NULL_ORDINATE);
        }
      } }]), t;
    }(b);
    ...
    var rn = function(r) {
      ...
      return h(t, [{ key: "getM", value: function() {
        ...
        if (this._m = null, arguments.length === 0) b.constructor_.call(this), this._m = 0;
          ...
          if (arguments[0] instanceof t) {
            var n = arguments[0];
            b.constructor_.call(this, n.x, n.y), this._m = n._m;
          } else if (arguments[0] instanceof b) {
            var i = arguments[0];
            b.constructor_.call(this, i.x, i.y), this._m = this.getM();
          }
        } else if (arguments.length === 3) {
          var u = arguments[0], c = arguments[1], f = arguments[2];
          b.constructor_.call(this, u, c, b.NULL_ORDINATE), this._m = f;
        }
      } }]), t;
    }(b);
    rn.X = 0, rn.Y = 1, rn.Z = -1, rn.M = 2;
    var qi = function(r) {
      g(t, r);
      var e = E(t);
      function t() {
      ...
      return h(t, [{ key: "getM", value: function() {
        ...
        if (this._m = null, arguments.length === 0) b.constructor_.call(this), this._m = 0;
          ...
          if (arguments[0] instanceof t) {
            var n = arguments[0];
            b.constructor_.call(this, n), this._m = n._m;
          } else if (arguments[0] instanceof b) {
            var i = arguments[0];
            b.constructor_.call(this, i), this._m = this.getM();
          }
        } else if (arguments.length === 4) {
          var u = arguments[0], c = arguments[1], f = arguments[2], d = arguments[3];
          b.constructor_.call(this, u, c, f), this._m = d;
        }
      } }]), t;
    }(b), ui = function() {
      function r() {
      ...
      return h(r, null, [{ key: "measures", value: function(e) {
        return e instanceof nn ? 0 : e instanceof rn || e instanceof qi ? 1 : 0;
      } }, { key: "dimension", value: function(e) {
        return e instanceof nn ? 2 : e instanceof rn ? 3 : e instanceof qi ? 4 : 3;
        ...
        if (arguments.length === 2) {
          var t = arguments[0], n = arguments[1];
          return t === 2 ? new nn() : t === 3 && n === 0 ? new b() : t === 3 && n === 1 ? new rn() : t === 4 && n === 1 ? new qi() : new b();
        }
      } }]), r;
    }(), Gn = function(r) {
      g(t, r);
      ...
      return h(t, [{ key: "getCoordinate", value: function(n) {
        ...
        if (arguments.length === 2) {
          ...
          var kt = arguments[0], Mt = arguments[1], un = arguments[2], Un = arguments[3], Xn = 1;
          un > Un && (Xn = -1);
          for (var Nn = un; Nn !== Un; Nn += Xn) this.add(kt[Nn], Mt);
          return !0;
        }
    ...
    Gn.coordArrayType = new Array(0).fill(null);
    var Ge = function() {
      function r() {
        s(this, r);
      }
      return h(r, null, [{ key: "isRing", value: function(e) {
        ...
        for (var n = new Gn(), i = 0; i < e.length; i++) t.intersects(e[i]) && n.add(e[i], !0);
        ...
        return r.hasRepeatedPoints(e) ? new Gn(e, !1).toCoordinateArray() : e;
      } }, { key: "reverse", value: function(e) {
        ...
        t = tn.clamp(t, 0, e.length);
        var i = (n = tn.clamp(n, -1, e.length)) - t + 1;
    ...
    var oi = function() {
      ...
      return h(r, [{ key: "getM", value: function(e) {
        ...
        return ui.create(this.getDimension(), this.getMeasures());
      } }, { key: "getDimension", value: function() {
        ...
        if (this._coordinates.length > 0) {
          var e = new oi(17 * this._coordinates.length);
        ...
        if (this._dimension = 3, this._measures = 0, this._coordinates = null, arguments.length === 1) {
          if (arguments[0] instanceof Array) {
            ...
            for (var n = 0; n < t; n++) this._coordinates[n] = new b();
          ...
          if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            ...
            for (var S = 0; S < d; S++) this._coordinates[S] = ui.create(p);
          }
        } else if (arguments.length === 3) {
      ...
      return h(r, [{ key: "readResolve", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          if (arguments.length === 2) {
            var n = arguments[0], i = arguments[1];
            return i > 3 && (i = 3), i < 2 && (i = 2), new qn(n, i);
          }
          if (arguments.length === 3) {
            var u = arguments[0], c = arguments[1], f = arguments[2], d = c - f;
            return f > 1 && (f = 1), d > 3 && (d = 3), d < 2 && (d = 2), new qn(u, d + f, f);
          }
        }
      } }, { key: "interfaces_", get: function() {
        return [si, G];
    ...
    vn.nameToTypeMap = new Da(), pt.Type = vn, pt.FIXED = new vn("FIXED"), pt.FLOATING = new vn("FLOATING"), pt.FLOATING_SINGLE = new vn("FLOATING SINGLE"), pt.maximumPreciseValue = 9007199254740992;
    var Bi = function(r) {
      g(t, r);
      var e = E(t);
      function t() {
      ...
      return h(r, [{ key: "createEmpty", value: function(e) {
        ...
        return e.isNull() ? this.createPoint() : e.getMinX() === e.getMaxX() && e.getMinY() === e.getMaxY() ? this.createPoint(new b(e.getMinX(), e.getMinY())) : e.getMinX() === e.getMaxX() || e.getMinY() === e.getMaxY() ? this.createLineString([new b(e.getMinX(), e.getMinY()), new b(e.getMaxX(), e.getMaxY())]) : this.createPolygon(this.createLinearRing([new b(e.getMinX(), e.getMinY()), new b(e.getMinX(), e.getMaxY()), new b(e.getMaxX(), e.getMaxY()), new b(e.getMaxX(), e.getMinY()), new b(e.getMinX(), e.getMinY())]), null);
        ...
        if (arguments.length === 0) return new Gi(null, this);
        if (arguments.length === 1) {
          if (arguments[0] instanceof Array) {
            var e = arguments[0];
    ...
    }(), Ui = "XY", Fa = "XYZ", Ga = "XYM", qa = "XYZM", wr = { POINT: "Point", LINE_STRING: "LineString", LINEAR_RING: "LinearRing", POLYGON: "Polygon", MULTI_POINT: "MultiPoint", MULTI_LINE_STRING: "MultiLineString", MULTI_POLYGON: "MultiPolygon", GEOMETRY_COLLECTION: "GeometryCollection", CIRCLE: "Circle" }, Sr = "EMPTY", li = 1, Rt = 2, zt = 3, Lr = 4, pn = 5, za = 6;
    for (var Ya in wr) wr[Ya].toUpperCase();
    var Ba = function() {
      function r(e) {
...
`;
        ...
        else if (this.isNumeric_(t) || t == "-") e = Lr, i = this.readNumber_();
        else if (this.isAlpha_(t)) e = li, i = this.readText_();
        else {
      ...
      function r(e, t) {
        s(this, r), this.lexer_ = e, this.token_, this.layout_ = Ui, this.factory = t;
      }
      return h(r, [{ key: "consume_", value: function() {
        ...
        var e = Ui, t = this.token_;
        if (this.isTokenType(li)) {
          var n = t.value;
          n === "Z" ? e = Fa : n === "M" ? e = Ga : n === "ZM" && (e = qa), e !== Ui && this.consume_();
        }
        return e;
        ...
        var e;
        if (this.match(Rt)) {
          if (e = this.token_.type == Rt ? this.parsePointTextList_() : this.parsePointList_(), this.match(zt)) return e;
        } else if (this.isEmptyGeometry_()) return [];
        throw new Error(this.formatErrorMessage_());
        ...
        var e = this.isTokenType(li) && this.token_.value == Sr;
        ...
        if (this.match(li)) {
          ...
          switch (u) {
            case "POINT":
              ...
              return f ? e.createPoint(_(b, R(f))) : e.createPoint();
            case "LINESTRING":
    ...
    function Tr(r) {
      var e = [];
      e.push("(" + zn(r.getExteriorRing()) + ")");
      for (var t = 0, n = r.getNumInteriorRing(); t < n; ++t) e.push("(" + zn(r.getInteriorRingN(t)) + ")");
      return e.join(", ");
    }
    var Xa = { Point: br, LineString: zn, LinearRing: zn, Polygon: Tr, MultiPoint: function(r) {
      for (var e = [], t = 0, n = r.getNumGeometries(); t < n; ++t) e.push("(" + br(r.getGeometryN(t)) + ")");
      return e.join(", ");
    }, MultiLineString: function(r) {
      for (var e = [], t = 0, n = r.getNumGeometries(); t < n; ++t) e.push("(" + zn(r.getGeometryN(t)) + ")");
      return e.join(", ");
    ...
    function Cr(r) {
      ...
      return n.length > 0 && (e += " " + n), r.isEmpty() ? e + " " + Sr : e + " (" + t(r) + ")";
    }
    var Wa = function() {
      function r(e) {
      ...
      return h(r, [{ key: "getIndexAlongSegment", value: function(e, t) {
        ...
        return Xi.toLineString(this._inputLines[0][0], this._inputLines[0][1]) + " - " + Xi.toLineString(this._inputLines[1][0], this._inputLines[1][1]) + this.getTopologySummary();
    ...
    var sn = function(r) {
      ...
      return h(t, [{ key: "isInSegmentEnvelopes", value: function(n) {
        ...
        return this.isInSegmentEnvelopes(f) || (f = new b(t.nearestEndpoint(n, i, u, c))), this._precisionModel !== null && this._precisionModel.makePrecise(f), f;
      } }, { key: "checkDD", value: function(n, i, u, c, f) {
        var d = en.intersection(n, i, u, c), p = this.isInSegmentEnvelopes(d);
        ...
        return p > 0 && S > 0 || p < 0 && S < 0 ? Te.NO_INTERSECTION : f === 0 && d === 0 && p === 0 && S === 0 ? this.computeCollinearIntersection(n, i, u, c) : (f === 0 || d === 0 || p === 0 || S === 0 ? (this._isProper = !1, n.equals2D(u) || n.equals2D(c) ? this._intPt[0] = n : i.equals2D(u) || i.equals2D(c) ? this._intPt[0] = i : f === 0 ? this._intPt[0] = new b(u) : d === 0 ? this._intPt[0] = new b(c) : p === 0 ? this._intPt[0] = new b(n) : S === 0 && (this._intPt[0] = new b(i))) : (this._isProper = !0, this._intPt[0] = this.intersection(n, i, u, c)), Te.POINT_INTERSECTION);
      ...
      return h(r, [{ key: "countSegment", value: function(e, t) {
        ...
        if (arguments[0] instanceof b && ue(arguments[1], ge)) {
          for (var e = arguments[0], t = arguments[1], n = new r(e), i = new b(), u = new b(), c = 1; c < t.size(); c++) if (t.getCoordinate(c, i), t.getCoordinate(c - 1, u), n.countSegment(i, u), n.isOnSegment()) return n.getLocation();
      ...
      return h(r, null, [{ key: "isOnLine", value: function() {
        if (arguments[0] instanceof b && ue(arguments[1], ge)) {
          for (var e = arguments[0], t = arguments[1], n = new sn(), i = new b(), u = new b(), c = t.size(), f = 1; f < c; f++) if (t.getCoordinate(f - 1, i), t.getCoordinate(f, u), n.computeIntersection(e, i, u), n.hasIntersection()) return !0;
          return !1;
        }
        if (arguments[0] instanceof b && arguments[1] instanceof Array) {
          for (var d = arguments[0], p = arguments[1], S = new sn(), L = 1; L < p.length; L++) {
            var P = p[L - 1], V = p[L];
      ...
      return h(r, [{ key: "computeRing", value: function() {
        ...
        if (!t.getEnvelopeInternal().contains(e) || !Wi.isInRing(e, t.getCoordinates())) return !1;
    ...
    var Yn = function(r) {
      ...
      return h(t, [{ key: "get", value: function(n) {
        ...
        var i;
        for (n.color = 1; n != null && n !== this.root_ && n.parent.color === 1; ) ye(n) === Vi(ye(ye(n))) ? Or(i = Mr(ye(ye(n)))) === 1 ? (wt(ye(n), 0), wt(i, 0), wt(ye(ye(n)), 1), n = ye(ye(n))) : (n === Mr(ye(n)) && (n = ye(n), this.rotateLeft(n)), wt(ye(n), 0), wt(ye(ye(n)), 1), this.rotateRight(ye(ye(n)))) : Or(i = Vi(ye(ye(n)))) === 1 ? (wt(ye(n), 0), wt(i, 0), wt(ye(ye(n)), 1), n = ye(ye(n))) : (n === Vi(ye(n)) && (n = ye(n), this.rotateRight(n)), wt(ye(n), 0), wt(ye(ye(n)), 1), this.rotateLeft(ye(ye(n))));
        this.root_.color = 0;
      } }, { key: "values", value: function() {
      ...
      return h(r, [{ key: "find", value: function(e) {
        ...
        this.nodeMap = new Yn(), this.nodeFact = null;
        var e = arguments[0];
        this.nodeFact = e;
      } }]), r;
    }(), He = function() {
      ...
      return h(r, null, [{ key: "isNorthern", value: function(e) {
        ...
        if (arguments[0] instanceof b && arguments[1] instanceof b) {
          var n = arguments[0], i = arguments[1];
          if (i.x === n.x && i.y === n.y) throw new O("Cannot compute the quadrant for two identical points " + n);
    ...
    var Ar = function() {
      ...
      return h(t, [{ key: "getNextMin", value: function() {
        ...
        var n = arguments[0], i = arguments[1];
        if (Ar.constructor_.call(this, n), this._isForward = i, i) this.init(n.getCoordinate(0), n.getCoordinate(1));
        else {
      ...
      return h(r, [{ key: "printEdges", value: function(e) {
        ...
        if (this._edges = new ne(), this._nodes = null, this._edgeEndList = new ne(), arguments.length === 0) this._nodes = new Pr(new Dr());
        else if (arguments.length === 1) {
          var e = arguments[0];
          this._nodes = new Pr(e);
        }
      ...
      return h(r, [{ key: "sortShellsAndHoles", value: function(e, t, n) {
        ...
        for (var n = e.getLinearRing(), i = n.getEnvelopeInternal(), u = n.getCoordinateN(0), c = null, f = null, d = t.iterator(); d.hasNext(); ) {
          ...
          if (!L.equals(i) && L.contains(i)) {
            ...
            var P = !1;
            Wi.isInRing(u, S.getCoordinates()) && (P = !0), P && (c === null || f.contains(L)) && (f = (c = p).getLinearRing().getEnvelopeInternal());
          }
        }
        return c;
      } }]), r;
      ...
      return h(r, [{ key: "queryInternal", value: function() {
        if (ue(arguments[2], qr) && arguments[0] instanceof Object && arguments[1] instanceof ft) for (var e = arguments[0], t = arguments[1], n = arguments[2], i = t.getChildBoundables(), u = 0; u < i.size(); u++) {
          var c = i.get(u);
          this.getIntersectsOp().intersects(c.getBounds(), e) && (c instanceof ft ? this.queryInternal(e, c, n) : c instanceof Ot ? n.visitItem(c.getItem()) : he.shouldNeverReachHere());
        }
          ...
          var P = S.get(L);
          this.getIntersectsOp().intersects(P.getBounds(), f) && (P instanceof ft ? this.queryInternal(f, P, p) : P instanceof Ot ? p.add(P.getItem()) : he.shouldNeverReachHere());
        }
        ...
        if (arguments.length === 1) {
          for (var e = arguments[0], t = 0, n = e.getChildBoundables().iterator(); n.hasNext(); ) {
            var i = n.next();
            i instanceof ft ? t += this.size(i) : i instanceof Ot && (t += 1);
          }
          return t;
        }
        ...
        if (arguments.length === 3) {
          ...
          for (var c = i.getChildBoundables().iterator(); c.hasNext(); ) {
            var f = c.next();
            f instanceof ft ? this.boundablesAtLevel(n, f, u) : (he.isTrue(f instanceof Ot), n === -1 && u.add(f));
          }
          return null;
        }
      } }, { key: "query", value: function() {
    ...
    var $a = function() {
      ...
      return h(t, [{ key: "createParentBoundablesFromVerticalSlices", value: function(n, i) {
        ...
        if (arguments.length === 3) {
          var u = arguments[0], c = arguments[1], f = arguments[2], d = c, p = new fi();
          p.add(u);
          for (var S = new fi(); !p.isEmpty() && d >= 0; ) {
        ...
        if (arguments.length === 1) {
          ...
          if (arguments[0] instanceof kn) {
            var u = arguments[0], c = Q.POSITIVE_INFINITY, f = null, d = new fi();
          ...
          if (arguments.length === 4) {
            var Oe = arguments[0], Be = arguments[1], st = arguments[2], kt = arguments[3], Mt = new Ot(Oe, Be), un = new kn(this.getRoot(), Mt, st);
            return this.nearestNeighbourK(un, kt);
          }
        }
      } }, { key: "isWithinDistance", value: function() {
        if (arguments.length === 2) {
          var n = arguments[0], i = arguments[1], u = Q.POSITIVE_INFINITY, c = new fi();
    ...
    St.STRtreeNode = zr, St.xComparator = new (function() {
      function r() {
        s(this, r);
      }
    ...
    var eu = function() {
      ...
      return h(r, [{ key: "getCoordinate", value: function() {
        ...
        var e = arguments[0], t = arguments[1], n = arguments[2], i = arguments[3];
        this._segString = e, this.coord = new b(t), this.segmentIndex = n, this._segmentOctant = i, this._isInterior = !t.equals2D(e.getCoordinate(n));
      } }]), r;
    }(), nu = function() {
      function r() {
        s(this, r);
      ...
      return h(r, [{ key: "getSplitCoordinates", value: function() {
        ...
        if (n === 2) return [new b(e.coord), new b(t.coord)];
        ...
        return new an(n, this._edge.getData());
      } }, { key: "add", value: function(e, t) {
        ...
        this._nodeMap = new Yn(), this._edge = null;
        var e = arguments[0];
        this._edge = e;
      } }]), r;
    }(), ru = function() {
      ...
      return h(r, null, [{ key: "octant", value: function() {
        ...
        if (arguments[0] instanceof b && arguments[1] instanceof b) {
          ...
          if (f === 0 && d === 0) throw new O("Cannot compute the octant for two identical points " + u);
          return r.octant(f, d);
        }
      } }]), r;
    }(), su = function() {
      ...
      return h(r, [{ key: "getCoordinates", value: function() {
        ...
        if (arguments.length === 2) {
          ...
          var n = arguments[0], i = arguments[1], u = arguments[3], c = new b(n.getIntersection(u));
          this.addIntersection(c, i);
        }
      } }, { key: "toString", value: function() {
        return Xi.toLineString(new qn(this._pts));
      ...
      return h(r, [{ key: "minX", value: function() {
        ...
        if (arguments[0] instanceof b) {
          ...
          var t = this.projectionFactor(e), n = new b();
        ...
        return Dn.intersection(this.p0, this.p1, e.p0, e.p1);
        ...
        return new b((-c * f - 2 * t * n * d - 2 * t * i) / u, (c * d - 2 * t * n * f - 2 * n * i) / u);
      } }, { key: "distance", value: function() {
        if (arguments[0] instanceof r) {
          var e = arguments[0];
        ...
        if (this.p0 = null, this.p1 = null, arguments.length === 0) r.constructor_.call(this, new b(), new b());
        else if (arguments.length === 1) {
          var e = arguments[0];
          ...
          var i = arguments[0], u = arguments[1], c = arguments[2], f = arguments[3];
          r.constructor_.call(this, new b(i, u), new b(c, f));
        }
      } }, { key: "midPoint", value: function(e, t) {
        return new b((e.x + t.x) / 2, (e.y + t.y) / 2);
      } }]), r;
    }(), uu = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, null, [{ key: "findChainEnd", value: function(e, t) {
        ...
        if (arguments.length === 2) {
          ...
          do {
            var c = r.findChainEnd(t, u), f = new Yr(t, u, c, n);
            i.add(f), u = c;
          } while (u < t.length - 1);
          return i;
        }
      ...
      return h(t, [{ key: "getMonotoneChains", value: function() {
        ...
        return an.getNodedSubstrings(this._nodedSegStrings);
        ...
        for (var n = new Ur(this._segInt), i = this._monoChains.iterator(); i.hasNext(); ) for (var u = i.next(), c = this._index.query(u.getEnvelope()).iterator(); c.hasNext(); ) {
          var f = c.next();
    ...
    var _t = function() {
      ...
      return h(r, [{ key: "isDeletable", value: function(e, t, n, i) {
        ...
        for (var e = new Gn(), t = 0; t < this._inputLine.length; t++) this._isDeleted[t] !== r.DELETE && e.add(this._inputLine[t]);
        return e.toCoordinateArray();
      } }], [{ key: "constructor_", value: function() {
    ...
    var Xr = function() {
      ...
      return h(r, [{ key: "getCoordinates", value: function() {
        ...
        var e = new b(this._ptList.get(0)), t = this._ptList.get(this._ptList.size() - 1);
    ...
    Xr.COORDINATE_ARRAY_TYPE = new Array(0).fill(null);
    var rt = function() {
      function r() {
        s(this, r);
      }
      ...
      return h(r, [{ key: "addNextSegment", value: function(e, t) {
        ...
        switch (this._bufParams.getEndCapStyle()) {
          ...
          case C.CAP_SQUARE:
            ...
            var S = new b(i.p1.x + p.x, i.p1.y + p.y), L = new b(u.p1.x + p.x, u.p1.y + p.y);
            this._segList.addPt(S), this._segList.addPt(L);
        }
      } }, { key: "getCoordinates", value: function() {
        return this._segList.getCoordinates();
      } }, { key: "addMitreJoin", value: function(e, t, n, i) {
        var u = Dn.intersection(t.p0, t.p1, n.p0, n.p1);
        ...
        this._bufParams.getJoinStyle() === C.JOIN_MITRE ? this.addMitreJoin(this._s1, this._offset0, this._offset1, this._distance) : this._bufParams.getJoinStyle() === C.JOIN_BEVEL ? this.addBevelJoin(this._offset0, this._offset1) : (t && this._segList.addPt(this._offset0.p1), this.addCornerFillet(this._s1, this._offset0.p1, this._offset1.p0, e, this._distance), this._segList.addPt(this._offset1.p0));
      } }, { key: "createSquare", value: function(e) {
        this._segList.addPt(new b(e.x + this._distance, e.y + this._distance)), this._segList.addPt(new b(e.x + this._distance, e.y - this._distance)), this._segList.addPt(new b(e.x - this._distance, e.y - this._distance)), this._segList.addPt(new b(e.x - this._distance, e.y + this._distance)), this._segList.closeRing();
        ...
        var u = this._seg0.p1, c = rt.angle(u, this._seg0.p0), f = rt.angleBetweenOriented(this._seg0.p0, u, this._seg1.p1) / 2, d = rt.normalize(c + f), p = rt.normalize(d + Math.PI), S = i * n, L = n - S * Math.abs(Math.sin(f)), P = u.x + S * Math.cos(p), V = u.y + S * Math.sin(p), W = new b(P, V), $ = new it(u, W), ie = $.pointAlongOffset(1, L), le = $.pointAlongOffset(1, -L);
        ...
        if (d < 1) return null;
        for (var p = f / d, S = new b(), L = 0; L < d; L++) {
          var P = t + c * L * p;
        ...
        if (this._li.computeIntersection(this._offset0.p0, this._offset0.p1, this._offset1.p0, this._offset1.p1), this._li.hasIntersection()) this._segList.addPt(this._li.getIntersection(0));
          ...
          if (this._segList.addPt(this._offset0.p1), this._closingSegLengthFactor > 0) {
            var n = new b((this._closingSegLengthFactor * this._offset0.p1.x + this._s1.x) / (this._closingSegLengthFactor + 1), (this._closingSegLengthFactor * this._offset0.p1.y + this._s1.y) / (this._closingSegLengthFactor + 1));
        ...
        var t = new b(e.x + this._distance, e.y);
        ...
        this._distance = e, this._maxCurveSegmentError = e * (1 - Math.cos(this._filletAngleQuantum / 2)), this._segList = new Xr(), this._segList.setPrecisionModel(this._precisionModel), this._segList.setMinimumVertexDistance(e * r.CURVE_VERTEX_SNAP_DISTANCE_FACTOR);
      } }, { key: "addCollinear", value: function(e) {
        this._li.computeIntersection(this._s0, this._s1, this._s1, this._s2), this._li.getIntersectionNum() >= 2 && (this._bufParams.getJoinStyle() === C.JOIN_BEVEL || this._bufParams.getJoinStyle() === C.JOIN_MITRE ? (e && this._segList.addPt(this._offset0.p1), this._segList.addPt(this._offset1.p0)) : this.addCornerFillet(this._s1, this._offset0.p1, this._offset1.p0, re.CLOCKWISE, this._distance));
      } }, { key: "closeRing", value: function() {
        ...
        var e = arguments[0], t = arguments[1], n = arguments[2];
        this._precisionModel = e, this._bufParams = t, this._li = new sn(), this._filletAngleQuantum = Math.PI / 2 / t.getQuadrantSegments(), t.getQuadrantSegments() >= 8 && t.getJoinStyle() === C.JOIN_ROUND && (this._closingSegLengthFactor = r.MAX_CLOSING_SEG_LEN_FACTOR), this.init(n);
      } }]), r;
    }();
    ...
    var lu = function() {
      ...
      return h(r, [{ key: "getOffsetCurve", value: function(e, t) {
        ...
        for (var t = new Array(e.length).fill(null), n = 0; n < t.length; n++) t[n] = new b(e[n]);
        return t;
      } }]), r;
    }(), Wr = function() {
      function r() {
      ...
      return h(r, [{ key: "findStabbedSegments", value: function() {
        ...
        if (arguments.length === 3) {
          if (ue(arguments[2], Ke) && arguments[0] instanceof b && arguments[1] instanceof Hi) for (var c = arguments[0], f = arguments[1], d = arguments[2], p = f.getEdge().getCoordinates(), S = 0; S < p.length - 1; S++) {
            ...
            if (!(L < c.x) && !(this._seg.isHorizontal() || c.y < this._seg.p0.y || c.y > this._seg.p1.y || re.index(this._seg.p0, this._seg.p1, c) === re.RIGHT)) {
              ...
              var V = new Vr(this._seg, P);
              d.add(V);
            }
          }
          else if (ue(arguments[2], Ke) && arguments[0] instanceof b && ue(arguments[1], Ke)) for (var W = arguments[0], $ = arguments[1], ie = arguments[2], le = $.iterator(); le.hasNext(); ) {
            var pe = le.next();
    ...
    var Hr = function(r) {
      ...
      return h(r, [{ key: "getY", value: function() {
        var e = this.y / this.w;
        if (Q.isNaN(e) || Q.isInfinite(e)) throw new Hr();
        return e;
      } }, { key: "getX", value: function() {
        var e = this.x / this.w;
        if (Q.isNaN(e) || Q.isInfinite(e)) throw new Hr();
        ...
        if (this.x = null, this.y = null, this.w = null, arguments.length === 0) this.x = 0, this.y = 0, this.w = 1;
          ...
          var L = arguments[0], P = arguments[1], V = arguments[2], W = arguments[3], $ = L.y - P.y, ie = P.x - L.x, le = L.x * P.y - P.x * L.y, pe = V.y - W.y, Oe = W.x - V.x, Be = V.x * W.y - W.x * V.y;
          this.x = ie * Be - Oe * le, this.y = pe * le - $ * Be, this.w = $ * Oe - pe * ie;
        }
      } }]), r;
    }(), hu = function() {
      function r() {
      ...
      return h(r, [{ key: "addRingSide", value: function(e, t, n, i, u) {
        if (t === 0 && e.length < Fn.MINIMUM_VALID_SIZE) return null;
        var c = i, f = u;
        e.length >= Fn.MINIMUM_VALID_SIZE && re.isCCW(e) && (c = u, f = i, n = U.opposite(n));
        ...
        var i = new an(e, new ct(0, w.BOUNDARY, t, n));
        ...
        else if (e instanceof Gi) this.addCollection(e);
        else if (e instanceof Bi) this.addCollection(e);
        else if (e instanceof Yi) this.addCollection(e);
        else {
      ...
      return h(r, [{ key: "locate", value: function(e) {
        ...
        return t.getEnvelopeInternal().intersects(e) ? Wi.locateInRing(e, t.getCoordinates()) : w.EXTERIOR;
      ...
      return h(r, [{ key: "getNextCW", value: function(e) {
        ...
        return this._ptInAreaLocation[e] === w.NONE && (this._ptInAreaLocation[e] = du.locate(t, n[e].getGeometry())), this._ptInAreaLocation[e];
      } }, { key: "toString", value: function() {
        var e = new $t();
...
`);
        ...
        this._edgeMap = new Yn(), this._edgeList = null, this._ptInAreaLocation = [w.NONE, w.NONE];
      } }]), r;
    }(), vu = function(r) {
      g(t, r);
      var e = E(t);
      ...
      return h(r, [{ key: "print", value: function(e) {
        ...
        this._edges = new ne(), this._ocaMap = new Yn();
      } }]), r;
    }(), jr = function() {
      function r() {
        s(this, r);
      ...
      return h(r, [{ key: "getSegmentIndex", value: function() {
        ...
        var e = arguments[0], t = arguments[1], n = arguments[2];
        this.coord = new b(e), this.segmentIndex = t, this.dist = n;
      } }]), r;
    }(), Eu = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, [{ key: "print", value: function(e) {
        ...
        return u && (c[f] = t.coord), new Kr(c, new ct(this.edge._label));
        ...
        this._nodeMap = new Yn(), this.edge = null;
        var e = arguments[0];
        this.edge = e;
      } }]), r;
    }(), xu = function() {
      ...
      return h(r, [{ key: "isIntersects", value: function() {
        ...
        for (var e = new oi("123456789"), t = 0; t < 3; t++) for (var n = 0; n < 3; n++) e.setCharAt(3 * t + n, H.toDimensionSymbol(this._matrix[t][n]));
        return e.toString();
    ...
    var Kr = function(r) {
      ...
      return h(t, [{ key: "getDepth", value: function() {
        ...
        var f = new b(n.getIntersection(c)), d = i, p = n.getEdgeDistance(u, c), S = d + 1;
        ...
        if (this.pts = null, this._env = null, this.eiList = new Eu(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new Qr(), this._depthDelta = 0, arguments.length === 1) {
          var n = arguments[0];
        ...
        if (!(arguments.length === 2 && arguments[1] instanceof xu && arguments[0] instanceof ct)) return I(v(t), "updateIM", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
      ...
      return h(r, [{ key: "setWorkingPrecisionModel", value: function(e) {
        ...
        for (var n = new ne(), i = e.iterator(); i.hasNext(); ) {
          var u = i.next(), c = u.getRightmostCoordinate(), f = new Wr(n).getDepth(c);
        ...
        this.computeNodedEdges(u, n), this._graph = new Fr(new yu()), this._graph.addEdges(this._edgeList.getEdges());
        ...
        for (var i = n.getNodedSubstrings().iterator(); i.hasNext(); ) {
          ...
          if (c.length !== 2 || !c[0].equals2D(c[1])) {
            var f = u.getData(), d = new Kr(u.getCoordinates(), new ct(f));
      ...
      return h(r, [{ key: "rescale", value: function() {
        ...
        if (ue(arguments[0], oe)) {
          for (var e = arguments[0], t = new ne(e.size()), n = e.iterator(); n.hasNext(); ) {
            var i = n.next();
            t.add(new an(this.scale(i.getCoordinates()), i.getData()));
          }
          return t;
        }
        if (arguments[0] instanceof Array) {
          for (var u = arguments[0], c = new Array(u.length).fill(null), f = 0; f < u.length; f++) c[f] = new b(Math.round((u[f].x - this._offsetX) * this._scaleFactor), Math.round((u[f].y - this._offsetY) * this._scaleFactor), u[f].getZ());
    ...
    var Ki = function() {
      ...
      return h(r, [{ key: "intersectsScaled", value: function(e, t) {
        ...
        var t = 0.5;
        this._minx = e.x - t, this._maxx = e.x + t, this._miny = e.y - t, this._maxy = e.y + t, this._corner[0] = new b(this._maxx, this._maxy), this._corner[1] = new b(this._minx, this._maxy), this._corner[2] = new b(this._minx, this._miny), this._corner[3] = new b(this._maxx, this._miny);
      } }, { key: "intersects", value: function(e, t) {
        ...
        t !== 1 && (this._pt = new b(this.scale(e.x), this.scale(e.y)), this._p0Scaled = new b(), this._p1Scaled = new b()), this.initCorners(this._pt);
      } }]), r;
    }();
    Ki.SAFE_ENV_EXPANSION_FACTOR = 0.75;
    var Lu = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      }
      ...
      return h(r, [{ key: "snap", value: function() {
        ...
        if (arguments.length === 3) {
          var t = arguments[0], n = arguments[1], i = arguments[2], u = t.getSafeEnvelope(), c = new ts(t, n, i);
      ...
      return h(t, [{ key: "isNodeAdded", value: function() {
        ...
        if (!(arguments.length === 2 && Number.isInteger(arguments[1]) && arguments[0] instanceof Yr)) return I(v(t.prototype), "select", this).apply(this, arguments);
    ...
    var bu = function() {
      ...
      return h(r, [{ key: "checkCorrectness", value: function(e) {
        var t = an.getNodedSubstrings(e), n = new $r(t);
        try {
          n.checkValid();
        } catch (i) {
        ...
        else if (arguments[0] instanceof an) for (var i = arguments[0], u = i.getCoordinates(), c = 0; c < u.length; c++) {
          var f = new Ki(u[c], this._scaleFactor, this._li), d = this._pointSnapper.snap(f, i, c);
          d && i.addIntersection(u[c], c);
        }
      } }, { key: "computeNodes", value: function(e) {
        this._nodedSegStrings = e, this._noder = new ji(), this._pointSnapper = new es(this._noder.getIndex()), this.snapRound(e, this._li);
      } }, { key: "computeIntersectionSnaps", value: function(e) {
        for (var t = e.iterator(); t.hasNext(); ) {
          var n = t.next(), i = new Ki(n, this._scaleFactor, this._li);
        ...
        var e = arguments[0];
        this._pm = e, this._li = new sn(), this._li.setPrecisionModel(e), this._scaleFactor = e.getScale();
      } }]), r;
    }(), xn = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, [{ key: "bufferFixedPrecision", value: function(e) {
        var t = new Su(new Tu(new pt(1)), e.getScale()), n = new Jr(this._bufParams);
        ...
        if (arguments.length === 3) {
          ...
          if (arguments[2] instanceof C && arguments[0] instanceof J && typeof arguments[1] == "number") {
          ...
          var Be = Oe.getResultGeometry(ie);
          return Be;
        }
      } }, { key: "precisionScaleFactor", value: function(e, t, n) {
        var i = e.getEnvelopeInternal(), u = tn.max(Math.abs(i.getMaxX()), Math.abs(i.getMaxY()), Math.abs(i.getMinX()), Math.abs(i.getMinY())) + 2 * (t > 0 ? t : 0), c = n - Math.trunc(Math.log(u) / Math.log(10) + 1);
        return Math.pow(10, c);
      } }]), r;
    }();
    xn.CAP_ROUND = C.CAP_ROUND, xn.CAP_BUTT = C.CAP_FLAT, xn.CAP_FLAT = C.CAP_FLAT, xn.CAP_SQUARE = C.CAP_SQUARE, xn.MAX_PRECISION_DIGITS = 12;
    var Cu = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], ns = function() {
      function r(e) {
      ...
      return h(r, [{ key: "read", value: function(e) {
        ...
        return Cu.indexOf(n) !== -1 ? gt[n].call(this, t.coordinates) : n === "GeometryCollection" ? gt[n].call(this, t.geometries) : gt[n].call(this, t);
      } }, { key: "write", value: function(e) {
      ...
      return this.geometryFactory.createLinearRing([new b(r[0], r[1]), new b(r[2], r[1]), new b(r[2], r[3]), new b(r[0], r[3]), new b(r[0], r[1])]);
    }, Point: function(r) {
      var e = _(b, R(r));
    ...
    return { BufferOp: xn, GeoJSONReader: function() {
      function r(e) {
        s(this, r), this.parser = new ns(e || new yn());
      }
      return h(r, [{ key: "read", value: function(e) {
      ...
      function r() {
        s(this, r), this.parser = new ns(this.geometryFactory);
      }
      return h(r, [{ key: "write", value: function(e) {
        return this.parser.write(e);
      } }]), r;
...
bi.prototype = {
  ...
  add: function(o) {
    Ys(mi, o, this.t), Ys(this, mi.s, this.s), this.s ? this.t += mi.t : this.s = mi.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var Ne = 1e-6, ve = Math.PI, bt = ve / 2, Bs = ve / 4, Tt = ve * 2, Yt = 180 / ve, dt = ve / 180, Ye = Math.abs, Ll = Math.atan, Tn = Math.atan2, Me = Math.cos, Pe = Math.sin, On = Math.sqrt;
function pa(o) {
...
function Ti(o, a) {
  o && Xs.hasOwnProperty(o.type) && Xs[o.type](o, a);
}
var Us = {
  ...
  LineString: function(o, a) {
    mr(o.coordinates, a, 0);
  },
  MultiLineString: function(o, a) {
    for (var s = o.coordinates, l = -1, h = s.length; ++l < h; ) mr(s[l], a, 0);
  },
  Polygon: function(o, a) {
    Ws(o.coordinates, a);
  },
  MultiPolygon: function(o, a) {
    for (var s = o.coordinates, l = -1, h = s.length; ++l < h; ) Ws(s[l], a);
  },
...
function Ws(o, a) {
  var s = -1, l = o.length;
  for (a.polygonStart(); ++s < l; ) mr(o[s], a, 1);
  a.polygonEnd();
}
function bl(o, a) {
  o && Us.hasOwnProperty(o.type) ? Us[o.type](o, a) : Ti(o, a);
}
Kt();
Kt();
function vr(o) {
  return [Tn(o[1], o[0]), hn(o[2])];
}
function Cn(o) {
...
function yr(o) {
  var a = On(o[0] * o[0] + o[1] * o[1] + o[2] * o[2]);
  o[0] /= a, o[1] /= a, o[2] /= a;
}
Kt();
function _a(o, a) {
...
pr.invert = pr;
function Tl(o, a, s) {
  return (o %= Tt) ? a || s ? _a(Hs(o), Zs(a, s)) : Hs(o) : a || s ? Zs(a, s) : pr;
}
function Vs(o) {
  return function(a, s) {
...
function Hs(o) {
  var a = Vs(o);
  return a.invert = Vs(-o), a;
}
function Zs(o, a) {
  var s = Me(o), l = Pe(o), h = Me(a), g = Pe(a);
  function v(m, N) {
    var _ = Me(N), k = Me(m) * _, y = Pe(m) * _, x = Pe(N), E = x * s + k * l;
    return [
      Tn(y * h - E * g, k * s - x * l),
      hn(E * h + y * g)
    ];
  }
  return v.invert = function(m, N) {
    var _ = Me(N), k = Me(m) * _, y = Pe(m) * _, x = Pe(N), E = x * h - y * g;
    return [
      Tn(y * h + x * g, k * s + E * l),
      hn(E * s - k * l)
    ];
...
function Cl(o, a, s, l, h, g) {
  if (s) {
    var v = Me(a), m = Pe(a), N = l * s;
    h == null ? (h = a + l * Tt, g = a - N / 2) : (h = js(v, h), g = js(v, g), (l > 0 ? h < g : h > g) && (h += l * Tt));
    for (var _, k = h; l > 0 ? k > g : k < g; k -= N)
      _ = vr([v, -m * Me(k), -m * Pe(k)]), o.point(_[0], _[1]);
  }
}
function js(o, a) {
  a = Cn(a), a[0] -= o, yr(a);
...
function Rl(o, a, s, l, h, g) {
  var v = o[0], m = o[1], N = a[0], _ = a[1], k = 0, y = 1, x = N - v, E = _ - m, I;
  if (I = s - v, !(!x && I > 0)) {
    if (I /= x, x < 0) {
      if (I < k) return;
      I < y && (y = I);
    ...
    if (I = h - v, !(!x && I < 0)) {
      ...
      if (I = l - m, !(!E && I > 0)) {
        ...
        if (I = g - m, !(!E && I < 0)) {
          ...
          return k > 0 && (o[0] = v + k * x, o[1] = m + k * E), y < 1 && (a[0] = v + y * x, a[1] = m + y * E), !0;
        }
      }
    }
  }
...
function Ea(o, a, s, l, h) {
  ...
  if (o.forEach(function(I) {
    if (!((R = I.length - 1) <= 0)) {
      var R, T = I[0], M = I[R], F;
      if (Ii(T, M)) {
        for (h.lineStart(), m = 0; m < R; ++m) h.point((T = I[m])[0], T[1]);
        h.lineEnd();
        return;
      }
      g.push(F = new pi(T, I, null, !0)), v.push(F.o = new pi(T, null, F, !1)), g.push(F = new pi(M, I, null, !1)), v.push(F.o = new pi(M, null, F, !0));
    }
  }), !!g.length) {
    for (v.sort(a), Qs(g), Qs(v), m = 0, N = v.length; m < N; ++m)
      v[m].e = s = !s;
    for (var _ = g[0], k, y; ; ) {
      for (var x = _, E = !0; x.v; ) if ((x = x.n) === _) return;
      k = x.z, h.lineStart();
      do {
        if (x.v = x.o.v = !0, x.e) {
          if (E)
            for (m = 0, N = k.length; m < N; ++m) h.point((y = k[m])[0], y[1]);
          else
            l(x.x, x.n.x, 1, h);
          x = x.n;
        } else {
          if (E)
            for (k = x.p.z, m = k.length - 1; m >= 0; --m) h.point((y = k[m])[0], y[1]);
          else
            l(x.x, x.p.x, -1, h);
          x = x.p;
        }
...
function Pl(o, a, s, l) {
  ...
  function g(_, k, y, x) {
    var E = 0, I = 0;
    if (_ == null || (E = v(_, y)) !== (I = v(k, y)) || N(_, k) < 0 ^ y > 0)
      do
        x.point(E === 0 || E === 3 ? o : s, E > 1 ? l : a);
      while ((E = (E + y + 4) % 4) !== I);
    else
      x.point(k[0], k[1]);
  }
  ...
  function N(_, k) {
    var y = v(_, 1), x = v(k, 1);
    return y !== x ? y - x : y === 0 ? k[1] - _[1] : y === 1 ? _[0] - k[0] : y === 2 ? _[1] - k[1] : k[0] - _[0];
  }
  return function(_) {
    var k = _, y = ka(), x, E, I, R, T, M, F, C, q, O, B, z = {
      point: X,
      lineStart: j,
      lineEnd: ce,
      polygonStart: Z,
    ...
    function G() {
      for (var K = 0, se = 0, me = E.length; se < me; ++se)
        for (var Re = E[se], Ee = 1, Q = Re.length, Ae = Re[0], Ie, qe, he = Ae[0], ut = Ae[1]; Ee < Q; ++Ee)
          Ie = he, qe = ut, Ae = Re[Ee], he = Ae[0], ut = Ae[1], qe <= l ? ut > l && (he - Ie) * (l - qe) > (ut - qe) * (o - Ie) && ++K : ut <= l && (he - Ie) * (l - qe) < (ut - qe) * (o - Ie) && --K;
      return K;
    }
    function Z() {
      k = y, x = [], E = [], B = !0;
    ...
    function ee() {
      var K = G(), se = B && K, me = (x = Na(x)).length;
      (se || me) && (_.polygonStart(), se && (_.lineStart(), g(null, null, 1, _), _.lineEnd()), me && Ea(x, m, K, g, _), _.polygonEnd()), k = _, x = E = I = null;
    }
    function j() {
      z.point = D, E && E.push(I = []), O = !0, q = !1, F = C = NaN;
    }
    function ce() {
      x && (D(R, T), M && q && y.rejoin(), x.push(y.result())), z.point = X, q && k.lineEnd();
    }
    function D(K, se) {
      var me = h(K, se);
      if (E && I.push([K, se]), O)
        R = K, T = se, M = me, O = !1, me && (k.lineStart(), k.point(K, se));
      else if (me && q) k.point(K, se);
      else {
        var Re = [F = Math.max(_i, Math.min(jn, F)), C = Math.max(_i, Math.min(jn, C))], Ee = [K = Math.max(_i, Math.min(jn, K)), se = Math.max(_i, Math.min(jn, se))];
        Rl(Re, Ee, o, a, s, l) ? (q || (k.lineStart(), k.point(Re[0], Re[1])), k.point(Ee[0], Ee[1]), me || k.lineEnd(), B = !1) : me && (k.lineStart(), k.point(K, se), B = !1);
      }
      F = K, C = se, q = me;
    }
    return z;
...
function Al(o, a) {
  ...
  for (var m = 0, N = o.length; m < N; ++m)
    if (k = (_ = o[m]).length)
      for (var _, k, y = _[k - 1], x = y[0], E = y[1] / 2 + Bs, I = Pe(E), R = Me(E), T = 0; T < k; ++T, x = F, I = q, R = O, y = M) {
        var M = _[T], F = M[0], C = M[1] / 2 + Bs, q = Pe(C), O = Me(C), B = F - x, z = B >= 0 ? 1 : -1, X = z * B, G = X > ve, Z = I * q;
        if (ar.add(Tn(Z * z * Pe(X), R * O + Z * Me(X))), g += G ? B + z * Tt : B, G ^ x >= s ^ F >= s) {
          var ee = Ci(Cn(y), Cn(M));
          yr(ee);
          var j = Ci(h, ee);
          yr(j);
          var ce = (G ^ B >= 0 ? -1 : 1) * hn(j[2]);
          (l > ce || l === ce && (ee[0] || ee[1])) && (v += G ^ B >= 0 ? 1 : -1);
        }
      }
...
Kt();
Kt();
var Rn = 1 / 0, Ri = Rn, ei = -Rn, Oi = ei, Js = {
  point: Dl,
  lineStart: Zn,
  lineEnd: Zn,
  polygonStart: Zn,
  ...
  result: function() {
    var o = [[Rn, Ri], [ei, Oi]];
    return ei = Oi = -(Ri = Rn = 1 / 0), o;
  }
};
function Dl(o, a) {
  o < Rn && (Rn = o), o > ei && (ei = o), a < Ri && (Ri = a), a > Oi && (Oi = a);
}
Kt();
function Ia(o, a, s, l) {
  return function(h, g) {
    var v = a(g), m = h.invert(l[0], l[1]), N = ka(), _ = a(N), k = !1, y, x, E, I = {
      point: R,
      lineStart: M,
      lineEnd: F,
      polygonStart: function() {
        I.point = C, I.lineStart = q, I.lineEnd = O, x = [], y = [];
      },
      polygonEnd: function() {
        I.point = R, I.lineStart = M, I.lineEnd = F, x = Na(x);
        var B = Al(y, m);
        x.length ? (k || (g.polygonStart(), k = !0), Ea(x, Gl, B, s, g)) : B && (k || (g.polygonStart(), k = !0), g.lineStart(), s(null, null, 1, g), g.lineEnd()), k && (g.polygonEnd(), k = !1), x = y = null;
      },
      sphere: function() {
    ...
    function O() {
      C(E[0][0], E[0][1]), _.lineEnd();
      var B = _.clean(), z = N.result(), X, G = z.length, Z, ee, j;
      if (E.pop(), y.push(E), E = null, !!G) {
        if (B & 1) {
        ...
        G > 1 && B & 2 && z.push(z.pop().concat(z.shift())), x.push(z.filter(Fl));
      }
    }
    return I;
  };
...
function ql(o) {
  ...
  return {
    ...
    point: function(g, v) {
      var m = g > 0 ? ve : -ve, N = Ye(g - a);
      Ye(N - ve) < Ne ? (o.point(a, s = (s + v) / 2 > 0 ? bt : -bt), o.point(l, s), o.lineEnd(), o.lineStart(), o.point(m, s), o.point(g, s), h = 0) : l !== m && N >= ve && (Ye(a - l) < Ne && (a -= l * Ne), Ye(g - m) < Ne && (g -= m * Ne), s = zl(a, s, g, v), o.point(l, s), o.lineEnd(), o.lineStart(), o.point(m, s), h = 0), o.point(a = g, s = v), l = m;
    },
    lineEnd: function() {
      o.lineEnd(), a = s = NaN;
    },
...
function zl(o, a, s, l) {
  var h, g, v = Pe(o - s);
  return Ye(v) > Ne ? Ll((Pe(a) * (g = Me(l)) * Pe(s) - Pe(l) * (h = Me(a)) * Pe(o)) / (h * g * v)) : (a + l) / 2;
}
function Yl(o, a, s, l) {
  var h;
  if (o == null)
...
function Bl(o, a) {
  ...
  function m(k) {
    ...
    return {
      ...
      point: function(T, M) {
        var F = [T, M], C, q = v(T, M), O = l ? q ? 0 : _(T, M) : q ? _(T + (T < 0 ? ve : -ve), M) : 0;
        if (!y && (I = E = q) && k.lineStart(), q !== E && (C = N(y, F), (!C || Ii(y, C) || Ii(F, C)) && (F[0] += Ne, F[1] += Ne, q = v(F[0], F[1]))), q !== E)
          R = 0, q ? (k.lineStart(), C = N(F, y), k.point(C[0], C[1])) : (C = N(y, F), k.point(C[0], C[1]), k.lineEnd()), y = C;
        else if (h && y && l ^ q) {
          var B;
          !(O & x) && (B = N(F, y, !0)) && (R = 0, l ? (k.lineStart(), k.point(B[0][0], B[0][1]), k.point(B[1][0], B[1][1]), k.lineEnd()) : (k.point(B[1][0], B[1][1]), k.lineEnd(), k.lineStart(), k.point(B[0][0], B[0][1])));
        }
        q && (!y || !Ii(y, F)) && k.point(F[0], F[1]), y = F, E = q, x = O;
      },
      lineEnd: function() {
        E && k.lineEnd(), y = null;
      },
  ...
  function N(k, y, x) {
    var E = Cn(k), I = Cn(y), R = [1, 0, 0], T = Ci(E, I), M = vi(T, T), F = T[0], C = M - F * F;
    if (!C) return !x && k;
    var q = s * M / C, O = -s * F / C, B = Ci(R, T), z = yi(R, q), X = yi(T, O);
    sr(z, X);
    var G = B, Z = vi(z, G), ee = vi(G, G), j = Z * Z - ee * (vi(z, z) - 1);
    if (!(j < 0)) {
      var ce = On(j), D = yi(G, (-Z - ce) / ee);
      if (sr(D, z), D = vr(D), !x) return D;
      var K = k[0], se = y[0], me = k[1], Re = y[1], Ee;
      se < K && (Ee = K, K = se, se = Ee);
      var Q = se - K, Ae = Ye(Q - ve) < Ne, Ie = Ae || Q < Ne;
      if (!Ae && Re < me && (Ee = me, me = Re, Re = Ee), Ie ? Ae ? me + Re > 0 ^ D[1] < (Ye(D[0] - K) < Ne ? me : Re) : me <= D[1] && D[1] <= Re : Q > ve ^ (K <= D[0] && D[0] <= se)) {
        var qe = yi(G, (-Z + ce) / ee);
        return sr(qe, z), [D, vr(qe)];
      }
    }
  }
  function _(k, y) {
    var x = l ? o : ve - o, E = 0;
    return k < -x ? E |= 1 : k > x && (E |= 2), y < -x ? E |= 4 : y > x && (E |= 8), E;
  }
...
function Sa(o, a, s) {
  ...
  o.scale(150).translate([0, 0]), g != null && o.clipExtent(null), bl(s, o.stream(Js));
  var v = Js.result(), m = Math.min(l / (v[1][0] - v[0][0]), h / (v[1][1] - v[0][1])), N = +a[0][0] + (l - m * (v[1][0] + v[0][0])) / 2, _ = +a[0][1] + (h - m * (v[1][1] + v[0][1])) / 2;
  return g != null && o.clipExtent(g), o.scale(m * 150).translate([N, _]);
}
function Ul(o, a, s) {
  return Sa(o, [[0, 0], a], s);
}
var ea = 16, Xl = Me(30 * dt);
function ta(o, a) {
  return +a ? Vl(o, a) : Wl(o);
}
function Wl(o) {
  return wa({
    point: function(a, s) {
...
function Vl(o, a) {
  function s(l, h, g, v, m, N, _, k, y, x, E, I, R, T) {
    var M = _ - l, F = k - h, C = M * M + F * F;
    if (C > 4 * a && R--) {
      var q = v + x, O = m + E, B = N + I, z = On(q * q + O * O + B * B), X = hn(B /= z), G = Ye(Ye(B) - 1) < Ne || Ye(g - y) < Ne ? (g + y) / 2 : Tn(O, q), Z = o(G, X), ee = Z[0], j = Z[1], ce = ee - l, D = j - h, K = F * ce - M * D;
      (K * K / C > a || Ye((M * ce + F * D) / C - 0.5) > 0.3 || v * x + m * E + N * I < Xl) && (s(l, h, g, v, m, N, ee, j, G, q /= z, O /= z, B, R, T), T.point(ee, j), s(ee, j, G, q, O, B, _, k, y, x, E, I, R, T));
    }
  }
  return function(l) {
    var h, g, v, m, N, _, k, y, x, E, I, R, T = {
      point: M,
      lineStart: F,
      lineEnd: q,
      polygonStart: function() {
        l.polygonStart(), T.lineStart = O;
      },
      polygonEnd: function() {
        l.polygonEnd(), T.lineStart = F;
      }
    };
    function M(X, G) {
    ...
    function F() {
      y = NaN, T.point = C, l.lineStart();
    }
    function C(X, G) {
      var Z = Cn([X, G]), ee = o(X, G);
      s(y, x, k, E, I, R, y = ee[0], x = ee[1], k = X, E = Z[0], I = Z[1], R = Z[2], ea, l), l.point(y, x);
    }
    function q() {
      T.point = M, l.lineEnd();
    }
    function O() {
      F(), T.point = B, T.lineEnd = z;
    }
    function B(X, G) {
      C(h = X, G), g = y, v = x, m = E, N = I, _ = R, T.point = C;
    }
    function z() {
      s(y, x, k, E, I, R, g, v, h, m, N, _, ea, l), T.lineEnd = q, q();
    }
    return T;
  };
}
...
function jl(o) {
  var a, s = 150, l = 480, h = 250, g, v, m = 0, N = 0, _ = 0, k = 0, y = 0, x, E, I = null, R = $s, T = null, M, F, C, q = Ks, O = 0.5, B = ta(ee, O), z, X;
  function G(D) {
    return D = E(D[0] * dt, D[1] * dt), [D[0] * s + g, v - D[1] * s];
  }
  function Z(D) {
    return D = E.invert((D[0] - g) / s, (v - D[1]) / s), D && [D[0] * Yt, D[1] * Yt];
  }
  function ee(D, K) {
    return D = a(D, K), [D[0] * s + g, v - D[1] * s];
  }
  G.stream = function(D) {
    return z && X === D ? z : z = Hl(R(x, B(q(X = D))));
  }, G.clipAngle = function(D) {
    return arguments.length ? (R = +D ? Bl(I = D * dt, 6 * dt) : (I = null, $s), ce()) : I * Yt;
  }, G.clipExtent = function(D) {
    return arguments.length ? (q = D == null ? (T = M = F = C = null, Ks) : Pl(T = +D[0][0], M = +D[0][1], F = +D[1][0], C = +D[1][1]), ce()) : T == null ? null : [[T, M], [F, C]];
  }, G.scale = function(D) {
    return arguments.length ? (s = +D, j()) : s;
  }, G.translate = function(D) {
    return arguments.length ? (l = +D[0], h = +D[1], j()) : [l, h];
  }, G.center = function(D) {
    return arguments.length ? (m = D[0] % 360 * dt, N = D[1] % 360 * dt, j()) : [m * Yt, N * Yt];
  }, G.rotate = function(D) {
    return arguments.length ? (_ = D[0] % 360 * dt, k = D[1] % 360 * dt, y = D.length > 2 ? D[2] % 360 * dt : 0, j()) : [_ * Yt, k * Yt, y * Yt];
  }, G.precision = function(D) {
    return arguments.length ? (B = ta(ee, O = D * D), ce()) : On(O);
  }, G.fitExtent = function(D, K) {
    return Sa(G, D, K);
  }, G.fitSize = function(D, K) {
    return Ul(G, D, K);
  };
  function j() {
    E = _a(x = Tl(_, k, y), a);
    var D = a(m, N);
    return g = l - D[0] * s, v = h + D[1] * s, ce();
  }
  function ce() {
    return z = X = null, G;
  }
...
function ba(o) {
  return function(a, s) {
    var l = On(a * a + s * s), h = o(l), g = Pe(h), v = Me(h);
    return [
      Tn(a * g, l * v),
      hn(l && s * g / l)
    ];
...
var Ql = La(function(o) {
  return On(2 / (1 + o));
});
Ql.invert = ba(function(o) {
  return 2 * hn(o / 2);
});
...
function Kl() {
  return Zl(Ta).scale(79.4188).clipAngle(180 - 1e-3);
}
function na(o, a) {
  return [o, a];
}
na.invert = na;
var { BufferOp: Jl, GeoJSONReader: $l, GeoJSONWriter: eh } = Sl;
function th(o, a, s) {
  s = s || {};
  ...
  switch (o.type) {
    case "GeometryCollection":
      return Mi(o, function(v) {
        var m = wi(v, a, l, h);
        m && g.push(m);
      }), bn(g);
    case "FeatureCollection":
      return zs(o, function(v) {
        var m = wi(v, a, l, h);
        m && zs(m, function(N) {
          N && g.push(N);
        });
...
function wi(o, a, s, l) {
  ...
  }, _ = new $l(), k = _.read(N), y = Uo(Xo(a, s), "meters"), x = Jl.bufferOp(k, y, l), E = new eh();
  if (x = E.write(x), !Ca(x.coordinates)) {
    var I = {
      type: x.type,
      coordinates: Oa(x.coordinates, m)
    };
    return ti(I, h);
  }
}
...
function nh(o) {
  var a = xl(o).geometry.coordinates, s = [-a[0], -a[1]];
  return Kl().rotate(s).scale($e);
}
var ih = th;
function rh(o) {
  const a = [];
  ...
  return l.length === 0 ? null : l.length === 1 ? Er(l[0], s) : ga(l, s);
}
var sh = rh;
function ia(o) {
  let a;
...
function ah(o, a = !0, s = !0, l = {}, h = {}, g = (v) => {
  var _, k, y;
  const m = (_ = v == null ? void 0 : v.geometry) == null ? void 0 : _.type, N = (k = v == null ? void 0 : v.properties) != null && k.isMask ? 0 : m === "LineString" || m === "MultiLineString" ? 3 : 2;
  return {
    color: "#3170fe",
    fillColor: "#000",
    fillOpacity: (y = v == null ? void 0 : v.properties) != null && y.isMask ? 0.1 : 0,
    weight: N,
    dashArray: [N, N],
    lineCap: "butt"
  };
  ...
  function x(E, I = !1) {
    ...
    return new yo({ props: { displayIn: "leaflet" }, target: R }), new Pt.Marker(E, {
      interactive: I,
      icon: new Pt.DivIcon({
        html: R,
        className: "",
  ...
  return {
    setEventHandler(E) {
      E ? (v = E, o.on("click", y)) : (v = void 0, o.off("click", y));
    },
    flyTo(E, I) {
      o.flyTo([E[1], E[0]], I, { duration: 2, ...l });
    },
    fitBounds(E, I, R) {
      o.flyToBounds(
        [
        ...
        { padding: [I, I], duration: 2, maxZoom: R, ...h }
      );
    },
    indicateReverse(E) {
      o.getContainer().style.cursor = E ? "crosshair" : "";
    },
    setReverseMarker(E) {
      var R;
      if (!a)
        return;
      const I = E && [E[1], E[0]];
      _ ? I ? _.setLatLng(I) : (_.remove(), _ = void 0) : I && (_ = (typeof a == "object" ? new Pt.Marker(I, a) : x(I)).addTo(o), (R = _.getElement()) == null || R.classList.add("marker-reverse"));
    },
    setMarkers(E, I) {
      if (!a)
        return;
      function R(T) {
        k.clearLayers(), T && k.addData(T);
      }
      for (const T of m)
        T.remove();
      if (m.length = 0, R(), I) {
        ...
        if (I.geometry.type === "GeometryCollection") {
          const F = I.geometry.geometries.filter(
          ...
          e: if (F.length > 0) {
            ...
            const C = I.geometry.geometries.filter(
        ...
        m.push(
          (typeof a == "object" ? new Pt.Marker(M, a) : x(M)).addTo(o)
        );
      }
      if (s)
        for (const T of E ?? []) {
          ...
          const M = [
            T.center[1],
            T.center[0]
          ], F = typeof s == "object" ? new Pt.Marker(M, s) : x(M, !0);
          F.addTo(o).bindTooltip(
            T.place_type[0] === "reverse" ? T.place_name : T.place_name.replace(/,.*/, ""),
            {
              direction: "top"
            }
          );
          const C = F.getElement();
          C && (C.addEventListener("click", (q) => {
            q.stopPropagation(), v == null || v({ type: "markerClick", id: T.id });
          }), C.addEventListener("mouseenter", () => {
            v == null || v({ type: "markerMouseEnter", id: T.id });
          }), C.addEventListener("mouseleave", () => {
            v == null || v({ type: "markerMouseLeave", id: T.id });
          }), C.classList.toggle("marker-fuzzy", !!T.matching_text)), m.push(F);
        }
    },
    setSelectedMarker(E) {
      var I, R;
      N && ((I = N.getElement()) == null || I.classList.toggle("marker-selected", !1)), N = E > -1 ? m[E] : void 0, (R = N == null ? void 0 : N.getElement()) == null || R.classList.toggle("marker-selected", !0);
    },
    getCenterAndZoom() {
      const E = o.getCenter();
      return [o.getZoom(), E.lng, E.lat];
    }
  };
}
var mt, ln;
class uh extends Pt.Control {
  constructor(s) {
    super();
    tr(this, mt);
    tr(this, ln);
  ...
  onAdd(s) {
    ...
    l.className = "leaflet-ctrl-geocoder", Pt.DomEvent.disableClickPropagation(l), Pt.DomEvent.disableScrollPropagation(l);
    const {
      marker: h,
      showResultMarkers: g,
      flyTo: v,
      fullGeometryStyle: m,
      ...N
    } = Et(this, ln), _ = typeof v == "boolean" ? {} : v, k = ah(
      s,
      h,
      g,
      _,
    ...
    for (const y of [
      ...
      Et(this, mt).$on(
        y,
        (x) => s.fire(y.toLowerCase(), x.detail)
      );
    return l;
  }
  setOptions(s) {
    ...
    (N = Et(this, mt)) == null || N.$set(m);
  }
  setQuery(s, l = !0) {
    var h;
    (h = Et(this, mt)) == null || h.setQuery(s, l);
  }
  clearMap() {
    var s;
    (s = Et(this, mt)) == null || s.clearMap();
  }
  clearList() {
    var s;
    (s = Et(this, mt)) == null || s.clearList();
  }
  focus() {
    var s;
    (s = Et(this, mt)) == null || s.focus();
  }
  blur() {
    var s;
    (s = Et(this, mt)) == null || s.blur();
  }
  onRemove() {
    var s;
    (s = Et(this, mt)) == null || s.$destroy();
  }
}
mt = new WeakMap(), ln = new WeakMap();
function oh(...o) {
  return new uh(...o);
}
window.L && typeof window.L == "object" && typeof window.L.control == "function" && (window.L.control.maptilerGeocoding = oh);
export {
  uh as GeocodingControl,
  ah as createLeafletMapController
};
