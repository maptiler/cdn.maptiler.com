...
import * as Mu from "@maptiler/sdk";
function Le() {
}
function Pu(o, a) {
...
class ch extends oh {
  ...
  getExtraProps(a, s) {
    const l = {};
    if (!("getSdkConfig" in a && typeof a.getSdkConfig == "function"))
      throw new Error("MapTiler SDK not detected");
    const { primaryLanguage: h, apiKey: g } = a.getSdkConfig();
    l.apiKey = g;
    const v = /^([a-z]{2})($|_|-)/.exec(h);
    return v && (l.language = v[1]), s.className += " maptiler-ctrl", l;
  }
}
export {
