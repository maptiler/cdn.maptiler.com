...
var Yu = (o, a, s) => a in o ? zu(o, a, { enumerable: !0, configurable: !0, writable: !0, value: s }) : o[a] = s;
var dt = (o, a, s) => Yu(o, typeof a != "symbol" ? a + "" : a, s), os = (o, a, s) => a.has(o) || us("Cannot " + s);
var Et = (o, a, s) => (os(o, a, "read from private field"), s ? s.call(o) : a.get(o)), nr = (o, a, s) => a.has(o) ? us("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(o) : a.set(o, s), di = (o, a, s, l) => (os(o, a, "write to private field"), l ? l.call(o, s) : a.set(o, s), s);
import { Control as Bu } from "ol/control";
import jt from "ol/events/Event";
import { Feature as Mt } from "ol";
import { Point as ir, Polygon as ls, MultiPolygon as hs, GeometryCollection as Uu, LineString as cs, MultiLineString as fs } from "ol/geom";
import Xu from "ol/layer/Vector";
import { fromLonLat as mi, transformExtent as Wu, toLonLat as gs, getUserProjection as Vu } from "ol/proj";
import Hu from "ol/source/Vector";
import ds from "ol/style/Fill";
import Zu from "ol/style/Icon";
import ms from "ol/style/Stroke";
import ju from "ol/style/Style";
import Qu from "ol/style/Text";
function Me() {
}
function Ku(o, a) {
...
let vi;
function Xe(o, a) {
  return o === a ? !0 : (vi || (vi = document.createElement("a")), vi.href = a, o === vi.href);
}
function Ju(o) {
...
function ya(o, a, s, l) {
  return o[1] && l ? Ku(s.ctx.slice(), o[1](l(a))) : s.ctx;
}
function eo(o, a, s, l) {
  if (o[2] && l) {
    const h = o[2](l(s));
...
function ao(o, a, { bubbles: s = !1, cancelable: l = !1 } = {}) {
...
const bn = [], lr = [];
let Tn = [];
const ks = [], lo = /* @__PURE__ */ Promise.resolve();
let hr = !1;
function ho() {
  hr || (hr = !0, lo.then(_a));
}
...
function _a() {
  ...
  do {
    try {
      ...
      throw bn.length = 0, Sn = 0, a;
    }
    for (Kn(null), bn.length = 0, Sn = 0; lr.length; ) lr.pop()();
    for (let a = 0; a < Tn.length; a += 1) {
      const s = Tn[a];
      rr.has(s) || (rr.add(s), s());
    }
    Tn.length = 0;
...
function co(o) {
  if (o.fragment !== null) {
    ...
    const a = o.dirty;
    o.dirty = [-1], o.fragment && o.fragment.p(o.ctx, a), o.after_update.forEach(cr);
  }
}
function fo(o) {
  const a = [], s = [];
  Tn.forEach((l) => o.indexOf(l) === -1 ? a.push(l) : s.push(l)), s.forEach((l) => l()), Tn = a;
}
...
function Ii() {
  un.r || Gt(un.c), un = un.p;
}
function De(o, a) {
  o && o.i && (xi.delete(o), o.i(a));
}
function ze(o, a, s, l) {
  if (o && o.o) {
    if (xi.has(o)) return;
    xi.add(o), un.c.push(() => {
      xi.delete(o), l && (s && o.d(1), l());
    }), o.o(a);
  } else l && l();
}
function Es(o) {
...
function mo(o, a, s, l, h, g, v, m, x, _, k, y) {
  let E = o.length, N = g.length, I = E;
  const b = {};
  for (; I--; ) b[o[I].key] = I;
  const O = [], C = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), R = [];
  for (I = N; I--; ) {
    const z = y(h, g, I), X = s(z);
    let G = v.get(X);
    G ? R.push(() => G.p(z, a)) : (G = _(X, z), G.c()), C.set(X, O[I] = G), X in b && P.set(X, Math.abs(I - b[X]));
  }
  ...
  for (; E && N; ) {
    const z = O[N - 1], X = o[E - 1], G = z.key, Z = X.key;
    z === X ? (k = z.first, E--, N--) : C.has(Z) ? !v.has(G) || q.has(G) ? Y(z) : M.has(Z) ? E-- : P.get(G) > P.get(Z) ? (M.add(G), Y(z)) : (q.add(Z), E--) : (x(X, v), E--);
  }
  for (; E--; ) {
    const z = o[E];
    C.has(z.key) || x(z, v);
...
function Dt(o, a, s) {
  ...
  l && l.m(a, s), cr(() => {
    const g = o.$$.on_mount.map(ma).filter(va);
    o.$$.on_destroy ? o.$$.on_destroy.push(...g) : Gt(g), o.$$.on_mount = [];
  }), h.forEach(cr);
}
function Ft(o, a) {
  const s = o.$$;
  s.fragment !== null && (fo(s.after_update), Gt(s.on_destroy), s.fragment && s.fragment.d(a), s.on_destroy = s.fragment = null, s.ctx = []);
}
function vo(o, a) {
  o.$$.dirty[0] === -1 && (bn.push(o), ho(), o.$$.dirty.fill(0)), o.$$.dirty[a / 31 | 0] |= 1 << a % 31;
}
function cn(o, a, s, l, h, g, v = null, m = [-1]) {
  const x = $n;
  Kn(o);
  const _ = o.$$ = {
    fragment: null,
  ...
  if (_.ctx = s ? s(o, a.props || {}, (y, E, ...N) => {
    ...
    return _.ctx && h(_.ctx[y], _.ctx[y] = I) && (!_.skip_bound && _.bound[y] && _.bound[y](I), k && vo(o, y)), E;
  }) : [], _.update(), k = !0, Gt(_.before_update), _.fragment = l ? l(_.ctx) : !1, a.target) {
    if (a.hydrate) {
      const y = so(a.target);
      _.fragment && _.fragment.l(y), y.forEach(be);
    } else
      _.fragment && _.fragment.c();
    a.intro && De(o.$$.fragment), Dt(o, a.target, a.anchor), _a();
  }
  Kn(x);
}
class fn {
   ...
   */
  $set(a) {
    this.$$set && !Ju(a) && (this.$$.skip_bound = !0, this.$$set(a), this.$$.skip_bound = !1);
  }
}
const yo = "4";
...
function bo(o) {
  ...
  function R(G, Z) {
    ...
    G[5] ? Lo : (
      ...
      G[0].address ? So : (
        /*feature*/
        ((ee = G[0].properties) == null ? void 0 : ee.kind) === "road" || /*feature*/
        ((j = G[0].properties) == null ? void 0 : j.kind) === "road_relation" ? wo : (s == null && (s = !!/*feature*/
        G[0].id.startsWith("address.")), s ? Io : (l == null && (l = !!/*feature*/
        G[0].id.startsWith("postal_code.")), l ? No : (h == null && (h = !!/*feature*/
        G[0].id.startsWith("poi.")), h ? xo : (
          /*isReverse*/
          G[7] ? Eo : ko
        ))))
      )
  ...
  let q = R(o, -1), M = q(o), Y = E && xs(o);
  return {
    c() {
      a = _e("li"), M.c(), g = at(), v = _e("span"), m = _e("span"), x = _e("span"), k = Vt(_), y = at(), Y && Y.c(), N = at(), I = _e("span"), O = Vt(b), B(x, "class", "primary svelte-ltkwvy"), B(m, "class", "svelte-ltkwvy"), B(I, "class", "line2 svelte-ltkwvy"), B(v, "class", "texts svelte-ltkwvy"), B(a, "tabindex", "0"), B(
        a,
        "data-selected",
        /*selected*/
        o[1]
      ), B(a, "class", "svelte-ltkwvy"), Ut(
        a,
        "selected",
        /*selected*/
        o[1]
    ...
    m(G, Z) {
      Pe(G, a, Z), M.m(a, null), de(a, g), de(a, v), de(v, m), de(m, x), de(x, k), de(m, y), Y && Y.m(m, null), de(v, N), de(v, I), de(I, O), C || (P = [
        je(
          a,
          "mouseenter",
          /*mouseenter_handler*/
    ...
    p(G, [Z]) {
      var ee, j;
      q === (q = R(G, Z)) && M ? M.p(G, Z) : (M.d(1), M = q(G), M && (M.c(), M.m(a, g))), Z & /*feature*/
      1 && _ !== (_ = /*isReverse*/
      (G[7] ? (
        /*feature*/
        G[0].place_name
      ...
      )) + "") && Jn(k, _), Z & /*showPlaceType, feature, imageUrl*/
      37 && (E = /*showPlaceType*/
      G[2] === "always" || /*showPlaceType*/
      G[2] && !/*feature*/
      G[0].address && /*feature*/
      ((ee = G[0].properties) == null ? void 0 : ee.kind) !== "road" && /*feature*/
      ((j = G[0].properties) == null ? void 0 : j.kind) !== "road_relation" && !/*feature*/
      G[0].id.startsWith("address.") && !/*feature*/
      G[0].id.startsWith("postal_code.") && (!/*feature*/
      G[0].id.startsWith("poi.") || !/*imageUrl*/
      G[5]) && !/*isReverse*/
      G[7]), E ? Y ? Y.p(G, Z) : (Y = xs(G), Y.c(), Y.m(m, null)) : Y && (Y.d(1), Y = null), Z & /*feature*/
      1 && b !== (b = /*isReverse*/
      (G[7] ? "" : (
        /*feature*/
...
function To(o, a, s) {
  ...
  const k = (R = g.properties) == null ? void 0 : R.categories;
  let y, E, N = 0, I = g.place_type[0] === "reverse";
  function b() {
    E && x.add(E), s(10, N++, N);
  }
  function O(q) {
  ...
  const P = () => b();
  return o.$$set = (q) => {
    "feature" in q && s(0, g = q.feature), "selected" in q && s(1, v = q.selected), "showPlaceType" in q && s(2, m = q.showPlaceType), "missingIconsCache" in q && s(9, x = q.missingIconsCache), "iconsBaseUrl" in q && s(3, _ = q.iconsBaseUrl);
  }, o.$$.update = () => {
    var q, M, Y, z;
    ...
    3640)
      ...
      while (l > -1 && (!E || x.has(E)));
    o.$$.dirty & /*feature*/
    1 && s(6, h = g.id.startsWith("poi.") ? (M = (q = g.properties) == null ? void 0 : q.categories) == null ? void 0 : M.join(", ") : ((z = (Y = g.properties) == null ? void 0 : Y.place_type_name) == null ? void 0 : z[0]) ?? g.place_type[0]);
...
function Ao(o) {
  ...
  return {
    c() {
      a = Pt("svg"), s = Pt("circle"), l = Pt("path"), B(s, "cx", "4.789"), B(s, "cy", "4.787"), B(s, "r", "3.85"), B(s, "class", "svelte-1aq105l"), B(l, "d", "M12.063 12.063 7.635 7.635"), B(l, "class", "svelte-1aq105l"), B(a, "xmlns", "http://www.w3.org/2000/svg"), B(a, "width", "13"), B(a, "height", "13"), B(a, "viewBox", "0 0 13 13"), B(a, "class", "svelte-1aq105l");
    },
    m(h, g) {
      Pe(h, a, g), de(a, s), de(a, l);
    },
    p: Me,
    i: Me,
    o: Me,
  ...
  for (const h of a ?? [])
    if (!(l && (h.minZoom != null && h.minZoom > l[0] || h.maxZoom != null && h.maxZoom < l[0]))) {
      ...
      e: if (h.type === "client-geolocation") {
        if (Vn && h.cachedLocationExpiry && Vn.time + h.cachedLocationExpiry > Date.now()) {
          if (!Vn.coords)
            break e;
          return Vn.coords;
        }
...
const qo = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(EAST|WEST|[EW])?$/i, Is = /^([+-]?[0-8]?[0-9])\s+([0-5]?[0-9]\.\d{3,})[\s,]{1,}([+-]?[0-1]?[0-9]?[0-9])\s+([0-5]?[0-9]\.\d{3,})$/, ws = /^(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?$/i, Ss = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?$/i, Ls = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?$/i, bs = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?$/i;
function zo(o) {
  ...
  if (this.decimalCoordinates && this.decimalCoordinates.trim()) {
    ...
    if (o == "DM") {
      let N = Ts(y, 3).toFixed(3).padStart(6, "0"), I = Ts(E, 3).toFixed(3).padStart(6, "0");
      N.endsWith(".000") && I.endsWith(".000") && (N = N.replace(/\.000$/, ""), I = I.replace(/\.000$/, "")), x = `${_}° ${N}' ${v}, ${k}° ${I}' ${m}`;
    }
    if (o == "DMS") {
      const N = Math.floor(y), I = Math.floor(E);
      let b = ((y - N) * 60).toFixed(1).padStart(4, "0"), O = ((E - I) * 60).toFixed(1).padStart(4, "0");
      const C = N.toString().padStart(2, "0"), P = I.toString().padStart(2, "0");
      b.endsWith(".0") && O.endsWith(".0") && (b = b.replace(/\.0$/, ""), O = O.replace(/\.0$/, "")), x = `${_}° ${C}' ${b}" ${v}, ${k}° ${P}' ${O}" ${m}`;
    }
    return x;
  } else
...
function xr(o, a) {
  ...
  if (Is.test(o))
    ...
    if (m = bs.exec(o), x = Hn(m), m.filter((_) => _).length <= 5)
  ...
  if (x) {
    ...
    const k = m[0].trim();
    let y, E;
    const N = /[,/;\u0020]/g, I = k.match(N);
    if (I == null) {
      const C = Math.floor(o.length / 2);
      y = k.substring(0, C).trim(), E = k.substring(C).trim();
    } else {
      let C;
      I.length % 2 == 1 ? C = Math.floor(I.length / 2) : C = I.length / 2 - 1;
      let P = 0;
      if (C == 0)
        P = k.indexOf(I[0]), y = k.substring(0, P).trim(), E = k.substring(P + 1).trim();
      else {
        let R = 0, q = 0;
        for (; R <= C; )
          P = k.indexOf(I[R], q), q = P + 1, R++;
        y = k.substring(0, P).trim(), E = k.substring(P + 1).trim();
      }
    }
    const b = y.split(".");
...
function Yo(o) {
  ...
  if (o.includes(",")) {
    ...
    return Cs(this.decimalLatitude, Number(a[0])) && Cs(this.decimalLongitude, a[1]);
  } else
...
function Ho() {
  const o = [];
  return Uo.forEach((a) => {
    a.decimalLatitude ? o.push(a) : o.push({ ...a, ...Xo });
  }), [...o, ...Wo, ...Vo];
}
const Zo = Ho();
xr.formats = Zo.map((o) => o.verbatimCoordinates);
const jo = xr;
function Rs(o, a, s) {
  const l = o.slice();
...
function Ms(o) {
  ...
  return s = new Po({}), {
    c() {
      a = _e("button"), Ht(s.$$.fragment), B(a, "type", "button"), B(
        a,
        "title",
        /*reverseButtonTitle*/
        o[9]
      ), B(a, "class", "svelte-zh3kmv"), Ut(
        a,
        "active",
        /*reverseActive*/
        o[0]
    ...
    m(v, m) {
      Pe(v, a, m), Dt(s, a, null), l = !0, h || (g = je(
        a,
        "click",
        /*click_handler_2*/
        o[67]
...
function Qo(o) {
  let a, s = [], l = /* @__PURE__ */ new Map(), h, g, v, m = Es(
    /*listFeatures*/
    o[14]
  );
  const x = (_) => (
  ...
  return {
    ...
    p(_, k) {
      ...
      17880064 && (m = Es(
        /*listFeatures*/
        _[14]
      ), Ni(), s = mo(s, k, x, 1, _, m, l, a, go, Ps, null, Rs), Ii());
    },
    i(_) {
      if (!h) {
...
function Ko(o) {
  ...
  return s = new Ea({}), {
    c() {
      a = _e("div"), Ht(s.$$.fragment), l = at(), h = _e("div"), g = Vt(
        /*noResultsMessage*/
        o[7]
      ), B(h, "class", "svelte-zh3kmv"), B(a, "class", "no-results svelte-zh3kmv");
    },
    m(m, x) {
      Pe(m, a, x), Dt(s, a, null), de(a, l), de(a, h), de(h, g), v = !0;
    },
    p(m, x) {
...
function $o(o) {
  ...
  return s = new Ea({}), x = new ka({}), {
    c() {
      a = _e("div"), Ht(s.$$.fragment), l = at(), h = _e("div"), g = Vt(
        /*errorMessage*/
        o[6]
      ), v = at(), m = _e("button"), Ht(x.$$.fragment), B(h, "class", "svelte-zh3kmv"), B(m, "class", "svelte-zh3kmv"), B(a, "class", "error svelte-zh3kmv");
    },
    m(E, N) {
      Pe(E, a, N), Dt(s, a, null), de(a, l), de(a, h), de(h, g), de(a, v), de(a, m), Dt(x, m, null), _ = !0, k || (y = je(
        m,
        "click",
        /*click_handler_3*/
        o[68]
...
function Ps(o, a) {
  ...
  return l = new Co({
    ...
    first: null,
    c() {
      s = io(), Ht(l.$$.fragment), this.first = s;
    },
    m(m, x) {
      Pe(m, s, x), Dt(l, m, x), h = !0;
    },
    p(m, x) {
      a = m;
      const _ = {};
...
function el(o) {
  let a, s, l, h, g, v, m, x, _, k, y, E, N, I, b, O, C, P, R, q, M, Y = !1;
  g = new Do({}), y = new ka({});
  let z = (
    /*abortController*/
    o[19] && Os()
  ...
  function ce(F, K) {
    ...
    return (
      ...
      F[18] ? 0 : (
        ...
        F[16] ? (
          /*listFeatures*/
          ((se = F[14]) == null ? void 0 : se.length) === 0 ? 2 : (
            /*focusedDelayed*/
            F[16] && /*listFeatures*/
  ...
  return ~(O = ce(o)) && (C = j[O] = ee[O](o)), {
    c() {
      a = at(), s = _e("form"), l = _e("div"), h = _e("button"), Ht(g.$$.fragment), v = at(), m = _e("input"), x = at(), _ = _e("div"), k = _e("button"), Ht(y.$$.fragment), E = at(), z && z.c(), N = at(), X && X.c(), I = at(), Z && Z.c(), b = at(), C && C.c(), B(h, "class", "search-button svelte-zh3kmv"), B(h, "type", "button"), B(
        m,
        "placeholder",
        /*placeholder*/
        o[8]
        ...
        /*clearButtonTitle*/
        o[3]
      ), B(k, "class", "svelte-zh3kmv"), B(_, "class", "clear-button-container svelte-zh3kmv"), Ut(
        _,
        "displayable",
        /*searchValue*/
        o[1] !== ""
      ), B(l, "class", "input-group svelte-zh3kmv"), B(s, "tabindex", "0"), B(s, "class", P = ys(
        /*className*/
        o[2]
      ) + " svelte-zh3kmv"), Ut(
        s,
    ...
    m(F, K) {
      Pe(F, a, K), Pe(F, s, K), de(s, l), de(l, h), Dt(g, h, null), de(l, v), de(l, m), o[61](m), ps(
        m,
        /*searchValue*/
        o[1]
      ), de(l, x), de(l, _), de(_, k), Dt(y, k, null), de(_, E), z && z.m(_, null), de(l, N), X && X.m(l, null), de(l, I), Z && Z.m(l, null), de(s, b), ~O && j[O].m(s, null), R = !0, q || (M = [
        je(
          h,
          "click",
          /*click_handler*/
    ...
    p(F, K) {
      ...
      F[19] ? z ? K[0] & /*abortController*/
      524288 && De(z, 1) : (z = Os(), z.c(), De(z, 1), z.m(_, null)) : z && (Ni(), ze(z, 1, 1, () => {
        z = null;
      }), Ii()), (!R || K[0] & /*searchValue*/
      2) && Ut(
        _,
        "displayable",
        /*searchValue*/
      ...
      F[5] === !0 ? X ? (X.p(F, K), K[0] & /*enableReverse*/
      32 && De(X, 1)) : (X = Ms(F), X.c(), De(X, 1), X.m(l, I)) : X && (Ni(), ze(X, 1, 1, () => {
        X = null;
      }), Ii()), Z && Z.p && (!R || K[1] & /*$$scope*/
      134217728) && to(
        Z,
        G,
        F,
      ...
      let se = O;
      O = ce(F), O === se ? ~O && j[O].p(F, K) : (C && (Ni(), ze(j[se], 1, 1, () => {
        j[se] = null;
      }), Ii()), ~O ? (C = j[O], C ? C.p(F, K) : (C = j[O] = ee[O](F), C.c()), De(C, 1), C.m(s, null)) : C = null), (!R || K[0] & /*className*/
      4 && P !== (P = ys(
        /*className*/
        F[2]
      ) + " svelte-zh3kmv")) && B(s, "class", P), (!R || K[0] & /*className, collapsed, searchValue*/
      22) && Ut(
        s,
        "can-collapse",
        /*collapsed*/
    ...
    i(F) {
      R || (De(Y), De(g.$$.fragment, F), De(y.$$.fragment, F), De(z), De(X), De(Z, F), De(C), R = !0);
    },
    o(F) {
      ze(Y), ze(g.$$.fragment, F), ze(y.$$.fragment, F), ze(z), ze(X), ze(Z, F), ze(C), R = !1;
    },
    d(F) {
      F && (be(a), be(s)), Ft(g), o[61](null), Ft(y), z && z.d(), X && X.d(), Z && Z.d(F), ~O && j[O].d(), q = !1, Gt(M);
    }
  };
}
function tl(o, a, s) {
  let l, { $$slots: h = {}, $$scope: g } = a, { class: v = void 0 } = a, { apiKey: m } = a, { bbox: x = void 0 } = a, { clearButtonTitle: _ = "clear" } = a, { clearOnBlur: k = !1 } = a, { collapsed: y = !1 } = a, { country: E = void 0 } = a, { debounceSearch: N = 200 } = a, { enableReverse: I = !1 } = a, { errorMessage: b = "Something went wrong…" } = a, { filter: O = () => !0 } = a, { flyTo: C = !0 } = a, { fuzzyMatch: P = !0 } = a, { language: R = void 0 } = a, { limit: q = void 0 } = a, { mapController: M = void 0 } = a, { minLength: Y = 2 } = a, { noResultsMessage: z = "Oops! Looks like you're trying to predict something that's not quite right. We can't seem to find what you're looking for. Maybe try double-checking your spelling or try a different search term. Keep on typing - we'll do our best to get you where you need to go!" } = a, { placeholder: X = "Search" } = a, { proximity: G = [{ type: "server-geolocation" }] } = a, { reverseActive: Z = I === "always" } = a, { reverseButtonTitle: ee = "toggle reverse geocoding" } = a, { searchValue: j = "" } = a, { showFullGeometry: ce = !0 } = a, { showPlaceType: F = "ifNeeded" } = a, { showResultsWhileTyping: K = !0 } = a, { selectFirst: se = !0 } = a, { flyToSelected: me = !1 } = a, { markerOnSelected: Te = !0 } = a, { types: Ee = void 0 } = a, { excludeTypes: Q = !1 } = a, { zoom: Ae = 16 } = a, { maxZoom: Ie = 18 } = a, { apiUrl: qe = "https://api.maptiler.com/geocoding" } = a, { fetchParameters: he = {} } = a, { iconsBaseUrl: ut = "https://cdn.maptiler.com/maptiler-geocoding-control/v1.3.3/icons/" } = a, { adjustUrlQuery: Pn = () => {
  } } = a;
  function ri() {
    Qe.focus();
  }
  ...
  function si(D, Se = !0, Fe = !1) {
    s(1, j = D), Se ? (s(15, xe = -1), dn()) : (tt(!Fe, Fe), setTimeout(() => {
      Qe.focus(), Qe.select();
    }));
  }
  function ke() {
  ...
  let w = !1, oe, we, ae, An = "", Qe, xe = -1, U, Kt = [], Nt, Ke, gn, ue;
  const Jt = /* @__PURE__ */ new Set(), et = oo();
  uo(() => {
  ...
  async function $t(D, { byId: Se = !1, exact: Fe = !1 } = {}) {
    s(18, U = void 0), Nt == null || Nt.abort();
    const We = new AbortController();
    s(19, Nt = We);
    try {
      const fe = te(D), Ve = new URLSearchParams();
      if (R !== void 0 && Ve.set("language", Array.isArray(R) ? R.join(",") : R ?? ""), Ee && Ve.set("types", Ee.join(",")), Q && Ve.set("excludeTypes", String(Q)), x && Ve.set("bbox", x.map((yn) => yn.toFixed(6)).join(",")), E && Ve.set("country", Array.isArray(E) ? E.join(",") : E), !Se && !fe) {
        const yn = await Go(M, G, We);
        yn && Ve.set("proximity", yn), (Fe || !K) && Ve.set("autocomplete", "false"), Ve.set("fuzzyMatch", String(P));
      }
      q !== void 0 && (!fe || (Ee == null ? void 0 : Ee.length) === 1) && Ve.set("limit", String(q)), Ve.set("key", m), Pn(Ve);
      const lt = qe + "/" + encodeURIComponent(fe ? fe.decimalLongitude + "," + fe.decimalLatitude : D) + ".json?" + Ve.toString();
      if (lt === An) {
        Se ? (s(14, oe = void 0), s(55, ae = Kt[0])) : s(14, oe = Kt);
        return;
      }
      An = lt;
      const vn = await fetch(lt, { signal: We.signal, ...he });
      if (!vn.ok)
        throw new Error(await vn.text());
      const qt = await vn.json();
      et("response", { url: lt, featureCollection: qt }), Se ? (s(14, oe = void 0), s(55, ae = qt.features[0]), Kt = [ae]) : (s(14, oe = qt.features.filter(O)), fe && oe.unshift({
        type: "Feature",
        properties: {},
  ...
  function ge() {
    ...
    M && we.length > 0 && (ae && D[0] === D[2] && D[1] === D[3] ? M.flyTo(ae.center, Ae) : M.fitBounds(Ns(D), 50, Ie));
  }
  function re(D) {
    s(0, Z = I === "always"), s(14, oe = void 0), s(55, ae = void 0), s(15, xe = -1), si(D[1].toFixed(6) + ", " + Fo(D[0], [-180, 180], !0).toFixed(6), !1, !0);
  }
  function Di(D) {
    if (!oe)
      return;
  ...
  function Gi() {
    j = this.value, s(1, j), s(13, w), s(27, k);
  }
  const Fn = () => s(13, w = !0), Je = () => s(13, w = !1), en = () => tt(), ot = () => {
    s(1, j = ""), Qe.focus();
  }, ai = () => s(0, Z = !Z), mn = () => s(18, U = void 0), qi = (D) => s(15, xe = D), ui = (D) => Dn(D), Tt = () => {
    se || s(15, xe = -1);
  }, H = () => {
  };
  return o.$$set = (D) => {
    "class" in D && s(2, v = D.class), "apiKey" in D && s(25, m = D.apiKey), "bbox" in D && s(26, x = D.bbox), "clearButtonTitle" in D && s(3, _ = D.clearButtonTitle), "clearOnBlur" in D && s(27, k = D.clearOnBlur), "collapsed" in D && s(4, y = D.collapsed), "country" in D && s(28, E = D.country), "debounceSearch" in D && s(29, N = D.debounceSearch), "enableReverse" in D && s(5, I = D.enableReverse), "errorMessage" in D && s(6, b = D.errorMessage), "filter" in D && s(30, O = D.filter), "flyTo" in D && s(31, C = D.flyTo), "fuzzyMatch" in D && s(32, P = D.fuzzyMatch), "language" in D && s(33, R = D.language), "limit" in D && s(34, q = D.limit), "mapController" in D && s(35, M = D.mapController), "minLength" in D && s(36, Y = D.minLength), "noResultsMessage" in D && s(7, z = D.noResultsMessage), "placeholder" in D && s(8, X = D.placeholder), "proximity" in D && s(37, G = D.proximity), "reverseActive" in D && s(0, Z = D.reverseActive), "reverseButtonTitle" in D && s(9, ee = D.reverseButtonTitle), "searchValue" in D && s(1, j = D.searchValue), "showFullGeometry" in D && s(38, ce = D.showFullGeometry), "showPlaceType" in D && s(10, F = D.showPlaceType), "showResultsWhileTyping" in D && s(39, K = D.showResultsWhileTyping), "selectFirst" in D && s(11, se = D.selectFirst), "flyToSelected" in D && s(40, me = D.flyToSelected), "markerOnSelected" in D && s(41, Te = D.markerOnSelected), "types" in D && s(42, Ee = D.types), "excludeTypes" in D && s(43, Q = D.excludeTypes), "zoom" in D && s(44, Ae = D.zoom), "maxZoom" in D && s(45, Ie = D.maxZoom), "apiUrl" in D && s(46, qe = D.apiUrl), "fetchParameters" in D && s(47, he = D.fetchParameters), "iconsBaseUrl" in D && s(12, ut = D.iconsBaseUrl), "adjustUrlQuery" in D && s(48, Pn = D.adjustUrlQuery), "$$scope" in D && s(58, g = D.$$scope);
  }, o.$$.update = () => {
    if (o.$$.dirty[0] & /*enableReverse*/
    32 && s(0, Z = I === "always"), o.$$.dirty[0] & /*focused, clearOnBlur*/
    ...
    50356241 && (M && ae && ae.id !== ue && C && (!ae.bbox || ae.bbox[0] === ae.bbox[2] && ae.bbox[1] === ae.bbox[3] ? M.flyTo(ae.center, ae.id.startsWith("poi.") || ae.id.startsWith("address.") ? Ie : Ae) : M.fitBounds(Ns(ae.bbox), 50, Ie), s(14, oe = void 0), s(54, we = void 0), s(15, xe = -1)), s(56, ue = ae == null ? void 0 : ae.id)), o.$$.dirty[0] & /*selectFirst, listFeatures*/
    ...
    8388624 && M && M.setEventHandler((D) => {
      switch (D.type) {
        ...
        case "markerMouseEnter":
          we && s(15, xe = gn ? (oe == null ? void 0 : oe.findIndex((Se) => Se.id === D.id)) ?? -1 : -1);
          break;
    ...
    67133969 && M && l && C && me && M.flyTo(l.center, l.id.startsWith("poi.") || l.id.startsWith("address.") ? Ie : Ae), o.$$.dirty[1] & /*markerOnSelected, mapController*/
    1040 && (Te || M == null || M.setMarkers(void 0, void 0)), o.$$.dirty[1] & /*mapController, markerOnSelected, markedFeatures, selected*/
    75498512 && M && Te && !we && (M.setMarkers(l ? [l] : void 0, void 0), M.setSelectedMarker(l ? 0 : -1)), o.$$.dirty[1] & /*mapController, markedFeatures, picked*/
    25165840 && M && M.setMarkers(we, ae), o.$$.dirty[0] & /*selectedItemIndex*/
    32768 | o.$$.dirty[1] & /*markedFeatures, mapController*/
    8388624 && we && M && M.setSelectedMarker(xe), o.$$.dirty[0] & /*searchValue*/
    2 | o.$$.dirty[1] & /*mapController*/
    16 && M) {
      const D = te(j);
      M.setReverseMarker(D ? [D.decimalLongitude, D.decimalLatitude] : void 0);
    }
    o.$$.dirty[1] & /*selected*/
    67108864 && et("select", l), o.$$.dirty[1] & /*picked*/
    16777216 && et("pick", ae), o.$$.dirty[0] & /*focusedDelayed, listFeatures*/
    81920 && et("optionsVisibilityChange", gn && !!oe), o.$$.dirty[0] & /*listFeatures*/
...
function sl(o, a = "kilometers") {
  const s = xa[a];
  if (!s)
    throw new Error(a + " units is invalid");
  return o * s;
}
function al(o, a = "kilometers") {
  const s = xa[a];
  if (!s)
    throw new Error(a + " units is invalid");
  return o / s;
...
function Ia(o, a, s) {
  if (o !== null)
    for (var l, h, g, v, m, x, _, k = 0, y = 0, E, N = o.type, I = N === "FeatureCollection", b = N === "Feature", O = I ? o.features.length : 1, C = 0; C < O; C++) {
      _ = I ? o.features[C].geometry : b ? o.geometry : o, E = _ ? _.type === "GeometryCollection" : !1, m = E ? _.geometries.length : 1;
      for (var P = 0; P < m; P++) {
        var R = 0, q = 0;
        if (v = E ? _.geometries[P] : _, v !== null) {
          x = v.coordinates;
          var M = v.type;
          switch (k = 0, M) {
            case null:
            ...
            case "MultiLineString":
              for (l = 0; l < x.length; l++) {
                ...
                M === "MultiLineString" && R++, M === "Polygon" && q++;
              }
              M === "Polygon" && R++;
              break;
            case "MultiPolygon":
              for (l = 0; l < x.length; l++) {
                for (q = 0, h = 0; h < x[l].length; h++) {
...
function Nr(o, a) {
  var s, l, h, g, v, m, x, _, k, y, E = 0, N = o.type === "FeatureCollection", I = o.type === "Feature", b = N ? o.features.length : 1;
  for (s = 0; s < b; s++) {
    for (m = N ? o.features[s].geometry : I ? o.geometry : o, _ = N ? o.features[s].properties : I ? o.properties : {}, k = N ? o.features[s].bbox : I ? o.bbox : void 0, y = N ? o.features[s].id : I ? o.id : void 0, x = m ? m.type === "GeometryCollection" : !1, v = x ? m.geometries.length : 1, h = 0; h < v; h++) {
...
function ol(o, a = {}) {
  const s = ul(o), l = (s[0] + s[2]) / 2, h = (s[1] + s[3]) / 2;
  return il([l, h], a.properties, a);
}
...
(function(o, a) {
  (function(s, l) {
    ...
    function I(r, e, t) {
      return I = typeof Reflect < "u" && Reflect.get ? Reflect.get : function(n, i, u) {
        var c = function(d, p) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var Z, ee, j, ce, F, K, se, me, Te = function() {
      function r() {
        s(this, r);
      }
    ...
    Q.NaN = NaN, Q.isNaN = function(r) {
    ...
    }) : (Z = 1023, ee = Math.log2, j = Math.floor, ce = Math.pow, F = function() {
      for (var r = 53; r > 0; r--) {
        var e = ce(2, r) - 1;
      ...
      if (i = 0, p = 0, (e = j(r)) > 1) if (e <= F) (i = j(ee(e))) <= 20 ? (p = 0, d = e << 20 - i & 1048575) : (p = e % (t = ce(2, n = i - 20)) << 32 - n, d = e / t & 1048575);
    ...
    var Ie = function(r) {
    ...
    }(), ut = new ArrayBuffer(8), Pn = new Float64Array(ut), ri = new Int32Array(ut), T = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getM", value: function() {
        ...
        if (arguments.length === 2) {
          var t = arguments[0], n = arguments[1];
          return !!Te.equalsWithTolerance(this.x, t.x, n) && !!Te.equalsWithTolerance(this.y, t.y, n);
        }
      } }, { key: "setM", value: function(e) {
        throw new M("Invalid ordinate index: " + r.M);
        ...
        return Te.equalsWithTolerance(this.getZ(), e.getZ(), t);
    ...
    T.DimensionalComparator = si, T.NULL_ORDINATE = Q.NaN, T.X = 0, T.Y = 1, T.Z = 2, T.M = 3;
    var ke = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      }
      ...
      return h(r, [{ key: "isGeometryCollection", value: function() {
        ...
        if (e.getTypeCode() === r.TYPECODE_GEOMETRYCOLLECTION) throw new M("This method does not support GeometryCollection arguments");
    ...
    }(An, Symbol.iterator), xe = function() {
      function r(e) {
    ...
    var Kt = function(r) {
      ...
      return h(t, [{ key: "add", value: function(n) {
        ...
        if (n < 0 || n >= this.size()) throw new Nt();
        return this.array[n];
    ...
    var Jt = function() {
      ...
      return h(r, [{ key: "le", value: function(e) {
        ...
        for (var c = i + 1, f = new Jt(), d = r.MAX_PRINT_DIGITS - 1, p = 0; p <= d; p++) {
          ...
          if (S < 0) break;
          var L = !1, A = 0;
          S > 9 ? (L = !0, A = "9") : A = "0" + S, f.append(A), n = n.subtract(r.valueOf(S)).multiply(r.TEN), L && n.selfAdd(r.TEN);
        ...
        if (arguments.length === 1) {
          ...
          var n = arguments[0], i = arguments[1], u = null, c = null, f = null, d = null, p = null, S = null, L = null, A = null;
          return p = this._hi / n, A = (u = (S = r.SPLIT * p) - (u = S - p)) * (f = (A = r.SPLIT * n) - (f = A - n)) - (L = p * n) + u * (d = n - f) + (c = p - u) * f + c * d, A = p + (S = (this._hi - L - A + this._lo - p * i) / n), this._hi = A, this._lo = p - A + S, this;
        }
        ...
        if (typeof arguments[0] == "number") {
          var A = arguments[0];
          return Q.isNaN(A) ? r.createNaN() : r.copy(this).selfDivide(A, 0);
        }
        ...
        if (arguments.length === 1) {
          ...
          var p = arguments[0], S = arguments[1], L = null, A = null, V = null, W = null, $ = null, ie = null, le = null;
          W = this._hi + p, A = this._lo + S, $ = W - (ie = W - this._hi), V = A - (le = A - this._lo);
          var pe = (L = W + (ie = ($ = p - ie + (this._hi - $)) + A)) + (ie = (V = S - le + (this._lo - V)) + (ie + (W - L))), Ce = ie + (L - pe);
          return this._hi = pe, this._lo = Ce, this;
        }
        ...
        if (arguments.length === 1) {
          ...
          var L = (p = this._hi * n) + (S = u * (f = S - f) - p + u * (d = n - f) + c * f + c * d + (this._hi * i + this._lo * n)), A = S + (u = p - L);
          return this._hi = L, this._lo = A, this;
        }
        ...
        for (var c = new r(), f = 0, d = 0, p = 0, S = !1; !(t >= n); ) {
          ...
          if (t++, dn.isDigit(L)) {
            var A = L - "0";
            c.selfMultiply(r.TEN), c.selfAdd(A), f++;
          } else {
            if (L !== ".") {
              if (L === "e" || L === "E") {
                var V = e.substring(t);
    ...
    var $t = function() {
      ...
      return h(r, null, [{ key: "orientationIndex", value: function(e, t, n) {
        ...
        if (typeof arguments[3] == "number" && typeof arguments[2] == "number" && typeof arguments[0] == "number" && typeof arguments[1] == "number") {
          var c = arguments[0], f = arguments[1], d = arguments[2], p = arguments[3], S = te.valueOf(c), L = te.valueOf(f), A = te.valueOf(d), V = te.valueOf(p), W = S.multiply(V).selfSubtract(L.multiply(A));
          return W.signum();
        }
      } }, { key: "intersection", value: function(e, t, n, i) {
        var u = new te(e.y).selfSubtract(t.y), c = new te(t.x).selfSubtract(e.x), f = new te(e.x).selfMultiply(t.y).selfSubtract(new te(t.x).selfMultiply(e.y)), d = new te(n.y).selfSubtract(i.y), p = new te(i.x).selfSubtract(n.x), S = new te(n.x).selfMultiply(i.y).selfSubtract(new te(i.x).selfMultiply(n.y)), L = c.multiply(S).selfSubtract(p.multiply(f)), A = d.multiply(f).selfSubtract(u.multiply(S)), V = u.multiply(p).selfSubtract(d.multiply(c)), W = L.selfDivide(V).doubleValue(), $ = A.selfDivide(V).doubleValue();
    ...
    var re = function() {
      ...
      return h(r, null, [{ key: "index", value: function(e, t, n) {
        ...
        if (arguments[0] instanceof Array) {
          ...
          var L = r.index(p, n, S), A = null;
          return A = L === 0 ? p.x > S.x : L > 0, A;
        }
        if (ue(arguments[0], ge)) {
          var V = arguments[0], W = V.size() - 1;
          if (W < 3) throw new M("Ring has fewer than 4 points, so orientation cannot be determined");
          ...
          var Ce = null, Be = ie;
          do
            (Be -= 1) < 0 && (Be = W), Ce = V.getCoordinate(Be);
          while (Ce.equals2D($) && Be !== ie);
          var st = null, kt = ie;
          do
            kt = (kt + 1) % W, st = V.getCoordinate(kt);
          while (st.equals2D($) && kt !== ie);
          if (Ce.equals2D($) || st.equals2D($) || Ce.equals2D(st)) return !1;
          var Ot = r.index(Ce, $, st);
          return Ot === 0 ? Ce.x > st.x : Ot > 0;
        }
      } }]), r;
    }();
    ...
    var Di = function() {
      ...
      return h(n, [{ key: "interfaces_", get: function() {
        ...
        if (i < 0 || i >= this.size()) throw new Nt();
        return this.array[i];
      } }, { key: "isEmpty", value: function() {
        return this.array.length === 0;
    ...
    }(Ke, Symbol.iterator), Fi = function() {
      function r(e) {
      ...
      return h(r, [{ key: "clearVisitedEdges", value: function() {
        ...
        var t = new Qe(), n = new Dn(), i = e.getNode();
        ...
        this._finder = null, this._dirEdgeList = new ne(), this._nodes = new ne(), this._rightMostCoord = null, this._env = null, this._finder = new Di();
      } }]), r;
    }(), Fn = function() {
      function r() {
        s(this, r);
      ...
      return h(r, null, [{ key: "intersection", value: function(e, t, n, i) {
        var u = e.x < t.x ? e.x : t.x, c = e.y < t.y ? e.y : t.y, f = e.x > t.x ? e.x : t.x, d = e.y > t.y ? e.y : t.y, p = n.x < i.x ? n.x : i.x, S = n.y < i.y ? n.y : i.y, L = n.x > i.x ? n.x : i.x, A = n.y > i.y ? n.y : i.y, V = ((u > p ? u : p) + (f < L ? f : L)) / 2, W = ((c > S ? c : S) + (d < A ? d : A)) / 2, $ = e.x - V, ie = e.y - W, le = t.x - V, pe = t.y - W, Ce = n.x - V, Be = n.y - W, st = i.x - V, kt = i.y - W, Ot = ie - pe, an = le - $, Xn = $ * pe - le * ie, Wn = Be - kt, wn = st - Ce, ss = Ce * kt - st * Be, as = Ot * wn - Wn * an, er = (an * ss - wn * Xn) / as, tr = (Wn * Xn - Ot * ss) / as;
        return Q.isNaN(er) || Q.isInfinite(er) || Q.isNaN(tr) || Q.isInfinite(tr) ? null : new T(er + V, tr + W);
      } }]), r;
    }(), Je = function() {
      function r() {
        s(this, r);
...
` }[e];
    ...
    var ot = function() {
      ...
      return h(r, null, [{ key: "copyCoord", value: function(e, t, n, i) {
        ...
        if (arguments.length === 2) {
          ...
          if (p <= 0) return null;
          for (var S = c.copy(), L = d ? c.size() - 1 : c.size(), A = 0; A < L; A++) for (var V = 0; V < c.getDimension(); V++) c.setOrdinate(A, V, S.getOrdinate((f + A) % L, V));
    ...
    var D = function() {
      ...
      return h(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        return Tt.reverse(n), this.getFactory().createLineString(n);
        ...
        if (ue(arguments[0], mn)) for (var n = arguments[0], i = 0; i < this._points.size(); i++) n.filter(this._points.getCoordinate(i));
      ...
      return h(r, null, [{ key: "ofRing", value: function() {
        ...
        if (ue(arguments[0], ge)) {
          ...
          if (p < 3) return 0;
          var S = new T(), L = new T(), A = new T();
          d.getCoordinate(0, L), d.getCoordinate(1, A);
          var V = L.x;
          A.x -= V;
          for (var W = 0, $ = 1; $ < p - 1; $++) S.y = L.y, L.x = A.x, L.y = A.y, d.getCoordinate($ + 1, A), A.x -= V, W += L.x * (S.y - A.y);
          return W / 2;
        }
      } }]), r;
    }(), lt = function() {
      ...
      return h(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        if (arguments.length === 0) {
          ...
          var c = i.getCoordinateSequence(), f = Tt.minCoordinateIndex(c, 0, c.size() - 2);
          Tt.scroll(c, f, !0), re.isCCW(c) === u && Tt.reverse(c);
        }
      } }, { key: "getCoordinate", value: function() {
        ...
        if (arguments.length === 2) {
          ...
          if (L !== 0) return L;
          for (var A = this.getNumInteriorRing(), V = d.getNumInteriorRing(), W = 0; W < A && W < V; ) {
            var $ = this.getInteriorRingN(W), ie = d.getInteriorRingN(W), le = $.compareToSameClass(ie, f);
            if (le !== 0) return le;
            W++;
          }
          return W < A ? 1 : W < V ? -1 : 0;
        }
      } }, { key: "apply", value: function() {
        if (ue(arguments[0], mn)) {
          var n = arguments[0];
        ...
        var n = arguments[0], i = arguments[1], u = arguments[2];
        if (J.constructor_.call(this, u), n === null && (n = this.getFactory().createLinearRing()), i === null && (i = []), J.hasNullElements(i)) throw new M("holes must not contain null elements");
        if (n.isEmpty() && J.hasNonEmptyElements(i)) throw new M("shell is empty but holes are not");
      ...
      return h(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        if (arguments.length === 1) {
          var n = arguments[0], i = new wr(lt.asList(this._geometries)), u = new wr(lt.asList(n._geometries));
          return this.compare(i, u);
        }
        if (arguments.length === 2) {
          for (var c = arguments[0], f = arguments[1], d = c, p = this.getNumGeometries(), S = d.getNumGeometries(), L = 0; L < p && L < S; ) {
            var A = this.getGeometryN(L), V = d.getGeometryN(L), W = A.compareToSameClass(V, f);
            if (W !== 0) return W;
            L++;
          }
        ...
        if (ue(arguments[0], mn)) for (var n = arguments[0], i = 0; i < this._geometries.length; i++) this._geometries[i].apply(n);
        else if (ue(arguments[0], Se)) {
          var u = arguments[0];
        ...
        if (this._geometries = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var n = arguments[0], i = arguments[1];
            if (J.constructor_.call(this, i), n === null && (n = []), J.hasNullElements(n)) throw new M("geometries must not contain null elements");
            this._geometries = n;
          }
        }
      } }]), t;
      ...
      return h(t, [{ key: "copyInternal", value: function() {
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof J) {
          var n = arguments[0], i = arguments[1];
          return !!this.isEquivalentClass(n) && I(v(t.prototype), "equalsExact", this).call(this, n, i);
        }
        return I(v(t.prototype), "equalsExact", this).apply(this, arguments);
      } }, { key: "getCoordinate", value: function() {
      ...
      return h(t, [{ key: "copyInternal", value: function() {
        ...
        var n = this._points.copy();
        return Tt.reverse(n), this.getFactory().createLinearRing(n);
      } }, { key: "getTypeCode", value: function() {
        return J.TYPECODE_LINEARRING;
      } }, { key: "validateConstruction", value: function() {
        if (!this.isEmpty() && !I(v(t.prototype), "isClosed", this).call(this)) throw new M("Points of LinearRing do not form a closed linestring");
    ...
    var Yi = function(r) {
      ...
      return h(r, null, [{ key: "measures", value: function(e) {
        return e instanceof tn ? 0 : e instanceof nn || e instanceof Yi ? 1 : 0;
      } }, { key: "dimension", value: function(e) {
        return e instanceof tn ? 2 : e instanceof nn ? 3 : e instanceof Yi ? 4 : 3;
        ...
        if (arguments.length === 2) {
          var t = arguments[0], n = arguments[1];
          return t === 2 ? new tn() : t === 3 && n === 0 ? new T() : t === 3 && n === 1 ? new nn() : t === 4 && n === 1 ? new Yi() : new T();
        }
      } }]), r;
    }(), qn = function(r) {
      g(t, r);
      ...
      return h(t, [{ key: "getCoordinate", value: function(n) {
        ...
        for (var n = I(v(t.prototype), "clone", this).call(this), i = 0; i < this.size(); i++) n.add(i, this.get(i).clone());
        return n;
      } }, { key: "toCoordinateArray", value: function() {
        ...
        if (arguments.length === 2) {
          ...
          if (arguments[0] instanceof T && typeof arguments[1] == "boolean") {
            ...
            I(v(t.prototype), "add", this).call(this, c);
          ...
          if (typeof arguments[2] == "boolean" && arguments[0] instanceof Array && typeof arguments[1] == "boolean") {
            var L = arguments[0], A = arguments[1], V = arguments[2];
            if (V) for (var W = 0; W < L.length; W++) this.add(L[W], A);
            else for (var $ = L.length - 1; $ >= 0; $--) this.add(L[$], A);
            return !0;
          }
          if (typeof arguments[2] == "boolean" && Number.isInteger(arguments[0]) && arguments[1] instanceof T) {
            ...
            if (!pe) {
              ...
              if (Ce > 0) {
                if (ie > 0) {
                  var Be = this.get(ie - 1);
                  if (Be.equals2D(le)) return null;
                }
                if (ie < Ce) {
                  var st = this.get(ie);
            ...
            I(v(t.prototype), "add", this).call(this, ie, le);
          }
        } else if (arguments.length === 4) {
          var kt = arguments[0], Ot = arguments[1], an = arguments[2], Xn = arguments[3], Wn = 1;
          an > Xn && (Wn = -1);
          for (var wn = an; wn !== Xn; wn += Wn) this.add(kt[wn], Ot);
          return !0;
        }
    ...
    qn.coordArrayType = new Array(0).fill(null);
    var Ge = function() {
      function r() {
        s(this, r);
      }
      return h(r, null, [{ key: "isRing", value: function(e) {
        ...
        for (var n = new qn(), i = 0; i < e.length; i++) t.intersects(e[i]) && n.add(e[i], !0);
        ...
        return r.hasRepeatedPoints(e) ? new qn(e, !1).toCoordinateArray() : e;
      } }, { key: "reverse", value: function(e) {
    ...
    Ge.ForwardComparator = Ua, Ge.BidirectionalComparator = Xa, Ge.coordArrayType = new Array(0).fill(null);
    var li = function() {
      function r(e) {
        s(this, r), this.str = e;
      }
      ...
      return h(r, [{ key: "getM", value: function(e) {
        ...
        return oi.create(this.getDimension(), this.getMeasures());
      } }, { key: "getDimension", value: function() {
        ...
        if (this._coordinates.length > 0) {
          var e = new li(17 * this._coordinates.length);
        ...
        if (this._dimension = 3, this._measures = 0, this._coordinates = null, arguments.length === 1) {
          ...
          if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            ...
            for (var S = 0; S < d; S++) this._coordinates[S] = oi.create(p);
          }
        } else if (arguments.length === 3) {
          if (Number.isInteger(arguments[2]) && arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            var L = arguments[0], A = arguments[1], V = arguments[2];
            this._dimension = A, this._measures = V, this._coordinates = L === null ? new Array(0).fill(null) : L;
      ...
      return h(r, [{ key: "readResolve", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          if (arguments.length === 2) {
            var n = arguments[0], i = arguments[1];
            return i > 3 && (i = 3), i < 2 && (i = 2), new zn(n, i);
          }
          if (arguments.length === 3) {
            var u = arguments[0], c = arguments[1], f = arguments[2], d = c - f;
            return f > 1 && (f = 1), d > 3 && (d = 3), d < 2 && (d = 2), new zn(u, d + f, f);
          }
        }
      } }, { key: "interfaces_", get: function() {
        return [ai, G];
    ...
    pn.nameToTypeMap = new Wa(), pt.Type = pn, pt.FIXED = new pn("FIXED"), pt.FLOATING = new pn("FLOATING"), pt.FLOATING_SINGLE = new pn("FLOATING SINGLE"), pt.maximumPreciseValue = 9007199254740992;
    var Xi = function(r) {
      g(t, r);
      var e = N(t);
      function t() {
      ...
      return h(r, [{ key: "createEmpty", value: function(e) {
        ...
        if (arguments.length === 0) return new Xi(null, this);
        if (arguments.length === 1) {
          var e = arguments[0];
        ...
        if (e.size() > 1) {
          if (d instanceof qt) return this.createMultiPolygon(r.toPolygonArray(e));
        ...
        if (arguments.length === 1) {
          ...
          if (ue(arguments[0], ge)) {
            ...
            for (var n = new Array(t.size()).fill(null), i = 0; i < t.size(); i++) {
              ...
              Tt.copy(t, i, u, 0, 1), n[i] = this.createPoint(u);
            }
        ...
        if (this._precisionModel = null, this._coordinateSequenceFactory = null, this._SRID = null, arguments.length === 0) r.constructor_.call(this, new pt(), 0);
        else if (arguments.length === 1) {
          if (ue(arguments[0], ai)) {
            var e = arguments[0];
            r.constructor_.call(this, new pt(), 0, e);
    ...
    }(), Wi = "XY", Va = "XYZ", Ha = "XYM", Za = "XYZM", Lr = { POINT: "Point", LINE_STRING: "LineString", LINEAR_RING: "LinearRing", POLYGON: "Polygon", MULTI_POINT: "MultiPoint", MULTI_LINE_STRING: "MultiLineString", MULTI_POLYGON: "MultiPolygon", GEOMETRY_COLLECTION: "GeometryCollection", CIRCLE: "Circle" }, br = "EMPTY", hi = 1, Ct = 2, zt = 3, Tr = 4, kn = 5, ja = 6;
    for (var Qa in Lr) Lr[Qa].toUpperCase();
    var Ka = function() {
      function r(e) {
...
`;
        ...
        else if (this.isNumeric_(t) || t == "-") e = Tr, i = this.readNumber_();
        else if (this.isAlpha_(t)) e = hi, i = this.readText_();
        else {
      ...
      function r(e, t) {
        s(this, r), this.lexer_ = e, this.token_, this.layout_ = Wi, this.factory = t;
      }
      return h(r, [{ key: "consume_", value: function() {
        ...
        var e = Wi, t = this.token_;
        if (this.isTokenType(hi)) {
          var n = t.value;
          n === "Z" ? e = Va : n === "M" ? e = Ha : n === "ZM" && (e = Za), e !== Wi && this.consume_();
        }
        return e;
        ...
        var e;
        if (this.match(Ct)) {
          if (e = this.token_.type == Ct ? this.parsePointTextList_() : this.parsePointList_(), this.match(zt)) return e;
        } else if (this.isEmptyGeometry_()) return [];
        throw new Error(this.formatErrorMessage_());
        ...
        for (var e = [], t = this.layout_.length, n = 0; n < t; ++n) {
          var i = this.token_;
          if (!this.match(Tr)) break;
          e.push(i.value);
        }
        if (e.length == t) return e;
        throw new Error(this.formatErrorMessage_());
      } }, { key: "parsePointList_", value: function() {
        for (var e = [this.parsePoint_()]; this.match(kn); ) e.push(this.parsePoint_());
        return e;
      } }, { key: "parsePointTextList_", value: function() {
        for (var e = [this.parsePointText_()]; this.match(kn); ) e.push(this.parsePointText_());
        return e;
      } }, { key: "parseLineStringTextList_", value: function() {
        for (var e = [this.parseLineStringText_()]; this.match(kn); ) e.push(this.parseLineStringText_());
        return e;
      } }, { key: "parsePolygonTextList_", value: function() {
        for (var e = [this.parsePolygonText_()]; this.match(kn); ) e.push(this.parsePolygonText_());
        return e;
      } }, { key: "isEmptyGeometry_", value: function() {
        var e = this.isTokenType(hi) && this.token_.value == br;
        ...
        if (this.match(hi)) {
          ...
          switch (u) {
            case "POINT":
              ...
              return f ? e.createPoint(_(T, b(f))) : e.createPoint();
            case "LINESTRING":
            ...
            case "MULTIPOINT":
              ...
              var A = L.map(t).map(function(ie) {
                return e.createPoint(ie);
              });
              return e.createMultiPoint(A);
            case "MULTILINESTRING":
    ...
    function Rr(r) {
      var e = [];
      e.push("(" + Yn(r.getExteriorRing()) + ")");
      for (var t = 0, n = r.getNumInteriorRing(); t < n; ++t) e.push("(" + Yn(r.getInteriorRingN(t)) + ")");
      return e.join(", ");
    }
    var $a = { Point: Cr, LineString: Yn, LinearRing: Yn, Polygon: Rr, MultiPoint: function(r) {
      for (var e = [], t = 0, n = r.getNumGeometries(); t < n; ++t) e.push("(" + Cr(r.getGeometryN(t)) + ")");
      return e.join(", ");
    }, MultiLineString: function(r) {
      for (var e = [], t = 0, n = r.getNumGeometries(); t < n; ++t) e.push("(" + Yn(r.getGeometryN(t)) + ")");
      return e.join(", ");
    }, MultiPolygon: function(r) {
      for (var e = [], t = 0, n = r.getNumGeometries(); t < n; ++t) e.push("(" + Rr(r.getGeometryN(t)) + ")");
      return e.join(", ");
    }, GeometryCollection: function(r) {
      for (var e = [], t = 0, n = r.getNumGeometries(); t < n; ++t) e.push(Or(r.getGeometryN(t)));
      return e.join(", ");
    } };
    function Or(r) {
      var e = r.getGeometryType(), t = $a[e];
      e = e.toUpperCase();
      var n = function(i) {
        var u = "";
      ...
      return n.length > 0 && (e += " " + n), r.isEmpty() ? e + " " + br : e + " (" + t(r) + ")";
    }
    var eu = function() {
      function r(e) {
        s(this, r), this.geometryFactory = e || new _n(), this.precisionModel = this.geometryFactory.getPrecisionModel();
      }
      return h(r, [{ key: "read", value: function(e) {
        var t = new Ka(e);
        return new Ja(t, this.geometryFactory).parse();
      } }, { key: "write", value: function(e) {
        return Or(e);
      } }]), r;
    }(), Vi = function() {
      function r(e) {
        s(this, r), this.parser = new eu(e);
      }
    ...
    var rn = function(r) {
      ...
      return h(t, [{ key: "isInSegmentEnvelopes", value: function(n) {
        ...
        var n = arguments[0], i = arguments[1], u = arguments[2];
        if (this._isProper = !1, ke.intersects(i, u, n) && re.index(i, u, n) === 0 && re.index(u, i, n) === 0) return this._isProper = !0, (n.equals(i) || n.equals(u)) && (this._isProper = !1), this._result = Le.POINT_INTERSECTION, null;
        ...
        return f && d ? (this._intPt[0] = u, this._intPt[1] = c, Le.COLLINEAR_INTERSECTION) : p && S ? (this._intPt[0] = n, this._intPt[1] = i, Le.COLLINEAR_INTERSECTION) : f && p ? (this._intPt[0] = u, this._intPt[1] = n, !u.equals(n) || d || S ? Le.COLLINEAR_INTERSECTION : Le.POINT_INTERSECTION) : f && S ? (this._intPt[0] = u, this._intPt[1] = i, !u.equals(i) || d || p ? Le.COLLINEAR_INTERSECTION : Le.POINT_INTERSECTION) : d && p ? (this._intPt[0] = c, this._intPt[1] = n, !c.equals(n) || f || S ? Le.COLLINEAR_INTERSECTION : Le.POINT_INTERSECTION) : d && S ? (this._intPt[0] = c, this._intPt[1] = i, !c.equals(i) || f || p ? Le.COLLINEAR_INTERSECTION : Le.POINT_INTERSECTION) : Le.NO_INTERSECTION;
      } }, { key: "computeIntersect", value: function(n, i, u, c) {
        if (this._isProper = !1, !ke.intersects(n, i, u, c)) return Le.NO_INTERSECTION;
        var f = re.index(n, i, u), d = re.index(n, i, c);
        if (f > 0 && d > 0 || f < 0 && d < 0) return Le.NO_INTERSECTION;
        var p = re.index(u, c, n), S = re.index(u, c, i);
        return p > 0 && S > 0 || p < 0 && S < 0 ? Le.NO_INTERSECTION : f === 0 && d === 0 && p === 0 && S === 0 ? this.computeCollinearIntersection(n, i, u, c) : (f === 0 || d === 0 || p === 0 || S === 0 ? (this._isProper = !1, n.equals2D(u) || n.equals2D(c) ? this._intPt[0] = n : i.equals2D(u) || i.equals2D(c) ? this._intPt[0] = i : f === 0 ? this._intPt[0] = new T(u) : d === 0 ? this._intPt[0] = new T(c) : p === 0 ? this._intPt[0] = new T(n) : S === 0 && (this._intPt[0] = new T(i))) : (this._isProper = !0, this._intPt[0] = this.intersection(n, i, u, c)), Le.POINT_INTERSECTION);
      } }], [{ key: "nearestEndpoint", value: function(n, i, u, c) {
        var f = n, d = ot.pointToSegment(n, u, c), p = ot.pointToSegment(i, u, c);
        return p < d && (d = p, f = i), (p = ot.pointToSegment(u, n, i)) < d && (d = p, f = u), (p = ot.pointToSegment(c, n, i)) < d && (d = p, f = c), f;
      } }]), t;
    }(Le), tu = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, [{ key: "countSegment", value: function(e, t) {
        ...
        if (arguments[0] instanceof T && arguments[1] instanceof Array) {
          for (var f = arguments[0], d = arguments[1], p = new r(f), S = 1; S < d.length; S++) {
            var L = d[S], A = d[S - 1];
            if (p.countSegment(L, A), p.isOnSegment()) return p.getLocation();
          }
      ...
      return h(r, null, [{ key: "isOnLine", value: function() {
        ...
        if (arguments[0] instanceof T && arguments[1] instanceof Array) {
          for (var d = arguments[0], p = arguments[1], S = new rn(), L = 1; L < p.length; L++) {
            var A = p[L - 1], V = p[L];
            if (S.computeIntersection(d, A, V), S.hasIntersection()) return !0;
          }
          return !1;
        }
      } }, { key: "locateInRing", value: function(e, t) {
        return tu.locatePointInRing(e, t);
      } }, { key: "isInRing", value: function(e, t) {
        return r.locateInRing(e, t) !== w.EXTERIOR;
      } }]), r;
    }(), ht = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, [{ key: "setAllLocations", value: function(e) {
        ...
        for (var e = 0; e < this.location.length; e++) if (this.location[e] !== w.NONE) return !1;
        return !0;
      } }, { key: "setAllLocationsIfNull", value: function(e) {
        for (var t = 0; t < this.location.length; t++) this.location[t] === w.NONE && (this.location[t] = e);
        ...
        if (e.location.length > this.location.length) {
          ...
          t[U.ON] = this.location[U.ON], t[U.LEFT] = w.NONE, t[U.RIGHT] = w.NONE, this.location = t;
        }
        for (var n = 0; n < this.location.length; n++) this.location[n] === w.NONE && n < e.location.length && (this.location[n] = e.location[n]);
        ...
        var e = new Jt();
        return this.location.length > 1 && e.append(w.toLocationSymbol(this.location[U.LEFT])), e.append(w.toLocationSymbol(this.location[U.ON])), this.location.length > 1 && e.append(w.toLocationSymbol(this.location[U.RIGHT])), e.toString();
        ...
        for (var e = 0; e < this.location.length; e++) if (this.location[e] === w.NONE) return !0;
        return !1;
        ...
        this.location = new Array(e).fill(null), this.setAllLocations(w.NONE);
      ...
      return h(r, [{ key: "getGeometryCount", value: function() {
        ...
        for (var t = 0; t < 2; t++) this.elt[t] === null && e.elt[t] !== null ? this.elt[t] = new ht(e.elt[t]) : this.elt[t].merge(e.elt[t]);
      } }, { key: "flip", value: function() {
        ...
        this.elt[e].isArea() && (this.elt[e] = new ht(this.elt[e].location[0]));
      } }], [{ key: "constructor_", value: function() {
        if (this.elt = new Array(2).fill(null), arguments.length === 1) {
          if (Number.isInteger(arguments[0])) {
            var e = arguments[0];
            this.elt[0] = new ht(e), this.elt[1] = new ht(e);
          } else if (arguments[0] instanceof r) {
            var t = arguments[0];
            this.elt[0] = new ht(t.elt[0]), this.elt[1] = new ht(t.elt[1]);
          }
        } else if (arguments.length === 2) {
          var n = arguments[0], i = arguments[1];
          this.elt[0] = new ht(w.NONE), this.elt[1] = new ht(w.NONE), this.elt[n].setLocation(i);
        } else if (arguments.length === 3) {
          var u = arguments[0], c = arguments[1], f = arguments[2];
          this.elt[0] = new ht(u, c, f), this.elt[1] = new ht(u, c, f);
        } else if (arguments.length === 4) {
          var d = arguments[0], p = arguments[1], S = arguments[2], L = arguments[3];
          this.elt[0] = new ht(w.NONE, w.NONE, w.NONE), this.elt[1] = new ht(w.NONE, w.NONE, w.NONE), this.elt[d].setLocations(p, S, L);
        }
      } }, { key: "toLineLabel", value: function(e) {
        for (var t = new r(w.NONE), n = 0; n < 2; n++) t.setLocation(n, e.getLocation(n));
        return t;
      } }]), r;
    }(), ci = function() {
      function r() {
      ...
      return h(r, [{ key: "computeRing", value: function() {
        ...
        if (!t.getEnvelopeInternal().contains(e) || !Hi.isInRing(e, t.getCoordinates())) return !1;
        ...
        if (this._startDe = null, this._maxNodeDegree = -1, this._edges = new ne(), this._pts = new ne(), this._label = new ct(w.NONE), this._ring = null, this._isHole = null, this._shell = null, this._holes = new ne(), this._geometryFactory = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var e = arguments[0], t = arguments[1];
      ...
      return h(t, [{ key: "buildMinimalRings", value: function() {
        ...
        do {
          if (i.getMinEdgeRing() === null) {
            var u = new nu(i, this._geometryFactory);
            n.add(u);
          }
          i = i.getNext();
      ...
      return h(t, [{ key: "isIncidentEdgeInResult", value: function() {
        ...
        var n = arguments[0], i = arguments[1];
        this._label === null ? this._label = new ct(n, i) : this._label.setLocation(n, i);
      } }, { key: "getEdges", value: function() {
        return this._edges;
      } }, { key: "mergeLabel", value: function() {
        if (arguments[0] instanceof t) {
        ...
        } else if (arguments[0] instanceof ct) for (var i = arguments[0], u = 0; u < 2; u++) {
          var c = this.computeMergedLocation(i, u), f = this._label.getLocation(u);
          f === w.NONE && this._label.setLocation(u, c);
        }
      } }, { key: "add", value: function(n) {
        ...
        var n = arguments[0], i = arguments[1];
        this._coord = n, this._edges = i, this._label = new ct(0, w.NONE);
      } }]), t;
    }(Mr), ru = function(r) {
      g(t, r);
      var e = N(t);
    ...
    var Bn = function(r) {
      ...
      return h(t, [{ key: "get", value: function(n) {
        ...
        var i;
        for (n.color = 1; n != null && n !== this.root_ && n.parent.color === 1; ) ye(n) === Zi(ye(ye(n))) ? Pr(i = Ar(ye(ye(n)))) === 1 ? (It(ye(n), 0), It(i, 0), It(ye(ye(n)), 1), n = ye(ye(n))) : (n === Ar(ye(n)) && (n = ye(n), this.rotateLeft(n)), It(ye(n), 0), It(ye(ye(n)), 1), this.rotateRight(ye(ye(n)))) : Pr(i = Zi(ye(ye(n)))) === 1 ? (It(ye(n), 0), It(i, 0), It(ye(ye(n)), 1), n = ye(ye(n))) : (n === Zi(ye(n)) && (n = ye(n), this.rotateRight(n)), It(ye(n), 0), It(ye(ye(n)), 1), this.rotateLeft(ye(ye(n))));
        this.root_.color = 0;
      } }, { key: "values", value: function() {
      ...
      return h(r, [{ key: "find", value: function(e) {
        ...
        for (var t = new ne(), n = this.iterator(); n.hasNext(); ) {
          var i = n.next();
          i.getLabel().getLocation(e) === w.BOUNDARY && t.add(i);
        }
        return t;
    ...
    var Fr = function() {
      ...
      return h(t, [{ key: "getNextMin", value: function() {
        ...
        this._label = new ct(this._edge.getLabel()), this._isForward || this._label.flip();
        ...
        for (var n = !0, i = 0; i < 2; i++) this._label.isArea(i) && this._label.getLocation(i, U.LEFT) === w.INTERIOR && this._label.getLocation(i, U.RIGHT) === w.INTERIOR || (n = !1);
        return n;
      } }, { key: "setNextMin", value: function(n) {
        this._nextMin = n;
      } }, { key: "print", value: function(n) {
        I(v(t.prototype), "print", this).call(this, n), n.print(" " + this._depth[U.LEFT] + "/" + this._depth[U.RIGHT]), n.print(" (" + this.getDepthDelta() + ")"), this._isInResult && n.print(" inResult");
      } }, { key: "setMinEdgeRing", value: function(n) {
        this._minEdgeRing = n;
      } }, { key: "isLineEdge", value: function() {
        var n = this._label.isLine(0) || this._label.isLine(1), i = !this._label.isArea(0) || this._label.allPositionsEqual(0, w.EXTERIOR), u = !this._label.isArea(1) || this._label.allPositionsEqual(1, w.EXTERIOR);
        return n && i && u;
        ...
        var n = arguments[0], i = arguments[1];
        if (Fr.constructor_.call(this, n), this._isForward = i, i) this.init(n.getCoordinate(0), n.getCoordinate(1));
        else {
        ...
        return n === w.EXTERIOR && i === w.INTERIOR ? 1 : n === w.INTERIOR && i === w.EXTERIOR ? -1 : 0;
      } }]), t;
    }(Fr), Gr = function() {
      function r() {
        s(this, r);
      ...
      return h(r, [{ key: "printEdges", value: function(e) {
        ...
        if (n === null) return !1;
        var i = n.getLabel();
        return i !== null && i.getLocation(e) === w.BOUNDARY;
        ...
        if (this._edges = new ne(), this._nodes = null, this._edgeEndList = new ne(), arguments.length === 0) this._nodes = new Dr(new Gr());
        else if (arguments.length === 1) {
          var e = arguments[0];
          this._nodes = new Dr(e);
        }
      ...
      return h(r, [{ key: "sortShellsAndHoles", value: function(e, t, n) {
        ...
        for (var t = new ne(), n = e.iterator(); n.hasNext(); ) {
          ...
          if (i.isInResult() && i.getLabel().isArea() && i.getEdgeRing() === null) {
            var u = new iu(i, this._geometryFactory);
        ...
        for (var n = e.getLinearRing(), i = n.getEnvelopeInternal(), u = n.getCoordinateN(0), c = null, f = null, d = t.iterator(); d.hasNext(); ) {
          ...
          if (!L.equals(i) && L.contains(i)) {
            ...
            var A = !1;
            Hi.isInRing(u, S.getCoordinates()) && (A = !0), A && (c === null || f.contains(L)) && (f = (c = p).getLinearRing().getEnvelopeInternal());
          }
        }
        return c;
      } }]), r;
    ...
    }(), En = { reverseOrder: function() {
      return { compare: function(r, e) {
        return e.compareTo(r);
      } };
    }, min: function(r) {
      return En.sort(r), r.get(0);
    }, sort: function(r, e) {
      var t = r.toArray();
      e ? lt.sort(t, e) : lt.sort(t);
      ...
      return h(r, [{ key: "maximumDistance", value: function() {
        return uu.maximumDistance(this._boundable1.getBounds(), this._boundable2.getBounds());
      ...
      return h(r, [{ key: "queryInternal", value: function() {
        if (ue(arguments[2], Yr) && arguments[0] instanceof Object && arguments[1] instanceof ft) for (var e = arguments[0], t = arguments[1], n = arguments[2], i = t.getChildBoundables(), u = 0; u < i.size(); u++) {
          var c = i.get(u);
          this.getIntersectsOp().intersects(c.getBounds(), e) && (c instanceof ft ? this.queryInternal(e, c, n) : c instanceof Rt ? n.visitItem(c.getItem()) : he.shouldNeverReachHere());
        }
        else if (ue(arguments[2], Ke) && arguments[0] instanceof Object && arguments[1] instanceof ft) for (var f = arguments[0], d = arguments[1], p = arguments[2], S = d.getChildBoundables(), L = 0; L < S.size(); L++) {
          var A = S.get(L);
          this.getIntersectsOp().intersects(A.getBounds(), f) && (A instanceof ft ? this.queryInternal(f, A, p) : A instanceof Rt ? p.add(A.getItem()) : he.shouldNeverReachHere());
        }
        ...
        if (arguments.length === 1) {
          for (var e = arguments[0], t = 0, n = e.getChildBoundables().iterator(); n.hasNext(); ) {
            var i = n.next();
            i instanceof ft ? t += this.size(i) : i instanceof Rt && (t += 1);
          }
          return t;
        }
        ...
        for (var n = null, i = e.getChildBoundables().iterator(); i.hasNext(); ) {
          var u = i.next();
          u instanceof Rt && u.getItem() === t && (n = u);
        }
        ...
        if (arguments.length === 1) {
          for (var t = arguments[0], n = new ne(), i = t.getChildBoundables().iterator(); i.hasNext(); ) {
            ...
            if (u instanceof ft) {
              ...
              c !== null && n.add(c);
            } else u instanceof Rt ? n.add(u.getItem()) : he.shouldNeverReachHere();
          }
          return n.size() <= 0 ? null : n;
        }
      } }, { key: "insert", value: function(e, t) {
        he.isTrue(!this._built, "Cannot insert items into an STR packed R-tree after it has been built."), this._itemBoundables.add(new Rt(e, t));
        ...
        if (arguments.length === 3) {
          ...
          for (var c = i.getChildBoundables().iterator(); c.hasNext(); ) {
            var f = c.next();
            f instanceof ft ? this.boundablesAtLevel(n, f, u) : (he.isTrue(f instanceof Rt), n === -1 && u.add(f));
          }
          return null;
        }
      } }, { key: "query", value: function() {
        ...
        if (arguments.length === 3) {
          ...
          for (var f = null, d = i.getChildBoundables().iterator(); d.hasNext(); ) {
            var p = d.next();
            if (this.getIntersectsOp().intersects(p.getBounds(), n) && p instanceof ft && (c = this.remove(n, p, u))) {
              f = p;
              break;
            }
          }
    ...
    var ou = function() {
      ...
      return h(t, [{ key: "createParentBoundablesFromVerticalSlices", value: function(n, i) {
        ...
        if (arguments.length === 3) {
          var u = arguments[0], c = arguments[1], f = arguments[2], d = c, p = new gi();
          p.add(u);
          for (var S = new gi(); !p.isEmpty() && d >= 0; ) {
            var L = p.poll(), A = L.getDistance();
            if (A >= d) break;
            if (L.isLeaves()) if (S.size() < f) S.add(L);
            else {
              var V = S.peek();
              V.getDistance() > A && (S.poll(), S.add(L));
              var W = S.peek();
              d = W.getDistance();
            }
        ...
        if (!(arguments.length === 2 && arguments[1] instanceof Object && arguments[0] instanceof ke)) return I(v(t.prototype), "insert", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
        if (n.isNull()) return null;
        I(v(t.prototype), "insert", this).call(this, n, i);
        ...
        if (arguments.length === 1) {
          if (ue(arguments[0], ou)) {
            var n = arguments[0];
            if (this.isEmpty()) return null;
            var i = new xn(this.getRoot(), this.getRoot(), n);
            return this.nearestNeighbour(i);
          }
          if (arguments[0] instanceof xn) {
            var u = arguments[0], c = Q.POSITIVE_INFINITY, f = null, d = new gi();
          ...
          if (arguments.length === 2) {
            var L = arguments[0], A = arguments[1];
            if (this.isEmpty() || L.isEmpty()) return null;
            var V = new xn(this.getRoot(), L.getRoot(), A);
            return this.nearestNeighbour(V);
          }
          if (arguments.length === 3) {
            var W = arguments[0], $ = arguments[1], ie = arguments[2], le = new Rt(W, $), pe = new xn(this.getRoot(), le, ie);
            return this.nearestNeighbour(pe)[0];
          }
          if (arguments.length === 4) {
            var Ce = arguments[0], Be = arguments[1], st = arguments[2], kt = arguments[3], Ot = new Rt(Ce, Be), an = new xn(this.getRoot(), Ot, st);
            return this.nearestNeighbourK(an, kt);
          }
        }
      } }, { key: "isWithinDistance", value: function() {
        if (arguments.length === 2) {
          var n = arguments[0], i = arguments[1], u = Q.POSITIVE_INFINITY, c = new gi();
        ...
        if (arguments.length === 3) {
          var p = arguments[0], S = arguments[1], L = arguments[2], A = new xn(this.getRoot(), p.getRoot(), S);
          return this.isWithinDistance(A, L);
        }
      } }, { key: "interfaces_", get: function() {
        return [au, G];
      } }], [{ key: "constructor_", value: function() {
      ...
      return h(t, [{ key: "computeBounds", value: function() {
        ...
        var n = arguments[0];
        ft.constructor_.call(this, n);
      } }]), t;
    }(ft);
    wt.STRtreeNode = Br, wt.xComparator = new (function() {
      function r() {
        s(this, r);
      }
      return h(r, [{ key: "interfaces_", get: function() {
        ...
        return Nn.compareDoubles(wt.centreX(e.getBounds()), wt.centreX(t.getBounds()));
      } }]), r;
    }())(), wt.yComparator = new (function() {
      function r() {
        s(this, r);
      }
      return h(r, [{ key: "interfaces_", get: function() {
        ...
        return Nn.compareDoubles(wt.centreY(e.getBounds()), wt.centreY(t.getBounds()));
      } }]), r;
    }())(), wt.intersectsOp = new (function() {
      function r() {
        s(this, r);
      }
      return h(r, [{ key: "interfaces_", get: function() {
    ...
    var lu = function() {
      ...
      return h(r, [{ key: "getSplitCoordinates", value: function() {
        ...
        var n = new hu(this._edge, e, t, this._edge.getSegmentOctant(t)), i = this._nodeMap.get(n);
      ...
      return h(r, null, [{ key: "octant", value: function() {
        ...
        if (arguments[0] instanceof T && arguments[1] instanceof T) {
          ...
          if (f === 0 && d === 0) throw new M("Cannot compute the octant for two identical points " + u);
          return r.octant(f, d);
        }
      } }]), r;
    }(), du = function() {
      ...
      return h(r, [{ key: "getCoordinates", value: function() {
        ...
        return e.equals2D(t) ? 0 : gu.octant(e, t);
      } }, { key: "getData", value: function() {
        return this._data;
        ...
        return Vi.toLineString(new zn(this._pts));
        ...
        this._nodeList = new fu(this), this._pts = null, this._data = null;
        var e = arguments[0], t = arguments[1];
      ...
      return h(r, [{ key: "minX", value: function() {
        ...
        return ot.pointToLinePerpendicular(e, this.p0, this.p1);
        ...
        return Fn.intersection(this.p0, this.p1, e.p0, e.p1);
        ...
        if (arguments[0] instanceof r) {
          var e = arguments[0];
          return ot.segmentToSegment(this.p0, this.p1, e.p0, e.p1);
        }
        if (arguments[0] instanceof T) {
          var t = arguments[0];
          return ot.pointToSegment(t, this.p0, this.p1);
        }
      ...
      return h(r, null, [{ key: "findChainEnd", value: function(e, t) {
        ...
        if (arguments.length === 2) {
          ...
          do {
            var c = r.findChainEnd(t, u), f = new Ur(t, u, c, n);
            i.add(f), u = c;
          } while (u < t.length - 1);
          return i;
        }
      ...
      return h(t, [{ key: "getMonotoneChains", value: function() {
        ...
        for (var i = yu.getChains(n.getCoordinates(), n).iterator(); i.hasNext(); ) {
          var u = i.next();
        ...
        for (var n = new Wr(this._segInt), i = this._monoChains.iterator(); i.hasNext(); ) for (var u = i.next(), c = this._index.query(u.getEnvelope()).iterator(); c.hasNext(); ) {
          var f = c.next();
          if (f.getId() > u.getId() && (u.computeOverlaps(f, n), this._nOverlaps++), this._segInt.isDone()) return null;
        }
      } }], [{ key: "constructor_", value: function() {
        if (this._monoChains = new ne(), this._index = new wt(), this._idCounter = 0, this._nodedSegStrings = null, this._nOverlaps = 0, arguments.length !== 0) {
          if (arguments.length === 1) {
            var n = arguments[0];
            Xr.constructor_.call(this, n);
          }
        }
      } }]), t;
    }(Xr), Wr = function(r) {
    ...
    var _t = function() {
      ...
      return h(r, [{ key: "isDeletable", value: function(e, t, n, i) {
        ...
        return re.index(e, t, n) === this._angleOrientation && ot.pointToSegment(t, e, n) < i;
        ...
        return ot.pointToSegment(t, e, n) < i;
      } }, { key: "collapseLine", value: function() {
        for (var e = new qn(), t = 0; t < this._inputLine.length; t++) this._isDeleted[t] !== r.DELETE && e.add(this._inputLine[t]);
        return e.toCoordinateArray();
      } }], [{ key: "constructor_", value: function() {
    ...
    _t.INIT = 0, _t.DELETE = 1, _t.KEEP = 1, _t.NUM_PTS_TO_CHECK = 10;
    var Vr = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getCoordinates", value: function() {
        ...
        return new _n().createLineString(this.getCoordinates()).toString();
      } }, { key: "closeRing", value: function() {
    ...
    Vr.COORDINATE_ARRAY_TYPE = new Array(0).fill(null);
    var rt = function() {
      function r() {
        s(this, r);
      }
    ...
    var Un = function() {
      ...
      return h(r, [{ key: "addNextSegment", value: function(e, t) {
        ...
        var u = Fn.intersection(t.p0, t.p1, n.p0, n.p1);
        ...
        var u = this._seg0.p1, c = rt.angle(u, this._seg0.p0), f = rt.angleBetweenOriented(this._seg0.p0, u, this._seg1.p1) / 2, d = rt.normalize(c + f), p = rt.normalize(d + Math.PI), S = i * n, L = n - S * Math.abs(Math.sin(f)), A = u.x + S * Math.cos(p), V = u.y + S * Math.sin(p), W = new T(A, V), $ = new it(u, W), ie = $.pointAlongOffset(1, L), le = $.pointAlongOffset(1, -L);
        ...
        for (var p = f / d, S = new T(), L = 0; L < d; L++) {
          var A = t + c * L * p;
          S.x = e.x + u * Math.cos(A), S.y = e.y + u * Math.sin(A), this._segList.addPt(S);
        }
        ...
        this._distance = e, this._maxCurveSegmentError = e * (1 - Math.cos(this._filletAngleQuantum / 2)), this._segList = new Vr(), this._segList.setPrecisionModel(this._precisionModel), this._segList.setMinimumVertexDistance(e * r.CURVE_VERTEX_SNAP_DISTANCE_FACTOR);
      } }, { key: "addCollinear", value: function(e) {
        this._li.computeIntersection(this._s0, this._s1, this._s1, this._s2), this._li.getIntersectionNum() >= 2 && (this._bufParams.getJoinStyle() === R.JOIN_BEVEL || this._bufParams.getJoinStyle() === R.JOIN_MITRE ? (e && this._segList.addPt(this._offset0.p1), this._segList.addPt(this._offset1.p0)) : this.addCornerFillet(this._s1, this._offset0.p1, this._offset1.p0, re.CLOCKWISE, this._distance));
      } }, { key: "closeRing", value: function() {
        ...
        var e = arguments[0], t = arguments[1], n = arguments[2];
        this._precisionModel = e, this._bufParams = t, this._li = new rn(), this._filletAngleQuantum = Math.PI / 2 / t.getQuadrantSegments(), t.getQuadrantSegments() >= 8 && t.getJoinStyle() === R.JOIN_ROUND && (this._closingSegLengthFactor = r.MAX_CLOSING_SEG_LEN_FACTOR), this.init(n);
      } }]), r;
    }();
    Un.OFFSET_SEGMENT_SEPARATION_FACTOR = 1e-3, Un.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR = 1e-3, Un.CURVE_VERTEX_SNAP_DISTANCE_FACTOR = 1e-6, Un.MAX_CLOSING_SEG_LEN_FACTOR = 80;
    var pu = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      }
      return h(r, [{ key: "getOffsetCurve", value: function(e, t) {
        ...
        return new Un(this._precisionModel, this._bufParams, e);
      } }], [{ key: "constructor_", value: function() {
      ...
      return h(r, [{ key: "findStabbedSegments", value: function() {
        ...
        if (arguments.length === 3) {
          if (ue(arguments[2], Ke) && arguments[0] instanceof T && arguments[1] instanceof ji) for (var c = arguments[0], f = arguments[1], d = arguments[2], p = f.getEdge().getCoordinates(), S = 0; S < p.length - 1; S++) {
            ...
            if (!(L < c.x) && !(this._seg.isHorizontal() || c.y < this._seg.p0.y || c.y > this._seg.p1.y || re.index(this._seg.p0, this._seg.p1, c) === re.RIGHT)) {
              var A = f.getDepth(U.LEFT);
              this._seg.p0.equals(p[S]) || (A = f.getDepth(U.RIGHT));
              var V = new Zr(this._seg, A);
              d.add(V);
            }
          }
        ...
        return t.size() === 0 ? 0 : En.min(t)._leftDepth;
      } }], [{ key: "constructor_", value: function() {
    ...
    var jr = function(r) {
      ...
      return h(t, null, [{ key: "constructor_", value: function() {
        q.constructor_.call(this, "Projective point not representable on the Cartesian plane.");
      } }]), t;
    }(q), Ji = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, [{ key: "getY", value: function() {
        var e = this.y / this.w;
        if (Q.isNaN(e) || Q.isInfinite(e)) throw new jr();
        return e;
      } }, { key: "getX", value: function() {
        var e = this.x / this.w;
        if (Q.isNaN(e) || Q.isInfinite(e)) throw new jr();
        ...
        if (this.x = null, this.y = null, this.w = null, arguments.length === 0) this.x = 0, this.y = 0, this.w = 1;
          ...
          var L = arguments[0], A = arguments[1], V = arguments[2], W = arguments[3], $ = L.y - A.y, ie = A.x - L.x, le = L.x * A.y - A.x * L.y, pe = V.y - W.y, Ce = W.x - V.x, Be = V.x * W.y - W.x * V.y;
          this.x = ie * Be - Ce * le, this.y = pe * le - $ * Be, this.w = $ * Ce - pe * ie;
        }
      } }]), r;
    }(), _u = function() {
      function r() {
      ...
      return h(r, [{ key: "area", value: function() {
        ...
        var u = t.x, c = t.y, f = n.x - u, d = i.x - u, p = n.y - c, S = i.y - c, L = f * S - d * p, A = e.x - u, V = e.y - c, W = (S * A - d * V) / L, $ = (-p * A + f * V) / L;
        ...
        var i = te.valueOf(e.x).subtract(n.x), u = te.valueOf(e.y).subtract(n.y), c = te.valueOf(t.x).subtract(n.x), f = te.valueOf(t.y).subtract(n.y), d = te.determinant(i, u, c, f).multiply(2), p = i.sqr().add(u.sqr()), S = c.sqr().add(f.sqr()), L = te.determinant(u, p, f, S), A = te.determinant(i, p, c, S), V = te.valueOf(n.x).subtract(L.divide(d)).doubleValue(), W = te.valueOf(n.y).add(A.divide(d)).doubleValue();
        return new T(V, W);
      } }, { key: "isAcute", value: function(e, t, n) {
        return !!rt.isAcute(e, t, n) && !!rt.isAcute(t, n, e) && !!rt.isAcute(n, e, t);
      } }, { key: "circumcentre", value: function(e, t, n) {
        var i = n.x, u = n.y, c = e.x - i, f = e.y - u, d = t.x - i, p = t.y - u, S = 2 * r.det(c, f, d, p), L = r.det(f, c * c + f * f, p, d * d + p * p), A = r.det(c, c * c + f * f, d, d * d + p * p);
        return new T(i - L / S, u + A / S);
        ...
        var i = t.x - e.x, u = t.y - e.y, c = t.getZ() - e.getZ(), f = n.x - e.x, d = n.y - e.y, p = n.getZ() - e.getZ(), S = u * p - c * d, L = c * f - i * p, A = i * d - u * f, V = S * S + L * L + A * A, W = Math.sqrt(V) / 2;
        return W;
      ...
      return h(r, [{ key: "addRingSide", value: function(e, t, n, i, u) {
        if (t === 0 && e.length < Gn.MINIMUM_VALID_SIZE) return null;
        var c = i, f = u;
        e.length >= Gn.MINIMUM_VALID_SIZE && re.isCCW(e) && (c = u, f = i, n = U.opposite(n));
        var d = this._curveBuilder.getRingCurve(e, n, t);
        this.addCurve(d, c, f);
      } }, { key: "addRingBothSides", value: function(e, t) {
        this.addRingSide(e, t, U.LEFT, w.EXTERIOR, w.INTERIOR), this.addRingSide(e, t, U.RIGHT, w.INTERIOR, w.EXTERIOR);
        ...
        this.addRingSide(u, t, n, w.EXTERIOR, w.INTERIOR);
        for (var c = 0; c < e.getNumInteriorRing(); c++) {
          var f = e.getInteriorRingN(c), d = Ge.removeRepeatedPoints(f.getCoordinates());
          this._distance > 0 && this.isErodedCompletely(f, -this._distance) || this.addRingSide(d, t, U.opposite(n), w.INTERIOR, w.EXTERIOR);
        }
      } }, { key: "isTriangleErodedCompletely", value: function(e, t) {
        var n = new _u(e[0], e[1], e[2]), i = n.inCentre();
        return ot.pointToSegment(i, n.p0, n.p1) < Math.abs(t);
        ...
        var i = new sn(e, new ct(0, w.BOUNDARY, t, n));
        this._curveList.add(i);
      } }, { key: "getCurves", value: function() {
        return this.add(this._inputGeom), this._curveList;
      } }, { key: "add", value: function(e) {
        if (e.isEmpty()) return null;
        if (e instanceof qt) this.addPolygon(e);
        ...
        else if (e instanceof Xi) this.addCollection(e);
      ...
      return h(r, [{ key: "locate", value: function(e) {
        ...
        if (t.isEmpty()) return w.EXTERIOR;
        ...
        for (var u = 0; u < t.getNumInteriorRing(); u++) {
          ...
          if (f === w.BOUNDARY) return w.BOUNDARY;
          if (f === w.INTERIOR) return w.EXTERIOR;
        }
        return w.INTERIOR;
      } }, { key: "locatePointInRing", value: function(e, t) {
        return t.getEnvelopeInternal().intersects(e) ? Hi.locateInRing(e, t.getCoordinates()) : w.EXTERIOR;
      } }, { key: "containsPointInPolygon", value: function(e, t) {
        return w.EXTERIOR !== r.locatePointInPolygon(e, t);
      } }, { key: "locateInGeometry", value: function(e, t) {
        if (t instanceof qt) return r.locatePointInPolygon(e, t);
        if (t instanceof nt) for (var n = new xu(t); n.hasNext(); ) {
          var i = n.next();
          if (i !== t) {
            var u = r.locateInGeometry(e, i);
            if (u !== w.EXTERIOR) return u;
          }
        }
        return w.EXTERIOR;
      } }, { key: "isContained", value: function(e, t) {
        return w.EXTERIOR !== r.locate(e, t);
      } }, { key: "locate", value: function(e, t) {
        return t.isEmpty() ? w.EXTERIOR : t.getEnvelopeInternal().intersects(e) ? r.locateInGeometry(e, t) : w.EXTERIOR;
      } }]), r;
    }(), Iu = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      ...
      return h(r, [{ key: "getNextCW", value: function(e) {
        ...
        for (var t = w.NONE, n = this.iterator(); n.hasNext(); ) {
          var i = n.next().getLabel();
          i.isArea(e) && i.getLocation(e, U.LEFT) !== w.NONE && (t = i.getLocation(e, U.LEFT));
        }
        if (t === w.NONE) return null;
        for (var u = t, c = this.iterator(); c.hasNext(); ) {
          var f = c.next(), d = f.getLabel();
          if (d.getLocation(e, U.ON) === w.NONE && d.setLocation(e, U.ON, u), d.isArea(e)) {
            var p = d.getLocation(e, U.LEFT), S = d.getLocation(e, U.RIGHT);
            if (S !== w.NONE) {
              if (S !== u) throw new tt("side location conflict", f.getCoordinate());
              p === w.NONE && he.shouldNeverReachHere("found single null side (at " + f.getCoordinate() + ")"), u = p;
            } else he.isTrue(d.getLocation(e, U.LEFT) === w.NONE, "found single null side"), d.setLocation(e, U.RIGHT, u), d.setLocation(e, U.LEFT, u);
          }
        }
      } }, { key: "getCoordinate", value: function() {
        var e = this.iterator();
        ...
        he.isTrue(i !== w.NONE, "Found unlabelled area edge");
        ...
        return this._ptInAreaLocation[e] === w.NONE && (this._ptInAreaLocation[e] = Nu.locate(t, n[e].getGeometry())), this._ptInAreaLocation[e];
      } }, { key: "toString", value: function() {
        var e = new Jt();
...
`);
        ...
        for (var t = [!1, !1], n = this.iterator(); n.hasNext(); ) for (var i = n.next().getLabel(), u = 0; u < 2; u++) i.isLine(u) && i.getLocation(u) === w.BOUNDARY && (t[u] = !0);
        ...
        this._edgeMap = new Bn(), this._edgeList = null, this._ptInAreaLocation = [w.NONE, w.NONE];
      } }]), r;
    }(), wu = function(r) {
      g(t, r);
      var e = N(t);
      ...
      return h(t, [{ key: "linkResultDirectedEdges", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          for (var p = arguments[0], S = arguments[1], L = arguments[2], A = L, V = p; V < S; V++) {
            var W = this._edgeList.get(V);
            W.setEdgeDepths(U.RIGHT, A), A = W.getDepth(U.LEFT);
          }
          return A;
        }
        ...
        for (var n = w.NONE, i = this.iterator(); i.hasNext(); ) {
        ...
        for (var f = n, d = this.iterator(); d.hasNext(); ) {
          ...
          p.isLineEdge() ? p.getEdge().setCovered(f === w.INTERIOR) : (p.isInResult() && (f = w.EXTERIOR), S.isInResult() && (f = w.INTERIOR));
        }
      } }, { key: "computeLabelling", value: function(n) {
        I(v(t.prototype), "computeLabelling", this).call(this, n), this._label = new ct(w.NONE);
        for (var i = this.iterator(); i.hasNext(); ) for (var u = i.next().getEdge().getLabel(), c = 0; c < 2; c++) {
          var f = u.getLocation(c);
          f !== w.INTERIOR && f !== w.BOUNDARY || this._label.setLocation(c, w.INTERIOR);
        }
      } }], [{ key: "constructor_", value: function() {
      ...
      return h(r, [{ key: "print", value: function(e) {
        ...
        this._edges = new ne(), this._ocaMap = new Bn();
      } }]), r;
    }(), Kr = function() {
      function r() {
        s(this, r);
      ...
      return h(r, [{ key: "print", value: function(e) {
        ...
        return u && (c[f] = t.coord), new $r(c, new ct(this.edge._label));
      } }, { key: "add", value: function(e, t, n) {
        var i = new Tu(e, t, n), u = this._nodeMap.get(i);
      ...
      return h(r, [{ key: "isIntersects", value: function() {
        ...
        return (r.isTrue(this._matrix[w.INTERIOR][w.INTERIOR]) || r.isTrue(this._matrix[w.INTERIOR][w.BOUNDARY]) || r.isTrue(this._matrix[w.BOUNDARY][w.INTERIOR]) || r.isTrue(this._matrix[w.BOUNDARY][w.BOUNDARY])) && this._matrix[w.EXTERIOR][w.INTERIOR] === H.FALSE && this._matrix[w.EXTERIOR][w.BOUNDARY] === H.FALSE;
      } }, { key: "isCoveredBy", value: function() {
        return (r.isTrue(this._matrix[w.INTERIOR][w.INTERIOR]) || r.isTrue(this._matrix[w.INTERIOR][w.BOUNDARY]) || r.isTrue(this._matrix[w.BOUNDARY][w.INTERIOR]) || r.isTrue(this._matrix[w.BOUNDARY][w.BOUNDARY])) && this._matrix[w.INTERIOR][w.EXTERIOR] === H.FALSE && this._matrix[w.BOUNDARY][w.EXTERIOR] === H.FALSE;
      } }, { key: "set", value: function() {
        ...
        return r.isTrue(this._matrix[w.INTERIOR][w.INTERIOR]) && this._matrix[w.EXTERIOR][w.INTERIOR] === H.FALSE && this._matrix[w.EXTERIOR][w.BOUNDARY] === H.FALSE;
        ...
        return r.isTrue(this._matrix[w.INTERIOR][w.INTERIOR]) && this._matrix[w.INTERIOR][w.EXTERIOR] === H.FALSE && this._matrix[w.BOUNDARY][w.EXTERIOR] === H.FALSE;
      } }, { key: "isTouches", value: function(e, t) {
        return e > t ? this.isTouches(t, e) : (e === H.A && t === H.A || e === H.L && t === H.L || e === H.L && t === H.A || e === H.P && t === H.A || e === H.P && t === H.L) && this._matrix[w.INTERIOR][w.INTERIOR] === H.FALSE && (r.isTrue(this._matrix[w.INTERIOR][w.BOUNDARY]) || r.isTrue(this._matrix[w.BOUNDARY][w.INTERIOR]) || r.isTrue(this._matrix[w.BOUNDARY][w.BOUNDARY]));
      } }, { key: "isOverlaps", value: function(e, t) {
        return e === H.P && t === H.P || e === H.A && t === H.A ? r.isTrue(this._matrix[w.INTERIOR][w.INTERIOR]) && r.isTrue(this._matrix[w.INTERIOR][w.EXTERIOR]) && r.isTrue(this._matrix[w.EXTERIOR][w.INTERIOR]) : e === H.L && t === H.L && this._matrix[w.INTERIOR][w.INTERIOR] === 1 && r.isTrue(this._matrix[w.INTERIOR][w.EXTERIOR]) && r.isTrue(this._matrix[w.EXTERIOR][w.INTERIOR]);
      } }, { key: "isEquals", value: function(e, t) {
        return e === t && r.isTrue(this._matrix[w.INTERIOR][w.INTERIOR]) && this._matrix[w.INTERIOR][w.EXTERIOR] === H.FALSE && this._matrix[w.BOUNDARY][w.EXTERIOR] === H.FALSE && this._matrix[w.EXTERIOR][w.INTERIOR] === H.FALSE && this._matrix[w.EXTERIOR][w.BOUNDARY] === H.FALSE;
      } }, { key: "toString", value: function() {
        for (var e = new li("123456789"), t = 0; t < 3; t++) for (var n = 0; n < 3; n++) e.setCharAt(3 * t + n, H.toDimensionSymbol(this._matrix[t][n]));
        return e.toString();
        ...
        return this._matrix[w.INTERIOR][w.INTERIOR] === H.FALSE && this._matrix[w.INTERIOR][w.BOUNDARY] === H.FALSE && this._matrix[w.BOUNDARY][w.INTERIOR] === H.FALSE && this._matrix[w.BOUNDARY][w.BOUNDARY] === H.FALSE;
      } }, { key: "isCrosses", value: function(e, t) {
        return e === H.P && t === H.L || e === H.P && t === H.A || e === H.L && t === H.A ? r.isTrue(this._matrix[w.INTERIOR][w.INTERIOR]) && r.isTrue(this._matrix[w.INTERIOR][w.EXTERIOR]) : e === H.L && t === H.P || e === H.A && t === H.P || e === H.A && t === H.L ? r.isTrue(this._matrix[w.INTERIOR][w.INTERIOR]) && r.isTrue(this._matrix[w.EXTERIOR][w.INTERIOR]) : e === H.L && t === H.L && this._matrix[w.INTERIOR][w.INTERIOR] === 0;
      } }, { key: "interfaces_", get: function() {
        return [X];
      } }], [{ key: "constructor_", value: function() {
        if (this._matrix = null, arguments.length === 0) this._matrix = Array(3).fill().map(function() {
          ...
          if (typeof arguments[0] == "string") {
            ...
            var t = arguments[0];
            r.constructor_.call(this), this._matrix[w.INTERIOR][w.INTERIOR] = t._matrix[w.INTERIOR][w.INTERIOR], this._matrix[w.INTERIOR][w.BOUNDARY] = t._matrix[w.INTERIOR][w.BOUNDARY], this._matrix[w.INTERIOR][w.EXTERIOR] = t._matrix[w.INTERIOR][w.EXTERIOR], this._matrix[w.BOUNDARY][w.INTERIOR] = t._matrix[w.BOUNDARY][w.INTERIOR], this._matrix[w.BOUNDARY][w.BOUNDARY] = t._matrix[w.BOUNDARY][w.BOUNDARY], this._matrix[w.BOUNDARY][w.EXTERIOR] = t._matrix[w.BOUNDARY][w.EXTERIOR], this._matrix[w.EXTERIOR][w.INTERIOR] = t._matrix[w.EXTERIOR][w.INTERIOR], this._matrix[w.EXTERIOR][w.BOUNDARY] = t._matrix[w.EXTERIOR][w.BOUNDARY], this._matrix[w.EXTERIOR][w.EXTERIOR] = t._matrix[w.EXTERIOR][w.EXTERIOR];
          }
        }
      ...
      return h(r, [{ key: "size", value: function() {
        ...
        this._data = lt.copyOf(this._data, t);
      } }, { key: "toArray", value: function() {
      ...
      return h(r, [{ key: "getChainStartIndices", value: function(e) {
        var t = 0, n = new Ou(Math.trunc(e.length / 2));
        n.add(t);
        do {
      ...
      return h(r, [{ key: "getCoordinates", value: function() {
        ...
        if (arguments.length === 4) {
          ...
          var L = Math.trunc((u + c) / 2), A = Math.trunc((d + p) / 2);
          u < L && (d < A && this.computeIntersectsForChain(u, L, f, d, A, S), A < p && this.computeIntersectsForChain(u, L, f, A, p, S)), L < c && (d < A && this.computeIntersectsForChain(L, c, f, d, A, S), A < p && this.computeIntersectsForChain(L, c, f, A, p, S));
        }
      } }, { key: "overlaps", value: function(e, t, n, i, u) {
      ...
      return h(r, [{ key: "getDepth", value: function(e, t) {
        ...
        if (arguments.length === 1) for (var e = arguments[0], t = 0; t < 2; t++) for (var n = 1; n < 3; n++) {
          ...
          i !== w.EXTERIOR && i !== w.INTERIOR || (this.isNull(t, n) ? this._depth[t][n] = r.depthAtLocation(i) : this._depth[t][n] += r.depthAtLocation(i));
        }
        else if (arguments.length === 3) {
          var u = arguments[0], c = arguments[1], f = arguments[2];
          f === w.INTERIOR && this._depth[u][c]++;
        }
      } }], [{ key: "constructor_", value: function() {
        ...
        return e === w.EXTERIOR ? 0 : e === w.INTERIOR ? 1 : r.NULL_VALUE;
      } }]), r;
    }();
    Jr.NULL_VALUE = -1;
    var $r = function(r) {
      ...
      return h(t, [{ key: "getDepth", value: function() {
        ...
        return n[0] = this.pts[0], n[1] = this.pts[1], new t(n, ct.toLineLabel(this._label));
      } }, { key: "isIsolated", value: function() {
        ...
        return this._mce === null && (this._mce = new Pu(this)), this._mce;
      } }, { key: "getEnvelope", value: function() {
        if (this._env === null) {
          this._env = new ke();
        ...
        if (this.pts = null, this._env = null, this.eiList = new Cu(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new Jr(), this._depthDelta = 0, arguments.length === 1) {
          var n = arguments[0];
        ...
        if (!(arguments.length === 2 && arguments[1] instanceof Ru && arguments[0] instanceof ct)) return I(v(t), "updateIM", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
      ...
      return h(r, [{ key: "setWorkingPrecisionModel", value: function(e) {
        ...
        if (t !== null) {
          ...
          t.isPointwiseEqual(e) || (i = new ct(e.getLabel())).flip(), n.merge(i);
        ...
        for (var n = new ne(), i = e.iterator(); i.hasNext(); ) {
          var u = i.next(), c = u.getRightmostCoordinate(), f = new Hr(n).getDepth(c);
        ...
        return En.sort(t, En.reverseOrder()), t;
      } }, { key: "createEmptyResultGeometry", value: function() {
        return this._geomFact.createPolygon();
      } }, { key: "getNoder", value: function(e) {
        if (this._workingNoder !== null) return this._workingNoder;
        var t = new Ki(), n = new rn();
        return n.setPrecisionModel(e), t.setSegmentIntersector(new bu(n)), t;
      } }, { key: "buffer", value: function(e, t) {
        var n = this._workingPrecisionModel;
        n === null && (n = e.getPrecisionModel()), this._geomFact = e.getFactory();
        var i = new pu(n, this._bufParams), u = new ku(e, t, i).getCurves();
        if (u.size() <= 0) return this.createEmptyResultGeometry();
        this.computeNodedEdges(u, n), this._graph = new qr(new Su()), this._graph.addEdges(this._edgeList.getEdges());
        var c = this.createSubgraphs(this._graph), f = new su(this._geomFact);
        ...
        for (var i = n.getNodedSubstrings().iterator(); i.hasNext(); ) {
          ...
          if (c.length !== 2 || !c[0].equals2D(c[1])) {
            var f = u.getData(), d = new $r(u.getCoordinates(), new ct(f));
        ...
        this._bufParams = null, this._workingPrecisionModel = null, this._workingNoder = null, this._geomFact = null, this._graph = null, this._edgeList = new Lu();
        var e = arguments[0];
        this._bufParams = e;
      } }, { key: "depthDelta", value: function(e) {
        var t = e.getLocation(0, U.LEFT), n = e.getLocation(0, U.RIGHT);
        return t === w.INTERIOR && n === w.EXTERIOR ? 1 : t === w.EXTERIOR && n === w.INTERIOR ? -1 : 0;
      } }, { key: "convertSegStrings", value: function(e) {
        for (var t = new _n(), n = new ne(); e.hasNext(); ) {
      ...
      return h(r, [{ key: "checkEndPtVertexIntersections", value: function() {
        ...
        if (arguments.length === 0) for (var e = this._segStrings.iterator(); e.hasNext(); ) for (var t = e.next(), n = this._segStrings.iterator(); n.hasNext(); ) {
          ...
          var L = arguments[0], A = arguments[1], V = arguments[2], W = arguments[3];
          if (L === V && A === W) return null;
          var $ = L.getCoordinates()[A], ie = L.getCoordinates()[A + 1], le = V.getCoordinates()[W], pe = V.getCoordinates()[W + 1];
    ...
    $i.SAFE_ENV_EXPANSION_FACTOR = 0.75;
    var Du = function() {
      function r() {
        s(this, r), r.constructor_.apply(this, arguments);
      }
      ...
      return h(r, [{ key: "snap", value: function() {
        ...
        if (arguments.length === 3) {
          var t = arguments[0], n = arguments[1], i = arguments[2], u = t.getSafeEnvelope(), c = new is(t, n, i);
      ...
      return h(t, [{ key: "isNodeAdded", value: function() {
        ...
        if (!(arguments.length === 2 && Number.isInteger(arguments[1]) && arguments[0] instanceof Ur)) return I(v(t.prototype), "select", this).apply(this, arguments);
    ...
    var Fu = function() {
      ...
      return h(r, [{ key: "checkCorrectness", value: function(e) {
        var t = sn.getNodedSubstrings(e), n = new ts(t);
        try {
          n.checkValid();
        } catch (i) {
          if (!(i instanceof q)) throw i;
          i.printStackTrace();
        }
      } }, { key: "getNodedSubstrings", value: function() {
        return sn.getNodedSubstrings(this._nodedSegStrings);
        ...
        if (ue(arguments[0], oe)) for (var e = arguments[0], t = e.iterator(); t.hasNext(); ) {
          ...
          var f = new $i(u[c], this._scaleFactor, this._li), d = this._pointSnapper.snap(f, i, c);
          d && i.addIntersection(u[c], c);
        }
      } }, { key: "computeNodes", value: function(e) {
        this._nodedSegStrings = e, this._noder = new Ki(), this._pointSnapper = new ns(this._noder.getIndex()), this.snapRound(e, this._li);
      } }, { key: "computeIntersectionSnaps", value: function(e) {
        for (var t = e.iterator(); t.hasNext(); ) {
          var n = t.next(), i = new $i(n, this._scaleFactor, this._li);
      ...
      return h(r, [{ key: "bufferFixedPrecision", value: function(e) {
        var t = new Au(new Gu(new pt(1)), e.getScale()), n = new es(this._bufParams);
        ...
        if (arguments.length === 1) {
          var t = arguments[0], n = r.precisionScaleFactor(this._argGeom, this._distance, t), i = new pt(n);
        ...
        e.getType() === pt.FIXED ? this.bufferFixedPrecision(e) : this.bufferReducedPrecision();
      } }, { key: "setQuadrantSegments", value: function(e) {
        this._bufParams.setQuadrantSegments(e);
      } }, { key: "bufferOriginalPrecision", value: function() {
        try {
          var e = new es(this._bufParams);
        ...
        if (arguments.length === 3) {
          ...
          if (arguments[2] instanceof R && arguments[0] instanceof J && typeof arguments[1] == "number") {
            var S = arguments[0], L = arguments[1], A = arguments[2], V = new r(S, A), W = V.getResultGeometry(L);
            return W;
          }
        } else if (arguments.length === 4) {
          var $ = arguments[0], ie = arguments[1], le = arguments[2], pe = arguments[3], Ce = new r($);
          Ce.setQuadrantSegments(le), Ce.setEndCapStyle(pe);
          var Be = Ce.getResultGeometry(ie);
          return Be;
        }
    ...
    In.CAP_ROUND = R.CAP_ROUND, In.CAP_BUTT = R.CAP_FLAT, In.CAP_FLAT = R.CAP_FLAT, In.CAP_SQUARE = R.CAP_SQUARE, In.MAX_PRECISION_DIGITS = 12;
    var qu = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], rs = function() {
      function r(e) {
        s(this, r), this.geometryFactory = e || new _n();
      }
      return h(r, [{ key: "read", value: function(e) {
        var t, n = (t = typeof e == "string" ? JSON.parse(e) : e).type;
        if (!gt[n]) throw new Error("Unknown GeoJSON type: " + t.type);
        return qu.indexOf(n) !== -1 ? gt[n].call(this, t.coordinates) : n === "GeometryCollection" ? gt[n].call(this, t.geometries) : gt[n].call(this, t);
      } }, { key: "write", value: function(e) {
        var t = e.getGeometryType();
        if (!St[t]) throw new Error("Geometry is not supported");
        return St[t].call(this, e);
      } }]), r;
    }(), gt = { Feature: function(r) {
      var e = {};
      for (var t in r) e[t] = r[t];
      if (r.geometry) {
        var n = r.geometry.type;
        if (!gt[n]) throw new Error("Unknown GeoJSON type: " + r.type);
        e.geometry = this.read(r.geometry);
      }
      return r.bbox && (e.bbox = gt.bbox.call(this, r.bbox)), e;
      ...
      for (var e = [], t = 0; t < r.length; ++t) e.push(gt.Point.call(this, r[t]));
      return this.geometryFactory.createMultiPoint(e);
    }, LineString: function(r) {
      var e = gt.coordinates.call(this, r);
      return this.geometryFactory.createLineString(e);
    }, MultiLineString: function(r) {
      for (var e = [], t = 0; t < r.length; ++t) e.push(gt.LineString.call(this, r[t]));
      return this.geometryFactory.createMultiLineString(e);
    }, Polygon: function(r) {
      for (var e = gt.coordinates.call(this, r[0]), t = this.geometryFactory.createLinearRing(e), n = [], i = 1; i < r.length; ++i) {
        var u = r[i], c = gt.coordinates.call(this, u), f = this.geometryFactory.createLinearRing(c);
        n.push(f);
      }
    ...
    } }, St = { coordinate: function(r) {
      var e = [r.x, r.y];
      return r.z && e.push(r.z), r.m && e.push(r.m), e;
    }, Point: function(r) {
      return { type: "Point", coordinates: St.coordinate.call(this, r.getCoordinate()) };
    }, MultiPoint: function(r) {
      for (var e = [], t = 0; t < r._geometries.length; ++t) {
        var n = r._geometries[t], i = St.Point.call(this, n);
      ...
      for (var e = [], t = 0; t < r._geometries.length; ++t) {
        var n = r._geometries[t], i = St.LineString.call(this, n);
        e.push(i.coordinates);
      }
      return { type: "MultiLineString", coordinates: e };
    }, Polygon: function(r) {
      var e = [], t = St.LineString.call(this, r._shell);
      e.push(t.coordinates);
      for (var n = 0; n < r._holes.length; ++n) {
        var i = r._holes[n], u = St.LineString.call(this, i);
        e.push(u.coordinates);
      }
      return { type: "Polygon", coordinates: e };
    }, MultiPolygon: function(r) {
      for (var e = [], t = 0; t < r._geometries.length; ++t) {
        var n = r._geometries[t], i = St.Polygon.call(this, n);
        e.push(i.coordinates);
      }
    ...
    return { BufferOp: In, GeoJSONReader: function() {
      function r(e) {
        s(this, r), this.parser = new rs(e || new _n());
      }
      return h(r, [{ key: "read", value: function(e) {
      ...
      function r() {
        s(this, r), this.parser = new rs(this.geometryFactory);
      }
      return h(r, [{ key: "write", value: function(e) {
        return this.parser.write(e);
      } }]), r;
...
bi.prototype = {
  ...
  add: function(o) {
    Fs(yi, o, this.t), Fs(this, yi.s, this.s), this.s ? this.t += yi.t : this.s = yi.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var Ne = 1e-6, ve = Math.PI, Lt = ve / 2, Gs = ve / 4, bt = ve * 2, Yt = 180 / ve, mt = ve / 180, Ye = Math.abs, gl = Math.atan, Cn = Math.atan2, Re = Math.cos, Oe = Math.sin, Mn = Math.sqrt;
function Sa(o) {
...
function Ti(o, a) {
  o && zs.hasOwnProperty(o.type) && zs[o.type](o, a);
}
var qs = {
  ...
  FeatureCollection: function(o, a) {
    for (var s = o.features, l = -1, h = s.length; ++l < h; ) Ti(s[l].geometry, a);
  }
}, zs = {
  Sphere: function(o, a) {
    a.sphere();
  ...
  LineString: function(o, a) {
    fr(o.coordinates, a, 0);
  },
  MultiLineString: function(o, a) {
    for (var s = o.coordinates, l = -1, h = s.length; ++l < h; ) fr(s[l], a, 0);
  },
  Polygon: function(o, a) {
    Ys(o.coordinates, a);
  },
  MultiPolygon: function(o, a) {
    for (var s = o.coordinates, l = -1, h = s.length; ++l < h; ) Ys(s[l], a);
  },
  GeometryCollection: function(o, a) {
    for (var s = o.geometries, l = -1, h = s.length; ++l < h; ) Ti(s[l], a);
  }
};
function fr(o, a, s) {
...
function Ys(o, a) {
  var s = -1, l = o.length;
  for (a.polygonStart(); ++s < l; ) fr(o[s], a, 1);
  a.polygonEnd();
}
function dl(o, a) {
  o && qs.hasOwnProperty(o.type) ? qs[o.type](o, a) : Ti(o, a);
}
Qt();
Qt();
function gr(o) {
  return [Cn(o[1], o[0]), ln(o[2])];
}
function Rn(o) {
  var a = o[0], s = o[1], l = Re(s);
  return [l * Re(a), l * Oe(a), Oe(s)];
}
function pi(o, a) {
...
function dr(o) {
  var a = Mn(o[0] * o[0] + o[1] * o[1] + o[2] * o[2]);
  o[0] /= a, o[1] /= a, o[2] /= a;
}
Qt();
function La(o, a) {
...
function mr(o, a) {
  return [o > ve ? o - bt : o < -ve ? o + bt : o, a];
}
mr.invert = mr;
function ml(o, a, s) {
  return (o %= bt) ? a || s ? La(Us(o), Xs(a, s)) : Us(o) : a || s ? Xs(a, s) : mr;
}
function Bs(o) {
  return function(a, s) {
    return a += o, [a > ve ? a - bt : a < -ve ? a + bt : a, s];
  };
}
function Us(o) {
  var a = Bs(o);
  return a.invert = Bs(-o), a;
}
function Xs(o, a) {
  var s = Re(o), l = Oe(o), h = Re(a), g = Oe(a);
  function v(m, x) {
    var _ = Re(x), k = Re(m) * _, y = Oe(m) * _, E = Oe(x), N = E * s + k * l;
    return [
      Cn(y * h - N * g, k * s - E * l),
      ln(N * h + y * g)
    ];
  ...
  return v.invert = function(m, x) {
    var _ = Re(x), k = Re(m) * _, y = Oe(m) * _, E = Oe(x), N = E * h - y * g;
    return [
      Cn(y * h + E * g, k * s + N * l),
      ln(N * s - k * l)
    ];
...
function vl(o, a, s, l, h, g) {
  if (s) {
    var v = Re(a), m = Oe(a), x = l * s;
    h == null ? (h = a + l * bt, g = a - x / 2) : (h = Ws(v, h), g = Ws(v, g), (l > 0 ? h < g : h > g) && (h += l * bt));
    for (var _, k = h; l > 0 ? k > g : k < g; k -= x)
      _ = gr([v, -m * Re(k), -m * Oe(k)]), o.point(_[0], _[1]);
  }
}
function Ws(o, a) {
  a = Rn(a), a[0] -= o, dr(a);
  var s = Sa(-a[1]);
  return ((-a[2] < 0 ? -s : s) + bt - Ne) % bt;
}
function ba() {
  var o = [], a;
  return {
...
function yl(o, a, s, l, h, g) {
  var v = o[0], m = o[1], x = a[0], _ = a[1], k = 0, y = 1, E = x - v, N = _ - m, I;
  if (I = s - v, !(!E && I > 0)) {
    if (I /= E, E < 0) {
      if (I < k) return;
      I < y && (y = I);
...
function wi(o, a) {
  return Ye(o[0] - a[0]) < Ne && Ye(o[1] - a[1]) < Ne;
}
function ki(o, a, s, l) {
  this.x = o, this.z = a, this.o = s, this.e = l, this.v = !1, this.n = this.p = null;
}
function Ta(o, a, s, l, h) {
  var g = [], v = [], m, x;
  if (o.forEach(function(I) {
    if (!((b = I.length - 1) <= 0)) {
      var b, O = I[0], C = I[b], P;
      if (wi(O, C)) {
        for (h.lineStart(), m = 0; m < b; ++m) h.point((O = I[m])[0], O[1]);
        h.lineEnd();
        return;
      }
      g.push(P = new ki(O, I, null, !0)), v.push(P.o = new ki(O, null, P, !1)), g.push(P = new ki(C, I, null, !1)), v.push(P.o = new ki(C, null, P, !0));
    }
  }), !!g.length) {
    for (v.sort(a), Vs(g), Vs(v), m = 0, x = v.length; m < x; ++m)
      v[m].e = s = !s;
    for (var _ = g[0], k, y; ; ) {
...
function kl(o, a, s, l) {
  ...
  function g(_, k, y, E) {
    var N = 0, I = 0;
    if (_ == null || (N = v(_, y)) !== (I = v(k, y)) || x(_, k) < 0 ^ y > 0)
      do
  ...
  function v(_, k) {
    return Ye(_[0] - o) < Ne ? k > 0 ? 0 : 3 : Ye(_[0] - s) < Ne ? k > 0 ? 2 : 1 : Ye(_[1] - a) < Ne ? k > 0 ? 1 : 0 : k > 0 ? 3 : 2;
  }
  function m(_, k) {
    return x(_.x, k.x);
  }
  ...
  return function(_) {
    var k = _, y = ba(), E, N, I, b, O, C, P, R, q, M, Y, z = {
      point: X,
      lineStart: j,
      lineEnd: ce,
      polygonStart: Z,
    ...
    function G() {
      for (var K = 0, se = 0, me = N.length; se < me; ++se)
        for (var Te = N[se], Ee = 1, Q = Te.length, Ae = Te[0], Ie, qe, he = Ae[0], ut = Ae[1]; Ee < Q; ++Ee)
          Ie = he, qe = ut, Ae = Te[Ee], he = Ae[0], ut = Ae[1], qe <= l ? ut > l && (he - Ie) * (l - qe) > (ut - qe) * (o - Ie) && ++K : ut <= l && (he - Ie) * (l - qe) < (ut - qe) * (o - Ie) && --K;
      return K;
    }
    function Z() {
      k = y, E = [], N = [], Y = !0;
    ...
    function ee() {
      var K = G(), se = Y && K, me = (E = Ra(E)).length;
      (se || me) && (_.polygonStart(), se && (_.lineStart(), g(null, null, 1, _), _.lineEnd()), me && Ta(E, m, K, g, _), _.polygonEnd()), k = _, E = N = I = null;
    }
    function j() {
      z.point = F, N && N.push(I = []), M = !0, q = !1, P = R = NaN;
    }
    function ce() {
      E && (F(b, O), C && q && y.rejoin(), E.push(y.result())), z.point = X, q && k.lineEnd();
    }
    function F(K, se) {
      var me = h(K, se);
      if (N && I.push([K, se]), M)
        b = K, O = se, C = me, M = !1, me && (k.lineStart(), k.point(K, se));
      else if (me && q) k.point(K, se);
      else {
        var Te = [P = Math.max(Ei, Math.min(Qn, P)), R = Math.max(Ei, Math.min(Qn, R))], Ee = [K = Math.max(Ei, Math.min(Qn, K)), se = Math.max(Ei, Math.min(Qn, se))];
        yl(Te, Ee, o, a, s, l) ? (q || (k.lineStart(), k.point(Te[0], Te[1])), k.point(Ee[0], Ee[1]), me || k.lineEnd(), Y = !1) : me && (k.lineStart(), k.point(K, se), Y = !1);
      }
      P = K, R = se, q = me;
    }
    return z;
...
var ar = Qt();
function El(o, a) {
  var s = a[0], l = a[1], h = [Oe(s), -Re(s), 0], g = 0, v = 0;
  ar.reset();
  for (var m = 0, x = o.length; m < x; ++m)
    if (k = (_ = o[m]).length)
      for (var _, k, y = _[k - 1], E = y[0], N = y[1] / 2 + Gs, I = Oe(N), b = Re(N), O = 0; O < k; ++O, E = P, I = q, b = M, y = C) {
        var C = _[O], P = C[0], R = C[1] / 2 + Gs, q = Oe(R), M = Re(R), Y = P - E, z = Y >= 0 ? 1 : -1, X = z * Y, G = X > ve, Z = I * q;
        if (ar.add(Cn(Z * z * Oe(X), b * M + Z * Re(X))), g += G ? Y + z * bt : Y, G ^ E >= s ^ P >= s) {
          var ee = Ci(Rn(y), Rn(C));
          dr(ee);
          var j = Ci(h, ee);
          dr(j);
          var ce = (G ^ Y >= 0 ? -1 : 1) * ln(j[2]);
          (l > ce || l === ce && (ee[0] || ee[1])) && (v += G ^ Y >= 0 ? 1 : -1);
        }
      }
  return (g < -Ne || g < Ne && ar < -Ne) ^ v & 1;
}
Qt();
function Hs(o) {
  return o;
...
Qt();
Qt();
var On = 1 / 0, Ri = On, ti = -On, Oi = ti, Zs = {
  point: xl,
  lineStart: jn,
  lineEnd: jn,
  polygonStart: jn,
  ...
  result: function() {
    var o = [[On, Ri], [ti, Oi]];
    return ti = Oi = -(Ri = On = 1 / 0), o;
  }
};
function xl(o, a) {
  o < On && (On = o), o > ti && (ti = o), a < Ri && (Ri = a), a > Oi && (Oi = a);
}
Qt();
function Oa(o, a, s, l) {
  return function(h, g) {
    var v = a(g), m = h.invert(l[0], l[1]), x = ba(), _ = a(x), k = !1, y, E, N, I = {
      point: b,
      lineStart: C,
      lineEnd: P,
      polygonStart: function() {
        I.point = R, I.lineStart = q, I.lineEnd = M, E = [], y = [];
      },
      polygonEnd: function() {
        I.point = b, I.lineStart = C, I.lineEnd = P, E = Ra(E);
        var Y = El(y, m);
        E.length ? (k || (g.polygonStart(), k = !0), Ta(E, Il, Y, s, g)) : Y && (k || (g.polygonStart(), k = !0), g.lineStart(), s(null, null, 1, g), g.lineEnd()), k && (g.polygonEnd(), k = !1), E = y = null;
      },
      sphere: function() {
    ...
    function M() {
      R(N[0][0], N[0][1]), _.lineEnd();
      var Y = _.clean(), z = x.result(), X, G = z.length, Z, ee, j;
      if (N.pop(), y.push(N), N = null, !!G) {
        if (Y & 1) {
        ...
        G > 1 && Y & 2 && z.push(z.pop().concat(z.shift())), E.push(z.filter(Nl));
      }
    }
    return I;
  };
...
function Il(o, a) {
  return ((o = o.x)[0] < 0 ? o[1] - Lt - Ne : Lt - o[1]) - ((a = a.x)[0] < 0 ? a[1] - Lt - Ne : Lt - a[1]);
}
const js = Oa(
  function() {
    return !0;
...
function wl(o) {
  ...
  return {
    ...
    point: function(g, v) {
      var m = g > 0 ? ve : -ve, x = Ye(g - a);
      Ye(x - ve) < Ne ? (o.point(a, s = (s + v) / 2 > 0 ? Lt : -Lt), o.point(l, s), o.lineEnd(), o.lineStart(), o.point(m, s), o.point(g, s), h = 0) : l !== m && x >= ve && (Ye(a - l) < Ne && (a -= l * Ne), Ye(g - m) < Ne && (g -= m * Ne), s = Sl(a, s, g, v), o.point(l, s), o.lineEnd(), o.lineStart(), o.point(m, s), h = 0), o.point(a = g, s = v), l = m;
    },
    lineEnd: function() {
      o.lineEnd(), a = s = NaN;
    },
...
function Sl(o, a, s, l) {
  var h, g, v = Oe(o - s);
  return Ye(v) > Ne ? gl((Oe(a) * (g = Re(l)) * Oe(s) - Oe(l) * (h = Re(a)) * Oe(o)) / (h * g * v)) : (a + l) / 2;
}
function Ll(o, a, s, l) {
  var h;
  if (o == null)
    h = s * Lt, l.point(-ve, h), l.point(0, h), l.point(ve, h), l.point(ve, 0), l.point(ve, -h), l.point(0, -h), l.point(-ve, -h), l.point(-ve, 0), l.point(-ve, h);
  else if (Ye(o[0] - a[0]) > Ne) {
    var g = o[0] < a[0] ? ve : -ve;
...
function bl(o, a) {
  ...
  function m(k) {
    ...
    return {
      ...
      point: function(O, C) {
        var P = [O, C], R, q = v(O, C), M = l ? q ? 0 : _(O, C) : q ? _(O + (O < 0 ? ve : -ve), C) : 0;
        if (!y && (I = N = q) && k.lineStart(), q !== N && (R = x(y, P), (!R || wi(y, R) || wi(P, R)) && (P[0] += Ne, P[1] += Ne, q = v(P[0], P[1]))), q !== N)
          b = 0, q ? (k.lineStart(), R = x(P, y), k.point(R[0], R[1])) : (R = x(y, P), k.point(R[0], R[1]), k.lineEnd()), y = R;
        else if (h && y && l ^ q) {
          var Y;
          !(M & E) && (Y = x(P, y, !0)) && (b = 0, l ? (k.lineStart(), k.point(Y[0][0], Y[0][1]), k.point(Y[1][0], Y[1][1]), k.lineEnd()) : (k.point(Y[1][0], Y[1][1]), k.lineEnd(), k.lineStart(), k.point(Y[0][0], Y[0][1])));
        }
        q && (!y || !wi(y, P)) && k.point(P[0], P[1]), y = P, N = q, E = M;
      },
      lineEnd: function() {
        N && k.lineEnd(), y = null;
      },
  ...
  function x(k, y, E) {
    var N = Rn(k), I = Rn(y), b = [1, 0, 0], O = Ci(N, I), C = pi(O, O), P = O[0], R = C - P * P;
    if (!R) return !E && k;
    var q = s * C / R, M = -s * P / R, Y = Ci(b, O), z = _i(b, q), X = _i(O, M);
    sr(z, X);
    var G = Y, Z = pi(z, G), ee = pi(G, G), j = Z * Z - ee * (pi(z, z) - 1);
    if (!(j < 0)) {
      var ce = Mn(j), F = _i(G, (-Z - ce) / ee);
      if (sr(F, z), F = gr(F), !E) return F;
      var K = k[0], se = y[0], me = k[1], Te = y[1], Ee;
      se < K && (Ee = K, K = se, se = Ee);
      var Q = se - K, Ae = Ye(Q - ve) < Ne, Ie = Ae || Q < Ne;
      if (!Ae && Te < me && (Ee = me, me = Te, Te = Ee), Ie ? Ae ? me + Te > 0 ^ F[1] < (Ye(F[0] - K) < Ne ? me : Te) : me <= F[1] && F[1] <= Te : Q > ve ^ (K <= F[0] && F[0] <= se)) {
        var qe = _i(G, (-Z + ce) / ee);
        return sr(qe, z), [F, gr(qe)];
      }
    }
  }
  function _(k, y) {
...
function Pa(o, a, s) {
  ...
  o.scale(150).translate([0, 0]), g != null && o.clipExtent(null), dl(s, o.stream(Zs));
  var v = Zs.result(), m = Math.min(l / (v[1][0] - v[0][0]), h / (v[1][1] - v[0][1])), x = +a[0][0] + (l - m * (v[1][0] + v[0][0])) / 2, _ = +a[0][1] + (h - m * (v[1][1] + v[0][1])) / 2;
  return g != null && o.clipExtent(g), o.scale(m * 150).translate([x, _]);
}
function Tl(o, a, s) {
  return Pa(o, [[0, 0], a], s);
}
var Qs = 16, Cl = Re(30 * mt);
function Ks(o, a) {
  return +a ? Ol(o, a) : Rl(o);
}
function Rl(o) {
  return Ma({
    point: function(a, s) {
...
function Ol(o, a) {
  function s(l, h, g, v, m, x, _, k, y, E, N, I, b, O) {
    var C = _ - l, P = k - h, R = C * C + P * P;
    if (R > 4 * a && b--) {
      var q = v + E, M = m + N, Y = x + I, z = Mn(q * q + M * M + Y * Y), X = ln(Y /= z), G = Ye(Ye(Y) - 1) < Ne || Ye(g - y) < Ne ? (g + y) / 2 : Cn(M, q), Z = o(G, X), ee = Z[0], j = Z[1], ce = ee - l, F = j - h, K = P * ce - C * F;
      (K * K / R > a || Ye((C * ce + P * F) / R - 0.5) > 0.3 || v * E + m * N + x * I < Cl) && (s(l, h, g, v, m, x, ee, j, G, q /= z, M /= z, Y, b, O), O.point(ee, j), s(ee, j, G, q, M, Y, _, k, y, E, N, I, b, O));
    }
  }
  return function(l) {
    var h, g, v, m, x, _, k, y, E, N, I, b, O = {
      point: C,
      lineStart: P,
      lineEnd: q,
      polygonStart: function() {
        l.polygonStart(), O.lineStart = M;
      },
      polygonEnd: function() {
        l.polygonEnd(), O.lineStart = P;
      }
    };
    function C(X, G) {
      X = o(X, G), l.point(X[0], X[1]);
    }
    function P() {
      y = NaN, O.point = R, l.lineStart();
    }
    function R(X, G) {
      var Z = Rn([X, G]), ee = o(X, G);
      s(y, E, k, N, I, b, y = ee[0], E = ee[1], k = X, N = Z[0], I = Z[1], b = Z[2], Qs, l), l.point(y, E);
    }
    function q() {
      O.point = C, l.lineEnd();
    }
    function M() {
      P(), O.point = Y, O.lineEnd = z;
    }
    function Y(X, G) {
      R(h = X, G), g = y, v = E, m = N, x = I, _ = b, O.point = R;
    }
    function z() {
      s(y, E, k, N, I, b, g, v, h, m, x, _, Qs, l), O.lineEnd = q, q();
    }
    return O;
  };
}
...
function Al(o) {
  var a, s = 150, l = 480, h = 250, g, v, m = 0, x = 0, _ = 0, k = 0, y = 0, E, N, I = null, b = js, O = null, C, P, R, q = Hs, M = 0.5, Y = Ks(ee, M), z, X;
  function G(F) {
    return F = N(F[0] * mt, F[1] * mt), [F[0] * s + g, v - F[1] * s];
  }
  function Z(F) {
    return F = N.invert((F[0] - g) / s, (v - F[1]) / s), F && [F[0] * Yt, F[1] * Yt];
  }
  function ee(F, K) {
    return F = a(F, K), [F[0] * s + g, v - F[1] * s];
  }
  G.stream = function(F) {
    return z && X === F ? z : z = Ml(b(E, Y(q(X = F))));
  }, G.clipAngle = function(F) {
    return arguments.length ? (b = +F ? bl(I = F * mt, 6 * mt) : (I = null, js), ce()) : I * Yt;
  }, G.clipExtent = function(F) {
    return arguments.length ? (q = F == null ? (O = C = P = R = null, Hs) : kl(O = +F[0][0], C = +F[0][1], P = +F[1][0], R = +F[1][1]), ce()) : O == null ? null : [[O, C], [P, R]];
  }, G.scale = function(F) {
    return arguments.length ? (s = +F, j()) : s;
  }, G.translate = function(F) {
    return arguments.length ? (l = +F[0], h = +F[1], j()) : [l, h];
  }, G.center = function(F) {
    return arguments.length ? (m = F[0] % 360 * mt, x = F[1] % 360 * mt, j()) : [m * Yt, x * Yt];
  }, G.rotate = function(F) {
    return arguments.length ? (_ = F[0] % 360 * mt, k = F[1] % 360 * mt, y = F.length > 2 ? F[2] % 360 * mt : 0, j()) : [_ * Yt, k * Yt, y * Yt];
  }, G.precision = function(F) {
    return arguments.length ? (Y = Ks(ee, M = F * F), ce()) : Mn(M);
  }, G.fitExtent = function(F, K) {
    return Pa(G, F, K);
  }, G.fitSize = function(F, K) {
    return Tl(G, F, K);
  };
  function j() {
    N = La(E = ml(_, k, y), a);
    var F = a(m, x);
    return g = l - F[0] * s, v = h + F[1] * s, ce();
  }
  function ce() {
    return z = X = null, G;
  }
  return function() {
    return a = o.apply(this, arguments), G.invert = a.invert && Z, j();
  };
}
function Aa(o) {
  return function(a, s) {
    var l = Re(a), h = Re(s), g = o(l * h);
    return [
      g * h * Oe(a),
      g * Oe(s)
    ];
...
function Da(o) {
  return function(a, s) {
    var l = Mn(a * a + s * s), h = o(l), g = Oe(h), v = Re(h);
    return [
      Cn(a * g, l * v),
      ln(l && s * g / l)
    ];
...
var Dl = Aa(function(o) {
  return Mn(2 / (1 + o));
});
Dl.invert = Da(function(o) {
  return 2 * ln(o / 2);
});
var Fa = Aa(function(o) {
  return (o = Sa(o)) && o / Oe(o);
});
Fa.invert = Da(function(o) {
  return o;
});
function Fl() {
  return Pl(Fa).scale(79.4188).clipAngle(180 - 1e-3);
}
function Js(o, a) {
  return [o, a];
}
Js.invert = Js;
var { BufferOp: Gl, GeoJSONReader: ql, GeoJSONWriter: zl } = fl;
function Yl(o, a, s) {
  s = s || {};
  ...
  switch (o.type) {
    case "GeometryCollection":
      return Nr(o, function(v) {
        var m = Si(v, a, l, h);
        m && g.push(m);
      }), ei(g);
    case "FeatureCollection":
      return Ds(o, function(v) {
        var m = Si(v, a, l, h);
        m && Ds(m, function(x) {
          x && g.push(x);
        });
...
function Si(o, a, s, l) {
  ...
  var m = Bl(g), x = {
    type: g.type,
    coordinates: qa(g.coordinates, m)
  }, _ = new ql(), k = _.read(x), y = sl(al(a, s), "meters"), E = Gl.bufferOp(k, y, l), N = new zl();
  if (E = N.write(E), !Ga(E.coordinates)) {
    var I = {
      type: E.type,
      coordinates: za(E.coordinates, m)
    };
    return Ai(I, h);
  }
}
function Ga(o) {
  return Array.isArray(o[0]) ? Ga(o[0]) : isNaN(o[0]);
}
function qa(o, a) {
...
function Bl(o) {
  var a = ol(o).geometry.coordinates, s = [-a[0], -a[1]];
  return Fl().rotate(s).scale($e);
}
var Ul = Yl;
/**
 * splaytree v3.1.2
...
function Bt(o, a, s) {
  for (var l = new Zt(null, null), h = l, g = l; ; ) {
    var v = s(o, a.key);
    if (v < 0) {
      if (a.left === null)
        break;
...
function yr(o, a, s, l, h) {
  if (o) {
    l("" + a + (s ? "└── " : "├── ") + h(o) + `
`);
    var g = a + (s ? "    " : "│   ");
    o.left && yr(o.left, g, !1, l, h), o.right && yr(o.right, g, !0, l, h);
  }
}
var Ir = (
  /** @class */
  function() {
    function o(a) {
      a === void 0 && (a = Wl), this._root = null, this._size = 0, this._comparator = a;
    }
    return o.prototype.insert = function(a, s) {
      return this._size++, this._root = ur(a, s, this._root, this._comparator);
      ...
      if (l && kr(a, s, 0, h - 1, g), this._root === null)
        this._root = pr(a, s, 0, h), this._size = h;
      else {
        var v = jl(this.toList(), Hl(a, s), g);
        h = this._size + h, this._root = _r({ head: v }, 0, h);
      }
      return this;
      ...
      var s = [];
      return yr(this._root, "", !0, function(l) {
        return s.push(l);
      }, a), s.join("");
    }, o.prototype.update = function(a, s, l) {
      var h = this._comparator, g = $s(a, this._root, h), v = g.left, m = g.right;
      h(a, s) < 0 ? m = ur(s, l, m, h) : v = ur(s, l, v, h), this._root = Vl(v, m, h);
    }, o.prototype.split = function(a) {
      return $s(a, this._root, this._comparator);
...
function pr(o, a, s, l) {
  var h = l - s;
  if (h > 0) {
    var g = s + Math.floor(h / 2), v = o[g], m = a[g], x = new Zt(v, m);
    return x.left = pr(o, a, s, g), x.right = pr(o, a, g + 1, l), x;
  }
  return null;
}
function Hl(o, a) {
  for (var s = new Zt(null, null), l = s, h = 0; h < o.length; h++)
    l = l.next = new Zt(o[h], a[h]);
  return l.next = null, s.next;
}
function Zl(o) {
  for (var a = o, s = [], l = !1, h = new Zt(null, null), g = h; !l; )
...
function _r(o, a, s) {
  var l = s - a;
  if (l > 0) {
    var h = a + Math.floor(l / 2), g = _r(o, a, h), v = o.head;
    return v.left = g, o.head = o.head.next, v.right = _r(o, h + 1, s), v;
  }
  return null;
}
function jl(o, a, s) {
  for (var l = new Zt(null, null), h = l, g = o, v = a; g !== null && v !== null; )
    s(g.key, v.key) < 0 ? (h.next = g, g = g.next) : (h.next = v, v = v.next), h = h.next;
  return g !== null ? h.next = g : v !== null && (h.next = v), l.next;
}
function kr(o, a, s, l, h) {
  if (!(s >= l)) {
    ...
    kr(o, a, s, m, h), kr(o, a, m + 1, l, h);
  }
}
const At = 11102230246251565e-32, Ue = 134217729, Ql = (3 + 8 * At) * At;
function or(o, a, s, l, h) {
...
const Jl = (3 + 16 * At) * At, $l = (2 + 12 * At) * At, eh = (9 + 64 * At) * At * At, Ln = ii(4), ea = ii(8), ta = ii(12), na = ii(16), Ze = ii(4);
function th(o, a, s, l, h, g, v) {
  let m, x, _, k, y, E, N, I, b, O, C, P, R, q, M, Y, z, X;
  const G = o - h, Z = s - h, ee = a - g, j = l - g;
  q = G * j, E = Ue * G, N = E - (E - G), I = G - N, E = Ue * j, b = E - (E - j), O = j - b, M = I * O - (q - N * b - I * b - N * O), Y = ee * Z, E = Ue * ee, N = E - (E - ee), I = ee - N, E = Ue * Z, b = E - (E - Z), O = Z - b, z = I * O - (Y - N * b - I * b - N * O), C = M - z, y = M - C, Ln[0] = M - (C + y) + (y - z), P = q + C, y = P - q, R = q - (P - y) + (C - y), C = R - Y, y = R - C, Ln[1] = R - (C + y) + (y - Y), X = P + C, y = X - P, Ln[2] = P - (X - y) + (C - y), Ln[3] = X;
  let ce = Kl(4, Ln), F = $l * v;
  if (ce >= F || -ce >= F || (y = o - G, m = o - (G + y) + (y - h), y = s - Z, _ = s - (Z + y) + (y - h), y = a - ee, x = a - (ee + y) + (y - g), y = l - j, k = l - (j + y) + (y - g), m === 0 && x === 0 && _ === 0 && k === 0) || (F = eh * v + Ql * Math.abs(ce), ce += G * k + j * m - (ee * _ + Z * x), ce >= F || -ce >= F)) return ce;
  q = m * j, E = Ue * m, N = E - (E - m), I = m - N, E = Ue * j, b = E - (E - j), O = j - b, M = I * O - (q - N * b - I * b - N * O), Y = x * Z, E = Ue * x, N = E - (E - x), I = x - N, E = Ue * Z, b = E - (E - Z), O = Z - b, z = I * O - (Y - N * b - I * b - N * O), C = M - z, y = M - C, Ze[0] = M - (C + y) + (y - z), P = q + C, y = P - q, R = q - (P - y) + (C - y), C = R - Y, y = R - C, Ze[1] = R - (C + y) + (y - Y), X = P + C, y = X - P, Ze[2] = P - (X - y) + (C - y), Ze[3] = X;
  const K = or(4, Ln, 4, Ze, ea);
  q = G * k, E = Ue * G, N = E - (E - G), I = G - N, E = Ue * k, b = E - (E - k), O = k - b, M = I * O - (q - N * b - I * b - N * O), Y = ee * _, E = Ue * ee, N = E - (E - ee), I = ee - N, E = Ue * _, b = E - (E - _), O = _ - b, z = I * O - (Y - N * b - I * b - N * O), C = M - z, y = M - C, Ze[0] = M - (C + y) + (y - z), P = q + C, y = P - q, R = q - (P - y) + (C - y), C = R - Y, y = R - C, Ze[1] = R - (C + y) + (y - Y), X = P + C, y = X - P, Ze[2] = P - (X - y) + (C - y), Ze[3] = X;
  const se = or(K, ea, 4, Ze, ta);
  q = m * k, E = Ue * m, N = E - (E - m), I = m - N, E = Ue * k, b = E - (E - k), O = k - b, M = I * O - (q - N * b - I * b - N * O), Y = x * _, E = Ue * x, N = E - (E - x), I = x - N, E = Ue * _, b = E - (E - _), O = _ - b, z = I * O - (Y - N * b - I * b - N * O), C = M - z, y = M - C, Ze[0] = M - (C + y) + (y - z), P = q + C, y = P - q, R = q - (P - y) + (C - y), C = R - Y, y = R - C, Ze[1] = R - (C + y) + (y - Y), X = P + C, y = X - P, Ze[2] = P - (X - y) + (C - y), Ze[3] = X;
  const me = or(se, ta, 4, Ze, na);
  return na[me - 1];
}
function nh(o, a, s, l, h, g) {
  const v = (a - g) * (s - h), m = (o - h) * (l - g), x = v - m, _ = Math.abs(v + m);
  return Math.abs(x) >= Jl * _ ? x : -th(o, a, s, l, h, g, _);
}
const Zn = (o, a) => o.ll.x <= a.x && a.x <= o.ur.x && o.ll.y <= a.y && a.y <= o.ur.y, Er = (o, a) => {
...
let Xt = Number.EPSILON;
Xt === void 0 && (Xt = Math.pow(2, -52));
const ih = Xt * Xt, ia = (o, a) => {
  if (-Xt < o && o < Xt && -Xt < a && a < Xt)
    return 0;
  const s = o - a;
  return s * s < ih * o * a ? 0 : o < a ? -1 : 1;
};
class rh {
  constructor() {
    this.reset();
  ...
  reset() {
    this.xRounder = new ra(), this.yRounder = new ra();
  }
  round(a, s) {
    return {
...
class ra {
  ...
  round(a) {
    ...
    if (l !== null && ia(s.key, l.key) === 0)
      return this.tree.remove(a), l.key;
    const h = this.tree.next(s);
    return h !== null && ia(s.key, h.key) === 0 ? (this.tree.remove(a), h.key) : a;
  }
}
const ni = new rh(), Li = (o, a) => o.x * a.y - o.y * a.x, Ya = (o, a) => o.x * a.x + o.y * a.y, sa = (o, a, s) => {
  const l = nh(o.x, o.y, a.x, a.y, s.x, s.y);
  return l > 0 ? -1 : l < 0 ? 1 : 0;
}, Mi = (o) => Math.sqrt(Ya(o, o)), sh = (o, a, s) => {
  const l = {
    x: a.x - o.x,
    y: a.y - o.y
  }, h = {
  ...
  if (a.x === 0) return ua(s, l, o.x);
  if (l.x === 0) return ua(o, a, s.x);
  if (a.y === 0) return aa(s, l, o.y);
  if (l.y === 0) return aa(o, a, s.y);
  const h = Li(a, l);
  if (h == 0) return null;
  const g = {
    x: s.x - o.x,
    y: s.y - o.y
  }, v = Li(g, a) / h, m = Li(g, l) / h, x = o.x + m * a.x, _ = s.x + v * l.x, k = o.y + m * a.y, y = s.y + v * l.y, E = (x + _) / 2, N = (k + y) / 2;
  return {
    x: E,
    y: N
  };
...
class yt {
  ...
  static compare(a, s) {
    ...
    return l !== 0 ? l : (a.point !== s.point && a.link(s), a.isLeft !== s.isLeft ? a.isLeft ? 1 : -1 : Wt.compare(a.segment, s.segment));
  }
  ...
  getLeftmostComparator(a) {
    const s = /* @__PURE__ */ new Map(), l = (h) => {
      const g = h.otherSE;
      s.set(h, {
        sine: sh(this.point, a.point, g.point),
        cosine: ah(this.point, a.point, g.point)
      });
    };
    return (h, g) => {
...
class Wt {
  ...
  constructor(a, s, l, h) {
    this.id = ++oh, this.leftSE = a, a.segment = this, a.otherSE = s, this.rightSE = s, s.segment = this, s.otherSE = a, this.rings = l, this.windings = h;
  }
   ...
   */
  getIntersection(a) {
    const s = this.bbox(), l = a.bbox(), h = Er(s, l);
    if (h === null) return null;
    const g = this.leftSE.point, v = this.rightSE.point, m = a.leftSE.point, x = a.rightSE.point, _ = Zn(s, m) && this.comparePoint(m) === 0, k = Zn(l, g) && a.comparePoint(g) === 0, y = Zn(s, x) && this.comparePoint(x) === 0, E = Zn(l, v) && a.comparePoint(v) === 0;
    if (k && _)
    ...
    if (E) return v;
    if (y) return x;
    const N = uh(g, this.vector(), m, a.vector());
    return N === null || !Zn(h, N) ? null : ni.round(N.x, N.y);
  }
  /**
  ...
  split(a) {
    ...
    const m = new Wt(h, v, this.rings.slice(), this.windings.slice());
  ...
  constructor(a, s, l) {
    ...
    for (let v = 1, m = a.length; v < m; v++) {
      if (typeof a[v][0] != "number" || typeof a[v][1] != "number")
        throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
      let x = ni.round(a[v][0], a[v][1]);
      x.x === g.x && x.y === g.y || (this.segments.push(Wt.fromRing(g, x, this)), x.x < this.bbox.ll.x && (this.bbox.ll.x = x.x), x.y < this.bbox.ll.y && (this.bbox.ll.y = x.y), x.x > this.bbox.ur.x && (this.bbox.ur.x = x.x), x.y > this.bbox.ur.y && (this.bbox.ur.y = x.y), g = x);
    }
    (h.x !== g.x || h.y !== g.y) && this.segments.push(Wt.fromRing(g, h, this));
  }
  getSweepEvents() {
    const a = [];
...
class lh {
  constructor(a, s) {
    if (!Array.isArray(a))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new oa(a[0], this, !0), this.bbox = {
      ll: {
...
class Pi {
    ...
    for (let l = 0, h = a.length; l < h; l++) {
      ...
      for (; v = m, m = x, _.push(m), m.point !== k; )
        for (; ; ) {
          ...
          if (E.length === 0) {
            const b = _[0].point, O = _[_.length - 1].point;
            throw new Error(`Unable to complete output ring starting at [${b.x}, ${b.y}]. Last matching segment found ends at [${O.x}, ${O.y}].`);
          }
          if (E.length === 1) {
            x = E[0].otherSE;
            break;
          ...
          let N = null;
          for (let b = 0, O = y.length; b < O; b++)
            if (y[b].point === m.point) {
              N = b;
              break;
            }
          if (N !== null) {
            const b = y.splice(N)[0], O = _.splice(b.index);
            O.unshift(O[0].otherSE), s.push(new Pi(O.reverse()));
            continue;
          }
          y.push({
            index: _.length,
          ...
          const I = m.getLeftmostComparator(v);
          x = E.sort(I)[0].otherSE;
          break;
        }
      s.push(new Pi(_));
    }
  ...
  getGeom() {
    ...
    for (let _ = 1, k = this.events.length - 1; _ < k; _++) {
      ...
      sa(y, a, E) !== 0 && (s.push(y), a = y);
    }
    if (s.length === 1) return null;
    const l = s[0], h = s[1];
    sa(l, a, h) === 0 && s.shift(), s.push(s[0]);
...
class hh {
  ...
  _composePolys(a) {
    ...
    for (let l = 0, h = a.length; l < h; l++) {
      const g = a[l];
      if (!g.poly)
        if (g.isExteriorRing()) s.push(new ha(g));
        else {
          const v = g.enclosingRing();
          v.poly || s.push(new ha(v)), v.poly.addInterior(g);
        }
    }
    return s;
  }
...
class ch {
  constructor(a) {
    let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Wt.compare;
    this.queue = a, this.tree = new Ir(s), this.segments = [];
  }
  process(a) {
    const s = a.segment, l = [];
    if (a.consumedBy)
...
const ca = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, fh = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6;
class gh {
  run(a, s, l) {
    xt.type = a, ni.reset();
    const h = [new la(s, !0)];
    ...
    if (xt.numMultiPolys = h.length, xt.type === "difference") {
      ...
      let E = 1;
      for (; E < h.length; )
        Er(h[E].bbox, y.bbox) !== null ? E++ : h.splice(E, 1);
    }
    if (xt.type === "intersection")
      for (let y = 0, E = h.length; y < E; y++) {
        const N = h[y];
        for (let I = y + 1, b = h.length; I < b; I++)
          if (Er(N.bbox, h[I].bbox) === null) return [];
      }
    const g = new Ir(yt.compare);
    for (let y = 0, E = h.length; y < E; y++) {
      const N = h[y].getSweepEvents();
      for (let I = 0, b = N.length; I < b; I++)
        if (g.insert(N[I]), g.size > ca)
    ...
    for (; x; ) {
      ...
      if (v.segments.length > fh)
        throw new Error("Infinite loop when passing sweep line over endpoints (too many sweep line segments).");
      const E = v.process(y);
      for (let N = 0, I = E.length; N < I; N++) {
        const b = E[N];
        b.consumedBy === void 0 && g.insert(b);
      }
      m = g.size, x = g.pop();
    }
    ni.reset();
    const _ = Pi.factory(v.segments);
    return new hh(_).getGeom();
  }
}
const xt = new gh(), dh = function(o) {
...
function _h(o) {
  ...
  const s = o.features[0].properties || {}, l = ph.difference(a[0], ...a.slice(1));
  return l.length === 0 ? null : l.length === 1 ? Na(l[0], s) : rl(l, s);
}
var kh = _h;
function fa(o) {
  let a;
...
function Eh(o) {
  var g;
  const a = o.getProperties(), { isMask: s } = a, l = (g = o.getGeometry()) == null ? void 0 : g.getType(), h = s ? 0 : l === "LineString" || l === "MultiLineString" ? 3 : 2;
  return new ju({
    stroke: s ? void 0 : new ms({
      color: "#3170fe",
      lineDash: [h, h],
      width: h,
      lineCap: "butt"
    ...
    image: new Zu({
      src: `/icons/marker_${a.isReverse ? "reverse" : a.isSelected ? "selected" : "unselected"}.svg`,
      anchor: [0.5, 1]
    }),
    zIndex: a.isSelected ? 2 : a.isReverse ? 0 : 1,
    text: a.isSelected && a.tooltip ? new Qu({
      backgroundFill: new ds({ color: "white" }),
      text: a.tooltip,
      offsetY: -40,
      backgroundStroke: new ms({
        color: "white",
        lineJoin: "round",
        width: 3
      }),
...
function xh(o, a = {}, s = {}, l = Eh) {
  ...
  o.addLayer(_);
  const k = new Hu({});
  _.setSource(k), _.setStyle(l), o.on("click", (I) => {
    o.forEachFeatureAtPixel(I.pixel, (b) => {
      const O = b.getId();
      if (O)
        return I.stopPropagation(), v == null || v({ type: "markerClick", id: O }), b;
    });
  }), o.on("pointermove", (I) => {
    const b = o.forEachFeatureAtPixel(I.pixel, (O) => O.getId());
    g !== b && (g && (v == null || v({
      ...
      id: b
    })), o.getTargetElement().style.cursor = b ? "pointer" : x ? "crosshair" : "", g = b);
  });
  function y() {
    return Vu() ?? o.getView().getProjection();
  }
  function E(I) {
    return I.transform(da, y());
  }
  const N = (I) => {
    v == null || v({
      type: "mapClick",
      coordinates: gs(I.coordinate, y())
    });
  };
  return {
    setEventHandler(I) {
      I ? (v = I, o.on("click", N)) : (v = void 0, o.un("click", N));
    },
    flyTo(I, b) {
      o.getView().animate({
        center: mi(I, y()),
    ...
    indicateReverse(I) {
      x = I, o.getTargetElement().style.cursor = I ? "crosshair" : "";
    },
    setReverseMarker(I) {
      m ? I ? m.getGeometry().setCoordinates(
        mi(I, y())
      ) : (k.removeFeature(m), m.dispose(), m = void 0) : I && (m = new Mt(
        new ir(mi(I, y()))
      ), m.setProperties({ isReverse: !0 }), k.addFeature(m));
    },
    setMarkers(I, b) {
      function O(C) {
        var P;
        if (C)
          for (const R of C.features) {
            const q = R.geometry.type === "Polygon" ? new ls(R.geometry.coordinates) : R.geometry.type === "MultiPolygon" ? new hs(R.geometry.coordinates) : null;
            q && k.addFeature(
              new Mt({
      ...
      if (k.clear(), m && k.addFeature(m), O(), b) {
        let C = !1;
        if (b.geometry.type === "GeometryCollection") {
          const P = b.geometry.geometries.map(
            (R) => R.type === "Polygon" ? new ls(R.coordinates) : R.type === "MultiPolygon" ? new hs(R.coordinates) : null
          ).filter((R) => !!R);
          if (P.length > 0)
            k.addFeature(
              new Mt(E(new Uu(P)))
            ...
            for (const R of b.geometry.geometries)
              R.type === "LineString" ? (k.addFeature(
                new Mt(
                  E(new cs(R.coordinates))
                )
              ), C = !0) : R.type === "MultiLineString" && k.addFeature(
                new Mt(
                  E(new fs(R.coordinates))
                )
              ), C = !0;
        }
        if (!C) {
          if (b.geometry.type === "Polygon")
            ...
            k.addFeature(
              new Mt(
                E(new cs(b.geometry.coordinates))
              )
            );
            return;
          } else if (b.geometry.type === "MultiLineString") {
            k.addFeature(
              new Mt(
                E(new fs(b.geometry.coordinates))
              )
            );
            return;
          }
        }
        k.addFeature(new Mt(E(new ir(b.center))));
      }
      for (const C of I ?? []) {
        if (C === b)
          continue;
        const P = new Mt(
          new ir(mi(C.center, y()))
        );
        P.setId(C.id), P.setProperties({
    ...
    setSelectedMarker(I) {
      var C, P, R;
      const b = k.getFeatures(), O = (C = b[0]) != null && C.getProperties().isReverse ? 1 : 0;
      h > -1 && ((P = b[h + O]) == null || P.setProperties({
        isSelected: !1
      })), I > -1 && ((R = b[I + O]) == null || R.setProperties({
        isSelected: !0
      })), h = I;
    },
    getCenterAndZoom() {
      const I = o.getView(), b = I.getCenter(), O = I.getZoom();
      if (!(!b || O === void 0))
        return [O, ...gs(b, y())];
    }
  };
...
class Wh extends Bu {
  constructor(s) {
    ...
    nr(this, vt);
    nr(this, on);
    const { flyTo: h, fullGeometryStyle: g, ...v } = s;
    di(this, vt, new nl({
      target: l,
      props: {
        flyTo: h === void 0 ? !0 : !!h,
      ...
      Et(this, vt).$on(m, (x) => {
        switch (m) {
          ...
          case "pick":
            ...
            break;
          case "queryChange":
            this.dispatchEvent(new bh(x.detail));
            break;
          case "response":
            this.dispatchEvent(
              new Th(
                x.detail.url,
                x.detail.featureCollection
              )
            );
            break;
          case "reverseToggle":
            this.dispatchEvent(new Ch(x.detail));
            break;
        }
      });
    di(this, on, s);
  ...
  setMap(s) {
    ...
    if (super.setMap(s), s) {
      ...
      (l = Et(this, vt)) == null || l.$set({ mapController: v });
    }
  }
  setOptions(s) {
    var v;
    di(this, on, s);
    const { flyTo: l, fullGeometryStyle: h, ...g } = Et(this, on);
    (v = Et(this, vt)) == null || v.$set({
      ...g,
      flyTo: l === void 0 ? !0 : !!l
    });
  }
  setQuery(s, l = !0) {
    var h;
    (h = Et(this, vt)) == null || h.setQuery(s, l);
  }
  clearMap() {
    var s;
    (s = Et(this, vt)) == null || s.clearMap();
  }
  clearList() {
    var s;
    (s = Et(this, vt)) == null || s.clearList();
  }
  focus() {
    var s;
    (s = Et(this, vt)) == null || s.focus();
  }
  blur() {
    var s;
    (s = Et(this, vt)) == null || s.blur();
  }
  // onRemove() {
  //   this.#gc?.$destroy();
  // }
}
vt = new WeakMap(), on = new WeakMap();
class Nh extends jt {
  constructor(s) {
    super("select");
    dt(this, "feature");
...
class Sh extends jt {
  constructor(s) {
    ...
    dt(this, "optionsVisible");
    this.optionsVisible = s;
  }
}
class Lh extends jt {
  constructor(s) {
...
class Th extends jt {
  constructor(s, l) {
    super("response");
    dt(this, "url");
    dt(this, "featureCollection");
    this.url = s, this.featureCollection = l;
  }
}
class Ch extends jt {
  constructor(s) {
...
export {
  Ih as FeaturesListedEvent,
  wh as FeaturesMarkedEvent,
  Wh as GeocodingControl,
  Sh as OptionsVisibilityChangeEvent,
  Lh as PickEvent,
  bh as QueryChangeEvent,
  Th as ResponseEvent,
  Ch as ReverseToggleEvent,
  Nh as SelectEvent,
  xh as createOpenLayersMapController
};
