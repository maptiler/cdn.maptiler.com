...
var Gf = (o, r, a) => r in o ? $f(o, r, { enumerable: !0, configurable: !0, writable: !0, value: a }) : o[r] = a;
var Oi = (o, r, a) => Gf(o, typeof r != "symbol" ? r + "" : r, a);
import * as nn from "leaflet";
...
var Va = Object.prototype.toString, Qu = function(r) {
  var a = Va.call(r), l = a === "[object Arguments]";
  return l || (l = a !== "[object Array]" && r !== null && typeof r == "object" && typeof r.length == "number" && r.length >= 0 && Va.call(r.callee) === "[object Function]"), l;
}, Ti, Wa;
function qf() {
  if (Wa) return Ti;
  Wa = 1;
  var o;
  if (!Object.keys) {
    var r = Object.prototype.hasOwnProperty, a = Object.prototype.toString, l = Qu, c = Object.prototype.propertyIsEnumerable, h = !c.call({ toString: null }, "toString"), v = c.call(function() {
    }, "prototype"), p = [
      "toString",
      "toLocaleString",
      "valueOf",
      ...
      for (var k in window)
        try {
          if (!x["$" + k] && r.call(window, k) && window[k] !== null && typeof window[k] == "object")
            try {
              _(window[k]);
            } catch {
              return !0;
    ...
    o = function(E) {
      var N = E !== null && typeof E == "object", T = a.call(E) === "[object Function]", R = l(E), A = N && a.call(E) === "[object String]", P = [];
      if (!N && !T && !R)
      ...
      if (R && E.length > 0)
        ...
        for (var B in E)
          !(C && B === "prototype") && r.call(E, B) && P.push(String(B));
      if (h)
        for (var Y = m(E), U = 0; U < p.length; ++U)
          !(Y && p[U] === "constructor") && r.call(E, p[U]) && P.push(p[U]);
      return P;
    };
  }
  return Ti = o, Ti;
}
var zf = Array.prototype.slice, Yf = Qu, Ha = Object.keys, kr = Ha ? function(r) {
  return Ha(r);
} : qf(), Za = Object.keys;
kr.shim = function() {
  if (Object.keys) {
    ...
    r || (Object.keys = function(l) {
      return Yf(l) ? Za(zf.call(l)) : Za(l);
    });
  } else
    Object.keys = kr;
  return Object.keys || kr;
};
var Ps = kr, Uf = Error, Xf = EvalError, jf = RangeError, Vf = ReferenceError, Ku = SyntaxError, Rt = TypeError, Wf = URIError, ti = function() {
  ...
  return !0;
}, Ja = typeof Symbol < "u" && Symbol, Hf = ti, As = function() {
  return typeof Ja != "function" || typeof Symbol != "function" || typeof Ja("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : Hf();
}, Li = {
  __proto__: null,
  foo: {}
}, Zf = Object, Jf = function() {
  return { __proto__: Li }.foo === Li.foo && !(Li instanceof Zf);
}, Qf = "Function.prototype.bind called on incompatible ", Kf = Object.prototype.toString, eh = Math.max, th = "[object Function]", Qa = function(r, a) {
  ...
  var a = this;
  if (typeof a != "function" || Kf.apply(a) !== th)
    throw new TypeError(Qf + a);
  for (var l = nh(arguments, 1), c, h = function() {
  ...
  }, v = eh(0, a.length - l.length), p = [], _ = 0; _ < v; _++)
    p[_] = "$" + _;
  if (c = Function("binder", "return function (" + rh(p, ",") + "){ return binder.apply(this,arguments); }")(h), a.prototype) {
    var x = function() {
    };
    x.prototype = a.prototype, c.prototype = new x(), x.prototype = null;
  }
  return c;
}, sh = ih, Ms = Function.prototype.bind || sh, ah = Function.prototype.call, oh = Object.prototype.hasOwnProperty, uh = Ms, el = uh.call(ah, oh), oe, lh = Uf, ch = Xf, fh = jf, hh = Vf, gn = Ku, fn = Rt, gh = Wf, tl = Function, Ri = function(o) {
  try {
    return tl('"use strict"; return (' + o + ").constructor;")();
  } catch {
  }
...
var Ci = function() {
...
}() : Ci, rn = As(), vh = Jf(), Ne = Object.getPrototypeOf || (vh ? function(o) {
  return o.__proto__;
} : null), un = {}, ph = typeof Uint8Array > "u" || !Ne ? oe : Ne(Uint8Array), Yt = {
  __proto__: null,
  "%AggregateError%": typeof AggregateError > "u" ? oe : AggregateError,
  "%Array%": Array,
  "%ArrayBuffer%": typeof ArrayBuffer > "u" ? oe : ArrayBuffer,
  "%ArrayIteratorPrototype%": rn && Ne ? Ne([][Symbol.iterator]()) : oe,
  ...
  "%isFinite%": isFinite,
  "%isNaN%": isNaN,
  "%IteratorPrototype%": rn && Ne ? Ne(Ne([][Symbol.iterator]())) : oe,
  "%JSON%": typeof JSON == "object" ? JSON : oe,
  "%Map%": typeof Map > "u" ? oe : Map,
  "%MapIteratorPrototype%": typeof Map > "u" || !rn || !Ne ? oe : Ne((/* @__PURE__ */ new Map())[Symbol.iterator]()),
  "%Math%": Math,
  "%Number%": Number,
  "%Object%": Object,
  ...
  "%SetIteratorPrototype%": typeof Set > "u" || !rn || !Ne ? oe : Ne((/* @__PURE__ */ new Set())[Symbol.iterator]()),
  "%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? oe : SharedArrayBuffer,
  "%String%": String,
  "%StringIteratorPrototype%": rn && Ne ? Ne(""[Symbol.iterator]()) : oe,
  "%Symbol%": rn ? Symbol : oe,
  "%SyntaxError%": gn,
  "%ThrowTypeError%": yh,
  "%TypedArray%": ph,
...
var dh = function o(r) {
...
}, Kn = Ms, Cr = el, _h = Kn.call(Function.call, Array.prototype.concat), xh = Kn.call(Function.apply, Array.prototype.splice), eo = Kn.call(Function.call, String.prototype.replace), Pr = Kn.call(Function.call, String.prototype.slice), Eh = Kn.call(Function.call, RegExp.prototype.exec), kh = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, Ih = /\\(\\)?/g, Sh = function(r) {
  ...
  var c = [];
  return eo(r, kh, function(h, v, p, _) {
    c[c.length] = p ? eo(_, Ih, "$1") : v || h;
  }), c;
}, Nh = function(r, a) {
  var l = r, c;
  if (Cr(Ka, l) && (c = Ka[l], l = "%" + c[0] + "%"), Cr(Yt, l)) {
    var h = Yt[l];
    if (h === un && (h = dh(l)), typeof h > "u" && !a)
      throw new fn("intrinsic " + r + " exists, but is not available. Please file an issue!");
    return {
      alias: c,
      name: l,
      value: h
  ...
  throw new gn("intrinsic " + r + " does not exist!");
}, ft = function(r, a) {
  ...
  var l = Sh(r), c = l.length > 0 ? l[0] : "", h = Nh("%" + c + "%", a), v = h.name, p = h.value, _ = !1, x = h.alias;
  x && (c = x[0], xh(l, _h([0, 1], x)));
  for (var I = 1, m = !0; I < l.length; I += 1) {
    var k = l[I], E = Pr(k, 0, 1), N = Pr(k, -1);
    if ((E === '"' || E === "'" || E === "`" || N === '"' || N === "'" || N === "`") && E !== N)
      throw new gn("property names with quotes must have matching quotes");
    if ((k === "constructor" || !m) && (_ = !0), c += "." + k, v = "%" + c + "%", Cr(Yt, v))
      p = Yt[v];
    else if (p != null) {
      if (!(k in p)) {
        if (!a)
          throw new fn("base intrinsic for " + r + " exists, but the property is not available.");
        return;
      }
      if (zt && I + 1 >= l.length) {
        var T = zt(p, k);
        m = !!T, m && "get" in T && !("originalValue" in T.get) ? p = T.get : p = p[k];
      } else
        m = Cr(p, k), p = p[k];
      m && !_ && (Yt[v] = p);
    }
...
function Ds() {
  if (to) return Pi;
  to = 1;
  var o = ft, r = o("%Object.defineProperty%", !0) || !1;
  if (r)
    try {
      r({}, "a", { value: 1 });
    } catch {
...
var wh = ft, Ir = wh("%Object.getOwnPropertyDescriptor%", !0);
if (Ir)
  try {
    Ir([], "length");
  } catch {
...
var Fs = Ir, no = Ds(), bh = Ku, sn = Rt, ro = Fs, $s = function(r, a, l) {
  ...
  var c = arguments.length > 3 ? arguments[3] : null, h = arguments.length > 4 ? arguments[4] : null, v = arguments.length > 5 ? arguments[5] : null, p = arguments.length > 6 ? arguments[6] : !1, _ = !!ro && ro(r, a);
  if (no)
    no(r, a, {
...
nl.hasArrayLengthDefineBug = function() {
  if (!es)
    return null;
  try {
    return es([], "length", { value: 1 }).length !== 1;
  } catch {
    return !0;
  }
};
var Gs = nl, Oh = Ps, Th = typeof Symbol == "function" && typeof Symbol("foo") == "symbol", Lh = Object.prototype.toString, Rh = Array.prototype.concat, io = $s, Ch = function(o) {
  return typeof o == "function" && Lh.call(o) === "[object Function]";
}, rl = Gs(), Ph = function(o, r, a, l) {
  if (r in o) {
    if (l === !0) {
      if (o[r] === a)
        return;
...
il.supportsDescriptors = !!rl;
var Xt = il, sl = { exports: {} }, Ah = ft, so = $s, Mh = Gs(), ao = Fs, oo = Rt, Dh = Ah("%Math.floor%"), Fh = function(r, a) {
  if (typeof r != "function")
    throw new oo("`fn` is not a function");
  if (typeof a != "number" || a < 0 || a > 4294967295 || Dh(a) !== a)
    throw new oo("`length` must be a positive 32-bit integer");
...
(function(o) {
  var r = Ms, a = ft, l = Fh, c = Rt, h = a("%Function.prototype.apply%"), v = a("%Function.prototype.call%"), p = a("%Reflect.apply%", !0) || r.call(v, h), _ = Ds(), x = a("%Math.max%");
  o.exports = function(k) {
    if (typeof k != "function")
      throw new c("a function is required");
    var E = p(r, v, arguments);
    return l(
      E,
      1 + x(0, k.length - (arguments.length - 1)),
      !0
    );
  };
  var I = function() {
...
var _n = sl.exports, al = ft, ol = _n, $h = ol(al("String.prototype.indexOf")), We = function(r, a) {
  var l = al(r, !!a);
  return typeof l == "function" && $h(r, ".prototype.") > -1 ? ol(l) : l;
}, Gh = Ps, ul = ti(), ll = We, uo = Object, Bh = ll("Array.prototype.push"), lo = ll("Object.prototype.propertyIsEnumerable"), qh = ul ? Object.getOwnPropertySymbols : null, cl = function(r, a) {
  if (r == null)
  ...
  for (var c = 1; c < arguments.length; ++c) {
    var h = uo(arguments[c]), v = Gh(h), p = ul && (Object.getOwnPropertySymbols || qh);
    if (p)
  ...
  return !Object.assign || zh() || Yh() ? Ai : Object.assign;
}, Uh = Xt, Xh = fl, jh = function() {
  var r = Xh();
  return Uh(
    Object,
    { assign: r },
...
}, Vh = Xt, Wh = _n, Hh = cl, hl = fl, Zh = jh, Jh = Wh.apply(hl()), gl = function(r, a) {
...
Hn.functionsHaveConfigurableNames = function() {
  if (!Hn() || !Yn)
    return !1;
  var r = Yn(function() {
  }, "name");
...
Hn.boundFunctionsHaveNames = function() {
  return Hn() && typeof Kh == "function" && (function() {
  }).bind().name !== "";
};
var eg = Hn, co = $s, tg = Gs(), ng = eg.functionsHaveConfigurableNames(), rg = Rt, ig = function(r, a) {
  if (typeof r != "function")
...
}, sg = ig, ag = Rt, og = Object, yl = sg(function() {
...
}, "get flags", !0), ug = yl, lg = Xt.supportsDescriptors, cg = Object.getOwnPropertyDescriptor, vl = function() {
  ...
  return ug;
}, fg = Xt.supportsDescriptors, hg = vl, gg = Object.getOwnPropertyDescriptor, yg = Object.defineProperty, vg = TypeError, fo = Object.getPrototypeOf, pg = /a/, mg = function() {
  if (!fg || !fo)
    throw new vg("RegExp.prototype.flags requires a true ES5 environment that supports property descriptors");
  var r = hg(), a = fo(pg), l = gg(a, "flags");
  return (!l || l.get !== r) && yg(a, "flags", {
    configurable: !0,
    enumerable: !1,
    get: r
  }), r;
}, dg = Xt, _g = _n, xg = yl, pl = vl, Eg = mg, ml = _g(pl());
dg(ml, {
  getPolyfill: pl,
  implementation: xg,
  shim: Eg
});
var kg = ml, Sr = { exports: {} }, Ig = ti, jt = function() {
  return Ig() && !!Symbol.toStringTag;
}, Sg = jt(), Ng = We, ts = Ng("Object.prototype.toString"), ni = function(r) {
  return Sg && r && typeof r == "object" && Symbol.toStringTag in r ? !1 : ts(r) === "[object Arguments]";
}, dl = function(r) {
  return ni(r) ? !0 : r !== null && typeof r == "object" && typeof r.length == "number" && r.length >= 0 && ts(r) !== "[object Array]" && ts(r.callee) === "[object Function]";
}, wg = function() {
  return ni(arguments);
}();
ni.isLegacyArguments = dl;
var _l = wg ? ni : dl;
const bg = {}, Og = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: bg
}, Symbol.toStringTag, { value: "Module" })), Tg = /* @__PURE__ */ Bf(Og);
var Bs = typeof Map == "function" && Map.prototype, Mi = Object.getOwnPropertyDescriptor && Bs ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null, Ar = Bs && Mi && typeof Mi.get == "function" ? Mi.get : null, ho = Bs && Map.prototype.forEach, qs = typeof Set == "function" && Set.prototype, Di = Object.getOwnPropertyDescriptor && qs ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null, Mr = qs && Di && typeof Di.get == "function" ? Di.get : null, go = qs && Set.prototype.forEach, Lg = typeof WeakMap == "function" && WeakMap.prototype, Un = Lg ? WeakMap.prototype.has : null, Rg = typeof WeakSet == "function" && WeakSet.prototype, Xn = Rg ? WeakSet.prototype.has : null, Cg = typeof WeakRef == "function" && WeakRef.prototype, yo = Cg ? WeakRef.prototype.deref : null, Pg = Boolean.prototype.valueOf, Ag = Object.prototype.toString, Mg = Function.prototype.toString, Dg = String.prototype.match, zs = String.prototype.slice, bt = String.prototype.replace, Fg = String.prototype.toUpperCase, vo = String.prototype.toLowerCase, xl = RegExp.prototype.test, po = Array.prototype.concat, at = Array.prototype.join, $g = Array.prototype.slice, mo = Math.floor, ns = typeof BigInt == "function" ? BigInt.prototype.valueOf : null, Fi = Object.getOwnPropertySymbols, rs = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? Symbol.prototype.toString : null, yn = typeof Symbol == "function" && typeof Symbol.iterator == "object", Le = typeof Symbol == "function" && Symbol.toStringTag && (typeof Symbol.toStringTag === yn || !0) ? Symbol.toStringTag : null, El = Object.prototype.propertyIsEnumerable, _o = (typeof Reflect == "function" ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(o) {
  return o.__proto__;
} : null);
function xo(o, r) {
  if (o === 1 / 0 || o === -1 / 0 || o !== o || o && o > -1e3 && o < 1e3 || xl.call(/e/, r))
    return r;
  var a = /[0-9](?=(?:[0-9]{3})+(?![0-9]))/g;
  if (typeof o == "number") {
    var l = o < 0 ? -mo(-o) : mo(o);
    if (l !== o) {
      var c = String(l), h = zs.call(r, c.length + 1);
      return bt.call(c, a, "$&_") + "." + bt.call(bt.call(h, /([0-9]{3})/g, "$&_"), /_$/, "");
    }
  }
  return bt.call(r, a, "$&_");
}
var is = Tg, Eo = is.custom, ko = Il(Eo) ? Eo : null, Gg = function o(r, a, l, c) {
  var h = a || {};
  ...
  if (typeof r == "function" && !Io(r)) {
    var E = Wg(r), N = gr(r, k);
    return "[Function" + (E ? ": " + E : " (anonymous)") + "]" + (N.length > 0 ? " { " + at.call(N, ", ") + " }" : "");
  }
  if (Il(r)) {
    var T = yn ? bt.call(String(r), /^(Symbol\(.*\))_[^)]*$/, "$1") : rs.call(r);
    return typeof r == "object" && !yn ? Dn(T) : T;
  }
  if (ey(r)) {
    for (var R = "<" + vo.call(String(r.nodeName)), A = r.attributes || [], P = 0; P < A.length; P++)
      R += " " + A[P].name + "=" + kl(Bg(A[P].value), "double", h);
    return R += ">", r.childNodes && r.childNodes.length && (R += "..."), R += "</" + vo.call(String(r.nodeName)) + ">", R;
  }
  if (ss(r)) {
    if (r.length === 0)
      return "[]";
    var C = gr(r, k);
    return m && !ny(C) ? "[" + as(C, m) + "]" : "[ " + at.call(C, ", ") + " ]";
  }
  if (zg(r)) {
    var F = gr(r, k);
    return !("cause" in Error.prototype) && "cause" in r && !El.call(r, "cause") ? "{ [" + String(r) + "] " + at.call(po.call("[cause]: " + k(r.cause), F), ", ") + " }" : F.length === 0 ? "[" + String(r) + "]" : "{ [" + String(r) + "] " + at.call(F, ", ") + " }";
  }
  if (typeof r == "object" && v) {
    if (ko && typeof r[ko] == "function" && is)
      return is(r, { depth: I - l });
    if (v !== "symbol" && typeof r.inspect == "function")
      return r.inspect();
  }
  if (Hg(r)) {
    var M = [];
    return ho && ho.call(r, function(ae, q) {
      M.push(k(q, r, !0) + " => " + k(ae, r));
    }), So("Map", Ar.call(r), M, m);
  }
  if (Qg(r)) {
    var B = [];
    return go && go.call(r, function(ae) {
      B.push(k(ae, r));
    }), So("Set", Mr.call(r), B, m);
  }
  if (Zg(r))
    return $i("WeakMap");
  if (Kg(r))
  ...
  if (Jg(r))
    return $i("WeakRef");
  if (Ug(r))
    return Dn(k(Number(r)));
  if (jg(r))
    return Dn(k(ns.call(r)));
  if (Xg(r))
    return Dn(Pg.call(r));
  if (Yg(r))
    return Dn(k(String(r)));
  if (typeof window < "u" && r === window)
    return "{ [object Window] }";
  if (typeof globalThis < "u" && r === globalThis || typeof Wn < "u" && r === Wn)
    return "{ [object globalThis] }";
  if (!qg(r) && !Io(r)) {
    var Y = gr(r, k), U = _o ? _o(r) === Object.prototype : r instanceof Object || r.constructor === Object, X = r instanceof Object ? "" : "null prototype", ie = !U && Le && Object(r) === r && Le in r ? zs.call(Ct(r), 8, -1) : X ? "Object" : "", ee = U || typeof r.constructor != "function" ? "" : r.constructor.name ? r.constructor.name + " " : "", te = ee + (ie || X ? "[" + at.call(po.call([], ie || [], X || []), ": ") + "] " : "");
    return Y.length === 0 ? te + "{}" : m ? te + "{" + as(Y, m) + "}" : te + "{ " + at.call(Y, ", ") + " }";
  }
  return String(r);
};
function kl(o, r, a) {
...
function Nl(o, r) {
  if (o.length > r.maxStringLength) {
    ...
    return Nl(zs.call(o, 0, r.maxStringLength), r) + l;
  }
  var c = bt.call(bt.call(o, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, ty);
  return kl(c, "single", r);
}
function ty(o) {
...
function gr(o, r) {
  ...
  var h = typeof Fi == "function" ? Fi(o) : [], v;
  if (yn) {
    v = {};
  ...
  for (var _ in o)
    Nt(o, _) && (a && String(Number(_)) === _ && _ < o.length || yn && v["$" + _] instanceof Symbol || (xl.call(/[^\w$]/, _) ? l.push(r(_, o) + ": " + r(o[_], o)) : l.push(_ + ": " + r(o[_], o))));
  if (typeof Fi == "function")
    for (var x = 0; x < h.length; x++)
      El.call(o, h[x]) && l.push("[" + r(h[x]) + "]: " + r(o[h[x]], o));
  return l;
}
var wl = ft, xn = We, iy = Gg, sy = Rt, yr = wl("%WeakMap%", !0), vr = wl("%Map%", !0), ay = xn("WeakMap.prototype.get", !0), oy = xn("WeakMap.prototype.set", !0), uy = xn("WeakMap.prototype.has", !0), ly = xn("Map.prototype.get", !0), cy = xn("Map.prototype.set", !0), fy = xn("Map.prototype.has", !0), Ys = function(o, r) {
  ...
  var r, a, l, c = {
    ...
    get: function(h) {
      if (yr && h && (typeof h == "object" || typeof h == "function")) {
        if (r)
          return ay(r, h);
      } else if (vr) {
        if (a)
    ...
    set: function(h, v) {
      yr && h && (typeof h == "object" || typeof h == "function") ? (r || (r = new yr()), oy(r, h, v)) : vr ? (a || (a = new vr()), cy(a, h, v)) : (l || (l = { key: {}, next: null }), gy(l, h, v));
    }
  };
  return c;
}, vy = el, Fn = bl(), dt = Rt, Us = {
  assert: function(o, r) {
    if (!o || typeof o != "object" && typeof o != "function")
      throw new dt("`O` is not an object");
    if (typeof r != "string")
      throw new dt("`slot` must be a string");
    if (Fn.assert(o), !Us.has(o, r))
  ...
  set: function(o, r, a) {
    ...
    if (typeof r != "string")
      throw new dt("`slot` must be a string");
    var l = Fn.get(o);
    l || (l = {}, Fn.set(o, l)), l["$" + r] = a;
  }
};
Object.freeze && Object.freeze(Us);
var py = Us, $n = py, my = SyntaxError, No = typeof StopIteration == "object" ? StopIteration : null, dy = function(r) {
  if (!No)
    throw new my("this environment lacks StopIteration");
  $n.set(r, "[[Done]]", !1);
  var a = {
    next: function() {
      var c = $n.get(this, "[[Iterator]]"), h = $n.get(c, "[[Done]]");
      try {
        return {
          done: h,
  ...
  return $n.set(a, "[[Iterator]]", r), a;
}, _y = {}.toString, Ol = Array.isArray || function(o) {
...
}, ky = Object.prototype.toString, Iy = "[object String]", Sy = jt(), Tl = function(r) {
  return typeof r == "string" ? !0 : typeof r != "object" ? !1 : Sy ? Ey(r) : ky.call(r) === Iy;
}, Xs = typeof Map == "function" && Map.prototype ? Map : null, Ny = typeof Set == "function" && Set.prototype ? Set : null, Dr;
Xs || (Dr = function(r) {
  return !1;
});
var Ll = Xs ? Map.prototype.has : null, wo = Ny ? Set.prototype.has : null;
!Dr && !Ll && (Dr = function(r) {
  return !1;
});
var Rl = Dr || function(r) {
  ...
  return !1;
}, wy = typeof Map == "function" && Map.prototype ? Map : null, js = typeof Set == "function" && Set.prototype ? Set : null, Fr;
js || (Fr = function(r) {
  return !1;
});
var bo = wy ? Map.prototype.has : null, Cl = js ? Set.prototype.has : null;
!Fr && !Cl && (Fr = function(r) {
  return !1;
});
var Pl = Fr || function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    if (Cl.call(r), bo)
...
if (As() || ti()) {
  var Gi = Symbol.iterator;
  Sr.exports = function(r) {
    if (r != null && typeof r[Gi] < "u")
      return r[Gi]();
    if (Oo(r))
      return Array.prototype[Gi].call(r);
  };
} else {
  var by = Ol, Oy = Tl, Lo = ft, Ty = Lo("%Map%", !0), Ly = Lo("%Set%", !0), Qe = We, Ro = Qe("Array.prototype.push"), Co = Qe("String.prototype.charCodeAt"), Ry = Qe("String.prototype.slice"), Cy = function(r, a) {
    var l = r.length;
    if (a + 1 >= l)
      return a + 1;
    var c = Co(r, a);
  ...
  if (!Ty && !Ly)
    ...
    var Py = Rl, Ay = Pl, Ao = Qe("Map.prototype.forEach", !0), Mo = Qe("Set.prototype.forEach", !0);
    if (typeof process > "u" || !process.versions || !process.versions.node)
      var Do = Qe("Map.prototype.iterator", !0), Fo = Qe("Set.prototype.iterator", !0);
    var $o = Qe("Map.prototype.@@iterator", !0) || Qe("Map.prototype._es6-shim iterator_", !0), Go = Qe("Set.prototype.@@iterator", !0) || Qe("Set.prototype._es6-shim iterator_", !0), My = function(r) {
      if (Py(r)) {
        if (Do)
          return To(Do(r));
        if ($o)
...
var Dy = Sr.exports, Bo = function(o) {
  return o !== o;
}, Al = function(r, a) {
  return r === 0 && a === 0 ? 1 / r === 1 / a : !!(r === a || Bo(r) && Bo(a));
}, Fy = Al, Ml = function() {
  return typeof Object.is == "function" ? Object.is : Fy;
}, $y = Ml, Gy = Xt, By = function() {
  var r = $y();
  return Gy(Object, { is: r }, {
    is: function() {
      return Object.is !== r;
    }
  }), r;
}, qy = Xt, zy = _n, Yy = Al, Dl = Ml, Uy = By, Fl = zy(Dl(), Object);
qy(Fl, {
  getPolyfill: Dl,
  implementation: Yy,
  shim: Uy
});
var Xy = Fl, jy = _n, $l = We, Vy = ft, os = Vy("%ArrayBuffer%", !0), Nr = $l("ArrayBuffer.prototype.byteLength", !0), Wy = $l("Object.prototype.toString"), qo = !!os && !Nr && new os(0).slice, zo = !!qo && jy(qo), Gl = Nr || zo ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    return Nr ? Nr(r) : zo(r, 0), !0;
  } catch {
    return !1;
  }
} : os ? function(r) {
...
}, us = We, Bl = jt(), ql, zl, ls, cs;
if (Bl) {
  ql = us("Object.prototype.hasOwnProperty"), zl = us("RegExp.prototype.exec"), ls = {};
  var qi = function() {
    throw ls;
  };
  cs = {
    toString: qi,
    valueOf: qi
  }, typeof Symbol.toPrimitive == "symbol" && (cs[Symbol.toPrimitive] = qi);
}
var tv = us("Object.prototype.toString"), nv = Object.getOwnPropertyDescriptor, rv = "[object RegExp]", iv = Bl ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  var a = nv(r, "lastIndex"), l = a && ql(a, "value");
  if (!l)
    return !1;
  try {
    zl(r, cs);
...
}, sv = We, Yo = sv("SharedArrayBuffer.prototype.byteLength", !0), av = Yo ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    return Yo(r), !0;
...
}, Yl = We, gv = Yl("Boolean.prototype.toString"), yv = Yl("Object.prototype.toString"), vv = function(r) {
  try {
    return gv(r), !0;
  } catch {
    return !1;
...
}, fs = { exports: {} }, _v = Object.prototype.toString, xv = As();
if (xv) {
...
var Sv = fs.exports, hs = { exports: {} }, Uo = typeof BigInt < "u" && BigInt, Nv = function() {
...
var Tv = hs.exports, Lv = Tl, Rv = hv, Cv = dv, Pv = Sv, Av = Tv, Mv = function(r) {
  ...
  if (Av(r))
    return "BigInt";
}, $r = typeof WeakMap == "function" && WeakMap.prototype ? WeakMap : null, Xo = typeof WeakSet == "function" && WeakSet.prototype ? WeakSet : null, Gr;
$r || (Gr = function(r) {
  return !1;
});
var gs = $r ? $r.prototype.has : null, zi = Xo ? Xo.prototype.has : null;
!Gr && !gs && (Gr = function(r) {
  return !1;
});
var Dv = Gr || function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    if (gs.call(r, gs), zi)
  ...
  return !1;
}, ys = { exports: {} }, Fv = ft, Ul = We, $v = Fv("%WeakSet%", !0), Yi = Ul("WeakSet.prototype.has", !0);
if (Yi) {
  var Ui = Ul("WeakMap.prototype.has", !0);
...
var Gv = ys.exports, Bv = Rl, qv = Pl, zv = Dv, Yv = Gv, Uv = function(r) {
  if (r && typeof r == "object") {
    if (Bv(r))
      return "Map";
    if (qv(r))
  ...
  return !1;
}, Xl = Function.prototype.toString, cn = typeof Reflect == "object" && Reflect !== null && Reflect.apply, vs, wr;
if (typeof cn == "function" && typeof Object.defineProperty == "function")
  ...
  cn = null;
var Xv = /^\s*class\b/, ps = function(r) {
  try {
    var a = Xl.call(r);
    return Xv.test(a);
  } catch {
  ...
  try {
    return ps(r) ? !1 : (Xl.call(r), !0);
  } catch {
    return !1;
  }
}, br = Object.prototype.toString, jv = "[object Object]", Vv = "[object Function]", Wv = "[object GeneratorFunction]", Hv = "[object HTMLAllCollection]", Zv = "[object HTML document.all class]", Jv = "[object HTMLCollection]", Qv = typeof Symbol == "function" && !!Symbol.toStringTag, Kv = !(0 in [,]), ms = function() {
  return !1;
};
if (typeof document == "object") {
  var ep = document.all;
  br.call(ep) === br.call(document.all) && (ms = function(r) {
...
var tp = cn ? function(r) {
  ...
  if (ps(r))
    return !1;
  var a = br.call(r);
  return a !== Vv && a !== Wv && !/^\[object HTML/.test(a) ? !1 : Xi(r);
}, np = tp, rp = Object.prototype.toString, jl = Object.prototype.hasOwnProperty, ip = function(r, a, l) {
  for (var c = 0, h = r.length; c < h; c++)
    jl.call(r, c) && (l == null ? a(r[c], c, r) : a.call(l, r[c], c, r));
}, sp = function(r, a, l) {
  for (var c = 0, h = r.length; c < h; c++)
  ...
  "BigInt64Array",
  "BigUint64Array"
], ji = lp, cp = typeof globalThis > "u" ? Wn : globalThis, fp = function() {
  for (var r = [], a = 0; a < ji.length; a++)
    typeof cp[ji[a]] == "function" && (r[r.length] = ji[a]);
  return r;
}, Br = up, hp = fp, jo = _n, Vs = We, Or = Fs, gp = Vs("Object.prototype.toString"), Vl = jt(), Vo = typeof globalThis > "u" ? Wn : globalThis, ds = hp(), Ws = Vs("String.prototype.slice"), Vi = Object.getPrototypeOf, yp = Vs("Array.prototype.indexOf", !0) || function(r, a) {
  for (var l = 0; l < r.length; l += 1)
    if (r[l] === a)
      return l;
  return -1;
}, qr = { __proto__: null };
Vl && Or && Vi ? Br(ds, function(o) {
  var r = new Vo[o]();
  if (Symbol.toStringTag in r) {
    var a = Vi(r), l = Or(a, Symbol.toStringTag);
    if (!l) {
      var c = Vi(a);
  ...
  var r = new Vo[o](), a = r.slice || r.set;
  a && (qr["$" + o] = jo(a));
});
var vp = function(r) {
  var a = !1;
  ...
  if (!Vl) {
    var a = Ws(gp(r), 8, -1);
    return yp(ds, a) > -1 ? a : a !== "Object" ? !1 : pp(r);
  }
  return Or ? vp(r) : null;
}, dp = We, Wo = dp("ArrayBuffer.prototype.byteLength", !0), _p = Gl, xp = function(r) {
  return _p(r) ? Wo ? Wo(r) : r.byteLength : NaN;
}, Wl = Qh, ht = We, Ho = kg, Ep = ft, vn = Dy, kp = bl, Zo = Xy, Jo = _l, Qo = Ol, Ko = Gl, eu = ev, tu = iv, nu = av, ru = Ps, iu = Mv, su = Uv, au = mp, ou = xp, uu = ht("SharedArrayBuffer.prototype.byteLength", !0), lu = ht("Date.prototype.getTime"), Wi = Object.getPrototypeOf, cu = ht("Object.prototype.toString"), zr = Ep("%Set%", !0), _s = ht("Map.prototype.has", !0), Yr = ht("Map.prototype.get", !0), fu = ht("Map.prototype.size", !0), Ur = ht("Set.prototype.add", !0), Hl = ht("Set.prototype.delete", !0), Xr = ht("Set.prototype.has", !0), Tr = ht("Set.prototype.size", !0);
function hu(o, r, a, l) {
  for (var c = vn(o), h; (h = c.next()) && !h.done; )
    if (et(r, h.value, a, l))
      return Hl(o, h.value), !0;
  return !1;
}
function Zl(o) {
  if (typeof o > "u")
...
function Ip(o, r, a, l, c, h) {
  ...
  if (v != null)
    return v;
  var p = Yr(r, v), _ = Wl({}, c, { strict: !1 });
  return typeof p > "u" && !_s(r, v) || !et(l, p, _, h) ? !1 : !_s(o, v) && et(l, p, _, h);
}
function Sp(o, r, a) {
  var l = Zl(a);
  return l ?? (Xr(r, l) && !Xr(o, l));
}
function gu(o, r, a, l, c, h) {
  for (var v = vn(o), p, _; (p = v.next()) && !p.done; )
...
function et(o, r, a, l) {
  var c = a || {};
  if (c.strict ? Zo(o, r) : o === r)
    return !0;
  var h = iu(o), v = iu(r);
  if (h !== v)
    return !1;
  if (!o || !r || typeof o != "object" && typeof r != "object")
    return c.strict ? Zo(o, r) : o == r;
...
function Np(o, r, a, l) {
  if (Tr(o) !== Tr(r))
    return !1;
  for (var c = vn(o), h = vn(r), v, p, _; (v = c.next()) && !v.done; )
  ...
  if (_) {
    for (; (p = h.next()) && !p.done; )
      if (p.value && typeof p.value == "object") {
        if (!hu(_, p.value, a.strict, l))
          return !1;
      } else if (!a.strict && !Xr(o, p.value) && !hu(_, p.value, a.strict, l))
        return !1;
    return Tr(_) === 0;
  }
  return !0;
...
function wp(o, r, a, l) {
  if (fu(o) !== fu(r))
    return !1;
  for (var c = vn(o), h = vn(r), v, p, _, x, I, m; (v = c.next()) && !v.done; )
    if (x = v.value[0], I = v.value[1], x && typeof x == "object")
      _ || (_ = new zr()), Ur(_, x);
    else if (m = Yr(r, x), typeof m > "u" && !_s(r, x) || !et(I, m, a, l)) {
  ...
  if (_) {
    for (; (p = h.next()) && !p.done; )
      if (x = p.value[0], m = p.value[1], x && typeof x == "object") {
        if (!gu(_, o, x, m, a, l))
          return !1;
      } else if (!a.strict && (!o.has(x) || !et(Yr(o, x), m, a, l)) && !gu(_, o, x, m, Wl({}, a, { strict: !1 }), l))
        return !1;
    return Tr(_) === 0;
  }
  return !0;
...
function bp(o, r, a, l) {
  var c, h;
  if (typeof o != typeof r || o == null || r == null || cu(o) !== cu(r) || Jo(o) !== Jo(r))
    return !1;
  var v = Qo(o), p = Qo(r);
  if (v !== p)
    return !1;
  ...
  if (_ !== x || (_ || x) && (o.name !== r.name || o.message !== r.message))
    return !1;
  var I = tu(o), m = tu(r);
  if (I !== m || (I || m) && (o.source !== r.source || Ho(o) !== Ho(r)))
    return !1;
  var k = eu(o), E = eu(r);
  if (k !== E || (k || E) && lu(o) !== lu(r) || a.strict && Wi && Wi(o) !== Wi(r))
    return !1;
  var N = au(o), T = au(r);
  if (N !== T)
    return !1;
  ...
  if (P !== C)
    return !1;
  if (P || C)
    return ou(o) !== ou(r) ? !1 : typeof Uint8Array == "function" && et(new Uint8Array(o), new Uint8Array(r), a, l);
  var F = nu(o), M = nu(r);
  if (F !== M)
    return !1;
  if (F || M)
    return uu(o) !== uu(r) ? !1 : typeof Uint8Array == "function" && et(new Uint8Array(o), new Uint8Array(r), a, l);
  if (typeof o != typeof r)
    return !1;
  var B = ru(o), Y = ru(r);
  if (B.length !== Y.length)
    return !1;
  for (B.sort(), Y.sort(), c = B.length - 1; c >= 0; c--)
    if (B[c] != Y[c])
      return !1;
  for (c = B.length - 1; c >= 0; c--)
    if (h = B[c], !et(o[h], r[h], a, l))
      return !1;
  var U = su(o), X = su(r);
...
function Cp(o, r, a = {}) {
  switch (o) {
    ...
    case "Polygon":
      return En(r).geometry;
    case "MultiPoint":
      return Kl(r).geometry;
...
ge(Fp, "round");
function Hs(o, r = "kilometers") {
  const a = Jl[r];
  if (!a)
    throw new Error(r + " units is invalid");
  return o * a;
}
ge(Hs, "radiansToLength");
...
ge(Gp, "bearingToAzimuth");
function ec(o) {
  return o % (2 * Math.PI) * 180 / Math.PI;
}
ge(ec, "radiansToDegrees");
function Bp(o) {
  return o % 360 * Math.PI / 180;
}
ge(Bp, "degreesToRadians");
...
function Es(o, r, a, l, c) {
  if (o) {
    l("" + r + (a ? "└── " : "├── ") + c(o) + `
`);
    var h = r + (a ? "    " : "│   ");
    o.left && Es(o.left, h, !1, l, c), o.right && Es(o.right, h, !0, l, c);
  }
}
var Js = (
  /** @class */
  function() {
    ...
    return o.prototype.insert = function(r, a) {
      return this._size++, this._root = Hi(r, a, this._root, this._comparator);
      ...
      if (l && Ss(r, a, 0, c - 1, h), this._root === null)
        this._root = ks(r, a, 0, c), this._size = c;
      else {
        var v = Zp(this.toList(), Wp(r, a), h);
        c = this._size + c, this._root = Is({ head: v }, 0, c);
      }
      return this;
      ...
      var a = [];
      return Es(this._root, "", !0, function(l) {
        return a.push(l);
      }, r), a.join("");
    }, o.prototype.update = function(r, a, l) {
      var c = this._comparator, h = pu(r, this._root, c), v = h.left, p = h.right;
      c(r, a) < 0 ? p = Hi(a, l, p, c) : v = Hi(a, l, v, c), this._root = Vp(v, p, c);
    }, o.prototype.split = function(r) {
      return pu(r, this._root, this._comparator);
...
function ks(o, r, a, l) {
  ...
  if (c > 0) {
    ...
    return _.left = ks(o, r, a, h), _.right = ks(o, r, h + 1, l), _;
  }
  return null;
}
function Wp(o, r) {
...
function Is(o, r, a) {
  var l = a - r;
  if (l > 0) {
    var c = r + Math.floor(l / 2), h = Is(o, r, c), v = o.head;
    return v.left = h, o.head = o.head.next, v.right = Is(o, c + 1, a), v;
  }
  return null;
}
function Zp(o, r, a) {
...
function Ss(o, r, a, l, c) {
  if (!(a >= l)) {
    ...
    Ss(o, r, a, p, c), Ss(o, r, p + 1, l, c);
  }
}
const xt = 11102230246251565e-32, Te = 134217729, Jp = (3 + 8 * xt) * xt;
function Zi(o, r, a, l, c) {
  let h, v, p, _, x = r[0], I = l[0], m = 0, k = 0;
  I > x == I > -x ? (h = x, x = r[++m]) : (h = I, I = l[++k]);
  let E = 0;
  if (m < o && k < a)
    for (I > x == I > -x ? (v = x + h, p = h - (v - x), x = r[++m]) : (v = I + h, p = h - (v - I), I = l[++k]), h = v, p !== 0 && (c[E++] = p); m < o && k < a; )
      I > x == I > -x ? (v = h + x, _ = v - h, p = h - (v - _) + (x - _), x = r[++m]) : (v = h + I, _ = v - h, p = h - (v - _) + (I - _), I = l[++k]), h = v, p !== 0 && (c[E++] = p);
  for (; m < o; )
    v = h + x, _ = v - h, p = h - (v - _) + (x - _), x = r[++m], h = v, p !== 0 && (c[E++] = p);
  for (; k < a; )
    v = h + I, _ = v - h, p = h - (v - _) + (I - _), I = l[++k], h = v, p !== 0 && (c[E++] = p);
  return (h !== 0 || E === 0) && (c[E++] = h), E;
}
function Qp(o, r) {
  let a = r[0];
...
const Kp = (3 + 16 * xt) * xt, em = (2 + 12 * xt) * xt, tm = (9 + 64 * xt) * xt * xt, an = er(4), mu = er(8), du = er(12), _u = er(16), Pe = er(4);
function nm(o, r, a, l, c, h, v) {
  let p, _, x, I, m, k, E, N, T, R, A, P, C, F, M, B, Y, U;
  const X = o - c, ie = a - c, ee = r - h, te = l - h;
  F = X * te, k = Te * X, E = k - (k - X), N = X - E, k = Te * te, T = k - (k - te), R = te - T, M = N * R - (F - E * T - N * T - E * R), B = ee * ie, k = Te * ee, E = k - (k - ee), N = ee - E, k = Te * ie, T = k - (k - ie), R = ie - T, Y = N * R - (B - E * T - N * T - E * R), A = M - Y, m = M - A, an[0] = M - (A + m) + (m - Y), P = F + A, m = P - F, C = F - (P - m) + (A - m), A = C - B, m = C - A, an[1] = C - (A + m) + (m - B), U = P + A, m = U - P, an[2] = P - (U - m) + (A - m), an[3] = U;
  let ae = Qp(4, an), q = em * v;
  ...
  F = p * te, k = Te * p, E = k - (k - p), N = p - E, k = Te * te, T = k - (k - te), R = te - T, M = N * R - (F - E * T - N * T - E * R), B = _ * ie, k = Te * _, E = k - (k - _), N = _ - E, k = Te * ie, T = k - (k - ie), R = ie - T, Y = N * R - (B - E * T - N * T - E * R), A = M - Y, m = M - A, Pe[0] = M - (A + m) + (m - Y), P = F + A, m = P - F, C = F - (P - m) + (A - m), A = C - B, m = C - A, Pe[1] = C - (A + m) + (m - B), U = P + A, m = U - P, Pe[2] = P - (U - m) + (A - m), Pe[3] = U;
  const ne = Zi(4, an, 4, Pe, mu);
  F = X * I, k = Te * X, E = k - (k - X), N = X - E, k = Te * I, T = k - (k - I), R = I - T, M = N * R - (F - E * T - N * T - E * R), B = ee * x, k = Te * ee, E = k - (k - ee), N = ee - E, k = Te * x, T = k - (k - x), R = x - T, Y = N * R - (B - E * T - N * T - E * R), A = M - Y, m = M - A, Pe[0] = M - (A + m) + (m - Y), P = F + A, m = P - F, C = F - (P - m) + (A - m), A = C - B, m = C - A, Pe[1] = C - (A + m) + (m - B), U = P + A, m = U - P, Pe[2] = P - (U - m) + (A - m), Pe[3] = U;
  const ue = Zi(ne, mu, 4, Pe, du);
  F = p * I, k = Te * p, E = k - (k - p), N = p - E, k = Te * I, T = k - (k - I), R = I - T, M = N * R - (F - E * T - N * T - E * R), B = _ * x, k = Te * _, E = k - (k - _), N = _ - E, k = Te * x, T = k - (k - x), R = x - T, Y = N * R - (B - E * T - N * T - E * R), A = M - Y, m = M - A, Pe[0] = M - (A + m) + (m - Y), P = F + A, m = P - F, C = F - (P - m) + (A - m), A = C - B, m = C - A, Pe[1] = C - (A + m) + (m - B), U = P + A, m = U - P, Pe[2] = P - (U - m) + (A - m), Pe[3] = U;
  const ye = Zi(ue, du, 4, Pe, _u);
  return _u[ye - 1];
}
...
const Gn = (o, r) => o.ll.x <= r.x && r.x <= o.ur.x && o.ll.y <= r.y && r.y <= o.ur.y, Ns = (o, r) => {
...
class sm {
  ...
  reset() {
    this.xRounder = new Eu(), this.yRounder = new Eu();
  }
  round(r, a) {
    return {
...
class Eu {
  ...
  round(r) {
    ...
    if (l !== null && xu(a.key, l.key) === 0)
      return this.tree.remove(r), l.key;
    const c = this.tree.next(a);
    return c !== null && xu(a.key, c.key) === 0 ? (this.tree.remove(r), c.key) : r;
  }
}
const Zn = new sm(), Lr = (o, r) => o.x * r.y - o.y * r.x, tc = (o, r) => o.x * r.x + o.y * r.y, ku = (o, r, a) => {
  const l = rm(o.x, o.y, r.x, r.y, a.x, a.y);
  return l > 0 ? -1 : l < 0 ? 1 : 0;
}, Vr = (o) => Math.sqrt(tc(o, o)), am = (o, r, a) => {
  const l = {
    x: r.x - o.x,
    y: r.y - o.y
  }, c = {
  ...
  if (r.x === 0) return Su(a, l, o.x);
  if (l.x === 0) return Su(o, r, a.x);
  if (r.y === 0) return Iu(a, l, o.y);
  if (l.y === 0) return Iu(o, r, a.y);
  const c = Lr(r, l);
  if (c == 0) return null;
  const h = {
    x: a.x - o.x,
    y: a.y - o.y
  }, v = Lr(h, r) / c, p = Lr(h, l) / c, _ = o.x + p * r.x, x = a.x + v * l.x, I = o.y + p * r.y, m = a.y + v * l.y, k = (_ + x) / 2, E = (I + m) / 2;
  return {
    x: k,
    y: E
  };
...
class Tt {
  ...
  static compare(r, a) {
    ...
    if (l < c) {
      ...
      if (m < 0) return 1;
      if (m > 0) return -1;
      const k = a.comparePoint(r.rightSE.point);
      return k !== 0 ? k : -1;
    }
    if (l > c) {
      if (p < _ && p < I) return -1;
      ...
      if (m !== 0) return m;
      const k = r.comparePoint(a.rightSE.point);
   ...
   */
  getIntersection(r) {
    const a = this.bbox(), l = r.bbox(), c = Ns(a, l);
    if (c === null) return null;
    const h = this.leftSE.point, v = this.rightSE.point, p = r.leftSE.point, _ = r.rightSE.point, x = Gn(a, p) && this.comparePoint(p) === 0, I = Gn(l, h) && r.comparePoint(h) === 0, m = Gn(a, _) && this.comparePoint(_) === 0, k = Gn(l, v) && r.comparePoint(v) === 0;
    if (I && x)
      return k && !m ? v : !k && m ? _ : null;
    if (I)
      return m && h.x === _.x && h.y === _.y ? null : h;
    if (x)
      return k && v.x === p.x && v.y === p.y ? null : p;
    if (k && m) return null;
    if (k) return v;
    if (m) return _;
    const E = um(h, this.vector(), p, r.vector());
    return E === null || !Gn(c, E) ? null : Zn.round(E.x, E.y);
  }
  /**
...
class cm {
  constructor(r, a) {
    if (!Array.isArray(r))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new Nu(r[0], this, !0), this.bbox = {
      ll: {
...
class Wr {
  ...
  static factory(r) {
    ...
    for (let l = 0, c = r.length; l < c; l++) {
      ...
      for (; v = p, p = _, x.push(p), p.point !== I; )
        for (; ; ) {
          const k = p.getAvailableLinkedEvents();
          if (k.length === 0) {
            const T = x[0].point, R = x[x.length - 1].point;
            throw new Error(`Unable to complete output ring starting at [${T.x}, ${T.y}]. Last matching segment found ends at [${R.x}, ${R.y}].`);
          }
          if (k.length === 1) {
            _ = k[0].otherSE;
            break;
          ...
          if (E !== null) {
            const T = m.splice(E)[0], R = x.splice(T.index);
            R.unshift(R[0].otherSE), a.push(new Wr(R.reverse()));
            continue;
          }
          m.push({
            index: x.length,
          ...
          const N = p.getLeftmostComparator(v);
          _ = k.sort(N)[0].otherSE;
          break;
        }
      a.push(new Wr(x));
    }
  ...
  getGeom() {
    ...
    for (let x = 1, I = this.events.length - 1; x < I; x++) {
      const m = this.events[x].point, k = this.events[x + 1].point;
      ku(m, r, k) !== 0 && (a.push(m), r = m);
    }
    if (a.length === 1) return null;
    const l = a[0], c = a[1];
    ku(l, r, c) === 0 && a.shift(), a.push(a[0]);
...
class fm {
  ...
  _composePolys(r) {
    ...
    for (let l = 0, c = r.length; l < c; l++) {
      const h = r[l];
      if (!h.poly)
        if (h.isExteriorRing()) a.push(new bu(h));
        else {
          const v = h.enclosingRing();
          v.poly || a.push(new bu(v)), v.poly.addInterior(h);
        }
    }
    return a;
  }
...
class hm {
  constructor(r) {
    ...
    this.queue = r, this.tree = new Js(a), this.segments = [];
  }
  process(r) {
    const a = r.segment, l = [];
    if (r.consumedBy)
...
const Ou = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, gm = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6;
class ym {
  run(r, a, l) {
    Ke.type = r, Zn.reset();
    const c = [new wu(a, !0)];
    for (let m = 0, k = l.length; m < k; m++)
      c.push(new wu(l[m], !1));
    if (Ke.numMultiPolys = c.length, Ke.type === "difference") {
      const m = c[0];
      let k = 1;
      for (; k < c.length; )
        Ns(c[k].bbox, m.bbox) !== null ? k++ : c.splice(k, 1);
    }
    if (Ke.type === "intersection")
      for (let m = 0, k = c.length; m < k; m++) {
        const E = c[m];
        for (let N = m + 1, T = c.length; N < T; N++)
          if (Ns(E.bbox, c[N].bbox) === null) return [];
      }
    const h = new Js(je.compare);
    for (let m = 0, k = c.length; m < k; m++) {
      const E = c[m].getSweepEvents();
      for (let N = 0, T = E.length; N < T; N++)
        if (h.insert(E[N]), h.size > Ou)
    ...
    for (; _; ) {
      ...
      for (let E = 0, N = k.length; E < N; E++) {
        const T = k[E];
        T.consumedBy === void 0 && h.insert(T);
      }
      p = h.size, _ = h.pop();
    }
    Zn.reset();
...
function kn(o, r, a) {
  if (o !== null)
    for (var l, c, h, v, p, _, x, I = 0, m = 0, k, E = o.type, N = E === "FeatureCollection", T = E === "Feature", R = N ? o.features.length : 1, A = 0; A < R; A++) {
      x = N ? o.features[A].geometry : T ? o.geometry : o, k = x ? x.type === "GeometryCollection" : !1, p = k ? x.geometries.length : 1;
      for (var P = 0; P < p; P++) {
        var C = 0, F = 0;
        if (v = k ? x.geometries[P] : x, v !== null) {
          _ = v.coordinates;
          var M = v.type;
          switch (I = a && (M === "Polygon" || M === "MultiPolygon") ? 1 : 0, M) {
            ...
            case "MultiLineString":
              for (l = 0; l < _.length; l++) {
                ...
                M === "MultiLineString" && C++, M === "Polygon" && F++;
              }
              M === "Polygon" && C++;
              break;
            case "MultiPolygon":
              for (l = 0; l < _.length; l++) {
                for (F = 0, c = 0; c < _[l].length; c++) {
...
be(Im, "coordAll");
function Vt(o, r) {
  var a, l, c, h, v, p, _, x, I, m, k = 0, E = o.type === "FeatureCollection", N = o.type === "Feature", T = E ? o.features.length : 1;
  for (a = 0; a < T; a++) {
    for (p = E ? o.features[a].geometry : N ? o.geometry : o, x = E ? o.features[a].properties : N ? o.properties : {}, I = E ? o.features[a].bbox : N ? o.bbox : void 0, m = E ? o.features[a].id : N ? o.id : void 0, _ = p ? p.type === "GeometryCollection" : !1, v = _ ? p.geometries.length : 1, c = 0; c < v; c++) {
...
function Tm(o, r) {
  ...
  switch (p.type) {
    ...
    case "LineString":
      return h < 0 && (h = _.length + h), ot(_[h], v, r);
    case "Polygon":
      return c < 0 && (c = _.length + c), h < 0 && (h = _[c].length + h), ot(_[c][h], v, r);
    case "MultiLineString":
      return l < 0 && (l = _.length + l), h < 0 && (h = _[l].length + h), ot(_[l][h], v, r);
    case "MultiPolygon":
      return l < 0 && (l = _.length + l), c < 0 && (c = _[l].length + c), h < 0 && (h = _[l][c].length - h), ot(
        _[l][c][h],
        v,
        r
      );
...
function ac(o, r = {}) {
  ...
  const l = nc.union(a[0], ...a.slice(1));
  return l.length === 0 ? null : l.length === 1 ? En(l[0], r.properties) : ri(l, r.properties);
}
Rm(ac, "union");
var Cm = ac;
function Jn() {
...
const ln = [], Ru = [];
let hn = [];
const Cu = [], $m = /* @__PURE__ */ Promise.resolve();
let ws = !1;
function Gm() {
  ws || (ws = !0, $m.then(cc));
}
...
function cc() {
  ...
  do {
    try {
      ...
      throw ln.length = 0, on = 0, r;
    }
    for (jn(null), ln.length = 0, on = 0; Ru.length; ) Ru.pop()();
    for (let r = 0; r < hn.length; r += 1) {
      const a = hn[r];
      Ji.has(a) || (Ji.add(a), a());
    }
    hn.length = 0;
...
function Bm(o) {
  if (o.fragment !== null) {
    ...
    const r = o.dirty;
    o.dirty = [-1], o.fragment && o.fragment.p(o.ctx, r), o.after_update.forEach(bs);
  }
}
function qm(o) {
  const r = [], a = [];
  hn.forEach((l) => o.indexOf(l) === -1 ? r.push(l) : a.push(l)), a.forEach((l) => l()), hn = r;
}
...
function Um(o, r, a) {
  ...
  l && l.m(r, a), bs(() => {
    const h = o.$$.on_mount.map(oc).filter(uc);
...
function jm(o, r) {
  o.$$.dirty[0] === -1 && (ln.push(o), Gm(), o.$$.dirty.fill(0)), o.$$.dirty[r / 31 | 0] |= 1 << r % 31;
}
function Vm(o, r, a, l, c, h, v = null, p = [-1]) {
  ...
  v && v(x.root);
  let I = !1;
  if (x.ctx = a ? a(o, r.props || {}, (m, k, ...E) => {
    const N = E.length ? E[0] : k;
    return x.ctx && c(x.ctx[m], x.ctx[m] = N) && (!x.skip_bound && x.bound[m] && x.bound[m](N), I && jm(o, m)), k;
  }) : [], x.update(), I = !0, ai(x.before_update), x.fragment = l ? l(x.ctx) : !1, r.target) {
    if (r.hydrate) {
      const m = Fm(r.target);
      x.fragment && x.fragment.l(m), m.forEach(lc);
    } else
      x.fragment && x.fragment.c();
    r.intro && Ym(o.$$.fragment), Um(o, r.target, r.anchor), cc();
  }
  jn(_);
}
class Wm {
...
function Zm(o) {
  ...
  return {
    c() {
      r = Lu("svg"), a = Lu("path"), It(a, "stroke-width", "4"), It(a, "d", "M 5,33.103579 C 5,17.607779 18.457,5 35,5 C 51.543,5 65,17.607779 65,33.103579 C 65,56.388679 40.4668,76.048179 36.6112,79.137779 C 36.3714,79.329879 36.2116,79.457979 36.1427,79.518879 C 35.8203,79.800879 35.4102,79.942779 35,79.942779 C 34.5899,79.942779 34.1797,79.800879 33.8575,79.518879 C 33.7886,79.457979 33.6289,79.330079 33.3893,79.138079 C 29.5346,76.049279 5,56.389379 5,33.103579 Z M 35.0001,49.386379 C 43.1917,49.386379 49.8323,42.646079 49.8323,34.331379 C 49.8323,26.016779 43.1917,19.276479 35.0001,19.276479 C 26.8085,19.276479 20.1679,26.016779 20.1679,34.331379 C 20.1679,42.646079 26.8085,49.386379 35.0001,49.386379 Z"), It(a, "class", "svelte-gzo3ar"), It(r, "width", l = /*displayIn*/
      o[0] === "list" ? 20 : void 0), It(r, "viewBox", "0 0 70 85"), It(r, "fill", "none"), It(r, "class", "svelte-gzo3ar"), pr(
        r,
        "in-map",
        /*displayIn*/
        o[0] !== "list"
...
function hc(o, r = {}) {
  const a = fc(o), l = (a[0] + a[2]) / 2, c = (a[1] + a[3]) / 2;
...
(function(o, r) {
  (function(a, l) {
    ...
    function N(s, e, t) {
      return N = typeof Reflect < "u" && Reflect.get ? Reflect.get : function(n, i, u) {
        var f = function(y, d) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    function R(s, e) {
      if (s) {
        if (typeof s == "string") return A(s, e);
        var t = Object.prototype.toString.call(s).slice(8, -1);
        return t === "Object" && s.constructor && (t = s.constructor.name), t === "Map" || t === "Set" ? Array.from(s) : t === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? A(s, e) : void 0;
      }
    }
    function A(s, e) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    }(), gt = new ArrayBuffer(8), Tc = new Float64Array(gt), na = new Int32Array(gt), O = function() {
      function s() {
        a(this, s), s.constructor_.apply(this, arguments);
      }
    ...
    O.DimensionalComparator = Lc, O.NULL_ORDINATE = j.NaN, O.X = 0, O.Y = 1, O.Z = 2, O.M = 3;
    var pe = function() {
      function s() {
        a(this, s), s.constructor_.apply(this, arguments);
      }
      return c(s, [{ key: "getArea", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          if (typeof arguments[0] == "number" && typeof arguments[1] == "number") {
            var d = arguments[0], w = arguments[1];
            return !this.isNull() && !(d > this._maxx || d < this._minx || w > this._maxy || w < this._miny);
          }
        }
        ...
        if (arguments.length === 4) {
          var i = arguments[0], u = arguments[1], f = arguments[2], g = arguments[3], y = Math.min(f.x, g.x), d = Math.max(f.x, g.x), w = Math.min(i.x, u.x), b = Math.max(i.x, u.x);
          return !(w > d) && !(b < y) && (y = Math.min(f.y, g.y), d = Math.max(f.y, g.y), w = Math.min(i.y, u.y), b = Math.max(i.y, u.y), !(w > d) && !(b < y));
        }
      } }]), s;
    }(), W = function() {
      function s() {
    ...
    var tt = function() {
      ...
      return c(n, [{ key: "contains", value: function(i) {
        ...
        return new Rc(this.map);
      } }, { key: e, value: function() {
        return this.map;
      } }]), n;
    }(ra, Symbol.iterator), Rc = function() {
      function s(e) {
    ...
    var ia = function(s) {
      ...
      return c(t, [{ key: "add", value: function(n) {
        ...
        if (n < 0 || n >= this.size()) throw new sa();
        return this.array[n];
      } }, { key: "push", value: function(n) {
        return this.array.push(n), n;
      } }, { key: "pop", value: function() {
        if (this.array.length === 0) throw new ia();
    ...
    var Nn = function() {
      ...
      return c(s, [{ key: "le", value: function(e) {
        ...
        for (var f = i + 1, g = new Nn(), y = s.MAX_PRINT_DIGITS - 1, d = 0; d <= y; d++) {
          e && d === f && g.append(".");
          var w = Math.trunc(n._hi);
          if (w < 0) break;
          var b = !1, L = 0;
          w > 9 ? (b = !0, L = "9") : L = "0" + w, g.append(L), n = n.subtract(s.valueOf(w)).multiply(s.TEN), b && n.selfAdd(s.TEN);
          var $ = !0, D = s.magnitude(n._hi);
          if (D < 0 && Math.abs(D) >= y - d && ($ = !1), !$) break;
        }
        ...
        if (arguments.length === 1) {
          ...
          var n = arguments[0], i = arguments[1], u = null, f = null, g = null, y = null, d = null, w = null, b = null, L = null;
          return d = this._hi / n, L = (u = (w = s.SPLIT * d) - (u = w - d)) * (g = (L = s.SPLIT * n) - (g = L - n)) - (b = d * n) + u * (y = n - g) + (f = d - u) * g + f * y, L = d + (w = (this._hi - b - L + this._lo - d * i) / n), this._hi = L, this._lo = d - L + w, this;
        }
        ...
        if (arguments[0] instanceof s) {
          ...
          var w = d = f + (g = (this._hi - y - d + this._lo - f * e._lo) / e._hi), b = f - d + g;
          return new s(w, b);
        }
        if (typeof arguments[0] == "number") {
          var L = arguments[0];
        ...
        if (arguments.length === 1) {
          ...
          var d = arguments[0], w = arguments[1], b = null, L = null, $ = null, D = null, V = null, H = null, K = null;
          D = this._hi + d, L = this._lo + w, V = D - (H = D - this._hi), $ = L - (K = L - this._lo);
          var he = (b = D + (H = (V = d - H + (this._hi - V)) + L)) + (H = ($ = w - K + (this._lo - $)) + (H + (D - b))), de = H + (b - he);
        ...
        if (arguments.length === 1) {
          ...
          var n = arguments[0], i = arguments[1], u = null, f = null, g = null, y = null, d = null, w = null;
          u = (d = s.SPLIT * this._hi) - this._hi, w = s.SPLIT * n, u = d - u, f = this._hi - u, g = w - n;
          var b = (d = this._hi * n) + (w = u * (g = w - g) - d + u * (y = n - g) + f * g + f * y + (this._hi * i + this._lo * n)), L = w + (u = d - b);
        ...
        for (var f = new s(), g = 0, y = 0, d = 0, w = !1; !(t >= n); ) {
          var b = e.charAt(t);
          if (t++, ui.isDigit(b)) {
            var L = b - "0";
        ...
        for (var n = new Nn(), i = 0; i < t; i++) n.append(e);
        return n.toString();
      } }]), s;
    }();
    ...
    var Q = function() {
      ...
      return c(s, null, [{ key: "index", value: function(e, t, n) {
        ...
        if (arguments[0] instanceof Array) {
          ...
          var d = e[g], w = e[y];
          if (d.equals2D(n) || w.equals2D(n) || d.equals2D(w)) return !1;
          var b = s.index(d, n, w), L = null;
          return L = b === 0 ? d.x > w.x : b > 0, L;
        }
        if (re(arguments[0], le)) {
          var $ = arguments[0], D = $.size() - 1;
          if (D < 3) throw new M("Ring has fewer than 4 points, so orientation cannot be determined");
          for (var V = $.getCoordinate(0), H = 0, K = 1; K <= D; K++) {
            var he = $.getCoordinate(K);
            he.y > V.y && (V = he, H = K);
          }
          var de = null, Oe = H;
          do
            (Oe -= 1) < 0 && (Oe = D), de = $.getCoordinate(Oe);
          while (de.equals2D(V) && Oe !== H);
          var Ge = null, Je = H;
          do
            Je = (Je + 1) % D, Ge = $.getCoordinate(Je);
          while (Ge.equals2D(V) && Je !== H);
          if (de.equals2D(V) || Ge.equals2D(V) || de.equals2D(Ge)) return !1;
          var mt = s.index(de, V, Ge);
          return mt === 0 ? de.x > Ge.x : mt > 0;
        }
      } }]), s;
    }();
    ...
    var Pc = function() {
      ...
      return c(s, [{ key: "getCoordinate", value: function() {
        ...
        var i = G.LEFT;
        return n[t].y < n[t + 1].y && (i = G.RIGHT), i;
      ...
      return c(n, [{ key: "interfaces_", get: function() {
        ...
        if (i < 0 || i >= this.size()) throw new sa();
        return this.array[i];
      } }, { key: "isEmpty", value: function() {
        return this.array.length === 0;
    ...
    }(At, Symbol.iterator), Mc = function() {
      function s(e) {
        a(this, s), this.arrayList = e, this.position = 0;
      }
      return c(s, [{ key: "next", value: function() {
        if (this.position === this.arrayList.size()) throw new tr();
      ...
      return c(s, [{ key: "clearVisitedEdges", value: function() {
        ...
        t.getNode(), t.getLabel(), t.setEdgeDepths(G.RIGHT, e), this.copySymDepths(t), this.computeDepths(t);
        ...
        for (var e = this._dirEdgeList.iterator(); e.hasNext(); ) {
          var t = e.next();
          t.getDepth(G.RIGHT) >= 1 && t.getDepth(G.LEFT) <= 0 && !t.isInteriorAreaEdge() && t.setInResult(!0);
        }
      } }, { key: "computeDepths", value: function(e) {
        var t = new oi(), n = new Ac(), i = e.getNode();
        ...
        var t = e.getSym();
        t.setDepth(G.LEFT, e.getDepth(G.RIGHT)), t.setDepth(G.RIGHT, e.getDepth(G.LEFT));
        ...
        this._finder = null, this._dirEdgeList = new Z(), this._nodes = new Z(), this._rightMostCoord = null, this._env = null, this._finder = new Pc();
      } }]), s;
    }(), ci = function() {
      function s() {
        a(this, s);
      ...
      return c(s, null, [{ key: "intersection", value: function(e, t, n, i) {
        var u = e.x < t.x ? e.x : t.x, f = e.y < t.y ? e.y : t.y, g = e.x > t.x ? e.x : t.x, y = e.y > t.y ? e.y : t.y, d = n.x < i.x ? n.x : i.x, w = n.y < i.y ? n.y : i.y, b = n.x > i.x ? n.x : i.x, L = n.y > i.y ? n.y : i.y, $ = ((u > d ? u : d) + (g < b ? g : b)) / 2, D = ((f > w ? f : w) + (y < L ? y : L)) / 2, V = e.x - $, H = e.y - D, K = t.x - $, he = t.y - D, de = n.x - $, Oe = n.y - D, Ge = i.x - $, Je = i.y - D, mt = H - he, qt = K - V, An = V * he - K * H, Mn = Oe - Je, tn = Ge - de, Xa = de * Je - Ge * Oe, ja = mt * tn - Mn * qt, wi = (qt * Xa - tn * An) / ja, bi = (Mn * An - mt * Xa) / ja;
        return j.isNaN(wi) || j.isInfinite(wi) || j.isNaN(bi) || j.isInfinite(bi) ? null : new O(wi + $, bi + D);
      } }]), s;
    }(), Be = function() {
      function s() {
        a(this, s);
...
` }[e];
    ...
    var nt = function() {
      ...
      return c(s, null, [{ key: "segmentToSegment", value: function(e, t, n, i) {
        ...
        return u ? wn.min(s.pointToSegment(e, n, i), s.pointToSegment(t, n, i), s.pointToSegment(n, e, t), s.pointToSegment(i, e, t)) : 0;
      ...
      return c(s, null, [{ key: "ofLine", value: function(e) {
        ...
        for (var u = i.x, f = i.y, g = 1; g < t; g++) {
          e.getCoordinate(g, i);
          var y = i.x, d = i.y, w = y - u, b = d - f;
          n += Math.sqrt(w * w + b * b), u = y, f = d;
        }
        return n;
      } }]), s;
    }(), oa = function s() {
      ...
      return c(s, null, [{ key: "copyCoord", value: function(e, t, n, i) {
        ...
        if (arguments.length === 2) {
          ...
          if (d <= 0) return null;
          for (var w = f.copy(), b = y ? f.size() - 1 : f.size(), L = 0; L < b; L++) for (var $ = 0; $ < f.getDimension(); $++) f.setOrdinate(L, $, w.getOrdinate((g + L) % b, $));
          if (y) for (var D = 0; D < f.getDimension(); D++) f.setOrdinate(b, D, f.getOrdinate(0, D));
        }
    ...
    var ir = function() {
      ...
      return c(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        return N(v(t.prototype), "equalsExact", this).apply(this, arguments);
        ...
        if (arguments.length === 2) {
          var y = arguments[0], d = arguments[1], w = y;
          return d.compare(this._points, w._points);
        }
      } }, { key: "apply", value: function() {
        if (re(arguments[0], rr)) for (var n = arguments[0], i = 0; i < this._points.size(); i++) n.filter(this._points.getCoordinate(i));
        else if (re(arguments[0], sr)) {
          var u = arguments[0];
      ...
      return c(s, null, [{ key: "ofRing", value: function() {
        ...
        if (re(arguments[0], le)) {
          ...
          if (d < 3) return 0;
          var w = new O(), b = new O(), L = new O();
          y.getCoordinate(0, b), y.getCoordinate(1, L);
          var $ = b.x;
          L.x -= $;
          for (var D = 0, V = 1; V < d - 1; V++) w.y = b.y, b.x = L.x, b.y = L.y, y.getCoordinate(V + 1, L), L.x -= $, D += b.x * (w.y - L.y);
          return D / 2;
        }
      } }]), s;
    }(), Dt = function() {
      ...
      return c(s, null, [{ key: "sort", value: function() {
        ...
        if (arguments.length === 1) t.sort(function($, D) {
          return $.compareTo(D);
        });
        else if (arguments.length === 2) t.sort(function($, D) {
          return e[1].compare($, D);
        });
        else if (arguments.length === 3) {
      ...
      return c(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        var n = 0;
        n += la.ofRing(this._shell.getCoordinateSequence());
        for (var i = 0; i < this._holes.length; i++) n -= la.ofRing(this._holes[i].getCoordinateSequence());
        return n;
      } }, { key: "copyInternal", value: function() {
        ...
        for (var y = n.getX(0), d = n.getY(0), w = 1; w <= 4; w++) {
          var b = n.getX(w), L = n.getY(w);
          if (b !== y == (L !== d)) return !1;
          y = b, d = L;
        }
        return !0;
        ...
        if (arguments.length === 2) {
          var f = arguments[0], g = arguments[1], y = f, d = this._shell, w = y._shell, b = d.compareToSameClass(w, g);
          if (b !== 0) return b;
          for (var L = this.getNumInteriorRing(), $ = y.getNumInteriorRing(), D = 0; D < L && D < $; ) {
      ...
      return c(s, [{ key: "next", value: function() {
        if (this.position === this.array.length) throw new tr();
      ...
      return c(t, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        if (arguments.length === 1) {
          var n = arguments[0], i = new fa(Dt.asList(this._geometries)), u = new fa(Dt.asList(n._geometries));
          return this.compare(i, u);
        }
        if (arguments.length === 2) {
          for (var f = arguments[0], g = arguments[1], y = f, d = this.getNumGeometries(), w = y.getNumGeometries(), b = 0; b < d && b < w; ) {
            var L = this.getGeometryN(b), $ = y.getGeometryN(b), D = L.compareToSameClass($, g);
            if (D !== 0) return D;
            b++;
          }
          return b < d ? 1 : b < w ? -1 : 0;
        }
      } }, { key: "apply", value: function() {
        if (re(arguments[0], rr)) for (var n = arguments[0], i = 0; i < this._geometries.length; i++) this._geometries[i].apply(n);
        else if (re(arguments[0], sr)) {
          var u = arguments[0];
          ...
          var d = arguments[0];
          d.filter(this);
          for (var w = 0; w < this._geometries.length; w++) this._geometries[w].apply(d);
        }
      } }, { key: "getBoundary", value: function() {
      ...
      return c(t, [{ key: "copyInternal", value: function() {
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof W) {
          var n = arguments[0], i = arguments[1];
          return !!this.isEquivalentClass(n) && N(v(t.prototype), "equalsExact", this).call(this, n, i);
        }
        return N(v(t.prototype), "equalsExact", this).apply(this, arguments);
      } }, { key: "getCoordinate", value: function() {
        ...
        return N(v(t.prototype), "getCoordinate", this).apply(this, arguments);
      } }, { key: "getBoundaryDimension", value: function() {
        return z.FALSE;
      } }, { key: "getTypeCode", value: function() {
      ...
      return c(t, [{ key: "copyInternal", value: function() {
        ...
        return !!this.isEmpty() || N(v(t.prototype), "isClosed", this).call(this);
      } }, { key: "reverseInternal", value: function() {
        var n = this._points.copy();
        ...
        if (!this.isEmpty() && !N(v(t.prototype), "isClosed", this).call(this)) throw new M("Points of LinearRing do not form a closed linestring");
        ...
        var n = arguments[0], i = arguments[1];
        bn.constructor_.call(this, n, i), this.validateConstruction();
      } }]), t;
    }(bn);
    On.MINIMUM_VALID_SIZE = 4;
    var Ft = function(s) {
      h(t, s);
      var e = E(t);
      function t() {
    ...
    var gi = function(s) {
      ...
      return c(t, [{ key: "getCoordinate", value: function(n) {
        ...
        return N(v(t.prototype), "addAll", this).apply(this, arguments);
      } }, { key: "clone", value: function() {
        for (var n = N(v(t.prototype), "clone", this).call(this), i = 0; i < this.size(); i++) n.add(i, this.get(i).clone());
        return n;
      } }, { key: "toCoordinateArray", value: function() {
        ...
        if (arguments.length === 1) {
          var n = arguments[0];
          return N(v(t.prototype), "add", this).call(this, n);
        }
        if (arguments.length === 2) {
          ...
          if (arguments[0] instanceof O && typeof arguments[1] == "boolean") {
            ...
            N(v(t.prototype), "add", this).call(this, f);
          } else if (arguments[0] instanceof Object && typeof arguments[1] == "boolean") {
            var d = arguments[0], w = arguments[1];
            return this.add(d, w), !0;
          }
        } else if (arguments.length === 3) {
          if (typeof arguments[2] == "boolean" && arguments[0] instanceof Array && typeof arguments[1] == "boolean") {
            var b = arguments[0], L = arguments[1], $ = arguments[2];
            if ($) for (var D = 0; D < b.length; D++) this.add(b[D], L);
          ...
          if (typeof arguments[2] == "boolean" && Number.isInteger(arguments[0]) && arguments[1] instanceof O) {
            ...
            if (!he) {
              ...
              if (de > 0) {
                ...
                if (H < de) {
                  var Ge = this.get(H);
                  if (Ge.equals2D(K)) return null;
                }
              }
            }
            N(v(t.prototype), "add", this).call(this, H, K);
          }
        } else if (arguments.length === 4) {
          var Je = arguments[0], mt = arguments[1], qt = arguments[2], An = arguments[3], Mn = 1;
          qt > An && (Mn = -1);
          for (var tn = qt; tn !== An; tn += Mn) this.add(Je[tn], mt);
          return !0;
        }
    ...
    Tn.coordArrayType = new Array(0).fill(null);
    var Ee = function() {
      function s() {
        a(this, s);
      }
      return c(s, null, [{ key: "isRing", value: function(e) {
        ...
        Be.arraycopy(e, n, i, 0, e.length - n), Be.arraycopy(e, 0, i, e.length - n, n), Be.arraycopy(i, 0, e, 0, e.length);
      } }, { key: "equals", value: function() {
        if (arguments.length === 2) {
          var e = arguments[0], t = arguments[1];
          if (e === t) return !0;
        ...
        for (var n = new Tn(), i = 0; i < e.length; i++) t.intersects(e[i]) && n.add(e[i], !0);
        ...
        return s.hasRepeatedPoints(e) ? new Tn(e, !1).toCoordinateArray() : e;
      } }, { key: "reverse", value: function(e) {
        ...
        t = wn.clamp(t, 0, e.length);
        var i = (n = wn.clamp(n, -1, e.length)) - t + 1;
    ...
    Ee.ForwardComparator = Bc, Ee.BidirectionalComparator = qc, Ee.coordArrayType = new Array(0).fill(null);
    var ur = function() {
      function s(e) {
        a(this, s), this.str = e;
      }
      ...
      return c(s, [{ key: "getM", value: function(e) {
        ...
        return or.create(this.getDimension(), this.getMeasures());
      } }, { key: "getDimension", value: function() {
        ...
        if (this._coordinates.length > 0) {
          var e = new ur(17 * this._coordinates.length);
        ...
        if (this._dimension = 3, this._measures = 0, this._coordinates = null, arguments.length === 1) {
          ...
          if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            ...
            for (var w = 0; w < y; w++) this._coordinates[w] = or.create(d);
          }
        } else if (arguments.length === 3) {
      ...
      return c(s, [{ key: "readResolve", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          if (arguments.length === 2) {
            var n = arguments[0], i = arguments[1];
            return i > 3 && (i = 3), i < 2 && (i = 2), new Ln(n, i);
          }
          if (arguments.length === 3) {
            var u = arguments[0], f = arguments[1], g = arguments[2], y = f - g;
            return g > 1 && (g = 1), y > 3 && (y = 3), y < 2 && (y = 2), new Ln(u, y + g, g);
          }
        }
      } }, { key: "interfaces_", get: function() {
        return [aa, X];
    ...
    Wt.nameToTypeMap = new zc(), He.Type = Wt, He.FIXED = new Wt("FIXED"), He.FLOATING = new Wt("FLOATING"), He.FLOATING_SINGLE = new Wt("FLOATING SINGLE"), He.maximumPreciseValue = 9007199254740992;
    var pi = function(s) {
      h(t, s);
      var e = E(t);
      function t() {
      ...
      return c(s, [{ key: "createEmpty", value: function(e) {
        ...
        if (e.size() > 1) {
          if (y instanceof ar) return this.createMultiPolygon(s.toPolygonArray(e));
          if (y instanceof bn) return this.createMultiLineString(s.toLineStringArray(e));
    ...
    }(), mi = "XY", Yc = "XYZ", Uc = "XYM", Xc = "XYZM", ga = { POINT: "Point", LINE_STRING: "LineString", LINEAR_RING: "LinearRing", POLYGON: "Polygon", MULTI_POINT: "MultiPoint", MULTI_LINE_STRING: "MultiLineString", MULTI_POLYGON: "MultiPolygon", GEOMETRY_COLLECTION: "GeometryCollection", CIRCLE: "Circle" }, ya = "EMPTY", lr = 1, vt = 2, kt = 3, va = 4, Zt = 5, jc = 6;
    for (var Vc in ga) ga[Vc].toUpperCase();
    var Wc = function() {
      function s(e) {
...
`;
        ...
        else if (this.isNumeric_(t) || t == "-") e = va, i = this.readNumber_();
        else if (this.isAlpha_(t)) e = lr, i = this.readText_();
        else {
      ...
      return c(s, [{ key: "consume_", value: function() {
        ...
        if (this.isTokenType(lr)) {
          var n = t.value;
          n === "Z" ? e = Yc : n === "M" ? e = Uc : n === "ZM" && (e = Xc), e !== mi && this.consume_();
        }
        return e;
        ...
        var e = this.isTokenType(lr) && this.token_.value == ya;
    ...
    function ma(s) {
      var e = [];
      e.push("(" + Rn(s.getExteriorRing()) + ")");
      for (var t = 0, n = s.getNumInteriorRing(); t < n; ++t) e.push("(" + Rn(s.getInteriorRingN(t)) + ")");
      return e.join(", ");
    }
    var Zc = { Point: pa, LineString: Rn, LinearRing: Rn, Polygon: ma, MultiPoint: function(s) {
      for (var e = [], t = 0, n = s.getNumGeometries(); t < n; ++t) e.push("(" + pa(s.getGeometryN(t)) + ")");
      return e.join(", ");
    }, MultiLineString: function(s) {
      for (var e = [], t = 0, n = s.getNumGeometries(); t < n; ++t) e.push("(" + Rn(s.getGeometryN(t)) + ")");
      return e.join(", ");
    }, MultiPolygon: function(s) {
      for (var e = [], t = 0, n = s.getNumGeometries(); t < n; ++t) e.push("(" + ma(s.getGeometryN(t)) + ")");
      return e.join(", ");
    }, GeometryCollection: function(s) {
      for (var e = [], t = 0, n = s.getNumGeometries(); t < n; ++t) e.push(da(s.getGeometryN(t)));
      return e.join(", ");
    } };
    function da(s) {
      var e = s.getGeometryType(), t = Zc[e];
      e = e.toUpperCase();
      var n = function(i) {
        var u = "";
      ...
      return n.length > 0 && (e += " " + n), s.isEmpty() ? e + " " + ya : e + " (" + t(s) + ")";
    }
    var Jc = function() {
      function s(e) {
      ...
      return c(s, [{ key: "read", value: function(e) {
        var t = new Wc(e);
        return new Hc(t, this.geometryFactory).parse();
      } }, { key: "write", value: function(e) {
        return da(e);
      } }]), s;
    }(), di = function() {
      function s(e) {
        a(this, s), this.parser = new Jc(e);
      }
    ...
    var Gt = function(s) {
      ...
      return c(t, [{ key: "isInSegmentEnvelopes", value: function(n) {
        ...
        if (arguments.length !== 3) return N(v(t.prototype), "computeIntersection", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1], u = arguments[2];
        ...
        Be.out.println("DD in env = " + d + "  --------------------- " + y), g.distance(y) > 1e-4 && Be.out.println("Distance = " + g.distance(y));
        ...
        var g = pe.intersects(n, i, u), y = pe.intersects(n, i, f), d = pe.intersects(u, f, n), w = pe.intersects(u, f, i);
        return g && y ? (this._intPt[0] = u, this._intPt[1] = f, me.COLLINEAR_INTERSECTION) : d && w ? (this._intPt[0] = n, this._intPt[1] = i, me.COLLINEAR_INTERSECTION) : g && d ? (this._intPt[0] = u, this._intPt[1] = n, !u.equals(n) || y || w ? me.COLLINEAR_INTERSECTION : me.POINT_INTERSECTION) : g && w ? (this._intPt[0] = u, this._intPt[1] = i, !u.equals(i) || y || d ? me.COLLINEAR_INTERSECTION : me.POINT_INTERSECTION) : y && d ? (this._intPt[0] = f, this._intPt[1] = n, !f.equals(n) || g || w ? me.COLLINEAR_INTERSECTION : me.POINT_INTERSECTION) : y && w ? (this._intPt[0] = f, this._intPt[1] = i, !f.equals(i) || g || d ? me.COLLINEAR_INTERSECTION : me.POINT_INTERSECTION) : me.NO_INTERSECTION;
        ...
        var d = Q.index(u, f, n), w = Q.index(u, f, i);
        return d > 0 && w > 0 || d < 0 && w < 0 ? me.NO_INTERSECTION : g === 0 && y === 0 && d === 0 && w === 0 ? this.computeCollinearIntersection(n, i, u, f) : (g === 0 || y === 0 || d === 0 || w === 0 ? (this._isProper = !1, n.equals2D(u) || n.equals2D(f) ? this._intPt[0] = n : i.equals2D(u) || i.equals2D(f) ? this._intPt[0] = i : g === 0 ? this._intPt[0] = new O(u) : y === 0 ? this._intPt[0] = new O(f) : d === 0 ? this._intPt[0] = new O(n) : w === 0 && (this._intPt[0] = new O(i))) : (this._isProper = !0, this._intPt[0] = this.intersection(n, i, u, f)), me.POINT_INTERSECTION);
      } }], [{ key: "nearestEndpoint", value: function(n, i, u, f) {
        var g = n, y = nt.pointToSegment(n, u, f), d = nt.pointToSegment(i, u, f);
        return d < y && (y = d, g = i), (d = nt.pointToSegment(u, n, i)) < y && (y = d, g = u), (d = nt.pointToSegment(f, n, i)) < y && (y = d, g = f), g;
      } }]), t;
    }(me), Qc = function() {
      function s() {
        a(this, s), s.constructor_.apply(this, arguments);
      ...
      return c(s, [{ key: "countSegment", value: function(e, t) {
        ...
        if (arguments[0] instanceof O && arguments[1] instanceof Array) {
          for (var g = arguments[0], y = arguments[1], d = new s(g), w = 1; w < y.length; w++) {
            var b = y[w], L = y[w - 1];
      ...
      return c(s, null, [{ key: "isOnLine", value: function() {
        if (arguments[0] instanceof O && re(arguments[1], le)) {
          for (var e = arguments[0], t = arguments[1], n = new Gt(), i = new O(), u = new O(), f = t.size(), g = 1; g < f; g++) if (t.getCoordinate(g - 1, i), t.getCoordinate(g, u), n.computeIntersection(e, i, u), n.hasIntersection()) return !0;
          return !1;
        }
        if (arguments[0] instanceof O && arguments[1] instanceof Array) {
          for (var y = arguments[0], d = arguments[1], w = new Gt(), b = 1; b < d.length; b++) {
            var L = d[b - 1], $ = d[b];
            if (w.computeIntersection(y, L, $), w.hasIntersection()) return !0;
          }
          return !1;
        }
      } }, { key: "locateInRing", value: function(e, t) {
        return Qc.locatePointInRing(e, t);
      ...
      return c(s, [{ key: "setAllLocations", value: function(e) {
        ...
        if (e.location.length > this.location.length) {
          ...
          t[G.ON] = this.location[G.ON], t[G.LEFT] = S.NONE, t[G.RIGHT] = S.NONE, this.location = t;
        }
        ...
        var e = this.location[G.LEFT];
        this.location[G.LEFT] = this.location[G.RIGHT], this.location[G.RIGHT] = e;
      } }, { key: "toString", value: function() {
        var e = new Nn();
        return this.location.length > 1 && e.append(S.toLocationSymbol(this.location[G.LEFT])), e.append(S.toLocationSymbol(this.location[G.ON])), this.location.length > 1 && e.append(S.toLocationSymbol(this.location[G.RIGHT])), e.toString();
      } }, { key: "setLocations", value: function(e, t, n) {
        this.location[G.ON] = e, this.location[G.LEFT] = t, this.location[G.RIGHT] = n;
        ...
        if (this.location = null, arguments.length === 1) {
          if (arguments[0] instanceof Array) {
            ...
            var t = arguments[0];
            this.init(1), this.location[G.ON] = t;
          } else if (arguments[0] instanceof s) {
            var n = arguments[0];
          ...
          var u = arguments[0], f = arguments[1], g = arguments[2];
          this.init(3), this.location[G.ON] = u, this.location[G.LEFT] = f, this.location[G.RIGHT] = g;
        }
      } }]), s;
    }(), ze = function() {
      function s() {
      ...
      return c(s, [{ key: "getGeometryCount", value: function() {
        ...
        if (this.elt = new Array(2).fill(null), arguments.length === 1) {
          ...
          var y = arguments[0], d = arguments[1], w = arguments[2], b = arguments[3];
          this.elt[0] = new qe(S.NONE, S.NONE, S.NONE), this.elt[1] = new qe(S.NONE, S.NONE, S.NONE), this.elt[y].setLocations(d, w, b);
        }
      ...
      return c(s, [{ key: "computeRing", value: function() {
        ...
        if (arguments.length === 1) {
          ...
          var t = arguments[0], n = arguments[1], i = t.getLocation(n, G.RIGHT);
      ...
      return c(t, [{ key: "isIncidentEdgeInResult", value: function() {
        ...
        if (arguments.length !== 2 || !Number.isInteger(arguments[1]) || !Number.isInteger(arguments[0])) return N(v(t.prototype), "setLabel", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
    ...
    var Cn = function(s) {
      ...
      return c(t, [{ key: "get", value: function(n) {
        ...
        var i;
        for (n.color = 1; n != null && n !== this.root_ && n.parent.color === 1; ) fe(n) === xi(fe(fe(n))) ? xa(i = Ea(fe(fe(n)))) === 1 ? (rt(fe(n), 0), rt(i, 0), rt(fe(fe(n)), 1), n = fe(fe(n))) : (n === Ea(fe(n)) && (n = fe(n), this.rotateLeft(n)), rt(fe(n), 0), rt(fe(fe(n)), 1), this.rotateRight(fe(fe(n)))) : xa(i = xi(fe(fe(n)))) === 1 ? (rt(fe(n), 0), rt(i, 0), rt(fe(fe(n)), 1), n = fe(fe(n))) : (n === xi(fe(n)) && (n = fe(n), this.rotateRight(n)), rt(fe(n), 0), rt(fe(fe(n)), 1), this.rotateLeft(fe(fe(n))));
        this.root_.color = 0;
      } }, { key: "values", value: function() {
    ...
    var Ia = function() {
      ...
      return c(t, [{ key: "getNextMin", value: function() {
        ...
        for (var n = !0, i = 0; i < 2; i++) this._label.isArea(i) && this._label.getLocation(i, G.LEFT) === S.INTERIOR && this._label.getLocation(i, G.RIGHT) === S.INTERIOR || (n = !1);
        return n;
      } }, { key: "setNextMin", value: function(n) {
        this._nextMin = n;
      } }, { key: "print", value: function(n) {
        N(v(t.prototype), "print", this).call(this, n), n.print(" " + this._depth[G.LEFT] + "/" + this._depth[G.RIGHT]), n.print(" (" + this.getDepthDelta() + ")"), this._isInResult && n.print(" inResult");
        ...
        var n = arguments[0], i = arguments[1];
        if (Ia.constructor_.call(this, n), this._isForward = i, i) this.init(n.getCoordinate(0), n.getCoordinate(1));
        else {
      ...
      return c(s, [{ key: "printEdges", value: function(e) {
        ...
        if (this._edges = new Z(), this._nodes = null, this._edgeEndList = new Z(), arguments.length === 0) this._nodes = new ka(new Sa());
        else if (arguments.length === 1) {
          var e = arguments[0];
          this._nodes = new ka(e);
        }
      ...
      return c(s, [{ key: "sortShellsAndHoles", value: function(e, t, n) {
        ...
        for (var t = new Z(), n = e.iterator(); n.hasNext(); ) {
          ...
          if (i.isInResult() && i.getLabel().isArea() && i.getEdgeRing() === null) {
            var u = new ef(i, this._geometryFactory);
        ...
        for (var n = e.getLinearRing(), i = n.getEnvelopeInternal(), u = n.getCoordinateN(0), f = null, g = null, y = t.iterator(); y.hasNext(); ) {
          var d = y.next(), w = d.getLinearRing(), b = w.getEnvelopeInternal();
          if (!b.equals(i) && b.contains(i)) {
            u = Ee.ptNotInList(n.getCoordinates(), w.getCoordinates());
            var L = !1;
            _i.isInRing(u, w.getCoordinates()) && (L = !0), L && (f === null || g.contains(b)) && (g = (f = d).getLinearRing().getEnvelopeInternal());
          }
        }
        return f;
      } }]), s;
      ...
      return c(s, null, [{ key: "maxDistance", value: function(e, t, n, i, u, f, g, y) {
        ...
        var n = e.getMinX(), i = e.getMinY(), u = e.getMaxX(), f = e.getMaxY(), g = t.getMinX(), y = t.getMinY(), d = t.getMaxX(), w = t.getMaxY(), b = s.maxDistance(n, i, n, f, g, y, g, w);
        return b = Math.min(b, s.maxDistance(n, i, n, f, g, y, d, y)), b = Math.min(b, s.maxDistance(n, i, n, f, d, w, g, w)), b = Math.min(b, s.maxDistance(n, i, n, f, d, w, d, y)), b = Math.min(b, s.maxDistance(n, i, u, i, g, y, g, w)), b = Math.min(b, s.maxDistance(n, i, u, i, g, y, d, y)), b = Math.min(b, s.maxDistance(n, i, u, i, d, w, g, w)), b = Math.min(b, s.maxDistance(n, i, u, i, d, w, d, y)), b = Math.min(b, s.maxDistance(u, f, n, f, g, y, g, w)), b = Math.min(b, s.maxDistance(u, f, n, f, g, y, d, y)), b = Math.min(b, s.maxDistance(u, f, n, f, d, w, g, w)), b = Math.min(b, s.maxDistance(u, f, n, f, d, w, d, y)), b = Math.min(b, s.maxDistance(u, f, u, i, g, y, g, w)), b = Math.min(b, s.maxDistance(u, f, u, i, g, y, d, y)), b = Math.min(b, s.maxDistance(u, f, u, i, d, w, g, w)), b = Math.min(b, s.maxDistance(u, f, u, i, d, w, d, y));
      } }]), s;
    }(), Qt = function() {
      function s() {
        a(this, s), s.constructor_.apply(this, arguments);
      ...
      return c(s, [{ key: "maximumDistance", value: function() {
        return sf.maximumDistance(this._boundable1.getBounds(), this._boundable2.getBounds());
      ...
      return c(s, [{ key: "queryInternal", value: function() {
        if (re(arguments[2], ba) && arguments[0] instanceof Object && arguments[1] instanceof Ye) for (var e = arguments[0], t = arguments[1], n = arguments[2], i = t.getChildBoundables(), u = 0; u < i.size(); u++) {
          var f = i.get(u);
        ...
        else if (re(arguments[2], At) && arguments[0] instanceof Object && arguments[1] instanceof Ye) for (var g = arguments[0], y = arguments[1], d = arguments[2], w = y.getChildBoundables(), b = 0; b < w.size(); b++) {
          var L = w.get(b);
    ...
    var af = function() {
      ...
      return c(t, [{ key: "createParentBoundablesFromVerticalSlices", value: function(n, i) {
        ...
        if (arguments.length === 3) {
          var u = arguments[0], f = arguments[1], g = arguments[2], y = f, d = new hr();
          d.add(u);
          for (var w = new hr(); !d.isEmpty() && y >= 0; ) {
            var b = d.poll(), L = b.getDistance();
            if (L >= y) break;
            if (b.isLeaves()) if (w.size() < g) w.add(b);
            else {
              var $ = w.peek();
              $.getDistance() > L && (w.poll(), w.add(b));
              var D = w.peek();
              y = D.getDistance();
            }
        ...
        return arguments.length === 0 ? N(v(t.prototype), "size", this).call(this) : N(v(t.prototype), "size", this).apply(this, arguments);
      } }, { key: "insert", value: function() {
        if (!(arguments.length === 2 && arguments[1] instanceof Object && arguments[0] instanceof pe)) return N(v(t.prototype), "insert", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
        if (n.isNull()) return null;
        N(v(t.prototype), "insert", this).call(this, n, i);
        ...
        if (arguments.length === 1) {
          var n = arguments[0];
          return N(v(t.prototype), "query", this).call(this, n);
        }
        if (arguments.length === 2) {
          var i = arguments[0], u = arguments[1];
          N(v(t.prototype), "query", this).call(this, i, u);
        }
      } }, { key: "getComparator", value: function() {
        return t.yComparator;
      } }, { key: "createParentBoundablesFromVerticalSlice", value: function(n, i) {
        return N(v(t.prototype), "createParentBoundables", this).call(this, n, i);
      } }, { key: "remove", value: function() {
        if (arguments.length === 2 && arguments[1] instanceof Object && arguments[0] instanceof pe) {
          var n = arguments[0], i = arguments[1];
          return N(v(t.prototype), "remove", this).call(this, n, i);
        }
        return N(v(t.prototype), "remove", this).apply(this, arguments);
      } }, { key: "depth", value: function() {
        return arguments.length === 0 ? N(v(t.prototype), "depth", this).call(this) : N(v(t.prototype), "depth", this).apply(this, arguments);
        ...
        if (arguments.length === 1) {
          ...
          if (arguments[0] instanceof Qt) {
            var u = arguments[0], f = j.POSITIVE_INFINITY, g = null, y = new hr();
            for (y.add(u); !y.isEmpty() && f > 0; ) {
              var d = y.poll(), w = d.getDistance();
              if (w >= f) break;
              d.isLeaves() ? (f = w, g = d) : d.expandToQueue(y, f);
            }
          ...
          if (arguments.length === 3) {
            var D = arguments[0], V = arguments[1], H = arguments[2], K = new pt(D, V), he = new Qt(this.getRoot(), K, H);
            return this.nearestNeighbour(he)[0];
          }
          if (arguments.length === 4) {
            var de = arguments[0], Oe = arguments[1], Ge = arguments[2], Je = arguments[3], mt = new pt(de, Oe), qt = new Qt(this.getRoot(), mt, Ge);
            return this.nearestNeighbourK(qt, Je);
          }
        }
      } }, { key: "isWithinDistance", value: function() {
        if (arguments.length === 2) {
          var n = arguments[0], i = arguments[1], u = j.POSITIVE_INFINITY, f = new hr();
        ...
        if (arguments.length === 3) {
          var d = arguments[0], w = arguments[1], b = arguments[2], L = new Qt(this.getRoot(), d.getRoot(), w);
    ...
    it.STRtreeNode = Oa, it.xComparator = new (function() {
      function s() {
        a(this, s);
      }
      return c(s, [{ key: "interfaces_", get: function() {
        ...
        return Kt.compareDoubles(it.centreX(e.getBounds()), it.centreX(t.getBounds()));
      } }]), s;
      ...
      return c(s, [{ key: "interfaces_", get: function() {
        ...
        return Kt.compareDoubles(it.centreY(e.getBounds()), it.centreY(t.getBounds()));
      } }]), s;
    ...
    var of = function() {
      ...
      return c(s, [{ key: "getCoordinate", value: function() {
        ...
        var t = e;
        return this.segmentIndex < t.segmentIndex ? -1 : this.segmentIndex > t.segmentIndex ? 1 : this.coord.equals2D(t.coord) ? 0 : this._isInterior ? t._isInterior ? of.compare(this._segmentOctant, this.coord, t.coord) : 1 : -1;
      ...
      return c(s, [{ key: "getSplitCoordinates", value: function() {
        ...
        for (var t = 0; t < this._edge.size() - 2; t++) {
          ...
          n.equals2D(i) && e.add(nr.valueOf(t + 1));
        }
        ...
        for (var t = new Array(1).fill(null), n = this.iterator(), i = n.next(); n.hasNext(); ) {
          var u = n.next();
          this.findCollapseIndex(i, u, t) && e.add(nr.valueOf(t[0])), i = u;
        }
      } }, { key: "getEdge", value: function() {
        return this._edge;
        ...
        return new Bt(n, this._edge.getData());
      } }, { key: "add", value: function(e, t) {
        var n = new uf(this._edge, e, t, this._edge.getSegmentOctant(t)), i = this._nodeMap.get(n);
      ...
      return c(s, [{ key: "getCoordinates", value: function() {
        ...
        return e.equals2D(t) ? 0 : ff.octant(e, t);
      } }, { key: "getData", value: function() {
        return this._data;
        ...
        return di.toLineString(new Ln(this._pts));
        ...
        this._nodeList = new cf(this), this._pts = null, this._data = null;
        var e = arguments[0], t = arguments[1];
      ...
      return c(s, [{ key: "getLineSegment", value: function(e, t) {
        ...
        if (arguments.length === 2) {
          ...
          var d = Math.trunc((n + i) / 2), w = Math.trunc((f + g) / 2);
          n < d && (f < w && this.computeOverlaps(n, d, u, f, w, y), w < g && this.computeOverlaps(n, d, u, w, g, y)), d < i && (f < w && this.computeOverlaps(d, i, u, f, w, y), w < g && this.computeOverlaps(d, i, u, w, g, y));
        }
      ...
      return c(s, null, [{ key: "findChainEnd", value: function(e, t) {
        ...
        if (arguments.length === 2) {
          ...
          do {
            var f = s.findChainEnd(t, u), g = new Ta(t, u, f, n);
            i.add(g), u = f;
          } while (u < t.length - 1);
          return i;
        }
      ...
      return c(t, [{ key: "getMonotoneChains", value: function() {
        ...
        return Bt.getNodedSubstrings(this._nodedSegStrings);
      } }, { key: "getIndex", value: function() {
        return this._index;
      } }, { key: "add", value: function(n) {
        for (var i = vf.getChains(n.getCoordinates(), n).iterator(); i.hasNext(); ) {
          var u = i.next();
        ...
        for (var n = new Ra(this._segInt), i = this._monoChains.iterator(); i.hasNext(); ) for (var u = i.next(), f = this._index.query(u.getEnvelope()).iterator(); f.hasNext(); ) {
          var g = f.next();
      ...
      return c(t, [{ key: "overlap", value: function() {
        if (arguments.length !== 4) return N(v(t.prototype), "overlap", this).apply(this, arguments);
    ...
    var Ze = function() {
      ...
      return c(s, [{ key: "isDeletable", value: function(e, t, n, i) {
        ...
        for (var e = new Tn(), t = 0; t < this._inputLine.length; t++) this._isDeleted[t] !== s.DELETE && e.add(this._inputLine[t]);
        return e.toCoordinateArray();
      } }], [{ key: "constructor_", value: function() {
    ...
    Ca.COORDINATE_ARRAY_TYPE = new Array(0).fill(null);
    var $e = function() {
      function s() {
        a(this, s);
      }
    ...
    var Pn = function() {
      ...
      return c(s, [{ key: "addNextSegment", value: function(e, t) {
        ...
        var n = Q.index(this._s0, this._s1, this._s2), i = n === Q.CLOCKWISE && this._side === G.LEFT || n === Q.COUNTERCLOCKWISE && this._side === G.RIGHT;
        ...
        this.computeOffsetSegment(n, G.LEFT, this._distance, i);
        var u = new Fe();
        this.computeOffsetSegment(n, G.RIGHT, this._distance, u);
        ...
        switch (this._bufParams.getEndCapStyle()) {
          ...
          case C.CAP_SQUARE:
            ...
            var w = new O(i.p1.x + d.x, i.p1.y + d.y), b = new O(u.p1.x + d.x, u.p1.y + d.y);
            this._segList.addPt(w), this._segList.addPt(b);
        }
      } }, { key: "getCoordinates", value: function() {
        ...
        var f = t.x - e.x, g = t.y - e.y, y = Math.atan2(g, f), d = n.x - e.x, w = n.y - e.y, b = Math.atan2(w, d);
        ...
        var u = this._seg0.p1, f = $e.angle(u, this._seg0.p0), g = $e.angleBetweenOriented(this._seg0.p0, u, this._seg1.p1) / 2, y = $e.normalize(f + g), d = $e.normalize(y + Math.PI), w = i * n, b = n - w * Math.abs(Math.sin(g)), L = u.x + w * Math.cos(d), $ = u.y + w * Math.sin(d), D = new O(L, $), V = new Fe(u, D), H = V.pointAlongOffset(1, b), K = V.pointAlongOffset(1, -b);
        this._side === G.LEFT ? (this._segList.addPt(H), this._segList.addPt(K)) : (this._segList.addPt(K), this._segList.addPt(H));
        ...
        if (y < 1) return null;
        for (var d = g / y, w = new O(), b = 0; b < y; b++) {
          var L = t + f * b * d;
          w.x = e.x + u * Math.cos(L), w.y = e.y + u * Math.sin(L), this._segList.addPt(w);
        }
      } }, { key: "computeOffsetSegment", value: function(e, t, n, i) {
        var u = t === G.LEFT ? 1 : -1, f = e.p1.x - e.p0.x, g = e.p1.y - e.p0.y, y = Math.sqrt(f * f + g * g), d = u * n * f / y, w = u * n * g / y;
        i.p0.x = e.p0.x - w, i.p0.y = e.p0.y + d, i.p1.x = e.p1.x - w, i.p1.y = e.p1.y + d;
        ...
        this._distance = e, this._maxCurveSegmentError = e * (1 - Math.cos(this._filletAngleQuantum / 2)), this._segList = new Ca(), this._segList.setPrecisionModel(this._precisionModel), this._segList.setMinimumVertexDistance(e * s.CURVE_VERTEX_SNAP_DISTANCE_FACTOR);
      } }, { key: "addCollinear", value: function(e) {
        this._li.computeIntersection(this._s0, this._s1, this._s1, this._s2), this._li.getIntersectionNum() >= 2 && (this._bufParams.getJoinStyle() === C.JOIN_BEVEL || this._bufParams.getJoinStyle() === C.JOIN_MITRE ? (e && this._segList.addPt(this._offset0.p1), this._segList.addPt(this._offset1.p0)) : this.addCornerFillet(this._s1, this._offset0.p1, this._offset1.p0, Q.CLOCKWISE, this._distance));
      } }, { key: "closeRing", value: function() {
        ...
        var e = arguments[0], t = arguments[1], n = arguments[2];
        this._precisionModel = e, this._bufParams = t, this._li = new Gt(), this._filletAngleQuantum = Math.PI / 2 / t.getQuadrantSegments(), t.getQuadrantSegments() >= 8 && t.getJoinStyle() === C.JOIN_ROUND && (this._closingSegLengthFactor = s.MAX_CLOSING_SEG_LEN_FACTOR), this.init(n);
      } }]), s;
    }();
    ...
    var pf = function() {
      ...
      return c(s, [{ key: "getOffsetCurve", value: function(e, t) {
        ...
        if (t) {
          ...
          n.initSideSegments(u[f], u[f - 1], G.LEFT), n.addFirstSegment();
          for (var g = f - 2; g >= 0; g--) n.addNextSegment(u[g], !0);
        } else {
          n.addSegments(e, !1);
          var y = Ze.simplify(e, i), d = y.length - 1;
          n.initSideSegments(y[0], y[1], G.LEFT), n.addFirstSegment();
          for (var w = 2; w <= d; w++) n.addNextSegment(y[w], !0);
        }
        ...
        return new Pn(this._precisionModel, this._bufParams, e);
      } }], [{ key: "constructor_", value: function() {
      ...
      return c(s, [{ key: "findStabbedSegments", value: function() {
        ...
        if (arguments.length === 3) {
          if (re(arguments[2], At) && arguments[0] instanceof O && arguments[1] instanceof Ei) for (var f = arguments[0], g = arguments[1], y = arguments[2], d = g.getEdge().getCoordinates(), w = 0; w < d.length - 1; w++) {
            this._seg.p0 = d[w], this._seg.p1 = d[w + 1], this._seg.p0.y > this._seg.p1.y && this._seg.reverse();
            ...
            if (!(b < f.x) && !(this._seg.isHorizontal() || f.y < this._seg.p0.y || f.y > this._seg.p1.y || Q.index(this._seg.p0, this._seg.p1, f) === Q.RIGHT)) {
              var L = g.getDepth(G.LEFT);
              this._seg.p0.equals(d[w]) || (L = g.getDepth(G.RIGHT));
              var $ = new Aa(this._seg, L);
              y.add($);
            }
          }
            ...
            var he = K.next();
            he.isForward() && this.findStabbedSegments(D, he, H);
          }
        }
    ...
    var Ma = function(s) {
      ...
      return c(s, [{ key: "getY", value: function() {
        var e = this.y / this.w;
        if (j.isNaN(e) || j.isInfinite(e)) throw new Ma();
        return e;
      } }, { key: "getX", value: function() {
        var e = this.x / this.w;
        if (j.isNaN(e) || j.isInfinite(e)) throw new Ma();
        ...
        if (this.x = null, this.y = null, this.w = null, arguments.length === 0) this.x = 0, this.y = 0, this.w = 1;
          ...
          var y = arguments[0], d = arguments[1], w = arguments[2];
          this.x = y, this.y = d, this.w = w;
        } else if (arguments.length === 4) {
          var b = arguments[0], L = arguments[1], $ = arguments[2], D = arguments[3], V = b.y - L.y, H = L.x - b.x, K = b.x * L.y - L.x * b.y, he = $.y - D.y, de = D.x - $.x, Oe = $.x * D.y - D.x * $.y;
      ...
      return c(s, [{ key: "area", value: function() {
        ...
        var u = t.x, f = t.y, g = n.x - u, y = i.x - u, d = n.y - f, w = i.y - f, b = g * w - y * d, L = e.x - u, $ = e.y - f, D = (w * L - y * $) / b, V = (-d * L + g * $) / b;
        ...
        var i = J.valueOf(e.x).subtract(n.x), u = J.valueOf(e.y).subtract(n.y), f = J.valueOf(t.x).subtract(n.x), g = J.valueOf(t.y).subtract(n.y), y = J.determinant(i, u, f, g).multiply(2), d = i.sqr().add(u.sqr()), w = f.sqr().add(g.sqr()), b = J.determinant(u, d, g, w), L = J.determinant(i, d, f, w), $ = J.valueOf(n.x).subtract(b.divide(y)).doubleValue(), D = J.valueOf(n.y).add(L.divide(y)).doubleValue();
        return new O($, D);
      } }, { key: "isAcute", value: function(e, t, n) {
        return !!$e.isAcute(e, t, n) && !!$e.isAcute(t, n, e) && !!$e.isAcute(n, e, t);
      } }, { key: "circumcentre", value: function(e, t, n) {
        var i = n.x, u = n.y, f = e.x - i, g = e.y - u, y = t.x - i, d = t.y - u, w = 2 * s.det(f, g, y, d), b = s.det(g, f * f + g * g, d, y * y + d * d), L = s.det(f, f * f + g * g, y, y * y + d * d);
        return new O(i - b / w, u + L / w);
        ...
        var i = t.x - e.x, u = t.y - e.y, f = t.getZ() - e.getZ(), g = n.x - e.x, y = n.y - e.y, d = n.getZ() - e.getZ(), w = u * d - f * y, b = f * g - i * d, L = i * y - u * g, $ = w * w + b * b + L * L, D = Math.sqrt($) / 2;
        return D;
      ...
      return c(s, [{ key: "addRingSide", value: function(e, t, n, i, u) {
        if (t === 0 && e.length < On.MINIMUM_VALID_SIZE) return null;
        var f = i, g = u;
        e.length >= On.MINIMUM_VALID_SIZE && Q.isCCW(e) && (f = u, g = i, n = G.opposite(n));
        var y = this._curveBuilder.getRingCurve(e, n, t);
        this.addCurve(y, f, g);
      } }, { key: "addRingBothSides", value: function(e, t) {
        this.addRingSide(e, t, G.LEFT, S.EXTERIOR, S.INTERIOR), this.addRingSide(e, t, G.RIGHT, S.INTERIOR, S.EXTERIOR);
        ...
        var t = this._distance, n = G.LEFT;
        this._distance < 0 && (t = -this._distance, n = G.RIGHT);
        ...
        for (var f = 0; f < e.getNumInteriorRing(); f++) {
          ...
          this._distance > 0 && this.isErodedCompletely(g, -this._distance) || this.addRingSide(y, t, G.opposite(n), S.INTERIOR, S.EXTERIOR);
        }
      } }, { key: "isTriangleErodedCompletely", value: function(e, t) {
        var n = new mf(e[0], e[1], e[2]), i = n.inCentre();
        ...
        var i = new Bt(e, new ze(0, S.BOUNDARY, t, n));
        this._curveList.add(i);
      } }, { key: "getCurves", value: function() {
        return this.add(this._inputGeom), this._curveList;
      } }, { key: "add", value: function(e) {
        if (e.isEmpty()) return null;
        if (e instanceof ar) this.addPolygon(e);
        else if (e instanceof bn) this.addLineString(e);
      ...
      return c(s, [{ key: "next", value: function() {
        ...
        if (this._index >= this._max) throw new tr();
      ...
      return c(s, [{ key: "locate", value: function(e) {
        ...
        if (t instanceof ar) return s.locatePointInPolygon(e, t);
        if (t instanceof De) for (var n = new xf(t); n.hasNext(); ) {
          var i = n.next();
          if (i !== t) {
      ...
      return c(s, [{ key: "getNextCW", value: function(e) {
        ...
        for (var t = S.NONE, n = this.iterator(); n.hasNext(); ) {
          ...
          i.isArea(e) && i.getLocation(e, G.LEFT) !== S.NONE && (t = i.getLocation(e, G.LEFT));
        }
        if (t === S.NONE) return null;
        for (var u = t, f = this.iterator(); f.hasNext(); ) {
          var g = f.next(), y = g.getLabel();
          if (y.getLocation(e, G.ON) === S.NONE && y.setLocation(e, G.ON, u), y.isArea(e)) {
            var d = y.getLocation(e, G.LEFT), w = y.getLocation(e, G.RIGHT);
            if (w !== S.NONE) {
              if (w !== u) throw new yt("side location conflict", g.getCoordinate());
              d === S.NONE && se.shouldNeverReachHere("found single null side (at " + g.getCoordinate() + ")"), u = d;
            } else se.isTrue(y.getLocation(e, G.LEFT) === S.NONE, "found single null side"), y.setLocation(e, G.RIGHT, u), y.setLocation(e, G.LEFT, u);
          }
        }
      } }, { key: "getCoordinate", value: function() {
        var e = this.iterator();
        ...
        Be.out.println("EdgeEndStar:   " + this.getCoordinate());
        for (var t = this.iterator(); t.hasNext(); )
          t.next().print(e);
        ...
        var n = t.size() - 1, i = t.get(n).getLabel().getLocation(e, G.LEFT);
        ...
        for (var u = i, f = this.iterator(); f.hasNext(); ) {
          ...
          var y = g.getLocation(e, G.LEFT), d = g.getLocation(e, G.RIGHT);
          if (y === d || d !== u) return !1;
          u = y;
        }
        return !0;
        ...
        return this._ptInAreaLocation[e] === S.NONE && (this._ptInAreaLocation[e] = Ef.locate(t, n[e].getGeometry())), this._ptInAreaLocation[e];
      } }, { key: "toString", value: function() {
        var e = new Nn();
...
`);
        ...
        for (var f = this.iterator(); f.hasNext(); ) for (var g = f.next(), y = g.getLabel(), d = 0; d < 2; d++) if (y.isAnyNull(d)) {
          ...
          if (t[d]) w = S.EXTERIOR;
            ...
            w = this.getLocation(d, b, e);
          }
          y.setAllLocationsIfNull(d, w);
        }
        ...
        this._edgeMap = new Cn(), this._edgeList = null, this._ptInAreaLocation = [S.NONE, S.NONE];
      } }]), s;
    }(), If = function(s) {
      h(t, s);
      var e = E(t);
      ...
      return c(t, [{ key: "linkResultDirectedEdges", value: function() {
        ...
        Be.out.println("DirectedEdgeStar: " + this.getCoordinate());
        ...
        if (arguments.length === 1) {
          var n = arguments[0], i = this.findIndex(n), u = n.getDepth(G.LEFT), f = n.getDepth(G.RIGHT), g = this.computeDepths(i + 1, this._edgeList.size(), u), y = this.computeDepths(0, i, g);
          if (y !== f) throw new yt("depth mismatch at " + n.getCoordinate());
        } else if (arguments.length === 3) {
          for (var d = arguments[0], w = arguments[1], b = arguments[2], L = b, $ = d; $ < w; $++) {
            var D = this._edgeList.get($);
            D.setEdgeDepths(G.RIGHT, L), L = D.getDepth(G.LEFT);
          }
          return L;
        }
        ...
        for (var g = n, y = this.iterator(); y.hasNext(); ) {
          var d = y.next(), w = d.getSym();
          d.isLineEdge() ? d.getEdge().setCovered(g === S.INTERIOR) : (d.isInResult() && (g = S.EXTERIOR), w.isInResult() && (g = S.INTERIOR));
        }
      } }, { key: "computeLabelling", value: function(n) {
        N(v(t.prototype), "computeLabelling", this).call(this, n), this._label = new ze(S.NONE);
      ...
      return c(s, [{ key: "compareTo", value: function(e) {
        ...
        for (var u = t ? 1 : -1, f = i ? 1 : -1, g = t ? e.length : -1, y = i ? n.length : -1, d = t ? 0 : e.length - 1, w = i ? 0 : n.length - 1; ; ) {
          var b = e[d].compareTo(n[w]);
          if (b !== 0) return b;
          var L = (d += u) === g, $ = (w += f) === y;
          if (L && !$) return -1;
          if (!L && $) return 1;
      ...
      return c(s, [{ key: "print", value: function(e) {
        ...
        this._edges = new Z(), this._ocaMap = new Cn();
      } }]), s;
    }(), Fa = function() {
      function s() {
        a(this, s);
      ...
      return c(s, [{ key: "print", value: function(e) {
        ...
        return u && (f[g] = t.coord), new Ga(f, new ze(this.edge._label));
      } }, { key: "add", value: function(e, t, n) {
        var i = new bf(e, t, n), u = this._nodeMap.get(i);
      ...
      return c(s, [{ key: "isIntersects", value: function() {
        ...
        for (var e = new ur("123456789"), t = 0; t < 3; t++) for (var n = 0; n < 3; n++) e.setCharAt(3 * t + n, z.toDimensionSymbol(this._matrix[t][n]));
        return e.toString();
      ...
      return c(s, [{ key: "size", value: function() {
        ...
        return e === null || e.length === 0 ? null : (this.ensureCapacity(this._size + e.length), Be.arraycopy(e, 0, this._data, this._size, e.length), void (this._size += e.length));
        ...
        return Be.arraycopy(this._data, 0, e, 0, this._size), e;
      } }, { key: "add", value: function(e) {
      ...
      return c(s, [{ key: "getChainStartIndices", value: function(e) {
        var t = 0, n = new Lf(Math.trunc(e.length / 2));
        n.add(t);
        do {
      ...
      return c(s, [{ key: "getCoordinates", value: function() {
        ...
        if (arguments.length === 4) {
          ...
          var u = arguments[0], f = arguments[1], g = arguments[2], y = arguments[3], d = arguments[4], w = arguments[5];
          if (f - u == 1 && d - y == 1) return w.addIntersections(this.e, u, g.e, y), null;
          if (!this.overlaps(u, f, g, y, d)) return null;
          var b = Math.trunc((u + f) / 2), L = Math.trunc((y + d) / 2);
          u < b && (y < L && this.computeIntersectsForChain(u, b, g, y, L, w), L < d && this.computeIntersectsForChain(u, b, g, L, d, w)), b < f && (y < L && this.computeIntersectsForChain(b, f, g, y, L, w), L < d && this.computeIntersectsForChain(b, f, g, L, d, w));
        }
      } }, { key: "overlaps", value: function(e, t, n, i, u) {
      ...
      return c(s, [{ key: "getDepth", value: function(e, t) {
        ...
        return this._depth[e][G.RIGHT] - this._depth[e][G.LEFT];
    ...
    var Ga = function(s) {
      ...
      return c(t, [{ key: "getDepth", value: function() {
        ...
        return this._mce === null && (this._mce = new Cf(this)), this._mce;
      } }, { key: "getEnvelope", value: function() {
        if (this._env === null) {
          this._env = new pe();
        ...
        var g = new O(n.getIntersection(f)), y = i, d = n.getEdgeDistance(u, f), w = y + 1;
        if (w < this.pts.length) {
          var b = this.pts[w];
          g.equals2D(b) && (y = w, d = 0);
        }
        ...
        if (this.pts = null, this._env = null, this.eiList = new Of(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new $a(), this._depthDelta = 0, arguments.length === 1) {
          var n = arguments[0];
        ...
        if (!(arguments.length === 2 && arguments[1] instanceof Tf && arguments[0] instanceof ze)) return N(v(t), "updateIM", this).apply(this, arguments);
        var n = arguments[0], i = arguments[1];
        i.setAtLeastIfValid(n.getLocation(0, G.ON), n.getLocation(1, G.ON), 1), n.isArea() && (i.setAtLeastIfValid(n.getLocation(0, G.LEFT), n.getLocation(1, G.LEFT), 2), i.setAtLeastIfValid(n.getLocation(0, G.RIGHT), n.getLocation(1, G.RIGHT), 2));
      } }]), t;
    }(_a), Ba = function() {
      function s() {
        a(this, s), s.constructor_.apply(this, arguments);
      ...
      return c(s, [{ key: "setWorkingPrecisionModel", value: function(e) {
        ...
        for (var n = new Z(), i = e.iterator(); i.hasNext(); ) {
          var u = i.next(), f = u.getRightmostCoordinate(), g = new Pa(n).getDepth(f);
        ...
        var t = new Ii(), n = new Gt();
        return n.setPrecisionModel(e), t.setSegmentIntersector(new wf(n)), t;
      } }, { key: "buffer", value: function(e, t) {
        var n = this._workingPrecisionModel;
        n === null && (n = e.getPrecisionModel()), this._geomFact = e.getFactory();
        var i = new pf(n, this._bufParams), u = new df(e, t, i).getCurves();
        if (u.size() <= 0) return this.createEmptyResultGeometry();
        this.computeNodedEdges(u, n), this._graph = new Na(new Sf()), this._graph.addEdges(this._edgeList.getEdges());
        var f = this.createSubgraphs(this._graph), g = new nf(this._geomFact);
        ...
        for (var i = n.getNodedSubstrings().iterator(); i.hasNext(); ) {
          ...
          if (f.length !== 2 || !f[0].equals2D(f[1])) {
            var g = u.getData(), y = new Ga(u.getCoordinates(), new ze(g));
        ...
        this._bufParams = null, this._workingPrecisionModel = null, this._workingNoder = null, this._geomFact = null, this._graph = null, this._edgeList = new Nf();
        var e = arguments[0];
        this._bufParams = e;
      } }, { key: "depthDelta", value: function(e) {
        var t = e.getLocation(0, G.LEFT), n = e.getLocation(0, G.RIGHT);
      ...
      return c(s, [{ key: "checkEndPtVertexIntersections", value: function() {
        ...
        else if (arguments.length === 2) for (var u = arguments[0], f = arguments[1], g = u.getCoordinates(), y = f.getCoordinates(), d = 0; d < g.length - 1; d++) for (var w = 0; w < y.length - 1; w++) this.checkInteriorIntersections(u, d, f, w);
        else if (arguments.length === 4) {
          var b = arguments[0], L = arguments[1], $ = arguments[2], D = arguments[3];
          if (b === $ && L === D) return null;
          var V = b.getCoordinates()[L], H = b.getCoordinates()[L + 1], K = $.getCoordinates()[D], he = $.getCoordinates()[D + 1];
        ...
        this._li = new Gt(), this._segStrings = null;
        var e = arguments[0];
        this._segStrings = e;
      } }]), s;
    }();
    ...
    var Af = function() {
      ...
      return c(s, [{ key: "snap", value: function() {
        ...
        if (arguments.length === 3) {
          var t = arguments[0], n = arguments[1], i = arguments[2], u = t.getSafeEnvelope(), f = new Ya(t, n, i);
      ...
      return c(t, [{ key: "isNodeAdded", value: function() {
        ...
        if (!(arguments.length === 2 && Number.isInteger(arguments[1]) && arguments[0] instanceof Ta)) return N(v(t.prototype), "select", this).apply(this, arguments);
    ...
    var Mf = function() {
      ...
      return c(s, [{ key: "checkCorrectness", value: function(e) {
        var t = Bt.getNodedSubstrings(e), n = new qa(t);
        try {
          n.checkValid();
        } catch (i) {
        ...
        else if (arguments[0] instanceof Bt) for (var i = arguments[0], u = i.getCoordinates(), f = 0; f < u.length; f++) {
          var g = new Ni(u[f], this._scaleFactor, this._li), y = this._pointSnapper.snap(g, i, f);
          y && i.addIntersection(u[f], f);
        }
      } }, { key: "computeNodes", value: function(e) {
        this._nodedSegStrings = e, this._noder = new Ii(), this._pointSnapper = new za(this._noder.getIndex()), this.snapRound(e, this._li);
        ...
        var e = arguments[0];
        this._pm = e, this._li = new Gt(), this._li.setPrecisionModel(e), this._scaleFactor = e.getScale();
      } }]), s;
    }(), en = function() {
      function s() {
        a(this, s), s.constructor_.apply(this, arguments);
      ...
      return c(s, [{ key: "bufferFixedPrecision", value: function(e) {
        var t = new Pf(new Df(new He(1)), e.getScale()), n = new Ba(this._bufParams);
        ...
        if (arguments.length === 3) {
          ...
          if (arguments[2] instanceof C && arguments[0] instanceof W && typeof arguments[1] == "number") {
            var w = arguments[0], b = arguments[1], L = arguments[2], $ = new s(w, L), D = $.getResultGeometry(b);
            return D;
          }
        } else if (arguments.length === 4) {
        ...
        var i = e.getEnvelopeInternal(), u = wn.max(Math.abs(i.getMaxX()), Math.abs(i.getMaxY()), Math.abs(i.getMinX()), Math.abs(i.getMinY())) + 2 * (t > 0 ? t : 0), f = n - Math.trunc(Math.log(u) / Math.log(10) + 1);
        return Math.pow(10, f);
      } }]), s;
    }();
    en.CAP_ROUND = C.CAP_ROUND, en.CAP_BUTT = C.CAP_FLAT, en.CAP_FLAT = C.CAP_FLAT, en.CAP_SQUARE = C.CAP_SQUARE, en.MAX_PRECISION_DIGITS = 12;
    var Ff = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], Ua = function() {
      function s(e) {
      ...
      return c(s, [{ key: "read", value: function(e) {
        ...
        return Ff.indexOf(n) !== -1 ? Ue[n].call(this, t.coordinates) : n === "GeometryCollection" ? Ue[n].call(this, t.geometries) : Ue[n].call(this, t);
      } }, { key: "write", value: function(e) {
    ...
    return { BufferOp: en, GeoJSONReader: function() {
      function s(e) {
        a(this, s), this.parser = new Ua(e || new Ht());
      }
      return c(s, [{ key: "read", value: function(e) {
      ...
      function s() {
        a(this, s), this.parser = new Ua(this.geometryFactory);
      }
      return c(s, [{ key: "write", value: function(e) {
        return this.parser.write(e);
      } }]), s;
...
Zr.prototype = {
  ...
  add: function(o) {
    Pu(mr, o, this.t), Pu(this, mr.s, this.s), this.s ? this.t += mr.t : this.s = mr.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var ve = 1e-6, ce = Math.PI, ut = ce / 2, Au = ce / 4, ct = ce * 2, St = 180 / ce, Xe = ce / 180, we = Math.abs, sd = Math.atan, pn = Math.atan2, _e = Math.cos, xe = Math.sin, In = Math.sqrt;
function yc(o) {
...
function Jr(o, r) {
  o && Du.hasOwnProperty(o.type) && Du[o.type](o, r);
}
var Mu = {
  ...
  LineString: function(o, r) {
    Os(o.coordinates, r, 0);
  },
  MultiLineString: function(o, r) {
    for (var a = o.coordinates, l = -1, c = a.length; ++l < c; ) Os(a[l], r, 0);
  },
  Polygon: function(o, r) {
    Fu(o.coordinates, r);
  },
  MultiPolygon: function(o, r) {
    for (var a = o.coordinates, l = -1, c = a.length; ++l < c; ) Fu(a[l], r);
  },
...
function Fu(o, r) {
  var a = -1, l = o.length;
  for (r.polygonStart(); ++a < l; ) Os(o[a], r, 1);
  r.polygonEnd();
}
function ad(o, r) {
  o && Mu.hasOwnProperty(o.type) ? Mu[o.type](o, r) : Jr(o, r);
}
Pt();
Pt();
function Ts(o) {
  return [pn(o[1], o[0]), Ut(o[2])];
}
function mn(o) {
...
function Ls(o) {
  var r = In(o[0] * o[0] + o[1] * o[1] + o[2] * o[2]);
  o[0] /= r, o[1] /= r, o[2] /= r;
}
Pt();
function vc(o, r) {
...
Rs.invert = Rs;
function od(o, r, a) {
  return (o %= ct) ? r || a ? vc(Gu(o), Bu(r, a)) : Gu(o) : r || a ? Bu(r, a) : Rs;
}
function $u(o) {
  return function(r, a) {
...
function Gu(o) {
  var r = $u(o);
  return r.invert = $u(-o), r;
}
function Bu(o, r) {
  var a = _e(o), l = xe(o), c = _e(r), h = xe(r);
  function v(p, _) {
    var x = _e(_), I = _e(p) * x, m = xe(p) * x, k = xe(_), E = k * a + I * l;
    return [
      pn(m * c - E * h, I * a - k * l),
      Ut(E * c + m * h)
    ];
  ...
  return v.invert = function(p, _) {
    var x = _e(_), I = _e(p) * x, m = xe(p) * x, k = xe(_), E = k * c - m * h;
    return [
      pn(m * c + k * h, I * a + E * l),
      Ut(E * a - I * l)
    ];
...
function ud(o, r, a, l, c, h) {
  if (a) {
    ...
    c == null ? (c = r + l * ct, h = r - _ / 2) : (c = qu(v, c), h = qu(v, h), (l > 0 ? c < h : c > h) && (c += l * ct));
    for (var x, I = c; l > 0 ? I > h : I < h; I -= _)
      x = Ts([v, -p * _e(I), -p * xe(I)]), o.point(x[0], x[1]);
  }
}
function qu(o, r) {
  r = mn(r), r[0] -= o, Ls(r);
...
function ld(o, r, a, l, c, h) {
  var v = o[0], p = o[1], _ = r[0], x = r[1], I = 0, m = 1, k = _ - v, E = x - p, N;
  if (N = a - v, !(!k && N > 0)) {
    if (N /= k, k < 0) {
      if (N < I) return;
      N < m && (m = N);
    ...
    if (N = c - v, !(!k && N < 0)) {
      ...
      if (N = l - p, !(!E && N > 0)) {
        ...
        if (N = h - p, !(!E && N < 0)) {
          ...
          return I > 0 && (o[0] = v + I * k, o[1] = p + I * E), m < 1 && (r[0] = v + m * k, r[1] = p + m * E), !0;
        }
      }
    }
  }
...
function mc(o, r, a, l, c) {
  var h = [], v = [], p, _;
  if (o.forEach(function(N) {
    if (!((T = N.length - 1) <= 0)) {
      var T, R = N[0], A = N[T], P;
      if (Rr(R, A)) {
        for (c.lineStart(), p = 0; p < T; ++p) c.point((R = N[p])[0], R[1]);
        c.lineEnd();
        return;
      }
      h.push(P = new xr(R, N, null, !0)), v.push(P.o = new xr(R, null, P, !1)), h.push(P = new xr(A, N, null, !1)), v.push(P.o = new xr(A, null, P, !0));
    }
  }), !!h.length) {
    for (v.sort(r), zu(h), zu(v), p = 0, _ = v.length; p < _; ++p)
      v[p].e = a = !a;
    for (var x = h[0], I, m; ; ) {
      for (var k = x, E = !0; k.v; ) if ((k = k.n) === x) return;
      I = k.z, c.lineStart();
      do {
        if (k.v = k.o.v = !0, k.e) {
          if (E)
          ...
          if (E)
            for (I = k.p.z, p = I.length - 1; p >= 0; --p) c.point((m = I[p])[0], m[1]);
          else
            l(k.x, k.p.x, -1, c);
          k = k.p;
        }
...
function hd(o, r, a, l) {
  ...
  function h(x, I, m, k) {
    var E = 0, N = 0;
    if (x == null || (E = v(x, m)) !== (N = v(I, m)) || _(x, I) < 0 ^ m > 0)
      do
        k.point(E === 0 || E === 3 ? o : a, E > 1 ? l : r);
      while ((E = (E + m + 4) % 4) !== N);
    else
      k.point(I[0], I[1]);
  }
  ...
  function _(x, I) {
    var m = v(x, 1), k = v(I, 1);
    return m !== k ? m - k : m === 0 ? I[1] - x[1] : m === 1 ? x[0] - I[0] : m === 2 ? x[1] - I[1] : I[0] - x[0];
  }
  return function(x) {
    var I = x, m = pc(), k, E, N, T, R, A, P, C, F, M, B, Y = {
      point: U,
      lineStart: te,
      lineEnd: ae,
      polygonStart: ie,
    ...
    function X() {
      for (var ne = 0, ue = 0, ye = E.length; ue < ye; ++ue)
        for (var ke = E[ue], Ie = 1, j = ke.length, Re = ke[0], Se, Ae, se = Re[0], gt = Re[1]; Ie < j; ++Ie)
    ...
    function ee() {
      var ne = X(), ue = B && ne, ye = (k = _c(k)).length;
      (ue || ye) && (x.polygonStart(), ue && (x.lineStart(), h(null, null, 1, x), x.lineEnd()), ye && mc(k, p, ne, h, x), x.polygonEnd()), I = x, k = E = N = null;
    }
    function te() {
      Y.point = q, E && E.push(N = []), M = !0, F = !1, P = C = NaN;
    }
    function ae() {
      k && (q(T, R), A && F && m.rejoin(), k.push(m.result())), Y.point = U, F && I.lineEnd();
    }
    function q(ne, ue) {
      var ye = c(ne, ue);
      if (E && N.push([ne, ue]), M)
        T = ne, R = ue, A = ye, M = !1, ye && (I.lineStart(), I.point(ne, ue));
      else if (ye && F) I.point(ne, ue);
      else {
        var ke = [P = Math.max(Er, Math.min(zn, P)), C = Math.max(Er, Math.min(zn, C))], Ie = [ne = Math.max(Er, Math.min(zn, ne)), ue = Math.max(Er, Math.min(zn, ue))];
        ld(ke, Ie, o, r, a, l) ? (F || (I.lineStart(), I.point(ke[0], ke[1])), I.point(Ie[0], Ie[1]), ye || I.lineEnd(), B = !1) : ye && (I.lineStart(), I.point(ne, ue), B = !1);
      }
      P = ne, C = ue, F = ye;
    }
    return Y;
...
function gd(o, r) {
  ...
  for (var p = 0, _ = o.length; p < _; ++p)
    if (I = (x = o[p]).length)
      for (var x, I, m = x[I - 1], k = m[0], E = m[1] / 2 + Au, N = xe(E), T = _e(E), R = 0; R < I; ++R, k = P, N = F, T = M, m = A) {
        var A = x[R], P = A[0], C = A[1] / 2 + Au, F = xe(C), M = _e(C), B = P - k, Y = B >= 0 ? 1 : -1, U = Y * B, X = U > ce, ie = N * F;
        if (Ki.add(pn(ie * Y * xe(U), T * M + ie * _e(U))), h += X ? B + Y * ct : B, X ^ k >= a ^ P >= a) {
          var ee = Qr(mn(m), mn(A));
          Ls(ee);
          var te = Qr(c, ee);
          Ls(te);
          var ae = (X ^ B >= 0 ? -1 : 1) * Ut(te[2]);
          (l > ae || l === ae && (ee[0] || ee[1])) && (v += X ^ B >= 0 ? 1 : -1);
        }
      }
  return (h < -ve || h < ve && Ki < -ve) ^ v & 1;
}
Pt();
function Yu(o) {
  return o;
...
Pt();
Pt();
var dn = 1 / 0, Kr = dn, Qn = -dn, ei = Qn, Uu = {
  point: yd,
  lineStart: qn,
  lineEnd: qn,
  polygonStart: qn,
  ...
  result: function() {
    var o = [[dn, Kr], [Qn, ei]];
    return Qn = ei = -(Kr = dn = 1 / 0), o;
  }
};
function yd(o, r) {
  o < dn && (dn = o), o > Qn && (Qn = o), r < Kr && (Kr = r), r > ei && (ei = r);
}
Pt();
function xc(o, r, a, l) {
  return function(c, h) {
    var v = r(h), p = c.invert(l[0], l[1]), _ = pc(), x = r(_), I = !1, m, k, E, N = {
      point: T,
      lineStart: A,
      lineEnd: P,
      polygonStart: function() {
        N.point = C, N.lineStart = F, N.lineEnd = M, k = [], m = [];
      },
      polygonEnd: function() {
        N.point = T, N.lineStart = A, N.lineEnd = P, k = _c(k);
        var B = gd(m, p);
        k.length ? (I || (h.polygonStart(), I = !0), mc(k, pd, B, a, h)) : B && (I || (h.polygonStart(), I = !0), h.lineStart(), a(null, null, 1, h), h.lineEnd()), I && (h.polygonEnd(), I = !1), k = m = null;
      },
      sphere: function() {
    ...
    function M() {
      C(E[0][0], E[0][1]), x.lineEnd();
      var B = x.clean(), Y = _.result(), U, X = Y.length, ie, ee, te;
      if (E.pop(), m.push(E), E = null, !!X) {
        if (B & 1) {
        ...
        X > 1 && B & 2 && Y.push(Y.pop().concat(Y.shift())), k.push(Y.filter(vd));
      }
    }
    return N;
  };
...
function md(o) {
  ...
  return {
    ...
    point: function(h, v) {
      ...
      we(_ - ce) < ve ? (o.point(r, a = (a + v) / 2 > 0 ? ut : -ut), o.point(l, a), o.lineEnd(), o.lineStart(), o.point(p, a), o.point(h, a), c = 0) : l !== p && _ >= ce && (we(r - l) < ve && (r -= l * ve), we(h - p) < ve && (h -= p * ve), a = dd(r, a, h, v), o.point(l, a), o.lineEnd(), o.lineStart(), o.point(p, a), c = 0), o.point(r = h, a = v), l = p;
    },
    lineEnd: function() {
      o.lineEnd(), r = a = NaN;
    },
...
function xd(o, r) {
  ...
  function p(I) {
    ...
    return {
      ...
      point: function(R, A) {
        var P = [R, A], C, F = v(R, A), M = l ? F ? 0 : x(R, A) : F ? x(R + (R < 0 ? ce : -ce), A) : 0;
        if (!m && (N = E = F) && I.lineStart(), F !== E && (C = _(m, P), (!C || Rr(m, C) || Rr(P, C)) && (P[0] += ve, P[1] += ve, F = v(P[0], P[1]))), F !== E)
          T = 0, F ? (I.lineStart(), C = _(P, m), I.point(C[0], C[1])) : (C = _(m, P), I.point(C[0], C[1]), I.lineEnd()), m = C;
        else if (c && m && l ^ F) {
          var B;
          !(M & k) && (B = _(P, m, !0)) && (T = 0, l ? (I.lineStart(), I.point(B[0][0], B[0][1]), I.point(B[1][0], B[1][1]), I.lineEnd()) : (I.point(B[1][0], B[1][1]), I.lineEnd(), I.lineStart(), I.point(B[0][0], B[0][1])));
        }
        F && (!m || !Rr(m, P)) && I.point(P[0], P[1]), m = P, E = F, k = M;
      },
      lineEnd: function() {
        E && I.lineEnd(), m = null;
      },
  ...
  function _(I, m, k) {
    var E = mn(I), N = mn(m), T = [1, 0, 0], R = Qr(E, N), A = dr(R, R), P = R[0], C = A - P * P;
    if (!C) return !k && I;
    var F = a * A / C, M = -a * P / C, B = Qr(T, R), Y = _r(T, F), U = _r(R, M);
    Qi(Y, U);
    var X = B, ie = dr(Y, X), ee = dr(X, X), te = ie * ie - ee * (dr(Y, Y) - 1);
    if (!(te < 0)) {
      var ae = In(te), q = _r(X, (-ie - ae) / ee);
      if (Qi(q, Y), q = Ts(q), !k) return q;
      ...
      if (!Re && ke < ye && (Ie = ye, ye = ke, ke = Ie), Se ? Re ? ye + ke > 0 ^ q[1] < (we(q[0] - ne) < ve ? ye : ke) : ye <= q[1] && q[1] <= ke : j > ce ^ (ne <= q[0] && q[0] <= ue)) {
        var Ae = _r(X, (-ie + ae) / ee);
        return Qi(Ae, Y), [q, Ts(Ae)];
      }
    }
  }
  function x(I, m) {
    var k = l ? o : ce - o, E = 0;
    return I < -k ? E |= 1 : I > k && (E |= 2), m < -k ? E |= 4 : m > k && (E |= 8), E;
  }
  return xc(v, p, h, l ? [0, -o] : [-ce, o - ce]);
}
function Ec(o) {
  return function(r) {
    var a = new Cs();
...
function kc(o, r, a) {
  ...
  o.scale(150).translate([0, 0]), h != null && o.clipExtent(null), ad(a, o.stream(Uu));
  var v = Uu.result(), p = Math.min(l / (v[1][0] - v[0][0]), c / (v[1][1] - v[0][1])), _ = +r[0][0] + (l - p * (v[1][0] + v[0][0])) / 2, x = +r[0][1] + (c - p * (v[1][1] + v[0][1])) / 2;
  return h != null && o.clipExtent(h), o.scale(p * 150).translate([_, x]);
}
function Ed(o, r, a) {
  return kc(o, [[0, 0], r], a);
}
var ju = 16, kd = _e(30 * Xe);
function Vu(o, r) {
...
function Sd(o, r) {
  function a(l, c, h, v, p, _, x, I, m, k, E, N, T, R) {
    var A = x - l, P = I - c, C = A * A + P * P;
    if (C > 4 * r && T--) {
      var F = v + k, M = p + E, B = _ + N, Y = In(F * F + M * M + B * B), U = Ut(B /= Y), X = we(we(B) - 1) < ve || we(h - m) < ve ? (h + m) / 2 : pn(M, F), ie = o(X, U), ee = ie[0], te = ie[1], ae = ee - l, q = te - c, ne = P * ae - A * q;
      (ne * ne / C > r || we((A * ae + P * q) / C - 0.5) > 0.3 || v * k + p * E + _ * N < kd) && (a(l, c, h, v, p, _, ee, te, X, F /= Y, M /= Y, B, T, R), R.point(ee, te), a(ee, te, X, F, M, B, x, I, m, k, E, N, T, R));
    }
  }
  return function(l) {
    var c, h, v, p, _, x, I, m, k, E, N, T, R = {
      point: A,
      lineStart: P,
      lineEnd: F,
      polygonStart: function() {
        l.polygonStart(), R.lineStart = M;
      },
      polygonEnd: function() {
        l.polygonEnd(), R.lineStart = P;
      }
    };
    function A(U, X) {
    ...
    function P() {
      m = NaN, R.point = C, l.lineStart();
    }
    function C(U, X) {
      var ie = mn([U, X]), ee = o(U, X);
      a(m, k, I, E, N, T, m = ee[0], k = ee[1], I = U, E = ie[0], N = ie[1], T = ie[2], ju, l), l.point(m, k);
    }
    function F() {
      R.point = A, l.lineEnd();
    }
    function M() {
      P(), R.point = B, R.lineEnd = Y;
    }
    function B(U, X) {
      C(c = U, X), h = m, v = k, p = E, _ = N, x = T, R.point = C;
    }
    function Y() {
      a(m, k, I, E, N, T, h, v, c, p, _, x, ju, l), R.lineEnd = F, F();
    }
    return R;
  };
}
...
function bd(o) {
  var r, a = 150, l = 480, c = 250, h, v, p = 0, _ = 0, x = 0, I = 0, m = 0, k, E, N = null, T = Xu, R = null, A, P, C, F = Yu, M = 0.5, B = Vu(ee, M), Y, U;
  function X(q) {
    return q = E(q[0] * Xe, q[1] * Xe), [q[0] * a + h, v - q[1] * a];
  }
  function ie(q) {
    return q = E.invert((q[0] - h) / a, (v - q[1]) / a), q && [q[0] * St, q[1] * St];
  }
  function ee(q, ne) {
    return q = r(q, ne), [q[0] * a + h, v - q[1] * a];
  }
  X.stream = function(q) {
    return Y && U === q ? Y : Y = Nd(T(k, B(F(U = q))));
  }, X.clipAngle = function(q) {
    return arguments.length ? (T = +q ? xd(N = q * Xe, 6 * Xe) : (N = null, Xu), ae()) : N * St;
  }, X.clipExtent = function(q) {
    return arguments.length ? (F = q == null ? (R = A = P = C = null, Yu) : hd(R = +q[0][0], A = +q[0][1], P = +q[1][0], C = +q[1][1]), ae()) : R == null ? null : [[R, A], [P, C]];
  }, X.scale = function(q) {
    ...
    return arguments.length ? (B = Vu(ee, M = q * q), ae()) : In(M);
...
function Sc(o) {
  return function(r, a) {
    var l = In(r * r + a * a), c = o(l), h = xe(c), v = _e(c);
    return [
      pn(r * h, l * v),
      Ut(l && a * h / l)
    ];
...
var Od = Ic(function(o) {
  return In(2 / (1 + o));
});
Od.invert = Sc(function(o) {
  return 2 * Ut(o / 2);
});
var Nc = Ic(function(o) {
  return (o = yc(o)) && o / xe(o);
});
Nc.invert = Sc(function(o) {
  return o;
});
function Td() {
  return wd(Nc).scale(79.4188).clipAngle(180 - 1e-3);
}
function Wu(o, r) {
  return [o, r];
}
Wu.invert = Wu;
var Ld = Object.defineProperty, Sn = (o, r) => Ld(o, "name", { value: r, configurable: !0 }), { BufferOp: Rd, GeoJSONReader: Cd, GeoJSONWriter: Pd } = id;
function wc(o, r, a) {
  a = a || {};
...
function Vn(o, r, a, l) {
  ...
  var p = bc(h), _ = {
    type: h.type,
    coordinates: ea(h.coordinates, p)
  }, x = new Cd(), I = x.read(_), m = Hs(ii(r, a), "meters"), k = Rd.bufferOp(I, m, l), E = new Pd();
  if (k = E.write(k), !Ks(k.coordinates)) {
    var N = {
      type: k.type,
      coordinates: ta(k.coordinates, p)
    };
    return Ve(N, c);
  }
}
Sn(Vn, "bufferFeature");
function Ks(o) {
  return Array.isArray(o[0]) ? Ks(o[0]) : isNaN(o[0]);
}
Sn(Ks, "coordsIsNaN");
function ea(o, r) {
...
Sn(ta, "unprojectCoords");
function bc(o) {
  var r = hc(o).geometry.coordinates, a = [-r[0], -r[1]];
  return Td().rotate(a).scale(Me);
}
Sn(bc, "defineProjection");
var Ad = wc, Md = Object.defineProperty, Dd = (o, r) => Md(o, "name", { value: r, configurable: !0 });
function Oc(o) {
  const r = [];
  if (Vt(o, (c) => {
  ...
  const a = o.features[0].properties || {}, l = nc.difference(r[0], ...r.slice(1));
  return l.length === 0 ? null : l.length === 1 ? En(l[0], a) : ri(l, a);
}
Dd(Oc, "difference");
var Fd = Oc;
function Hu(o) {
...
function Bd(o, r = !0, a = !0, l = {}, c = {}, h = (v) => {
  var x, I, m;
  const p = (x = v == null ? void 0 : v.geometry) == null ? void 0 : x.type, _ = (I = v == null ? void 0 : v.properties) != null && I.isMask ? 0 : p === "LineString" || p === "MultiLineString" ? 3 : 2;
  return {
    color: "#3170fe",
    fillColor: "#000",
    fillOpacity: (m = v == null ? void 0 : v.properties) != null && m.isMask ? 0.1 : 0,
    weight: _,
    dashArray: [_, _],
    lineCap: "butt"
  };
  ...
  function k(E, N = !1) {
    ...
    return new Qm({ props: { displayIn: "leaflet" }, target: T }), new nn.Marker(E, {
      interactive: N,
      icon: new nn.DivIcon({
        html: T,
        className: "",
  ...
  return {
    setEventHandler(E) {
      E ? (v = E, o.on("click", m)) : (v = void 0, o.off("click", m));
    },
    flyTo(E, N) {
      o.flyTo([E[1], E[0]], N, { duration: 2, ...l });
    },
    fitBounds(E, N, T) {
      o.flyToBounds(
        [
        ...
        { padding: [N, N], duration: 2, maxZoom: T, ...c }
      );
    },
    indicateReverse(E) {
    ...
    setReverseMarker(E) {
      ...
      if (!r)
        return;
      const N = E && [E[1], E[0]];
      x ? N ? x.setLatLng(N) : (x.remove(), x = void 0) : N && (x = (typeof r == "object" ? new nn.Marker(N, r) : k(N)).addTo(o), (T = x.getElement()) == null || T.classList.add("marker-reverse"));
    },
    setMarkers(E, N) {
      if (!r)
        return;
      function T(R) {
        I.clearLayers(), R && I.addData(R);
      }
      for (const R of p)
        R.remove();
      if (p.length = 0, T(), N) {
        ...
        if (N.geometry.type === "GeometryCollection") {
          const P = N.geometry.geometries.filter(
          ...
          e: if (P.length > 0) {
            ...
            const C = N.geometry.geometries.filter(
              (F) => F.type === "LineString" || F.type === "MultiLineString"
            );
            C.length > 0 && (T({
              ...N,
        ...
        const A = [N.center[1], N.center[0]];
        p.push(
          (typeof r == "object" ? new nn.Marker(A, r) : k(A)).addTo(o)
        );
      }
      if (a)
        for (const R of E ?? []) {
          ...
          const A = [
            R.center[1],
            R.center[0]
          ], P = typeof a == "object" ? new nn.Marker(A, a) : k(A, !0);
          P.addTo(o).bindTooltip(
            R.place_type[0] === "reverse" ? R.place_name : R.place_name.replace(/,.*/, ""),
            {
              direction: "top"
            }
          );
          const C = P.getElement();
          C && (C.addEventListener("click", (F) => {
            F.stopPropagation(), v == null || v({ type: "markerClick", id: R.id });
          }), C.addEventListener("mouseenter", () => {
            v == null || v({ type: "markerMouseEnter", id: R.id });
          }), C.addEventListener("mouseleave", () => {
            v == null || v({ type: "markerMouseLeave", id: R.id });
          }), C.classList.toggle("marker-fuzzy", !!R.matching_text)), p.push(P);
        }
    },
    setSelectedMarker(E) {
      var N, T;
      _ && ((N = _.getElement()) == null || N.classList.toggle("marker-selected", !1)), _ = E > -1 ? p[E] : void 0, (T = _ == null ? void 0 : _.getElement()) == null || T.classList.toggle("marker-selected", !0);
    },
    getCenterAndZoom() {
      const E = o.getCenter();
...
export {
  Bd as createLeafletMapController
};
