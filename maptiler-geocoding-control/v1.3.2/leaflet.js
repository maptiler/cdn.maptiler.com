...
var Fh = (a, r, i) => r in a ? Dh(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i }) : a[r] = i;
var Ss = (a, r, i) => Fh(a, typeof r != "symbol" ? r + "" : r, i), Fo = (a, r, i) => r.has(a) || Do("Cannot " + i);
var Lt = (a, r, i) => (Fo(a, r, "read from private field"), i ? i.call(a) : r.get(a)), bs = (a, r, i) => r.has(a) ? Do("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(a) : r.set(a, i), ai = (a, r, i, u) => (Fo(a, r, "write to private field"), u ? u.call(a, i) : r.set(a, i), i);
...
const $n = [], Qs = [];
let nr = [];
const Uo = [], Qh = /* @__PURE__ */ Promise.resolve();
let Ks = !1;
function Kh() {
  Ks || (Ks = !0, Qh.then(ac));
}
...
function tg(a, r, i, u, l, f, v, y, m, _, x, p) {
...
function Jt(a, r, i) {
  ...
  u && u.m(r, i), Js(() => {
    const f = a.$$.on_mount.map(nc).filter(rc);
    a.$$.on_destroy ? a.$$.on_destroy.push(...f) : en(f), a.$$.on_mount = [];
  }), l.forEach(Js);
}
function $t(a, r) {
  const i = a.$$;
  i.fragment !== null && ($h(i.after_update), en(i.on_destroy), i.fragment && i.fragment.d(r), i.on_destroy = i.fragment = null, i.ctx = []);
}
function ng(a, r) {
  a.$$.dirty[0] === -1 && ($n.push(a), Kh(), a.$$.dirty.fill(0)), a.$$.dirty[r / 31 | 0] |= 1 << r % 31;
}
function yn(a, r, i, u, l, f, v = null, y = [-1]) {
  ...
  if (_.ctx = i ? i(a, r.props || {}, (p, S, ...k) => {
    ...
    return _.ctx && l(_.ctx[p], _.ctx[p] = b) && (!_.skip_bound && _.bound[p] && _.bound[p](b), x && ng(a, p)), S;
    ...
    r.intro && Be(a.$$.fragment), Jt(a, r.target, r.anchor), ac();
  }
  Fr(m);
}
class vn {
...
function yg(a) {
  ...
  return {
    ...
    p(D, [H]) {
      ...
      D[5]) && !/*isReverse*/
      D[7]), S ? z ? z.p(D, H) : (z = Wo(D), z.c(), z.m(y, null)) : z && (z.d(1), z = null), H & /*feature*/
      1 && C !== (C = /*isReverse*/
      (D[7] ? "" : (
        /*feature*/
...
class kg extends vn {
  constructor(r) {
    super(), yn(this, r, Eg, _g, gn, { displayIn: 0 });
  }
}
function xg(a) {
  let r, i;
...
const Lg = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(EAST|WEST|[EW])?$/i, jo = /^([+-]?[0-8]?[0-9])\s+([0-5]?[0-9]\.\d{3,})[\s,]{1,}([+-]?[0-1]?[0-9]?[0-9])\s+([0-5]?[0-9]\.\d{3,})$/, Vo = /^(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?$/i, Ho = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?$/i, Zo = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?$/i, Qo = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?$/i;
function Tg(a) {
  ...
  if (this.decimalCoordinates && this.decimalCoordinates.trim()) {
    ...
    if (a == "DM") {
      let k = Ko(p, 3).toFixed(3).padStart(6, "0"), b = Ko(S, 3).toFixed(3).padStart(6, "0");
...
function Ca(a, r) {
  ...
  if (jo.test(a))
    ...
    if (y = Qo.exec(a), m = Tr(y), y.filter((_) => _).length <= 5)
...
const Fg = Dg();
Ca.formats = Fg.map((a) => a.verbatimCoordinates);
const Bg = Ca;
function $o(a, r, i) {
  const u = a.slice();
...
function Gg(a) {
  let r, i = [], u = /* @__PURE__ */ new Map(), l, f, v, y = Yo(
    /*listFeatures*/
    a[14]
  );
  const m = (_) => (
  ...
  return {
    ...
    p(_, x) {
      ...
      17880064 && (y = Yo(
        /*listFeatures*/
        _[14]
      ), mi(), i = tg(i, x, m, 1, _, y, u, r, eg, nu, null, $o), pi());
    },
    i(_) {
      if (!l) {
...
function nu(a, r) {
  ...
  return u = new dg({
    ...
    first: null,
    c() {
      i = Wh(), fn(u.$$.fragment), this.first = i;
    },
    m(y, m) {
...
function Yg(a) {
  ...
  return ~(L = ae(a)) && (M = Z[L] = ee[L](a)), {
    ...
    m(F, Q) {
      Re(F, r, Q), Re(F, i, Q), ve(i, u), ve(u, l), Jt(f, l, null), ve(u, v), ve(u, y), a[61](y), qo(
        y,
        /*searchValue*/
        a[1]
    ...
    p(F, Q) {
      ...
      32 && Be(U, 1)) : (U = tu(F), U.c(), Be(U, 1), U.m(u, b)) : U && (mi(), Ye(U, 1, 1, () => {
        U = null;
...
function Wg(a, r, i) {
  ...
  const En = /* @__PURE__ */ new Set(), st = Zh();
  Hh(() => {
  ...
  function ge() {
    ...
    R && Ne.length > 0 && (oe && G[0] === G[2] && G[1] === G[3] ? R.flyTo(oe.center, Fe) : R.fitBounds(Xo(G), 50, we));
  }
  function se(G) {
    i(0, H = b === "always"), i(14, le = void 0), i(55, oe = void 0), i(15, be = -1), Kr(G[1].toFixed(6) + ", " + wg(G[0], [-180, 180], !0).toFixed(6), !1, !0);
  }
  function rs(G) {
    if (!le)
      return;
  ...
  return a.$$set = (G) => {
    ...
    50356241 && (R && oe && oe.id !== ue && M && (!oe.bbox || oe.bbox[0] === oe.bbox[2] && oe.bbox[1] === oe.bbox[3] ? R.flyTo(oe.center, oe.id.startsWith("poi.") || oe.id.startsWith("address.") ? we : Fe) : R.fitBounds(Xo(oe.bbox), 50, we), i(14, le = void 0), i(54, Ne = void 0), i(15, be = -1)), i(56, ue = oe == null ? void 0 : oe.id)), a.$$.dirty[0] & /*selectFirst, listFeatures*/
...
var ru = Object.prototype.toString, cc = function(r) {
...
function Vg() {
  ...
  var a;
  if (!Object.keys) {
    var r = Object.prototype.hasOwnProperty, i = Object.prototype.toString, u = cc, l = Object.prototype.propertyIsEnumerable, f = !l.call({ toString: null }, "toString"), v = l.call(function() {
    }, "prototype"), y = [
      "toString",
      "toLocaleString",
      "valueOf",
...
var Hg = Array.prototype.slice, Zg = cc, su = Object.keys, _i = su ? function(r) {
  return su(r);
} : Vg(), au = Object.keys;
_i.shim = function() {
  if (Object.keys) {
    ...
    r || (Object.keys = function(u) {
      return Zg(u) ? au(Hg.call(u)) : au(u);
    });
  } else
    Object.keys = _i;
  return Object.keys || _i;
};
var Oa = _i, Qg = Error, Kg = EvalError, Jg = RangeError, $g = ReferenceError, fc = SyntaxError, dn = TypeError, ey = URIError, Ji = function() {
  ...
  return !0;
}, ou = typeof Symbol < "u" && Symbol, ty = Ji, Ra = function() {
  return typeof ou != "function" || typeof Symbol != "function" || typeof ou("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : ty();
}, Ns = {
  __proto__: null,
  foo: {}
}, ny = Object, ry = function() {
  return { __proto__: Ns }.foo === Ns.foo && !(Ns instanceof ny);
}, iy = "Function.prototype.bind called on incompatible ", sy = Object.prototype.toString, ay = Math.max, oy = "[object Function]", uu = function(r, i) {
  ...
  return l;
}, fy = cy, Ma = Function.prototype.bind || fy, hy = Function.prototype.call, gy = Object.prototype.hasOwnProperty, yy = Ma, hc = yy.call(hy, gy), ye, vy = Qg, dy = Kg, my = Jg, py = $g, ir = fc, rr = dn, _y = ey, gc = Function, Ls = function(a) {
  try {
    return gc('"use strict"; return (' + a + ").constructor;")();
  } catch {
  }
...
}() : Ts, Qn = Ra(), ky = ry(), Ue = Object.getPrototypeOf || (ky ? function(a) {
  return a.__proto__;
} : null), er = {}, xy = typeof Uint8Array > "u" || !Ue ? ye : Ue(Uint8Array), On = {
  __proto__: null,
...
var by = function a(r) {
...
}, Hr = Ma, Ti = hc, Iy = Hr.call(Function.call, Array.prototype.concat), wy = Hr.call(Function.apply, Array.prototype.splice), cu = Hr.call(Function.call, String.prototype.replace), Ci = Hr.call(Function.call, String.prototype.slice), Ny = Hr.call(Function.call, RegExp.prototype.exec), Ly = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, Ty = /\\(\\)?/g, Cy = function(r) {
  ...
  var l = [];
  return cu(r, Ly, function(f, v, y, m) {
    l[l.length] = y ? cu(m, Ty, "$1") : v || f;
  }), l;
}, Oy = function(r, i) {
  var u = r, l;
  if (Ti(lu, u) && (l = lu[u], u = "%" + l[0] + "%"), Ti(On, u)) {
    var f = On[u];
    if (f === er && (f = by(u)), typeof f > "u" && !i)
...
var Ry = Ut, Ei = Ry("%Object.getOwnPropertyDescriptor%", !0);
if (Ei)
  try {
    Ei([], "length");
  } catch {
...
var Aa = Ei, hu = Pa(), My = fc, Kn = dn, gu = Aa, Da = function(r, i, u) {
  ...
  var l = arguments.length > 3 ? arguments[3] : null, f = arguments.length > 4 ? arguments[4] : null, v = arguments.length > 5 ? arguments[5] : null, y = arguments.length > 6 ? arguments[6] : !1, m = !!gu && gu(r, i);
  if (hu)
    hu(r, i, {
...
yc.hasArrayLengthDefineBug = function() {
  if (!$s)
    return null;
  try {
...
var Fa = yc, Py = Oa, Ay = typeof Symbol == "function" && typeof Symbol("foo") == "symbol", Dy = Object.prototype.toString, Fy = Array.prototype.concat, yu = Da, By = function(a) {
  return typeof a == "function" && Dy.call(a) === "[object Function]";
}, vc = Fa(), Gy = function(a, r, i, u) {
  if (r in a) {
    if (u === !0) {
      if (a[r] === i)
        return;
...
dc.supportsDescriptors = !!vc;
var Mn = dc, mc = { exports: {} }, qy = Ut, vu = Da, zy = Fa(), du = Aa, mu = dn, Uy = qy("%Math.floor%"), Yy = function(r, i) {
  if (typeof r != "function")
...
(function(a) {
  var r = Ma, i = Ut, u = Yy, l = dn, f = i("%Function.prototype.apply%"), v = i("%Function.prototype.call%"), y = i("%Reflect.apply%", !0) || r.call(v, f), m = Pa(), _ = i("%Math.max%");
...
var cr = mc.exports, pc = Ut, _c = cr, Wy = _c(pc("String.prototype.indexOf")), bt = function(r, i) {
  var u = pc(r, !!i);
  return typeof u == "function" && Wy(r, ".prototype.") > -1 ? _c(u) : u;
}, Xy = Oa, Ec = Ji(), kc = bt, pu = Object, jy = kc("Array.prototype.push"), _u = kc("Object.prototype.propertyIsEnumerable"), Vy = Ec ? Object.getOwnPropertySymbols : null, xc = function(r, i) {
  if (r == null)
  ...
  for (var l = 1; l < arguments.length; ++l) {
    var f = pu(arguments[l]), v = Xy(f), y = Ec && (Object.getOwnPropertySymbols || Vy);
    if (y)
...
}, $y = Mn, ev = cr, tv = xc, bc = Sc, nv = Jy, rv = ev.apply(bc()), Ic = function(r, i) {
...
Xr.boundFunctionsHaveNames = function() {
  return Xr() && typeof sv == "function" && (function() {
  }).bind().name !== "";
};
var av = Xr, Eu = Da, ov = Fa(), uv = av.functionsHaveConfigurableNames(), lv = dn, cv = function(r, i) {
  if (typeof r != "function")
...
}, fv = cv, hv = dn, gv = Object, wc = fv(function() {
...
}, "get flags", !0), yv = wc, vv = Mn.supportsDescriptors, dv = Object.getOwnPropertyDescriptor, Nc = function() {
  ...
  return yv;
}, mv = Mn.supportsDescriptors, pv = Nc, _v = Object.getOwnPropertyDescriptor, Ev = Object.defineProperty, kv = TypeError, ku = Object.getPrototypeOf, xv = /a/, Sv = function() {
  if (!mv || !ku)
    throw new kv("RegExp.prototype.flags requires a true ES5 environment that supports property descriptors");
  var r = pv(), i = ku(xv), u = _v(i, "flags");
  return (!u || u.get !== r) && Ev(i, "flags", {
    configurable: !0,
    enumerable: !1,
    get: r
  }), r;
}, bv = Mn, Iv = cr, wv = wc, Lc = Nc, Nv = Sv, Tc = Iv(Lc());
bv(Tc, {
  getPolyfill: Lc,
  implementation: wv,
  shim: Nv
});
var Lv = Tc, ki = { exports: {} }, Tv = Ji, Pn = function() {
  return Tv() && !!Symbol.toStringTag;
}, Cv = Pn(), Ov = bt, ea = Ov("Object.prototype.toString"), $i = function(r) {
...
$i.isLegacyArguments = Cc;
var Oc = Rv ? $i : Cc;
const Mv = {}, Pv = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Mv
}, Symbol.toStringTag, { value: "Module" })), Av = /* @__PURE__ */ jg(Pv);
var Ba = typeof Map == "function" && Map.prototype, Rs = Object.getOwnPropertyDescriptor && Ba ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null, Oi = Ba && Rs && typeof Rs.get == "function" ? Rs.get : null, xu = Ba && Map.prototype.forEach, Ga = typeof Set == "function" && Set.prototype, Ms = Object.getOwnPropertyDescriptor && Ga ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null, Ri = Ga && Ms && typeof Ms.get == "function" ? Ms.get : null, Su = Ga && Set.prototype.forEach, Dv = typeof WeakMap == "function" && WeakMap.prototype, Gr = Dv ? WeakMap.prototype.has : null, Fv = typeof WeakSet == "function" && WeakSet.prototype, qr = Fv ? WeakSet.prototype.has : null, Bv = typeof WeakRef == "function" && WeakRef.prototype, bu = Bv ? WeakRef.prototype.deref : null, Gv = Boolean.prototype.valueOf, qv = Object.prototype.toString, zv = Function.prototype.toString, Uv = String.prototype.match, qa = String.prototype.slice, on = String.prototype.replace, Yv = String.prototype.toUpperCase, Iu = String.prototype.toLowerCase, Rc = RegExp.prototype.test, wu = Array.prototype.concat, Ft = Array.prototype.join, Wv = Array.prototype.slice, Nu = Math.floor, ta = typeof BigInt == "function" ? BigInt.prototype.valueOf : null, Ps = Object.getOwnPropertySymbols, na = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? Symbol.prototype.toString : null, sr = typeof Symbol == "function" && typeof Symbol.iterator == "object", Ze = typeof Symbol == "function" && Symbol.toStringTag && (typeof Symbol.toStringTag === sr || !0) ? Symbol.toStringTag : null, Mc = Object.prototype.propertyIsEnumerable, Lu = (typeof Reflect == "function" ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(a) {
  return a.__proto__;
} : null);
function Tu(a, r) {
  if (a === 1 / 0 || a === -1 / 0 || a !== a || a && a > -1e3 && a < 1e3 || Rc.call(/e/, r))
    return r;
...
var ra = Av, Cu = ra.custom, Ou = Ac(Cu) ? Cu : null, Xv = function a(r, i, u, l) {
  var f = i || {};
  ...
  if (ad(r)) {
    for (var L = "<" + Iu.call(String(r.nodeName)), M = r.attributes || [], P = 0; P < M.length; P++)
      L += " " + M[P].name + "=" + Pc(jv(M[P].value), "double", f);
  ...
  if (ia(r)) {
    if (r.length === 0)
      return "[]";
    var O = ui(r, S);
    return p && !ud(O) ? "[" + sa(O, p) + "]" : "[ " + Ft.call(O, ", ") + " ]";
  }
  if (Hv(r)) {
    var A = ui(r, S);
    return !("cause" in Error.prototype) && "cause" in r && !Mc.call(r, "cause") ? "{ [" + String(r) + "] " + Ft.call(wu.call("[cause]: " + S(r.cause), A), ", ") + " }" : A.length === 0 ? "[" + String(r) + "]" : "{ [" + String(r) + "] " + Ft.call(A, ", ") + " }";
  }
  if (typeof r == "object" && v) {
    if (Ou && typeof r[Ou] == "function" && ra)
  ...
  if (td(r)) {
    var R = [];
    return xu && xu.call(r, function(ae, F) {
      R.push(S(F, r, !0) + " => " + S(ae, r));
    }), Mu("Map", Oi.call(r), R, p);
  }
  if (id(r)) {
    var z = [];
    return Su && Su.call(r, function(ae) {
      z.push(S(ae, r));
    }), Mu("Set", Ri.call(r), z, p);
  }
  if (nd(r))
    return As("WeakMap");
  if (sd(r))
  ...
  if (!Vv(r) && !Ru(r)) {
    var q = ui(r, S), U = Lu ? Lu(r) === Object.prototype : r instanceof Object || r.constructor === Object, D = r instanceof Object ? "" : "null prototype", H = !U && Ze && Object(r) === r && Ze in r ? qa.call(mn(r), 8, -1) : D ? "Object" : "", ee = U || typeof r.constructor != "function" ? "" : r.constructor.name ? r.constructor.name + " " : "", Z = ee + (H || D ? "[" + Ft.call(wu.call([], H || [], D || []), ": ") + "] " : "");
...
function Fc(a, r) {
  if (a.length > r.maxStringLength) {
    ...
    return Fc(qa.call(a, 0, r.maxStringLength), r) + u;
  }
  var l = on.call(on.call(a, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, od);
  return Pc(l, "single", r);
}
function od(a) {
...
function ui(a, r) {
  ...
  var f = typeof Ps == "function" ? Ps(a) : [], v;
  if (sr) {
    v = {};
  ...
  for (var m in a)
    sn(a, m) && (i && String(Number(m)) === m && m < a.length || sr && v["$" + m] instanceof Symbol || (Rc.call(/[^\w$]/, m) ? u.push(r(m, a) + ": " + r(a[m], a)) : u.push(m + ": " + r(a[m], a))));
  if (typeof Ps == "function")
    for (var _ = 0; _ < f.length; _++)
      Mc.call(a, f[_]) && u.push("[" + r(f[_]) + "]: " + r(a[f[_]], a));
  return u;
}
var Bc = Ut, fr = bt, cd = Xv, fd = dn, li = Bc("%WeakMap%", !0), ci = Bc("%Map%", !0), hd = fr("WeakMap.prototype.get", !0), gd = fr("WeakMap.prototype.set", !0), yd = fr("WeakMap.prototype.has", !0), vd = fr("Map.prototype.get", !0), dd = fr("Map.prototype.set", !0), md = fr("Map.prototype.has", !0), za = function(a, r) {
  ...
  var r, i, u, l = {
    assert: function(f) {
      if (!l.has(f))
        throw new fd("Side channel does not contain " + cd(f));
    },
    get: function(f) {
    ...
    set: function(f, v) {
      li && f && (typeof f == "object" || typeof f == "function") ? (r || (r = new li()), gd(r, f, v)) : ci ? (i || (i = new ci()), dd(i, f, v)) : (u || (u = { key: {}, next: null }), _d(u, f, v));
    }
  };
  return l;
}, kd = hc, Or = Gc(), Ht = dn, Ua = {
  assert: function(a, r) {
...
var xd = Ua, Rr = xd, Sd = SyntaxError, Pu = typeof StopIteration == "object" ? StopIteration : null, bd = function(r) {
  if (!Pu)
...
}, Id = {}.toString, qc = Array.isArray || function(a) {
  return Id.call(a) == "[object Array]";
...
}, Ld = Object.prototype.toString, Td = "[object String]", Cd = Pn(), zc = function(r) {
  return typeof r == "string" ? !0 : typeof r != "object" ? !1 : Cd ? Nd(r) : Ld.call(r) === Td;
}, Ya = typeof Map == "function" && Map.prototype ? Map : null, Od = typeof Set == "function" && Set.prototype ? Set : null, Mi;
Ya || (Mi = function(r) {
  return !1;
});
var Uc = Ya ? Map.prototype.has : null, Au = Od ? Set.prototype.has : null;
!Mi && !Uc && (Mi = function(r) {
  return !1;
});
var Yc = Mi || function(r) {
  ...
  return !1;
}, Rd = typeof Map == "function" && Map.prototype ? Map : null, Wa = typeof Set == "function" && Set.prototype ? Set : null, Pi;
Wa || (Pi = function(r) {
  return !1;
});
var Du = Rd ? Map.prototype.has : null, Wc = Wa ? Set.prototype.has : null;
!Pi && !Wc && (Pi = function(r) {
  return !1;
});
var Xc = Pi || function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    if (Wc.call(r), Du)
...
if (Ra() || Ji()) {
  ...
  var Md = qc, Pd = zc, Gu = Ut, Ad = Gu("%Map%", !0), Dd = Gu("%Set%", !0), Tt = bt, qu = Tt("Array.prototype.push"), zu = Tt("String.prototype.charCodeAt"), Fd = Tt("String.prototype.slice"), Bd = function(r, i) {
    var u = r.length;
    if (i + 1 >= u)
      return i + 1;
    var l = zu(r, i);
  ...
  if (!Ad && !Dd)
    ...
    var Gd = Yc, qd = Xc, Yu = Tt("Map.prototype.forEach", !0), Wu = Tt("Set.prototype.forEach", !0);
    if (typeof process > "u" || !process.versions || !process.versions.node)
      var Xu = Tt("Map.prototype.iterator", !0), ju = Tt("Set.prototype.iterator", !0);
    var Vu = Tt("Map.prototype.@@iterator", !0) || Tt("Map.prototype._es6-shim iterator_", !0), Hu = Tt("Set.prototype.@@iterator", !0) || Tt("Set.prototype._es6-shim iterator_", !0), zd = function(r) {
      if (Gd(r)) {
        if (Xu)
          return Bu(Xu(r));
        if (Vu)
...
var Ud = ki.exports, Zu = function(a) {
  return a !== a;
}, jc = function(r, i) {
  return r === 0 && i === 0 ? 1 / r === 1 / i : !!(r === i || Zu(r) && Zu(i));
}, Yd = jc, Vc = function() {
  return typeof Object.is == "function" ? Object.is : Yd;
}, Wd = Vc, Xd = Mn, jd = function() {
  var r = Wd();
...
}, Vd = Mn, Hd = cr, Zd = jc, Hc = Vc, Qd = jd, Zc = Hd(Hc(), Object);
Vd(Zc, {
  getPolyfill: Hc,
  implementation: Zd,
  shim: Qd
});
var Kd = Zc, Jd = cr, Qc = bt, $d = Ut, aa = $d("%ArrayBuffer%", !0), xi = Qc("ArrayBuffer.prototype.byteLength", !0), em = Qc("Object.prototype.toString"), Qu = !!aa && !xi && new aa(0).slice, Ku = !!Qu && Jd(Qu), Kc = xi || Ku ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    return xi ? xi(r) : Ku(r, 0), !0;
  } catch {
    return !1;
  }
} : aa ? function(r) {
  return em(r) === "[object ArrayBuffer]";
} : function(r) {
  return !1;
}, tm = Date.prototype.getDay, nm = function(r) {
  try {
    return tm.call(r), !0;
  } catch {
    return !1;
  }
}, rm = Object.prototype.toString, im = "[object Date]", sm = Pn(), am = function(r) {
  return typeof r != "object" || r === null ? !1 : sm ? nm(r) : rm.call(r) === im;
}, oa = bt, Jc = Pn(), $c, ef, ua, la;
if (Jc) {
  $c = oa("Object.prototype.hasOwnProperty"), ef = oa("RegExp.prototype.exec"), ua = {};
  var Bs = function() {
    throw ua;
  };
  la = {
...
var om = oa("Object.prototype.toString"), um = Object.getOwnPropertyDescriptor, lm = "[object RegExp]", cm = Jc ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  var i = um(r, "lastIndex"), u = i && $c(i, "value");
  if (!u)
    return !1;
  try {
    ef(r, la);
...
}, fm = bt, Ju = fm("SharedArrayBuffer.prototype.byteLength", !0), hm = Ju ? function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    return Ju(r), !0;
  ...
  return !1;
}, gm = Number.prototype.toString, ym = function(r) {
  try {
    return gm.call(r), !0;
  } catch {
    return !1;
  }
}, vm = Object.prototype.toString, dm = "[object Number]", mm = Pn(), pm = function(r) {
  return typeof r == "number" ? !0 : typeof r != "object" ? !1 : mm ? ym(r) : vm.call(r) === dm;
}, tf = bt, _m = tf("Boolean.prototype.toString"), Em = tf("Object.prototype.toString"), km = function(r) {
  try {
    return _m(r), !0;
  } catch {
    return !1;
  }
}, xm = "[object Boolean]", Sm = Pn(), bm = function(r) {
  return typeof r == "boolean" ? !0 : r === null || typeof r != "object" ? !1 : Sm && Symbol.toStringTag in r ? km(r) : Em(r) === xm;
}, ca = { exports: {} }, Im = Object.prototype.toString, wm = Ra();
if (wm) {
  var Nm = Symbol.prototype.toString, Lm = /^Symbol\(.*\)$/, Tm = function(r) {
    return typeof r.valueOf() != "symbol" ? !1 : Lm.test(Nm.call(r));
  };
  ca.exports = function(r) {
    if (typeof r == "symbol")
      return !0;
    if (Im.call(r) !== "[object Symbol]")
      return !1;
    try {
      return Tm(r);
    } catch {
...
var Cm = ca.exports, fa = { exports: {} }, $u = typeof BigInt < "u" && BigInt, Om = function() {
  return typeof $u == "function" && typeof BigInt == "function" && typeof $u(42) == "bigint" && typeof BigInt(42) == "bigint";
}, Rm = Om();
if (Rm) {
  ...
  fa.exports = function(r) {
    return r === null || typeof r > "u" || typeof r == "boolean" || typeof r == "string" || typeof r == "number" || typeof r == "symbol" || typeof r == "function" ? !1 : typeof r == "bigint" ? !0 : Pm(r);
  };
} else
  fa.exports = function(r) {
    return !1;
  };
var Am = fa.exports, Dm = zc, Fm = pm, Bm = bm, Gm = Cm, qm = Am, zm = function(r) {
  ...
  if (qm(r))
    return "BigInt";
}, Ai = typeof WeakMap == "function" && WeakMap.prototype ? WeakMap : null, el = typeof WeakSet == "function" && WeakSet.prototype ? WeakSet : null, Di;
Ai || (Di = function(r) {
  return !1;
});
var ha = Ai ? Ai.prototype.has : null, Gs = el ? el.prototype.has : null;
!Di && !ha && (Di = function(r) {
  return !1;
});
var Um = Di || function(r) {
  if (!r || typeof r != "object")
    return !1;
  try {
    if (ha.call(r, ha), Gs)
  ...
  return !1;
}, ga = { exports: {} }, Ym = Ut, nf = bt, Wm = Ym("%WeakSet%", !0), qs = nf("WeakSet.prototype.has", !0);
if (qs) {
  var zs = nf("WeakMap.prototype.has", !0);
...
var Xm = ga.exports, jm = Yc, Vm = Xc, Hm = Um, Zm = Xm, Qm = function(r) {
  if (r && typeof r == "object") {
    if (jm(r))
      return "Map";
    if (Vm(r))
  ...
  return !1;
}, rf = Function.prototype.toString, tr = typeof Reflect == "object" && Reflect !== null && Reflect.apply, ya, Si;
if (typeof tr == "function" && typeof Object.defineProperty == "function")
  ...
  tr = null;
var Km = /^\s*class\b/, va = function(r) {
  try {
    var i = rf.call(r);
    return Km.test(i);
  } catch {
  ...
  try {
    return va(r) ? !1 : (rf.call(r), !0);
  } catch {
    return !1;
  }
}, bi = Object.prototype.toString, Jm = "[object Object]", $m = "[object Function]", ep = "[object GeneratorFunction]", tp = "[object HTMLAllCollection]", np = "[object HTML document.all class]", rp = "[object HTMLCollection]", ip = typeof Symbol == "function" && !!Symbol.toStringTag, sp = !(0 in [,]), da = function() {
  return !1;
};
if (typeof document == "object") {
  var ap = document.all;
  bi.call(ap) === bi.call(document.all) && (da = function(r) {
...
var op = tr ? function(r) {
  ...
  if (va(r))
    return !1;
  var i = bi.call(r);
  return i !== $m && i !== ep && !/^\[object HTML/.test(i) ? !1 : Us(r);
}, up = op, lp = Object.prototype.toString, sf = Object.prototype.hasOwnProperty, cp = function(r, i, u) {
  for (var l = 0, f = r.length; l < f; l++)
    sf.call(r, l) && (u == null ? i(r[l], l, r) : i.call(u, r[l], l, r));
}, fp = function(r, i, u) {
  for (var l = 0, f = r.length; l < f; l++)
  ...
  "BigInt64Array",
  "BigUint64Array"
], Ys = vp, dp = typeof globalThis > "u" ? Wr : globalThis, mp = function() {
  for (var r = [], i = 0; i < Ys.length; i++)
    typeof dp[Ys[i]] == "function" && (r[r.length] = Ys[i]);
  return r;
}, Fi = yp, pp = mp, tl = cr, Xa = bt, Ii = Aa, _p = Xa("Object.prototype.toString"), af = Pn(), nl = typeof globalThis > "u" ? Wr : globalThis, ma = pp(), ja = Xa("String.prototype.slice"), Ws = Object.getPrototypeOf, Ep = Xa("Array.prototype.indexOf", !0) || function(r, i) {
  for (var u = 0; u < r.length; u += 1)
    if (r[u] === i)
      return u;
  return -1;
}, Bi = { __proto__: null };
af && Ii && Ws ? Fi(ma, function(a) {
  var r = new nl[a]();
  ...
  var r = new nl[a](), i = r.slice || r.set;
  i && (Bi["$" + a] = tl(i));
});
var kp = function(r) {
  var i = !1;
  ...
  if (!af) {
    var i = ja(_p(r), 8, -1);
    return Ep(ma, i) > -1 ? i : i !== "Object" ? !1 : xp(r);
  }
  return Ii ? kp(r) : null;
}, bp = bt, rl = bp("ArrayBuffer.prototype.byteLength", !0), Ip = Kc, wp = function(r) {
  return Ip(r) ? rl ? rl(r) : r.byteLength : NaN;
}, of = iv, Yt = bt, il = Lv, Np = Ut, ar = Ud, Lp = Gc, sl = Kd, al = Oc, ol = qc, ul = Kc, ll = am, cl = cm, fl = hm, hl = Oa, gl = zm, yl = Qm, vl = Sp, dl = wp, ml = Yt("SharedArrayBuffer.prototype.byteLength", !0), pl = Yt("Date.prototype.getTime"), Xs = Object.getPrototypeOf, _l = Yt("Object.prototype.toString"), Gi = Np("%Set%", !0), pa = Yt("Map.prototype.has", !0), qi = Yt("Map.prototype.get", !0), El = Yt("Map.prototype.size", !0), zi = Yt("Set.prototype.add", !0), uf = Yt("Set.prototype.delete", !0), Ui = Yt("Set.prototype.has", !0), wi = Yt("Set.prototype.size", !0);
function kl(a, r, i, u) {
  for (var l = ar(a), f; (f = l.next()) && !f.done; )
    if (Rt(r, f.value, i, u))
      return uf(a, f.value), !0;
  return !1;
}
function lf(a) {
  if (typeof a > "u")
...
function Tp(a, r, i, u, l, f) {
  ...
  if (v != null)
    return v;
  var y = qi(r, v), m = of({}, l, { strict: !1 });
  return typeof y > "u" && !pa(r, v) || !Rt(u, y, m, f) ? !1 : !pa(a, v) && Rt(u, y, m, f);
}
function Cp(a, r, i) {
  var u = lf(i);
  return u ?? (Ui(r, u) && !Ui(a, u));
}
function xl(a, r, i, u, l, f) {
...
function Rt(a, r, i, u) {
  var l = i || {};
  if (l.strict ? sl(a, r) : a === r)
    return !0;
  var f = gl(a), v = gl(r);
  if (f !== v)
    return !1;
  if (!a || !r || typeof a != "object" && typeof r != "object")
    return l.strict ? sl(a, r) : a == r;
  ...
  if (y && m) {
    ...
    _ = {};
  return y || u.set(a, _), m || u.set(r, _), Mp(a, r, l, u);
}
function Sl(a) {
  ...
  if (m) {
    for (; (y = f.next()) && !y.done; )
      if (y.value && typeof y.value == "object") {
        if (!kl(m, y.value, i.strict, u))
          return !1;
      } else if (!i.strict && !Ui(a, y.value) && !kl(m, y.value, i.strict, u))
        return !1;
    return wi(m) === 0;
  }
  return !0;
  ...
  if (m) {
    for (; (y = f.next()) && !y.done; )
      if (_ = y.value[0], p = y.value[1], _ && typeof _ == "object") {
        if (!xl(m, a, _, p, i, u))
          return !1;
      } else if (!i.strict && (!a.has(_) || !Rt(qi(a, _), p, i, u)) && !xl(m, a, _, p, of({}, i, { strict: !1 }), u))
        return !1;
    return wi(m) === 0;
  }
  return !0;
...
function Mp(a, r, i, u) {
  var l, f;
  if (typeof a != typeof r || a == null || r == null || _l(a) !== _l(r) || al(a) !== al(r))
    return !1;
  var v = ol(a), y = ol(r);
  if (v !== y)
    return !1;
  ...
  if (m !== _ || (m || _) && (a.name !== r.name || a.message !== r.message))
    return !1;
  var x = cl(a), p = cl(r);
  if (x !== p || (x || p) && (a.source !== r.source || il(a) !== il(r)))
    return !1;
  var S = ll(a), k = ll(r);
  if (S !== k || (S || k) && pl(a) !== pl(r) || i.strict && Xs && Xs(a) !== Xs(r))
    return !1;
  var b = vl(a), C = vl(r);
  if (b !== C)
    return !1;
  ...
  if (P !== O)
    return !1;
  if (P || O)
    return dl(a) !== dl(r) ? !1 : typeof Uint8Array == "function" && Rt(new Uint8Array(a), new Uint8Array(r), i, u);
  var A = fl(a), R = fl(r);
  if (A !== R)
    return !1;
  if (A || R)
  ...
  function() {
    ...
    return a.prototype.insert = function(r, i) {
      ...
      if (u && Sa(r, i, 0, l - 1, f), this._root === null)
        ...
        var v = n0(this.toList(), e0(r, i), f);
        l = this._size + l, this._root = xa({ head: v }, 0, l);
      }
      return this;
      ...
      var l = this._comparator, f = Il(r, this._root, l), v = f.left, y = f.right;
      l(r, i) < 0 ? y = js(i, u, y, l) : v = js(i, u, v, l), this._root = $p(v, y, l);
...
function ka(a, r, i, u) {
  ...
  if (l > 0) {
    ...
    return m.left = ka(a, r, i, f), m.right = ka(a, r, f + 1, u), m;
  }
  return null;
}
function e0(a, r) {
...
function xa(a, r, i) {
  var u = i - r;
  if (u > 0) {
    var l = r + Math.floor(u / 2), f = xa(a, r, l), v = a.head;
    return v.left = f, a.head = a.head.next, v.right = xa(a, l + 1, i), v;
  }
  return null;
}
function n0(a, r, i) {
...
const s0 = (3 + 16 * Kt) * Kt, a0 = (2 + 12 * Kt) * Kt, o0 = (9 + 64 * Kt) * Kt * Kt, Jn = Zr(4), wl = Zr(8), Nl = Zr(12), Ll = Zr(16), $e = Zr(4);
function u0(a, r, i, u, l, f, v) {
  ...
  let ae = i0(4, Jn), F = a0 * v;
  if (ae >= F || -ae >= F || (p = a - D, y = a - (D + p) + (p - l), p = i - H, _ = i - (H + p) + (p - l), p = r - ee, m = r - (ee + p) + (p - f), p = u - Z, x = u - (Z + p) + (p - f), y === 0 && m === 0 && _ === 0 && x === 0) || (F = o0 * v + r0 * Math.abs(ae), ae += D * x + Z * y - (ee * _ + H * m), ae >= F || -ae >= F)) return ae;
  ...
  const de = Vs(ie, Nl, 4, $e, Ll);
  return Ll[de - 1];
}
function l0(a, r, i, u, l, f) {
  const v = (r - f) * (i - l), y = (a - l) * (u - f), m = v - y, _ = Math.abs(v + y);
  return Math.abs(m) >= s0 * _ ? m : -u0(a, r, i, u, l, f, _);
}
const Mr = (a, r) => a.ll.x <= r.x && r.x <= a.ur.x && a.ll.y <= r.y && r.y <= a.ur.y, ba = (a, r) => {
...
class f0 {
  ...
  reset() {
    this.xRounder = new Cl(), this.yRounder = new Cl();
  }
  round(r, i) {
    return {
...
class Cl {
  ...
  round(r) {
    ...
    if (u !== null && Tl(i.key, u.key) === 0)
      return this.tree.remove(r), u.key;
    const l = this.tree.next(i);
    return l !== null && Tl(i.key, l.key) === 0 ? (this.tree.remove(r), l.key) : r;
  }
}
const jr = new f0(), Ni = (a, r) => a.x * r.y - a.y * r.x, yf = (a, r) => a.x * r.x + a.y * r.y, Ol = (a, r, i) => {
  const u = l0(a.x, a.y, r.x, r.y, i.x, i.y);
  return u > 0 ? -1 : u < 0 ? 1 : 0;
}, Wi = (a) => Math.sqrt(yf(a, a)), h0 = (a, r, i) => {
  const u = {
    x: r.x - a.x,
    y: r.y - a.y
  }, l = {
  ...
  if (r.x === 0) return Ml(i, u, a.x);
  if (u.x === 0) return Ml(a, r, i.x);
  if (r.y === 0) return Rl(i, u, a.y);
  if (u.y === 0) return Rl(a, r, i.y);
  const l = Ni(r, u);
  if (l == 0) return null;
  const f = {
    x: i.x - a.x,
...
class ln {
   ...
   */
  getIntersection(r) {
    const i = this.bbox(), u = r.bbox(), l = ba(i, u);
    ...
    if (S) return v;
    if (p) return m;
    const k = y0(f, this.vector(), y, r.vector());
...
class d0 {
  constructor(r, i) {
    if (!Array.isArray(r))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new Pl(r[0], this, !0), this.bbox = {
      ll: {
...
class Xi {
  ...
  getGeom() {
    ...
    for (let _ = 1, x = this.events.length - 1; _ < x; _++) {
      ...
      Ol(p, r, S) !== 0 && (i.push(p), r = p);
    }
    if (i.length === 1) return null;
    const u = i[0], l = i[1];
    Ol(u, r, l) === 0 && i.shift(), i.push(i[0]);
...
class m0 {
  ...
  _composePolys(r) {
    ...
    for (let u = 0, l = r.length; u < l; u++) {
      const f = r[u];
      if (!f.poly)
        if (f.isExteriorRing()) i.push(new Dl(f));
        else {
          const v = f.enclosingRing();
          v.poly || i.push(new Dl(v)), v.poly.addInterior(f);
        }
    }
    return i;
  }
...
const Fl = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6, _0 = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6;
class E0 {
  run(r, i, u) {
    Ct.type = r, jr.reset();
    const l = [new Al(i, !0)];
...
var vf = {
  ...
  xor: S0,
  difference: b0
}, I0 = Object.defineProperty, Xe = (a, r) => I0(a, "name", { value: r, configurable: !0 });
function gr(a, r, i) {
  if (a !== null)
...
function _f(a, r = {}) {
  ...
  const u = vf.union(i[0], ...i.slice(1));
  return u.length === 0 ? null : u.length === 1 ? hr(u[0], r.properties) : es(u, r.properties);
}
F0(_f, "union");
var B0 = _f, G0 = Object.defineProperty, q0 = (a, r) => G0(a, "name", { value: r, configurable: !0 });
function Ef(a, r = {}) {
...
function kf(a, r = {}) {
  const i = Ef(a), u = (i[0] + i[2]) / 2, l = (i[1] + i[3]) / 2;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var rs = function() {
      ...
      return l(o, null, [{ key: "intersection", value: function(e, t, n, s) {
        var c = e.x < t.x ? e.x : t.x, h = e.y < t.y ? e.y : t.y, g = e.x > t.x ? e.x : t.x, d = e.y > t.y ? e.y : t.y, E = n.x < s.x ? n.x : s.x, w = n.y < s.y ? n.y : s.y, N = n.x > s.x ? n.x : s.x, B = n.y > s.y ? n.y : s.y, j = ((c > E ? c : E) + (g < N ? g : N)) / 2, X = ((h > w ? h : w) + (d < B ? d : B)) / 2, $ = e.x - j, re = e.y - X, ce = t.x - j, _e = t.y - X, Pe = n.x - j, je = n.y - X, ct = s.x - j, Nt = s.y - X, Vt = re - _e, Nn = ce - $, wr = $ * _e - ce * re, Nr = je - Nt, Hn = ct - Pe, Po = Pe * Nt - ct * je, Ao = Vt * Hn - Nr * Nn, ks = (Nn * Po - Hn * wr) / Ao, xs = (Nr * wr - Vt * Po) / Ao;
...
` }[e];
    ...
    qe.ForwardComparator = Gf, qe.BidirectionalComparator = qf, qe.coordArrayType = new Array(0).fill(null);
    var ti = function() {
      function o(e) {
        i(this, o), this.str = e;
      }
    ...
    zn.nameToTypeMap = new zf(), It.Type = zn, It.FIXED = new zn("FIXED"), It.FLOATING = new zn("FLOATING"), It.FLOATING_SINGLE = new zn("FLOATING SINGLE"), It.maximumPreciseValue = 9007199254740992;
    var fs = function(o) {
      f(t, o);
      var e = k(t);
      function t() {
    ...
    }(), hs = "XY", Uf = "XYZ", Yf = "XYM", Wf = "XYZM", to = { POINT: "Point", LINE_STRING: "LineString", LINEAR_RING: "LinearRing", POLYGON: "Polygon", MULTI_POINT: "MultiPoint", MULTI_LINE_STRING: "MultiLineString", MULTI_POLYGON: "MultiPolygon", GEOMETRY_COLLECTION: "GeometryCollection", CIRCLE: "Circle" }, no = "EMPTY", ni = 1, Xt = 2, nn = 3, ro = 4, Yn = 5, Xf = 6;
    for (var jf in to) to[jf].toUpperCase();
    var Vf = function() {
      function o(e) {
...
`;
      ...
      return l(o, [{ key: "consume_", value: function() {
        ...
        if (this.isTokenType(ni)) {
          var n = t.value;
          n === "Z" ? e = Uf : n === "M" ? e = Yf : n === "ZM" && (e = Wf), e !== hs && this.consume_();
        }
        return e;
        ...
        var e = this.isTokenType(ni) && this.token_.value == no;
    ...
    var Zf = { Point: io, LineString: Sr, LinearRing: Sr, Polygon: so, MultiPoint: function(o) {
    ...
    function ao(o) {
      var e = o.getGeometryType(), t = Zf[e];
      e = e.toUpperCase();
      var n = function(s) {
        var c = "";
    ...
    var Qf = function() {
      ...
      return l(o, [{ key: "read", value: function(e) {
        var t = new Vf(e);
        return new Hf(t, this.geometryFactory).parse();
      } }, { key: "write", value: function(e) {
        return ao(e);
      } }]), o;
    }(), gs = function() {
      function o(e) {
        i(this, o), this.parser = new Qf(e);
      }
    ...
    var br = function(o) {
      ...
      return l(t, [{ key: "get", value: function(n) {
        ...
        var s;
        for (n.color = 1; n != null && n !== this.root_ && n.parent.color === 1; ) pe(n) === vs(pe(pe(n))) ? uo(s = lo(pe(pe(n)))) === 1 ? (Pt(pe(n), 0), Pt(s, 0), Pt(pe(pe(n)), 1), n = pe(pe(n))) : (n === lo(pe(n)) && (n = pe(n), this.rotateLeft(n)), Pt(pe(n), 0), Pt(pe(pe(n)), 1), this.rotateRight(pe(pe(n)))) : uo(s = vs(pe(pe(n)))) === 1 ? (Pt(pe(n), 0), Pt(s, 0), Pt(pe(pe(n)), 1), n = pe(pe(n))) : (n === vs(pe(n)) && (n = pe(n), this.rotateRight(n)), Pt(pe(n), 0), Pt(pe(pe(n)), 1), this.rotateLeft(pe(pe(n))));
        this.root_.color = 0;
      } }, { key: "values", value: function() {
    ...
    var fo = function() {
      ...
      return l(o, [{ key: "sortShellsAndHoles", value: function(e, t, n) {
        ...
        for (var t = new ne(), n = e.iterator(); n.hasNext(); ) {
          ...
          if (s.isInResult() && s.getLabel().isArea() && s.getEdgeRing() === null) {
            var c = new $f(s, this._geometryFactory);
      ...
      return l(o, [{ key: "maximumDistance", value: function() {
        return rh.maximumDistance(this._boundable1.getBounds(), this._boundable2.getBounds());
      ...
      return l(o, [{ key: "queryInternal", value: function() {
        if (ue(arguments[2], vo) && arguments[0] instanceof Object && arguments[1] instanceof mt) for (var e = arguments[0], t = arguments[1], n = arguments[2], s = t.getChildBoundables(), c = 0; c < s.size(); c++) {
          var h = s.get(c);
    ...
    var sh = function() {
      ...
      return l(o, [{ key: "getCoordinate", value: function() {
        ...
        var t = e;
        return this.segmentIndex < t.segmentIndex ? -1 : this.segmentIndex > t.segmentIndex ? 1 : this.coord.equals2D(t.coord) ? 0 : this._isInterior ? t._isInterior ? sh.compare(this._segmentOctant, this.coord, t.coord) : 1 : -1;
      ...
      return l(o, [{ key: "getSplitCoordinates", value: function() {
        ...
        var n = new ah(this._edge, e, t, this._edge.getSegmentOctant(t)), s = this._nodeMap.get(n);
      ...
      return l(o, [{ key: "getCoordinates", value: function() {
        ...
        return e.equals2D(t) ? 0 : lh.octant(e, t);
      } }, { key: "getData", value: function() {
        return this._data;
        ...
        this._nodeList = new uh(this), this._pts = null, this._data = null;
        var e = arguments[0], t = arguments[1];
      ...
      return l(o, null, [{ key: "findChainEnd", value: function(e, t) {
        ...
        if (arguments.length === 2) {
          ...
          do {
            var h = o.findChainEnd(t, c), g = new po(t, c, h, n);
            s.add(g), c = h;
          } while (c < t.length - 1);
          return s;
        }
      ...
      return l(t, [{ key: "getMonotoneChains", value: function() {
        ...
        for (var s = gh.getChains(n.getCoordinates(), n).iterator(); s.hasNext(); ) {
          var c = s.next();
    ...
    var bo = function(o) {
      ...
      return l(o, [{ key: "getY", value: function() {
        var e = this.y / this.w;
        if (K.isNaN(e) || K.isInfinite(e)) throw new bo();
        return e;
      } }, { key: "getX", value: function() {
        var e = this.x / this.w;
        if (K.isNaN(e) || K.isInfinite(e)) throw new bo();
      ...
      return l(o, [{ key: "addRingSide", value: function(e, t, n, s, c) {
        ...
        var n = new vh(e[0], e[1], e[2]), s = n.inCentre();
      ...
      return l(o, [{ key: "locate", value: function(e) {
        ...
        if (t instanceof ot) for (var n = new ph(t); n.hasNext(); ) {
          var s = n.next();
          if (s !== t) {
      ...
      return l(o, [{ key: "getNextCW", value: function(e) {
        ...
        return this._ptInAreaLocation[e] === I.NONE && (this._ptInAreaLocation[e] = _h.locate(t, n[e].getGeometry())), this._ptInAreaLocation[e];
      } }, { key: "toString", value: function() {
        var e = new En();
...
`);
      ...
      return l(o, [{ key: "print", value: function(e) {
        ...
        return c && (h[g] = t.coord), new Lo(h, new dt(this.edge._label));
      ...
      return l(o, [{ key: "getChainStartIndices", value: function(e) {
        var t = 0, n = new Lh(Math.trunc(e.length / 2));
        n.add(t);
        do {
    ...
    var Lo = function(o) {
      ...
      return l(t, [{ key: "getDepth", value: function() {
        ...
        return this._mce === null && (this._mce = new Ch(this)), this._mce;
      } }, { key: "getEnvelope", value: function() {
        if (this._env === null) {
          this._env = new xe();
        ...
        if (this.pts = null, this._env = null, this.eiList = new wh(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new No(), this._depthDelta = 0, arguments.length === 1) {
          var n = arguments[0];
        ...
        if (!(arguments.length === 2 && arguments[1] instanceof Nh && arguments[0] instanceof dt)) return b(v(t), "updateIM", this).apply(this, arguments);
        var n = arguments[0], s = arguments[1];
      ...
      return l(o, [{ key: "setWorkingPrecisionModel", value: function(e) {
        ...
        for (var n = new ne(), s = e.iterator(); s.hasNext(); ) {
          var c = s.next(), h = c.getRightmostCoordinate(), g = new xo(n).getDepth(h);
        ...
        return n.setPrecisionModel(e), t.setSegmentIntersector(new bh(n)), t;
      } }, { key: "buffer", value: function(e, t) {
        var n = this._workingPrecisionModel;
        n === null && (n = e.getPrecisionModel()), this._geomFact = e.getFactory();
        var s = new yh(n, this._bufParams), c = new dh(e, t, s).getCurves();
        if (c.size() <= 0) return this.createEmptyResultGeometry();
        this.computeNodedEdges(c, n), this._graph = new go(new xh()), this._graph.addEdges(this._edgeList.getEdges());
        var h = this.createSubgraphs(this._graph), g = new th(this._geomFact);
        ...
        for (var s = n.getNodedSubstrings().iterator(); s.hasNext(); ) {
          ...
          if (h.length !== 2 || !h[0].equals2D(h[1])) {
            var g = c.getData(), d = new Lo(c.getCoordinates(), new dt(g));
        ...
        this._bufParams = null, this._workingPrecisionModel = null, this._workingNoder = null, this._geomFact = null, this._graph = null, this._edgeList = new Sh();
        var e = arguments[0];
        this._bufParams = e;
    ...
    var Rh = function() {
      ...
      return l(t, [{ key: "isNodeAdded", value: function() {
        ...
        if (!(arguments.length === 2 && Number.isInteger(arguments[1]) && arguments[0] instanceof po)) return b(v(t.prototype), "select", this).apply(this, arguments);
    ...
    var Mh = function() {
      ...
      return l(o, [{ key: "bufferFixedPrecision", value: function(e) {
        var t = new Oh(new Ph(new It(1)), e.getScale()), n = new To(this._bufParams);
    ...
    var Ah = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], Mo = function() {
      function o(e) {
      ...
      return l(o, [{ key: "read", value: function(e) {
        ...
        return Ah.indexOf(n) !== -1 ? pt[n].call(this, t.coordinates) : n === "GeometryCollection" ? pt[n].call(this, t.geometries) : pt[n].call(this, t);
      } }, { key: "write", value: function(e) {
...
Vi.prototype = {
  ...
  add: function(a) {
    Bl(fi, a, this.t), Bl(this, fi.s, this.s), this.s ? this.t += fi.t : this.s = fi.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var Ie = 1e-6, me = Math.PI, Gt = me / 2, Gl = me / 4, zt = me * 2, rn = 180 / me, _t = me / 180, We = Math.abs, X0 = Math.atan, or = Math.atan2, Ae = Math.cos, De = Math.sin, yr = Math.sqrt;
function Sf(a) {
...
function Hi(a, r) {
  a && zl.hasOwnProperty(a.type) && zl[a.type](a, r);
}
var ql = {
  ...
  MultiPolygon: function(a, r) {
    for (var i = a.coordinates, u = -1, l = i.length; ++u < l; ) Ul(i[u], r);
  },
...
function j0(a, r) {
  a && ql.hasOwnProperty(a.type) ? ql[a.type](a, r) : Hi(a, r);
}
pn();
pn();
function wa(a) {
...
La.invert = La;
function V0(a, r, i) {
  return (a %= zt) ? r || i ? bf(Wl(a), Xl(r, i)) : Wl(a) : r || i ? Xl(r, i) : La;
}
function Yl(a) {
  return function(r, i) {
...
function H0(a, r, i, u, l, f) {
  if (i) {
    ...
    l == null ? (l = r + u * zt, f = r - m / 2) : (l = jl(v, l), f = jl(v, f), (u > 0 ? l < f : l > f) && (l += u * zt));
    for (var _, x = l; u > 0 ? x > f : x < f; x -= m)
      _ = wa([v, -y * Ae(x), -y * De(x)]), a.point(_[0], _[1]);
  }
}
function jl(a, r) {
  r = ur(r), r[0] -= a, Na(r);
...
function wf(a, r, i, u, l) {
  ...
  if (a.forEach(function(b) {
    ...
    for (v.sort(r), Vl(f), Vl(v), y = 0, m = v.length; y < m; ++y)
      v[y].e = i = !i;
    for (var _ = f[0], x, p; ; ) {
...
function J0(a, r, i, u) {
  ...
  return function(_) {
    var x = _, p = If(), S, k, b, C, L, M, P, O, A, R, z, q = {
      point: U,
      lineStart: Z,
      lineEnd: ae,
      polygonStart: H,
    ...
    function ee() {
      var Q = D(), ie = z && Q, de = (S = Lf(S)).length;
      (ie || de) && (_.polygonStart(), ie && (_.lineStart(), f(null, null, 1, _), _.lineEnd()), de && wf(S, y, Q, f, _), _.polygonEnd()), x = _, S = k = b = null;
    }
    function Z() {
    ...
    function F(Q, ie) {
      ...
      if (k && b.push([Q, ie]), R)
        ...
        Z0(Me, Se, a, r, i, u) ? (A || (x.lineStart(), x.point(Me[0], Me[1])), x.point(Se[0], Se[1]), de || x.lineEnd(), z = !1) : de && (x.lineStart(), x.point(Q, ie), z = !1);
      }
      P = Q, O = ie, A = de;
    }
    return q;
...
function $0(a, r) {
  ...
  for (var y = 0, m = a.length; y < m; ++y)
    if (x = (_ = a[y]).length)
      for (var _, x, p = _[x - 1], S = p[0], k = p[1] / 2 + Gl, b = De(k), C = Ae(k), L = 0; L < x; ++L, S = P, b = A, C = R, p = M) {
        var M = _[L], P = M[0], O = M[1] / 2 + Gl, A = De(O), R = Ae(O), z = P - S, q = z >= 0 ? 1 : -1, U = q * z, D = U > me, H = b * A;
        if (Zs.add(or(H * q * De(U), C * R + H * Ae(U))), f += D ? z + q * zt : z, D ^ S >= i ^ P >= i) {
          var ee = Zi(ur(p), ur(M));
          Na(ee);
          var Z = Zi(l, ee);
          Na(Z);
...
pn();
pn();
var lr = 1 / 0, Qi = lr, Vr = -lr, Ki = Vr, Zl = {
  point: e_,
  lineStart: Ar,
  lineEnd: Ar,
  polygonStart: Ar,
...
function Tf(a, r, i, u) {
  return function(l, f) {
    var v = r(f), y = l.invert(u[0], u[1]), m = If(), _ = r(m), x = !1, p, S, k, b = {
      point: C,
      lineStart: M,
      lineEnd: P,
      ...
      polygonEnd: function() {
        b.point = C, b.lineStart = M, b.lineEnd = P, S = Lf(S);
        var z = $0(p, y);
        S.length ? (x || (f.polygonStart(), x = !0), wf(S, n_, z, i, f)) : z && (x || (f.polygonStart(), x = !0), f.lineStart(), i(null, null, 1, f), f.lineEnd()), x && (f.polygonEnd(), x = !1), S = p = null;
      },
      sphere: function() {
    ...
    function R() {
      ...
      if (k.pop(), p.push(k), k = null, !!D) {
        ...
        D > 1 && z & 2 && q.push(q.pop().concat(q.shift())), S.push(q.filter(t_));
      }
    }
    return b;
  };
...
function r_(a) {
  ...
  return {
    ...
    point: function(f, v) {
      ...
      We(m - me) < Ie ? (a.point(r, i = (i + v) / 2 > 0 ? Gt : -Gt), a.point(u, i), a.lineEnd(), a.lineStart(), a.point(y, i), a.point(f, i), l = 0) : u !== y && m >= me && (We(r - u) < Ie && (r -= u * Ie), We(f - y) < Ie && (f -= y * Ie), i = i_(r, i, f, v), a.point(u, i), a.lineEnd(), a.lineStart(), a.point(y, i), l = 0), a.point(r = f, i = v), u = y;
    },
    lineEnd: function() {
      a.lineEnd(), r = i = NaN;
    },
...
function i_(a, r, i, u) {
  var l, f, v = De(a - i);
  return We(v) > Ie ? X0((De(r) * (f = Ae(u)) * De(i) - De(u) * (l = Ae(r)) * De(a)) / (l * f * v)) : (r + u) / 2;
}
function s_(a, r, i, u) {
  var l;
  if (a == null)
...
function Of(a, r, i) {
  ...
  a.scale(150).translate([0, 0]), f != null && a.clipExtent(null), j0(i, a.stream(Zl));
  var v = Zl.result(), y = Math.min(u / (v[1][0] - v[0][0]), l / (v[1][1] - v[0][1])), m = +r[0][0] + (u - y * (v[1][0] + v[0][0])) / 2, _ = +r[0][1] + (l - y * (v[1][1] + v[0][1])) / 2;
  return f != null && a.clipExtent(f), a.scale(y * 150).translate([m, _]);
}
function o_(a, r, i) {
  return Of(a, [[0, 0], r], i);
}
var Kl = 16, u_ = Ae(30 * _t);
function Jl(a, r) {
...
function c_(a, r) {
  function i(u, l, f, v, y, m, _, x, p, S, k, b, C, L) {
    ...
    if (O > 4 * r && C--) {
      ...
      (Q * Q / O > r || We((M * ae + P * F) / O - 0.5) > 0.3 || v * S + y * k + m * b < u_) && (i(u, l, f, v, y, m, ee, Z, D, A /= q, R /= q, z, C, L), L.point(ee, Z), i(ee, Z, D, A, R, z, _, x, p, S, k, b, C, L));
    }
  }
  return function(u) {
    ...
    function O(U, D) {
      ...
      i(p, S, x, k, b, C, p = ee[0], S = ee[1], x = U, k = H[0], b = H[1], C = H[2], Kl, u), u.point(p, S);
    }
    function A() {
      L.point = M, u.lineEnd();
    }
    ...
    function q() {
      i(p, S, x, k, b, C, f, v, l, y, m, _, Kl, u), L.lineEnd = A, A();
    }
    return L;
  };
}
...
function g_(a) {
  var r, i = 150, u = 480, l = 250, f, v, y = 0, m = 0, _ = 0, x = 0, p = 0, S, k, b = null, C = Ql, L = null, M, P, O, A = Hl, R = 0.5, z = Jl(ee, R), q, U;
  function D(F) {
  ...
  D.stream = function(F) {
    return q && U === F ? q : q = f_(C(S, z(A(U = F))));
  }, D.clipAngle = function(F) {
    return arguments.length ? (C = +F ? a_(b = F * _t, 6 * _t) : (b = null, Ql), ae()) : b * rn;
  }, D.clipExtent = function(F) {
    return arguments.length ? (A = F == null ? (L = M = P = O = null, Hl) : J0(L = +F[0][0], M = +F[0][1], P = +F[1][0], O = +F[1][1]), ae()) : L == null ? null : [[L, M], [P, O]];
  }, D.scale = function(F) {
    ...
    return arguments.length ? (z = Jl(ee, R = F * F), ae()) : yr(R);
...
var y_ = Rf(function(a) {
  return yr(2 / (1 + a));
});
y_.invert = Mf(function(a) {
  return 2 * Rn(a / 2);
});
var Pf = Rf(function(a) {
  return (a = Sf(a)) && a / De(a);
});
Pf.invert = Mf(function(a) {
  return a;
});
function v_() {
  return h_(Pf).scale(79.4188).clipAngle(180 - 1e-3);
}
function $l(a, r) {
  return [a, r];
}
$l.invert = $l;
var d_ = Object.defineProperty, vr = (a, r) => d_(a, "name", { value: r, configurable: !0 }), { BufferOp: m_, GeoJSONReader: p_, GeoJSONWriter: __ } = W0;
function Af(a, r, i) {
  i = i || {};
...
function zr(a, r, i, u) {
  ...
  }, _ = new p_(), x = _.read(m), p = Va(ts(r, i), "meters"), S = m_.bufferOp(x, p, u), k = new __();
  if (S = k.write(S), !Qa(S.coordinates)) {
    var b = {
      type: S.type,
      coordinates: Ja(S.coordinates, y)
    };
    return St(b, l);
  }
}
...
function Df(a) {
  var r = kf(a).geometry.coordinates, i = [-r[0], -r[1]];
  return v_().rotate(i).scale(it);
}
vr(Df, "defineProjection");
var E_ = Af, k_ = Object.defineProperty, x_ = (a, r) => k_(a, "name", { value: r, configurable: !0 });
function Ff(a) {
  const r = [];
  if (An(a, (l) => {
  ...
  const i = a.features[0].properties || {}, u = vf.difference(r[0], ...r.slice(1));
...
function b_(a, r = !0, i = !0, u = {}, l = {}, f = (v) => {
  ...
  function S(k, b = !1) {
    ...
    return new kg({ props: { displayIn: "leaflet" }, target: C }), new Zt.Marker(k, {
      interactive: b,
      icon: new Zt.DivIcon({
        html: C,
        className: "",
...
class I_ extends Zt.Control {
  ...
  onAdd(i) {
    ...
    const {
      ...
      fullGeometryStyle: y,
      ...m
    } = Lt(this, Tn), _ = typeof v == "boolean" ? {} : v, x = b_(
      i,
      l,
      f,
      _,
...
export {
  I_ as GeocodingControl,
  b_ as createLeafletMapController
};
