    ...
    value: function(e, r, i) {
      ...
      for (var E = new ko(yr.compare), v = 0, m = o.length; v < m; v++)
        for (var I = o[v].getSweepEvents(), C = 0, S = I.length; C < S; C++)
          if (E.insert(I[C]), E.size > ps)
            throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");
      for (var b = new iu(E), P = E.size, D = E.pop(); D; ) {
        var G = D.key;
        if (E.size === P) {
          var A = G.segment;
...
function Du(n) {
  ...
  return {
    c() {
      t = vs("svg"), e = vs("path"), pr(e, "stroke-width", "4"), pr(e, "fill-rule", "evenodd"), pr(e, "clip-rule", "evenodd"), pr(e, "d", "M 5,33.103579 C 5,17.607779 18.457,5 35,5 C 51.543,5 65,17.607779 65,33.103579 C 65,56.388679 40.4668,76.048179 36.6112,79.137779 C 36.3714,79.329879 36.2116,79.457979 36.1427,79.518879 C 35.8203,79.800879 35.4102,79.942779 35,79.942779 C 34.5899,79.942779 34.1797,79.800879 33.8575,79.518879 C 33.7886,79.457979 33.6289,79.330079 33.3893,79.138079 C 29.5346,76.049279 5,56.389379 5,33.103579 Z M 35.0001,49.386379 C 43.1917,49.386379 49.8323,42.646079 49.8323,34.331379 C 49.8323,26.016779 43.1917,19.276479 35.0001,19.276479 C 26.8085,19.276479 20.1679,26.016779 20.1679,34.331379 C 20.1679,42.646079 26.8085,49.386379 35.0001,49.386379 Z"), pr(e, "class", "svelte-gzo3ar"), pr(t, "width", r = /*displayIn*/
...
At.prototype.fixAfterInsertion = function(n) {
  ...
  for (n.color = qr; n != null && n !== this.root_ && n.parent.color === qr; )
    if ($(n) === Io($($(n)))) {
      var e = Is($($(n)));
      Es(e) === qr ? (gr($(n), mr), gr(e, mr), gr($($(n)), qr), n = $($(n))) : (n === Is($(n)) && (n = $(n), t.rotateLeft(n)), gr($(n), mr), gr($($(n)), qr), t.rotateRight($($(n))));
    } else {
      var r = Io($($(n)));
      Es(r) === qr ? (gr($(n), mr), gr(r, mr), gr($($(n)), qr), n = $($(n))) : (n === Io($(n)) && (n = $(n), t.rotateRight(n)), gr($(n), mr), gr($($(n)), qr), t.rotateLeft($($(n))));
    }
  this.root_.color = mr;
};
...
pn.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (M(arguments[2], Ne) && arguments[0] instanceof d && arguments[1] instanceof Mo)
...
var at = 1e-6, Z = Math.PI, _r = Z / 2, Ss = Z / 4, Lr = Z * 2, Xr = 180 / Z, Ae = Z / 180, Ut = Math.abs, $u = Math.atan, Jn = Math.atan2, Et = Math.cos, It = Math.sin, ii = Math.sqrt;
function La(n) {
...
Go.invert = Go;
function el(n, t, e) {
  return (n %= Lr) ? t || e ? wa(Rs(n), Os(t, e)) : Rs(n) : t || e ? Os(t, e) : Go;
}
function bs(n) {
  return function(t, e) {
...
function rl(n, t, e, r, i, o) {
  if (e) {
    ...
    i == null ? (i = t + r * Lr, o = t - u / 2) : (i = Ds(s, i), o = Ds(s, o), (r > 0 ? i < o : i > o) && (i += r * Lr));
...
function sl(n, t, e, r) {
  ...
  return function(l) {
    var c = l, f = Pa(), h, p, g, E, v, m, I, C, S, b, P, D = {
      point: G,
      lineStart: nt,
      lineEnd: ct,
      polygonStart: et,
    ...
    function w(X, ft) {
      ...
      if (p && g.push([X, ft]), b)
        ...
        nl(pe, Te, n, t, e, r) ? (S || (c.lineStart(), c.point(pe[0], pe[1])), c.point(Te[0], Te[1]), Gt || c.lineEnd(), P = !1) : Gt && (c.lineStart(), c.point(X, ft), P = !1);
      }
      I = X, C = ft, S = Gt;
    }
    return D;
...
function al(n, t) {
  ...
  for (var a = 0, u = n.length; a < u; ++a)
    if (c = (l = n[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], p = f[1] / 2 + Ss, g = It(p), E = Et(p), v = 0; v < c; ++v, h = I, g = S, E = b, f = m) {
        var m = l[v], I = m[0], C = m[1] / 2 + Ss, S = It(C), b = Et(C), P = I - h, D = P >= 0 ? 1 : -1, G = D * P, A = G > Z, et = g * S;
        if (No.add(Jn(et * D * It(G), E * b + et * Et(G))), o += A ? P + D * Lr : P, A ^ h >= e ^ I >= e) {
          var K = to(Zn(f), Zn(m));
          Bo(K);
          var nt = to(i, K);
          Bo(nt);
...
function Da(n, t, e, r) {
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = Pa(), l = t(u), c = !1, f, h, p, g = {
      ...
      polygonEnd: function() {
        g.point = E, g.lineStart = m, g.lineEnd = I, h = Oa(h);
        var P = al(f, a);
...
function fl(n) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      Ut(u - Z) < at ? (n.point(t, e = (e + s) / 2 > 0 ? _r : -_r), n.point(r, e), n.lineEnd(), n.lineStart(), n.point(a, e), n.point(o, e), i = 0) : r !== a && u >= Z && (Ut(t - r) < at && (t -= r * at), Ut(o - a) < at && (o -= a * at), e = hl(t, e, o, s), n.point(r, e), n.lineEnd(), n.lineStart(), n.point(a, e), i = 0), n.point(t = o, e = s), r = a;
    },
    lineEnd: function() {
      n.lineEnd(), t = e = NaN;
    },
...
function ml(n, t) {
  function e(r, i, o, s, a, u, l, c, f, h, p, g, E, v) {
    ...
    if (C > 4 * t && E--) {
      ...
      (X * X / C > t || Ut((m * ct + I * w) / C - 0.5) > 0.3 || s * h + a * p + u * g < vl) && (e(r, i, o, s, a, u, K, nt, A, S /= D, b /= D, P, E, v), v.point(K, nt), e(K, nt, A, S, b, P, l, c, f, h, p, g, E, v));
    }
  }
  return function(r) {
    ...
    function C(G, A) {
      ...
      e(f, h, c, p, g, E, f = K[0], h = K[1], c = G, p = et[0], g = et[1], E = et[2], Bs, r), r.point(f, h);
    }
    function S() {
      v.point = m, r.lineEnd();
    }
    ...
    function D() {
      e(f, h, c, p, g, E, o, s, i, a, u, l, Bs, r), v.lineEnd = S, S();
    }
    return v;
  };
}
...
function Il(n) {
  var t, e = 150, r = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, p, g = null, E = Fs, v = null, m, I, C, S = Ms, b = 0.5, P = Gs(K, b), D, G;
  function A(w) {
  ...
  A.stream = function(w) {
    return D && G === w ? D : D = _l(E(h, P(S(G = w))));
  }, A.clipAngle = function(w) {
    return arguments.length ? (E = +w ? gl(g = w * Ae, 6 * Ae) : (g = null, Fs), ct()) : g * Xr;
  }, A.clipExtent = function(w) {
    return arguments.length ? (S = w == null ? (v = m = I = C = null, Ms) : sl(v = +w[0][0], m = +w[0][1], I = +w[1][0], C = +w[1][1]), ct()) : v == null ? null : [[v, m], [I, C]];
  }, A.scale = function(w) {
    ...
    return arguments.length ? (P = Gs(K, b = w * w), ct()) : ii(b);
...
function Pl(n, t = !0, e = !0, r = {}, i = {}, o = (s) => {
  ...
  function g(v, m = !1) {
    ...
    return new Mu({ props: { displayIn: "leaflet" }, target: I }), new Pn.Marker(v, {
      interactive: m,
      icon: new Pn.DivIcon({
        html: I,
        className: "",
