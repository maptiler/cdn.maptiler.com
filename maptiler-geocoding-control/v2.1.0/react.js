...
function Dn(i, e, t) {
  ...
  const wt = void 0;
  let { reverseGeocodingExcludeTypes: He = wt } = e, { zoom: Ze = d } = e, { apiUrl: tt = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: it = {} } = e, { iconsBaseUrl: pt = "https://cdn.maptiler.com/maptiler-geocoding-control/v2.1.0/icons/" } = e, { adjustUrlQuery: nt = () => {
  } } = e, { adjustUrl: rt = () => {
  } } = e;
  function ni(s) {
    ie.focus(s);
