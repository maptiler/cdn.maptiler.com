...
function Fr(i, e, t) {
  ...
  const ye = void 0;
  let { reverseGeocodingExcludeTypes: Ne = ye } = e, { zoom: de = g } = e, { apiUrl: fe = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: J = {} } = e, { iconsBaseUrl: ai = "https://cdn.maptiler.com/maptiler-geocoding-control/v2.1.0/icons/" } = e, { adjustUrlQuery: Dt = () => {
  } } = e, { adjustUrl: Ut = () => {
  } } = e;
  function hn(_) {
    Te.focus(_);
...
const bs = "@maptiler/geocoding-control", ws = "2.1.0", { MapLibreBasedGeocodingControl: Es, events: Xe } = vs(
  vi.Evented,
  vi,
  (i, e) => {
    const t = {};
...
class Ss extends Es {
  onAdd(e) {
    return e.telemetry.registerModule(bs, ws), super.onAddInt(e);
  }
}
